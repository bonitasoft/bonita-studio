...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.PasswordFormFieldItemSemanticEditPolicy;
 ...
 * @generated
 */
public class PasswordFormFieldEditPart extends ShapeNodeEditPart {

	/**
	* @generated
	*/
	public static final int VISUAL_ID = 2117;
	...
	* @generated
	*/
	public PasswordFormFieldEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new PasswordFormFieldItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new PasswordFigureDescriptor();
	}

	/**
	* @generated
	*/
	public PasswordFigureDescriptor getPrimaryShape() {
		return (PasswordFigureDescriptor) primaryShape;
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PasswordFormFieldNameEditPart) {
			((PasswordFormFieldNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelWidgetLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(PasswordFormFieldNameEditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class PasswordFigureDescriptor extends RectangleFigure {
		 ...
		 * @generated
		 */
		public PasswordFigureDescriptor() {
		...
		private void createContents() {
			...
			sVGfigureName0.setURI("platform:/plugin/org.bonitasoft.studio.pics/icons/formFields/password.svgz");
