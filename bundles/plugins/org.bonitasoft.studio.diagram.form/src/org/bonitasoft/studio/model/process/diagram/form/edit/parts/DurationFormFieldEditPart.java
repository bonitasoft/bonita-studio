...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.DurationFormFieldItemSemanticEditPolicy;
 ...
 * @generated
 */
public class DurationFormFieldEditPart extends ShapeNodeEditPart {

	/**
	* @generated
	*/
	public static final int VISUAL_ID = 2137;
	...
	* @generated
	*/
	public DurationFormFieldEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DurationFormFieldItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new DurationFigureDescriptor();
	}

	/**
	* @generated
	*/
	public DurationFigureDescriptor getPrimaryShape() {
		return (DurationFigureDescriptor) primaryShape;
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DurationFormFieldNameEditPart) {
			((DurationFormFieldNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelWidgetLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(DurationFormFieldNameEditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class DurationFigureDescriptor extends RectangleFigure {
		 ...
		 * @generated
		 */
		public DurationFigureDescriptor() {
		...
		private void createContents() {
			...
			sVGfigureName0.setURI("platform:/plugin/org.bonitasoft.studio.pics/icons/formFields/duration.svgz");
			sVGfigureName0.setPreferredSize(new Dimension(getMapMode().DPtoLP(200), getMapMode().DPtoLP(25)));
