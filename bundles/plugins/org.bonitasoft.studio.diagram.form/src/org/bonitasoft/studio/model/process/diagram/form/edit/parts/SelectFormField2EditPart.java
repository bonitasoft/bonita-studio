...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.SelectFormField2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class SelectFormField2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public SelectFormField2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new SelectFormField2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SelectFormFieldName2EditPart) {
			((SelectFormFieldName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelWidgetLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(SelectFormFieldName2EditPart.VISUAL_ID));
	}
