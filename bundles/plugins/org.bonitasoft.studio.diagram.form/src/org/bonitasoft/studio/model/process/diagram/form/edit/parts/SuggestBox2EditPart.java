...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.SuggestBox2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class SuggestBox2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public SuggestBox2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new SuggestBox2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SuggestBoxName2EditPart) {
			((SuggestBoxName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelWidgetLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(SuggestBoxName2EditPart.VISUAL_ID));
	}
