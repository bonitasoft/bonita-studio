 ...
 * @generated
 */
public class CheckBoxSingleFormFieldNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CheckBoxSingleFormFieldNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ProcessParserProvider.getParser(ProcessElementTypes.CheckBoxSingleFormField_2130,
					getParserElement(), ProcessVisualIDRegistry.getType(
							org.bonitasoft.studio.model.process.diagram.form.edit.parts.CheckBoxSingleFormFieldNameEditPart.VISUAL_ID));
		}
		return parser;
	}
