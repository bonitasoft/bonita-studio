...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.RichTextAreaFormField2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class RichTextAreaFormField2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public RichTextAreaFormField2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new RichTextAreaFormField2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof RichTextAreaFormFieldName2EditPart) {
			((RichTextAreaFormFieldName2EditPart) childEditPart)
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(RichTextAreaFormFieldName2EditPart.VISUAL_ID));
	}
