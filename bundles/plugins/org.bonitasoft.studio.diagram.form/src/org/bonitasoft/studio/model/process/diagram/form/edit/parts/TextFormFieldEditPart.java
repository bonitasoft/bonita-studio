...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.TextFormFieldItemSemanticEditPolicy;
 ...
 * @generated
 */
public class TextFormFieldEditPart extends ShapeNodeEditPart {

	/**
	* @generated
	*/
	public static final int VISUAL_ID = 2120;
	...
	* @generated
	*/
	public TextFormFieldEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new TextFormFieldItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new TextFigureDescriptor();
	}

	/**
	* @generated
	*/
	public TextFigureDescriptor getPrimaryShape() {
		return (TextFigureDescriptor) primaryShape;
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TextFormFieldNameEditPart) {
			((TextFormFieldNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelWidgetLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(TextFormFieldNameEditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class TextFigureDescriptor extends RectangleFigure {
		...
		private void createContents() {
			...
			sVGfigureName0.setURI("platform:/plugin/org.bonitasoft.studio.pics/icons/formFields/textbox.svgz");
