...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.TextInfoItemSemanticEditPolicy;
 ...
 * @generated
 */
public class TextInfoEditPart extends ShapeNodeEditPart {

	/**
	* @generated
	*/
	public static final int VISUAL_ID = 2132;
	...
	* @generated
	*/
	public TextInfoEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new TextInfoItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new TextInfoFigureDescriptor();
	}

	/**
	* @generated
	*/
	public TextInfoFigureDescriptor getPrimaryShape() {
		return (TextInfoFigureDescriptor) primaryShape;
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TextInfoNameEditPart) {
			((TextInfoNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelWidgetLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(TextInfoNameEditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class TextInfoFigureDescriptor extends RectangleFigure {
		 ...
		 * @generated
		 */
		public TextInfoFigureDescriptor() {
		...
		private void createContents() {
			...
			sVGfigureName0.setURI("platform:/plugin/org.bonitasoft.studio.pics/icons/formFields/text-info.svgz");
