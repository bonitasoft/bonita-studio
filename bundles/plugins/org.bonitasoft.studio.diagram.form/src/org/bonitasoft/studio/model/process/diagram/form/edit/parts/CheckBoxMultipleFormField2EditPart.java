...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.CheckBoxMultipleFormField2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class CheckBoxMultipleFormField2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public CheckBoxMultipleFormField2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new CheckBoxMultipleFormField2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CheckBoxMultipleFormFieldName2EditPart) {
			((CheckBoxMultipleFormFieldName2EditPart) childEditPart)
