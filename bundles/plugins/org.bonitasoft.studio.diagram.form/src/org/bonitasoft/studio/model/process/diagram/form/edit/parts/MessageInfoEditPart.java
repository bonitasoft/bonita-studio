...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.MessageInfoItemSemanticEditPolicy;
 ...
 * @generated
 */
public class MessageInfoEditPart extends ShapeNodeEditPart {

	/**
	* @generated
	*/
	public static final int VISUAL_ID = 2131;
	...
	* @generated
	*/
	public MessageInfoEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new MessageInfoItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new MessageFigureDescriptor();
	}

	/**
	* @generated
	*/
	public MessageFigureDescriptor getPrimaryShape() {
		return (MessageFigureDescriptor) primaryShape;
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof MessageInfoLabelEditPart) {
			((MessageInfoLabelEditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelWidgetLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(MessageInfoLabelEditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class MessageFigureDescriptor extends RectangleFigure {
		 ...
		 * @generated
		 */
		public MessageFigureDescriptor() {
		...
		private void createContents() {
			...
			sVGfigureName0.setURI("platform:/plugin/org.bonitasoft.studio.pics/icons/formFields/message.svgz");
			sVGfigureName0.setPreferredSize(new Dimension(getMapMode().DPtoLP(1), getMapMode().DPtoLP(1)));
			sVGfigureName0.setMaximumSize(new Dimension(getMapMode().DPtoLP(400), getMapMode().DPtoLP(100)));
			sVGfigureName0.setMinimumSize(new Dimension(getMapMode().DPtoLP(350), getMapMode().DPtoLP(88)));

			GridData constraintSVGfigureName0 = new GridData();
			constraintSVGfigureName0.verticalAlignment = GridData.CENTER;
			constraintSVGfigureName0.horizontalAlignment = GridData.CENTER;
			constraintSVGfigureName0.horizontalIndent = 30;
			...
			constraintSVGfigureName0.widthHint = 350;
			constraintSVGfigureName0.heightHint = 88;
			this.add(sVGfigureName0, constraintSVGfigureName0);

			GridLayout layoutSVGfigureName0 = new GridLayout();
			layoutSVGfigureName0.numColumns = 1;
			layoutSVGfigureName0.makeColumnsEqualWidth = true;
			sVGfigureName0.setLayoutManager(layoutSVGfigureName0);
			...
			constraintFFigureLabelWidgetLabel.horizontalIndent = 170;
			...
			sVGfigureName0.add(fFigureLabelWidgetLabel, constraintFFigureLabelWidgetLabel);
