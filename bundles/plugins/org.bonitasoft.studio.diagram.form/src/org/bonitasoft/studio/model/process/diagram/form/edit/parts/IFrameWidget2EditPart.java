...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.IFrameWidget2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class IFrameWidget2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public IFrameWidget2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new IFrameWidget2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof IFrameWidgetName2EditPart) {
			((IFrameWidgetName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelWidgetLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(IFrameWidgetName2EditPart.VISUAL_ID));
	}
