 ...
 * @generated
 */
public class PreviousFormButtonNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PreviousFormButtonNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ProcessParserProvider.getParser(ProcessElementTypes.PreviousFormButton_2128, getParserElement(),
					ProcessVisualIDRegistry.getType(
							org.bonitasoft.studio.model.process.diagram.form.edit.parts.PreviousFormButtonNameEditPart.VISUAL_ID));
		}
		return parser;
	}
