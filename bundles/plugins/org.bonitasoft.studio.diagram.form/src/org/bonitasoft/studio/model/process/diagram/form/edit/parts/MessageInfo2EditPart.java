...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.MessageInfo2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class MessageInfo2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public MessageInfo2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new MessageInfo2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof MessageInfoLabel2EditPart) {
			((MessageInfoLabel2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelWidgetLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(MessageInfoLabel2EditPart.VISUAL_ID));
	}
