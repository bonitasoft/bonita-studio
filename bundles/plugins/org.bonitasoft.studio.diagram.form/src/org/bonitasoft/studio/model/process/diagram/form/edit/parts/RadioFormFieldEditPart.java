...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.RadioFormFieldItemSemanticEditPolicy;
 ...
 * @generated
 */
public class RadioFormFieldEditPart extends ShapeNodeEditPart {

	/**
	* @generated
	*/
	public static final int VISUAL_ID = 2118;
	...
	* @generated
	*/
	public RadioFormFieldEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new RadioFormFieldItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new RadioFigureDescriptor();
	}

	/**
	* @generated
	*/
	public RadioFigureDescriptor getPrimaryShape() {
		return (RadioFigureDescriptor) primaryShape;
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof RadioFormFieldNameEditPart) {
			((RadioFormFieldNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelWidgetLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(RadioFormFieldNameEditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class RadioFigureDescriptor extends RectangleFigure {
		...
		private void createContents() {
			...
			sVGfigureName0.setURI("platform:/plugin/org.bonitasoft.studio.pics/icons/formFields/radio-group.svgz");
