...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.SelectFormFieldItemSemanticEditPolicy;
 ...
 * @generated
 */
public class SelectFormFieldEditPart extends ShapeNodeEditPart {

	/**
	* @generated
	*/
	public static final int VISUAL_ID = 2119;
	...
	* @generated
	*/
	public SelectFormFieldEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new SelectFormFieldItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new SelectFigureDescriptor();
	}

	/**
	* @generated
	*/
	public SelectFigureDescriptor getPrimaryShape() {
		return (SelectFigureDescriptor) primaryShape;
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SelectFormFieldNameEditPart) {
			((SelectFormFieldNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelWidgetLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(SelectFormFieldNameEditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class SelectFigureDescriptor extends RectangleFigure {
		...
		private void createContents() {
			...
			sVGfigureName0.setURI("platform:/plugin/org.bonitasoft.studio.pics/icons/formFields/select.svgz");
