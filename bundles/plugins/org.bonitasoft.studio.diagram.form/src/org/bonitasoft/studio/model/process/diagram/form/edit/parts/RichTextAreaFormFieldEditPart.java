...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.RichTextAreaFormFieldItemSemanticEditPolicy;
 ...
 * @generated
 */
public class RichTextAreaFormFieldEditPart extends ShapeNodeEditPart {

	/**
	* @generated
	*/
	public static final int VISUAL_ID = 2140;
	...
	* @generated
	*/
	public RichTextAreaFormFieldEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new RichTextAreaFormFieldItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new RichTextAreaFigureDescriptor();
	}

	/**
	* @generated
	*/
	public RichTextAreaFigureDescriptor getPrimaryShape() {
		return (RichTextAreaFigureDescriptor) primaryShape;
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof RichTextAreaFormFieldNameEditPart) {
			((RichTextAreaFormFieldNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelWidgetLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(RichTextAreaFormFieldNameEditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class RichTextAreaFigureDescriptor extends RectangleFigure {
		 ...
		 * @generated
		 */
		public RichTextAreaFigureDescriptor() {
		...
		private void createContents() {
			...
			sVGfigureName0.setURI("platform:/plugin/org.bonitasoft.studio.pics/icons/formFields/richtextarea.svgz");
