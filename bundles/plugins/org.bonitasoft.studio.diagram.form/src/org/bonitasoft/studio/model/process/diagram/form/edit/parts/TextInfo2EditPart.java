...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.TextInfo2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class TextInfo2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public TextInfo2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new TextInfo2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TextInfoName2EditPart) {
			((TextInfoName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelWidgetLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(TextInfoName2EditPart.VISUAL_ID));
	}
