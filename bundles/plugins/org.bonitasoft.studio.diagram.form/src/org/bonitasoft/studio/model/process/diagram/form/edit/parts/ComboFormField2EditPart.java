...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.ComboFormField2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ComboFormField2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public ComboFormField2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ComboFormField2ItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new ComboFigureDescriptor();
	}

	/**
	* @generated
	*/
	public ComboFigureDescriptor getPrimaryShape() {
		return (ComboFigureDescriptor) primaryShape;
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ComboFormFieldName2EditPart) {
			((ComboFormFieldName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelWidgetLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(ComboFormFieldName2EditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class ComboFigureDescriptor extends RectangleFigure {
		...
		private void createContents() {
			...
			sVGfigureName0.setPreferredSize(new Dimension(getMapMode().DPtoLP(250), getMapMode().DPtoLP(22)));
			sVGfigureName0.setMaximumSize(new Dimension(getMapMode().DPtoLP(250), getMapMode().DPtoLP(22)));
			sVGfigureName0.setMinimumSize(new Dimension(getMapMode().DPtoLP(250), getMapMode().DPtoLP(22)));
