...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.CheckBoxSingleFormField2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class CheckBoxSingleFormField2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public CheckBoxSingleFormField2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new CheckBoxSingleFormField2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CheckBoxSingleFormFieldName2EditPart) {
			((CheckBoxSingleFormFieldName2EditPart) childEditPart)
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(CheckBoxSingleFormFieldName2EditPart.VISUAL_ID));
	}
