...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.NextFormButton2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class NextFormButton2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public NextFormButton2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new NextFormButton2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof NextFormButtonName2EditPart) {
			((NextFormButtonName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelWidgetLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(NextFormButtonName2EditPart.VISUAL_ID));
	}
