...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.PreviousFormButton2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class PreviousFormButton2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public PreviousFormButton2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new PreviousFormButton2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PreviousFormButtonName2EditPart) {
			((PreviousFormButtonName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelWidgetLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(PreviousFormButtonName2EditPart.VISUAL_ID));
	}
