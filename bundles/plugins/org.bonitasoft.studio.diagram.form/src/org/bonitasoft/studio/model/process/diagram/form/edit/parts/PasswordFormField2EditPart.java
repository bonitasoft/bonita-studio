...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.PasswordFormField2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class PasswordFormField2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public PasswordFormField2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new PasswordFormField2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PasswordFormFieldName2EditPart) {
			((PasswordFormFieldName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelWidgetLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(PasswordFormFieldName2EditPart.VISUAL_ID));
	}
