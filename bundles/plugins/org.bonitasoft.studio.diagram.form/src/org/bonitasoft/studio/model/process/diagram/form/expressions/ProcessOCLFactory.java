...
public class ProcessOCLFactory {
	...
	*/
	private static ProcessOCLFactory getInstance() {
		ProcessOCLFactory instance = FormDiagramEditorPlugin.getInstance().getProcessOCLFactory();
		if (instance == null) {
			FormDiagramEditorPlugin.getInstance().setProcessOCLFactory(instance = new ProcessOCLFactory());
		}
		return instance;
	}
