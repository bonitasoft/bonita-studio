 ...
 * @generated
 */
public class CheckBoxSingleFormFieldName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CheckBoxSingleFormFieldName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ProcessParserProvider.getParser(ProcessElementTypes.CheckBoxSingleFormField_3118,
					getParserElement(), ProcessVisualIDRegistry.getType(
							org.bonitasoft.studio.model.process.diagram.form.edit.parts.CheckBoxSingleFormFieldName2EditPart.VISUAL_ID));
		}
		return parser;
	}
