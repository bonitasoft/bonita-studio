...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.HtmlWidgetItemSemanticEditPolicy;
 ...
 * @generated
 */
public class HtmlWidgetEditPart extends ShapeNodeEditPart {

	/**
	* @generated
	*/
	public static final int VISUAL_ID = 2143;
	...
	* @generated
	*/
	public HtmlWidgetEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new HtmlWidgetItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new HTMLFigureDescriptor();
	}

	/**
	* @generated
	*/
	public HTMLFigureDescriptor getPrimaryShape() {
		return (HTMLFigureDescriptor) primaryShape;
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof HtmlWidgetNameEditPart) {
			((HtmlWidgetNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelWidgetLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(HtmlWidgetNameEditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class HTMLFigureDescriptor extends RectangleFigure {
		...
		private void createContents() {
			...
			sVGfigureName0.setURI("platform:/plugin/org.bonitasoft.studio.pics/icons/formFields/htmlwidget.svgz");
