...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.SuggestBoxItemSemanticEditPolicy;
 ...
 * @generated
 */
public class SuggestBoxEditPart extends ShapeNodeEditPart {

	/**
	* @generated
	*/
	public static final int VISUAL_ID = 2144;
	...
	* @generated
	*/
	public SuggestBoxEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new SuggestBoxItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new SuggestBoxFigureDescriptor();
	}

	/**
	* @generated
	*/
	public SuggestBoxFigureDescriptor getPrimaryShape() {
		return (SuggestBoxFigureDescriptor) primaryShape;
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SuggestBoxNameEditPart) {
			((SuggestBoxNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelWidgetLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(SuggestBoxNameEditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class SuggestBoxFigureDescriptor extends RectangleFigure {
		 ...
		 * @generated
		 */
		public SuggestBoxFigureDescriptor() {
		...
		private void createContents() {
			...
			sVGfigureName0.setURI("platform:/plugin/org.bonitasoft.studio.pics/icons/formFields/suggestbox.svgz");
