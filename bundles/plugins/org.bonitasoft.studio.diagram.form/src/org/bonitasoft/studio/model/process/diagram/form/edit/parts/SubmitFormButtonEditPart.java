...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.SubmitFormButtonItemSemanticEditPolicy;
 ...
 * @generated
 */
public class SubmitFormButtonEditPart extends ShapeNodeEditPart {

	/**
	* @generated
	*/
	public static final int VISUAL_ID = 2126;
	...
	* @generated
	*/
	public SubmitFormButtonEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new SubmitFormButtonItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SubmitFormButtonNameEditPart) {
			((SubmitFormButtonNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelWidgetLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(SubmitFormButtonNameEditPart.VISUAL_ID));
	}
