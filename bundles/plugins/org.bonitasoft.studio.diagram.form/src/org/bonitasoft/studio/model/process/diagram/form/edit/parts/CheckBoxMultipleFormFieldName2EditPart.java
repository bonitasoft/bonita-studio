 ...
 * @generated
 */
public class CheckBoxMultipleFormFieldName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CheckBoxMultipleFormFieldName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ProcessParserProvider.getParser(ProcessElementTypes.CheckBoxMultipleFormField_3120,
					getParserElement(), ProcessVisualIDRegistry.getType(
							org.bonitasoft.studio.model.process.diagram.form.edit.parts.CheckBoxMultipleFormFieldName2EditPart.VISUAL_ID));
		}
		return parser;
	}
