...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.DateFormFieldItemSemanticEditPolicy;
 ...
 * @generated
 */
public class DateFormFieldEditPart extends ShapeNodeEditPart {

	/**
	* @generated
	*/
	public static final int VISUAL_ID = 2115;
	...
	* @generated
	*/
	public DateFormFieldEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DateFormFieldItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new DateFigureDescriptor();
	}

	/**
	* @generated
	*/
	public DateFigureDescriptor getPrimaryShape() {
		return (DateFigureDescriptor) primaryShape;
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DateFormFieldNameEditPart) {
			((DateFormFieldNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelWidgetLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(DateFormFieldNameEditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class DateFigureDescriptor extends RectangleFigure {
