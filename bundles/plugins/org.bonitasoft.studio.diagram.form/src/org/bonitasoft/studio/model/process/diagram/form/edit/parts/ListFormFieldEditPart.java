...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.ListFormFieldItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ListFormFieldEditPart extends ShapeNodeEditPart {

	/**
	* @generated
	*/
	public static final int VISUAL_ID = 2116;
	...
	* @generated
	*/
	public ListFormFieldEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ListFormFieldItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new ListFigureDescriptor();
	}

	/**
	* @generated
	*/
	public ListFigureDescriptor getPrimaryShape() {
		return (ListFigureDescriptor) primaryShape;
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ListFormFieldNameEditPart) {
			((ListFormFieldNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelWidgetLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(ListFormFieldNameEditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class ListFigureDescriptor extends RectangleFigure {
