...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.CheckBoxMultipleFormFieldItemSemanticEditPolicy;
 ...
 * @generated
 */
public class CheckBoxMultipleFormFieldEditPart extends ShapeNodeEditPart {

	/**
	* @generated
	*/
	public static final int VISUAL_ID = 2134;
	...
	* @generated
	*/
	public CheckBoxMultipleFormFieldEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new CheckBoxMultipleFormFieldItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new CheckBoxGroupFigureDescriptor();
	}

	/**
	* @generated
	*/
	public CheckBoxGroupFigureDescriptor getPrimaryShape() {
		return (CheckBoxGroupFigureDescriptor) primaryShape;
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CheckBoxMultipleFormFieldNameEditPart) {
			((CheckBoxMultipleFormFieldNameEditPart) childEditPart)
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(CheckBoxMultipleFormFieldNameEditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class CheckBoxGroupFigureDescriptor extends RectangleFigure {
		 ...
		 * @generated
		 */
		public CheckBoxGroupFigureDescriptor() {
		...
		private void createContents() {
			...
			sVGfigureName0.setURI("platform:/plugin/org.bonitasoft.studio.pics/icons/formFields/checkbox-group.svgz");
			sVGfigureName0.setPreferredSize(new Dimension(getMapMode().DPtoLP(200), getMapMode().DPtoLP(50)));
			sVGfigureName0.setMaximumSize(new Dimension(getMapMode().DPtoLP(200), getMapMode().DPtoLP(100)));
			sVGfigureName0.setMinimumSize(new Dimension(getMapMode().DPtoLP(1), getMapMode().DPtoLP(1)));
			...
			constraintSVGfigureName0.widthHint = 200;
			constraintSVGfigureName0.heightHint = 100;
