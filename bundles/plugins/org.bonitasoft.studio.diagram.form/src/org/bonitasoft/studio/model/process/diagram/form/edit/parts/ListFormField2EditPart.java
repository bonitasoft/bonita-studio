...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.ListFormField2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ListFormField2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public ListFormField2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ListFormField2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ListFormFieldName2EditPart) {
			((ListFormFieldName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelWidgetLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(ListFormFieldName2EditPart.VISUAL_ID));
	}
