...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.FileWidgetItemSemanticEditPolicy;
 ...
 * @generated
 */
public class FileWidgetEditPart extends ShapeNodeEditPart {

	/**
	* @generated
	*/
	public static final int VISUAL_ID = 2133;
	...
	* @generated
	*/
	public FileWidgetEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new FileWidgetItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new FileWidgetFigureDescriptor();
	}

	/**
	* @generated
	*/
	public FileWidgetFigureDescriptor getPrimaryShape() {
		return (FileWidgetFigureDescriptor) primaryShape;
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof FileWidgetNameEditPart) {
			((FileWidgetNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelWidgetLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(FileWidgetNameEditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class FileWidgetFigureDescriptor extends RectangleFigure {
		 ...
		 * @generated
		 */
		public FileWidgetFigureDescriptor() {
		...
		private void createContents() {
			...
			sVGfigureName0.setURI("platform:/plugin/org.bonitasoft.studio.pics/icons/formFields/file.svg");
