...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.HiddenWidget2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class HiddenWidget2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public HiddenWidget2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new HiddenWidget2ItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new HiddenWidgetFigureDescriptor();
	}

	/**
	* @generated
	*/
	public HiddenWidgetFigureDescriptor getPrimaryShape() {
		return (HiddenWidgetFigureDescriptor) primaryShape;
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof HiddenWidgetLabelEditPart) {
			((HiddenWidgetLabelEditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelWidgetLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(HiddenWidgetLabelEditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class HiddenWidgetFigureDescriptor extends RectangleFigure {
		 ...
		 * @generated
		 */
		public HiddenWidgetFigureDescriptor() {
		...
		private void createContents() {
			...
			sVGfigureName0.setURI("platform:/plugin/org.bonitasoft.studio.pics/icons/formFields/hidden.svgz");
