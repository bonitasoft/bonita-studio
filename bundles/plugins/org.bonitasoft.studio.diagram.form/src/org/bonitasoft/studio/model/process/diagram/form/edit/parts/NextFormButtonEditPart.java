...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.NextFormButtonItemSemanticEditPolicy;
 ...
 * @generated
 */
public class NextFormButtonEditPart extends ShapeNodeEditPart {

	/**
	* @generated
	*/
	public static final int VISUAL_ID = 2127;
	...
	* @generated
	*/
	public NextFormButtonEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new NextFormButtonItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new NextButtonFigureDescriptor();
	}

	/**
	* @generated
	*/
	public NextButtonFigureDescriptor getPrimaryShape() {
		return (NextButtonFigureDescriptor) primaryShape;
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof NextFormButtonNameEditPart) {
			((NextFormButtonNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelWidgetLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(NextFormButtonNameEditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class NextButtonFigureDescriptor extends RectangleFigure {
