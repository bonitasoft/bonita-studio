...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.ImageWidget2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ImageWidget2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public ImageWidget2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ImageWidget2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ImageWidgetName2EditPart) {
			((ImageWidgetName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelWidgetLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(ImageWidgetName2EditPart.VISUAL_ID));
	}
