...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.ComboFormFieldItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ComboFormFieldEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public ComboFormFieldEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ComboFormFieldItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ComboFormFieldNameEditPart) {
			((ComboFormFieldNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelWidgetLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(ComboFormFieldNameEditPart.VISUAL_ID));
	}
