...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.TextFormField2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class TextFormField2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public TextFormField2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new TextFormField2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TextFormFieldName2EditPart) {
			((TextFormFieldName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelWidgetLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(TextFormFieldName2EditPart.VISUAL_ID));
	}
