...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.TextAreaFormField2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class TextAreaFormField2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public TextAreaFormField2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new TextAreaFormField2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TextAreaFormFieldName2EditPart) {
			((TextAreaFormFieldName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelWidgetLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(TextAreaFormFieldName2EditPart.VISUAL_ID));
	}
