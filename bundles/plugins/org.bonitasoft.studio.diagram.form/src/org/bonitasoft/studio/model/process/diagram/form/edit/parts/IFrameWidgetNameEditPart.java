 ...
 * @generated
 */
public class IFrameWidgetNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public IFrameWidgetNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ProcessParserProvider.getParser(ProcessElementTypes.IFrameWidget_2142, getParserElement(),
					ProcessVisualIDRegistry.getType(
							org.bonitasoft.studio.model.process.diagram.form.edit.parts.IFrameWidgetNameEditPart.VISUAL_ID));
		}
		return parser;
	}
