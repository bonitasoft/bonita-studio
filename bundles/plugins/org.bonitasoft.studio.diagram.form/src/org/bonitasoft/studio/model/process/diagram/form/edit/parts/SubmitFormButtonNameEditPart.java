 ...
 * @generated
 */
public class SubmitFormButtonNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public SubmitFormButtonNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ProcessParserProvider.getParser(ProcessElementTypes.SubmitFormButton_2126, getParserElement(),
					ProcessVisualIDRegistry.getType(
							org.bonitasoft.studio.model.process.diagram.form.edit.parts.SubmitFormButtonNameEditPart.VISUAL_ID));
		}
		return parser;
	}
