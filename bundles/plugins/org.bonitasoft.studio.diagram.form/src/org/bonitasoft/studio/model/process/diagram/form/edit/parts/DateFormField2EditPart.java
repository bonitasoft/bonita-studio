...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.DateFormField2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class DateFormField2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public DateFormField2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DateFormField2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DateFormFieldName2EditPart) {
			((DateFormFieldName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelWidgetLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(DateFormFieldName2EditPart.VISUAL_ID));
	}
