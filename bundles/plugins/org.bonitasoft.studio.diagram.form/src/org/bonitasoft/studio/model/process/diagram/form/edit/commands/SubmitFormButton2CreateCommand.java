 ...
 * @generated
 */
public class SubmitFormButton2CreateCommand extends EditElementCommand {

	/**
	* @generated
	*/
	public SubmitFormButton2CreateCommand(CreateElementRequest req) {
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		ElementInitializers.getInstance().init_SubmitFormButton_3116(newElement);
