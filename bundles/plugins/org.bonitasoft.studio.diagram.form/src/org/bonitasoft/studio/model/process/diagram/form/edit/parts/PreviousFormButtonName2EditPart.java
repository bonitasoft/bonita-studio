 ...
 * @generated
 */
public class PreviousFormButtonName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PreviousFormButtonName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ProcessParserProvider.getParser(ProcessElementTypes.PreviousFormButton_3114, getParserElement(),
					ProcessVisualIDRegistry.getType(
							org.bonitasoft.studio.model.process.diagram.form.edit.parts.PreviousFormButtonName2EditPart.VISUAL_ID));
		}
		return parser;
	}
