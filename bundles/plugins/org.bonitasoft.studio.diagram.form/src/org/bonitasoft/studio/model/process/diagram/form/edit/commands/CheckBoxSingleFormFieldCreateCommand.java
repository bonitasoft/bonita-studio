 ...
 * @generated
 */
public class CheckBoxSingleFormFieldCreateCommand extends EditElementCommand {

	/**
	* @generated
	*/
	public CheckBoxSingleFormFieldCreateCommand(CreateElementRequest req) {
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		ElementInitializers.getInstance().init_CheckBoxSingleFormField_2130(newElement);
