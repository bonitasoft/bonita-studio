...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.ImageWidgetItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ImageWidgetEditPart extends ShapeNodeEditPart {

	/**
	* @generated
	*/
	public static final int VISUAL_ID = 2135;
	...
	* @generated
	*/
	public ImageWidgetEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ImageWidgetItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new ImageWidgetFigureDescriptor();
	}

	/**
	* @generated
	*/
	public ImageWidgetFigureDescriptor getPrimaryShape() {
		return (ImageWidgetFigureDescriptor) primaryShape;
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ImageWidgetNameEditPart) {
			((ImageWidgetNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelWidgetLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(ImageWidgetNameEditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class ImageWidgetFigureDescriptor extends RectangleFigure {
		 ...
		 * @generated
		 */
		public ImageWidgetFigureDescriptor() {
		...
		private void createContents() {
			...
			sVGfigureName0.setURI("platform:/plugin/org.bonitasoft.studio.pics/icons/formFields/image.svgz");
			sVGfigureName0.setPreferredSize(new Dimension(getMapMode().DPtoLP(250), getMapMode().DPtoLP(80)));
			sVGfigureName0.setMaximumSize(new Dimension(getMapMode().DPtoLP(250), getMapMode().DPtoLP(80)));
			sVGfigureName0.setMinimumSize(new Dimension(getMapMode().DPtoLP(250), getMapMode().DPtoLP(80)));
			...
			constraintSVGfigureName0.widthHint = 80;
			constraintSVGfigureName0.heightHint = 80;
