...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.DynamicTableItemSemanticEditPolicy;
 ...
 * @generated
 */
public class DynamicTableEditPart extends ShapeNodeEditPart {

	/**
	* @generated
	*/
	public static final int VISUAL_ID = 2141;
	...
	* @generated
	*/
	public DynamicTableEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DynamicTableItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new DynamicTableFigureDescriptor();
	}

	/**
	* @generated
	*/
	public DynamicTableFigureDescriptor getPrimaryShape() {
		return (DynamicTableFigureDescriptor) primaryShape;
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DynamicTableNameEditPart) {
			((DynamicTableNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelWidgetLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(DynamicTableNameEditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class DynamicTableFigureDescriptor extends RectangleFigure {
		 ...
		 * @generated
		 */
		public DynamicTableFigureDescriptor() {
		...
		private void createContents() {
			...
			sVGfigureName0.setURI("platform:/plugin/org.bonitasoft.studio.pics/icons/formFields/dynamicTable.svgz");
