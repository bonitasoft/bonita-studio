...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.DurationFormField2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class DurationFormField2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public DurationFormField2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DurationFormField2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DurationFormFieldName2EditPart) {
			((DurationFormFieldName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelWidgetLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(DurationFormFieldName2EditPart.VISUAL_ID));
	}
