...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.Table2ItemSemanticEditPolicy;
...
public class Table2EditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TableName2EditPart) {
			((TableName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelWidgetLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(TableName2EditPart.VISUAL_ID));
	}
