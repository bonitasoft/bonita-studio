...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.FormButton2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class FormButton2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public FormButton2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new FormButton2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof FormButtonName2EditPart) {
			((FormButtonName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelWidgetLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(FormButtonName2EditPart.VISUAL_ID));
	}
