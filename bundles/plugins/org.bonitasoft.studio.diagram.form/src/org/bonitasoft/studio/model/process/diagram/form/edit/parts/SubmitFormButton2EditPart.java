...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.SubmitFormButton2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class SubmitFormButton2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public SubmitFormButton2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new SubmitFormButton2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SubmitFormButtonName2EditPart) {
			((SubmitFormButtonName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelWidgetLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(SubmitFormButtonName2EditPart.VISUAL_ID));
	}
