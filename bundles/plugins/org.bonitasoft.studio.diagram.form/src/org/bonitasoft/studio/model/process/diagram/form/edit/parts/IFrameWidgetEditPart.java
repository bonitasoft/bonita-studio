...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.IFrameWidgetItemSemanticEditPolicy;
 ...
 * @generated
 */
public class IFrameWidgetEditPart extends ShapeNodeEditPart {

	/**
	* @generated
	*/
	public static final int VISUAL_ID = 2142;
	...
	* @generated
	*/
	public IFrameWidgetEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new IFrameWidgetItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new IframeFigureDescriptor();
	}

	/**
	* @generated
	*/
	public IframeFigureDescriptor getPrimaryShape() {
		return (IframeFigureDescriptor) primaryShape;
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof IFrameWidgetNameEditPart) {
			((IFrameWidgetNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelWidgetLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(IFrameWidgetNameEditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class IframeFigureDescriptor extends RectangleFigure {
		...
		private void createContents() {
			...
			sVGfigureName0.setURI("platform:/plugin/org.bonitasoft.studio.pics/icons/formFields/iframe.svgz");
