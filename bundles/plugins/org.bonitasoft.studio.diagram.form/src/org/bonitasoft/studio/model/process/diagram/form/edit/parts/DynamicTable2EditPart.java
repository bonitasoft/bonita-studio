...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.DynamicTable2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class DynamicTable2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public DynamicTable2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DynamicTable2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DynamicTableName2EditPart) {
			((DynamicTableName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelWidgetLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(DynamicTableName2EditPart.VISUAL_ID));
	}
