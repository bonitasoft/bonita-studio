...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.FileWidget2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class FileWidget2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public FileWidget2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new FileWidget2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof FileWidgetName2EditPart) {
			((FileWidgetName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelWidgetLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(FileWidgetName2EditPart.VISUAL_ID));
	}
