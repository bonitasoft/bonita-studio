...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.RadioFormField2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class RadioFormField2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public RadioFormField2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new RadioFormField2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof RadioFormFieldName2EditPart) {
			((RadioFormFieldName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelWidgetLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(RadioFormFieldName2EditPart.VISUAL_ID));
	}
