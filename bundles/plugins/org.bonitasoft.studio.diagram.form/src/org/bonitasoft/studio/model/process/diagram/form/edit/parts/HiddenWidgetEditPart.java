...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.HiddenWidgetItemSemanticEditPolicy;
 ...
 * @generated
 */
public class HiddenWidgetEditPart extends ShapeNodeEditPart {

	/**
	* @generated
	*/
	public static final int VISUAL_ID = 2136;
	...
	* @generated
	*/
	public HiddenWidgetEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new HiddenWidgetItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof HiddenWidgetDisplayLabelShowDisplayEditPart) {
			((HiddenWidgetDisplayLabelShowDisplayEditPart) childEditPart)
