...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.TextAreaFormFieldItemSemanticEditPolicy;
 ...
 * @generated
 */
public class TextAreaFormFieldEditPart extends ShapeNodeEditPart {

	/**
	* @generated
	*/
	public static final int VISUAL_ID = 2121;
	...
	* @generated
	*/
	public TextAreaFormFieldEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new TextAreaFormFieldItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new TextAreaFigureDescriptor();
	}

	/**
	* @generated
	*/
	public TextAreaFigureDescriptor getPrimaryShape() {
		return (TextAreaFigureDescriptor) primaryShape;
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TextAreaFormFieldNameEditPart) {
			((TextAreaFormFieldNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelWidgetLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(TextAreaFormFieldNameEditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class TextAreaFigureDescriptor extends RectangleFigure {
		 ...
		 * @generated
		 */
		public TextAreaFigureDescriptor() {
		...
		private void createContents() {
			...
			sVGfigureName0.setURI("platform:/plugin/org.bonitasoft.studio.pics/icons/formFields/text-area.svgz");
