...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.HtmlWidget2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class HtmlWidget2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public HtmlWidget2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new HtmlWidget2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof HtmlWidgetName2EditPart) {
			((HtmlWidgetName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelWidgetLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(HtmlWidgetName2EditPart.VISUAL_ID));
	}
