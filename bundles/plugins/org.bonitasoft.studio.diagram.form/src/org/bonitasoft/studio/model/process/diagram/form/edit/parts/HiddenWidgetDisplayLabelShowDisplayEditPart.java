 ...
 * @generated
 */
public class HiddenWidgetDisplayLabelShowDisplayEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public HiddenWidgetDisplayLabelShowDisplayEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ProcessParserProvider.getParser(ProcessElementTypes.HiddenWidget_2136, getParserElement(),
					ProcessVisualIDRegistry.getType(
							org.bonitasoft.studio.model.process.diagram.form.edit.parts.HiddenWidgetDisplayLabelShowDisplayEditPart.VISUAL_ID));
		}
		return parser;
	}
