...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.PreviousFormButtonItemSemanticEditPolicy;
 ...
 * @generated
 */
public class PreviousFormButtonEditPart extends ShapeNodeEditPart {

	/**
	* @generated
	*/
	public static final int VISUAL_ID = 2128;
	...
	* @generated
	*/
	public PreviousFormButtonEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new PreviousFormButtonItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new PreviousButtonFigureDescriptor();
	}

	/**
	* @generated
	*/
	public PreviousButtonFigureDescriptor getPrimaryShape() {
		return (PreviousButtonFigureDescriptor) primaryShape;
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PreviousFormButtonNameEditPart) {
			((PreviousFormButtonNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelWidgetLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(PreviousFormButtonNameEditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class PreviousButtonFigureDescriptor extends RectangleFigure {
