...
import org.bonitasoft.studio.model.process.diagram.form.edit.policies.TableItemSemanticEditPolicy;
...
public class TableEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public static final int VISUAL_ID = 2139;
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new TableFigureDescriptor();
	}

	/**
	* @generated
	*/
	public TableFigureDescriptor getPrimaryShape() {
		return (TableFigureDescriptor) primaryShape;
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TableNameEditPart) {
			((TableNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelWidgetLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(TableNameEditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class TableFigureDescriptor extends RectangleFigure {
		...
		private void createContents() {
			...
			sVGfigureName0.setURI("platform:/plugin/org.bonitasoft.studio.pics/icons/formFields/table.svgz");
