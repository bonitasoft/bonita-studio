 ...
 *
 */
public class InformixConfigExtendedWizardPage extends AbstractConnectDBWizardWizardPage {
    ...
    public IConnectionProfile getConnectionProfile(final String className, final String jdbcUrl, final String username, final String password)
        ...
        return ConnectionProfileUtil.createInformixConnectionProfile(jdbcUrl, username, password, className, parseDatabaseFromURL(jdbcUrl));
	}
