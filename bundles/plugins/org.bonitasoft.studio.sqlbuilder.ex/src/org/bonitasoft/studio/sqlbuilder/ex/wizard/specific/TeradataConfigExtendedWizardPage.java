 ...
 *
 */
public class TeradataConfigExtendedWizardPage extends AbstractConnectDBWizardWizardPage {

	@Override
    public IConnectionProfile getConnectionProfile(final String className,
			final String jdbcUrl, final String username, final String password)
            throws ConnectionProfileException, ClassNotFoundException, UnsupportedEncodingException {
        return ConnectionProfileUtil.createTeraDataConnectionProfile(jdbcUrl, username, password, className, parseDatabaseFromURL(jdbcUrl));
	}
}
