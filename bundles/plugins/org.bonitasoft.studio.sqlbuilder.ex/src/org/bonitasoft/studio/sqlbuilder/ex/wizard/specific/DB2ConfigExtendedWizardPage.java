 ...
 *
 */
public class DB2ConfigExtendedWizardPage extends AbstractConnectDBWizardWizardPage {
    ...
    public IConnectionProfile getConnectionProfile(final String className,
        ...
        return ConnectionProfileUtil.createDB2ConnectionProfile(jdbcUrl, username, password, className, parseDatabaseFromURL(jdbcUrl));
	}
