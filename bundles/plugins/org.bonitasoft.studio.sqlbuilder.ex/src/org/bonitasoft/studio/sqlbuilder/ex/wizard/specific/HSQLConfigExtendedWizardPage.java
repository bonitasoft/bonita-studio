 ...
 *
 */
public class HSQLConfigExtendedWizardPage extends AbstractConnectDBWizardWizardPage {
    ...
    public IConnectionProfile getConnectionProfile(final String className, final String jdbcUrl, final String username, final String password)
        ...
        return ConnectionProfileUtil.createHSQLConnectionProfile(jdbcUrl, username, password, className, parseDatabaseFromURL(jdbcUrl));
	}
