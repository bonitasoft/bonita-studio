...
import org.bonitasoft.studio.model.process.diagram.edit.policies.CatchLinkEvent2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class CatchLinkEvent2EditPart extends AbstractBorderedShapeEditPart {
	...
	* @generated
	*/
	public CatchLinkEvent2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new CatchLinkEvent2ItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new LinkCatchEventFigure();
	}

	/**
	* @generated
	*/
	public LinkCatchEventFigure getPrimaryShape() {
		return (LinkCatchEventFigure) primaryShape;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(CatchLinkEventLabel2EditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class LinkCatchEventFigure extends SVGFigure {

		/**
		 * @generated
		 */
		public LinkCatchEventFigure() {
			...
			this.setURI("platform:/plugin/org.bonitasoft.studio.pics/icons/figures/CatchLinkEvent.svgz");
