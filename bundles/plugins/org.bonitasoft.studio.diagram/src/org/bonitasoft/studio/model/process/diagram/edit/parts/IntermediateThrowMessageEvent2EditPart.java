...
import org.bonitasoft.studio.model.process.diagram.edit.policies.IntermediateThrowMessageEvent2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class IntermediateThrowMessageEvent2EditPart extends AbstractBorderedShapeEditPart {
	...
	* @generated
	*/
	public IntermediateThrowMessageEvent2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new IntermediateThrowMessageEvent2ItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new MessageIntermediateThrowEventFigure();
	}

	/**
	* @generated
	*/
	public MessageIntermediateThrowEventFigure getPrimaryShape() {
		return (MessageIntermediateThrowEventFigure) primaryShape;
	}
	...
	*/
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof IntermediateThrowMessageEventLabel2EditPart) {
	...
	*/
	protected NodeFigure createNodePlate() {
		DefaultSizeNodeFigure result = new DefaultSizeNodeFigure(30, 34);
		return result;
	}
	...
	*/
	 ...
	 * @generated
	 */
	public class MessageIntermediateThrowEventFigure extends SVGFigure {

		/**
		 * @generated
		 */
		public MessageIntermediateThrowEventFigure() {
			...
			this.setURI("platform:/plugin/org.bonitasoft.studio.pics/icons/figures/IntermediateThrowMessageEvent.svgz");
