 ...
 * @generated
 */
public class ProcessModelingAssistantProviderOfTextAnnotation2EditPart extends ProcessModelingAssistantProvider {
	...
	*/
	...
	public List<IElementType> getRelTypesOnSource(IAdaptable source) {
		...
		return doGetRelTypesOnSource((TextAnnotation2EditPart) sourceEditPart);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetRelTypesOnSource(TextAnnotation2EditPart source) {
	...
	*/
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source, IAdaptable target) {
		...
		return doGetRelTypesOnSourceAndTarget((TextAnnotation2EditPart) sourceEditPart, targetEditPart);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetRelTypesOnSourceAndTarget(TextAnnotation2EditPart source,
		...
		if (targetEditPart instanceof SubProcessEventEditPart) {
			types.add(ProcessElementTypes.TextAnnotationAttachment_4003);
		}
		...
		if (targetEditPart instanceof IntermediateErrorCatchEvent2EditPart) {
			types.add(ProcessElementTypes.TextAnnotationAttachment_4003);
		}
		if (targetEditPart instanceof BoundaryMessageEventEditPart) {
			types.add(ProcessElementTypes.TextAnnotationAttachment_4003);
		}
		if (targetEditPart instanceof NonInterruptingBoundaryTimerEventEditPart) {
			types.add(ProcessElementTypes.TextAnnotationAttachment_4003);
		}
		if (targetEditPart instanceof BoundaryTimerEventEditPart) {
			types.add(ProcessElementTypes.TextAnnotationAttachment_4003);
		}
		if (targetEditPart instanceof BoundarySignalEventEditPart) {
			types.add(ProcessElementTypes.TextAnnotationAttachment_4003);
		}
		if (targetEditPart instanceof IntermediateErrorCatchEventEditPart) {
			types.add(ProcessElementTypes.TextAnnotationAttachment_4003);
		}
		if (targetEditPart instanceof BoundaryMessageEvent2EditPart) {
			types.add(ProcessElementTypes.TextAnnotationAttachment_4003);
		}
		if (targetEditPart instanceof NonInterruptingBoundaryTimerEvent2EditPart) {
			types.add(ProcessElementTypes.TextAnnotationAttachment_4003);
		}
		if (targetEditPart instanceof BoundaryTimerEvent2EditPart) {
			types.add(ProcessElementTypes.TextAnnotationAttachment_4003);
		}
		if (targetEditPart instanceof BoundarySignalEvent2EditPart) {
			types.add(ProcessElementTypes.TextAnnotationAttachment_4003);
		}
		...
		if (targetEditPart instanceof IntermediateErrorCatchEvent3EditPart) {
			types.add(ProcessElementTypes.TextAnnotationAttachment_4003);
		}
		...
		if (targetEditPart instanceof IntermediateErrorCatchEvent4EditPart) {
			types.add(ProcessElementTypes.TextAnnotationAttachment_4003);
		}
		if (targetEditPart instanceof ScriptTask2EditPart) {
			types.add(ProcessElementTypes.TextAnnotationAttachment_4003);
		}
		if (targetEditPart instanceof IntermediateErrorCatchEvent5EditPart) {
			types.add(ProcessElementTypes.TextAnnotationAttachment_4003);
		}
		...
		if (targetEditPart instanceof IntermediateErrorCatchEvent6EditPart) {
			types.add(ProcessElementTypes.TextAnnotationAttachment_4003);
		}
		...
		if (targetEditPart instanceof SubProcessEvent2EditPart) {
			types.add(ProcessElementTypes.TextAnnotationAttachment_4003);
		}
	...
	*/
	...
	public List<IElementType> getTypesForTarget(IAdaptable source, IElementType relationshipType) {
		IGraphicalEditPart sourceEditPart = (IGraphicalEditPart) source.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForTarget((TextAnnotation2EditPart) sourceEditPart, relationshipType);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetTypesForTarget(TextAnnotation2EditPart source, IElementType relationshipType) {
		...
		if (relationshipType == ProcessElementTypes.TextAnnotationAttachment_4003) {
			...
			types.add(ProcessElementTypes.Lane_3007);
	...
	*/
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target.getAdapter(IGraphicalEditPart.class);
		return doGetRelTypesOnTarget((TextAnnotation2EditPart) targetEditPart);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetRelTypesOnTarget(TextAnnotation2EditPart target) {
		List<IElementType> types = new ArrayList<IElementType>(1);
		types.add(ProcessElementTypes.TextAnnotationAttachment_4003);
		return types;
	}
	...
	*/
	...
	public List<IElementType> getTypesForSource(IAdaptable target, IElementType relationshipType) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForSource((TextAnnotation2EditPart) targetEditPart, relationshipType);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetTypesForSource(TextAnnotation2EditPart target, IElementType relationshipType) {
		List<IElementType> types = new ArrayList<IElementType>();
		if (relationshipType == ProcessElementTypes.TextAnnotationAttachment_4003) {
			types.add(ProcessElementTypes.TextAnnotation_2015);
			types.add(ProcessElementTypes.TextAnnotation_3015);
