...
import org.bonitasoft.studio.model.process.diagram.edit.policies.ServiceTaskCanonicalEditPolicy;
import org.bonitasoft.studio.model.process.diagram.edit.policies.ServiceTaskItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ServiceTaskEditPart extends AbstractBorderedShapeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new ServiceTaskCanonicalEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ServiceTaskLabelEditPart) {
			((ServiceTaskLabelEditPart) childEditPart).setLabel(getPrimaryShape().getFigureActivityNameFigure());
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof IntermediateErrorCatchEvent4EditPart) {
			getBorderedFigure().getBorderItemContainer()
					.remove(((IntermediateErrorCatchEvent4EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(ServiceTaskLabelEditPart.VISUAL_ID));
	}
