 ...
 * @generated
 */
public class IntermediateErrorCatchEventCreateCommand extends EditElementCommand {

	/**
	* @generated
	*/
	public IntermediateErrorCatchEventCreateCommand(CreateElementRequest req) {
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		ElementInitializers.getInstance().init_IntermediateErrorCatchEvent_3030(newElement);
