...
import org.bonitasoft.studio.model.process.diagram.edit.policies.StartSignalEvent2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class StartSignalEvent2EditPart extends AbstractBorderedShapeEditPart {
	...
	* @generated
	*/
	public StartSignalEvent2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new StartSignalEvent2ItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new SignalStartEventFigure();
	}

	/**
	* @generated
	*/
	public SignalStartEventFigure getPrimaryShape() {
		return (SignalStartEventFigure) primaryShape;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(StartSignalEventLabel2EditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class SignalStartEventFigure extends SVGFigure {

		/**
		 * @generated
		 */
		public SignalStartEventFigure() {
			...
			this.setURI("platform:/plugin/org.bonitasoft.studio.pics/icons/figures/StartSignalEvent.svgz");
