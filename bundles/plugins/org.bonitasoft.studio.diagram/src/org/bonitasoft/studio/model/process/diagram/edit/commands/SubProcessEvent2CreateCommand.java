 ...
 * @generated
 */
public class SubProcessEvent2CreateCommand extends EditElementCommand {

	/**
	* @generated
	*/
	public SubProcessEvent2CreateCommand(CreateElementRequest req) {
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		SubProcessEvent newElement = ProcessFactory.eINSTANCE.createSubProcessEvent();

		Container owner = (Container) getElementToEdit();
		owner.getElements().add(newElement);

		ElementInitializers.getInstance().init_SubProcessEvent_3058(newElement);
