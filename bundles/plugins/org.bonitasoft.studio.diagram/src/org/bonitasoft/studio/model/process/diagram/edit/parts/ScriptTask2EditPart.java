...
import org.bonitasoft.studio.model.process.diagram.edit.policies.ScriptTask2CanonicalEditPolicy;
import org.bonitasoft.studio.model.process.diagram.edit.policies.ScriptTask2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ScriptTask2EditPart extends AbstractBorderedShapeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ScriptTask2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new ScriptTask2CanonicalEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ScriptTaskLabel2EditPart) {
			((ScriptTaskLabel2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureActivityNameFigure());
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof IntermediateErrorCatchEvent5EditPart) {
			getBorderedFigure().getBorderItemContainer()
					.remove(((IntermediateErrorCatchEvent5EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(ScriptTaskLabel2EditPart.VISUAL_ID));
	}
