 ...
 * @generated
 */
public class IntermediateCatchMessageEvent2CreateCommand extends EditElementCommand {

	/**
	* @generated
	*/
	public IntermediateCatchMessageEvent2CreateCommand(CreateElementRequest req) {
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		ElementInitializers.getInstance().init_IntermediateCatchMessageEvent_3013(newElement);
