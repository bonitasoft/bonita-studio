...
import org.bonitasoft.studio.model.process.diagram.edit.policies.EndMessageEvent2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EndMessageEvent2EditPart extends AbstractBorderedShapeEditPart {
	...
	* @generated
	*/
	public EndMessageEvent2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new EndMessageEvent2ItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new MessageEndEventFigure();
	}

	/**
	* @generated
	*/
	public MessageEndEventFigure getPrimaryShape() {
		return (MessageEndEventFigure) primaryShape;
	}
	...
	*/
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof EndMessageEventLabel2EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(EndMessageEventLabel2EditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class MessageEndEventFigure extends SVGFigure {

		/**
		 * @generated
		 */
		public MessageEndEventFigure() {
			...
			this.setURI("platform:/plugin/org.bonitasoft.studio.pics/icons/figures/EndMessageEvent.svgz");
