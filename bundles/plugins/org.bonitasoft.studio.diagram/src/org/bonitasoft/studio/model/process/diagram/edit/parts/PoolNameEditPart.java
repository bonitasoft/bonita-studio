...
public class PoolNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ProcessParserProvider.getParser(ProcessElementTypes.Pool_2007, getParserElement(),
					ProcessVisualIDRegistry.getType(
							org.bonitasoft.studio.model.process.diagram.edit.parts.PoolNameEditPart.VISUAL_ID));
		}
		return parser;
	}
