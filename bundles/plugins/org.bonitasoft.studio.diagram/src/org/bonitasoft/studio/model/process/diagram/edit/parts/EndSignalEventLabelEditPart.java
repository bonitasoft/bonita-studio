 ...
 * @generated
 */
public class EndSignalEventLabelEditPart extends CustomEventLabelEditPart
	...
	static {
		registerSnapBackPosition(
				ProcessVisualIDRegistry.getType(
						org.bonitasoft.studio.model.process.diagram.edit.parts.EndSignalEventLabelEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public EndSignalEventLabelEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ProcessParserProvider.getParser(ProcessElementTypes.EndSignalEvent_2023, getParserElement(),
					ProcessVisualIDRegistry.getType(
							org.bonitasoft.studio.model.process.diagram.edit.parts.EndSignalEventLabelEditPart.VISUAL_ID));
		}
		return parser;
