 ...
 * @generated
 */
public class IntermediateErrorCatchEvent3CreateCommand extends EditElementCommand {

	/**
	* @generated
	*/
	public IntermediateErrorCatchEvent3CreateCommand(CreateElementRequest req) {
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		ElementInitializers.getInstance().init_IntermediateErrorCatchEvent_3031(newElement);
