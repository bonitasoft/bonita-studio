 ...
 * @generated
 */
public class MessageFlowLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				ProcessVisualIDRegistry.getType(
						org.bonitasoft.studio.model.process.diagram.edit.parts.MessageFlowLabelEditPart.VISUAL_ID),
				new Point(0, -10));
	}
	...
	* @generated
	*/
	public MessageFlowLabelEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ProcessParserProvider.getParser(ProcessElementTypes.MessageFlow_4002, getParserElement(),
					ProcessVisualIDRegistry.getType(
							org.bonitasoft.studio.model.process.diagram.edit.parts.MessageFlowLabelEditPart.VISUAL_ID));
		}
		return parser;
