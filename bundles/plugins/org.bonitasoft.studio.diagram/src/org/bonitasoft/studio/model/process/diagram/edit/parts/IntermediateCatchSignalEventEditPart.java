...
import org.bonitasoft.studio.model.process.diagram.edit.policies.IntermediateCatchSignalEventItemSemanticEditPolicy;
 ...
 * @generated
 */
public class IntermediateCatchSignalEventEditPart extends AbstractBorderedShapeEditPart {
	...
	* @generated
	*/
	public IntermediateCatchSignalEventEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new IntermediateCatchSignalEventItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new SignalCatchEventFigure();
	}

	/**
	* @generated
	*/
	public SignalCatchEventFigure getPrimaryShape() {
		return (SignalCatchEventFigure) primaryShape;
	}
	...
	*/
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof IntermediateCatchSignalEventLabelEditPart) {
	...
	*/
	 ...
	 * @generated
	 */
	public class SignalCatchEventFigure extends SVGFigure {

		/**
		 * @generated
		 */
		public SignalCatchEventFigure() {
			...
			this.setURI("platform:/plugin/org.bonitasoft.studio.pics/icons/figures/CatchSignalEvent.svgz");
