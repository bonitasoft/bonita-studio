 ...
 * @generated
 */
public class CatchLinkEventCreateCommand extends EditElementCommand {

	/**
	* @generated
	*/
	public CatchLinkEventCreateCommand(CreateElementRequest req) {
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		ElementInitializers.getInstance().init_CatchLinkEvent_2018(newElement);
