...
import org.bonitasoft.studio.model.process.diagram.edit.policies.Task2CanonicalEditPolicy;
import org.bonitasoft.studio.model.process.diagram.edit.policies.Task2ItemSemanticEditPolicy;
...
public class Task2EditPart extends AbstractBorderedShapeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Task2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new Task2CanonicalEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TaskName2EditPart) {
			((TaskName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureActivityNameFigure());
		...
		if (childEditPart instanceof IntermediateErrorCatchEvent2EditPart) {
			BorderItemLocator locator = new ActivityBorderItemLocator(getMainFigure(), PositionConstants.SOUTH);
			getBorderedFigure().getBorderItemContainer()
					.add(((IntermediateErrorCatchEvent2EditPart) childEditPart).getFigure(), locator);
			return true;
		}
		if (childEditPart instanceof BoundaryMessageEventEditPart) {
			BorderItemLocator locator = new ActivityBorderItemLocator(getMainFigure(), PositionConstants.SOUTH);
			getBorderedFigure().getBorderItemContainer().add(((BoundaryMessageEventEditPart) childEditPart).getFigure(),
					locator);
			return true;
		}
		if (childEditPart instanceof NonInterruptingBoundaryTimerEventEditPart) {
			BorderItemLocator locator = new ActivityBorderItemLocator(getMainFigure(), PositionConstants.SOUTH);
			getBorderedFigure().getBorderItemContainer()
					.add(((NonInterruptingBoundaryTimerEventEditPart) childEditPart).getFigure(), locator);
			return true;
		}
		if (childEditPart instanceof BoundaryTimerEventEditPart) {
			BorderItemLocator locator = new ActivityBorderItemLocator(getMainFigure(), PositionConstants.SOUTH);
			getBorderedFigure().getBorderItemContainer().add(((BoundaryTimerEventEditPart) childEditPart).getFigure(),
					locator);
			return true;
		}
		if (childEditPart instanceof BoundarySignalEventEditPart) {
			BorderItemLocator locator = new ActivityBorderItemLocator(getMainFigure(), PositionConstants.SOUTH);
			getBorderedFigure().getBorderItemContainer().add(((BoundarySignalEventEditPart) childEditPart).getFigure(),
					locator);
			return true;
		}
		return false;
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof IntermediateErrorCatchEvent2EditPart) {
			getBorderedFigure().getBorderItemContainer()
					.remove(((IntermediateErrorCatchEvent2EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof BoundaryMessageEventEditPart) {
			getBorderedFigure().getBorderItemContainer()
					.remove(((BoundaryMessageEventEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof NonInterruptingBoundaryTimerEventEditPart) {
			getBorderedFigure().getBorderItemContainer()
					.remove(((NonInterruptingBoundaryTimerEventEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof BoundaryTimerEventEditPart) {
			getBorderedFigure().getBorderItemContainer()
					.remove(((BoundaryTimerEventEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof BoundarySignalEventEditPart) {
			getBorderedFigure().getBorderItemContainer()
					.remove(((BoundarySignalEventEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(TaskName2EditPart.VISUAL_ID));
	}
