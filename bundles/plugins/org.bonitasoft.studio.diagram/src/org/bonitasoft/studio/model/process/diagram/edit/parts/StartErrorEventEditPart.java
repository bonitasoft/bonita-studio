...
import org.bonitasoft.studio.model.process.diagram.edit.policies.StartErrorEventItemSemanticEditPolicy;
 ...
 * @generated
 */
public class StartErrorEventEditPart extends AbstractBorderedShapeEditPart {
	...
	* @generated
	*/
	public StartErrorEventEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new StartErrorEventItemSemanticEditPolicy());
	...
	*/
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof StartErrorEventLabelEditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(StartErrorEventLabelEditPart.VISUAL_ID));
	}
