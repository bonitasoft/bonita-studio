...
import org.bonitasoft.studio.model.process.diagram.edit.policies.CallActivity2CanonicalEditPolicy;
import org.bonitasoft.studio.model.process.diagram.edit.policies.CallActivity2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class CallActivity2EditPart extends AbstractBorderedShapeEditPart {
	...
	* @generated
	*/
	public CallActivity2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new CallActivity2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new CallActivity2CanonicalEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new CallActivityFigure();
	}

	/**
	* @generated
	*/
	public CallActivityFigure getPrimaryShape() {
		return (CallActivityFigure) primaryShape;
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CallActivityName2EditPart) {
			((CallActivityName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureActivityNameFigure());
		...
		if (childEditPart instanceof IntermediateErrorCatchEventEditPart) {
			BorderItemLocator locator = new ActivityBorderItemLocator(getMainFigure(), PositionConstants.SOUTH);
			getBorderedFigure().getBorderItemContainer()
					.add(((IntermediateErrorCatchEventEditPart) childEditPart).getFigure(), locator);
			return true;
		}
		if (childEditPart instanceof BoundaryMessageEvent2EditPart) {
			BorderItemLocator locator = new ActivityBorderItemLocator(getMainFigure(), PositionConstants.SOUTH);
			getBorderedFigure().getBorderItemContainer()
					.add(((BoundaryMessageEvent2EditPart) childEditPart).getFigure(), locator);
			return true;
		}
		if (childEditPart instanceof NonInterruptingBoundaryTimerEvent2EditPart) {
			BorderItemLocator locator = new ActivityBorderItemLocator(getMainFigure(), PositionConstants.SOUTH);
			getBorderedFigure().getBorderItemContainer()
					.add(((NonInterruptingBoundaryTimerEvent2EditPart) childEditPart).getFigure(), locator);
			return true;
		}
		if (childEditPart instanceof BoundaryTimerEvent2EditPart) {
			BorderItemLocator locator = new ActivityBorderItemLocator(getMainFigure(), PositionConstants.SOUTH);
			getBorderedFigure().getBorderItemContainer().add(((BoundaryTimerEvent2EditPart) childEditPart).getFigure(),
					locator);
			return true;
		}
		if (childEditPart instanceof BoundarySignalEvent2EditPart) {
			BorderItemLocator locator = new ActivityBorderItemLocator(getMainFigure(), PositionConstants.SOUTH);
			getBorderedFigure().getBorderItemContainer().add(((BoundarySignalEvent2EditPart) childEditPart).getFigure(),
					locator);
			return true;
		}
		return false;
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof IntermediateErrorCatchEventEditPart) {
			getBorderedFigure().getBorderItemContainer()
					.remove(((IntermediateErrorCatchEventEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof BoundaryMessageEvent2EditPart) {
			getBorderedFigure().getBorderItemContainer()
					.remove(((BoundaryMessageEvent2EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof NonInterruptingBoundaryTimerEvent2EditPart) {
			getBorderedFigure().getBorderItemContainer()
					.remove(((NonInterruptingBoundaryTimerEvent2EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof BoundaryTimerEvent2EditPart) {
			getBorderedFigure().getBorderItemContainer()
					.remove(((BoundaryTimerEvent2EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof BoundarySignalEvent2EditPart) {
			getBorderedFigure().getBorderItemContainer()
					.remove(((BoundarySignalEvent2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(CallActivityName2EditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class CallActivityFigure extends CustomSVGFigure {
		...
		public CallActivityFigure() {
			...
			this.setURI("platform:/plugin/org.bonitasoft.studio.pics/icons/figures/SubProcess.svgz");
			createContents();
		}
