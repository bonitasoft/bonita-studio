...
import org.bonitasoft.studio.model.process.diagram.edit.policies.StartErrorEvent2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class StartErrorEvent2EditPart extends AbstractBorderedShapeEditPart {
	...
	* @generated
	*/
	public StartErrorEvent2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new StartErrorEvent2ItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new StartErrorEventFigure();
	}

	/**
	* @generated
	*/
	public StartErrorEventFigure getPrimaryShape() {
		return (StartErrorEventFigure) primaryShape;
	}
	...
	*/
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof StartErrorEventLabel2EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(StartErrorEventLabel2EditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class StartErrorEventFigure extends SVGFigure {

		/**
		 * @generated
		 */
		public StartErrorEventFigure() {
			...
			this.setURI("platform:/plugin/org.bonitasoft.studio.pics/icons/figures/StartErrorEvent.svgz");
