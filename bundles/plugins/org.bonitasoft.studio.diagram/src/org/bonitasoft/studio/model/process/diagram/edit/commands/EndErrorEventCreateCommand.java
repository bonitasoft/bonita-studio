 ...
 * @generated
 */
public class EndErrorEventCreateCommand extends EditElementCommand {

	/**
	* @generated
	*/
	public EndErrorEventCreateCommand(CreateElementRequest req) {
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		ElementInitializers.getInstance().init_EndErrorEvent_2029(newElement);
