 ...
 * @generated
 */
public class NonInterruptingBoundaryTimerEventNameEditPart extends CustomEventLabelEditPart
	...
	*/
	static {
		registerSnapBackPosition(ProcessVisualIDRegistry.getType(
				org.bonitasoft.studio.model.process.diagram.edit.parts.NonInterruptingBoundaryTimerEventNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public NonInterruptingBoundaryTimerEventNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ProcessParserProvider.getParser(ProcessElementTypes.NonInterruptingBoundaryTimerEvent_3064,
