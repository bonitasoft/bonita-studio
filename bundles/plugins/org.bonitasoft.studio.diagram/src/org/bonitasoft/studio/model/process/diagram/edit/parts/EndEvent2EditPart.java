...
import org.bonitasoft.studio.model.process.diagram.edit.policies.EndEvent2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EndEvent2EditPart extends AbstractBorderedShapeEditPart {
	...
	* @generated
	*/
	public EndEvent2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new EndEvent2ItemSemanticEditPolicy());
	...
	*/
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof EndEventLabel2EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(EndEventLabel2EditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class EndEventFigure extends SVGFigure {
		...
		public EndEventFigure() {
			...
			this.setURI("platform:/plugin/org.bonitasoft.studio.pics/icons/figures/EndEvent.svgz");
