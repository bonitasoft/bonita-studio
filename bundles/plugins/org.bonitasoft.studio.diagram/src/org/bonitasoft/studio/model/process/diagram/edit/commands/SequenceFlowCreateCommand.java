 ...
 * @generated
 */
public class SequenceFlowCreateCommand extends EditElementCommand {
	...
	*/
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof SourceElement) {
			return false;
		}
		if (target != null && false == target instanceof TargetElement) {
			return false;
		}
		if (getSource() == null) {
		...
		return ProcessBaseItemSemanticEditPolicy.getLinkConstraints().canCreateSequenceFlow_4001(getContainer(),
				getSource(), getTarget());
	}
	...
	* @generated
	*/
	protected SourceElement getSource() {
	...
	* @generated
	*/
	protected TargetElement getTarget() {
	...
	* @generated
	*/
	public AbstractProcess getContainer() {
		return container;
	}
	...
	* @generated
	*/
	private static AbstractProcess deduceContainer(EObject source, EObject target) {
		// Find container element for the new link.
		// Climb up by containment hierarchy starting from the source
		// and return the first element that is instance of the container class.
		for (EObject element = source; element != null; element = element.eContainer()) {
			if (element instanceof AbstractProcess) {
				return (AbstractProcess) element;
			}
		}
		return null;
	}
