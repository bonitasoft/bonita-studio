...
import org.bonitasoft.studio.model.process.diagram.edit.policies.ReceiveTask2CanonicalEditPolicy;
import org.bonitasoft.studio.model.process.diagram.edit.policies.ReceiveTask2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ReceiveTask2EditPart extends AbstractBorderedShapeEditPart {
	...
	* @generated
	*/
	public ReceiveTask2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ReceiveTask2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new ReceiveTask2CanonicalEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ReceiveTaskLabel2EditPart) {
			((ReceiveTaskLabel2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureActivityNameFigure());
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(ReceiveTaskLabel2EditPart.VISUAL_ID));
	}
