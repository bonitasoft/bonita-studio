...
import org.bonitasoft.studio.model.process.diagram.edit.policies.BoundaryMessageEvent2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class BoundaryMessageEvent2EditPart extends BorderedBorderItemEditPart {
	...
	* @generated
	*/
	public BoundaryMessageEvent2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new BoundaryMessageEvent2ItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new BoundaryMessageEventFigure();
	}

	/**
	* @generated
	*/
	public BoundaryMessageEventFigure getPrimaryShape() {
		return (BoundaryMessageEventFigure) primaryShape;
	}
	...
	*/
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof BoundaryMessageEventLabel2EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(BoundaryMessageEventLabel2EditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class BoundaryMessageEventFigure extends SVGFigure {

		/**
		 * @generated
		 */
		public BoundaryMessageEventFigure() {
			...
			this.setURI("platform:/plugin/org.bonitasoft.studio.pics/icons/figures/BoundaryMessageEvent.svgz");
