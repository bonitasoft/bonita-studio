...
import org.bonitasoft.studio.model.process.diagram.edit.policies.EndMessageEventItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EndMessageEventEditPart extends AbstractBorderedShapeEditPart {
	...
	* @generated
	*/
	public EndMessageEventEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new EndMessageEventItemSemanticEditPolicy());
	...
	*/
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof EndMessageEventLabelEditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(EndMessageEventLabelEditPart.VISUAL_ID));
	}
