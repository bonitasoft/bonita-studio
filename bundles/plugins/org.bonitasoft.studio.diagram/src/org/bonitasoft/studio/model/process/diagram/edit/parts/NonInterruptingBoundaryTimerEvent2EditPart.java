...
import org.bonitasoft.studio.model.process.diagram.edit.policies.NonInterruptingBoundaryTimerEvent2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class NonInterruptingBoundaryTimerEvent2EditPart extends BorderedBorderItemEditPart {
	...
	* @generated
	*/
	public NonInterruptingBoundaryTimerEvent2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new NonInterruptingBoundaryTimerEvent2ItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new NonInterruptingBoundaryTimerEventFigure();
	}

	/**
	* @generated
	*/
	public NonInterruptingBoundaryTimerEventFigure getPrimaryShape() {
		return (NonInterruptingBoundaryTimerEventFigure) primaryShape;
	}
	...
	*/
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof NonInterruptingBoundaryTimerEventName2EditPart) {
	...
	*/
	 ...
	 * @generated
	 */
	public class NonInterruptingBoundaryTimerEventFigure extends SVGFigure {

		/**
		 * @generated
		 */
		public NonInterruptingBoundaryTimerEventFigure() {
			...
			this.setURI(
					"platform:/plugin/org.bonitasoft.studio.pics/icons/figures/NonInterruptingBoundaryTimerEvent.svgz");
