 ...
 * @generated
 */
public class StartErrorEvent2CreateCommand extends EditElementCommand {

	/**
	* @generated
	*/
	public StartErrorEvent2CreateCommand(CreateElementRequest req) {
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		ElementInitializers.getInstance().init_StartErrorEvent_3060(newElement);
