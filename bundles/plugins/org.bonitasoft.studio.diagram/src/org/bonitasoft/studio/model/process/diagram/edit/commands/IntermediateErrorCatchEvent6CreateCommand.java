 ...
 * @generated
 */
public class IntermediateErrorCatchEvent6CreateCommand extends EditElementCommand {

	/**
	* @generated
	*/
	public IntermediateErrorCatchEvent6CreateCommand(CreateElementRequest req) {
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		ElementInitializers.getInstance().init_IntermediateErrorCatchEvent_3034(newElement);
