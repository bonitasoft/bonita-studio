 ...
 * @generated
 */
public class StartMessageEvent2CreateCommand extends EditElementCommand {

	/**
	* @generated
	*/
	public StartMessageEvent2CreateCommand(CreateElementRequest req) {
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		ElementInitializers.getInstance().init_StartMessageEvent_3012(newElement);
