...
import org.bonitasoft.studio.model.process.diagram.edit.policies.LaneLaneCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class LaneLaneCompartmentEditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public LaneLaneCompartmentEditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.LaneLaneCompartmentEditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new LaneLaneCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(ProcessVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new LaneLaneCompartmentCanonicalEditPolicy());
	}
