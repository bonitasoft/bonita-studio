...
import org.bonitasoft.studio.model.process.diagram.edit.policies.SendTaskItemSemanticEditPolicy;
 ...
 * @generated
 */
public class SendTaskEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public SendTaskEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new SendTaskItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SendTaskLabelEditPart) {
			((SendTaskLabelEditPart) childEditPart).setLabel(getPrimaryShape().getFigureActivityNameFigure());
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(SendTaskLabelEditPart.VISUAL_ID));
	}
