 ...
 * @generated
 */
public class ServiceTask2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<ProcessNodeDescriptor> childDescriptors = ProcessDiagramUpdater
				.getServiceTask_3027SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return IntermediateErrorCatchEvent4EditPart.VISUAL_ID == ProcessVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<ProcessNodeDescriptor> childDescriptors = ProcessDiagramUpdater
				.getServiceTask_3027SemanticChildren((View) getHost().getModel());
