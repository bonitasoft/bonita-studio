 ...
 * @generated
 */
public class EndEventLabelEditPart extends CustomEventLabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	static {
		registerSnapBackPosition(
				ProcessVisualIDRegistry.getType(
						org.bonitasoft.studio.model.process.diagram.edit.parts.EndEventLabelEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public EndEventLabelEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ProcessParserProvider.getParser(ProcessElementTypes.EndEvent_2003, getParserElement(),
					ProcessVisualIDRegistry.getType(
							org.bonitasoft.studio.model.process.diagram.edit.parts.EndEventLabelEditPart.VISUAL_ID));
		}
		return parser;
