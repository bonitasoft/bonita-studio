 ...
 * @generated
 */
public class SubProcessEventLabel2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public SubProcessEventLabel2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ProcessParserProvider.getParser(ProcessElementTypes.SubProcessEvent_3058, getParserElement(),
					ProcessVisualIDRegistry.getType(
							org.bonitasoft.studio.model.process.diagram.edit.parts.SubProcessEventLabel2EditPart.VISUAL_ID));
		}
		return parser;
	}
