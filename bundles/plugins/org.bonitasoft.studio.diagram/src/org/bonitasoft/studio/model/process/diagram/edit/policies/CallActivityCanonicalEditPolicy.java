 ...
 * @generated
 */
public class CallActivityCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<ProcessNodeDescriptor> childDescriptors = ProcessDiagramUpdater
				.getCallActivity_2036SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<ProcessNodeDescriptor> childDescriptors = ProcessDiagramUpdater
				.getCallActivity_2036SemanticChildren((View) getHost().getModel());
