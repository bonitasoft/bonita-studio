...
import org.bonitasoft.studio.model.process.diagram.edit.policies.ThrowLinkEventItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ThrowLinkEventEditPart extends AbstractBorderedShapeEditPart {
	...
	* @generated
	*/
	public ThrowLinkEventEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ThrowLinkEventItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new LinkThrowEventFigure();
	}

	/**
	* @generated
	*/
	public LinkThrowEventFigure getPrimaryShape() {
		return (LinkThrowEventFigure) primaryShape;
	}
	...
	*/
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof ThrowLinkEventLabelEditPart) {
	...
	*/
	protected NodeFigure createNodePlate() {
		DefaultSizeNodeFigure result = new DefaultSizeNodeFigure(34, 34);
		return result;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(ThrowLinkEventLabelEditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class LinkThrowEventFigure extends SVGFigure {

		/**
		 * @generated
		 */
		public LinkThrowEventFigure() {
			...
			this.setURI("platform:/plugin/org.bonitasoft.studio.pics/icons/figures/ThrowLinkEvent.svgz");
