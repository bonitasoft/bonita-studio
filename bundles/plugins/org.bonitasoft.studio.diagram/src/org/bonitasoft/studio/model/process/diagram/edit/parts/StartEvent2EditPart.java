...
import org.bonitasoft.studio.model.process.diagram.edit.policies.StartEvent2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class StartEvent2EditPart extends AbstractBorderedShapeEditPart {
	...
	* @generated
	*/
	public StartEvent2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new StartEvent2ItemSemanticEditPolicy());
	...
	*/
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof StartEventLabel2EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(StartEventLabel2EditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class StartEventFigure extends SVGFigure {
		...
		public StartEventFigure() {
			...
			this.setURI("platform:/plugin/org.bonitasoft.studio.pics/icons/figures/StartEvent.svgz");
