 ...
 * @generated
 */
public class SubProcessEventSubProcessCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<ProcessNodeDescriptor> childDescriptors = ProcessDiagramUpdater
				.getSubProcessEventEventSubProcessCompartment_7005SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<ProcessNodeDescriptor> childDescriptors = ProcessDiagramUpdater
				.getSubProcessEventEventSubProcessCompartment_7005SemanticChildren((View) getHost().getModel());
