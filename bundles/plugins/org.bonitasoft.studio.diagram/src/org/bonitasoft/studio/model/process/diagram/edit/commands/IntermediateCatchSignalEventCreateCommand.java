 ...
 * @generated
 */
public class IntermediateCatchSignalEventCreateCommand extends EditElementCommand {

	/**
	* @generated
	*/
	public IntermediateCatchSignalEventCreateCommand(CreateElementRequest req) {
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		ElementInitializers.getInstance().init_IntermediateCatchSignalEvent_2021(newElement);
