 ...
 * @generated
 */
public class IntermediateCatchSignalEvent2CreateCommand extends EditElementCommand {

	/**
	* @generated
	*/
	public IntermediateCatchSignalEvent2CreateCommand(CreateElementRequest req) {
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		IntermediateCatchSignalEvent newElement = ProcessFactory.eINSTANCE.createIntermediateCatchSignalEvent();

		Container owner = (Container) getElementToEdit();
		owner.getElements().add(newElement);

		ElementInitializers.getInstance().init_IntermediateCatchSignalEvent_3021(newElement);
