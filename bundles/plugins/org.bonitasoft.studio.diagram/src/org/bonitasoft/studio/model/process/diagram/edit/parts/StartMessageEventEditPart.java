...
import org.bonitasoft.studio.model.process.diagram.edit.policies.StartMessageEventItemSemanticEditPolicy;
 ...
 * @generated
 */
public class StartMessageEventEditPart extends AbstractBorderedShapeEditPart {
	...
	* @generated
	*/
	public StartMessageEventEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new StartMessageEventItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new MessageStartEventFigure();
	}

	/**
	* @generated
	*/
	public MessageStartEventFigure getPrimaryShape() {
		return (MessageStartEventFigure) primaryShape;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(StartMessageEventLabelEditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class MessageStartEventFigure extends SVGFigure {

		/**
		 * @generated
		 */
		public MessageStartEventFigure() {
			...
			this.setURI("platform:/plugin/org.bonitasoft.studio.pics/icons/figures/StartMessageEvent.svgz");
