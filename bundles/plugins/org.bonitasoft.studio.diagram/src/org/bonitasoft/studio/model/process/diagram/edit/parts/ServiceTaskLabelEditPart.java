 ...
 * @generated
 */
public class ServiceTaskLabelEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ServiceTaskLabelEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ProcessParserProvider.getParser(ProcessElementTypes.ServiceTask_2027, getParserElement(),
					ProcessVisualIDRegistry.getType(
							org.bonitasoft.studio.model.process.diagram.edit.parts.ServiceTaskLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
