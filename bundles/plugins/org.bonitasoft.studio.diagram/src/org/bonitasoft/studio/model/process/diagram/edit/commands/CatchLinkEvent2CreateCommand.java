 ...
 * @generated
 */
public class CatchLinkEvent2CreateCommand extends EditElementCommand {

	/**
	* @generated
	*/
	public CatchLinkEvent2CreateCommand(CreateElementRequest req) {
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		CatchLinkEvent newElement = ProcessFactory.eINSTANCE.createCatchLinkEvent();

		Container owner = (Container) getElementToEdit();
		owner.getElements().add(newElement);

		ElementInitializers.getInstance().init_CatchLinkEvent_3019(newElement);
