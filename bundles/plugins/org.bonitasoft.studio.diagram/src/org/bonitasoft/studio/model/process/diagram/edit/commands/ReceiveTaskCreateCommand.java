 ...
 * @generated
 */
public class ReceiveTaskCreateCommand extends EditElementCommand {

	/**
	* @generated
	*/
	public ReceiveTaskCreateCommand(CreateElementRequest req) {
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		ReceiveTask newElement = ProcessFactory.eINSTANCE.createReceiveTask();

		Container owner = (Container) getElementToEdit();
		owner.getElements().add(newElement);

		ElementInitializers.getInstance().init_ReceiveTask_2025(newElement);
