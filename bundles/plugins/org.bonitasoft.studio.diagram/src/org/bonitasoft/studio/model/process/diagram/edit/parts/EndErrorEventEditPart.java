...
import org.bonitasoft.studio.model.process.diagram.edit.policies.EndErrorEventItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EndErrorEventEditPart extends AbstractBorderedShapeEditPart {
	...
	* @generated
	*/
	public EndErrorEventEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new EndErrorEventItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new EndErrorEventFigure();
	}

	/**
	* @generated
	*/
	public EndErrorEventFigure getPrimaryShape() {
		return (EndErrorEventFigure) primaryShape;
	}
	...
	*/
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof EndErrorEventLabelEditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(EndErrorEventLabelEditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class EndErrorEventFigure extends SVGFigure {

		/**
		 * @generated
		 */
		public EndErrorEventFigure() {
			...
			this.setURI("platform:/plugin/org.bonitasoft.studio.pics/icons/figures/EndErrorEvent.svgz");
