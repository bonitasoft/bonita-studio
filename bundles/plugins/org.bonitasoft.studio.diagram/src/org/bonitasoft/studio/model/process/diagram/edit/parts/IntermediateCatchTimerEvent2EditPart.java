...
import org.bonitasoft.studio.model.process.diagram.edit.policies.IntermediateCatchTimerEvent2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class IntermediateCatchTimerEvent2EditPart extends AbstractBorderedShapeEditPart {
	...
	* @generated
	*/
	public IntermediateCatchTimerEvent2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new IntermediateCatchTimerEvent2ItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new TimerIntermediateCatchEventFigure();
	}

	/**
	* @generated
	*/
	public TimerIntermediateCatchEventFigure getPrimaryShape() {
		return (TimerIntermediateCatchEventFigure) primaryShape;
	}
	...
	*/
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof IntermediateCatchTimerEventLabel2EditPart) {
	...
	*/
	 ...
	 * @generated
	 */
	public class TimerIntermediateCatchEventFigure extends SVGFigure {

		/**
		 * @generated
		 */
		public TimerIntermediateCatchEventFigure() {
			...
			this.setURI("platform:/plugin/org.bonitasoft.studio.pics/icons/figures/IntermediateCatchTimerEvent.svgz");
