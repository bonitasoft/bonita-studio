...
import org.bonitasoft.studio.model.process.diagram.edit.policies.EndTerminatedEvent2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EndTerminatedEvent2EditPart extends AbstractBorderedShapeEditPart {
	...
	* @generated
	*/
	public EndTerminatedEvent2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new EndTerminatedEvent2ItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new TerminatedEndEventFigure();
	}

	/**
	* @generated
	*/
	public TerminatedEndEventFigure getPrimaryShape() {
		return (TerminatedEndEventFigure) primaryShape;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(EndTerminatedEventLabel2EditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class TerminatedEndEventFigure extends SVGFigure {

		/**
		 * @generated
		 */
		public TerminatedEndEventFigure() {
			...
			this.setURI("platform:/plugin/org.bonitasoft.studio.pics/icons/figures/EndTerminatedEvent.svgz");
