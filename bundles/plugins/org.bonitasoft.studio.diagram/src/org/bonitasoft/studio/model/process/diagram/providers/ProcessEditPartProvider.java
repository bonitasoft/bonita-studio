 ...
 * @generated
 */
public class ProcessEditPartProvider extends DefaultEditPartProvider {

	/**
	* @generated
	*/
	public ProcessEditPartProvider() {
		super(new ProcessEditPartFactory(), ProcessVisualIDRegistry.TYPED_INSTANCE, MainProcessEditPart.MODEL_ID);
	}
