 ...
 * @generated
 */
public class BoundaryMessageEventLabel2EditPart extends CustomEventLabelEditPart
	...
	*/
	static {
		registerSnapBackPosition(ProcessVisualIDRegistry.getType(
				org.bonitasoft.studio.model.process.diagram.edit.parts.BoundaryMessageEventLabel2EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public BoundaryMessageEventLabel2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ProcessParserProvider.getParser(ProcessElementTypes.BoundaryMessageEvent_3036, getParserElement(),
