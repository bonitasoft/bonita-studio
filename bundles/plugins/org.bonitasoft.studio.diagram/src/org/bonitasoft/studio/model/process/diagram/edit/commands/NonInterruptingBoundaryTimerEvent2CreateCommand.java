 ...
 * @generated
 */
public class NonInterruptingBoundaryTimerEvent2CreateCommand extends EditElementCommand {

	/**
	* @generated
	*/
	public NonInterruptingBoundaryTimerEvent2CreateCommand(CreateElementRequest req) {
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		NonInterruptingBoundaryTimerEvent newElement = ProcessFactory.eINSTANCE
				.createNonInterruptingBoundaryTimerEvent();

		Activity owner = (Activity) getElementToEdit();
		owner.getBoundaryIntermediateEvents().add(newElement);

		ElementInitializers.getInstance().init_NonInterruptingBoundaryTimerEvent_3065(newElement);
