...
public class TaskCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<ProcessNodeDescriptor> childDescriptors = ProcessDiagramUpdater.getTask_2004SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<ProcessNodeDescriptor> childDescriptors = ProcessDiagramUpdater
				.getTask_2004SemanticChildren((View) getHost().getModel());
