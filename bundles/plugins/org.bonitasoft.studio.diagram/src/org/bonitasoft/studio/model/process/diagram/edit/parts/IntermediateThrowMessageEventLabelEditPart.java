 ...
 * @generated
 */
public class IntermediateThrowMessageEventLabelEditPart extends CustomEventLabelEditPart
	...
	*/
	static {
		registerSnapBackPosition(ProcessVisualIDRegistry.getType(
				org.bonitasoft.studio.model.process.diagram.edit.parts.IntermediateThrowMessageEventLabelEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public IntermediateThrowMessageEventLabelEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ProcessParserProvider.getParser(ProcessElementTypes.IntermediateThrowMessageEvent_2014,
