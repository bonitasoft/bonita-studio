...
import org.bonitasoft.studio.model.process.diagram.edit.policies.SubProcessEventSubProcessCompartmentCanonicalEditPolicy;
import org.bonitasoft.studio.model.process.diagram.edit.policies.SubProcessEventSubProcessCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class SubProcessEventSubProcessCompartmentEditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public SubProcessEventSubProcessCompartmentEditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.SubProcessEventSubProcessCompartmentEditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SubProcessEventSubProcessCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(ProcessVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new SubProcessEventSubProcessCompartmentCanonicalEditPolicy());
	}
