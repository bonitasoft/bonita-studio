 ...
 * @generated
 */
public class TextAnnotationCreateCommand extends EditElementCommand {

	/**
	* @generated
	*/
	public TextAnnotationCreateCommand(CreateElementRequest req) {
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		TextAnnotation newElement = ProcessFactory.eINSTANCE.createTextAnnotation();

		Container owner = (Container) getElementToEdit();
		owner.getElements().add(newElement);

		ElementInitializers.getInstance().init_TextAnnotation_2015(newElement);
