...
import org.bonitasoft.studio.model.process.diagram.edit.policies.TaskCanonicalEditPolicy;
import org.bonitasoft.studio.model.process.diagram.edit.policies.TaskItemSemanticEditPolicy;
...
public class TaskEditPart extends AbstractBorderedShapeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new TaskCanonicalEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TaskNameEditPart) {
			((TaskNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureActivityNameFigure());
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(TaskNameEditPart.VISUAL_ID));
	}
