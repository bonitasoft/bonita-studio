 ...
 * @generated
 */
public class NonInterruptingBoundaryTimerEventName2EditPart extends CustomEventLabelEditPart
	...
	*/
	static {
		registerSnapBackPosition(ProcessVisualIDRegistry.getType(
				org.bonitasoft.studio.model.process.diagram.edit.parts.NonInterruptingBoundaryTimerEventName2EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public NonInterruptingBoundaryTimerEventName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ProcessParserProvider.getParser(ProcessElementTypes.NonInterruptingBoundaryTimerEvent_3065,
					getParserElement(), ProcessVisualIDRegistry.getType(
							org.bonitasoft.studio.model.process.diagram.edit.parts.NonInterruptingBoundaryTimerEventName2EditPart.VISUAL_ID));
		}
		return parser;
	}
