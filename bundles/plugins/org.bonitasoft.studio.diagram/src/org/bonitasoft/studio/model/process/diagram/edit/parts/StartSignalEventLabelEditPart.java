 ...
 * @generated
 */
public class StartSignalEventLabelEditPart extends CustomEventLabelEditPart
	...
	static {
		registerSnapBackPosition(
				ProcessVisualIDRegistry.getType(
						org.bonitasoft.studio.model.process.diagram.edit.parts.StartSignalEventLabelEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public StartSignalEventLabelEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ProcessParserProvider.getParser(ProcessElementTypes.StartSignalEvent_2022, getParserElement(),
					ProcessVisualIDRegistry.getType(
							org.bonitasoft.studio.model.process.diagram.edit.parts.StartSignalEventLabelEditPart.VISUAL_ID));
		}
		return parser;
