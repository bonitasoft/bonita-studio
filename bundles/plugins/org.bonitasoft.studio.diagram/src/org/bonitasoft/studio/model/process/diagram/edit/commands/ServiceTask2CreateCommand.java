 ...
 * @generated
 */
public class ServiceTask2CreateCommand extends EditElementCommand {

	/**
	* @generated
	*/
	public ServiceTask2CreateCommand(CreateElementRequest req) {
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		ElementInitializers.getInstance().init_ServiceTask_3027(newElement);
