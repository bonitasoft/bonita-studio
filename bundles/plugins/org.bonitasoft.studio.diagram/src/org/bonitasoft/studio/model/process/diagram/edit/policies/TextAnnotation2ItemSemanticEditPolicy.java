 ...
 * @generated
 */
public class TextAnnotation2ItemSemanticEditPolicy extends ProcessBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public TextAnnotation2ItemSemanticEditPolicy() {
		super(ProcessElementTypes.TextAnnotation_3015);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (ProcessVisualIDRegistry.getVisualID(outgoingLink) == TextAnnotationAttachmentEditPart.VISUAL_ID) {
