...
import org.bonitasoft.studio.model.process.diagram.edit.policies.TextAnnotation2ItemSemanticEditPolicy;
...
public class TextAnnotation2EditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new TextAnnotation2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TextAnnotationText2EditPart) {
			((TextAnnotationText2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureNoteMessage());
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(TextAnnotationText2EditPart.VISUAL_ID));
	}
