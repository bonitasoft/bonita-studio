...
import org.bonitasoft.studio.model.process.diagram.edit.policies.Activity2CanonicalEditPolicy;
import org.bonitasoft.studio.model.process.diagram.edit.policies.Activity2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Activity2EditPart extends AbstractBorderedShapeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new Activity2CanonicalEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ActivityName2EditPart) {
			((ActivityName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureActivityNameFigure());
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof IntermediateErrorCatchEvent6EditPart) {
			getBorderedFigure().getBorderItemContainer()
					.remove(((IntermediateErrorCatchEvent6EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(ActivityName2EditPart.VISUAL_ID));
	}
