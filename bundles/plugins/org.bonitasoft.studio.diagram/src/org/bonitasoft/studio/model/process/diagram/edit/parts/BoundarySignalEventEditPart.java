...
import org.bonitasoft.studio.model.process.diagram.edit.policies.BoundarySignalEventItemSemanticEditPolicy;
 ...
 * @generated
 */
public class BoundarySignalEventEditPart extends BorderedBorderItemEditPart {
	...
	* @generated
	*/
	public BoundarySignalEventEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new BoundarySignalEventItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new BoundarySignalEventFigure();
	}

	/**
	* @generated
	*/
	public BoundarySignalEventFigure getPrimaryShape() {
		return (BoundarySignalEventFigure) primaryShape;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(BoundarySignalEventLabelEditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class BoundarySignalEventFigure extends SVGFigure {

		/**
		 * @generated
		 */
		public BoundarySignalEventFigure() {
			...
			this.setURI("platform:/plugin/org.bonitasoft.studio.pics/icons/figures/BoundarySignalEvent.svgz");
