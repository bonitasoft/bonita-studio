 ...
 * @generated
 */
public class Activity2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<ProcessNodeDescriptor> childDescriptors = ProcessDiagramUpdater
				.getActivity_3006SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return IntermediateErrorCatchEvent6EditPart.VISUAL_ID == ProcessVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<ProcessNodeDescriptor> childDescriptors = ProcessDiagramUpdater
				.getActivity_3006SemanticChildren((View) getHost().getModel());
