 ...
 * @generated
 */
public class SequenceFlowNameEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				ProcessVisualIDRegistry.getType(
						org.bonitasoft.studio.model.process.diagram.edit.parts.SequenceFlowNameEditPart.VISUAL_ID),
				new Point(0, -10));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ProcessParserProvider.getParser(ProcessElementTypes.SequenceFlow_4001, getParserElement(),
					ProcessVisualIDRegistry.getType(
							org.bonitasoft.studio.model.process.diagram.edit.parts.SequenceFlowNameEditPart.VISUAL_ID));
		}
		return parser;
