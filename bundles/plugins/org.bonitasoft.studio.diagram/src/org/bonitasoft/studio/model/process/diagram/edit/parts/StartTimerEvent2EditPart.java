...
import org.bonitasoft.studio.model.process.diagram.edit.policies.StartTimerEvent2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class StartTimerEvent2EditPart extends AbstractBorderedShapeEditPart {
	...
	* @generated
	*/
	public StartTimerEvent2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new StartTimerEvent2ItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new TimerStartEventFigure();
	}

	/**
	* @generated
	*/
	public TimerStartEventFigure getPrimaryShape() {
		return (TimerStartEventFigure) primaryShape;
	}
	...
	*/
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof StartTimerEventLabel2EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(StartTimerEventLabel2EditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class TimerStartEventFigure extends SVGFigure {

		/**
		 * @generated
		 */
		public TimerStartEventFigure() {
			...
			this.setURI("platform:/plugin/org.bonitasoft.studio.pics/icons/figures/StartTimerEvent.svgz");
