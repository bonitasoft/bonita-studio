...
import org.bonitasoft.studio.model.process.diagram.edit.policies.Event2ItemSemanticEditPolicy;
...
public class Event2EditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Event2ItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new GenericEventFigure();
	}

	/**
	* @generated
	*/
	public GenericEventFigure getPrimaryShape() {
		return (GenericEventFigure) primaryShape;
	}
	...
	*/
	 ...
	 * @generated
	 */
	public class GenericEventFigure extends SVGFigure {

		/**
		 * @generated
		 */
		public GenericEventFigure() {
			...
			this.setURI("platform:/plugin/org.bonitasoft.studio.pics/icons/figures/GenericEvent.svgz");
