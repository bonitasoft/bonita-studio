...
import org.bonitasoft.studio.model.process.diagram.edit.policies.BoundaryTimerEvent2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class BoundaryTimerEvent2EditPart extends BorderedBorderItemEditPart {
	...
	* @generated
	*/
	public BoundaryTimerEvent2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new BoundaryTimerEvent2ItemSemanticEditPolicy());
	...
	*/
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof BoundaryTimerEventLabel2EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(BoundaryTimerEventLabel2EditPart.VISUAL_ID));
	}
