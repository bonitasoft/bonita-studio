...
import org.bonitasoft.studio.model.process.diagram.edit.policies.ScriptTaskCanonicalEditPolicy;
import org.bonitasoft.studio.model.process.diagram.edit.policies.ScriptTaskItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ScriptTaskEditPart extends AbstractBorderedShapeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ScriptTaskItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new ScriptTaskCanonicalEditPolicy());
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(ScriptTaskLabelEditPart.VISUAL_ID));
	}
