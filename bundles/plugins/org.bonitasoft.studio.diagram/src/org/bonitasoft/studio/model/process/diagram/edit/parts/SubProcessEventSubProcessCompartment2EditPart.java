...
import org.bonitasoft.studio.model.process.diagram.edit.policies.SubProcessEventSubProcessCompartment2CanonicalEditPolicy;
import org.bonitasoft.studio.model.process.diagram.edit.policies.SubProcessEventSubProcessCompartment2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class SubProcessEventSubProcessCompartment2EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public SubProcessEventSubProcessCompartment2EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.SubProcessEventSubProcessCompartment2EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SubProcessEventSubProcessCompartment2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(ProcessVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new SubProcessEventSubProcessCompartment2CanonicalEditPolicy());
	}
	...
	*/
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == ProcessElementTypes.StartErrorEvent_3060) {
				return this;
			}
