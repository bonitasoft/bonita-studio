 ...
 * @generated
 */
public class ScriptTaskLabelEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ScriptTaskLabelEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ProcessParserProvider.getParser(ProcessElementTypes.ScriptTask_2028, getParserElement(),
					ProcessVisualIDRegistry.getType(
							org.bonitasoft.studio.model.process.diagram.edit.parts.ScriptTaskLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
