 ...
 * @generated
 */
public class StartEvent2CreateCommand extends EditElementCommand {

	/**
	* @generated
	*/
	public StartEvent2CreateCommand(CreateElementRequest req) {
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		StartEvent newElement = ProcessFactory.eINSTANCE.createStartEvent();

		Container owner = (Container) getElementToEdit();
		owner.getElements().add(newElement);

		ElementInitializers.getInstance().init_StartEvent_3002(newElement);
