 ...
 * @generated
 */
public class EndMessageEvent2CreateCommand extends EditElementCommand {

	/**
	* @generated
	*/
	public EndMessageEvent2CreateCommand(CreateElementRequest req) {
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		EndMessageEvent newElement = ProcessFactory.eINSTANCE.createEndMessageEvent();

		Container owner = (Container) getElementToEdit();
		owner.getElements().add(newElement);

		ElementInitializers.getInstance().init_EndMessageEvent_3011(newElement);
