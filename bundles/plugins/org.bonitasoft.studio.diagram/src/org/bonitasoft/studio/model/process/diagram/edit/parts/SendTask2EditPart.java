...
import org.bonitasoft.studio.model.process.diagram.edit.policies.SendTask2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class SendTask2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public SendTask2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SendTaskLabel2EditPart) {
			((SendTaskLabel2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureActivityNameFigure());
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(SendTaskLabel2EditPart.VISUAL_ID));
	}
