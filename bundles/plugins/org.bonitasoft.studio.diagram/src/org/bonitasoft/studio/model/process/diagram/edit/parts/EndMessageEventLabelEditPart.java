 ...
 * @generated
 */
public class EndMessageEventLabelEditPart extends CustomEventLabelEditPart
	...
	static {
		registerSnapBackPosition(
				ProcessVisualIDRegistry.getType(
						org.bonitasoft.studio.model.process.diagram.edit.parts.EndMessageEventLabelEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public EndMessageEventLabelEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ProcessParserProvider.getParser(ProcessElementTypes.EndMessageEvent_2011, getParserElement(),
					ProcessVisualIDRegistry.getType(
							org.bonitasoft.studio.model.process.diagram.edit.parts.EndMessageEventLabelEditPart.VISUAL_ID));
		}
		return parser;
