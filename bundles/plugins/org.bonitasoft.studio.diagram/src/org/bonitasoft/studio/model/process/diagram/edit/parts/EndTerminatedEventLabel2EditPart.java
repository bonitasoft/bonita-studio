 ...
 * @generated
 */
public class EndTerminatedEventLabel2EditPart extends CustomEventLabelEditPart
	...
	*/
	static {
		registerSnapBackPosition(ProcessVisualIDRegistry.getType(
				org.bonitasoft.studio.model.process.diagram.edit.parts.EndTerminatedEventLabel2EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public EndTerminatedEventLabel2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ProcessParserProvider.getParser(ProcessElementTypes.EndTerminatedEvent_3062, getParserElement(),
