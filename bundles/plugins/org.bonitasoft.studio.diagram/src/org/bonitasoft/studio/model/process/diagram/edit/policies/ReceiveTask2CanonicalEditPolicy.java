 ...
 * @generated
 */
public class ReceiveTask2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<ProcessNodeDescriptor> childDescriptors = ProcessDiagramUpdater
				.getReceiveTask_3026SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return IntermediateErrorCatchEvent3EditPart.VISUAL_ID == ProcessVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<ProcessNodeDescriptor> childDescriptors = ProcessDiagramUpdater
				.getReceiveTask_3026SemanticChildren((View) getHost().getModel());
