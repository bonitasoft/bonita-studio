...
import org.bonitasoft.studio.model.process.diagram.edit.policies.EndSignalEvent2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EndSignalEvent2EditPart extends AbstractBorderedShapeEditPart {
	...
	* @generated
	*/
	public EndSignalEvent2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new EndSignalEvent2ItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new SignalEndEventFigure();
	}

	/**
	* @generated
	*/
	public SignalEndEventFigure getPrimaryShape() {
		return (SignalEndEventFigure) primaryShape;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(EndSignalEventLabel2EditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class SignalEndEventFigure extends SVGFigure {

		/**
		 * @generated
		 */
		public SignalEndEventFigure() {
			...
			this.setURI("platform:/plugin/org.bonitasoft.studio.pics/icons/figures/EndSignalEvent.svgz");
