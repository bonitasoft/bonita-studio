...
import org.bonitasoft.studio.model.process.diagram.edit.policies.ServiceTask2CanonicalEditPolicy;
import org.bonitasoft.studio.model.process.diagram.edit.policies.ServiceTask2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ServiceTask2EditPart extends AbstractBorderedShapeEditPart {
	...
	* @generated
	*/
	public ServiceTask2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ServiceTask2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new ServiceTask2CanonicalEditPolicy());
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProcessVisualIDRegistry.getType(ServiceTaskLabel2EditPart.VISUAL_ID));
	}
