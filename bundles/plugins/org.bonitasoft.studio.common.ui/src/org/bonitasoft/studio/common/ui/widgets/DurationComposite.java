 ...
 */
package org.bonitasoft.studio.common.ui.widgets;
...
public class DurationComposite extends Composite {
     ...
     * @param g
     */
    public DurationComposite(Composite parent, boolean showYear, boolean showMonth, boolean showDay, boolean showHour,
            boolean showMinute, boolean showSecond, TabbedPropertySheetWidgetFactory widgetFactory) {
        ...
        if (showYear) {
            ...
            Label label;
            if (widgetFactory != null) {
                label = widgetFactory.createLabel(this, org.bonitasoft.studio.common.Messages.yearsLabel,
                        SWT.TRANSPARENT);
            } else {
        ...
        if (showMonth) {
            Label label;
            if (widgetFactory != null) {
                label = widgetFactory.createLabel(this, org.bonitasoft.studio.common.Messages.monthsLabel,
                        SWT.TRANSPARENT);
            } else {
                label = new Label(this, SWT.TRANSPARENT);
        ...
        if (showDay) {
            Label label;
            if (widgetFactory != null) {
                label = widgetFactory.createLabel(this, org.bonitasoft.studio.common.Messages.daysLabel,
                        SWT.TRANSPARENT);
            } else {
                label = new Label(this, SWT.TRANSPARENT);
        ...
        if (showHour) {
            Label label;
            if (widgetFactory != null) {
                label = widgetFactory.createLabel(this, org.bonitasoft.studio.common.Messages.hoursLabel,
                        SWT.TRANSPARENT);
            } else {
                label = new Label(this, SWT.TRANSPARENT);
        ...
        if (showMinute) {
            Label label;
            if (widgetFactory != null) {
                label = widgetFactory.createLabel(this, org.bonitasoft.studio.common.Messages.minutesLabel,
                        SWT.TRANSPARENT);
            } else {
                label = new Label(this, SWT.TRANSPARENT);
        ...
        if (showSecond) {
            Label label;
            if (widgetFactory != null) {
                label = widgetFactory.createLabel(this, org.bonitasoft.studio.common.Messages.secondsLabel,
                        SWT.TRANSPARENT);
            } else {
                label = new Label(this, SWT.TRANSPARENT);
    ...
    public void setDuration(long value) {
        if (value > maximumDuration) {
            DateWidgetUtil.setWidgetDisplayDuration(yearsSpinner, monthsSpinner, daySpinner, hourSpinner,
                    minutesSpinner, secondSpinner, maximumDuration);
        } else {
            DateWidgetUtil.setWidgetDisplayDuration(yearsSpinner, monthsSpinner, daySpinner, hourSpinner,
                    minutesSpinner, secondSpinner, value);
        }

    }

    public long getDuration() {
        return DateWidgetUtil.getWidgetMillisecondAsLong(yearsSpinner, monthsSpinner, daySpinner, hourSpinner,
                minutesSpinner, secondSpinner);
    }
