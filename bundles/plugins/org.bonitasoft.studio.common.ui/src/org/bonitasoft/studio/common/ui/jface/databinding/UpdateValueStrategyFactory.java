...
import org.bonitasoft.studio.common.databinding.validator.IValidatorFactory;
import org.bonitasoft.studio.common.databinding.validator.ValidatorEvent;
...
public class UpdateValueStrategyFactory {
    ...
    public UpdateValueStrategyFactory withValidator(final IValidatorFactory validatorFactory) {
        return withValidator(validatorFactory.create(), ValidatorEvent.AFTER_GET);
    }
