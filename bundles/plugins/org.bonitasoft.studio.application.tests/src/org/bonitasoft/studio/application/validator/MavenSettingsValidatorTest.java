...
class MavenSettingsValidatorTest {
    ...
    @Test
    void should_validate_repository_without_id() {
        ...
        assertThat(status).extracting(IStatus::getMessage)
                .contains(String.format(Messages.repositoryIdMandatory, repo.getId()));
    }

    @Test
    void should_validate_repository_without_url() {
        var repo = new Repository();
        repo.setId(ID);
        repo.setName(NAME);
        validator.validateRepository(repo, multiStatus);
    ...
    @Test
    void should_validate_valid_repository() {
        var repo = new Repository();
        repo.setId(ID);
        repo.setName(NAME);
        repo.setUrl(URL);
    ...
    @Test
    void should_validate_proxy_without_id() {
        var proxy = new Proxy();
        proxy.setId("");
    ...
    @Test
    void should_validate_proxy_without_host() {
        var proxy = new Proxy();
        proxy.setId(ID);
        validator.validateProxy(proxy, multiStatus);
        StatusAssert.assertThat(multiStatus).isError();
        List<IStatus> status = List.of(multiStatus.getChildren());
        assertThat(status).extracting(IStatus::getMessage)
                .contains(String.format(Messages.proxyHostMandatory, proxy.getId()));
    }

    @Test
    void should_validate_valid_proxy() {
        var proxy = new Proxy();
        proxy.setId(ID);
        proxy.setHost(URL);
        validator.validateProxy(proxy, multiStatus);
    ...
    @Test
    void should_validate_mirror_without_id() {
    ...
    @Test
    void should_validate_mirror_without_url() {
        var mirror = new Mirror();
        mirror.setId(ID);
        validator.validateMirror(mirror, multiStatus);
        StatusAssert.assertThat(multiStatus).isError();
    ...
    @Test
    void should_validate_valid_mirror() {
        var mirror = new Mirror();
        mirror.setId(ID);
        mirror.setUrl(URL);
        validator.validateMirror(mirror, multiStatus);
