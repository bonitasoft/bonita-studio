...
class BonitaArtifactDependencyTest {
    ...
    @Test
    void should_return_latest_compatibleVersion() {
        ...
        assertThat(dependency.getLatestCompatibleVersion()).contains(version2);
    }

    @Test
    void should_not_find_any_compatibleVersion() {
