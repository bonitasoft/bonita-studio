...
public class DisplayMavenDependencyTreeAllProcessesMenuContribution extends ContributionItem {

    private static final String DISPLAY_TREE_COMMAND = "org.bonitasoft.studio.engine.showMavenDependencyTreeCommand";

    public DisplayMavenDependencyTreeAllProcessesMenuContribution() {
