...
public class EngineExpressionUtilTest {
    ...
    public void should_createExpression_document() throws Exception {
        //given
        final Expression studioExpression = createStudioExpression("document1", "document1", "org.bonitasoft.engine.bpm.document.DocumentValue", ExpressionConstants.DOCUMENT_TYPE);
    ...
    public void should_createExpression_groovy_with_data_dep() throws Exception {
        ...
        final Data stringData = createData("myData", false, DatasourceConstants.BOS_DATASOURCE);
        final Expression studioExpression = createStudioExpression("myScript", "return myData+'plop'", String.class.getName(), ExpressionConstants.SCRIPT_TYPE,stringData );
        studioExpression.setInterpreter(ExpressionConstants.GROOVY);
        //when
        final org.bonitasoft.engine.expression.Expression engineExpression = EngineExpressionUtil.createExpression(studioExpression);

        //then
        final org.bonitasoft.engine.expression.Expression excpectedExpression = new ExpressionBuilder().createGroovyScriptExpression("myScript", "return myData+'plop'", String.class.getName(), new ExpressionBuilder().createDataExpression("myData", String.class.getName()));
    ...
    public void should_createExpression_groovy_with_transient_data_dep() throws Exception {
        ...
        //then
        final org.bonitasoft.engine.expression.Expression excpectedExpression = new ExpressionBuilder().createGroovyScriptExpression("myScript", "return myData+'plop'", String.class.getName(), new ExpressionBuilder().createTransientDataExpression("myData", String.class.getName()));
        assertEquals(excpectedExpression, engineExpression);
    }
    ...
    public void should_createExpression_groovy_with_form_transient_data_dep() throws Exception {
        ...
        //then
        final org.bonitasoft.engine.expression.Expression excpectedExpression = new ExpressionBuilder().createGroovyScriptExpression("myScript", "return myData+'plop'", String.class.getName(), new ExpressionBuilder().createInputExpression("myData", String.class.getName()));
        assertEquals(excpectedExpression, engineExpression);
    }
