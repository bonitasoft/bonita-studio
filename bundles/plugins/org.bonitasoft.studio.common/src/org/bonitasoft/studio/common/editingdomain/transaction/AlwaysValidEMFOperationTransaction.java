...
public class AlwaysValidEMFOperationTransaction extends EMFOperationTransaction {

    public AlwaysValidEMFOperationTransaction(final Command command, final InternalTransactionalEditingDomain domain, final Map<?, ?> options) {
