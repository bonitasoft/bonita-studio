...
public class MultiInstanceConstraintInput extends AbstractLiveValidationMarkerConstraint {
    ...
    protected IStatus performLiveValidation(final IValidationContext context) {
        final EStructuralFeature feature = context.getFeature();
    ...
    private IStatus validateMultiInstantiation(final IValidationContext ctx, final Activity act) {
        final MultiInstantiation mult = act.getMultiInstantiation();
