...
AbstractLiveValidationMarkerConstraint {
	...
	/* (non-Javadoc)
	 * @see org.bonitasoft.studio.validation.constraints.live.AbstractLiveValidationMarkerConstraint#performLiveValidation(org.eclipse.emf.validation.IValidationContext)
	 */
	@Override
	...
	private boolean dontNeedIncomingLink(Object object) {
	...
	/* (non-Javadoc)
	 * @see org.bonitasoft.studio.validation.constraints.live.AbstractLiveValidationMarkerConstraint#performBatchValidation(org.eclipse.emf.validation.IValidationContext)
	 */
	@Override
	protected IStatus performBatchValidation(IValidationContext context) {
		EObject flowElement = context.getTarget();
	...
	/* (non-Javadoc)
	 * @see org.bonitasoft.studio.validation.constraints.live.AbstractLiveValidationMarkerConstraint#getMarkerType()
	 */
	@Override
