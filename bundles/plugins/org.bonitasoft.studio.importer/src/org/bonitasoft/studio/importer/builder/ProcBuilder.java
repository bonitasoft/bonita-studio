...
public class ProcBuilder implements IProcBuilder {
    ...
    public void addPool(String id, final String name, final String version, final Point location, final Dimension size) throws ProcBuilderException{
        ...
        final ViewAndElementDescriptor viewDescriptor = new ViewAndElementDescriptor(new CreateElementRequestAdapter(new CreateElementRequest(ProcessElementTypes.Pool_2007)), Node.class,
     ...
     */
    @Override
    public void addData(final String id, final String name, final String defaultValueContent, final String defaultValueReturnType, final String defaultValueInterpreter, final boolean isMultiple, final boolean isTransient, final DataType datatype, final String expressionType) throws ProcBuilderException {
    ...
    @Override
    public void addJavaData(final String id, final String name, final String defaultValueContent, final String defaultValueReturnType, final String defaultValueInterpreter, final String javaQualifiedName, final boolean isMultiple, final boolean isTransient, final String expressiontype) throws ProcBuilderException {
    ...
    public void addSequenceFlow(final String name, final String sourceId, final String targetId, final boolean isDefault,final Point sourceAnchor, final Point targetAnchor, final PointList bendpoints) throws ProcBuilderException {
        ...
        final CreateConnectionViewAndElementRequest request = new CreateConnectionViewAndElementRequest(ProcessElementTypes.SequenceFlow_4001, ((IHintedType) ProcessElementTypes.SequenceFlow_4001).getSemanticHint(), diagramPart
     ...
     */
    @Override
    public void addGateway(final String id, final String name, final Point location,final Dimension size, final GatewayType gatewayType) throws ProcBuilderException {
     ...
     */
    @Override
    public void addGateway(String id, final String name, final Point location,final Dimension size, final GatewayType gatewayType,final boolean displayLabel) throws ProcBuilderException {
        id = NamingUtils.convertToId(id) ;
    ...
    private Element createShape(final String id, final EObject container, final Point location, final Dimension size, final IElementType type, final boolean isCollapsed) throws ProcBuilderException {
        ...
        final ViewAndElementDescriptor viewDescriptor = new ViewAndElementDescriptor(new CreateElementRequestAdapter(new CreateElementRequest(type)), Node.class,
    ...
    public void addAnnotation(final String text, final Point location,final Dimension size, final String sourceId) throws ProcBuilderException {
        ...
        final ViewAndElementDescriptor viewDescriptor = new ViewAndElementDescriptor(new CreateElementRequestAdapter(new CreateElementRequest(ProcessElementTypes.TextAnnotation_3015)), Node.class,
    ...
    @Override
    public void addConnectorParameter(final String parameterKey, final String valueContent, final String valueReturnType, final String valueInterpreter, final String expressionType) throws ProcBuilderException {
    ...
    @Override
    public void addConnectorOutput(final String targetDataId, final String valueContent, final String valueReturnType, final String valueInterpreter, final String expressionType) throws ProcBuilderException {
    ...
    private void processMessageFlows() throws ProcBuilderException {
        ...
        for(final MessageFlowData entry : messageFlows){
            ...
            final CreateConnectionViewAndElementRequest request = new CreateConnectionViewAndElementRequest(ProcessElementTypes.MessageFlow_4002, ((IHintedType) ProcessElementTypes.MessageFlow_4002).getSemanticHint(), diagramPart.getDiagramPreferencesHint());
            ...
            final MessageFlow createdElement = (MessageFlow) ((CreateRelationshipRequest)((ConnectionViewAndElementDescriptor) request.getNewObject()).getCreateElementRequestAdapter().getAdapter(CreateElementRequest.class)).getNewElement();
