 ...
 */
public class ConnectorSourceRepositoryStore extends SourceRepositoryStore<AbstractFileStore> {

    private static final String STORE_NAME = "src-connectors";
    ...
    public String getDisplayName() {
        return Messages.connectorSourceRepositoryName;
    }
