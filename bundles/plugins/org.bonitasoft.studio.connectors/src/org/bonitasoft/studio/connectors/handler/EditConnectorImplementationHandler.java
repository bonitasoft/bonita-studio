 ...
 *
 */
public class EditConnectorImplementationHandler extends AbstractHandler {
    ...
    public Object execute(ExecutionEvent event) throws ExecutionException {
        SelectUserConnectorImplementationWizard selectWizard = new SelectUserConnectorImplementationWizard() ;
        ...
        if(selectDialog.open() == Dialog.OK){
            ConnectorImplementationWizard wizard = new ConnectorImplementationWizard(selectWizard.getConnectorImplementation()) ;
