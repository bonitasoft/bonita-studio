 ...
 */
public class URLConnectorDefFileStore extends ConnectorDefFileStore {

    private final URL url;

    public URLConnectorDefFileStore(final URL url, final AbstractEMFRepositoryStore<ConnectorDefFileStore> store) {
