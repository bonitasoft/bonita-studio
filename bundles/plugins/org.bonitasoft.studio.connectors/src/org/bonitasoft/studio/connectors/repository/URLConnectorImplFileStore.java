 ...
 */
public class URLConnectorImplFileStore extends ConnectorImplFileStore {

    private final URL url;

    public URLConnectorImplFileStore(final URL url, final AbstractEMFRepositoryStore<ConnectorImplFileStore> store) {
