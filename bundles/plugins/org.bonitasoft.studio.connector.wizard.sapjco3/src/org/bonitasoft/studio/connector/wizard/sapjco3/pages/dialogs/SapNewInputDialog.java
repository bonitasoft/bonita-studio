 ...
 * 
 */
public class SapNewInputDialog extends AbstractInputOutputDialog {

	public SapNewInputDialog(Shell parentShell, SapTool sapTool) {
	...
	protected void makeRadioButton(Button button, String name,
		...
		button.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				treeElement = sapTool.getFunctionFieldsInputFiltered(sapTool.selectedFunction, single, table,structure);
	...
	public void initializeTreeElement() {
		treeElement = sapTool.getFunctionFieldsInputFiltered(sapTool.selectedFunction, true,false, false);
