 ...
 * <ul>
 *   <li>{@link org.wfmc._2002.xpdl1.impl.ActivitiesTypeImpl#getActivity <em>Activity</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ActivitiesTypeImpl extends EObjectImpl implements ActivitiesType {
	...
	protected EClass eStaticClass() {
		return Xpdl1Package.Literals.ACTIVITIES_TYPE;
	}
	...
	public EList<ActivityType> getActivity() {
		if (activity == null) {
			activity = new EObjectContainmentEList<ActivityType>(ActivityType.class, this, Xpdl1Package.ACTIVITIES_TYPE__ACTIVITY);
		}
		return activity;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Xpdl1Package.ACTIVITIES_TYPE__ACTIVITY:
