 ...
 * <ul>
 *   <li>{@link org.wfmc._2002.xpdl1.impl.TransitionsTypeImpl#getTransition <em>Transition</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class TransitionsTypeImpl extends EObjectImpl implements TransitionsType {
	/**
	...
	protected EClass eStaticClass() {
		return Xpdl1Package.Literals.TRANSITIONS_TYPE;
	}
	...
	public EList<TransitionType> getTransition() {
		if (transition == null) {
			transition = new EObjectContainmentEList<TransitionType>(TransitionType.class, this, Xpdl1Package.TRANSITIONS_TYPE__TRANSITION);
		}
		return transition;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Xpdl1Package.TRANSITIONS_TYPE__TRANSITION:
