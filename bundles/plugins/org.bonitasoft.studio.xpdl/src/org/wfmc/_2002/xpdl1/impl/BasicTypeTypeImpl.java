 ...
 * <ul>
 *   <li>{@link org.wfmc._2002.xpdl1.impl.BasicTypeTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BasicTypeTypeImpl extends EObjectImpl implements BasicTypeType {
	 ...
	 * @ordered
	 */
	protected static final TypeType3 TYPE_EDEFAULT = TypeType3.STRING;
	...
	protected EClass eStaticClass() {
		return Xpdl1Package.Literals.BASIC_TYPE_TYPE;
	}
	...
	public void setType(TypeType3 newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xpdl1Package.BASIC_TYPE_TYPE__TYPE, oldType, type, !oldTypeESet));
	}
	...
	public void unsetType() {
		...
		typeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Xpdl1Package.BASIC_TYPE_TYPE__TYPE, oldType, TYPE_EDEFAULT, oldTypeESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Xpdl1Package.BASIC_TYPE_TYPE__TYPE:
				return getType();
		}
