...
public class ConfigurationWizardDialog extends WizardDialog implements ISelectionChangedListener,IPageChangedListener{
    ...
    private final PageContainerFillLayout pageContainerLayout = new PageContainerFillLayout(10, 10, 300, 225);
    ...
    public void updateMessage() {
        ...
        if( getCurrentPage() instanceof IProcessConfigurationWizardPage){
            String errorMessage =  ((IProcessConfigurationWizardPage)  getCurrentPage()).isConfigurationPageValid(getConfiguration())   ;
    ...
    private List<IConfigurationExportAction>  getConfigurationExporterContributions() {
        ...
        for(IConfigurationElement element : BonitaStudioExtensionRegistryManager.getInstance().getConfigurationElements(EXPORT_CONFIGURATION_ACTION_ID)){
            try {
    ...
    public void pageChanged(PageChangedEvent event) {
        IWizardPage currentSelectedPage = (IWizardPage) ((IStructuredSelection) pageChooserViewer.getSelection()).getFirstElement() ;
