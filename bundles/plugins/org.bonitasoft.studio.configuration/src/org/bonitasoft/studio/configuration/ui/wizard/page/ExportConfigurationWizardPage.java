 ...
 */
public class ExportConfigurationWizardPage extends WizardPage {
    ...
    public ExportConfigurationWizardPage(Configuration configuration, AbstractProcess process) {
        super(ExportConfigurationWizardPage.class.getName());
        setTitle(Messages.exportWizardPageTitle);
        setDescription(Messages.exportWizardPageDesc);
    ...
    public void createControl(Composite parent) {
        ...
        databindingContext.bindValue(ViewerProperties.singleSelection().observe(viewer),
                PojoProperties.value("action").observe(this), strategy, null);
    ...
    private List<IConfigurationExportAction> getConfigurationExporterContributions() {
        ...
        for (IConfigurationElement element : BonitaStudioExtensionRegistryManager.getInstance()
                .getConfigurationElements(EXPORT_CONFIGURATION_ACTION_ID)) {
            try {
                IConfigurationExportAction action = (IConfigurationExportAction) element
