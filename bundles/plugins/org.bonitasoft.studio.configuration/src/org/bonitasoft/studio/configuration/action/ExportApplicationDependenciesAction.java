 ...
 *
 */
public class ExportApplicationDependenciesAction extends Action implements IConfigurationExportAction {

    private Configuration configuration;
    private String path;

    public ExportApplicationDependenciesAction(){
        super() ;
        setText(Messages.applicationDependencies) ;
