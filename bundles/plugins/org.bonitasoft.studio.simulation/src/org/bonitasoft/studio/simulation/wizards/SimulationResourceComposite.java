...
public class SimulationResourceComposite {
	 ...
	 */
	public void setQuantityText(Label quantityText) {
	 ...
	 * @param quantityText the quantityText to set
	 */
	public void setMaxQuantityText(Label quantityText) {
		this.maxQuantityText = quantityText;
	}
	 ...
	 */
	public void setFixedCostText(Label fixedCostText) {
	 ...
	 */
	public void setCostUnitCombo(Label costUnitCombo) {
	 ...
	 */
	public void setTimeUnitCombo(Label timeUnitCombo) {
	 ...
	 * @param sashForm
	 */
	void createResourcePanel(ManageResourcesWizardPage manageResourcesWizardPage, SashForm sashForm) {
		Group composite = new Group(sashForm, SWT.NONE);
		...
		GridData gd_nameText = new GridData(SWT.FILL, SWT.FILL, true, false,3, 1);
		getNameText().setLayoutData(gd_nameText);
	
	

	
		Label lblQuantity = new Label(composite, SWT.RIGHT);
		...
		Label lblMaxQuantity = new Label(composite, SWT.RIGHT);
		...
		Label lblFixedCost = new Label(composite, SWT.RIGHT);
		...
		Label lblTimeCost = new Label(composite, SWT.RIGHT);
	 ...
	 * @param firstElement
	 */
	protected void changeBinding(Object firstElement) {
		...
		if (firstElement instanceof IRepositoryFileStore) {
			...
			getTimeCost().setText(currentResource.getTimeCost() + " "+currentResource.getCostUnit()+" "+Messages.per+" "+currentResource.getTimeUnit().getLiteral());//$NON-NLS-1$
