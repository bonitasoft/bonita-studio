 ...
 *
 */
public class ContigousContribution extends AbstractPropertySectionContribution{
	...
	public String getLabel() {
		return Messages.contigousContributionLabel;//TODO i18n
	}
	...
	public void createControl(Composite composite, TabbedPropertySheetWidgetFactory widgetFactory, ExtensibleGridPropertySection extensibleGridPropertySection) {
		...
		hint.setDescriptionText(Messages.contigousContributionHint);
		context = new EMFDataBindingContext();
		context.bindValue(SWTObservables.observeSelection(button), EMFEditObservables.observeValue(editingDomain, eObject, SimulationPackage.Literals.SIMULATION_ACTIVITY__CONTIGOUS));
	}
