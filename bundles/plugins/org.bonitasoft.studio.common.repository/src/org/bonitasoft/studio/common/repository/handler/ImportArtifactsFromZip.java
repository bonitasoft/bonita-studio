...
public class ImportArtifactsFromZip extends AbstractHandler {
    ...
    public Object execute(ExecutionEvent event) throws ExecutionException {
        ...
        if(workspaceArchiveFile != null){
            ...
            try {
                ...
                new BonitaErrorDialog(Display.getDefault().getActiveShell(), Messages.importRepositoryFailedTitle,  Messages.importRepositoryFailedMsg,new org.eclipse.core.runtime.Status(IStatus.ERROR, "org.bonitasoft.studio.repository.ex", e.getMessage(), e), IStatus.ERROR).open() ;
    ...
    //			dialog.open();
    //		}else{
    //			MessageDialog.openError(Display.getDefault().getActiveShell(), Messages.noArtifactsFound_title, NLS.bind(Messages.noArtifactsFound_message,workspaceArchiveFile)) ;
    //		}
    //	}
    //
    //	/**
