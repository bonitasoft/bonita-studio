...
public class ProjectDefaultConfiguration implements DefaultPluginVersions {
    ...
    public ProjectDefaultConfiguration(String bonitaVersion) {
        ...
        addPlugin(new MavenPlugin(APACHE_MAVEN_PLUGIN_GROUP_ID, MAVEN_DEPLOY_PLUGIN, MAVEN_DEPLOY_PLUGIN_VERSION));
        addPlugin(new MavenPlugin(APACHE_MAVEN_PLUGIN_GROUP_ID, MAVEN_ANTRUN_PLUGIN, MAVEN_ANTRUN_PLUGIN_VERSION));
        addPlugin(new MavenPlugin(APACHE_MAVEN_PLUGIN_GROUP_ID, MAVEN_ASSEMBLY_PLUGIN, MAVEN_ASSEMBLY_PLUGIN_VERSION));
        addPlugin(new MavenPlugin(APACHE_MAVEN_PLUGIN_GROUP_ID, MAVEN_DEPENDENCY_PLUGIN,
                MAVEN_DEPENDENCY_PLUGIN_VERSION));
        addPlugin(new MavenPlugin(APACHE_MAVEN_PLUGIN_GROUP_ID, MAVEN_RELEASE_PLUGIN, MAVEN_RELEASE_PLUGIN_VERSION));
        addPlugin(new MavenPlugin(APACHE_MAVEN_PLUGIN_GROUP_ID, MAVEN_CLEAN_PLUGIN, MAVEN_CLEAN_PLUGIN_VERSION));
        addPlugin(
                new MavenPlugin(APACHE_MAVEN_PLUGIN_GROUP_ID, MAVEN_RESOURCES_PLUGIN, MAVEN_RESOURCES_PLUGIN_VERSION));
        addPlugin(new MavenPlugin(APACHE_MAVEN_PLUGIN_GROUP_ID, MAVEN_JAR_PLUGIN, MAVEN_JAR_PLUGIN_VERSION));
        addPlugin(new MavenPlugin(APACHE_MAVEN_PLUGIN_GROUP_ID, MAVEN_SITE_PLUGIN, MAVEN_SITE_PLUGIN_VERSION));
