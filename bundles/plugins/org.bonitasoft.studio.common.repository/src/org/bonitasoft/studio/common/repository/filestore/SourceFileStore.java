...
//	private IContainer retrieveParentEmptyPackage(IFolder parent) {
//		IContainer result = null;
//		try {
//			while((parent.members().length == 0
//					|| (parent.members().length == 1 && !parent.members(0).equals(result)))
//					&& !ActorFilterSourceRepositoryStore.STORE_NAME.equals(parent.getName())){
//				if(parent.getParent() instanceof IFolder){
//					result = parent;
