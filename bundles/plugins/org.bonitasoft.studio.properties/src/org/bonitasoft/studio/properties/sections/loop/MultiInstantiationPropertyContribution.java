...
// final Composite radioComposite = widgetFactory.createComposite(composite, SWT.NONE);
...
// }
//
// protected void createMultiInstanceParametersComposite(final TabbedPropertySheetWidgetFactory widgetFactory) {
// final Composite parametersComposite = widgetFactory.createComposite(multiInstanciatorComposite, SWT.NONE);
...
// final ControlDecoration cdsequential = new ControlDecoration(sequentialButton, SWT.RIGHT, parametersComposite);
...
//
// final Label completionConditionLabel = widgetFactory.createLabel(parametersComposite, Messages.multiInstance_completionConditionLabel);
// completionConditionViewer = new ExpressionViewer(parametersComposite, SWT.BORDER, widgetFactory,
// ProcessPackage.Literals.MULTI_INSTANTIATION__COMPLETION_CONDITION);
...
// final ControlDecoration cdCompletionCondition = new ControlDecoration(completionConditionLabel, SWT.RIGHT, parametersComposite);
...
// }
//
// protected void createUseExpressionBlock(final TabbedPropertySheetWidgetFactory widgetFactory, final Composite parametersComposite) {
//
// final SelectionListener inputDataAndListOutputDataListener = new SelectionListener() {
//
// @Override
...
// };
//
// final ModifyListener inputDataAndListOutputDataModifyListener = new ModifyListener() {
//
// @Override
...
// final ControlDecoration cdUseCollection = new ControlDecoration(useCollectionButton, SWT.RIGHT, parametersComposite);
...
// inputOutputDataComposite.setLayout(GridLayoutFactory.fillDefaults().numColumns(6).spacing(10, 5).create());
// inputOutputDataComposite.setLayoutData(GridDataFactory.fillDefaults().span(3, 1).create());
//
// final SelectionListener outputDataAndListOutputDataListener = new SelectionListener() {
//
// @Override
// public void widgetSelected(final SelectionEvent e) {
...
// };
//
// final ModifyListener outputDataAndListOutputDataModifyListener = new ModifyListener() {
//
// @Override
// public void modifyText(final ModifyEvent e) {
// updateOutputDataDecorator();
...
// cdOutputData.setImage(PlatformUI.getWorkbench().getSharedImages().getImage(ISharedImages.IMG_OBJS_ERROR_TSK));
...
// cdInput.setImage(PlatformUI.getWorkbench().getSharedImages().getImage(ISharedImages.IMG_OBJS_ERROR_TSK));
...
// }
//
// protected void createCardinalityLine(final TabbedPropertySheetWidgetFactory widgetFactory, final Composite parametersComposite) {
// useCardinalityButton = widgetFactory.createButton(parametersComposite, Messages.multiInstance_useCardinality, SWT.RADIO);
// final ControlDecoration cd = new ControlDecoration(useCardinalityButton, SWT.RIGHT, parametersComposite);
...
// }
//
// protected ComboViewer createChooser(final TabbedPropertySheetWidgetFactory widgetFactory, final Composite inputOutputDataComposite) {
...
// final ToolBar toolBar = new ToolBar(inputOutputDataComposite, SWT.FLAT);
...
// }
//
// protected void createLoopParameterComposite(final TabbedPropertySheetWidgetFactory widgetFactory) {
// final Composite loopParametersComposite = widgetFactory.createComposite(loopComposite, SWT.NONE);
...
// });
//
// widgetFactory.createLabel(loopParametersComposite, Messages.loopConditionLabel).setLayoutData(
// GridDataFactory.fillDefaults().align(SWT.END, SWT.CENTER).create());
// loopConditionViewer = new ExpressionViewer(loopParametersComposite, SWT.BORDER, widgetFactory, editingDomain,
// ProcessPackage.Literals.ACTIVITY__LOOP_CONDITION);
...
// ExpressionConstants.PARAMETER_TYPE,
// ExpressionConstants.SCRIPT_TYPE }));
// loopConditionViewer.addFilter(new DisplayEngineExpressionWithName(new String[] { org.bonitasoft.engine.expression.ExpressionConstants.LOOP_COUNTER
// .getEngineConstantName() }));
// loopConditionViewer.addFilter(new StepDataViewerFilter());
//
// widgetFactory.createLabel(loopParametersComposite, Messages.maximumLoopLabel).setLayoutData(
// GridDataFactory.fillDefaults().align(SWT.END, SWT.CENTER).create());
...
// }
//
// protected void createFirstLevelRadioButtons(final TabbedPropertySheetWidgetFactory widgetFactory, final Composite radioComposite) {
...
// final MultiInstantiation res = ProcessFactory.eINSTANCE.createMultiInstantiation();
...
// final Command cmd = new SetCommand(editingDomain, activity, ProcessPackage.Literals.ACTIVITY__MULTI_INSTANTIATION, res);
...
// context.bindValue(ViewersObservables.observeSingleSelection(collectionDataChooser), EMFEditObservables.observeValue(editingDomain, multiInstantiation,
...
// EMFEditProperties.value(editingDomain, ProcessPackage.Literals.MULTI_INSTANTIATION__LIST_DATA_CONTAINING_OUTPUT_RESULTS).observe(
// multiInstantiation));
//
// /* Input Data Chooser */
