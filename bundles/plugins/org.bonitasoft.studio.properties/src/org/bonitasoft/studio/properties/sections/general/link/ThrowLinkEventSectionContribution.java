...
public class ThrowLinkEventSectionContribution implements
	...
	public void createControl(Composite composite,
		...
		List<CatchLinkEvent> events = new ArrayList<CatchLinkEvent>();
		...
		IViewerObservableValue comboViewerObservable = ViewersObservables.observeSingleSelection(combo);
		IObservableValue toObservableValue = EMFEditObservables.observeValue(editingDomain, throwLinkElement,  ProcessPackage.Literals.THROW_LINK_EVENT__TO);
	...
	public void setEObject(EObject object) {
		this.throwLinkElement = (ThrowLinkEvent) object ;
	}
