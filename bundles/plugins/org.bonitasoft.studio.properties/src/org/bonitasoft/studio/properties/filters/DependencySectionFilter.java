...
public class DependencySectionFilter implements IFilter {

	public boolean select(Object object) {
		if (object instanceof IGraphicalEditPart) {
			IGraphicalEditPart editPart = (IGraphicalEditPart) object;
			Object model = editPart.resolveSemanticElement();	
			return (model instanceof AbstractProcess  || model instanceof Lane) && BonitaProfilesManager.getInstance().isEnabled(IBonitaActivitiesCategory.DEPENDENCIES_MANAGEMENT);
		}
		return false;
	}
