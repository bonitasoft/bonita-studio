...
public class HasDataFilter implements IFilter {
	...
	public boolean select(Object object) {
		if (object instanceof IGraphicalEditPart) {
			...
			return BonitaProfilesManager.getInstance().isEnabled(IBonitaActivitiesCategory.DATA_MANAGEMENT) && (eObject.eClass().getEAllStructuralFeatures().contains(ProcessPackage.Literals.DATA_AWARE__DATA) || eObject instanceof Lane);
