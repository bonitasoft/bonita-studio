 ...
 */
package org.bonitasoft.studio.properties.sections.forms.filters;
 ...
 */
public class OverviewFormsSectionFilter implements IFilter {
	...
	public boolean select(Object toTest) {
		if (toTest instanceof IGraphicalEditPart) {
			...
			return model instanceof RecapFlow
			|| (model instanceof Lane && ((Lane)model).eContainer() instanceof RecapFlow);
		}
		return false;
	}
