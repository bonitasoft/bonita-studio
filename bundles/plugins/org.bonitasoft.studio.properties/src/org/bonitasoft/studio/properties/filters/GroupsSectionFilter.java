 ...
 * Filter to display/hide groups section (AbstractProcess and Lane)
 */
public class GroupsSectionFilter implements IFilter {
	...
	public boolean select(Object toTest) {
		if (toTest instanceof IGraphicalEditPart) {
			...
			return model instanceof AbstractProcess ;
		}
		return false;
	}
