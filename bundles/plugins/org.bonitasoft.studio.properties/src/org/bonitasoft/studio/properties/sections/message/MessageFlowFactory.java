...
public class MessageFlowFactory {
    ...
    //
    //	private static EditPart findContainingEditPart(EObject element,EObject event,IGraphicalEditPart selectedEditPart) {
    //		// event and eObject are not in the same resource instance,
    //		// then need to retrieve a location
    //		XMIResource eventXmiResource = (XMIResource)event.eResource();
    //		String flowElementURI = eventXmiResource.getURIFragment(element);
    //		XMIResource diagramXmiResource = (XMIResource)element.eResource();
    //		EObject diagramObject = diagramXmiResource.getEObject(flowElementURI);
    //		EditPart containingProcess =(IGraphicalEditPart) selectedEditPart;
    //		while (! (containingProcess instanceof DiagramEditPart)) {
    //			containingProcess = containingProcess.getParent();
    //		}
    //		DiagramEditPart diagramPart = (DiagramEditPart)containingProcess;
    ...
    private static EditPart findEditPart(EditPart diagramEditPart,Element elementToFind) {
        ...
        //				}else{
        //					EditPart ep = findEditPart((EditPart)child,elementToFind) ;
        //					if(ep!= null){
        //						return ep ;
        //					}
        //				}
