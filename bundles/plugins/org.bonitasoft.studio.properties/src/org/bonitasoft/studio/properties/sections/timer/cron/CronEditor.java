...
public class CronEditor extends Composite {
	...
	protected void createYearyTab(TabFolder tablFolder) {
		...
		monthComboStrategy2.setConverter(new Converter(Integer.class,String.class){
			...
			public Object convert(Object fromObject) {
				...
				switch (value) {
				case 1:return Messages.january;
				case 2:return Messages.february;
				case 3:return Messages.march;
				case 4:return Messages.april;
				case 5:return Messages.may;
				case 6:return Messages.june;
				case 7:return Messages.july;
				case 8:return Messages.august;
				case 9:return Messages.september;
				case 10:return Messages.october;
				case 11:return Messages.november;
				case 12:return Messages.december;
				default:
					break;
				}
		...
		dayComboStrategy2.setConverter(new Converter(Integer.class,String.class){
			...
			public Object convert(Object fromObject) {
				Integer value = (Integer) fromObject;
				switch (value) {
				case 1:return Messages.monday;
				case 2:return Messages.tuesday;
				case 3:return Messages.wednesday;
				case 4:return Messages.thursday;
				case 5:return Messages.friday;
				case 6:return Messages.saturday;
				case 7:return Messages.sunday;
				default:
					break;
				}
		...
		context.bindValue(SWTObservables.observeText(monthCombo2),
				PojoProperties.value("monthOfYearForYearly").observe(cronExpression), monthCombo2Strategy,monthCombo2Strategy2);
	...
	protected void createWeeklyTab(TabFolder tablFolder) {
		...
		context.bindValue(SWTObservables.observeSelection(mondayButton), PojoProperties.value("onMonday").observe(cronExpression));


		final Button tuesdayButton = new Button(weeklyContent, SWT.CHECK);
		tuesdayButton.setText(Messages.tuesday);
		context.bindValue(SWTObservables.observeSelection(tuesdayButton), PojoProperties.value("onTuesday").observe(cronExpression));

		final Button wednesdayButton = new Button(weeklyContent, SWT.CHECK);
		wednesdayButton.setText(Messages.wednesday);
		context.bindValue(SWTObservables.observeSelection(wednesdayButton), PojoProperties.value("onWednesday").observe(cronExpression));

		final Button thursdayButton = new Button(weeklyContent, SWT.CHECK);
		thursdayButton.setText(Messages.thursday);
		context.bindValue(SWTObservables.observeSelection(thursdayButton), PojoProperties.value("onThursday").observe(cronExpression));

		final Button fridayButton = new Button(weeklyContent, SWT.CHECK);
		fridayButton.setText(Messages.friday);
		context.bindValue(SWTObservables.observeSelection(fridayButton), PojoProperties.value("onFriday").observe(cronExpression));

		final Button saturdayButton = new Button(weeklyContent, SWT.CHECK);
		saturdayButton.setText(Messages.saturday);
		context.bindValue(SWTObservables.observeSelection(saturdayButton), PojoProperties.value("onSaturday").observe(cronExpression));

		final Button sundayButton = new Button(weeklyContent, SWT.CHECK);
		sundayButton.setText(Messages.sunday);
		context.bindValue(SWTObservables.observeSelection(sundayButton), PojoProperties.value("onSunday").observe(cronExpression));
		...
		createStartTimeComposite(weeklyContent, hourObservable, minuteObservable, secondObservable).setLayoutData(GridDataFactory.fillDefaults().grab(true, true).span(4, 1).create());
