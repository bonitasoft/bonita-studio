 ...
 *
 */
public class UserXPTabFilter implements IFilter {
    ...
    public boolean select(Object object) {
        if (object instanceof IGraphicalEditPart) {
            ...
            return model instanceof FlowElement && !(model instanceof TextAnnotation) && !(model instanceof BoundaryEvent) &&  !(model instanceof Connection) && !(model instanceof MessageFlow) && BonitaProfilesManager.getInstance().isEnabled(IBonitaActivitiesCategory.EXECUTION);
        }
        return false;
    }
