 ...
 *
 */
public class BusinessDataMappingViewerFilter extends ViewerFilter {
	...
	public boolean select(Viewer viewer, Object parentElement, Object element) {
		if(element instanceof WidgetMapping){
			Object modelElement = ((WidgetMapping) element).getModelElement();
			return !(modelElement instanceof BusinessObjectData);
		}
		return false;
	}
