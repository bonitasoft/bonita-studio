...
public class DuplicateFormCommandTest {
	...
	public void setUp() throws Exception {
		...
		CheckBoxMultipleFormField checkBoxMultipleFormField = FormFactory.eINSTANCE.createCheckBoxMultipleFormField();
		...
		checkBoxMultipleFormField.setDisplayDependentWidgetOnlyAfterFirstEventTriggeredAndCondition(ExpressionHelper.createConstantExpression("sdf<", String.class.getName()));
		...
		TextFormField textFieldWidget = FormFactory.eINSTANCE.createTextFormField();
		...
		textFieldWidget.setDisplayDependentWidgetOnlyAfterFirstEventTriggeredAndCondition(ExpressionHelper.createConstantExpression("qdsqsd", String.class.getName()));
		
		
		// creation of a widget dependency
		WidgetDependency depends = FormFactory.eINSTANCE.createWidgetDependency();
	...
	public void shouldcleanWidgetsContingenciesPropertiesOfForm_RemoveWidgetContingencies() throws Exception {
		...
		List<Widget> widgets = templateForm.getWidgets();
	...
	private static void isExpressionEmpty(Expression expr){
