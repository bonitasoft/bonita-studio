...
public class BusinessDataMappingViewerFilterTest {
    ...
    private BusinessDataMappingViewerFilter filterUnderTest;
    ...
    public void setUp() throws Exception {
        filterUnderTest = new BusinessDataMappingViewerFilter();
    }
    ...
    public void shouldSelect_ReturnTrue() throws Exception {
        ...
        assertThat(filterUnderTest.select(null, null, mapping)).isTrue();
