 ...
 */
public class ImageWidgetInitialValueContribution extends InitialValueContribution
        ...
        if (expressionViewer != null && !expressionViewer.getControl().isDisposed()) {
            ...
            if (input == null) {
                ...
                editingDomain.getCommandStack().execute(
                        SetCommand.create(editingDomain, widget, FormPackage.Literals.IMAGE_WIDGET__IMG_PATH, input));
            }
    ...
    protected AvailableExpressionTypeFilter getExpressionViewerFilter() {
        final AvailableExpressionTypeFilter filter = super.getExpressionViewerFilter();
