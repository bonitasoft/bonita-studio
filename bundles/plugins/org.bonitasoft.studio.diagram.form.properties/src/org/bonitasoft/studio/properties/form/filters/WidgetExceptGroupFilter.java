...
public class WidgetExceptGroupFilter implements IFilter {

	public boolean select(Object object) {
		if (object instanceof IGraphicalEditPart) {
			IGraphicalEditPart editPart = (IGraphicalEditPart) object;
			Object model = editPart.resolveSemanticElement();
			return model instanceof Widget && !(model instanceof Group) && !(model instanceof HiddenWidget) && !(model instanceof IFrameWidget);
		}
		return false;
	}
