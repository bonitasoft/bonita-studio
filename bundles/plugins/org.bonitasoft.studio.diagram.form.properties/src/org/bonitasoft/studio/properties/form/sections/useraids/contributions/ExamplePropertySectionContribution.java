...
IExtensibleGridPropertySectionContribution {
    ...
    public void createControl(Composite composite,
        ...
        ExpressionViewer exampleMessageViewer = new ExpressionViewer(composite, SWT.BORDER, widgetFactory,editingDomain, FormPackage.Literals.FORM_FIELD__EXAMPLE_MESSAGE);
        ...
        if(exampleMessageExpression == null){
            ...
            editingDomain.getCommandStack().execute(SetCommand.create(editingDomain, element, FormPackage.Literals.FORM_FIELD__EXAMPLE_MESSAGE, exampleMessageExpression));
        }
        ...
        exampleMessageViewer.addFilter(new AvailableExpressionTypeFilter(new String[]{ExpressionConstants.CONSTANT_TYPE,ExpressionConstants.VARIABLE_TYPE,ExpressionConstants.PARAMETER_TYPE,ExpressionConstants.SCRIPT_TYPE}));
        ...
        dataBindingContext.bindValue(ViewersObservables.observeSingleSelection(positionViewer), EMFEditObservables.observeValue(editingDomain, element, FormPackage.Literals.FORM_FIELD__EXAMPLE_MESSAGE_POSITION));
    }
