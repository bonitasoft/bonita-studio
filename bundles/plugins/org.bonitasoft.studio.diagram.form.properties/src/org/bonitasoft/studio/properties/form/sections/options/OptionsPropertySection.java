...
import org.bonitasoft.studio.properties.form.sections.options.contributions.InjectWidgetContribution;
import org.bonitasoft.studio.properties.form.sections.options.contributions.MandatoryFieldContribution;
import org.bonitasoft.studio.properties.form.sections.options.contributions.ReadOnlyContribution;
 ...
 * 
 */
public class OptionsPropertySection extends ExtensibleGridPropertySection {
	
	
	public OptionsPropertySection(){
		super();
	}
	...
	protected void addContributions() {
		...
		addContribution(new HtmlAttributesPropertySection());
		addContribution(new InjectWidgetContribution());
		addContribution(new MandatoryFieldContribution());
		addContribution(new ReadOnlyContribution());
