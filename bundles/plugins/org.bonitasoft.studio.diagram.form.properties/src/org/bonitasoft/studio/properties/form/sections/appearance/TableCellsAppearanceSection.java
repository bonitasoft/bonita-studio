 ...
 *
 */
public class TableCellsAppearanceSection extends AppearancePropertySection {
	...
	public void createControls(Composite parent, TabbedPropertySheetPage aTabbedPropertySheetPage) {
		...
		addSizeGroup(tabInputContents, ExporterTools.PREFIX_TABLE_CELLS, 1, 1);
		addCustomStyleGroup(tabInputContents, ExporterTools.PREFIX_TABLE_CELLS, 1, 2);
		addFontGroup(tabInputContents, ExporterTools.PREFIX_TABLE_CELLS, 1, 1);
		addTextGroup(tabInputContents, ExporterTools.PREFIX_TABLE_CELLS, 1, 1);
