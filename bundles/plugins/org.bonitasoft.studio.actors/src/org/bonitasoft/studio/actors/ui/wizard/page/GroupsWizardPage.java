        ...
        if(selectedGroup != null){
            ...
            for(Membership m : membershipList){
                if(selectedGroup.getName() != null && selectedGroup.getName().equals(m.getGroupName())
                        && selectedGroup.getParentPath() != null && selectedGroup.getParentPath().equals(m.getGroupParentPath())){
                    groupMemberShips.add(m) ;
                }
            }


            IObservableValue value = EMFObservables.observeValue(selectedGroup, OrganizationPackage.Literals.GROUP__NAME) ;
            ...
            context.bindValue(SWTObservables.observeText(groupNameText,SWT.Modify),value,strategy,new UpdateValueStrategy()) ;
