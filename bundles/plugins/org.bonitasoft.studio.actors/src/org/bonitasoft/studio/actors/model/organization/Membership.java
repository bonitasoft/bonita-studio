 ...
 * <ul>
 *   <li>{@link org.bonitasoft.studio.actors.model.organization.Membership#getUserName <em>User Name</em>}</li>
 *   <li>{@link org.bonitasoft.studio.actors.model.organization.Membership#getRoleName <em>Role Name</em>}</li>
 *   <li>{@link org.bonitasoft.studio.actors.model.organization.Membership#getGroupName <em>Group Name</em>}</li>
 *   <li>{@link org.bonitasoft.studio.actors.model.organization.Membership#getGroupParentPath <em>Group Parent Path</em>}</li>
 *   <li>{@link org.bonitasoft.studio.actors.model.organization.Membership#getAssignedBy <em>Assigned By</em>}</li>
 *   <li>{@link org.bonitasoft.studio.actors.model.organization.Membership#getAssignedDate <em>Assigned Date</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.bonitasoft.studio.actors.model.organization.OrganizationPackage#getMembership()
