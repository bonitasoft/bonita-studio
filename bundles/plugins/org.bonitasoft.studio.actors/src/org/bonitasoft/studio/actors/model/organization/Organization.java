 ...
 *   <li>{@link org.bonitasoft.studio.actors.model.organization.Organization#getMemberships <em>Memberships</em>}</li>
 *   <li>{@link org.bonitasoft.studio.actors.model.organization.Organization#getName <em>Name</em>}</li>
 *   <li>{@link org.bonitasoft.studio.actors.model.organization.Organization#getDescription <em>Description</em>}</li>
 *   <li>{@link org.bonitasoft.studio.actors.model.organization.Organization#getModelVersion <em>Model Version</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.bonitasoft.studio.actors.model.organization.OrganizationPackage#getOrganization()
...
public interface Organization extends EObject {
     ...
     * @see #setUsers(Users)
     * @see org.bonitasoft.studio.actors.model.organization.OrganizationPackage#getOrganization_Users()
     * @model containment="true"
	...
	/**
     * Sets the value of the '{@link org.bonitasoft.studio.actors.model.organization.Organization#getUsers <em>Users</em>}' containment reference.
     * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
     ...
     * @see #setRoles(Roles)
     * @see org.bonitasoft.studio.actors.model.organization.OrganizationPackage#getOrganization_Roles()
     * @model containment="true"
	...
	/**
     * Sets the value of the '{@link org.bonitasoft.studio.actors.model.organization.Organization#getRoles <em>Roles</em>}' containment reference.
     * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
     ...
     * @see org.bonitasoft.studio.actors.model.organization.OrganizationPackage#getOrganization_Memberships()
     * @model containment="true"
	...
	/**
     * Sets the value of the '{@link org.bonitasoft.studio.actors.model.organization.Organization#getMemberships <em>Memberships</em>}' containment reference.
     * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
     ...
     * @see org.bonitasoft.studio.actors.model.organization.OrganizationPackage#getOrganization_ModelVersion()
     * @model
     * @generated
     */
    ...
    /**
     * Sets the value of the '{@link org.bonitasoft.studio.actors.model.organization.Organization#getModelVersion <em>Model Version</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
