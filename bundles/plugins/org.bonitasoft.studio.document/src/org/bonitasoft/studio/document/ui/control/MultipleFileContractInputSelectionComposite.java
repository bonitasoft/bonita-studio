...
public class MultipleFileContractInputSelectionComposite extends FileContractInputSelectionComposite {

    public MultipleFileContractInputSelectionComposite(final Composite parent) {
        super(parent);
    }
    ...
    protected ValidationStatusProvider createContractInputParameter(final Document document, final IObservableValue observeInput,
        ...
        return new MultipleContractInputValidator(document, observeSingleSelection, observeInput);
    }
