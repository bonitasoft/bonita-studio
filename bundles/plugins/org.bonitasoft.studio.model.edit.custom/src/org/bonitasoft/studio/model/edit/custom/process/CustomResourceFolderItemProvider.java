...
import org.bonitasoft.studio.model.process.provider.ResourceFolderItemProvider;
 ...
 *
 */
public class CustomResourceFolderItemProvider extends ResourceFolderItemProvider {

	public CustomResourceFolderItemProvider(AdapterFactory adapterFactory) {
		super(adapterFactory);
	}
	
	@Override
	public String getText(Object object) {
		String path = ((ResourceFolder) object).getPath() ;
