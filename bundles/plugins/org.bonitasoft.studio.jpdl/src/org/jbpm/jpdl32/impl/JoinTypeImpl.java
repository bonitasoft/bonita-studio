 ...
 * <ul>
 *   <li>{@link org.jbpm.jpdl32.impl.JoinTypeImpl#getNodeContentElements <em>Node Content Elements</em>}</li>
 *   <li>{@link org.jbpm.jpdl32.impl.JoinTypeImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.jbpm.jpdl32.impl.JoinTypeImpl#getEvent <em>Event</em>}</li>
 *   <li>{@link org.jbpm.jpdl32.impl.JoinTypeImpl#getExceptionHandler <em>Exception Handler</em>}</li>
 *   <li>{@link org.jbpm.jpdl32.impl.JoinTypeImpl#getTimer <em>Timer</em>}</li>
 *   <li>{@link org.jbpm.jpdl32.impl.JoinTypeImpl#getTransition <em>Transition</em>}</li>
 *   <li>{@link org.jbpm.jpdl32.impl.JoinTypeImpl#getAsync <em>Async</em>}</li>
 *   <li>{@link org.jbpm.jpdl32.impl.JoinTypeImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class JoinTypeImpl extends EObjectImpl implements JoinType {
	...
	protected EClass eStaticClass() {
		return jpdl32Package.Literals.JOIN_TYPE;
	}
	...
	public FeatureMap getNodeContentElements() {
		if (nodeContentElements == null) {
			nodeContentElements = new BasicFeatureMap(this, jpdl32Package.JOIN_TYPE__NODE_CONTENT_ELEMENTS);
		}
	...
	public EList<String> getDescription() {
		return getNodeContentElements().list(jpdl32Package.Literals.JOIN_TYPE__DESCRIPTION);
	}
	...
	public EList<EventType> getEvent() {
		return getNodeContentElements().list(jpdl32Package.Literals.JOIN_TYPE__EVENT);
	}
	...
	public EList<ExceptionHandlerType> getExceptionHandler() {
		return getNodeContentElements().list(jpdl32Package.Literals.JOIN_TYPE__EXCEPTION_HANDLER);
	}
	...
	public EList<TimerType> getTimer() {
		return getNodeContentElements().list(jpdl32Package.Literals.JOIN_TYPE__TIMER);
	}
	...
	public EList<TransitionType> getTransition() {
		return getNodeContentElements().list(jpdl32Package.Literals.JOIN_TYPE__TRANSITION);
	}
	...
	public void setAsync(String newAsync) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, jpdl32Package.JOIN_TYPE__ASYNC, oldAsync, async, !oldAsyncESet));
	}
	...
	public void unsetAsync() {
		...
		asyncESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, jpdl32Package.JOIN_TYPE__ASYNC, oldAsync, ASYNC_EDEFAULT, oldAsyncESet));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, jpdl32Package.JOIN_TYPE__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case jpdl32Package.JOIN_TYPE__NODE_CONTENT_ELEMENTS:
				return ((InternalEList<?>)getNodeContentElements()).basicRemove(otherEnd, msgs);
			case jpdl32Package.JOIN_TYPE__EVENT:
				return ((InternalEList<?>)getEvent()).basicRemove(otherEnd, msgs);
			case jpdl32Package.JOIN_TYPE__EXCEPTION_HANDLER:
				return ((InternalEList<?>)getExceptionHandler()).basicRemove(otherEnd, msgs);
			case jpdl32Package.JOIN_TYPE__TIMER:
				return ((InternalEList<?>)getTimer()).basicRemove(otherEnd, msgs);
			case jpdl32Package.JOIN_TYPE__TRANSITION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case jpdl32Package.JOIN_TYPE__DESCRIPTION:
			...
			case jpdl32Package.JOIN_TYPE__ASYNC:
				return getAsync();
			case jpdl32Package.JOIN_TYPE__NAME:
				return getName();
		}
