...
public class BosArchiveProcessorTest {
    ...
    public void testGetStatusOkBasic() throws MalformedURLException, IOException, Exception {
        mockStatus(IStatus.OK, IStatus.OK);
    ...
    public void testGetStatusErrorForValidationOKForRun() throws MalformedURLException, IOException, Exception {
        mockStatus(IStatus.ERROR, IStatus.OK);
    ...
    public void testGetStatusErrorForValidationErrorForRun() throws MalformedURLException, IOException, Exception {
        mockStatus(IStatus.ERROR, IStatus.ERROR);
    ...
    public void testGetStatusOkForValidationErrorForRun() throws MalformedURLException, IOException, Exception {
        mockStatus(IStatus.OK, IStatus.ERROR);
    ...
    private void mockStatus(final int validationSTatusType, final int runValidationStatusType) {
        Mockito.doReturn(new Status(validationSTatusType, "pluginId.test", "message")).when(ibo).getValidationsStatus();
        Mockito.doReturn(new Status(runValidationStatusType, "pluginId.test", "message")).when(ibo).run(Mockito.any(NullProgressMonitor.class));
    }
