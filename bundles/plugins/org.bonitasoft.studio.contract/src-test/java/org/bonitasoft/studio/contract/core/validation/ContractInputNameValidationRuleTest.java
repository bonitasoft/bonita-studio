 ...
 *
 */
public class ContractInputNameValidationRuleTest {

    private ContractInputNameValidationRule validationRule;
    ...
    public void setUp() throws Exception {
        validationRule = new ContractInputNameValidationRule();
    }
    ...
    @Test
    public void should_validate_a_input_returns_an_error_status_for_invalid_input() throws Exception {
        final Contract contract = ProcessFactory.eINSTANCE.createContract();
        final ContractInput input = addInput(contract, "", ContractInputType.TEXT, null);
        final IStatus status = validationRule.validate(input);
