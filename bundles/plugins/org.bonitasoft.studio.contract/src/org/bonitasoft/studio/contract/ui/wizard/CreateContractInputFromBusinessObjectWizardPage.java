...
public class CreateContractInputFromBusinessObjectWizardPage extends WizardPage {
    ...
    public void setMannuallyDefinedOperation() {
        if (contract.eContainer() instanceof Task) {
    ...
    public boolean getIsAutogeneratedOperation() {
        return contract.eContainer() instanceof OperationContainer ? isAutogeneratedOperation : false;
    }
    ...
    public boolean getIsAutogeneratedScript() {
        return contract.eContainer() instanceof Pool ? isAutogeneratedScript : false;
    }
