...
public class CreateContractInputFromBusinessObjectWizardPage extends WizardPage {
    ...
    private boolean isAutogeneratedOperation;
    private boolean isAutogeneratedScript;
    ...
    private void createReminderText(final EMFDataBindingContext dbc, final Composite composite) {
        ...
        if (contract.eContainer() instanceof Task) {
            ...
            dbc.bindValue(SWTObservables.observeSelection(autoGeneratedOperationButton), PojoObservables.observeValue(this, "isAutogeneratedOperation"));
        } else {
            ...
            dbc.bindValue(SWTObservables.observeSelection(autoGeneratedOperationButton), PojoObservables.observeValue(this, "isAutogeneratedScript"));
        }
