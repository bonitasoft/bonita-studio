 ...
 *
 */
public class ContractInputColumnViewerEditorActivationStrategy extends ColumnViewerEditorActivationStrategy {

    public ContractInputColumnViewerEditorActivationStrategy(final ColumnViewer viewer) {
        super(viewer);
    }
