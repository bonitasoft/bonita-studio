...
public class ConstraintExpressionCellLabelProvider extends PropertyColumnLabelProvider {
    ...
    public ConstraintExpressionCellLabelProvider(final ColumnViewer viewer, final IPropertySourceProvider propertySourceProvider) {
    ...
    public Image getImage(final Object element) {
        final String expression = ((ContractConstraint) element).getExpression();
        final IStatus status = validator.validateConstraintExpression((ContractConstraint) element, expression);
        if (!status.isOK()) {
