...
public class TaskContractEngineDefinitionBuilder extends ContractEngineDefinitionBuilder<UserTaskDefinitionBuilder> {
    ...
    public boolean appliesTo(final EObject context, final EObject element) {
        return context instanceof Task && super.appliesTo(context, element);
    }
}
