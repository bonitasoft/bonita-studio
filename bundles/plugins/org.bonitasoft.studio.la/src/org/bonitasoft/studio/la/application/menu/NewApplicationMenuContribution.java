...
public class NewApplicationMenuContribution extends ContributionItem {

    private static final String NEW_COMMAND = "org.bonitasoft.studio.la.new.command";

    private CommandExecutor commandExecutor;

    public NewApplicationMenuContribution() {
    ...
    public void fill(Menu parent, int index) {
        ...
        item.setText(Messages.applicationDescriptor);
        item.addListener(SWT.Selection, e -> commandExecutor.executeCommand(NEW_COMMAND, null));
        item.setEnabled(true);
        item.setImage(Pics.getImage(PicsConstants.application));
    }
