 ...
 */
public interface ArchetypeConfigurationWithClassName extends ArchetypeConfiguration {

    /** className attribute key, for internal use */
    ...
    default void setClassName(String className) {
        setAttribute(CLASS_NAME_ATTRIBUTE, className);
    }
