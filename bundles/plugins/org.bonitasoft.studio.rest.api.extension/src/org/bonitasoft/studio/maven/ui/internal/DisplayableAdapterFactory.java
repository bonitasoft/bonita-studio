...
/**
 * Adapts {@link CustomPageProjectFileStore} to {@link IDisplayable}
 * 
...
public class DisplayableAdapterFactory implements IAdapterFactory {
    ...
    public <T> T getAdapter(Object adaptableObject, Class<T> adapterType) {
        if (adapterType.isAssignableFrom(IDisplayable.class) && adaptableObject instanceof CustomPageProjectFileStore) {
