...
public class ActorTabbedPropertyProvider extends ProcessGeneralTabbedPropertySelectionProvider {
    ...
    public boolean appliesTo(final EObject element, final IEditorReference activeEditor) {
        return element instanceof Actor || ModelHelper.getFirstContainerOfType(element, ActorFilter.class) != null;
    }
