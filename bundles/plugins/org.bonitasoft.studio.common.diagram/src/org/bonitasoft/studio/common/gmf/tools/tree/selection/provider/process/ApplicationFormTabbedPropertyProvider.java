...
public class ApplicationFormTabbedPropertyProvider extends ApplicationViewTabbedPropertySelectionProvider implements ITabbedSectionPropertyProvider {

    @Override
    public String tabId(final EObject element) {
        return ModelHelper.getFirstContainerOfType(element, Form.class) instanceof ViewForm ? "tab.forms.overview" : "tab.forms.entry";
    }
