...
public class ActivityNameCursorMouseMotionListener implements MouseMotionListener {

    private final AbstractEditPart editPart;

    public ActivityNameCursorMouseMotionListener(AbstractEditPart editPart) {
