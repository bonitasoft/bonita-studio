...
public class ValidatorTabbedPropertyProvider extends FormGeneralTabbedPropertySelectionProvider {
    ...
    public boolean appliesTo(final EObject element, final IEditorReference activeEditor) {
        return ModelHelper.getFirstContainerOfType(element, Validator.class) != null && isFormDiagramEditor(activeEditor);
    }
