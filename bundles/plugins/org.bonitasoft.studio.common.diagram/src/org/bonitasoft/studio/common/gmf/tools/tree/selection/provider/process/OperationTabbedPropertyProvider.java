...
public class OperationTabbedPropertyProvider extends ExecutionViewTabbedPropertySelectionProvider {
    ...
    public boolean appliesTo(final EObject element, final IEditorReference activeEditor) {
        ...
        return operation != null && operation.eContainingFeature().equals(ProcessPackage.Literals.OPERATION_CONTAINER__OPERATIONS);
    }
