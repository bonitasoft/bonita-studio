...
public class DocumentTabbedPropertyProvider extends DataViewTabbedPropertySelectionProvider {
    ...
    public boolean appliesTo(final EObject element, final IEditorReference activeEditor) {
        return ModelHelper.getFirstContainerOfType(element, Document.class) != null;
    }
}
