...
public class ButtonActionTabbedPropertyProvider extends FormGeneralTabbedPropertySelectionProvider {
    ...
    public boolean appliesTo(final EObject element, final IEditorReference activeEditor) {
        ...
        return operation != null && operation.eContainingFeature().equals(FormPackage.Literals.SUBMIT_FORM_BUTTON__ACTIONS)
