...
public class FormGeneralTabbedPropertyProvider extends FormGeneralTabbedPropertySelectionProvider {
    ...
    public boolean appliesTo(final EObject element, final IEditorReference activeEditor) {
        return (element instanceof Form || element instanceof Widget) && isFormDiagramEditor(activeEditor);
    }
