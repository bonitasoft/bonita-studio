...
public class KPITabbedPropertyProvider extends ExecutionViewTabbedPropertySelectionProvider {
    ...
    public boolean appliesTo(final EObject element, final IEditorReference activeEditor) {
        return ModelHelper.getFirstContainerOfType(element, AbstractKPIBinding.class) != null;
    }
