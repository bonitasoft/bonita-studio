...
public class BonitaTabsPresentationFactory extends WorkbenchPresentationFactory {
	...
	public StackPresentation createViewPresentation(Composite parent,
		...
		final DefaultTabFolder folder = new DefaultTabFolder(parent, PlatformUI.getPreferenceStore()
		...
		Display.getDefault().addFilter(SWT.MouseDoubleClick, new Listener() {

			public void handleEvent(Event event) {
				if(folder.getControl().equals(event.widget)){
					event.type = SWT.None;	
					event.doit=false;
				}
			}
