...
public class DocumentConverterConnectorConfigurationWizardPage extends FilteredGeneratedConnectorConfigurationWizardPage {

    private static final String OUTPUT_FILE_NAME_INPUT = "outputFileName";

    public DocumentConverterConnectorConfigurationWizardPage() {
