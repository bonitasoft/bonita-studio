...
public class DocumentConverterConnectorOutputWizardPage extends AbstractOfficeConnectorOutputWizardPage {

    private static final String OUTPUT_FILE_NAME_INPUT = "outputFileName";

    public DocumentConverterConnectorOutputWizardPage() {
    ...
    protected String getExampleOutputFilenameText() {
        return Messages.pdfOutputFileNameExample;
    }
