 ...
 * 
 */
public class SalesForceCreateObjectConnectorMapper extends
		AbstractConnectorDefinitionMapper implements IConnectorDefinitionMapper {

	private static final String SALESFORCE_CONNECTOR_DEFINITION_ID = "salesforce-createsobject";
	private static final String LEGACY_SALESFORCE_CONNECTOR_ID = "CreateSObjectConnector";
