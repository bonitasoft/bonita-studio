 ...
 *
 */
public class BarImporterFactory extends ImporterFactory {


    public BarImporterFactory() {
     ...
     */
    @Override
    public boolean appliesTo(String resourceName, InputStream is) {
        return resourceName.endsWith(".bar");
    }
     ...
     */
    @Override
    public ToProcProcessor createProcessor(String resourceName) {
        return new EdaptBarToProcProcessor();
    }
