 ...
 * 
 */
public class TwitterDirectConnectorMapper extends
		AbstractConnectorDefinitionMapper implements IConnectorDefinitionMapper {

	private static final String TWITTER_CONNECTOR_DEFINITION_ID = "twitter-direct";
	private static final String LEGACY_TWITTER_CONNECTOR_ID = "TwitterDirectMessageOAuth";
