 ...
 * 
 */
public class SalesForceRetrieveObjectsConnectorMapper extends
		AbstractConnectorDefinitionMapper implements IConnectorDefinitionMapper {

	private static final String SALESFORCE_CONNECTOR_DEFINITION_ID = "salesforce-retrievesobjects";
	private static final String LEGACY_SALESFORCE_CONNECTOR_ID = "RetrieveSObjectsConnector";
