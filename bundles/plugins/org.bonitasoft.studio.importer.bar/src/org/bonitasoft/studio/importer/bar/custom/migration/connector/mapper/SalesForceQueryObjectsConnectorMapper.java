 ...
 * 
 */
public class SalesForceQueryObjectsConnectorMapper extends
		AbstractConnectorDefinitionMapper implements IConnectorDefinitionMapper {

	private static final String SALESFORCE_CONNECTOR_DEFINITION_ID = "salesforce-querysobjects";
	private static final String LEGACY_SALESFORCE_CONNECTOR_ID = "QuerySObjectsConnector";
