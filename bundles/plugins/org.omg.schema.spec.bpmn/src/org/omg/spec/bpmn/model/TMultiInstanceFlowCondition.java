...
public enum TMultiInstanceFlowCondition implements Enumerator {
	 ...
	 * @generated
	 */
	private static final TMultiInstanceFlowCondition[] VALUES_ARRAY =
		new TMultiInstanceFlowCondition[] {
			NONE,
			ONE,
			ALL,
			COMPLEX,
	 ...
	 * @generated
	 */
	public static final List<TMultiInstanceFlowCondition> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
