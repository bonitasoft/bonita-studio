 ...
 * <ul>
 *   <li>{@link org.omg.spec.bpmn.model.impl.TDataObjectImpl#getDataState <em>Data State</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.model.impl.TDataObjectImpl#isIsCollection <em>Is Collection</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.model.impl.TDataObjectImpl#getItemSubjectRef <em>Item Subject Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TDataObjectImpl extends TFlowElementImpl implements TDataObject {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.TDATA_OBJECT;
	}
	...
	public NotificationChain basicSetDataState(TDataState newDataState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.TDATA_OBJECT__DATA_STATE, oldDataState, newDataState);
	...
	public void setDataState(TDataState newDataState) {
		if (newDataState != dataState) {
			...
			if (dataState != null)
				msgs = ((InternalEObject)dataState).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.TDATA_OBJECT__DATA_STATE, null, msgs);
			if (newDataState != null)
				msgs = ((InternalEObject)newDataState).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.TDATA_OBJECT__DATA_STATE, null, msgs);
			msgs = basicSetDataState(newDataState, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TDATA_OBJECT__DATA_STATE, newDataState, newDataState));
	}
	...
	public void setIsCollection(boolean newIsCollection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TDATA_OBJECT__IS_COLLECTION, oldIsCollection, isCollection, !oldIsCollectionESet));
	}
	...
	public void unsetIsCollection() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ModelPackage.TDATA_OBJECT__IS_COLLECTION, oldIsCollection, IS_COLLECTION_EDEFAULT, oldIsCollectionESet));
	}
	...
	public void setItemSubjectRef(QName newItemSubjectRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TDATA_OBJECT__ITEM_SUBJECT_REF, oldItemSubjectRef, itemSubjectRef));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.TDATA_OBJECT__DATA_STATE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.TDATA_OBJECT__DATA_STATE:
				return getDataState();
			case ModelPackage.TDATA_OBJECT__IS_COLLECTION:
				return isIsCollection();
			case ModelPackage.TDATA_OBJECT__ITEM_SUBJECT_REF:
