...
public class TConditionalEventDefinitionImpl extends TEventDefinitionImpl implements TConditionalEventDefinition {
	...
	public NotificationChain basicSetCondition(TExpression newCondition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.TCONDITIONAL_EVENT_DEFINITION__CONDITION, oldCondition, newCondition);
	...
	public void setCondition(TExpression newCondition) {
		if (newCondition != condition) {
			...
			if (condition != null)
				msgs = ((InternalEObject)condition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.TCONDITIONAL_EVENT_DEFINITION__CONDITION, null, msgs);
			if (newCondition != null)
				msgs = ((InternalEObject)newCondition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.TCONDITIONAL_EVENT_DEFINITION__CONDITION, null, msgs);
			msgs = basicSetCondition(newCondition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TCONDITIONAL_EVENT_DEFINITION__CONDITION, newCondition, newCondition));
	}
