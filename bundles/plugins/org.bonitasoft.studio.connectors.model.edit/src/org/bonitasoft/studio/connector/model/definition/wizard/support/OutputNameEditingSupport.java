 ...
 *
 */
public class OutputNameEditingSupport extends ObservableValueEditingSupport {

    private final ConnectorDefinition definition;
    private final DataBindingContext context;

    public OutputNameEditingSupport(ColumnViewer viewer,ConnectorDefinition definition,DataBindingContext context) {
    ...
    protected Binding createBinding(IObservableValue target, final IObservableValue model) {
        ...
        targetToModel.setConverter(new Converter(String.class,String.class){
            ...
            public Object convert(Object from) {
                return NamingUtils.toJavaIdentifier(from.toString(), false);
            }
    ...
    protected IObservableValue doCreateElementObservable(Object element, ViewerCell cell) {
        return EMFObservables.observeValue((EObject) element, ConnectorDefinitionPackage.Literals.OUTPUT__NAME);
    }
