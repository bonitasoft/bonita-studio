...
public class NewCategoryDialog extends Dialog {
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        ControlDecorationSupport.create(context.bindValue(SWTObservables.observeText(idText, SWT.Modify), EMFObservables.observeValue(category,ConnectorDefinitionPackage.Literals.CATEGORY__ID),idStrategy,null),SWT.LEFT) ;
