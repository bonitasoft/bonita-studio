...
public class SelectConnectorImplementationWizardPage extends WizardPage implements ISelectionChangedListener,IDoubleClickListener {
    ...
    public void createControl(Composite parent) {
        ...
        context.bindValue(ViewersObservables.observeSingleSelection(table), PojoProperties.value(SelectConnectorImplementationWizardPage.class, "selectedImplementation").observe(this),selectionStrategy,null)  ;
            ...
            public void widgetSelected(SelectionEvent e) {
                if(selectedImplementation != null){
                    ...
                    if(FileActionDialog.confirmDeletionQuestion(fileName)){
                        file.delete() ;
                        String className = selectedImplementation.getImplementationClassname() ;
