...
public abstract class AbstractImplementationWizardPage extends NewTypeWizardPage implements ISelectionChangedListener {
    ...
    public AbstractImplementationWizardPage(final ConnectorImplementation implementation,final List<ConnectorImplementation> existingImpl,final List<ConnectorDefinition> definitions,final SourceRepositoryStore<AbstractFileStore> sourceStore,final String pageTitle,final String pageDescription,final DefinitionResourceProvider messageProvider) {
        ...
        try {
            final IPackageFragmentRoot root = RepositoryManager.getInstance().getCurrentRepository().getJavaProject().findPackageFragmentRoot(sourceStore.getResource().getFullPath());
    ...
    public void createControl(final Composite parent) {
        ...
        final MultiValidator definitionValidator =  new MultiValidator() {
            ...
            protected IStatus validate() {
                ...
                final String implID = NamingUtils.toConnectorImplementationFilename(observableIdText.getValue().toString(),observableVersionText.getValue().toString(), false) ;
                for(final ConnectorImplementation impl : existingImpl){
                    final String existingId = NamingUtils.toConnectorImplementationFilename(impl.getImplementationId(),impl.getImplementationVersion(), false) ;
