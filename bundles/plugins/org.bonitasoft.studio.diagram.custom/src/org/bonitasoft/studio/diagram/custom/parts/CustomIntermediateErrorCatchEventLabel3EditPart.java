...
public class CustomIntermediateErrorCatchEventLabel3EditPart extends IntermediateErrorCatchEventLabel3EditPart {

    public CustomIntermediateErrorCatchEventLabel3EditPart(View view) {
        super(view);
    }
