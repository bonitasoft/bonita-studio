...
public class CustomIntermediateErrorCatchEventLabel6EditPart extends IntermediateErrorCatchEventLabel6EditPart {

    public CustomIntermediateErrorCatchEventLabel6EditPart(View view) {
        super(view);
    }
