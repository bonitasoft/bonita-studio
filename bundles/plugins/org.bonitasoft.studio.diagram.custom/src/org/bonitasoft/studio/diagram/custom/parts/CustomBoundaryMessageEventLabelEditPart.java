...
public class CustomBoundaryMessageEventLabelEditPart extends BoundaryMessageEventLabelEditPart {

    public CustomBoundaryMessageEventLabelEditPart(View view) {
        super(view);
    }
