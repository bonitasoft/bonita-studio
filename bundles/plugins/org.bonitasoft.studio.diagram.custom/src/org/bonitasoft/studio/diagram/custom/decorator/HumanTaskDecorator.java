...
public class HumanTaskDecorator extends AbstractBonitaDecorator/*implements IBonitaDecorator*/ {
     ...
     */
    public HumanTaskDecorator(IDecoratorTarget decoratorTarget, ActivityDecoratorProvider activityDecoratorProvider) {
    ...
    protected DecoratorSVGFigure getImageDecorator() {
        return FiguresHelper.getDecoratorFigure(FiguresHelper.HUMAN_DECORATOR);
    }
    ...
    protected boolean isAppearing(EObject activity) {
        return activity instanceof Task;
    }
