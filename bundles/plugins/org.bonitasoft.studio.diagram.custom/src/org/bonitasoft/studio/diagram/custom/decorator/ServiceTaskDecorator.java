 ...
 *
 */
public class ServiceTaskDecorator extends AbstractBonitaDecorator/*implements IBonitaDecorator*/ { 
	 ...
	 */
	public ServiceTaskDecorator(IDecoratorTarget decoratorTarget, ActivityDecoratorProvider activityDecoratorProvider) {
	...
	protected DecoratorSVGFigure getImageDecorator() {
		return FiguresHelper.getDecoratorFigure(FiguresHelper.SERVICE_DECORATOR) ;
	}
	...
	protected boolean isAppearing(EObject activity) {
		return activity instanceof ServiceTask;
	}
