...
public class CustomIntermediateErrorCatchEventLabel5EditPart extends IntermediateErrorCatchEventLabel5EditPart {

    public CustomIntermediateErrorCatchEventLabel5EditPart(View view) {
        super(view);
    }
