...
public class CustomNonInterruptingBoundaryTimerEventNameEditPart extends NonInterruptingBoundaryTimerEventNameEditPart {

    public CustomNonInterruptingBoundaryTimerEventNameEditPart(View view) {
        super(view);
    }
