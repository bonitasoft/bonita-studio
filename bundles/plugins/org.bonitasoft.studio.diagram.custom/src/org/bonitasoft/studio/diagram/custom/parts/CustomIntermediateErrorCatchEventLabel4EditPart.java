...
public class CustomIntermediateErrorCatchEventLabel4EditPart extends IntermediateErrorCatchEventLabel4EditPart {

    public CustomIntermediateErrorCatchEventLabel4EditPart(View view) {
        super(view);
    }
