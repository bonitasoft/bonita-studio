 ...
 *
 */
public class CustomIntermediateErrorCatchEvent2EditPart extends
		IntermediateErrorCatchEvent2EditPart {

	/**
	 * @param view
	 */
	public CustomIntermediateErrorCatchEvent2EditPart(View view) {
		super(view);
	}
