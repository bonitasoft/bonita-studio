 ...
 */
public class MessageSubProcessEventDecorator extends
		AbstractSubProcessEventStartTypeDecorator {
	
	public MessageSubProcessEventDecorator(IDecoratorTarget decoratorTarget) {
		super(decoratorTarget);
	}

	@Override
	protected DecoratorSVGFigure getImageDecorator() {
		return 	FiguresHelper.getDecoratorFigure(FiguresHelper.SUBPROCEVENT_MESSAGE_DECORATOR);
	}
