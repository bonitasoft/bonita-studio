 ...
 *
 */
public class CustomIntermediateThrowSignalEvent2EditPart extends
		IntermediateThrowSignalEvent2EditPart {

	/**
	 * @param view
	 */
	public CustomIntermediateThrowSignalEvent2EditPart(View view) {
		super(view);
	}
