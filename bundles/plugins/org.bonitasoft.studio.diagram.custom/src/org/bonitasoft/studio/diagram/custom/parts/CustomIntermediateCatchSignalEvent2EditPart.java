 ...
 *
 */
public class CustomIntermediateCatchSignalEvent2EditPart extends
		IntermediateCatchSignalEvent2EditPart {

	/**
	 * @param view
	 */
	public CustomIntermediateCatchSignalEvent2EditPart(View view) {
		super(view);
	}
