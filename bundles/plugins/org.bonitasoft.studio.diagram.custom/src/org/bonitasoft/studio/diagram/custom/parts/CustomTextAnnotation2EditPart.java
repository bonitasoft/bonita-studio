...
public class CustomTextAnnotation2EditPart extends TextAnnotation2EditPart {
    ...
    public class CustomNoteFigureDescriptor extends NoteFigureDescriptor {
        ...
        public void paintGradient(Graphics graphics) {
            ...
            graphics.pushState();
            Color from = PreferenceUtil.isDarkTheme() ? DiagramColorProvider.darkModeBackgroundColor : ColorConstants.white;
            Color to = PreferenceUtil.isDarkTheme() ? DiagramColorProvider.darkModeBackgroundGradientColor
                    : getBackgroundColor();
