 ...
 *
 */
public class SendTaskDecorator extends AbstractBonitaDecorator {

	
	public SendTaskDecorator(IDecoratorTarget decoratorTarget, ActivityDecoratorProvider activityDecoratorProvider) {
	...
	protected DecoratorSVGFigure getImageDecorator() {
		return FiguresHelper.getDecoratorFigure(FiguresHelper.SEND_DECORATOR) ;
	}

	@Override
	protected boolean isAppearing(EObject activity) {
		return activity instanceof SendTask;
	}
