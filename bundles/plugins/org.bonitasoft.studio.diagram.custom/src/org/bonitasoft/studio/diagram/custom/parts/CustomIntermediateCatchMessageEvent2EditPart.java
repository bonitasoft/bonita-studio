 ...
 *
 */
public class CustomIntermediateCatchMessageEvent2EditPart extends
		IntermediateCatchMessageEvent2EditPart {

	/**
	 * @param view
	 */
	public CustomIntermediateCatchMessageEvent2EditPart(View view) {
		super(view);
	}
