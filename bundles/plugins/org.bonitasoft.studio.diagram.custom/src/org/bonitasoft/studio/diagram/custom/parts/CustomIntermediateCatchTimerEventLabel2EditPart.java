...
public class CustomIntermediateCatchTimerEventLabel2EditPart extends IntermediateCatchTimerEventLabel2EditPart {

    public CustomIntermediateCatchTimerEventLabel2EditPart(View view) {
        super(view);
    }
