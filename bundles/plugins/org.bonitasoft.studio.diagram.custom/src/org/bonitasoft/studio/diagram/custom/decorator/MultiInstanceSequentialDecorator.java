 ...
 *
 */
public class MultiInstanceSequentialDecorator extends MultiInstanceDecorator {


    public MultiInstanceSequentialDecorator(final IDecoratorTarget decoratorTarget, final ActivityDecoratorProvider activityDecoratorProvider) {
        super(decoratorTarget, activityDecoratorProvider);
    }

    @Override
    protected DecoratorSVGFigure getImageDecorator() {
        return FiguresHelper.getDecoratorFigure(FiguresHelper.MULTIINSTANCE_SEQUENTIAL_DECORATOR) ;
    }
