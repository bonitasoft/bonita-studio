 ...
 */
public class SignalSubProcessEventDecorator extends
		AbstractSubProcessEventStartTypeDecorator {
	
	public SignalSubProcessEventDecorator(IDecoratorTarget decoratorTarget) {
		super(decoratorTarget);
	}

	@Override
	protected DecoratorSVGFigure getImageDecorator() {
		return FiguresHelper.getDecoratorFigure(FiguresHelper.SUBPROCEVENT_SIGNAL_DECORATOR);
	}
