 ...
 *
 */
public class CustomIntermediateThrowMessageEvent2EditPart extends
		IntermediateThrowMessageEvent2EditPart {

	/**
	 * @param view
	 */
	public CustomIntermediateThrowMessageEvent2EditPart(View view) {
		super(view);
	}
