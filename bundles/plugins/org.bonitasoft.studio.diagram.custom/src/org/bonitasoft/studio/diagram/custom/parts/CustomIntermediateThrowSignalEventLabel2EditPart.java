...
public class CustomIntermediateThrowSignalEventLabel2EditPart extends IntermediateThrowSignalEventLabel2EditPart {

    public CustomIntermediateThrowSignalEventLabel2EditPart(View view) {
        super(view);
    }
