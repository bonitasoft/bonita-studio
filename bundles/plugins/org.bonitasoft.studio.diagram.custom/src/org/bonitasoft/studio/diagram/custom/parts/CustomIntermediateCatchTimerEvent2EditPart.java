 ...
 *
 */
public class CustomIntermediateCatchTimerEvent2EditPart extends
		IntermediateCatchTimerEvent2EditPart {

	/**
	 * @param view
	 */
	public CustomIntermediateCatchTimerEvent2EditPart(View view) {
		super(view);
	}
