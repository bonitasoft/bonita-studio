 ...
 */
public class ErrorSubProcessEventStartDecorator extends
		AbstractSubProcessEventStartTypeDecorator {
	

	public ErrorSubProcessEventStartDecorator(IDecoratorTarget decoratorTarget) {
	...
	protected DecoratorSVGFigure getImageDecorator() {
		return FiguresHelper.getDecoratorFigure(FiguresHelper.SUBPROCEVENT_ERROR_DECORATOR);
	}
