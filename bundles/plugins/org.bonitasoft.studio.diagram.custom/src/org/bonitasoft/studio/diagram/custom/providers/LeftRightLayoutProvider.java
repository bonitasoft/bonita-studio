 ...
 *
 */
public class LeftRightLayoutProvider extends LeftRightProvider{

	public static final String LEFT_RIGHT_LAYOUT ="LeftRight" ;
	...
	public boolean provides(IOperation operation) {
		...
		return LEFT_RIGHT_LAYOUT.equals(layoutType) || "DEFAUlT".equalsIgnoreCase(layoutType);
	}
