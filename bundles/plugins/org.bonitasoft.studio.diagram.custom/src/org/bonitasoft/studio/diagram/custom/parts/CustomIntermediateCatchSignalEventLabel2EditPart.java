...
public class CustomIntermediateCatchSignalEventLabel2EditPart extends IntermediateCatchSignalEventLabel2EditPart {

    public CustomIntermediateCatchSignalEventLabel2EditPart(View view) {
        super(view);
    }
