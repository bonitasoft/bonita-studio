...
public class CustomIntermediateCatchMessageEventLabel2EditPart extends IntermediateCatchMessageEventLabel2EditPart {

    public CustomIntermediateCatchMessageEventLabel2EditPart(View view) {
        super(view);
    }
