...
public class CustomIntermediateErrorCatchEventLabelEditPart extends IntermediateErrorCatchEventLabelEditPart {

    public CustomIntermediateErrorCatchEventLabelEditPart(View view) {
        super(view);
    }
