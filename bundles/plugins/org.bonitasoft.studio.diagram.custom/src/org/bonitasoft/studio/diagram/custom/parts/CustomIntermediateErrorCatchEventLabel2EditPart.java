...
public class CustomIntermediateErrorCatchEventLabel2EditPart extends IntermediateErrorCatchEventLabel2EditPart {

    public CustomIntermediateErrorCatchEventLabel2EditPart(View view) {
        super(view);
    }
