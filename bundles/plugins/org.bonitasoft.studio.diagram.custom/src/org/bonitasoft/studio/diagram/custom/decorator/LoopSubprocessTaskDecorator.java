...
public class LoopSubprocessTaskDecorator extends AbstractBonitaDecorator {
    ...
    protected DecoratorSVGFigure getImageDecorator() {
        final DecoratorSVGFigure figure = FiguresHelper.getDecoratorFigure(FiguresHelper.LOOP_SUB_DECORATOR) ;
    ...
    protected boolean isAppearing(final EObject activity) {
        return activity instanceof CallActivity && ((CallActivity) activity).getType() == MultiInstanceType.STANDARD;
    }
