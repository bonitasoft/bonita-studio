 ...
 *
 */
public class WebWidgetFileStore extends AbstractFileStore {

    public WebWidgetFileStore(final String fileName, final IRepositoryStore<? extends IRepositoryFileStore> parentStore) {
