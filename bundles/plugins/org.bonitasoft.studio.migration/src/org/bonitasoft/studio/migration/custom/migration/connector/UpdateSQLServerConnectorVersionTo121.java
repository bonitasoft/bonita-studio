...
public class UpdateSQLServerConnectorVersionTo121 extends UpdateConnectorDefinitionMigration {
    ...
    /*
     * (non-Javadoc)
     * @see org.bonitasoft.studio.migration.custom.migration.connector.UpdateConnectorDefinitionMigration#shouldUpdateId(java.lang.String)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.bonitasoft.studio.migration.custom.migration.connector.UpdateConnectorDefinitionMigration#getNewDefinitionId()
     */
    @Override
