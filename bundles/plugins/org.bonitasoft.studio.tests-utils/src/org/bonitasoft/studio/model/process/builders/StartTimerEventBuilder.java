 ...
 *
 */
public class StartTimerEventBuilder extends ElementBuilder<StartTimerEvent, StartTimerEventBuilder> {

    public static StartTimerEventBuilder createStartTimerEventBuilder() {
