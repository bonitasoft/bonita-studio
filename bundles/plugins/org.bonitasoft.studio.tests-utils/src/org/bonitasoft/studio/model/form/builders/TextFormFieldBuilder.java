 ...
 */
public class TextFormFieldBuilder extends WidgetBuilder<TextFormField, TextFormFieldBuilder> {

    public static TextFormFieldBuilder aTextFormField() {
        return new TextFormFieldBuilder();
    }

    @Override
    protected TextFormField newInstance() {
