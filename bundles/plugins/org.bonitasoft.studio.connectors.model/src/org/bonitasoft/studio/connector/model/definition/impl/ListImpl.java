 ...
 * <ul>
 *   <li>{@link org.bonitasoft.studio.connector.model.definition.impl.ListImpl#isShowDocuments <em>Show Documents</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ListImpl extends WidgetImpl implements List {
    ...
    protected EClass eStaticClass() {
		return ConnectorDefinitionPackage.Literals.LIST;
	}
	...
	public void setShowDocuments(boolean newShowDocuments) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectorDefinitionPackage.LIST__SHOW_DOCUMENTS, oldShowDocuments, showDocuments));
	}
