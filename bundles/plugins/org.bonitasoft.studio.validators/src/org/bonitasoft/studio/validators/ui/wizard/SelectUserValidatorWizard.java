 ...
 *
 */
public class SelectUserValidatorWizard extends Wizard {

    private SelectValidatorWizardPage page ;
    ...
    public void addPages() {
        page =  new SelectValidatorWizardPage() ;
        addPage(page) ;
    }

    @Override
    public boolean performFinish() {
        validator = page.getSelectedValidator() ;
        return true;
    }
