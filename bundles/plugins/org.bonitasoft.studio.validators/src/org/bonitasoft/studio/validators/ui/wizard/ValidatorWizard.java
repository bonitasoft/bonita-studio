    ...
    public boolean performFinish() {
        ...
        IRunnableWithProgress runnable = new IRunnableWithProgress(){
            ...
            public void run(IProgressMonitor monitor){
                ...
                if(editMode){
                    if(!orginalValidator.getClassName().equals(validator.getClassName())){
                        ...
                        SourceFileStore sourceFile = (SourceFileStore) sourceStore.getChild(orginalValidator.getClassName()) ;
                        if(sourceFile != null){
                            sourceFile.rename(validator.getClassName()) ;
                        }
                    }
