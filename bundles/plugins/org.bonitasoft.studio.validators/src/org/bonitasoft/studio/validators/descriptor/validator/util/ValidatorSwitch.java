 ...
 * @generated
 */
public class ValidatorSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ValidatorPackage.VALIDATOR_DESCRIPTOR: {
				ValidatorDescriptor validatorDescriptor = (ValidatorDescriptor)theEObject;
				T result = caseValidatorDescriptor(validatorDescriptor);
	 ...
	 * @generated
	 */
	public T caseValidatorDescriptor(ValidatorDescriptor object) {
		return null;
	}
