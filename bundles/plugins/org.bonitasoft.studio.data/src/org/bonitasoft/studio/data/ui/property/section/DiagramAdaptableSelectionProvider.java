 ...
 */
@Creatable
public class DiagramAdaptableSelectionProvider extends EObjectAdaptableSelectionProvider {
    ...
    public Object getAdapter(final Class adapter) {
        if (EObject.class.equals(adapter)) {
            ...
            if (unwrapSelection instanceof IAdaptable) {
                return asMainProcess((EObject) ((IAdaptable) unwrapSelection).getAdapter(EObject.class));
            } else if (unwrapSelection instanceof EObject) {
                return asMainProcess((EObject) unwrapSelection);
            }
        }
        return null;
    }

    private static MainProcess asMainProcess(final EObject semanticElement) {
        return ModelHelper.getFirstContainerOfType(semanticElement, MainProcess.class);
    }
