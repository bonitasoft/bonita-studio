 ...
 *
 */
public class DataTypeNameEditingSupport extends EditingSupport {

	private Set<EnumType> existingTypes;
	
	public DataTypeNameEditingSupport(ColumnViewer viewer,Set<EnumType> existingTypes) {
		super(viewer);
	...
	protected void setValue(Object element, Object value) {
		if(element != null && value != null){
			((DataType)element).setName(value.toString()) ;
			getViewer().refresh() ;
		}
	}
