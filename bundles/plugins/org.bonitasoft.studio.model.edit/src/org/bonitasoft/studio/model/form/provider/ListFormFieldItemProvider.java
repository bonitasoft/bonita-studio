...
public class ListFormFieldItemProvider extends MultipleValuatedFormFieldItemProvider {
    ...
    protected void addMaxHeigthPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_ListFormField_maxHeigth_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_ListFormField_type"), //$NON-NLS-1$
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_ListFormField_type") : //$NON-NLS-1$
