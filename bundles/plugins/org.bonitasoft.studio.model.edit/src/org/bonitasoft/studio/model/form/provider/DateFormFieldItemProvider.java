...
/**
 * This is the item provider adapter for a {@link org.bonitasoft.studio.model.form.DateFormField} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DateFormFieldItemProvider extends SingleValuatedFormFieldItemProvider {
	/**
	 ...
	 * @generated
	 */
	public DateFormFieldItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addInitialFormatPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Initial Format feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addInitialFormatPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DateFormField_initialFormat_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_DateFormField_initialFormat_feature", "_UI_DateFormField_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 FormPackage.Literals.DATE_FORM_FIELD__INITIAL_FORMAT,
				 true,
				 false,
				 false,
	...
	protected void addDisplayFormatPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DateFormField_displayFormat_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_DateFormField_displayFormat_feature", "_UI_DateFormField_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	/**
	 * This returns DateFormField.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DateFormField")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((DateFormField)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DateFormField_type") : //$NON-NLS-1$
			getString("_UI_DateFormField_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DateFormField.class)) {
