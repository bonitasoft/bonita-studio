...
public class StartTimerEventItemProvider extends TimerEventItemProvider {
    ...
    protected void addFromPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_StartTimerEvent_from_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_StartTimerEvent_type"), //$NON-NLS-1$
    ...
    protected void addAtPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_StartTimerEvent_at_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_StartTimerEvent_type"), //$NON-NLS-1$
    ...
    protected void addMonthPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_StartTimerEvent_month_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_StartTimerEvent_type"), //$NON-NLS-1$
    ...
    protected void addDayPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_StartTimerEvent_day_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_StartTimerEvent_type"), //$NON-NLS-1$
    ...
    protected void addHoursPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_StartTimerEvent_hours_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_StartTimerEvent_type"), //$NON-NLS-1$
    ...
    protected void addDayNumberPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_StartTimerEvent_dayNumber_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_StartTimerEvent_type"), //$NON-NLS-1$
    ...
    protected void addMinutesPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_StartTimerEvent_minutes_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_StartTimerEvent_type"), //$NON-NLS-1$
    ...
    protected void addSecondsPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_StartTimerEvent_seconds_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_StartTimerEvent_type"), //$NON-NLS-1$
    ...
    protected void addScriptTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_StartTimerEvent_scriptType_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_StartTimerEvent_type"), //$NON-NLS-1$
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_StartTimerEvent_type") : //$NON-NLS-1$
