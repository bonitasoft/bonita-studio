...
public class ConnectorItemProvider
    ...
    protected void addDefinitionIdPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Connector_definitionId_feature", //$NON-NLS-1$//$NON-NLS-2$
    ...
    protected void addIgnoreErrorsPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Connector_ignoreErrors_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Connector_type"), //$NON-NLS-1$
    ...
    protected void addThrowErrorEventPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Connector_throwErrorEvent_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Connector_type"), //$NON-NLS-1$
    ...
    protected void addNamedErrorPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Connector_namedError_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Connector_type"), //$NON-NLS-1$
    ...
    protected void addDefinitionVersionPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Connector_definitionVersion_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Connector_type"), //$NON-NLS-1$
    ...
    protected void addOutputsPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Connector_outputs_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Connector_type"), //$NON-NLS-1$
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_Connector_type") : //$NON-NLS-1$
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.CONNECTOR__CONFIGURATION,
