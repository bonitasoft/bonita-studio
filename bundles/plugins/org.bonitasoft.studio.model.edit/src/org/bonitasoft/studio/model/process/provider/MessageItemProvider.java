...
/**
 * This is the item provider adapter for a {@link org.bonitasoft.studio.model.process.Message} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
...
public class MessageItemProvider
    ...
    protected void addThrowEventPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(),
                        getString("_UI_Message_throwEvent_feature"), //$NON-NLS-1$
                        getString("_UI_PropertyDescriptor_description", "_UI_Message_throwEvent_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Message_type"), //$NON-NLS-1$
                        ProcessPackage.Literals.MESSAGE__THROW_EVENT,
                        true,
                        false,
                        false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    protected void addTtlPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(),
                        getString("_UI_Message_ttl_feature"), //$NON-NLS-1$
                        getString("_UI_PropertyDescriptor_description", "_UI_Message_ttl_feature", "_UI_Message_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                        ProcessPackage.Literals.MESSAGE__TTL,
                        true,
                        false,
                        false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    protected void addCorrelationPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(),
                        getString("_UI_Message_correlation_feature"), //$NON-NLS-1$
                        getString("_UI_PropertyDescriptor_description", "_UI_Message_correlation_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Message_type"), //$NON-NLS-1$
                        ProcessPackage.Literals.MESSAGE__CORRELATION,
                        true,
                        false,
                        true,
                        null,
    ...
    protected void addMessageContentPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(),
                        getString("_UI_Message_messageContent_feature"), //$NON-NLS-1$
                        getString("_UI_PropertyDescriptor_description", "_UI_Message_messageContent_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Message_type"), //$NON-NLS-1$
                        ProcessPackage.Literals.MESSAGE__MESSAGE_CONTENT,
                        true,
                        false,
                        true,
                        null,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(ProcessPackage.Literals.MESSAGE__TARGET_PROCESS_EXPRESSION);
            childrenFeatures.add(ProcessPackage.Literals.MESSAGE__TARGET_ELEMENT_EXPRESSION);
        }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.MESSAGE__TARGET_PROCESS_EXPRESSION,
                ExpressionFactory.eINSTANCE.createExpression()));

        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.MESSAGE__TARGET_ELEMENT_EXPRESSION,
                ExpressionFactory.eINSTANCE.createExpression()));
    }
    ...
    public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
        ...
        boolean qualify = childFeature == ProcessPackage.Literals.MESSAGE__TARGET_PROCESS_EXPRESSION ||
                childFeature == ProcessPackage.Literals.MESSAGE__TARGET_ELEMENT_EXPRESSION;
