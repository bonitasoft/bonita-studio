...
public class BusinessObjectDataItemProvider extends JavaObjectDataItemProvider {
        ...
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
                                "_UI_BusinessObjectData_businessDataRepositoryId_feature", "_UI_BusinessObjectData_type"), //$NON-NLS-1$ //$NON-NLS-2$
    ...
    protected void addCreateNewInstancePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_BusinessObjectData_createNewInstance_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_BusinessObjectData_type"), //$NON-NLS-1$
    ...
    protected void addEClassNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_BusinessObjectData_eClassName_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_BusinessObjectData_type"), //$NON-NLS-1$
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_BusinessObjectData_type") : //$NON-NLS-1$
