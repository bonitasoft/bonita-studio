...
public class KPIParameterMappingItemProvider
    ...
    protected void addKpiFieldNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_KPIParameterMapping_kpiFieldName_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_KPIParameterMapping_type"), //$NON-NLS-1$
    ...
    protected void addValuePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_KPIParameterMapping_value_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_KPIParameterMapping_type"), //$NON-NLS-1$
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_KPIParameterMapping_type") : //$NON-NLS-1$
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(KpiPackage.Literals.KPI_PARAMETER_MAPPING__VALUE,
