...
/**
 * This is the item provider adapter for a {@link org.bonitasoft.studio.model.form.GroupIterator} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class GroupIteratorItemProvider
     ...
     * @generated
     */
    public GroupIteratorItemProvider(AdapterFactory adapterFactory) {
    ...
    protected void addClassNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(),
                        getString("_UI_GroupIterator_className_feature"), //$NON-NLS-1$
                        getString("_UI_PropertyDescriptor_description", "_UI_GroupIterator_className_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_GroupIterator_type"), //$NON-NLS-1$
                        FormPackage.Literals.GROUP_ITERATOR__CLASS_NAME,
                        true,
                        false,
                        false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    /**
     * This returns GroupIterator.gif.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
     * @generated
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/GroupIterator")); //$NON-NLS-1$
    }
    ...
    public String getText(Object object) {
        String label = ((GroupIterator) object).getName();
        return label == null || label.length() == 0 ? getString("_UI_GroupIterator_type") : //$NON-NLS-1$
                getString("_UI_GroupIterator_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(GroupIterator.class)) {
