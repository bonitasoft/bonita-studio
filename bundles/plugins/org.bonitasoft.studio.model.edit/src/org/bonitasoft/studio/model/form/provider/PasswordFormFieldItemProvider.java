...
public class PasswordFormFieldItemProvider extends SingleValuatedFormFieldItemProvider {
    ...
    protected void addMaxLengthPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_PasswordFormField_maxLength_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_PasswordFormField_type"), //$NON-NLS-1$
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_PasswordFormField_type") : //$NON-NLS-1$
