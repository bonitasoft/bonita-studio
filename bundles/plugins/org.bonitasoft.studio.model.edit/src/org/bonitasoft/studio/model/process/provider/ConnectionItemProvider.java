...
/**
 * This is the item provider adapter for a {@link org.bonitasoft.studio.model.process.Connection} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
    ...
    protected void addTargetPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Connection_target_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Connection_type"), //$NON-NLS-1$
                        ProcessPackage.Literals.CONNECTION__TARGET,
                        true,
                        false,
                        true,
                        null,
        ...
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Connection_source_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Connection_type"), //$NON-NLS-1$
                        ProcessPackage.Literals.CONNECTION__SOURCE,
                        true,
                        false,
                        true,
                        null,
