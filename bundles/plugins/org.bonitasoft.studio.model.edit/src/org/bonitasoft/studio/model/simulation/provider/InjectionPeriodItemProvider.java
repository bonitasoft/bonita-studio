    ...
    protected void addBeginPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_InjectionPeriod_begin_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_InjectionPeriod_type"), //$NON-NLS-1$
    ...
    protected void addEndPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_InjectionPeriod_end_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_InjectionPeriod_type"), //$NON-NLS-1$
    ...
    protected void addNbInstancesPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_InjectionPeriod_nbInstances_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_InjectionPeriod_type"), //$NON-NLS-1$
    ...
    protected void addRepartitionPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_InjectionPeriod_repartition_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_InjectionPeriod_type"), //$NON-NLS-1$
