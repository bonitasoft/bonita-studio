...
/**
 * This is the item provider adapter for a {@link org.bonitasoft.studio.model.form.ImageWidget} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
...
public class ImageWidgetItemProvider
    ...
    protected void addIsADocumentPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_ImageWidget_isADocument_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_ImageWidget_type"), //$NON-NLS-1$
    ...
    protected void addDocumentPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_ImageWidget_document_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_ImageWidget_type"), //$NON-NLS-1$
    ...
    protected void addImgPathPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(),
                        getString("_UI_ImageWidget_imgPath_feature"), //$NON-NLS-1$
                        getString("_UI_PropertyDescriptor_description", "_UI_ImageWidget_imgPath_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_ImageWidget_type"), //$NON-NLS-1$
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_ImageWidget_type") : //$NON-NLS-1$
