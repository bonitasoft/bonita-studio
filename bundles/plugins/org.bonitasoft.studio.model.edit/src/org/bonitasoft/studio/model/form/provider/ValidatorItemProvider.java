...
/**
 * This is the item provider adapter for a {@link org.bonitasoft.studio.model.form.Validator} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class ValidatorItemProvider
    ...
    protected void addValidatorClassPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Validator_validatorClass_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Validator_type"), //$NON-NLS-1$
    ...
    protected void addHtmlClassPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Validator_htmlClass_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Validator_type"), //$NON-NLS-1$
    ...
    protected void addBelowFieldPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Validator_belowField_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Validator_type"), //$NON-NLS-1$
    ...
    protected void addParameterPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Validator_parameter_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Validator_type"), //$NON-NLS-1$
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_Validator_type") : //$NON-NLS-1$
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(FormPackage.Literals.VALIDATOR__DISPLAY_NAME,
