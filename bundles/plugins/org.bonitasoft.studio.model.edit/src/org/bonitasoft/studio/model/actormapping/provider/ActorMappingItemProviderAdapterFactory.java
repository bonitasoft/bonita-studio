 ...
 * @generated
 */
public class ActorMappingItemProviderAdapterFactory extends ActorMappingAdapterFactory
    ...
    /**
     * This keeps track of the one adapter used for all {@link org.bonitasoft.studio.model.actormapping.ActorMapping}
     * instances.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * This keeps track of the one adapter used for all {@link org.bonitasoft.studio.model.actormapping.ActorMappingsType}
     * instances.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * This keeps track of the one adapter used for all {@link org.bonitasoft.studio.model.actormapping.DocumentRoot}
     * instances.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * This keeps track of the one adapter used for all {@link org.bonitasoft.studio.model.actormapping.Membership}
     * instances.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * This keeps track of the one adapter used for all {@link org.bonitasoft.studio.model.actormapping.MembershipType}
     * instances.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    public void dispose() {
        if (actorMappingItemProvider != null)
            actorMappingItemProvider.dispose();
        if (actorMappingsTypeItemProvider != null)
            actorMappingsTypeItemProvider.dispose();
        if (documentRootItemProvider != null)
            documentRootItemProvider.dispose();
        if (groupsItemProvider != null)
            groupsItemProvider.dispose();
        if (membershipItemProvider != null)
            membershipItemProvider.dispose();
        if (membershipTypeItemProvider != null)
            membershipTypeItemProvider.dispose();
        if (rolesItemProvider != null)
            rolesItemProvider.dispose();
        if (usersItemProvider != null)
