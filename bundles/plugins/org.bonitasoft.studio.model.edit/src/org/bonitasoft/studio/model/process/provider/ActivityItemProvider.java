...
public class ActivityItemProvider extends FlowElementItemProvider {
    ...
    protected void addTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_MultiInstantiable_type_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_MultiInstantiable_type"), //$NON-NLS-1$
    ...
    protected void addTestBeforePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_MultiInstantiable_testBefore_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_MultiInstantiable_type"), //$NON-NLS-1$
    ...
    protected void addUseCardinalityPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_MultiInstantiable_useCardinality_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_MultiInstantiable_type"), //$NON-NLS-1$
    ...
    protected void addCollectionDataToMultiInstantiatePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
                        "_UI_MultiInstantiable_collectionDataToMultiInstantiate_feature", "_UI_MultiInstantiable_type"), //$NON-NLS-1$ //$NON-NLS-2$
    ...
    protected void addOutputDataPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_MultiInstantiable_outputData_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_MultiInstantiable_type"), //$NON-NLS-1$
    ...
    protected void addListDataContainingOutputResultsPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
                        "_UI_MultiInstantiable_listDataContainingOutputResults_feature", "_UI_MultiInstantiable_type"), //$NON-NLS-1$ //$NON-NLS-2$
    ...
    protected void addStoreOutputPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_MultiInstantiable_storeOutput_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_MultiInstantiable_type"), //$NON-NLS-1$
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.OPERATION_CONTAINER__OPERATIONS,
                ExpressionFactory.eINSTANCE.createOperation()));

        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.MULTI_INSTANTIABLE__LOOP_CONDITION,
                ExpressionFactory.eINSTANCE.createExpression()));

        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.MULTI_INSTANTIABLE__LOOP_MAXIMUM,
                ExpressionFactory.eINSTANCE.createExpression()));

        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.MULTI_INSTANTIABLE__CARDINALITY_EXPRESSION,
                ExpressionFactory.eINSTANCE.createExpression()));

        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.MULTI_INSTANTIABLE__ITERATOR_EXPRESSION,
                ExpressionFactory.eINSTANCE.createExpression()));

        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.MULTI_INSTANTIABLE__COMPLETION_CONDITION,
                ExpressionFactory.eINSTANCE.createExpression()));

        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.ACTIVITY__BOUNDARY_INTERMEDIATE_EVENTS,
