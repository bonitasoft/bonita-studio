...
/**
 * This is the item provider adapter for a {@link org.bonitasoft.studio.model.kpi.AbstractKPIDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class AbstractKPIDefinitionItemProvider
     ...
     * @generated
     */
    public AbstractKPIDefinitionItemProvider(AdapterFactory adapterFactory) {
    ...
    protected void addVersionPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(),
                        getString("_UI_AbstractKPIDefinition_version_feature"), //$NON-NLS-1$
                        getString("_UI_PropertyDescriptor_description", "_UI_AbstractKPIDefinition_version_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_AbstractKPIDefinition_type"), //$NON-NLS-1$
                        KpiPackage.Literals.ABSTRACT_KPI_DEFINITION__VERSION,
                        true,
                        false,
                        false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(KpiPackage.Literals.ABSTRACT_KPI_DEFINITION__FIELDS);
        }
    ...
    public String getText(Object object) {
        String label = ((AbstractKPIDefinition) object).getName();
        return label == null || label.length() == 0 ? getString("_UI_AbstractKPIDefinition_type") : //$NON-NLS-1$
                getString("_UI_AbstractKPIDefinition_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(AbstractKPIDefinition.class)) {
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(KpiPackage.Literals.ABSTRACT_KPI_DEFINITION__FIELDS,
                KpiFactory.eINSTANCE.createKPIField()));
    }
