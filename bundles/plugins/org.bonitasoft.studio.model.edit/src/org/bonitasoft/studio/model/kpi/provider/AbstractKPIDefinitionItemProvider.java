...
public class AbstractKPIDefinitionItemProvider 
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 ...
                 getString("_UI_PropertyDescriptor_description", "_UI_AbstractKPIDefinition_version_feature", "_UI_AbstractKPIDefinition_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ?
            getString("_UI_AbstractKPIDefinition_type") : //$NON-NLS-1$
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (KpiPackage.Literals.ABSTRACT_KPI_DEFINITION__FIELDS,
