...
/**
 * This is the item provider adapter for a {@link org.bonitasoft.studio.model.process.InputMapping} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
...
public class InputMappingItemProvider
    ...
    protected void addProcessSourcePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_InputMapping_processSource_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_InputMapping_type"), //$NON-NLS-1$
    ...
    protected void addSubprocessTargetPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_InputMapping_subprocessTarget_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_InputMapping_type"), //$NON-NLS-1$
    ...
    protected void addAssignationTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_InputMapping_assignationType_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_InputMapping_type"), //$NON-NLS-1$
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_InputMapping_type") : //$NON-NLS-1$
