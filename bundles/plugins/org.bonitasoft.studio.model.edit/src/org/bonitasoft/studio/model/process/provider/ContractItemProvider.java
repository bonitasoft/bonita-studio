...
/**
 * This is the item provider adapter for a {@link org.bonitasoft.studio.model.process.Contract} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
...
public class ContractItemProvider
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(ProcessPackage.Literals.CONTRACT__INPUTS);
            childrenFeatures.add(ProcessPackage.Literals.CONTRACT__CONSTRAINTS);
        }
    ...
    public String getText(Object object) {
        return getString("_UI_Contract_type"); //$NON-NLS-1$
    }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.CONTRACT__INPUTS,
                ProcessFactory.eINSTANCE.createContractInput()));

        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.CONTRACT__CONSTRAINTS,
                ProcessFactory.eINSTANCE.createContractConstraint()));
    }
