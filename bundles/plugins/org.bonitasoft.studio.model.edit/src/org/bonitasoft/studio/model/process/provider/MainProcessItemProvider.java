...
public class MainProcessItemProvider extends AbstractProcessItemProvider {
    ...
    protected void addBonitaVersionPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_MainProcess_bonitaVersion_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_MainProcess_type"), //$NON-NLS-1$
    ...
    protected void addBonitaModelVersionPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_MainProcess_bonitaModelVersion_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_MainProcess_type"), //$NON-NLS-1$
    ...
    protected void addIncludedEntriesPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_MainProcess_includedEntries_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_MainProcess_type"), //$NON-NLS-1$
    ...
    protected void addGeneratedLibsPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_MainProcess_generatedLibs_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_MainProcess_type"), //$NON-NLS-1$
    ...
    protected void addEnableValidationPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_MainProcess_enableValidation_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_MainProcess_type"), //$NON-NLS-1$
    ...
    protected void addConfigIdPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_MainProcess_configId_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_MainProcess_type"), //$NON-NLS-1$
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_MainProcess_type") : //$NON-NLS-1$
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.MAIN_PROCESS__MESSAGE_CONNECTIONS,
