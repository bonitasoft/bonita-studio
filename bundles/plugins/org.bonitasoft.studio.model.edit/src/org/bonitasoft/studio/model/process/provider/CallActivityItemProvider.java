...
public class CallActivityItemProvider extends ActivityItemProvider {
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_CallActivity_type") : //$NON-NLS-1$
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.CALL_ACTIVITY__INPUT_MAPPINGS,
                ProcessFactory.eINSTANCE.createInputMapping()));

        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.CALL_ACTIVITY__OUTPUT_MAPPINGS,
                ProcessFactory.eINSTANCE.createOutputMapping()));

        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.CALL_ACTIVITY__CALLED_ACTIVITY_NAME,
                ExpressionFactory.eINSTANCE.createExpression()));

        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.CALL_ACTIVITY__CALLED_ACTIVITY_VERSION,
                ExpressionFactory.eINSTANCE.createExpression()));
    }
