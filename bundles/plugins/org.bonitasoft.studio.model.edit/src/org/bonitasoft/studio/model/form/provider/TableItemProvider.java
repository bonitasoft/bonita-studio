...
public class TableItemProvider extends AbstractTableItemProvider {
    ...
    protected void addAllowSelectionPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Table_allowSelection_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Table_type"), //$NON-NLS-1$
    ...
    protected void addSelectionModeIsMultiplePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Table_selectionModeIsMultiple_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Table_type"), //$NON-NLS-1$
    ...
    protected void addMaxRowForPaginationPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Table_maxRowForPagination_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Table_type"), //$NON-NLS-1$
    ...
    protected void addColumnForInitialSelectionIndexPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Table_columnForInitialSelectionIndex_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Table_type"), //$NON-NLS-1$
    ...
    protected void addSelectedValuesPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Table_selectedValues_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Table_type"), //$NON-NLS-1$
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(FormPackage.Literals.MULTIPLE_VALUATED_FORM_FIELD__DEFAULT_EXPRESSION,
                ExpressionFactory.eINSTANCE.createExpression()));

        newChildDescriptors
                .add(createChildParameter(FormPackage.Literals.MULTIPLE_VALUATED_FORM_FIELD__DEFAULT_EXPRESSION_AFTER_EVENT,
                        ExpressionFactory.eINSTANCE.createExpression()));
    }
