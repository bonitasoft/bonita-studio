...
/**
 * This is the item provider adapter for a {@link org.bonitasoft.studio.model.connectorconfiguration.ConnectorConfiguration}
 * object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
...
public class ConnectorConfigurationItemProvider
    ...
    protected void addDefinitionIdPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_ConnectorConfiguration_definitionId_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_ConnectorConfiguration_type"), //$NON-NLS-1$
    ...
    protected void addVersionPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_ConnectorConfiguration_version_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_ConnectorConfiguration_type"), //$NON-NLS-1$
    ...
    protected void addNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_ConnectorConfiguration_name_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_ConnectorConfiguration_type"), //$NON-NLS-1$
    ...
    protected void addModelVersionPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_ConnectorConfiguration_modelVersion_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_ConnectorConfiguration_type"), //$NON-NLS-1$
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_ConnectorConfiguration_type") : //$NON-NLS-1$
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors
                .add(createChildParameter(ConnectorConfigurationPackage.Literals.CONNECTOR_CONFIGURATION__PARAMETERS,
