...
public class TaskItemProvider extends ActivityItemProvider {
    ...
    protected void addActorPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Assignable_actor_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Assignable_type"), //$NON-NLS-1$
    ...
    protected void addOverrideActorsOfTheLanePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Task_overrideActorsOfTheLane_feature", //$NON-NLS-1$//$NON-NLS-2$
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.ASSIGNABLE__FILTERS,
                ProcessFactory.eINSTANCE.createActorFilter()));

        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.TASK__EXPECTED_DURATION,
    ...
    public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
        ...
        boolean qualify = childFeature == ProcessPackage.Literals.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_TRANSITIONS ||
