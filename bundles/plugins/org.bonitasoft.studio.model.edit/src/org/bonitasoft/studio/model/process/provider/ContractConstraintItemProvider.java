...
public class ContractConstraintItemProvider
    ...
    protected void addExpressionPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_ContractConstraint_expression_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_ContractConstraint_type"), //$NON-NLS-1$
    ...
    protected void addErrorMessagePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_ContractConstraint_errorMessage_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_ContractConstraint_type"), //$NON-NLS-1$
    ...
    protected void addNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_ContractConstraint_name_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_ContractConstraint_type"), //$NON-NLS-1$
    ...
    protected void addInputNamesPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_ContractConstraint_inputNames_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_ContractConstraint_type"), //$NON-NLS-1$
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_ContractConstraint_type") : //$NON-NLS-1$
