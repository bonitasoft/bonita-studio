...
/**
 * This is the item provider adapter for a {@link org.bonitasoft.studio.model.simulation.SimulationTransition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class SimulationTransitionItemProvider
     ...
     * @generated
     */
    public SimulationTransitionItemProvider(AdapterFactory adapterFactory) {
    ...
    protected void addProbabilityPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_SimulationTransition_probability_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_SimulationTransition_type"), //$NON-NLS-1$
    ...
    protected void addDataBasedPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_SimulationTransition_dataBased_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_SimulationTransition_type"), //$NON-NLS-1$
    ...
    protected void addUseExpressionPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_SimulationTransition_useExpression_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_SimulationTransition_type"), //$NON-NLS-1$
    ...
    /**
     * This returns SimulationTransition.gif.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
     * @generated
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/SimulationTransition")); //$NON-NLS-1$
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(SimulationTransition.class)) {
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(SimulationPackage.Literals.SIMULATION_TRANSITION__EXPRESSION,
