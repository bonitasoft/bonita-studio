...
public class ConfigurationItemProvider
    ...
    protected void addNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Configuration_name_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Configuration_type"), //$NON-NLS-1$
    ...
    protected void addDescriptionPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Configuration_description_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Configuration_type"), //$NON-NLS-1$
    ...
    protected void addAnonymousUserNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Configuration_anonymousUserName_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Configuration_type"), //$NON-NLS-1$
    ...
    protected void addAnonymousPasswordPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Configuration_anonymousPassword_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Configuration_type"), //$NON-NLS-1$
    ...
    protected void addVersionPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Configuration_version_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Configuration_type"), //$NON-NLS-1$
    ...
    protected void addUsernamePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Configuration_username_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Configuration_type"), //$NON-NLS-1$
    ...
    protected void addPasswordPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Configuration_password_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Configuration_type"), //$NON-NLS-1$
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_Configuration_type") : //$NON-NLS-1$
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(ConfigurationPackage.Literals.CONFIGURATION__ACTOR_MAPPINGS,
                ActorMappingFactory.eINSTANCE.createActorMappingsType()));

        newChildDescriptors.add(createChildParameter(ConfigurationPackage.Literals.CONFIGURATION__DEFINITION_MAPPINGS,
                ConfigurationFactory.eINSTANCE.createDefinitionMapping()));

        newChildDescriptors.add(createChildParameter(ConfigurationPackage.Literals.CONFIGURATION__PROCESS_DEPENDENCIES,
                ConfigurationFactory.eINSTANCE.createFragmentContainer()));

        newChildDescriptors.add(createChildParameter(ConfigurationPackage.Literals.CONFIGURATION__APPLICATION_DEPENDENCIES,
                ConfigurationFactory.eINSTANCE.createFragmentContainer()));

        newChildDescriptors.add(createChildParameter(ConfigurationPackage.Literals.CONFIGURATION__PARAMETERS,
    ...
    public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
        ...
        boolean qualify = childFeature == ConfigurationPackage.Literals.CONFIGURATION__PROCESS_DEPENDENCIES ||
