...
/**
 * This is the item provider adapter for a {@link org.bonitasoft.studio.model.actormapping.ActorMapping} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
...
public class ActorMappingItemProvider
    ...
    protected void addNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_ActorMapping_name_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_ActorMapping_type"), //$NON-NLS-1$
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_ActorMapping_type") : //$NON-NLS-1$
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(ActorMappingPackage.Literals.ACTOR_MAPPING__GROUPS,
                ActorMappingFactory.eINSTANCE.createGroups()));

        newChildDescriptors.add(createChildParameter(ActorMappingPackage.Literals.ACTOR_MAPPING__MEMBERSHIPS,
                ActorMappingFactory.eINSTANCE.createMembership()));

        newChildDescriptors.add(createChildParameter(ActorMappingPackage.Literals.ACTOR_MAPPING__ROLES,
                ActorMappingFactory.eINSTANCE.createRoles()));

        newChildDescriptors.add(createChildParameter(ActorMappingPackage.Literals.ACTOR_MAPPING__USERS,
