...
public class AbstractProcessItemProvider extends ContainerItemProvider {
    ...
    protected void addMandatorySymbolPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_MandatoryFieldsCustomization_mandatorySymbol_feature", //$NON-NLS-1$//$NON-NLS-2$
                        "_UI_MandatoryFieldsCustomization_type"), //$NON-NLS-1$
    ...
    protected void addMandatoryLabelPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_MandatoryFieldsCustomization_mandatoryLabel_feature", //$NON-NLS-1$//$NON-NLS-2$
                        "_UI_MandatoryFieldsCustomization_type"), //$NON-NLS-1$
    ...
    protected void addWelcomePageInternalPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_ProcessApplication_welcomePageInternal_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_ProcessApplication_type"), //$NON-NLS-1$
    ...
    protected void addAutoLoginPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_ProcessApplication_autoLogin_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_ProcessApplication_type"), //$NON-NLS-1$
    ...
    protected void addAutoLoginIdPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_ProcessApplication_autoLoginId_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_ProcessApplication_type"), //$NON-NLS-1$
    ...
    protected void addBasedOnLookAndFeelPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_ProcessApplication_basedOnLookAndFeel_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_ProcessApplication_type"), //$NON-NLS-1$
        ...
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
                                "_UI_AbstractPageFlow_regExpToHideDefaultField_feature", "_UI_AbstractPageFlow_type"), //$NON-NLS-1$ //$NON-NLS-2$
    ...
    protected void addUseRegExpToHideDefaultFieldPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
                                "_UI_AbstractPageFlow_useRegExpToHideDefaultField_feature", "_UI_AbstractPageFlow_type"), //$NON-NLS-1$ //$NON-NLS-2$
    ...
    protected void addByPassFormsGenerationPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_PageFlow_byPassFormsGeneration_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_PageFlow_type"), //$NON-NLS-1$
    ...
    protected void addConfirmationTemplatePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_PageFlow_confirmationTemplate_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_PageFlow_type"), //$NON-NLS-1$
    ...
    protected void addEntryPageFlowTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_PageFlow_entryPageFlowType_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_PageFlow_type"), //$NON-NLS-1$
    ...
    protected void addTransmitURLAsParameterPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_PageFlow_transmitURLAsParameter_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_PageFlow_type"), //$NON-NLS-1$
    ...
    protected void addEntryRedirectionURLPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_PageFlow_entryRedirectionURL_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_PageFlow_type"), //$NON-NLS-1$
    ...
    protected void addConfirmationMessagePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_PageFlow_confirmationMessage_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_PageFlow_type"), //$NON-NLS-1$
    ...
    protected void addLoadProfileIDPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
                                "_UI_SimulationAbstractProcess_loadProfileID_feature", "_UI_SimulationAbstractProcess_type"), //$NON-NLS-1$ //$NON-NLS-2$
    ...
    protected void addMaximumTimePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_SimulationAbstractProcess_maximumTime_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_SimulationAbstractProcess_type"), //$NON-NLS-1$
    ...
    protected void addRecapPageFlowTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_RecapFlow_recapPageFlowType_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_RecapFlow_type"), //$NON-NLS-1$
    ...
    protected void addRecapPageFlowRedirectionURLPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_RecapFlow_recapPageFlowRedirectionURL_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_RecapFlow_type"), //$NON-NLS-1$
    ...
    protected void addViewPageFlowTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_ViewPageFlow_viewPageFlowType_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_ViewPageFlow_type"), //$NON-NLS-1$
    ...
    protected void addViewPageFlowRedirectionURLPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
                                "_UI_ViewPageFlow_viewPageFlowRedirectionURL_feature", "_UI_ViewPageFlow_type"), //$NON-NLS-1$ //$NON-NLS-2$
    ...
    protected void addVersionPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_AbstractProcess_version_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_AbstractProcess_type"), //$NON-NLS-1$
    ...
    protected void addAuthorPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_AbstractProcess_author_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_AbstractProcess_type"), //$NON-NLS-1$
    ...
    protected void addCreationDatePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_AbstractProcess_creationDate_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_AbstractProcess_type"), //$NON-NLS-1$
    ...
    protected void addModificationDatePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_AbstractProcess_modificationDate_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_AbstractProcess_type"), //$NON-NLS-1$
    ...
    protected void addCategoriesPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_AbstractProcess_categories_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_AbstractProcess_type"), //$NON-NLS-1$
    ...
    protected void addConfigurationsPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_AbstractProcess_configurations_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_AbstractProcess_type"), //$NON-NLS-1$
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_AbstractProcess_type") : //$NON-NLS-1$
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.PROCESS_APPLICATION__ERROR_TEMPLATE,
                ProcessFactory.eINSTANCE.createAssociatedFile()));
        ...
        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.PROCESS_APPLICATION__PROCESS_TEMPLATE,
                ProcessFactory.eINSTANCE.createAssociatedFile()));
        ...
        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.PROCESS_APPLICATION__PAGE_TEMPLATE,
                ProcessFactory.eINSTANCE.createAssociatedFile()));
        ...
        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.PROCESS_APPLICATION__CONSULTATION_TEMPLATE,
                ProcessFactory.eINSTANCE.createAssociatedFile()));
        ...
        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.PROCESS_APPLICATION__LOG_IN_PAGE,
                ProcessFactory.eINSTANCE.createAssociatedFile()));
        ...
        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.PROCESS_APPLICATION__WELCOME_PAGE,
                ProcessFactory.eINSTANCE.createAssociatedFile()));
        ...
        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.PROCESS_APPLICATION__HOST_PAGE,
                ProcessFactory.eINSTANCE.createAssociatedFile()));
        ...
        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.DATA_AWARE__DATA,
        ...
        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.CONNECTABLE_ELEMENT__CONNECTORS,
                ProcessFactory.eINSTANCE.createConnector()));

        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.CONNECTABLE_ELEMENT__CONNECTORS,
                ProcessFactory.eINSTANCE.createActorFilter()));

        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.CONNECTABLE_ELEMENT__KPIS,
                KpiFactory.eINSTANCE.createDatabaseKPIBinding()));

        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.PAGE_FLOW__TRANSIENT_DATA,
                ProcessFactory.eINSTANCE.createData()));
        ...
        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.PAGE_FLOW__PAGE_FLOW_CONNECTORS,
                ProcessFactory.eINSTANCE.createConnector()));

        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.PAGE_FLOW__PAGE_FLOW_CONNECTORS,
                ProcessFactory.eINSTANCE.createActorFilter()));

        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.PAGE_FLOW__PAGE_FLOW_TRANSITIONS,
                ProcessFactory.eINSTANCE.createPageFlowTransition()));

        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.PAGE_FLOW__FORM,
                FormFactory.eINSTANCE.createForm()));

        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.PAGE_FLOW__FORM,
                FormFactory.eINSTANCE.createViewForm()));

        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.PAGE_FLOW__ENTRY_REDIRECTION_ACTIONS,
                ExpressionFactory.eINSTANCE.createOperation()));

        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.PAGE_FLOW__FORM_MAPPING,
                ProcessFactory.eINSTANCE.createFormMapping()));

        newChildDescriptors.add(createChildParameter(SimulationPackage.Literals.SIMULATION_DATA_CONTAINER__SIMULATION_DATA,
        ...
        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.RECAP_FLOW__RECAP_PAGE_FLOW_TRANSITIONS,
                ProcessFactory.eINSTANCE.createPageFlowTransition()));

        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.RECAP_FLOW__RECAP_TRANSIENT_DATA,
                ProcessFactory.eINSTANCE.createData()));
        ...
        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.RECAP_FLOW__RECAP_FLOW_CONNECTORS,
                ProcessFactory.eINSTANCE.createConnector()));

        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.RECAP_FLOW__RECAP_FLOW_CONNECTORS,
                ProcessFactory.eINSTANCE.createActorFilter()));

        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.RECAP_FLOW__RECAP_FORMS,
                FormFactory.eINSTANCE.createViewForm()));

        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.RECAP_FLOW__OVERVIEW_FORM_MAPPING,
                ProcessFactory.eINSTANCE.createFormMapping()));

        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_TRANSITIONS,
                ProcessFactory.eINSTANCE.createPageFlowTransition()));

        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.VIEW_PAGE_FLOW__VIEW_TRANSIENT_DATA,
                ProcessFactory.eINSTANCE.createData()));
        ...
        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_CONNECTORS,
                ProcessFactory.eINSTANCE.createConnector()));

        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_CONNECTORS,
                ProcessFactory.eINSTANCE.createActorFilter()));

        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.VIEW_PAGE_FLOW__VIEW_FORM,
                FormFactory.eINSTANCE.createViewForm()));

        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.ABSTRACT_PROCESS__DATATYPES,
        ...
        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.ABSTRACT_PROCESS__CONNECTIONS,
        ...
        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.ABSTRACT_PROCESS__ACTORS,
                ProcessFactory.eINSTANCE.createActor()));

        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.ABSTRACT_PROCESS__PARAMETERS,
