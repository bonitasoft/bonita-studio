...
/**
 * This is the item provider adapter for a {@link org.bonitasoft.studio.model.simulation.ModelVersion} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class ModelVersionItemProvider
    ...
    public String getText(Object object) {
        String label = ((ModelVersion) object).getVersion();
        return label == null || label.length() == 0 ? getString("_UI_ModelVersion_type") : //$NON-NLS-1$
                getString("_UI_ModelVersion_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
