...
public class RolesItemProvider 
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Roles_role_feature"), //$NON-NLS-1$
                 getString("_UI_PropertyDescriptor_description", "_UI_Roles_role_feature", "_UI_Roles_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                 ActorMappingPackage.Literals.ROLES__ROLE,
                 true,
                 false,
                 false,
	...
	public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/Roles")); //$NON-NLS-1$
    }
	...
	public String getText(Object object) {
        return getString("_UI_Roles_type"); //$NON-NLS-1$
    }
