...
/**
 * This is the item provider adapter for a {@link org.bonitasoft.studio.model.form.Validable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class ValidableItemProvider
     ...
     * @generated
     */
    public ValidableItemProvider(AdapterFactory adapterFactory) {
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/Validable")); //$NON-NLS-1$
    }
    ...
    public String getText(Object object) {
        Boolean labelValue = ((Validable) object).getUseDefaultValidator();
        String label = labelValue == null ? null : labelValue.toString();
        return label == null || label.length() == 0 ? getString("_UI_Validable_type") : //$NON-NLS-1$
                getString("_UI_Validable_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(Validable.class)) {
