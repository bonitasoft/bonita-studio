...
/**
 * This is the item provider adapter for a {@link org.bonitasoft.studio.model.kpi.AbstractKPIBinding} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
...
public class AbstractKPIBindingItemProvider
    ...
    protected void addKpiDefinitionNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_AbstractKPIBinding_kpiDefinitionName_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_AbstractKPIBinding_type"), //$NON-NLS-1$
    ...
    protected void addEventPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_AbstractKPIBinding_event_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_AbstractKPIBinding_type"), //$NON-NLS-1$
    ...
    protected void addIgnoreErrorPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_AbstractKPIBinding_ignoreError_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_AbstractKPIBinding_type"), //$NON-NLS-1$
    ...
    protected void addUseGraphicalEditorPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_AbstractKPIBinding_useGraphicalEditor_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_AbstractKPIBinding_type"), //$NON-NLS-1$
    ...
    protected void addRequestPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_AbstractKPIBinding_request_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_AbstractKPIBinding_type"), //$NON-NLS-1$
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_AbstractKPIBinding_type") : //$NON-NLS-1$
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(KpiPackage.Literals.ABSTRACT_KPI_BINDING__PARAMETERS,
