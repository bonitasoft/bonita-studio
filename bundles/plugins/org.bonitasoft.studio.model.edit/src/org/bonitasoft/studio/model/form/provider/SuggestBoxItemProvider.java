...
/**
 * This is the item provider adapter for a {@link org.bonitasoft.studio.model.form.SuggestBox} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SuggestBoxItemProvider extends MultipleValuatedFormFieldItemProvider {
	/**
     ...
     * @generated
     */
	public SuggestBoxItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
        if (itemPropertyDescriptors == null) {
            ...
            addUseMaxItemsPropertyDescriptor(object);
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_SuggestBox_maxItems_feature"), //$NON-NLS-1$
                 getString("_UI_PropertyDescriptor_description", "_UI_SuggestBox_maxItems_feature", "_UI_SuggestBox_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                 FormPackage.Literals.SUGGEST_BOX__MAX_ITEMS,
                 true,
                 false,
                 false,
	...
	/**
     * This adds a property descriptor for the Use Max Items feature.
     * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
     * @generated
     */
	protected void addUseMaxItemsPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_SuggestBox_useMaxItems_feature"), //$NON-NLS-1$
                 getString("_UI_PropertyDescriptor_description", "_UI_SuggestBox_useMaxItems_feature", "_UI_SuggestBox_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                 FormPackage.Literals.SUGGEST_BOX__USE_MAX_ITEMS,
                 true,
                 false,
                 false,
	...
	protected void addAsynchronousPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_SuggestBox_asynchronous_feature"), //$NON-NLS-1$
                 getString("_UI_PropertyDescriptor_description", "_UI_SuggestBox_asynchronous_feature", "_UI_SuggestBox_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	protected void addDelayPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_SuggestBox_delay_feature"), //$NON-NLS-1$
                 getString("_UI_PropertyDescriptor_description", "_UI_SuggestBox_delay_feature", "_UI_SuggestBox_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                 FormPackage.Literals.SUGGEST_BOX__DELAY,
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/SuggestBox")); //$NON-NLS-1$
    }
	...
	public String getText(Object object) {
        String label = ((SuggestBox)object).getName();
	...
	public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(SuggestBox.class)) {
