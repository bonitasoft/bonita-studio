...
/**
 * This is the item provider adapter for a {@link org.bonitasoft.studio.model.process.Association} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class AssociationItemProvider extends ConnectionItemProvider {
    ...
    protected void addIsDirectedPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(),
                        getString("_UI_Association_isDirected_feature"), //$NON-NLS-1$
                        getString("_UI_PropertyDescriptor_description", "_UI_Association_isDirected_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Association_type"), //$NON-NLS-1$
                        ProcessPackage.Literals.ASSOCIATION__IS_DIRECTED,
                        true,
                        false,
                        false,
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_Association_type") : //$NON-NLS-1$
