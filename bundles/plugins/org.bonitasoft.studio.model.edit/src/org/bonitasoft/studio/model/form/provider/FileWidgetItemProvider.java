...
public class FileWidgetItemProvider extends SingleValuatedFormFieldItemProvider {
    ...
    protected void addDownloadOnlyPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_FileWidget_downloadOnly_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_FileWidget_type"), //$NON-NLS-1$
    ...
    protected void addUsePreviewPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_FileWidget_usePreview_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_FileWidget_type"), //$NON-NLS-1$
    ...
    protected void addDocumentPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_FileWidget_document_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_FileWidget_type"), //$NON-NLS-1$
    ...
    protected void addInitialResourcePathPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_FileWidget_initialResourcePath_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_FileWidget_type"), //$NON-NLS-1$
    ...
    protected void addOutputDocumentNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_FileWidget_outputDocumentName_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_FileWidget_type"), //$NON-NLS-1$
    ...
    protected void addUpdateDocumentPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_FileWidget_updateDocument_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_FileWidget_type"), //$NON-NLS-1$
    ...
    protected void addIntialResourceListPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_FileWidget_intialResourceList_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_FileWidget_type"), //$NON-NLS-1$
    ...
    protected void addInputTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_FileWidget_inputType_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_FileWidget_type"), //$NON-NLS-1$
    ...
    protected void addDownloadTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_FileWidget_downloadType_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_FileWidget_type"), //$NON-NLS-1$
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_FileWidget_type") : //$NON-NLS-1$
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(FormPackage.Literals.FILE_WIDGET__OUTPUT_DOCUMENT_LIST_EXPRESSION,
