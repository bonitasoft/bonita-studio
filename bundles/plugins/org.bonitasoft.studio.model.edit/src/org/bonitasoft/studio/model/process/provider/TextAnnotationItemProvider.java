...
/**
 * This is the item provider adapter for a {@link org.bonitasoft.studio.model.process.TextAnnotation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
...
public class TextAnnotationItemProvider
    ...
    protected void addTextPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(),
                        getString("_UI_TextAnnotation_text_feature"), //$NON-NLS-1$
                        getString("_UI_PropertyDescriptor_description", "_UI_TextAnnotation_text_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_TextAnnotation_type"), //$NON-NLS-1$
                        ProcessPackage.Literals.TEXT_ANNOTATION__TEXT,
                        true,
                        false,
                        false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_TextAnnotation_type") : //$NON-NLS-1$
