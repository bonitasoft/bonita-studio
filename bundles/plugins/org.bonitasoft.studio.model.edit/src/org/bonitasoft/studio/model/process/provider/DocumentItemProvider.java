...
public class DocumentItemProvider
    ...
    protected void addDefaultValueIdOfDocumentStorePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Document_defaultValueIdOfDocumentStore_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Document_type"), //$NON-NLS-1$
    ...
    protected void addMimeTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Document_mimeType_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Document_type"), //$NON-NLS-1$
    ...
    protected void addDocumentTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Document_documentType_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Document_type"), //$NON-NLS-1$
    ...
    protected void addMultiplePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Document_multiple_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Document_type"), //$NON-NLS-1$
    ...
    protected void addContractInputPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Document_contractInput_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Document_type"), //$NON-NLS-1$
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_Document_type") : //$NON-NLS-1$
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.DOCUMENT__URL,
                ExpressionFactory.eINSTANCE.createExpression()));

        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.DOCUMENT__INITIAL_MULTIPLE_CONTENT,
                ExpressionFactory.eINSTANCE.createExpression()));
    }
    ...
    public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
        ...
        boolean qualify = childFeature == ProcessPackage.Literals.DOCUMENT__URL ||
