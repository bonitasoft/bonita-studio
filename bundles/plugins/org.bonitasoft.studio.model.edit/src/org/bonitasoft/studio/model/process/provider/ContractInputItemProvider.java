...
public class ContractInputItemProvider 
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 ...
                 getString("_UI_PropertyDescriptor_description", "_UI_ContractInput_name_feature", "_UI_ContractInput_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 ...
                 getString("_UI_PropertyDescriptor_description", "_UI_ContractInput_description_feature", "_UI_ContractInput_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 ...
                 getString("_UI_PropertyDescriptor_description", "_UI_ContractInput_multiple_feature", "_UI_ContractInput_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	/**
     * This adds a property descriptor for the Data Reference feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    protected void addDataReferencePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_ContractInput_dataReference_feature"), //$NON-NLS-1$
                 getString("_UI_PropertyDescriptor_description", "_UI_ContractInput_dataReference_feature", "_UI_ContractInput_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                 ProcessPackage.Literals.CONTRACT_INPUT__DATA_REFERENCE,
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (ProcessPackage.Literals.CONTRACT_INPUT__MAPPING,
                 ProcessFactory.eINSTANCE.createContractInputMapping()));

        newChildDescriptors.add
            (createChildParameter
                (ProcessPackage.Literals.CONTRACT_INPUT__INPUTS,
