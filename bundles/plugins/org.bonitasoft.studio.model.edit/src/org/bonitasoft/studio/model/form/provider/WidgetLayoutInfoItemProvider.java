    ...
    protected void addLinePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_WidgetLayoutInfo_line_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_WidgetLayoutInfo_type"), //$NON-NLS-1$
    ...
    protected void addColumnPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_WidgetLayoutInfo_column_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_WidgetLayoutInfo_type"), //$NON-NLS-1$
    ...
    protected void addVerticalSpanPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_WidgetLayoutInfo_verticalSpan_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_WidgetLayoutInfo_type"), //$NON-NLS-1$
    ...
    protected void addHorizontalSpanPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_WidgetLayoutInfo_horizontalSpan_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_WidgetLayoutInfo_type"), //$NON-NLS-1$
