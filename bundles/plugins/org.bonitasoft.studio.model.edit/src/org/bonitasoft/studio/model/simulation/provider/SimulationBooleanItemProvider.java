...
public class SimulationBooleanItemProvider extends SimulationElementItemProvider {
    ...
    protected void addProbabilityOfTruePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_SimulationBoolean_probabilityOfTrue_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_SimulationBoolean_type"), //$NON-NLS-1$
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_SimulationBoolean_type") : //$NON-NLS-1$
