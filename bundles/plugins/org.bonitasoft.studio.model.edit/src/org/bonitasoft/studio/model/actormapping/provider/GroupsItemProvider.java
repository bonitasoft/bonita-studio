...
/**
 * This is the item provider adapter for a {@link org.bonitasoft.studio.model.actormapping.Groups} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GroupsItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Groups_group_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_Groups_group_feature", "_UI_Groups_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 ActorMappingPackage.Literals.GROUPS__GROUP,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Groups")); //$NON-NLS-1$
	}
