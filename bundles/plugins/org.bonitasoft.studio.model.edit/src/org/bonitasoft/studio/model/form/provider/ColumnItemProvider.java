...
/**
 * This is the item provider adapter for a {@link org.bonitasoft.studio.model.form.Column} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ColumnItemProvider 
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Column_width_feature"), //$NON-NLS-1$
                 getString("_UI_PropertyDescriptor_description", "_UI_Column_width_feature", "_UI_Column_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                 FormPackage.Literals.COLUMN__WIDTH,
                 true,
                 false,
                 false,
	...
	protected void addNumberPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Column_number_feature"), //$NON-NLS-1$
                 getString("_UI_PropertyDescriptor_description", "_UI_Column_number_feature", "_UI_Column_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                 FormPackage.Literals.COLUMN__NUMBER,
                 true,
                 false,
                 false,
	...
	public String getText(Object object) {
        String label = ((Column)object).getWidth();
