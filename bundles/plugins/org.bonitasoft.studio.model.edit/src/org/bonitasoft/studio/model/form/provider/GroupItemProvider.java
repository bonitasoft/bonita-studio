...
public class GroupItemProvider
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(FormPackage.Literals.GROUP__WIDGETS,
        ...
        newChildDescriptors.add(createChildParameter(FormPackage.Literals.GROUP__COLUMNS,
                FormFactory.eINSTANCE.createColumn()));

        newChildDescriptors.add(createChildParameter(FormPackage.Literals.GROUP__LINES,
                FormFactory.eINSTANCE.createLine()));

        newChildDescriptors.add(createChildParameter(FormPackage.Literals.GROUP__ITERATOR,
