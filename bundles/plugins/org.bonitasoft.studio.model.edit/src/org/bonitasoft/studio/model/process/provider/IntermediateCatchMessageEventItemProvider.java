...
/**
 * This is the item provider adapter for a {@link org.bonitasoft.studio.model.process.IntermediateCatchMessageEvent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class IntermediateCatchMessageEventItemProvider extends MessageEventItemProvider {
     ...
     * @generated
     */
    public IntermediateCatchMessageEventItemProvider(AdapterFactory adapterFactory) {
    ...
    protected void addEventPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_AbstractCatchMessageEvent_event_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_AbstractCatchMessageEvent_type"), //$NON-NLS-1$
    ...
    protected void addIncomingMessagPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_AbstractCatchMessageEvent_incomingMessag_feature", //$NON-NLS-1$//$NON-NLS-2$
                        "_UI_AbstractCatchMessageEvent_type"), //$NON-NLS-1$
    ...
    protected void addCorrelationPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_AbstractCatchMessageEvent_correlation_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_AbstractCatchMessageEvent_type"), //$NON-NLS-1$
    ...
    protected void addMessageContentPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_AbstractCatchMessageEvent_messageContent_feature", //$NON-NLS-1$//$NON-NLS-2$
                        "_UI_AbstractCatchMessageEvent_type"), //$NON-NLS-1$
    ...
    /**
     * This returns IntermediateCatchMessageEvent.gif.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
     * @generated
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/IntermediateCatchMessageEvent")); //$NON-NLS-1$
    }
    ...
    public String getText(Object object) {
        String label = ((IntermediateCatchMessageEvent) object).getName();
        return label == null || label.length() == 0 ? getString("_UI_IntermediateCatchMessageEvent_type") : //$NON-NLS-1$
                getString("_UI_IntermediateCatchMessageEvent_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(IntermediateCatchMessageEvent.class)) {
