...
/**
 * This is the item provider adapter for a {@link org.bonitasoft.studio.model.simulation.SimulationNumberData} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
...
public class SimulationNumberDataItemProvider extends SimulationElementItemProvider {
    ...
    protected void addExpressionBasedPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_SimulationData_expressionBased_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_SimulationData_type"), //$NON-NLS-1$
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_SimulationNumberData_type") : //$NON-NLS-1$
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(SimulationPackage.Literals.SIMULATION_DATA__EXPRESSION,
                ExpressionFactory.eINSTANCE.createExpression()));

        newChildDescriptors.add(createChildParameter(SimulationPackage.Literals.SIMULATION_NUMBER_DATA__RANGES,
