        ...
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
                                "_UI_WidgetDependency_triggerRefreshOnModification_feature", "_UI_WidgetDependency_type"), //$NON-NLS-1$ //$NON-NLS-2$
    ...
    protected void addEventTypesPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_WidgetDependency_eventTypes_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_WidgetDependency_type"), //$NON-NLS-1$
    ...
    protected void addWidgetPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_WidgetDependency_widget_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_WidgetDependency_type"), //$NON-NLS-1$
