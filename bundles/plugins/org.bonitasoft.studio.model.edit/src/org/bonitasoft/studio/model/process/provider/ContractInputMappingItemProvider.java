...
/**
 * This is the item provider adapter for a {@link org.bonitasoft.studio.model.process.ContractInputMapping} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class ContractInputMappingItemProvider
    ...
    protected void addDataPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_ContractInputMapping_data_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_ContractInputMapping_type"), //$NON-NLS-1$
    ...
    protected void addSetterNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_ContractInputMapping_setterName_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_ContractInputMapping_type"), //$NON-NLS-1$
    ...
    protected void addSetterParamTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_ContractInputMapping_setterParamType_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_ContractInputMapping_type"), //$NON-NLS-1$
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_ContractInputMapping_type") : //$NON-NLS-1$
