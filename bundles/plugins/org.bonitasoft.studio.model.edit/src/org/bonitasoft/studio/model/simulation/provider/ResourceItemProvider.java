...
public class ResourceItemProvider extends SimulationElementItemProvider {
    ...
    protected void addQuantityPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Resource_quantity_feature", //$NON-NLS-1$//$NON-NLS-2$
    ...
    protected void addMaximumQuantityPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Resource_maximumQuantity_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Resource_type"), //$NON-NLS-1$
    ...
    protected void addCostUnitPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Resource_costUnit_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Resource_type"), //$NON-NLS-1$
    ...
    protected void addTimeUnitPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Resource_timeUnit_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Resource_type"), //$NON-NLS-1$
    ...
    protected void addFixedCostPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Resource_fixedCost_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Resource_type"), //$NON-NLS-1$
    ...
    protected void addTimeCostPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Resource_timeCost_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Resource_type"), //$NON-NLS-1$
    ...
    protected void addUnlimitedPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Resource_unlimited_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Resource_type"), //$NON-NLS-1$
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(SimulationPackage.Literals.RESOURCE__CALENDAR,
