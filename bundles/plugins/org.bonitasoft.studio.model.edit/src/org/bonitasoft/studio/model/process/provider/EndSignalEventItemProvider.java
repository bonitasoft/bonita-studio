...
/**
 * This is the item provider adapter for a {@link org.bonitasoft.studio.model.process.EndSignalEvent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class EndSignalEventItemProvider
     ...
     * @generated
     */
    public EndSignalEventItemProvider(AdapterFactory adapterFactory) {
    ...
    protected void addSignalCodePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_SignalEvent_signalCode_feature", //$NON-NLS-1$//$NON-NLS-2$
    ...
    protected void addOutgoingPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_SourceElement_outgoing_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_SourceElement_type"), //$NON-NLS-1$
    ...
    protected void addIncomingPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_TargetElement_incoming_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_TargetElement_type"), //$NON-NLS-1$
    ...
    protected void addExecutionTimePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_SimulationActivity_executionTime_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_SimulationActivity_type"), //$NON-NLS-1$
    ...
    protected void addEstimatedTimePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_SimulationActivity_estimatedTime_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_SimulationActivity_type"), //$NON-NLS-1$
    ...
    protected void addMaximumTimePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_SimulationActivity_maximumTime_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_SimulationActivity_type"), //$NON-NLS-1$
    ...
    protected void addContigousPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_SimulationActivity_contigous_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_SimulationActivity_type"), //$NON-NLS-1$
    ...
    protected void addExclusiveOutgoingTransitionPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
                                "_UI_SimulationActivity_exclusiveOutgoingTransition_feature", "_UI_SimulationActivity_type"), //$NON-NLS-1$ //$NON-NLS-2$
    ...
    protected void addDynamicLabelPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_FlowElement_dynamicLabel_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_FlowElement_type"), //$NON-NLS-1$
    ...
    protected void addDynamicDescriptionPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_FlowElement_dynamicDescription_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_FlowElement_type"), //$NON-NLS-1$
    ...
    protected void addStepSummaryPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_FlowElement_stepSummary_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_FlowElement_type"), //$NON-NLS-1$
    ...
    /**
     * This returns EndSignalEvent.gif.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
     * @generated
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/EndSignalEvent")); //$NON-NLS-1$
    }
    ...
    public String getText(Object object) {
        String label = ((EndSignalEvent) object).getName();
        return label == null || label.length() == 0 ? getString("_UI_EndSignalEvent_type") : //$NON-NLS-1$
                getString("_UI_EndSignalEvent_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(EndSignalEvent.class)) {
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(SimulationPackage.Literals.SIMULATION_ACTIVITY__RESOURCES_USAGES,
                SimulationFactory.eINSTANCE.createResourceUsage()));

        newChildDescriptors.add(createChildParameter(SimulationPackage.Literals.SIMULATION_ACTIVITY__LOOP_TRANSITION,
        ...
        newChildDescriptors.add(createChildParameter(SimulationPackage.Literals.SIMULATION_ACTIVITY__DATA_CHANGE,
