...
/**
 * This is the item provider adapter for a {@link org.bonitasoft.studio.model.process.SequenceFlow} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
...
public class SequenceFlowItemProvider extends ConnectionItemProvider {
    ...
    protected void addIsDefaultPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_SequenceFlow_isDefault_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_SequenceFlow_type"), //$NON-NLS-1$
    ...
    protected void addConditionTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_SequenceFlow_conditionType_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_SequenceFlow_type"), //$NON-NLS-1$
    ...
    protected void addConditionPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_SequenceFlow_condition_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_SequenceFlow_type"), //$NON-NLS-1$
    ...
    protected void addPathTokenPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_SequenceFlow_pathToken_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_SequenceFlow_type"), //$NON-NLS-1$
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.SEQUENCE_FLOW__DECISION_TABLE,
                DecisionFactory.eINSTANCE.createDecisionTable()));

        newChildDescriptors.add(createChildParameter(ProcessPackage.Literals.SEQUENCE_FLOW__CONDITION,
    ...
    public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
        ...
        boolean qualify = childFeature == SimulationPackage.Literals.SIMULATION_TRANSITION__EXPRESSION ||
                childFeature == ProcessPackage.Literals.SEQUENCE_FLOW__CONDITION;
