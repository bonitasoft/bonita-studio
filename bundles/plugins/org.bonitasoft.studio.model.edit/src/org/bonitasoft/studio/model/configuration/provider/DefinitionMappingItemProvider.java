...
public class DefinitionMappingItemProvider
    ...
    protected void addTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_DefinitionMapping_type_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_DefinitionMapping_type"), //$NON-NLS-1$
    ...
    protected void addDefinitionIdPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_DefinitionMapping_definitionId_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_DefinitionMapping_type"), //$NON-NLS-1$
    ...
    protected void addDefinitionVersionPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_DefinitionMapping_definitionVersion_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_DefinitionMapping_type"), //$NON-NLS-1$
    ...
    protected void addImplementationIdPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_DefinitionMapping_implementationId_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_DefinitionMapping_type"), //$NON-NLS-1$
        ...
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
                                "_UI_DefinitionMapping_implementationVersion_feature", "_UI_DefinitionMapping_type"), //$NON-NLS-1$ //$NON-NLS-2$
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_DefinitionMapping_type") : //$NON-NLS-1$
