...
/**
 * This is the item provider adapter for a {@link org.bonitasoft.studio.model.parameter.Parameter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
...
public class ParameterItemProvider
    ...
    protected void addNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        ParameterPackage.Literals.PARAMETER__NAME,
                        true,
                        false,
                        false,
    ...
    protected void addValuePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        ParameterPackage.Literals.PARAMETER__VALUE,
                        true,
                        false,
                        false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    /**
     * This adds a property descriptor for the Type Classname feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
     * @generated
    ...
    protected void addTypeClassnamePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(),
                        getString("_UI_Parameter_typeClassname_feature"), //$NON-NLS-1$
                        getString("_UI_PropertyDescriptor_description", "_UI_Parameter_typeClassname_feature", //$NON-NLS-1$//$NON-NLS-2$
    ...
    protected void addDescriptionPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Parameter_description_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Parameter_type"), //$NON-NLS-1$
                        ParameterPackage.Literals.PARAMETER__DESCRIPTION,
                        true,
                        false,
                        false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
