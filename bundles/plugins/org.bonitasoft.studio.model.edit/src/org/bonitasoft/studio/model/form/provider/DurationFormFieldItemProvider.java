...
/**
 * This is the item provider adapter for a {@link org.bonitasoft.studio.model.form.DurationFormField} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DurationFormFieldItemProvider extends SingleValuatedFormFieldItemProvider {
	/**
     ...
     * @generated
     */
	public DurationFormFieldItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
        if (itemPropertyDescriptors == null) {
            ...
            addItemClassPropertyDescriptor(object);
	...
	/**
     * This adds a property descriptor for the Item Class feature.
     * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
     * @generated
     */
	protected void addItemClassPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_ItemContainer_itemClass_feature"), //$NON-NLS-1$
                 getString("_UI_PropertyDescriptor_description", "_UI_ItemContainer_itemClass_feature", "_UI_ItemContainer_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	protected void addDayPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_DurationFormField_day_feature"), //$NON-NLS-1$
                 getString("_UI_PropertyDescriptor_description", "_UI_DurationFormField_day_feature", "_UI_DurationFormField_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                 FormPackage.Literals.DURATION_FORM_FIELD__DAY,
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addHourPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_DurationFormField_hour_feature"), //$NON-NLS-1$
                 getString("_UI_PropertyDescriptor_description", "_UI_DurationFormField_hour_feature", "_UI_DurationFormField_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                 FormPackage.Literals.DURATION_FORM_FIELD__HOUR,
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addMinPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_DurationFormField_min_feature"), //$NON-NLS-1$
                 getString("_UI_PropertyDescriptor_description", "_UI_DurationFormField_min_feature", "_UI_DurationFormField_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                 FormPackage.Literals.DURATION_FORM_FIELD__MIN,
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addSecPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_DurationFormField_sec_feature"), //$NON-NLS-1$
                 getString("_UI_PropertyDescriptor_description", "_UI_DurationFormField_sec_feature", "_UI_DurationFormField_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                 FormPackage.Literals.DURATION_FORM_FIELD__SEC,
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
     * This returns DurationFormField.gif.
     * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
     * @generated
     */
	...
	public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/DurationFormField")); //$NON-NLS-1$
    }
	...
	public String getText(Object object) {
        String label = ((DurationFormField)object).getName();
	...
	public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(DurationFormField.class)) {
