...
/**
 * This is the item provider adapter for a {@link org.bonitasoft.studio.model.form.Line} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LineItemProvider 
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Line_height_feature"), //$NON-NLS-1$
                 getString("_UI_PropertyDescriptor_description", "_UI_Line_height_feature", "_UI_Line_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                 FormPackage.Literals.LINE__HEIGHT,
                 true,
                 false,
                 false,
	...
	protected void addNumberPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Line_number_feature"), //$NON-NLS-1$
                 getString("_UI_PropertyDescriptor_description", "_UI_Line_number_feature", "_UI_Line_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                 FormPackage.Literals.LINE__NUMBER,
                 true,
                 false,
                 false,
	...
	public String getText(Object object) {
        String label = ((Line)object).getHeight();
