...
/**
 * This is the item provider adapter for a {@link org.bonitasoft.studio.model.process.ServiceTask} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
...
public class ServiceTaskItemProvider extends ActivityItemProvider {
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/ServiceTask")); //$NON-NLS-1$
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_ServiceTask_type") : //$NON-NLS-1$
                getString("_UI_ServiceTask_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
