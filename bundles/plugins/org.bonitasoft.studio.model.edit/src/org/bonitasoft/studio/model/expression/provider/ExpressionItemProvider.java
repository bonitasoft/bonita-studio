    ...
    protected void addContentPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Expression_content_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Expression_type"), //$NON-NLS-1$
    ...
    protected void addInterpreterPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Expression_interpreter_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Expression_type"), //$NON-NLS-1$
    ...
    protected void addTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Expression_type_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Expression_type"), //$NON-NLS-1$
    ...
    protected void addReturnTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Expression_returnType_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Expression_type"), //$NON-NLS-1$
    ...
    protected void addReferencedElementsPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Expression_referencedElements_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Expression_type"), //$NON-NLS-1$
    ...
    protected void addConnectorsPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Expression_connectors_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Expression_type"), //$NON-NLS-1$
    ...
    protected void addPropagateVariableChangePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Expression_propagateVariableChange_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Expression_type"), //$NON-NLS-1$
    ...
    protected void addReturnTypeFixedPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Expression_returnTypeFixed_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Expression_type"), //$NON-NLS-1$
    ...
    protected void addAutomaticDependenciesPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Expression_automaticDependencies_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Expression_type"), //$NON-NLS-1$
    ...
    protected void addHtmlAllowedPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Expression_htmlAllowed_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_Expression_type"), //$NON-NLS-1$
