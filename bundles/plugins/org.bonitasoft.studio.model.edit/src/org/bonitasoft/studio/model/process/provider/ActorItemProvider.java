...
/**
 * This is the item provider adapter for a {@link org.bonitasoft.studio.model.process.Actor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
...
public class ActorItemProvider
    ...
    protected void addInitiatorPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(),
                        getString("_UI_Actor_initiator_feature"), //$NON-NLS-1$
                        getString("_UI_PropertyDescriptor_description", "_UI_Actor_initiator_feature", "_UI_Actor_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                        ProcessPackage.Literals.ACTOR__INITIATOR,
                        true,
                        false,
                        false,
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_Actor_type") : //$NON-NLS-1$
