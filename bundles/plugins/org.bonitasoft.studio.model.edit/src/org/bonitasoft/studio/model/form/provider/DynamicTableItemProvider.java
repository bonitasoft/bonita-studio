...
public class DynamicTableItemProvider extends AbstractTableItemProvider {
    ...
    protected void addLimitMinNumberOfColumnPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_DynamicTable_limitMinNumberOfColumn_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_DynamicTable_type"), //$NON-NLS-1$
    ...
    protected void addLimitMinNumberOfRowPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_DynamicTable_limitMinNumberOfRow_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_DynamicTable_type"), //$NON-NLS-1$
    ...
    protected void addAllowAddRemoveRowPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_DynamicTable_allowAddRemoveRow_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_DynamicTable_type"), //$NON-NLS-1$
    ...
    protected void addAllowAddRemoveColumnPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_DynamicTable_allowAddRemoveColumn_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_DynamicTable_type"), //$NON-NLS-1$
    ...
    protected void addLimitMaxNumberOfColumnPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_DynamicTable_limitMaxNumberOfColumn_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_DynamicTable_type"), //$NON-NLS-1$
    ...
    protected void addLimitMaxNumberOfRowPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_DynamicTable_limitMaxNumberOfRow_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_DynamicTable_type"), //$NON-NLS-1$
    ...
    protected void addMinNumberOfColumnPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_DynamicTable_minNumberOfColumn_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_DynamicTable_type"), //$NON-NLS-1$
    ...
    protected void addMinNumberOfRowPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_DynamicTable_minNumberOfRow_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_DynamicTable_type"), //$NON-NLS-1$
    ...
    protected void addMaxNumberOfColumnPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_DynamicTable_maxNumberOfColumn_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_DynamicTable_type"), //$NON-NLS-1$
    ...
    protected void addMaxNumberOfRowPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_DynamicTable_maxNumberOfRow_feature", //$NON-NLS-1$//$NON-NLS-2$
                                "_UI_DynamicTable_type"), //$NON-NLS-1$
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_DynamicTable_type") : //$NON-NLS-1$
