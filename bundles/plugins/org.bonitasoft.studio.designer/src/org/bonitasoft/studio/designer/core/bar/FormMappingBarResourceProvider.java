...
public class FormMappingBarResourceProvider implements BARResourcesProvider {
    ...
    private void addFormMapping(final BusinessArchiveBuilder builder, final FormMappingModel formMappingModel, final FormMapping formMapping)
            throws BarResourceCreationException, InternalFormNotFoundException {
    ...
    private boolean isValid(final FormMapping formMapping) throws InternalFormNotFoundException {
        switch (formMapping.getType()) {
            case URL:
            ...
            case INTERNAL:
                ...
                return formMappingType == FormMappingType.PROCESS_OVERVIEW || formMapping
