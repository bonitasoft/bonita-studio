...
public class GroupsWizardPage extends AbstractOrganizationWizardPage implements ValidatorConstants {
    ...
    final class UniqueGroupNameValidator implements IValidator {
        ...
        @Override
        public IStatus validate(final Object value) {
            for (final org.bonitasoft.studio.identity.organization.model.organization.Group g : groupList) {
                final org.bonitasoft.studio.identity.organization.model.organization.Group selectedGroup = (org.bonitasoft.studio.identity.organization.model.organization.Group) groupSingleSelectionObservable
                        .getValue();
        ...
        groupSingleSelectionObservable.addValueChangeListener(new IValueChangeListener() {
            ...
            private final Adapter groupAdapter = new AdapterImpl() {
                ...
                public void notifyChanged(Notification notification) {
                    switch (notification.getFeatureID(org.bonitasoft.studio.identity.organization.model.organization.Group.class)) {
            ...
            public void handleValueChange(final ValueChangeEvent event) {
                final org.bonitasoft.studio.identity.organization.model.organization.Group previousGroup = (org.bonitasoft.studio.identity.organization.model.organization.Group) event.diff
                        .getOldValue();
                if (previousGroup != null) {
                    previousGroup.eAdapters().remove(groupAdapter);
                }
                final org.bonitasoft.studio.identity.organization.model.organization.Group selectedGroup = (org.bonitasoft.studio.identity.organization.model.organization.Group) event.diff
                        .getNewValue();
    ...
    protected void configureViewer(final StructuredViewer viewer) {
        viewer.setLabelProvider(new LabelProvider() {
            ...
            public String getText(final Object element) {
                final String displayName = ((org.bonitasoft.studio.identity.organization.model.organization.Group) element)
                        .getDisplayName();
                if (displayName == null || displayName.isEmpty()) {
                    return ((org.bonitasoft.studio.identity.organization.model.organization.Group) element).getName();
                }
                return displayName;
            }
        });
    ...
    protected void handleGroupNameChange(final Notification notification) {
        final org.bonitasoft.studio.identity.organization.model.organization.Group group = (org.bonitasoft.studio.identity.organization.model.organization.Group) notification
                .getNotifier();
        final org.bonitasoft.studio.identity.organization.model.organization.Group oldGroup = EcoreUtil.copy(group);
            ...
            if (oldGroup != null) {
                ...
                if (provider != null && provider.hasChildren(oldGroup)) {
                    for (final Object child : provider.getChildren(oldGroup)) {
                        final org.bonitasoft.studio.identity.organization.model.organization.Group childGroup = (org.bonitasoft.studio.identity.organization.model.organization.Group) child;
    ...
    private void handleGroupDisplayName(final ValueChangeEvent event) {
        final org.bonitasoft.studio.identity.organization.model.organization.Group group = (org.bonitasoft.studio.identity.organization.model.organization.Group) groupSingleSelectionObservable
                .getValue();
        final org.bonitasoft.studio.identity.organization.model.organization.Group oldGroup = EcoreUtil.copy(group);
    ...
    private void updateParentPath(final org.bonitasoft.studio.identity.organization.model.organization.Group group,
    ...
    protected void addButtonSelected() {
        final org.bonitasoft.studio.identity.organization.model.organization.Group parentGoup = (org.bonitasoft.studio.identity.organization.model.organization.Group) ((IStructuredSelection) getViewer()
                .getSelection()).getFirstElement();
        final org.bonitasoft.studio.identity.organization.model.organization.Group group = OrganizationFactory.eINSTANCE.createGroup();
    ...
    protected void removeButtonSelected() {
        for (final Object sel : ((IStructuredSelection) getViewer().getSelection()).toList()) {
            if (sel instanceof org.bonitasoft.studio.identity.organization.model.organization.Group) {
