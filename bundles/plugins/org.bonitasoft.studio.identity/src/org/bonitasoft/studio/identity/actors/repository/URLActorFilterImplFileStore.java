 ...
 */
public class URLActorFilterImplFileStore extends ActorFilterImplFileStore {

    private final URL url;

    public URLActorFilterImplFileStore(final URL url, final AbstractEMFRepositoryStore<ActorFilterImplFileStore> store) {
