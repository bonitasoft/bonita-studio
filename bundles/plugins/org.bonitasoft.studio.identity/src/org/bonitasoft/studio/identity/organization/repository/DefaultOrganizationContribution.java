...
public class DefaultOrganizationContribution implements IFileStoreContribution {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.bonitasoft.studio.common.repository.model.IFileStoreContribution#
	 * appliesTo(org.bonitasoft.studio.common.repository.model.IRepositoryStore)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.bonitasoft.studio.common.repository.model.IFileStoreContribution#execute(
	...
	public List<User> getDefaultUsers() {
		...
		defaultUsers.add(createUser(mr, "william.jobs", "William", "Jobs", "bpm", null, "Chief Executive Officer"));
		defaultUsers.add(
				createUser(mrs, "april.sanchez", "April", "Sanchez", "bpm", "helen.kelly", "Compensation specialist"));
		defaultUsers
				.add(createUser(mrs, "helen.kelly", "Helen", "Kelly", "bpm", "william.jobs", "Human resource manager"));
		defaultUsers.add(
				createUser(mr, "walter.bates", "Walter", "Bates", "bpm", "helen.kelly", "Human resources benefits"));

		defaultUsers.add(createUser(mr, "zachary.williamson", "Zachary", "Williamson", "bpm", "william.jobs",
				"Chief Financial Officer"));
		defaultUsers.add(createUser(mr, "patrick.gardenier", "Patrick", "Gardenier", "bpm", "zachary.williamson",
				"Financial controller"));
		defaultUsers.add(
				createUser(mrs, "virginie.jomphe", "Virginie", "Jomphe", "bpm", "zachary.williamson", "Accountant"));
		defaultUsers.add(createUser(mr, "thorsten.hartmann", "Thorsten", "Hartmann", "bpm", "zachary.williamson",
				"Financial planning manager"));

		defaultUsers
				.add(createUser(mr, "jan.fisher", "Jan", "Fisher", "bpm", "favio.riviera", "Infrastucture specialist"));

		defaultUsers.add(createUser(mrs, "isabel.bleasdale", "Isabel", "Bleasdale", "bpm", "favio.riviera",
				"Product marketing manager"));
		defaultUsers.add(createUser(mr, "favio.riviera", "Favio", "Riviera", "bpm", "william.jobs",
				"Vice President of Marketing"));

		defaultUsers.add(createUser(mr, "michael.morrison", "Michael", "Morrison", "bpm", "william.jobs",
				"Chief Technical Officer"));
		defaultUsers.add(createUser(mr, "marc.marseau", "Marc", "Marseau", "bpm", "michael.morrison", "Engineer"));
		defaultUsers.add(createUser(mr, "joseph.hovell", "Joseph", "Hovell", "bpm", "michael.morrison", "Engineer"));

		defaultUsers
				.add(createUser(mr, "mauro.zetticci", "Mauro", "Zetticci", "bpm", "michael.morrison", "Consultant"));
		defaultUsers.add(createUser(mr, "thomas.wallis", "Thomas", "Wallis", "bpm", "michael.morrison", "Consultant"));

		defaultUsers.add(createUser(mrs, "daniela.angelo", "Daniela", "Angelo", "bpm", "william.jobs",
				"Vice President of Sales"));
		defaultUsers.add(
				createUser(mr, "anthony.nichols", "Anthony", "Nichols", "bpm", "daniela.angelo", "Account manager"));
		defaultUsers
				.add(createUser(mrs, "misa.kumagai", "Misa", "Kumagai", "bpm", "daniela.angelo", "Account manager"));
		defaultUsers
				.add(createUser(mr, "norio.yamazaki", "Norio", "Yamazaki", "bpm", "daniela.angelo", "Account manager"));
		defaultUsers.add(
				createUser(mrs, "giovanna.almeida", "Giovanna", "Almeida", "bpm", "daniela.angelo", "Account manager"));
	...
	private User createUser(final String title, final String username, final String firstname, final String lastname,
			final String password, final String manager, final String jobTitle) {
