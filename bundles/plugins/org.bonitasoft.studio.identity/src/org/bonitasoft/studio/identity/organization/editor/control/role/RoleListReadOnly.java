...
public class RoleListReadOnly extends RoleList {

    public RoleListReadOnly(Composite parent, AbstractOrganizationFormPage formPage, DataBindingContext ctx) {
        ...
        var buttonWidget = new DynamicButtonWidget.Builder()
                ...
                .onClick(e -> formPage.getEditor().setActivePage("roles"))
                .createIn(section);
