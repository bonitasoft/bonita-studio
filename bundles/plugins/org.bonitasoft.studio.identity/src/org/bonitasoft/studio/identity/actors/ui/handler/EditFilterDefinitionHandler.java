...
import org.bonitasoft.studio.identity.actors.ui.wizard.SelectUserFilterDefinitionWizard;
...
public class EditFilterDefinitionHandler extends AbstractHandler {
    ...
    public Object execute(ExecutionEvent event) throws ExecutionException {
        ...
        if(selectDialog.open() == Dialog.OK){
            ...
            final DefinitionResourceProvider messageProvider = DefinitionResourceProvider.getInstance(defStore,IdentityPlugin.getDefault().getBundle());
