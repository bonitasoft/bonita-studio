 ...
 * 
 */
public class FilterDefinitionContentProvider extends AbstractDefinitionContentProvider {

	public FilterDefinitionContentProvider(boolean userDefinitionOnly) {
		super(userDefinitionOnly);
	}

	public FilterDefinitionContentProvider() {
		super();
	}
