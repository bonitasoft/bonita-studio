...
import org.bonitasoft.studio.identity.actors.ui.wizard.page.FilterUniqueDefinitionContentProvider;
...
public class FilterImplementationWizard extends ConnectorImplementationWizard {
    ...
    protected void initialize() {
        ...
        messageProvider = DefinitionResourceProvider.getInstance(defStore, IdentityPlugin.getDefault().getBundle()) ;
    }
