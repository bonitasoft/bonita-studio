...
import org.bonitasoft.studio.identity.actors.action.ExportActorMappingAction;
import org.bonitasoft.studio.identity.actors.action.ImportActorMappingAction;
import org.bonitasoft.studio.identity.actors.ui.wizard.SelectGroupsWizard;
import org.bonitasoft.studio.identity.actors.ui.wizard.SelectMembershipsWizard;
import org.bonitasoft.studio.identity.actors.ui.wizard.SelectRolesWizard;
import org.bonitasoft.studio.identity.actors.ui.wizard.SelectUsersWizard;
...
public class ActorMappingConfigurationWizardPage extends WizardPage
    ...
    public Image getConfigurationImage() {
        return Pics.getImage("actors_mapping.png", IdentityPlugin.getDefault());
    }
