...
public class BonitaProposalFilter implements IProposalFilter {
     ...
     * 
     */
    public BonitaProposalFilter() {

    }

    /* (non-Javadoc)
     * @see org.codehaus.groovy.eclipse.codeassist.processors.IProposalFilter#filterProposals(java.util.List, org.codehaus.groovy.eclipse.codeassist.requestor.ContentAssistContext, org.eclipse.jdt.ui.text.java.JavaContentAssistInvocationContext)
     */
    @Override
