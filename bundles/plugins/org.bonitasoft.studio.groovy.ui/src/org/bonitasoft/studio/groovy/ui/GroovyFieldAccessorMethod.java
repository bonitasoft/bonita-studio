...
public class GroovyFieldAccessorMethod implements IMethod {
    ...
    public GroovyFieldAccessorMethod(IType declaringType, String name, String returnType, String[] parameterNames,
    ...
    /*
     * (non-Javadoc)
     * @see org.eclipse.jdt.core.IMethod#isMainMethodCandidate()
     */
    @Override
