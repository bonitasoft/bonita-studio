...
public class ConditionModelStandaloneSetupGenerated implements ISetup {
	...
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.bonitasoft.org/studio/condition/ConditionModel")) {
		EPackage.Registry.INSTANCE.put("http://www.bonitasoft.org/studio/condition/ConditionModel", org.bonitasoft.studio.condition.conditionModel.ConditionModelPackage.eINSTANCE);
	}
		...
		org.eclipse.xtext.resource.IResourceServiceProvider.Registry.INSTANCE.getExtensionToFactoryMap().put("cmodel", serviceProvider);
