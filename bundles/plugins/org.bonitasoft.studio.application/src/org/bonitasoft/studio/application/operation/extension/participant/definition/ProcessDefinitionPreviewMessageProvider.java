...
public class ProcessDefinitionPreviewMessageProvider implements PreviewMessageProvider {
    ...
    public String getMessage() {
        return String.format("%s  %s", Messages.definitionUpateMessage, Messages.updateActionsMessage);
    }
