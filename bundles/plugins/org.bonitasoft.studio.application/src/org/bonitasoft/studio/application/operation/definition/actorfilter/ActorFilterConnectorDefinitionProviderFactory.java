...
public class ActorFilterConnectorDefinitionProviderFactory implements ConnectorDefinitionProviderFactory {
    
    private ActorFilterDefRepositoryStore actorFilterDefStore;

    public ActorFilterConnectorDefinitionProviderFactory(ActorFilterDefRepositoryStore actorFilterDefStore) {
        this.actorFilterDefStore = actorFilterDefStore;
    }

    @Override
    public ConnectorDefinitionProvider get() {
        return new ActorFilterConnectorDefinitionProvider(actorFilterDefStore);
    }
