	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		try {
			...
			if(globalProperties != null){
				...
				url = "http://docs.bonitasoft.com/" ;
			}
			IWebBrowser browser = PlatformUI.getWorkbench().getBrowserSupport().createBrowser(IWorkbenchBrowserSupport.AS_EDITOR,BonitaPreferenceConstants.HELP_BROWSER_ID,"Quick Start","");
