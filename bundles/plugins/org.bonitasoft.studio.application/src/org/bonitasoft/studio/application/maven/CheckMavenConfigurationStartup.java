...
public class CheckMavenConfigurationStartup implements IStartup {
    ...
    public void earlyStartup() {
        var prefStore = ApplicationPlugin.getDefault().getPreferenceStore();
        var skipCheck = prefStore.getBoolean(BonitaMavenConfigurationManager.SKIP_MAVEN_CONFIGURATION_CKECK_PREFERENCE);
        if (!skipCheck) {
            BonitaMavenConfigurationManager.testConnection(false);
        }
    }
