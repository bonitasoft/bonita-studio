...
public class ProjectOverviewEditorPart extends EditorPart implements EventHandler, IMavenProjectChangedListener {
    ...
    public static final String CREATE_EXTENSION_COMMAND = "org.bonitasoft.studio.extension.newCommand";
    /** Parameter for commands, with the extension type as {@link ArtifactType} {@link ArtifactType#name()} */
        ...
        repositoryAccessor.getCurrentRepository().ifPresent(current -> {
            events.stream()
                    ...
                    .filter(e -> Objects.equals(e.getMavenProject().getPom(),
                            current.getProject().getFile(IMavenConstants.POM_FILE_NAME)))
