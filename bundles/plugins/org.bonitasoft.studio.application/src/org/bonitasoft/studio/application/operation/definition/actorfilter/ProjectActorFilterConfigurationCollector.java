 ...
 */
package org.bonitasoft.studio.application.operation.definition.actorfilter;
...
public class ProjectActorFilterConfigurationCollector implements ConnectorConfigurationCollector {
    ...
    private ActorFilterConfRepositoryStore confStore;

    public ProjectActorFilterConfigurationCollector(DiagramRepositoryStore diagramStore,
            ActorFilterConfRepositoryStore confStore) {
    ...
    public Collection<ConnectorConfiguration> getConfigurations(String definitionId, String definitionVersion) {
        ...
        return Stream.concat(diagramStore.getComputedProcesses().stream()
                .flatMap(process -> ModelHelper.getAllElementOfTypeIn(process, ActorFilter.class).stream())
                .map(ActorFilter::getConfiguration)
