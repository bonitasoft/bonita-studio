...
public class BonitaStudioApplicationTest extends AbstractSWTTestCase {
    ...
    @Test
    public void should_createWorkbenchAdvisor_return_a_BonitaStudioWorkbenchAdvisor() throws Exception {
        assertThat(application.createWorkbenchAdvisor()).isInstanceOf(BonitaStudioWorkbenchAdvisor.class);
    }
