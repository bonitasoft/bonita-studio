...
public class SmartImportPackageModelTest {
    ...
    public void should_return_bo_to_import() {
        SmartImportPackageModel packageModel = new SmartImportPackageModel("com.bonitasoft");

        BusinessObject boConflicting = new BusinessObjectBuilder("com.bonitasoft.Conflicting").build();
        SmartImportBusinessObjectModel modelConflicting = new SmartImportBusinessObjectModel(packageModel, boConflicting);
        ...
        SmartImportBusinessObjectModel modelNone = new SmartImportBusinessObjectModel(packageModel, boNone);
        ...
        SmartImportBusinessObjectModel modelSameContent = new SmartImportBusinessObjectModel(packageModel, boSameContent);
