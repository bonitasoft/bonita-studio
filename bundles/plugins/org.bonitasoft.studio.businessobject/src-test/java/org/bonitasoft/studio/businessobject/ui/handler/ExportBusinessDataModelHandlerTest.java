...
public class ExportBusinessDataModelHandlerTest {
    ...
    public void setUp() throws Exception {
        ...
        doReturn(wizardDialog).when(handlerUnderTest).createWizardDialog(wizard, Messages.export);
    }
    ...
    public void shouldExecute_OpenWizardDialogWithExportWizard() throws Exception {
        ...
        verify(handlerUnderTest).createWizardDialog(wizard, Messages.export);
