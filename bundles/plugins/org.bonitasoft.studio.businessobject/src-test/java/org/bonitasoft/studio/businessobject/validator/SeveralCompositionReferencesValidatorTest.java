...
import org.bonitasoft.studio.businessobject.validator.SeveralCompositionReferencesValidator;
import org.eclipse.core.databinding.observable.value.IObservableValue;
import org.eclipse.core.runtime.IStatus;
import org.junit.Before;
import org.junit.Test;

public class SeveralCompositionReferencesValidatorTest {
    ...
    public void should_return_warning_if_bo_used_in_composition_and_aggregation() {
        SeveralCompositionReferencesValidator validator = new SeveralCompositionReferencesValidator(modelObservable);
        ...
        assertThat(status.getMessage()).isEqualTo(
                String.format(Messages.severalCompositionReferenceForABusinessObject, businessObject2.getSimpleName()));
