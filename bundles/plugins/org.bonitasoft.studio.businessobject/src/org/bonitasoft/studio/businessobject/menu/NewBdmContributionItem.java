...
public class NewBdmContributionItem extends ContributionItem {
    ...
    public void fill(Menu parent, int index) {
        ...
        item.setText(Messages.businessDataModel);
        item.addListener(SWT.Selection, e -> commandExecutor.executeCommand(NEW_COMMAND, null));
        item.setEnabled(true);
        item.setImage(Pics.getImage(PicsConstants.bdm));
    }
