...
import org.bonitasoft.studio.businessobject.ui.wizard.validator.QueryNameCellEditorValidator;
 ...
 */
public class QueryNameEditingSupport extends ObservableValueEditingSupport {
     ...
     * @param dbc
     */
    public QueryNameEditingSupport(final IObservableValue viewerObservableValue, final ColumnViewer viewer, final DataBindingContext dbc) {
        super(viewer, dbc);
        this.dbc = dbc;
    ...
    protected CellEditor getCellEditor(final Object element) {
        ...
        textControl.setData(SWTBotConstants.SWTBOT_WIDGET_ID_KEY, SWTBotConstants.SWTBOT_ID_QUERY_NAME_TEXTEDITOR);
        textControl.setTextLimit(QueryNameCellEditorValidator.MAX_QUERY_NAME_LENGTH + 5);
    ...
    protected Binding createBinding(final IObservableValue target, final IObservableValue model) {
        ...
        targetToModel.setAfterGetValidator(new QueryNameCellEditorValidator((BusinessObject) viewerObservableValue.getValue(),
                (Query) ((BeanObservableValueDecorator) model).getObserved()));
