...
public class ActorMappingImpl extends EObjectImpl implements ActorMapping {
    ...
    public NotificationChain basicSetGroups(Groups newGroups, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ActorMappingPackage.ACTOR_MAPPING__GROUPS, oldGroups, newGroups);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setGroups(Groups newGroups) {
        if (newGroups != groups) {
            ...
            if (groups != null)
                msgs = ((InternalEObject) groups).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ActorMappingPackage.ACTOR_MAPPING__GROUPS, null, msgs);
            if (newGroups != null)
                msgs = ((InternalEObject) newGroups).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - ActorMappingPackage.ACTOR_MAPPING__GROUPS, null, msgs);
            msgs = basicSetGroups(newGroups, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ActorMappingPackage.ACTOR_MAPPING__GROUPS, newGroups,
                    newGroups));
    }
    ...
    public NotificationChain basicSetMemberships(Membership newMemberships, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ActorMappingPackage.ACTOR_MAPPING__MEMBERSHIPS, oldMemberships, newMemberships);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setMemberships(Membership newMemberships) {
        if (newMemberships != memberships) {
            NotificationChain msgs = null;
            if (memberships != null)
                msgs = ((InternalEObject) memberships).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ActorMappingPackage.ACTOR_MAPPING__MEMBERSHIPS, null, msgs);
            if (newMemberships != null)
                msgs = ((InternalEObject) newMemberships).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - ActorMappingPackage.ACTOR_MAPPING__MEMBERSHIPS, null, msgs);
            msgs = basicSetMemberships(newMemberships, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ActorMappingPackage.ACTOR_MAPPING__MEMBERSHIPS,
    ...
    public NotificationChain basicSetRoles(Roles newRoles, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ActorMappingPackage.ACTOR_MAPPING__ROLES, oldRoles, newRoles);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newRoles != roles) {
            ...
            if (roles != null)
                msgs = ((InternalEObject) roles).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ActorMappingPackage.ACTOR_MAPPING__ROLES, null, msgs);
            if (newRoles != null)
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ActorMappingPackage.ACTOR_MAPPING__ROLES, newRoles,
                    newRoles));
    }
    ...
    public NotificationChain basicSetUsers(Users newUsers, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ActorMappingPackage.ACTOR_MAPPING__USERS, oldUsers, newUsers);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setUsers(Users newUsers) {
        if (newUsers != users) {
            NotificationChain msgs = null;
            if (users != null)
                msgs = ((InternalEObject) users).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ActorMappingPackage.ACTOR_MAPPING__USERS, null, msgs);
            if (newUsers != null)
                msgs = ((InternalEObject) newUsers).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - ActorMappingPackage.ACTOR_MAPPING__USERS, null, msgs);
            msgs = basicSetUsers(newUsers, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ActorMappingPackage.ACTOR_MAPPING__USERS, newUsers,
                    newUsers));
    }
