 ...
 * </p>
 * <ul>
 * <li>{@link org.bonitasoft.studio.model.form.impl.MandatoryFieldsCustomizationImpl#getMandatorySymbol <em>Mandatory
 * Symbol</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.MandatoryFieldsCustomizationImpl#getMandatoryLabel <em>Mandatory
 * Label</em>}</li>
 * </ul>
 *
 * @generated
...
public abstract class MandatoryFieldsCustomizationImpl extends CSSCustomizableImpl implements MandatoryFieldsCustomization {
    ...
    public NotificationChain basicSetMandatorySymbol(Expression newMandatorySymbol, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.MANDATORY_FIELDS_CUSTOMIZATION__MANDATORY_SYMBOL, oldMandatorySymbol, newMandatorySymbol);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newMandatorySymbol != mandatorySymbol) {
            ...
            if (mandatorySymbol != null)
                msgs = ((InternalEObject) mandatorySymbol).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.MANDATORY_FIELDS_CUSTOMIZATION__MANDATORY_SYMBOL, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    FormPackage.MANDATORY_FIELDS_CUSTOMIZATION__MANDATORY_SYMBOL, newMandatorySymbol, newMandatorySymbol));
    }
    ...
    public NotificationChain basicSetMandatoryLabel(Expression newMandatoryLabel, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.MANDATORY_FIELDS_CUSTOMIZATION__MANDATORY_LABEL, oldMandatoryLabel, newMandatoryLabel);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newMandatoryLabel != mandatoryLabel) {
            ...
            if (mandatoryLabel != null)
                msgs = ((InternalEObject) mandatoryLabel).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.MANDATORY_FIELDS_CUSTOMIZATION__MANDATORY_LABEL, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    FormPackage.MANDATORY_FIELDS_CUSTOMIZATION__MANDATORY_LABEL, newMandatoryLabel, newMandatoryLabel));
    }
