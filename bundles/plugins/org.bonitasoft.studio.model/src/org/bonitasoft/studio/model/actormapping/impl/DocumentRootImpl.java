 ...
 * <li>{@link org.bonitasoft.studio.model.actormapping.impl.DocumentRootImpl#getXMLNSPrefixMap <em>XMLNS Prefix
 * Map</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.actormapping.impl.DocumentRootImpl#getXSISchemaLocation <em>XSI Schema
 * Location</em>}</li>
...
public class DocumentRootImpl extends EObjectImpl implements DocumentRoot {
    ...
    public EMap<String, String> getXMLNSPrefixMap() {
        if (xMLNSPrefixMap == null) {
            xMLNSPrefixMap = new EcoreEMap<String, String>(EcorePackage.Literals.ESTRING_TO_STRING_MAP_ENTRY,
                    EStringToStringMapEntryImpl.class, this, ActorMappingPackage.DOCUMENT_ROOT__XMLNS_PREFIX_MAP);
        }
    ...
    public EMap<String, String> getXSISchemaLocation() {
        if (xSISchemaLocation == null) {
            xSISchemaLocation = new EcoreEMap<String, String>(EcorePackage.Literals.ESTRING_TO_STRING_MAP_ENTRY,
                    EStringToStringMapEntryImpl.class, this, ActorMappingPackage.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION);
        }
    ...
    public NotificationChain basicSetActorMappings(ActorMappingsType newActorMappings, NotificationChain msgs) {
        return ((FeatureMap.Internal) getMixed()).basicAdd(ActorMappingPackage.Literals.DOCUMENT_ROOT__ACTOR_MAPPINGS,
                newActorMappings, msgs);
    }
