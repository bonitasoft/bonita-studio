...
public class TextAnnotationAttachmentImpl extends EObjectImpl implements TextAnnotationAttachment {
            ...
            if (source != oldSource) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            ProcessPackage.TEXT_ANNOTATION_ATTACHMENT__SOURCE, oldSource, source));
            }
        }
        return source;
    }
    ...
    public void setSource(TextAnnotation newSource) {
        ...
        source = newSource;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.TEXT_ANNOTATION_ATTACHMENT__SOURCE,
                    oldSource, source));
    }
    ...
    public Element getTarget() {
        if (eContainerFeatureID() != ProcessPackage.TEXT_ANNOTATION_ATTACHMENT__TARGET)
            return null;
    ...
    public void setTarget(Element newTarget) {
        if (newTarget != eInternalContainer()
                || (eContainerFeatureID() != ProcessPackage.TEXT_ANNOTATION_ATTACHMENT__TARGET && newTarget != null)) {
            ...
            if (newTarget != null)
                msgs = ((InternalEObject) newTarget).eInverseAdd(this, ProcessPackage.ELEMENT__TEXT_ANNOTATION_ATTACHMENT,
                        Element.class, msgs);
            msgs = basicSetTarget(newTarget, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.TEXT_ANNOTATION_ATTACHMENT__TARGET,
                    newTarget, newTarget));
    }
    ...
    public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
        switch (eContainerFeatureID()) {
            case ProcessPackage.TEXT_ANNOTATION_ATTACHMENT__TARGET:
                return eInternalContainer().eInverseRemove(this, ProcessPackage.ELEMENT__TEXT_ANNOTATION_ATTACHMENT,
                        Element.class, msgs);
        }
