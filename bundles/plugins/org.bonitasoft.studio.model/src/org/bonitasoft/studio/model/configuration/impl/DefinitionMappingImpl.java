 ...
 * <li>{@link org.bonitasoft.studio.model.configuration.impl.DefinitionMappingImpl#getDefinitionId <em>Definition
 * Id</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.configuration.impl.DefinitionMappingImpl#getDefinitionVersion <em>Definition
 * Version</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.configuration.impl.DefinitionMappingImpl#getImplementationId <em>Implementation
 * Id</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.configuration.impl.DefinitionMappingImpl#getImplementationVersion
 * <em>Implementation Version</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DefinitionMappingImpl extends EObjectImpl implements DefinitionMapping {
    ...
    public void setType(String newType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConfigurationPackage.DEFINITION_MAPPING__TYPE, oldType,
                    type));
    }
    ...
    public void setDefinitionId(String newDefinitionId) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConfigurationPackage.DEFINITION_MAPPING__DEFINITION_ID,
                    oldDefinitionId, definitionId));
    }
    ...
    public void setDefinitionVersion(String newDefinitionVersion) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ConfigurationPackage.DEFINITION_MAPPING__DEFINITION_VERSION, oldDefinitionVersion, definitionVersion));
    }
    ...
    public void setImplementationId(String newImplementationId) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConfigurationPackage.DEFINITION_MAPPING__IMPLEMENTATION_ID,
    ...
    public void setImplementationVersion(String newImplementationVersion) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ConfigurationPackage.DEFINITION_MAPPING__IMPLEMENTATION_VERSION, oldImplementationVersion,
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            ...
            case ConfigurationPackage.DEFINITION_MAPPING__IMPLEMENTATION_VERSION:
                return IMPLEMENTATION_VERSION_EDEFAULT == null ? implementationVersion != null
                        : !IMPLEMENTATION_VERSION_EDEFAULT.equals(implementationVersion);
        }
