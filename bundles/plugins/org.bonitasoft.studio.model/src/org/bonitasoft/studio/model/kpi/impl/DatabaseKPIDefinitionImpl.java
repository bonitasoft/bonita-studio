 ...
 * </p>
 * <ul>
 * <li>{@link org.bonitasoft.studio.model.kpi.impl.DatabaseKPIDefinitionImpl#getDefaultDriverclassName <em>Default
 * Driverclass Name</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.kpi.impl.DatabaseKPIDefinitionImpl#getDefaultJdbcUrl <em>Default Jdbc
 * Url</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.kpi.impl.DatabaseKPIDefinitionImpl#getDefaultUser <em>Default User</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.kpi.impl.DatabaseKPIDefinitionImpl#getDefaultPassword <em>Default
 * Password</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.kpi.impl.DatabaseKPIDefinitionImpl#getDefaultJNDIUrl <em>Default JNDI
 * Url</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.kpi.impl.DatabaseKPIDefinitionImpl#getDefaultDBName <em>Default DB Name</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.kpi.impl.DatabaseKPIDefinitionImpl#getDefaultTableName <em>Default Table
 * Name</em>}</li>
 * </ul>
 *
 * @generated
...
public class DatabaseKPIDefinitionImpl extends AbstractKPIDefinitionImpl implements DatabaseKPIDefinition {
    ...
    /**
     * The cached value of the '{@link #getDefaultDriverclassName() <em>Default Driverclass Name</em>}' containment
     * reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    public NotificationChain basicSetDefaultDriverclassName(Expression newDefaultDriverclassName, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    KpiPackage.DATABASE_KPI_DEFINITION__DEFAULT_DRIVERCLASS_NAME, oldDefaultDriverclassName,
                    newDefaultDriverclassName);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setDefaultDriverclassName(Expression newDefaultDriverclassName) {
        if (newDefaultDriverclassName != defaultDriverclassName) {
            ...
            if (defaultDriverclassName != null)
                msgs = ((InternalEObject) defaultDriverclassName).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - KpiPackage.DATABASE_KPI_DEFINITION__DEFAULT_DRIVERCLASS_NAME, null, msgs);
            if (newDefaultDriverclassName != null)
                msgs = ((InternalEObject) newDefaultDriverclassName).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - KpiPackage.DATABASE_KPI_DEFINITION__DEFAULT_DRIVERCLASS_NAME, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    KpiPackage.DATABASE_KPI_DEFINITION__DEFAULT_DRIVERCLASS_NAME, newDefaultDriverclassName,
                    newDefaultDriverclassName));
    }
    ...
    public NotificationChain basicSetDefaultJdbcUrl(Expression newDefaultJdbcUrl, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    KpiPackage.DATABASE_KPI_DEFINITION__DEFAULT_JDBC_URL, oldDefaultJdbcUrl, newDefaultJdbcUrl);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setDefaultJdbcUrl(Expression newDefaultJdbcUrl) {
        if (newDefaultJdbcUrl != defaultJdbcUrl) {
            ...
            if (defaultJdbcUrl != null)
                msgs = ((InternalEObject) defaultJdbcUrl).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - KpiPackage.DATABASE_KPI_DEFINITION__DEFAULT_JDBC_URL, null, msgs);
            if (newDefaultJdbcUrl != null)
                msgs = ((InternalEObject) newDefaultJdbcUrl).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - KpiPackage.DATABASE_KPI_DEFINITION__DEFAULT_JDBC_URL, null, msgs);
            msgs = basicSetDefaultJdbcUrl(newDefaultJdbcUrl, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, KpiPackage.DATABASE_KPI_DEFINITION__DEFAULT_JDBC_URL,
                    newDefaultJdbcUrl, newDefaultJdbcUrl));
    }
    ...
    public NotificationChain basicSetDefaultUser(Expression newDefaultUser, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    KpiPackage.DATABASE_KPI_DEFINITION__DEFAULT_USER, oldDefaultUser, newDefaultUser);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setDefaultUser(Expression newDefaultUser) {
        if (newDefaultUser != defaultUser) {
            NotificationChain msgs = null;
            if (defaultUser != null)
                msgs = ((InternalEObject) defaultUser).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - KpiPackage.DATABASE_KPI_DEFINITION__DEFAULT_USER, null, msgs);
            if (newDefaultUser != null)
                msgs = ((InternalEObject) newDefaultUser).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - KpiPackage.DATABASE_KPI_DEFINITION__DEFAULT_USER, null, msgs);
            msgs = basicSetDefaultUser(newDefaultUser, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, KpiPackage.DATABASE_KPI_DEFINITION__DEFAULT_USER,
                    newDefaultUser, newDefaultUser));
    }
    ...
    public NotificationChain basicSetDefaultPassword(Expression newDefaultPassword, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    KpiPackage.DATABASE_KPI_DEFINITION__DEFAULT_PASSWORD, oldDefaultPassword, newDefaultPassword);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setDefaultPassword(Expression newDefaultPassword) {
        if (newDefaultPassword != defaultPassword) {
            ...
            if (defaultPassword != null)
                msgs = ((InternalEObject) defaultPassword).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - KpiPackage.DATABASE_KPI_DEFINITION__DEFAULT_PASSWORD, null, msgs);
            if (newDefaultPassword != null)
                msgs = ((InternalEObject) newDefaultPassword).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - KpiPackage.DATABASE_KPI_DEFINITION__DEFAULT_PASSWORD, null, msgs);
            msgs = basicSetDefaultPassword(newDefaultPassword, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, KpiPackage.DATABASE_KPI_DEFINITION__DEFAULT_PASSWORD,
    ...
    public NotificationChain basicSetDefaultJNDIUrl(Expression newDefaultJNDIUrl, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    KpiPackage.DATABASE_KPI_DEFINITION__DEFAULT_JNDI_URL, oldDefaultJNDIUrl, newDefaultJNDIUrl);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setDefaultJNDIUrl(Expression newDefaultJNDIUrl) {
        if (newDefaultJNDIUrl != defaultJNDIUrl) {
            ...
            if (defaultJNDIUrl != null)
                msgs = ((InternalEObject) defaultJNDIUrl).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - KpiPackage.DATABASE_KPI_DEFINITION__DEFAULT_JNDI_URL, null, msgs);
            if (newDefaultJNDIUrl != null)
                msgs = ((InternalEObject) newDefaultJNDIUrl).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - KpiPackage.DATABASE_KPI_DEFINITION__DEFAULT_JNDI_URL, null, msgs);
            msgs = basicSetDefaultJNDIUrl(newDefaultJNDIUrl, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, KpiPackage.DATABASE_KPI_DEFINITION__DEFAULT_JNDI_URL,
                    newDefaultJNDIUrl, newDefaultJNDIUrl));
    }
    ...
    public NotificationChain basicSetDefaultDBName(Expression newDefaultDBName, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    KpiPackage.DATABASE_KPI_DEFINITION__DEFAULT_DB_NAME, oldDefaultDBName, newDefaultDBName);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setDefaultDBName(Expression newDefaultDBName) {
        if (newDefaultDBName != defaultDBName) {
            ...
            if (defaultDBName != null)
                msgs = ((InternalEObject) defaultDBName).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - KpiPackage.DATABASE_KPI_DEFINITION__DEFAULT_DB_NAME, null, msgs);
            if (newDefaultDBName != null)
                msgs = ((InternalEObject) newDefaultDBName).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - KpiPackage.DATABASE_KPI_DEFINITION__DEFAULT_DB_NAME, null, msgs);
            msgs = basicSetDefaultDBName(newDefaultDBName, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, KpiPackage.DATABASE_KPI_DEFINITION__DEFAULT_DB_NAME,
                    newDefaultDBName, newDefaultDBName));
    }
    ...
    public void setDefaultTableName(String newDefaultTableName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, KpiPackage.DATABASE_KPI_DEFINITION__DEFAULT_TABLE_NAME,
                    oldDefaultTableName, defaultTableName));
    }
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            ...
            case KpiPackage.DATABASE_KPI_DEFINITION__DEFAULT_TABLE_NAME:
                return DEFAULT_TABLE_NAME_EDEFAULT == null ? defaultTableName != null
                        : !DEFAULT_TABLE_NAME_EDEFAULT.equals(defaultTableName);
        }
