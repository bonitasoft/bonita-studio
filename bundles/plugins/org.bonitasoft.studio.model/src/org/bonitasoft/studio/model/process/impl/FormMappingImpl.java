...
public class FormMappingImpl extends EObjectImpl implements FormMapping {
    ...
    public NotificationChain basicSetTargetForm(Expression newTargetForm, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.FORM_MAPPING__TARGET_FORM, oldTargetForm, newTargetForm);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setTargetForm(Expression newTargetForm) {
        if (newTargetForm != targetForm) {
            ...
            if (targetForm != null)
                msgs = ((InternalEObject) targetForm).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.FORM_MAPPING__TARGET_FORM, null, msgs);
            if (newTargetForm != null)
                msgs = ((InternalEObject) newTargetForm).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.FORM_MAPPING__TARGET_FORM, null, msgs);
            msgs = basicSetTargetForm(newTargetForm, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.FORM_MAPPING__TARGET_FORM, newTargetForm,
                    newTargetForm));
    }
