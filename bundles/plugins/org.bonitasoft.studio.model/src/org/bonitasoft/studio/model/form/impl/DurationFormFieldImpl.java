...
public class DurationFormFieldImpl extends SingleValuatedFormFieldImpl implements DurationFormField {
    ...
    public void setItemClass(String newItemClass) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DURATION_FORM_FIELD__ITEM_CLASS, oldItemClass,
                    itemClass));
    }
        ...
        if (baseClass == ItemContainer.class) {
            switch (baseFeatureID) {
                case FormPackage.ITEM_CONTAINER__ITEM_CLASS:
                    return FormPackage.DURATION_FORM_FIELD__ITEM_CLASS;
                default:
                    return -1;
            }
        }
