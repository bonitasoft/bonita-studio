...
public class SuggestBoxImpl extends MultipleValuatedFormFieldImpl implements SuggestBox {
    ...
    public void setMaxItems(int newMaxItems) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.SUGGEST_BOX__MAX_ITEMS, oldMaxItems,
                    maxItems));
    }
    ...
    public void setUseMaxItems(boolean newUseMaxItems) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.SUGGEST_BOX__USE_MAX_ITEMS, oldUseMaxItems,
                    useMaxItems));
    }
    ...
    public void setAsynchronous(boolean newAsynchronous) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.SUGGEST_BOX__ASYNCHRONOUS, oldAsynchronous,
                    asynchronous));
    }
