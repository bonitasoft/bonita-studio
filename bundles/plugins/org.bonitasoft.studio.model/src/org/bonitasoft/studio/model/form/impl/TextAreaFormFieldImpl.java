...
public class TextAreaFormFieldImpl extends SingleValuatedFormFieldImpl implements TextAreaFormField {
    ...
    public void setMaxLength(int newMaxLength) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXT_AREA_FORM_FIELD__MAX_LENGTH, oldMaxLength,
                    maxLength));
    }
    ...
    public void setMaxHeigth(int newMaxHeigth) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXT_AREA_FORM_FIELD__MAX_HEIGTH, oldMaxHeigth,
                    maxHeigth));
    }
