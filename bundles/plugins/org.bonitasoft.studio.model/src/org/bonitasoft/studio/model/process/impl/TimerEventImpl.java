 ...
 * </p>
 * <ul>
 * <li>{@link org.bonitasoft.studio.model.process.impl.TimerEventImpl#getCondition <em>Condition</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.process.impl.TimerEventImpl#getData <em>Data</em>}</li>
 * </ul>
 *
 * @generated
 */
    ...
    public NotificationChain basicSetCondition(Expression newCondition, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.TIMER_EVENT__CONDITION, oldCondition, newCondition);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newCondition != condition) {
            ...
            if (condition != null)
                msgs = ((InternalEObject) condition).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.TIMER_EVENT__CONDITION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.TIMER_EVENT__CONDITION, newCondition,
                    newCondition));
    }
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        if (baseClass == AbstractTimerEvent.class) {
            switch (derivedFeatureID) {
                case ProcessPackage.TIMER_EVENT__CONDITION:
                    return ProcessPackage.ABSTRACT_TIMER_EVENT__CONDITION;
                default:
                    return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == AbstractTimerEvent.class) {
            switch (baseFeatureID) {
                case ProcessPackage.ABSTRACT_TIMER_EVENT__CONDITION:
                    return ProcessPackage.TIMER_EVENT__CONDITION;
                default:
                    return -1;
            }
        }
        if (baseClass == DataAware.class) {
            switch (baseFeatureID) {
                case ProcessPackage.DATA_AWARE__DATA:
                    return ProcessPackage.TIMER_EVENT__DATA;
                default:
                    return -1;
            }
        }
