...
public class WidgetLayoutInfoImpl extends EObjectImpl implements WidgetLayoutInfo {
    ...
    public void setColumn(int newColumn) {
        ...
        column = newColumn;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.WIDGET_LAYOUT_INFO__COLUMN, oldColumn,
                    column));
    }
    ...
    public void setVerticalSpan(int newVerticalSpan) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.WIDGET_LAYOUT_INFO__VERTICAL_SPAN,
                    oldVerticalSpan, verticalSpan));
    }
    ...
    public void setHorizontalSpan(int newHorizontalSpan) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.WIDGET_LAYOUT_INFO__HORIZONTAL_SPAN,
