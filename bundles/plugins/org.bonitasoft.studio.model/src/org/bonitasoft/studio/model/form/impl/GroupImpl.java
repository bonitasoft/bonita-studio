 ...
 * <li>{@link org.bonitasoft.studio.model.form.impl.GroupImpl#getTextAnnotationAttachment <em>Text Annotation
 * Attachment</em>}</li>
 ...
 * <li>{@link org.bonitasoft.studio.model.form.impl.GroupImpl#isAllowHTMLForDisplayLabel <em>Allow HTML For Display
 * Label</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.GroupImpl#getDependOn <em>Depend On</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.GroupImpl#isDisplayDependentWidgetOnlyOnEventTriggered <em>Display
 ...
 * <li>{@link org.bonitasoft.studio.model.form.impl.GroupImpl#getDisplayDependentWidgetOnlyAfterFirstEventTriggeredAndCondition
 * <em>Display Dependent Widget Only After First Event Triggered And Condition</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.GroupImpl#getDisplayAfterEventDependsOnConditionScript <em>Display After
 * Event Depends On Condition Script</em>}</li>
 ...
 * <li>{@link org.bonitasoft.studio.model.form.impl.GroupImpl#isLimitNumberOfDuplication <em>Limit Number Of
 * Duplication</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.GroupImpl#isLimitMinNumberOfDuplication <em>Limit Min Number Of
 * Duplication</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.GroupImpl#getMaxNumberOfDuplication <em>Max Number Of
 * Duplication</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.GroupImpl#getMinNumberOfDuplication <em>Min Number Of
 * Duplication</em>}</li>
 ...
 * <li>{@link org.bonitasoft.studio.model.form.impl.GroupImpl#getDisplayLabelForRemove <em>Display Label For
 * Remove</em>}</li>
...
public class GroupImpl extends EObjectImpl implements Group {
    ...
    public void setDocumentation(String newDocumentation) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.GROUP__DOCUMENTATION, oldDocumentation,
                    documentation));
    }
    ...
    public EList<TextAnnotationAttachment> getTextAnnotationAttachment() {
        if (textAnnotationAttachment == null) {
            textAnnotationAttachment = new EObjectContainmentWithInverseEList<TextAnnotationAttachment>(
                    TextAnnotationAttachment.class, this, FormPackage.GROUP__TEXT_ANNOTATION_ATTACHMENT,
    ...
    public EMap<String, String> getHtmlAttributes() {
        if (htmlAttributes == null) {
            htmlAttributes = new EcoreEMap<String, String>(EcorePackage.Literals.ESTRING_TO_STRING_MAP_ENTRY,
                    EStringToStringMapEntryImpl.class, this, FormPackage.GROUP__HTML_ATTRIBUTES);
        }
    ...
    public NotificationChain basicSetWidgetLayoutInfo(WidgetLayoutInfo newWidgetLayoutInfo, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.GROUP__WIDGET_LAYOUT_INFO, oldWidgetLayoutInfo, newWidgetLayoutInfo);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newWidgetLayoutInfo != widgetLayoutInfo) {
            ...
            if (widgetLayoutInfo != null)
                msgs = ((InternalEObject) widgetLayoutInfo).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.GROUP__WIDGET_LAYOUT_INFO, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.GROUP__WIDGET_LAYOUT_INFO, newWidgetLayoutInfo,
                    newWidgetLayoutInfo));
    }
    ...
    public void setShowDisplayLabel(Boolean newShowDisplayLabel) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.GROUP__SHOW_DISPLAY_LABEL, oldShowDisplayLabel,
                    showDisplayLabel));
    }
    ...
    public void setAllowHTMLForDisplayLabel(boolean newAllowHTMLForDisplayLabel) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.GROUP__ALLOW_HTML_FOR_DISPLAY_LABEL,
    ...
    public void setDisplayDependentWidgetOnlyOnEventTriggered(boolean newDisplayDependentWidgetOnlyOnEventTriggered) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    FormPackage.GROUP__DISPLAY_DEPENDENT_WIDGET_ONLY_ON_EVENT_TRIGGERED,
    ...
    public void setLabelPosition(LabelPosition newLabelPosition) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.GROUP__LABEL_POSITION, oldLabelPosition,
                    labelPosition));
    }
    ...
    public void setRealHtmlAttributes(String newRealHtmlAttributes) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.GROUP__REAL_HTML_ATTRIBUTES,
    ...
    public void setInjectWidgetCondition(boolean newInjectWidgetCondition) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.GROUP__INJECT_WIDGET_CONDITION,
    ...
    public void setReturnTypeModifier(String newReturnTypeModifier) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.GROUP__RETURN_TYPE_MODIFIER,
    ...
    public NotificationChain basicSetDisplayDependentWidgetOnlyAfterFirstEventTriggeredAndCondition(
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.GROUP__DISPLAY_DEPENDENT_WIDGET_ONLY_AFTER_FIRST_EVENT_TRIGGERED_AND_CONDITION,
    ...
    public NotificationChain basicSetDisplayAfterEventDependsOnConditionScript(
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.GROUP__DISPLAY_AFTER_EVENT_DEPENDS_ON_CONDITION_SCRIPT,
        ...
        if (newDisplayAfterEventDependsOnConditionScript != displayAfterEventDependsOnConditionScript) {
            ...
            if (displayAfterEventDependsOnConditionScript != null)
                msgs = ((InternalEObject) displayAfterEventDependsOnConditionScript).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.GROUP__DISPLAY_AFTER_EVENT_DEPENDS_ON_CONDITION_SCRIPT, null,
                        msgs);
    ...
    public NotificationChain basicSetInputExpression(Expression newInputExpression, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.GROUP__INPUT_EXPRESSION, oldInputExpression, newInputExpression);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newInputExpression != inputExpression) {
            ...
            if (inputExpression != null)
                msgs = ((InternalEObject) inputExpression).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.GROUP__INPUT_EXPRESSION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.GROUP__INPUT_EXPRESSION, newInputExpression,
                    newInputExpression));
    }
    ...
    public NotificationChain basicSetAfterEventExpression(Expression newAfterEventExpression, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.GROUP__AFTER_EVENT_EXPRESSION, oldAfterEventExpression, newAfterEventExpression);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newAfterEventExpression != afterEventExpression) {
            ...
            if (afterEventExpression != null)
                msgs = ((InternalEObject) afterEventExpression).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.GROUP__AFTER_EVENT_EXPRESSION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.GROUP__AFTER_EVENT_EXPRESSION,
    ...
    public NotificationChain basicSetTooltip(Expression newTooltip, NotificationChain msgs) {
        ...
        tooltip = newTooltip;
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FormPackage.GROUP__TOOLTIP,
    ...
    public void setTooltip(Expression newTooltip) {
        if (newTooltip != tooltip) {
            NotificationChain msgs = null;
            if (tooltip != null)
                msgs = ((InternalEObject) tooltip).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FormPackage.GROUP__TOOLTIP,
                        null, msgs);
            if (newTooltip != null)
                msgs = ((InternalEObject) newTooltip).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FormPackage.GROUP__TOOLTIP,
                        null, msgs);
    ...
    public NotificationChain basicSetHelpMessage(Expression newHelpMessage, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FormPackage.GROUP__HELP_MESSAGE,
                    oldHelpMessage, newHelpMessage);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newHelpMessage != helpMessage) {
            ...
            if (helpMessage != null)
                msgs = ((InternalEObject) helpMessage).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.GROUP__HELP_MESSAGE, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.GROUP__HELP_MESSAGE, newHelpMessage,
                    newHelpMessage));
    }
    ...
    public NotificationChain basicSetDisplayLabel(Expression newDisplayLabel, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FormPackage.GROUP__DISPLAY_LABEL,
                    oldDisplayLabel, newDisplayLabel);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newDisplayLabel != displayLabel) {
            ...
            if (displayLabel != null)
                msgs = ((InternalEObject) displayLabel).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.GROUP__DISPLAY_LABEL, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.GROUP__DISPLAY_LABEL, newDisplayLabel,
                    newDisplayLabel));
    }
    ...
    public NotificationChain basicSetInjectWidgetScript(Expression newInjectWidgetScript, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.GROUP__INJECT_WIDGET_SCRIPT, oldInjectWidgetScript, newInjectWidgetScript);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newInjectWidgetScript != injectWidgetScript) {
            ...
            if (injectWidgetScript != null)
                msgs = ((InternalEObject) injectWidgetScript).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.GROUP__INJECT_WIDGET_SCRIPT, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.GROUP__INJECT_WIDGET_SCRIPT,
    ...
    public NotificationChain basicSetAction(Operation newAction, NotificationChain msgs) {
        ...
        action = newAction;
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FormPackage.GROUP__ACTION,
                    oldAction, newAction);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setAction(Operation newAction) {
        if (newAction != action) {
            NotificationChain msgs = null;
            if (action != null)
                msgs = ((InternalEObject) action).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FormPackage.GROUP__ACTION,
                        null, msgs);
            if (newAction != null)
                msgs = ((InternalEObject) newAction).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FormPackage.GROUP__ACTION,
                        null, msgs);
    ...
    public void setLimitNumberOfDuplication(boolean newLimitNumberOfDuplication) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.GROUP__LIMIT_NUMBER_OF_DUPLICATION,
    ...
    public void setLimitMinNumberOfDuplication(boolean newLimitMinNumberOfDuplication) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.GROUP__LIMIT_MIN_NUMBER_OF_DUPLICATION,
    ...
    public NotificationChain basicSetMaxNumberOfDuplication(Expression newMaxNumberOfDuplication, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.GROUP__MAX_NUMBER_OF_DUPLICATION, oldMaxNumberOfDuplication, newMaxNumberOfDuplication);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newMaxNumberOfDuplication != maxNumberOfDuplication) {
            ...
            if (maxNumberOfDuplication != null)
                msgs = ((InternalEObject) maxNumberOfDuplication).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.GROUP__MAX_NUMBER_OF_DUPLICATION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.GROUP__MAX_NUMBER_OF_DUPLICATION,
    ...
    public NotificationChain basicSetMinNumberOfDuplication(Expression newMinNumberOfDuplication, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.GROUP__MIN_NUMBER_OF_DUPLICATION, oldMinNumberOfDuplication, newMinNumberOfDuplication);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newMinNumberOfDuplication != minNumberOfDuplication) {
            ...
            if (minNumberOfDuplication != null)
                msgs = ((InternalEObject) minNumberOfDuplication).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.GROUP__MIN_NUMBER_OF_DUPLICATION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.GROUP__MIN_NUMBER_OF_DUPLICATION,
    ...
    public NotificationChain basicSetDisplayLabelForAdd(Expression newDisplayLabelForAdd, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.GROUP__DISPLAY_LABEL_FOR_ADD, oldDisplayLabelForAdd, newDisplayLabelForAdd);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newDisplayLabelForAdd != displayLabelForAdd) {
            ...
            if (displayLabelForAdd != null)
                msgs = ((InternalEObject) displayLabelForAdd).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.GROUP__DISPLAY_LABEL_FOR_ADD, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.GROUP__DISPLAY_LABEL_FOR_ADD,
    ...
    public NotificationChain basicSetTooltipForAdd(Expression newTooltipForAdd, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.GROUP__TOOLTIP_FOR_ADD, oldTooltipForAdd, newTooltipForAdd);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newTooltipForAdd != tooltipForAdd) {
            ...
            if (tooltipForAdd != null)
                msgs = ((InternalEObject) tooltipForAdd).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.GROUP__TOOLTIP_FOR_ADD, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.GROUP__TOOLTIP_FOR_ADD, newTooltipForAdd,
                    newTooltipForAdd));
    }
    ...
    public NotificationChain basicSetDisplayLabelForRemove(Expression newDisplayLabelForRemove, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.GROUP__DISPLAY_LABEL_FOR_REMOVE, oldDisplayLabelForRemove, newDisplayLabelForRemove);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newDisplayLabelForRemove != displayLabelForRemove) {
            ...
            if (displayLabelForRemove != null)
                msgs = ((InternalEObject) displayLabelForRemove).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.GROUP__DISPLAY_LABEL_FOR_REMOVE, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.GROUP__DISPLAY_LABEL_FOR_REMOVE,
    ...
    public NotificationChain basicSetTooltipForRemove(Expression newTooltipForRemove, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.GROUP__TOOLTIP_FOR_REMOVE, oldTooltipForRemove, newTooltipForRemove);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newTooltipForRemove != tooltipForRemove) {
            ...
            if (tooltipForRemove != null)
                msgs = ((InternalEObject) tooltipForRemove).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.GROUP__TOOLTIP_FOR_REMOVE, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.GROUP__TOOLTIP_FOR_REMOVE, newTooltipForRemove,
                    newTooltipForRemove));
    }
    ...
    public void setShowBorder(boolean newShowBorder) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.GROUP__SHOW_BORDER, oldShowBorder,
                    showBorder));
    }
    ...
    public void setUseIterator(boolean newUseIterator) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.GROUP__USE_ITERATOR, oldUseIterator,
                    useIterator));
    }
    ...
    public NotificationChain basicSetIterator(GroupIterator newIterator, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FormPackage.GROUP__ITERATOR,
        ...
        if (newIterator != iterator) {
            ...
            if (iterator != null)
                msgs = ((InternalEObject) iterator).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.GROUP__ITERATOR, null, msgs);
            if (newIterator != null)
        ...
        if (baseClass == CSSCustomizable.class) {
            switch (baseFeatureID) {
                case FormPackage.CSS_CUSTOMIZABLE__HTML_ATTRIBUTES:
                    return FormPackage.GROUP__HTML_ATTRIBUTES;
                default:
                    return -1;
            }
        }
        if (baseClass == Duplicable.class) {
            switch (baseFeatureID) {
                case FormPackage.DUPLICABLE__DUPLICATE:
                    return FormPackage.GROUP__DUPLICATE;
                case FormPackage.DUPLICABLE__LIMIT_NUMBER_OF_DUPLICATION:
                    return FormPackage.GROUP__LIMIT_NUMBER_OF_DUPLICATION;
                case FormPackage.DUPLICABLE__LIMIT_MIN_NUMBER_OF_DUPLICATION:
                    return FormPackage.GROUP__LIMIT_MIN_NUMBER_OF_DUPLICATION;
                case FormPackage.DUPLICABLE__MAX_NUMBER_OF_DUPLICATION:
                    return FormPackage.GROUP__MAX_NUMBER_OF_DUPLICATION;
                case FormPackage.DUPLICABLE__MIN_NUMBER_OF_DUPLICATION:
                    return FormPackage.GROUP__MIN_NUMBER_OF_DUPLICATION;
                case FormPackage.DUPLICABLE__DISPLAY_LABEL_FOR_ADD:
                    return FormPackage.GROUP__DISPLAY_LABEL_FOR_ADD;
                case FormPackage.DUPLICABLE__TOOLTIP_FOR_ADD:
                    return FormPackage.GROUP__TOOLTIP_FOR_ADD;
                case FormPackage.DUPLICABLE__DISPLAY_LABEL_FOR_REMOVE:
                    return FormPackage.GROUP__DISPLAY_LABEL_FOR_REMOVE;
                case FormPackage.DUPLICABLE__TOOLTIP_FOR_REMOVE:
                    return FormPackage.GROUP__TOOLTIP_FOR_REMOVE;
                default:
                    return -1;
            }
        }
