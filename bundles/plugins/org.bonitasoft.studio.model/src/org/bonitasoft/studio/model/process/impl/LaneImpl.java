 ...
 * </p>
 * <ul>
 * <li>{@link org.bonitasoft.studio.model.process.impl.LaneImpl#getActor <em>Actor</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.process.impl.LaneImpl#getFilters <em>Filters</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LaneImpl extends ContainerImpl implements Lane {
        ...
        if (actor != null && actor.eIsProxy()) {
            ...
            if (actor != oldActor) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, ProcessPackage.LANE__ACTOR, oldActor, actor));
            }
        }
        return actor;
    }
    ...
    public void setActor(Actor newActor) {
        ...
        actor = newActor;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.LANE__ACTOR, oldActor, actor));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case ProcessPackage.LANE__ACTOR:
                if (resolve)
                    return getActor();
        ...
        if (baseClass == Assignable.class) {
            switch (baseFeatureID) {
                case ProcessPackage.ASSIGNABLE__ACTOR:
                    return ProcessPackage.LANE__ACTOR;
                case ProcessPackage.ASSIGNABLE__FILTERS:
                    return ProcessPackage.LANE__FILTERS;
                default:
                    return -1;
            }
        }
