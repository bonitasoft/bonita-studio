 ...
 * <li>{@link org.bonitasoft.studio.model.process.impl.MessageImpl#getTextAnnotationAttachment <em>Text Annotation
 * Attachment</em>}</li>
 ...
 * <li>{@link org.bonitasoft.studio.model.process.impl.MessageImpl#getTargetProcessExpression <em>Target Process
 * Expression</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.process.impl.MessageImpl#getTargetElementExpression <em>Target Element
 * Expression</em>}</li>
...
public class MessageImpl extends EObjectImpl implements Message {
    ...
    /**
     * The cached value of the '{@link #getTargetProcessExpression() <em>Target Process Expression</em>}' containment
     * reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * The cached value of the '{@link #getTargetElementExpression() <em>Target Element Expression</em>}' containment
     * reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    public void setDocumentation(String newDocumentation) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.MESSAGE__DOCUMENTATION, oldDocumentation,
                    documentation));
    }
    ...
    public EList<TextAnnotationAttachment> getTextAnnotationAttachment() {
        if (textAnnotationAttachment == null) {
            textAnnotationAttachment = new EObjectContainmentWithInverseEList<TextAnnotationAttachment>(
                    TextAnnotationAttachment.class, this, ProcessPackage.MESSAGE__TEXT_ANNOTATION_ATTACHMENT,
    ...
    public void setThrowEvent(String newThrowEvent) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.MESSAGE__THROW_EVENT, oldThrowEvent,
                    throwEvent));
    }
    ...
    public NotificationChain basicSetCorrelation(Correlation newCorrelation, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.MESSAGE__CORRELATION, oldCorrelation, newCorrelation);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newCorrelation != correlation) {
            ...
            if (correlation != null)
                msgs = ((InternalEObject) correlation).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.MESSAGE__CORRELATION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.MESSAGE__CORRELATION, newCorrelation,
                    newCorrelation));
    }
    ...
    public ThrowMessageEvent getSource() {
        if (eContainerFeatureID() != ProcessPackage.MESSAGE__SOURCE)
            return null;
    ...
    public void setSource(ThrowMessageEvent newSource) {
        if (newSource != eInternalContainer()
                || (eContainerFeatureID() != ProcessPackage.MESSAGE__SOURCE && newSource != null)) {
            ...
            if (newSource != null)
                msgs = ((InternalEObject) newSource).eInverseAdd(this, ProcessPackage.THROW_MESSAGE_EVENT__EVENTS,
                        ThrowMessageEvent.class, msgs);
    ...
    public NotificationChain basicSetTargetProcessExpression(Expression newTargetProcessExpression, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.MESSAGE__TARGET_PROCESS_EXPRESSION, oldTargetProcessExpression,
                    newTargetProcessExpression);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setTargetProcessExpression(Expression newTargetProcessExpression) {
        if (newTargetProcessExpression != targetProcessExpression) {
            ...
            if (targetProcessExpression != null)
                msgs = ((InternalEObject) targetProcessExpression).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.MESSAGE__TARGET_PROCESS_EXPRESSION, null, msgs);
            if (newTargetProcessExpression != null)
                msgs = ((InternalEObject) newTargetProcessExpression).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.MESSAGE__TARGET_PROCESS_EXPRESSION, null, msgs);
            msgs = basicSetTargetProcessExpression(newTargetProcessExpression, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.MESSAGE__TARGET_PROCESS_EXPRESSION,
                    newTargetProcessExpression, newTargetProcessExpression));
    }
    ...
    public NotificationChain basicSetTargetElementExpression(Expression newTargetElementExpression, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.MESSAGE__TARGET_ELEMENT_EXPRESSION, oldTargetElementExpression,
                    newTargetElementExpression);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setTargetElementExpression(Expression newTargetElementExpression) {
        if (newTargetElementExpression != targetElementExpression) {
            ...
            if (targetElementExpression != null)
                msgs = ((InternalEObject) targetElementExpression).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.MESSAGE__TARGET_ELEMENT_EXPRESSION, null, msgs);
            if (newTargetElementExpression != null)
                msgs = ((InternalEObject) newTargetElementExpression).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.MESSAGE__TARGET_ELEMENT_EXPRESSION, null, msgs);
            msgs = basicSetTargetElementExpression(newTargetElementExpression, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.MESSAGE__TARGET_ELEMENT_EXPRESSION,
                    newTargetElementExpression, newTargetElementExpression));
    }
    ...
    public NotificationChain basicSetMessageContent(TableExpression newMessageContent, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.MESSAGE__MESSAGE_CONTENT, oldMessageContent, newMessageContent);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setMessageContent(TableExpression newMessageContent) {
        if (newMessageContent != messageContent) {
            ...
            if (messageContent != null)
                msgs = ((InternalEObject) messageContent).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.MESSAGE__MESSAGE_CONTENT, null, msgs);
            if (newMessageContent != null)
                msgs = ((InternalEObject) newMessageContent).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.MESSAGE__MESSAGE_CONTENT, null, msgs);
            msgs = basicSetMessageContent(newMessageContent, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.MESSAGE__MESSAGE_CONTENT, newMessageContent,
                    newMessageContent));
    }
    ...
    public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
        switch (eContainerFeatureID()) {
            case ProcessPackage.MESSAGE__SOURCE:
                return eInternalContainer().eInverseRemove(this, ProcessPackage.THROW_MESSAGE_EVENT__EVENTS,
                        ThrowMessageEvent.class, msgs);
        }
