 ...
 * </p>
 * <ul>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.IntermediateCatchSignalEventImpl#getDocumentation <em>Documentation</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.IntermediateCatchSignalEventImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.IntermediateCatchSignalEventImpl#getTextAnnotationAttachment <em>Text Annotation Attachment</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.IntermediateCatchSignalEventImpl#getSignalCode <em>Signal Code</em>}</li>
 ...
 *   <li>{@link org.bonitasoft.studio.model.process.impl.IntermediateCatchSignalEventImpl#getRegExpToHideDefaultField <em>Reg Exp To Hide Default Field</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.IntermediateCatchSignalEventImpl#isUseRegExpToHideDefaultField <em>Use Reg Exp To Hide Default Field</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.IntermediateCatchSignalEventImpl#getViewPageFlowTransitions <em>View Page Flow Transitions</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.IntermediateCatchSignalEventImpl#getViewTransientData <em>View Transient Data</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.IntermediateCatchSignalEventImpl#getViewPageFlowConnectors <em>View Page Flow Connectors</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.IntermediateCatchSignalEventImpl#getViewPageFlowType <em>View Page Flow Type</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.IntermediateCatchSignalEventImpl#getViewForm <em>View Form</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.IntermediateCatchSignalEventImpl#getViewPageFlowRedirectionURL <em>View Page Flow Redirection URL</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.IntermediateCatchSignalEventImpl#getSimulationData <em>Simulation Data</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.IntermediateCatchSignalEventImpl#getResourcesUsages <em>Resources Usages</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.IntermediateCatchSignalEventImpl#getExecutionTime <em>Execution Time</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.IntermediateCatchSignalEventImpl#getEstimatedTime <em>Estimated Time</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.IntermediateCatchSignalEventImpl#getMaximumTime <em>Maximum Time</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.IntermediateCatchSignalEventImpl#isContigous <em>Contigous</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.IntermediateCatchSignalEventImpl#isExclusiveOutgoingTransition <em>Exclusive Outgoing Transition</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.IntermediateCatchSignalEventImpl#getLoopTransition <em>Loop Transition</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.IntermediateCatchSignalEventImpl#getDataChange <em>Data Change</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.IntermediateCatchSignalEventImpl#getDynamicLabel <em>Dynamic Label</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.IntermediateCatchSignalEventImpl#getDynamicDescription <em>Dynamic Description</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.IntermediateCatchSignalEventImpl#getStepSummary <em>Step Summary</em>}</li>
...
public class IntermediateCatchSignalEventImpl extends EObjectImpl implements IntermediateCatchSignalEvent {
	...
	public void setDocumentation(String newDocumentation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__DOCUMENTATION, oldDocumentation, documentation));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__NAME, oldName, name));
	}
	...
	public void setSignalCode(String newSignalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__SIGNAL_CODE, oldSignalCode, signalCode));
	}
	...
	public void setRegExpToHideDefaultField(String newRegExpToHideDefaultField) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__REG_EXP_TO_HIDE_DEFAULT_FIELD, oldRegExpToHideDefaultField, regExpToHideDefaultField));
	}
	...
	public void setUseRegExpToHideDefaultField(boolean newUseRegExpToHideDefaultField) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__USE_REG_EXP_TO_HIDE_DEFAULT_FIELD, oldUseRegExpToHideDefaultField, useRegExpToHideDefaultField));
	}
	...
	public EList<PageFlowTransition> getViewPageFlowTransitions() {
		if (viewPageFlowTransitions == null) {
			viewPageFlowTransitions = new EObjectContainmentEList<PageFlowTransition>(PageFlowTransition.class, this, ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__VIEW_PAGE_FLOW_TRANSITIONS);
		}
	...
	public EList<Data> getViewTransientData() {
		if (viewTransientData == null) {
			viewTransientData = new EObjectContainmentEList<Data>(Data.class, this, ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__VIEW_TRANSIENT_DATA);
		}
	...
	public EList<Connector> getViewPageFlowConnectors() {
		if (viewPageFlowConnectors == null) {
			viewPageFlowConnectors = new EObjectContainmentEList<Connector>(Connector.class, this, ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__VIEW_PAGE_FLOW_CONNECTORS);
		}
	...
	public void setViewPageFlowType(ConsultationPageFlowType newViewPageFlowType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__VIEW_PAGE_FLOW_TYPE, oldViewPageFlowType, viewPageFlowType));
	}
	...
	public EList<ViewForm> getViewForm() {
		if (viewForm == null) {
			viewForm = new EObjectContainmentEList<ViewForm>(ViewForm.class, this, ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__VIEW_FORM);
		}
		return viewForm;
	}
	...
	public NotificationChain basicSetViewPageFlowRedirectionURL(Expression newViewPageFlowRedirectionURL, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__VIEW_PAGE_FLOW_REDIRECTION_URL, oldViewPageFlowRedirectionURL, newViewPageFlowRedirectionURL);
	...
	public void setViewPageFlowRedirectionURL(Expression newViewPageFlowRedirectionURL) {
		if (newViewPageFlowRedirectionURL != viewPageFlowRedirectionURL) {
			...
			if (viewPageFlowRedirectionURL != null)
				msgs = ((InternalEObject)viewPageFlowRedirectionURL).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__VIEW_PAGE_FLOW_REDIRECTION_URL, null, msgs);
			if (newViewPageFlowRedirectionURL != null)
				msgs = ((InternalEObject)newViewPageFlowRedirectionURL).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__VIEW_PAGE_FLOW_REDIRECTION_URL, null, msgs);
			msgs = basicSetViewPageFlowRedirectionURL(newViewPageFlowRedirectionURL, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__VIEW_PAGE_FLOW_REDIRECTION_URL, newViewPageFlowRedirectionURL, newViewPageFlowRedirectionURL));
	}
	...
	public EList<SimulationData> getSimulationData() {
		if (simulationData == null) {
			simulationData = new EObjectContainmentEList<SimulationData>(SimulationData.class, this, ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__SIMULATION_DATA);
		}
	...
	public EList<ResourceUsage> getResourcesUsages() {
		if (resourcesUsages == null) {
			resourcesUsages = new EObjectContainmentEList<ResourceUsage>(ResourceUsage.class, this, ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__RESOURCES_USAGES);
		}
	...
	public void setExecutionTime(long newExecutionTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__EXECUTION_TIME, oldExecutionTime, executionTime));
	}
	...
	public void setEstimatedTime(double newEstimatedTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__ESTIMATED_TIME, oldEstimatedTime, estimatedTime));
	}
	...
	public void setMaximumTime(double newMaximumTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__MAXIMUM_TIME, oldMaximumTime, maximumTime));
	}
	...
	public void setContigous(boolean newContigous) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__CONTIGOUS, oldContigous, contigous));
	}
	...
	public void setExclusiveOutgoingTransition(boolean newExclusiveOutgoingTransition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__EXCLUSIVE_OUTGOING_TRANSITION, oldExclusiveOutgoingTransition, exclusiveOutgoingTransition));
	}
	...
	public NotificationChain basicSetLoopTransition(SimulationTransition newLoopTransition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__LOOP_TRANSITION, oldLoopTransition, newLoopTransition);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLoopTransition(SimulationTransition newLoopTransition) {
		if (newLoopTransition != loopTransition) {
			...
			if (loopTransition != null)
				msgs = ((InternalEObject)loopTransition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__LOOP_TRANSITION, null, msgs);
			if (newLoopTransition != null)
				msgs = ((InternalEObject)newLoopTransition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__LOOP_TRANSITION, null, msgs);
			msgs = basicSetLoopTransition(newLoopTransition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__LOOP_TRANSITION, newLoopTransition, newLoopTransition));
	}
	...
	public EList<DataChange> getDataChange() {
		if (dataChange == null) {
			dataChange = new EObjectContainmentEList<DataChange>(DataChange.class, this, ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__DATA_CHANGE);
		}
		return dataChange;
	}
	...
	public NotificationChain basicSetDynamicLabel(Expression newDynamicLabel, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__DYNAMIC_LABEL, oldDynamicLabel, newDynamicLabel);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDynamicLabel(Expression newDynamicLabel) {
		if (newDynamicLabel != dynamicLabel) {
			...
			if (dynamicLabel != null)
				msgs = ((InternalEObject)dynamicLabel).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__DYNAMIC_LABEL, null, msgs);
			if (newDynamicLabel != null)
				msgs = ((InternalEObject)newDynamicLabel).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__DYNAMIC_LABEL, null, msgs);
			msgs = basicSetDynamicLabel(newDynamicLabel, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__DYNAMIC_LABEL, newDynamicLabel, newDynamicLabel));
	}
	...
	public NotificationChain basicSetDynamicDescription(Expression newDynamicDescription, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__DYNAMIC_DESCRIPTION, oldDynamicDescription, newDynamicDescription);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDynamicDescription(Expression newDynamicDescription) {
		if (newDynamicDescription != dynamicDescription) {
			...
			if (dynamicDescription != null)
				msgs = ((InternalEObject)dynamicDescription).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__DYNAMIC_DESCRIPTION, null, msgs);
			if (newDynamicDescription != null)
				msgs = ((InternalEObject)newDynamicDescription).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__DYNAMIC_DESCRIPTION, null, msgs);
			msgs = basicSetDynamicDescription(newDynamicDescription, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__DYNAMIC_DESCRIPTION, newDynamicDescription, newDynamicDescription));
	}
	...
	public NotificationChain basicSetStepSummary(Expression newStepSummary, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__STEP_SUMMARY, oldStepSummary, newStepSummary);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setStepSummary(Expression newStepSummary) {
		if (newStepSummary != stepSummary) {
			NotificationChain msgs = null;
			if (stepSummary != null)
				msgs = ((InternalEObject)stepSummary).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__STEP_SUMMARY, null, msgs);
			if (newStepSummary != null)
				msgs = ((InternalEObject)newStepSummary).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__STEP_SUMMARY, null, msgs);
			msgs = basicSetStepSummary(newStepSummary, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__STEP_SUMMARY, newStepSummary, newStepSummary));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == SourceElement.class) {
			switch (derivedFeatureID) {
				case ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__OUTGOING: return ProcessPackage.SOURCE_ELEMENT__OUTGOING;
				default: return -1;
			}
		}
		if (baseClass == TargetElement.class) {
			switch (derivedFeatureID) {
				case ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__INCOMING: return ProcessPackage.TARGET_ELEMENT__INCOMING;
				default: return -1;
			}
		}
		if (baseClass == AbstractPageFlow.class) {
			switch (derivedFeatureID) {
				case ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__REG_EXP_TO_HIDE_DEFAULT_FIELD: return ProcessPackage.ABSTRACT_PAGE_FLOW__REG_EXP_TO_HIDE_DEFAULT_FIELD;
				case ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__USE_REG_EXP_TO_HIDE_DEFAULT_FIELD: return ProcessPackage.ABSTRACT_PAGE_FLOW__USE_REG_EXP_TO_HIDE_DEFAULT_FIELD;
				default: return -1;
			}
		}
		if (baseClass == ViewPageFlow.class) {
			switch (derivedFeatureID) {
				case ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__VIEW_PAGE_FLOW_TRANSITIONS: return ProcessPackage.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_TRANSITIONS;
				case ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__VIEW_TRANSIENT_DATA: return ProcessPackage.VIEW_PAGE_FLOW__VIEW_TRANSIENT_DATA;
				case ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__VIEW_PAGE_FLOW_CONNECTORS: return ProcessPackage.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_CONNECTORS;
				case ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__VIEW_PAGE_FLOW_TYPE: return ProcessPackage.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_TYPE;
				case ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__VIEW_FORM: return ProcessPackage.VIEW_PAGE_FLOW__VIEW_FORM;
				case ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__VIEW_PAGE_FLOW_REDIRECTION_URL: return ProcessPackage.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_REDIRECTION_URL;
				default: return -1;
			}
		}
		if (baseClass == SimulationDataContainer.class) {
			switch (derivedFeatureID) {
				case ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__SIMULATION_DATA: return SimulationPackage.SIMULATION_DATA_CONTAINER__SIMULATION_DATA;
				default: return -1;
			}
		}
		if (baseClass == SimulationActivity.class) {
			switch (derivedFeatureID) {
				case ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__RESOURCES_USAGES: return SimulationPackage.SIMULATION_ACTIVITY__RESOURCES_USAGES;
				case ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__EXECUTION_TIME: return SimulationPackage.SIMULATION_ACTIVITY__EXECUTION_TIME;
				case ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__ESTIMATED_TIME: return SimulationPackage.SIMULATION_ACTIVITY__ESTIMATED_TIME;
				case ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__MAXIMUM_TIME: return SimulationPackage.SIMULATION_ACTIVITY__MAXIMUM_TIME;
				case ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__CONTIGOUS: return SimulationPackage.SIMULATION_ACTIVITY__CONTIGOUS;
				case ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__EXCLUSIVE_OUTGOING_TRANSITION: return SimulationPackage.SIMULATION_ACTIVITY__EXCLUSIVE_OUTGOING_TRANSITION;
				case ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__LOOP_TRANSITION: return SimulationPackage.SIMULATION_ACTIVITY__LOOP_TRANSITION;
				case ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__DATA_CHANGE: return SimulationPackage.SIMULATION_ACTIVITY__DATA_CHANGE;
				default: return -1;
			}
		}
		if (baseClass == FlowElement.class) {
			switch (derivedFeatureID) {
				case ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__DYNAMIC_LABEL: return ProcessPackage.FLOW_ELEMENT__DYNAMIC_LABEL;
				case ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__DYNAMIC_DESCRIPTION: return ProcessPackage.FLOW_ELEMENT__DYNAMIC_DESCRIPTION;
				case ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__STEP_SUMMARY: return ProcessPackage.FLOW_ELEMENT__STEP_SUMMARY;
				default: return -1;
			}
		}
		...
		if (baseClass == DataAware.class) {
			switch (derivedFeatureID) {
				case ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__DATA: return ProcessPackage.DATA_AWARE__DATA;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == SourceElement.class) {
			switch (baseFeatureID) {
				case ProcessPackage.SOURCE_ELEMENT__OUTGOING: return ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__OUTGOING;
				default: return -1;
			}
		}
		if (baseClass == TargetElement.class) {
			switch (baseFeatureID) {
				case ProcessPackage.TARGET_ELEMENT__INCOMING: return ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__INCOMING;
				default: return -1;
			}
		}
		if (baseClass == AbstractPageFlow.class) {
			switch (baseFeatureID) {
				case ProcessPackage.ABSTRACT_PAGE_FLOW__REG_EXP_TO_HIDE_DEFAULT_FIELD: return ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__REG_EXP_TO_HIDE_DEFAULT_FIELD;
				case ProcessPackage.ABSTRACT_PAGE_FLOW__USE_REG_EXP_TO_HIDE_DEFAULT_FIELD: return ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__USE_REG_EXP_TO_HIDE_DEFAULT_FIELD;
				default: return -1;
			}
		}
		if (baseClass == ViewPageFlow.class) {
			switch (baseFeatureID) {
				case ProcessPackage.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_TRANSITIONS: return ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__VIEW_PAGE_FLOW_TRANSITIONS;
				case ProcessPackage.VIEW_PAGE_FLOW__VIEW_TRANSIENT_DATA: return ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__VIEW_TRANSIENT_DATA;
				case ProcessPackage.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_CONNECTORS: return ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__VIEW_PAGE_FLOW_CONNECTORS;
				case ProcessPackage.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_TYPE: return ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__VIEW_PAGE_FLOW_TYPE;
				case ProcessPackage.VIEW_PAGE_FLOW__VIEW_FORM: return ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__VIEW_FORM;
				case ProcessPackage.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_REDIRECTION_URL: return ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__VIEW_PAGE_FLOW_REDIRECTION_URL;
				default: return -1;
			}
		}
		if (baseClass == SimulationDataContainer.class) {
			switch (baseFeatureID) {
				case SimulationPackage.SIMULATION_DATA_CONTAINER__SIMULATION_DATA: return ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__SIMULATION_DATA;
				default: return -1;
			}
		}
		if (baseClass == SimulationActivity.class) {
			switch (baseFeatureID) {
				case SimulationPackage.SIMULATION_ACTIVITY__RESOURCES_USAGES: return ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__RESOURCES_USAGES;
				case SimulationPackage.SIMULATION_ACTIVITY__EXECUTION_TIME: return ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__EXECUTION_TIME;
				case SimulationPackage.SIMULATION_ACTIVITY__ESTIMATED_TIME: return ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__ESTIMATED_TIME;
				case SimulationPackage.SIMULATION_ACTIVITY__MAXIMUM_TIME: return ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__MAXIMUM_TIME;
				case SimulationPackage.SIMULATION_ACTIVITY__CONTIGOUS: return ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__CONTIGOUS;
				case SimulationPackage.SIMULATION_ACTIVITY__EXCLUSIVE_OUTGOING_TRANSITION: return ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__EXCLUSIVE_OUTGOING_TRANSITION;
				case SimulationPackage.SIMULATION_ACTIVITY__LOOP_TRANSITION: return ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__LOOP_TRANSITION;
				case SimulationPackage.SIMULATION_ACTIVITY__DATA_CHANGE: return ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__DATA_CHANGE;
				default: return -1;
			}
		}
		if (baseClass == FlowElement.class) {
			switch (baseFeatureID) {
				case ProcessPackage.FLOW_ELEMENT__DYNAMIC_LABEL: return ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__DYNAMIC_LABEL;
				case ProcessPackage.FLOW_ELEMENT__DYNAMIC_DESCRIPTION: return ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__DYNAMIC_DESCRIPTION;
				case ProcessPackage.FLOW_ELEMENT__STEP_SUMMARY: return ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__STEP_SUMMARY;
				default: return -1;
			}
		}
		if (baseClass == Event.class) {
		...
		if (baseClass == DataAware.class) {
			switch (baseFeatureID) {
				case ProcessPackage.DATA_AWARE__DATA: return ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT__DATA;
				default: return -1;
			}
		}
