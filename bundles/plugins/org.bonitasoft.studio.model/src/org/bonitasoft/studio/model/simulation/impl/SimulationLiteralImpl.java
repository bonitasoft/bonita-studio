 ...
 * </p>
 * <ul>
 * <li>{@link org.bonitasoft.studio.model.simulation.impl.SimulationLiteralImpl#getProbability <em>Probability</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.simulation.impl.SimulationLiteralImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SimulationLiteralImpl extends EObjectImpl implements SimulationLiteral {
    ...
    public void setProbability(double newProbability) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SimulationPackage.SIMULATION_LITERAL__PROBABILITY,
    ...
    public void setValue(String newValue) {
        ...
        value = newValue;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SimulationPackage.SIMULATION_LITERAL__VALUE, oldValue,
                    value));
    }
