 ...
 * <li>{@link org.bonitasoft.studio.model.process.impl.MainProcessImpl#getBonitaModelVersion <em>Bonita Model
 * Version</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.process.impl.MainProcessImpl#getIncludedEntries <em>Included Entries</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.process.impl.MainProcessImpl#getMessageConnections <em>Message
 * Connections</em>}</li>
...
public class MainProcessImpl extends AbstractProcessImpl implements MainProcess {
    ...
    public void setBonitaVersion(String newBonitaVersion) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.MAIN_PROCESS__BONITA_VERSION,
                    oldBonitaVersion, bonitaVersion));
    }
    ...
    public void setBonitaModelVersion(String newBonitaModelVersion) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.MAIN_PROCESS__BONITA_MODEL_VERSION,
                    oldBonitaModelVersion, bonitaModelVersion));
    }
    ...
    public EList<String> getIncludedEntries() {
        if (includedEntries == null) {
            includedEntries = new EDataTypeUniqueEList<String>(String.class, this,
                    ProcessPackage.MAIN_PROCESS__INCLUDED_ENTRIES);
        }
    ...
    public EList<MessageFlow> getMessageConnections() {
        if (messageConnections == null) {
            messageConnections = new EObjectContainmentEList<MessageFlow>(MessageFlow.class, this,
                    ProcessPackage.MAIN_PROCESS__MESSAGE_CONNECTIONS);
        }
    ...
    public EList<String> getGeneratedLibs() {
        if (generatedLibs == null) {
            generatedLibs = new EDataTypeUniqueEList<String>(String.class, this,
                    ProcessPackage.MAIN_PROCESS__GENERATED_LIBS);
        }
    ...
    public void setEnableValidation(boolean newEnableValidation) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.MAIN_PROCESS__ENABLE_VALIDATION,
    ...
    public void setConfigId(Object newConfigId) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.MAIN_PROCESS__CONFIG_ID, oldConfigId,
                    configId));
    }
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            case ProcessPackage.MAIN_PROCESS__BONITA_VERSION:
                return BONITA_VERSION_EDEFAULT == null ? bonitaVersion != null
                        : !BONITA_VERSION_EDEFAULT.equals(bonitaVersion);
            case ProcessPackage.MAIN_PROCESS__BONITA_MODEL_VERSION:
                return BONITA_MODEL_VERSION_EDEFAULT == null ? bonitaModelVersion != null
                        : !BONITA_MODEL_VERSION_EDEFAULT.equals(bonitaModelVersion);
            case ProcessPackage.MAIN_PROCESS__INCLUDED_ENTRIES:
