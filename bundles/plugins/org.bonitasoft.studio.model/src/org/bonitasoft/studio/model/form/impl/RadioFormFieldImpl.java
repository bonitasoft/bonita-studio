...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Radio Form Field</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.bonitasoft.studio.model.form.impl.RadioFormFieldImpl#getItemClass <em>Item Class</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RadioFormFieldImpl extends MultipleValuatedFormFieldImpl implements RadioFormField {
    ...
    public void setItemClass(String newItemClass) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.RADIO_FORM_FIELD__ITEM_CLASS, oldItemClass,
                    itemClass));
    }
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        if (baseClass == ItemContainer.class) {
            switch (derivedFeatureID) {
                case FormPackage.RADIO_FORM_FIELD__ITEM_CLASS:
                    return FormPackage.ITEM_CONTAINER__ITEM_CLASS;
                default:
                    return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == ItemContainer.class) {
            switch (baseFeatureID) {
                case FormPackage.ITEM_CONTAINER__ITEM_CLASS:
                    return FormPackage.RADIO_FORM_FIELD__ITEM_CLASS;
                default:
                    return -1;
            }
        }
