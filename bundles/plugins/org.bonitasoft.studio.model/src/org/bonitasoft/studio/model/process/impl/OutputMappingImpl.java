...
public class OutputMappingImpl extends EObjectImpl implements OutputMapping {
    ...
    public void setSubprocessSource(String newSubprocessSource) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.OUTPUT_MAPPING__SUBPROCESS_SOURCE,
                    oldSubprocessSource, subprocessSource));
    }
    ...
    public Data getProcessTarget() {
        if (processTarget != null && processTarget.eIsProxy()) {
            ...
            if (processTarget != oldProcessTarget) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, ProcessPackage.OUTPUT_MAPPING__PROCESS_TARGET,
                            oldProcessTarget, processTarget));
            }
        }
    ...
    public void setProcessTarget(Data newProcessTarget) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.OUTPUT_MAPPING__PROCESS_TARGET,
                    oldProcessTarget, processTarget));
    }
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            case ProcessPackage.OUTPUT_MAPPING__SUBPROCESS_SOURCE:
                return SUBPROCESS_SOURCE_EDEFAULT == null ? subprocessSource != null
                        : !SUBPROCESS_SOURCE_EDEFAULT.equals(subprocessSource);
            case ProcessPackage.OUTPUT_MAPPING__PROCESS_TARGET:
