 ...
 * <li>{@link org.bonitasoft.studio.model.process.impl.MultiInstantiableImpl#getCardinalityExpression <em>Cardinality
 * Expression</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.process.impl.MultiInstantiableImpl#getCollectionDataToMultiInstantiate
 * <em>Collection Data To Multi Instantiate</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.process.impl.MultiInstantiableImpl#getIteratorExpression <em>Iterator
 * Expression</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.process.impl.MultiInstantiableImpl#getOutputData <em>Output Data</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.process.impl.MultiInstantiableImpl#getListDataContainingOutputResults <em>List Data
 * Containing Output Results</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.process.impl.MultiInstantiableImpl#getCompletionCondition <em>Completion
 * Condition</em>}</li>
...
public abstract class MultiInstantiableImpl extends EObjectImpl implements MultiInstantiable {
    ...
    public void setTestBefore(Boolean newTestBefore) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.MULTI_INSTANTIABLE__TEST_BEFORE,
    ...
    public NotificationChain basicSetLoopCondition(Expression newLoopCondition, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.MULTI_INSTANTIABLE__LOOP_CONDITION, oldLoopCondition, newLoopCondition);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newLoopCondition != loopCondition) {
            ...
            if (loopCondition != null)
                msgs = ((InternalEObject) loopCondition).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.MULTI_INSTANTIABLE__LOOP_CONDITION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.MULTI_INSTANTIABLE__LOOP_CONDITION,
    ...
    public NotificationChain basicSetLoopMaximum(Expression newLoopMaximum, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.MULTI_INSTANTIABLE__LOOP_MAXIMUM, oldLoopMaximum, newLoopMaximum);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newLoopMaximum != loopMaximum) {
            ...
            if (loopMaximum != null)
                msgs = ((InternalEObject) loopMaximum).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.MULTI_INSTANTIABLE__LOOP_MAXIMUM, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.MULTI_INSTANTIABLE__LOOP_MAXIMUM,
    ...
    public void setUseCardinality(boolean newUseCardinality) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.MULTI_INSTANTIABLE__USE_CARDINALITY,
    ...
    public NotificationChain basicSetCardinalityExpression(Expression newCardinalityExpression, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.MULTI_INSTANTIABLE__CARDINALITY_EXPRESSION, oldCardinalityExpression,
                    newCardinalityExpression);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newCardinalityExpression != cardinalityExpression) {
            ...
            if (cardinalityExpression != null)
                msgs = ((InternalEObject) cardinalityExpression).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.MULTI_INSTANTIABLE__CARDINALITY_EXPRESSION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.MULTI_INSTANTIABLE__CARDINALITY_EXPRESSION,
            ...
            if (collectionDataToMultiInstantiate != oldCollectionDataToMultiInstantiate) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            ProcessPackage.MULTI_INSTANTIABLE__COLLECTION_DATA_TO_MULTI_INSTANTIATE,
    ...
    public NotificationChain basicSetIteratorExpression(Expression newIteratorExpression, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.MULTI_INSTANTIABLE__ITERATOR_EXPRESSION, oldIteratorExpression, newIteratorExpression);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newIteratorExpression != iteratorExpression) {
            ...
            if (iteratorExpression != null)
                msgs = ((InternalEObject) iteratorExpression).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.MULTI_INSTANTIABLE__ITERATOR_EXPRESSION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.MULTI_INSTANTIABLE__ITERATOR_EXPRESSION,
    ...
    public Data getOutputData() {
        if (outputData != null && outputData.eIsProxy()) {
            ...
            if (outputData != oldOutputData) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, ProcessPackage.MULTI_INSTANTIABLE__OUTPUT_DATA,
    ...
    public void setOutputData(Data newOutputData) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.MULTI_INSTANTIABLE__OUTPUT_DATA,
                    oldOutputData, outputData));
    }
    ...
    public Data getListDataContainingOutputResults() {
        if (listDataContainingOutputResults != null && listDataContainingOutputResults.eIsProxy()) {
            ...
            if (listDataContainingOutputResults != oldListDataContainingOutputResults) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            ProcessPackage.MULTI_INSTANTIABLE__LIST_DATA_CONTAINING_OUTPUT_RESULTS,
                            oldListDataContainingOutputResults, listDataContainingOutputResults));
            }
        }
    ...
    public NotificationChain basicSetCompletionCondition(Expression newCompletionCondition, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.MULTI_INSTANTIABLE__COMPLETION_CONDITION, oldCompletionCondition, newCompletionCondition);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newCompletionCondition != completionCondition) {
            ...
            if (completionCondition != null)
                msgs = ((InternalEObject) completionCondition).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.MULTI_INSTANTIABLE__COMPLETION_CONDITION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.MULTI_INSTANTIABLE__COMPLETION_CONDITION,
    ...
    public void setStoreOutput(boolean newStoreOutput) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.MULTI_INSTANTIABLE__STORE_OUTPUT,
                    oldStoreOutput, storeOutput));
    }
