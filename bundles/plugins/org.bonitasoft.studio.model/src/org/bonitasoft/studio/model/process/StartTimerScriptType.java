...
public enum StartTimerScriptType implements Enumerator {
     ...
     * @generated
     */
    private static final StartTimerScriptType[] VALUES_ARRAY = new StartTimerScriptType[] {
            GROOVY,
            CUSTOM,
            YEARLY,
            YEARLY_DAY_OF_MONTH,
    ...
    public static StartTimerScriptType get(int value) {
        switch (value) {
            ...
            case YEARLY_VALUE:
                return YEARLY;
            case YEARLY_DAY_OF_MONTH_VALUE:
                return YEARLY_DAY_OF_MONTH;
            case YEARLY_DAY_OF_YEAR_VALUE:
                return YEARLY_DAY_OF_YEAR;
            case MONTHLY_VALUE:
                return MONTHLY;
            case MONTHLY_DAY_NUMBER_VALUE:
                return MONTHLY_DAY_NUMBER;
            case MONTHLY_DAY_OF_WEEK_VALUE:
