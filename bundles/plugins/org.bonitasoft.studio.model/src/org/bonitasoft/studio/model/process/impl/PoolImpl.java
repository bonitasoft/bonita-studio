...
public class PoolImpl extends AbstractProcessImpl implements Pool {
    ...
    public NotificationChain basicSetContract(Contract newContract, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.POOL__CONTRACT,
        ...
        if (newContract != contract) {
            ...
            if (contract != null)
                msgs = ((InternalEObject) contract).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.POOL__CONTRACT, null, msgs);
            if (newContract != null)
    ...
    public EList<SearchIndex> getSearchIndexes() {
        if (searchIndexes == null) {
            searchIndexes = new EObjectContainmentEList<SearchIndex>(SearchIndex.class, this,
                    ProcessPackage.POOL__SEARCH_INDEXES);
        }
    ...
    public void setDisplayName(String newDisplayName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.POOL__DISPLAY_NAME, oldDisplayName,
                    displayName));
    }
        ...
        if (baseClass == ContractContainer.class) {
            switch (baseFeatureID) {
                case ProcessPackage.CONTRACT_CONTAINER__CONTRACT:
                    return ProcessPackage.POOL__CONTRACT;
                default:
                    return -1;
            }
        }
