...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Intermediate Error Catch Event</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.bonitasoft.studio.model.process.impl.IntermediateErrorCatchEventImpl#getErrorCode <em>Error Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntermediateErrorCatchEventImpl extends BoundaryEventImpl implements IntermediateErrorCatchEvent {
    ...
    public void setErrorCode(String newErrorCode) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.INTERMEDIATE_ERROR_CATCH_EVENT__ERROR_CODE,
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        if (baseClass == ErrorEvent.class) {
            switch (derivedFeatureID) {
                case ProcessPackage.INTERMEDIATE_ERROR_CATCH_EVENT__ERROR_CODE:
                    return ProcessPackage.ERROR_EVENT__ERROR_CODE;
                default:
                    return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == ErrorEvent.class) {
            switch (baseFeatureID) {
                case ProcessPackage.ERROR_EVENT__ERROR_CODE:
                    return ProcessPackage.INTERMEDIATE_ERROR_CATCH_EVENT__ERROR_CODE;
                default:
                    return -1;
            }
        }
