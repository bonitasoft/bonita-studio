 ...
 * </p>
 * <ul>
 * <li>{@link org.bonitasoft.studio.model.simulation.impl.SimulationLiteralDataImpl#isExpressionBased <em>Expression
 * Based</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.simulation.impl.SimulationLiteralDataImpl#getExpression <em>Expression</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.simulation.impl.SimulationLiteralDataImpl#getLiterals <em>Literals</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SimulationLiteralDataImpl extends SimulationElementImpl implements SimulationLiteralData {
    ...
    public void setExpressionBased(boolean newExpressionBased) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    SimulationPackage.SIMULATION_LITERAL_DATA__EXPRESSION_BASED, oldExpressionBased, expressionBased));
    }
    ...
    public NotificationChain basicSetExpression(Expression newExpression, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    SimulationPackage.SIMULATION_LITERAL_DATA__EXPRESSION, oldExpression, newExpression);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newExpression != expression) {
            ...
            if (expression != null)
                msgs = ((InternalEObject) expression).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - SimulationPackage.SIMULATION_LITERAL_DATA__EXPRESSION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, SimulationPackage.SIMULATION_LITERAL_DATA__EXPRESSION,
    ...
    public EList<SimulationLiteral> getLiterals() {
        if (literals == null) {
            literals = new EObjectContainmentEList<SimulationLiteral>(SimulationLiteral.class, this,
                    SimulationPackage.SIMULATION_LITERAL_DATA__LITERALS);
        }
        return literals;
    }
