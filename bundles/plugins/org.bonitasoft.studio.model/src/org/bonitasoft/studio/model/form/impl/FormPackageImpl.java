...
public class FormPackageImpl extends EPackageImpl implements FormPackage {
    ...
    public static FormPackage init() {
        ...
        FormPackageImpl theFormPackage = (FormPackageImpl) (EPackage.Registry.INSTANCE
                .get(eNS_URI) instanceof FormPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new FormPackageImpl());
    ...
    public void initializePackageContents() {
        ...
        initEClass(widgetDependencyEClass, WidgetDependency.class, "WidgetDependency", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getWidgetDependency_TriggerRefreshOnModification(), ecorePackage.getEBoolean(),
                "triggerRefreshOnModification", "true", 0, 1, WidgetDependency.class, !IS_TRANSIENT, !IS_VOLATILE, //$NON-NLS-1$//$NON-NLS-2$
                IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getWidgetDependency_EventTypes(), this.getEventDependencyType(), "eventTypes", "onChange", 1, -1, //$NON-NLS-1$//$NON-NLS-2$
                WidgetDependency.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEReference(getWidgetDependency_Widget(), this.getWidget(), null, "widget", null, 1, 1, WidgetDependency.class, //$NON-NLS-1$
        ...
        initEAttribute(getValidator_ValidatorClass(), ecorePackage.getEString(), "validatorClass", null, 0, 1, //$NON-NLS-1$
                Validator.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEAttribute(getValidator_HtmlClass(), ecorePackage.getEString(), "htmlClass", null, 0, 1, Validator.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getValidator_Name(), ecorePackage.getEString(), "name", null, 0, 1, Validator.class, !IS_TRANSIENT, //$NON-NLS-1$
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getValidator_BelowField(), ecorePackage.getEBoolean(), "belowField", "true", 0, 1, Validator.class, //$NON-NLS-1$//$NON-NLS-2$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getValidator_Parameter(), theExpressionPackage.getExpression(), null, "parameter", null, 0, 1, //$NON-NLS-1$
                Validator.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getValidator_DisplayName(), theExpressionPackage.getExpression(), null, "displayName", null, 0, 1, //$NON-NLS-1$
                Validator.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(validableEClass, Validable.class, "Validable", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
        initEReference(getValidable_Validators(), this.getValidator(), null, "validators", null, 0, -1, Validable.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getValidable_UseDefaultValidator(), ecorePackage.getEBooleanObject(), "useDefaultValidator", "true", //$NON-NLS-1$//$NON-NLS-2$
                0, 1, Validable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getValidable_Below(), ecorePackage.getEBoolean(), "below", "true", 1, 1, Validable.class, //$NON-NLS-1$//$NON-NLS-2$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(formEClass, Form.class, "Form", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
        initEAttribute(getForm_NColumn(), ecorePackage.getEInt(), "nColumn", "1", 0, 1, Form.class, !IS_TRANSIENT, //$NON-NLS-1$//$NON-NLS-2$
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getForm_StringAttributes(), ecorePackage.getEStringToStringMapEntry(), null, "stringAttributes", null, //$NON-NLS-1$
                0, -1, Form.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getForm_NLine(), ecorePackage.getEInt(), "nLine", "4", 0, 1, Form.class, !IS_TRANSIENT, !IS_VOLATILE, //$NON-NLS-1$//$NON-NLS-2$
                IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getForm_ShowPageLabel(), ecorePackage.getEBooleanObject(), "showPageLabel", "true", 0, 1, Form.class, //$NON-NLS-1$//$NON-NLS-2$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getForm_AllowHTMLInPageLabel(), ecorePackage.getEBoolean(), "allowHTMLInPageLabel", "false", 0, 1, //$NON-NLS-1$//$NON-NLS-2$
                Form.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEAttribute(getForm_Version(), ecorePackage.getEString(), "version", null, 0, 1, Form.class, !IS_TRANSIENT, //$NON-NLS-1$
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getForm_Columns(), this.getColumn(), null, "columns", null, 0, -1, Form.class, !IS_TRANSIENT, //$NON-NLS-1$
                !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEReference(getForm_Lines(), this.getLine(), null, "lines", null, 0, -1, Form.class, !IS_TRANSIENT, !IS_VOLATILE, //$NON-NLS-1$
                IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getForm_Widgets(), this.getWidget(), null, "widgets", null, 0, -1, Form.class, !IS_TRANSIENT, //$NON-NLS-1$
                !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEReference(getForm_PageLabel(), theExpressionPackage.getExpression(), null, "pageLabel", null, 0, 1, Form.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEReference(getForm_Actions(), theExpressionPackage.getOperation(), null, "actions", null, 0, -1, Form.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);

        initEClass(widgetLayoutInfoEClass, WidgetLayoutInfo.class, "WidgetLayoutInfo", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getWidgetLayoutInfo_Line(), ecorePackage.getEInt(), "line", null, 0, 1, WidgetLayoutInfo.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getWidgetLayoutInfo_Column(), ecorePackage.getEInt(), "column", null, 0, 1, WidgetLayoutInfo.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getWidgetLayoutInfo_VerticalSpan(), ecorePackage.getEInt(), "verticalSpan", "1", 0, 1, //$NON-NLS-1$//$NON-NLS-2$
                WidgetLayoutInfo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getWidgetLayoutInfo_HorizontalSpan(), ecorePackage.getEInt(), "horizontalSpan", "1", 0, 1, //$NON-NLS-1$//$NON-NLS-2$
                WidgetLayoutInfo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);

        initEClass(columnEClass, Column.class, "Column", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
        initEAttribute(getColumn_Width(), ecorePackage.getEString(), "width", null, 0, 1, Column.class, !IS_TRANSIENT, //$NON-NLS-1$
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getColumn_Number(), ecorePackage.getEInt(), "number", null, 0, 1, Column.class, !IS_TRANSIENT, //$NON-NLS-1$
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(lineEClass, Line.class, "Line", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
        initEAttribute(getLine_Height(), ecorePackage.getEString(), "height", null, 0, 1, Line.class, !IS_TRANSIENT, //$NON-NLS-1$
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getLine_Number(), ecorePackage.getEInt(), "number", null, 0, 1, Line.class, !IS_TRANSIENT, //$NON-NLS-1$
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(itemContainerEClass, ItemContainer.class, "ItemContainer", IS_ABSTRACT, IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getItemContainer_ItemClass(), ecorePackage.getEString(), "itemClass", null, 0, 1, ItemContainer.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(duplicableEClass, Duplicable.class, "Duplicable", IS_ABSTRACT, IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
        initEAttribute(getDuplicable_Duplicate(), ecorePackage.getEBoolean(), "duplicate", "false", 1, 1, Duplicable.class, //$NON-NLS-1$//$NON-NLS-2$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getDuplicable_LimitNumberOfDuplication(), ecorePackage.getEBoolean(), "limitNumberOfDuplication", //$NON-NLS-1$
                "false", 0, 1, Duplicable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, //$NON-NLS-1$
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getDuplicable_LimitMinNumberOfDuplication(), ecorePackage.getEBoolean(),
                "limitMinNumberOfDuplication", "false", 0, 1, Duplicable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, //$NON-NLS-1$//$NON-NLS-2$
                !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getDuplicable_MaxNumberOfDuplication(), theExpressionPackage.getExpression(), null,
                "maxNumberOfDuplication", null, 0, 1, Duplicable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, //$NON-NLS-1$
                IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getDuplicable_MinNumberOfDuplication(), theExpressionPackage.getExpression(), null,
                "minNumberOfDuplication", null, 0, 1, Duplicable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, //$NON-NLS-1$
                IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getDuplicable_DisplayLabelForAdd(), theExpressionPackage.getExpression(), null, "displayLabelForAdd", //$NON-NLS-1$
                null, 0, 1, Duplicable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getDuplicable_TooltipForAdd(), theExpressionPackage.getExpression(), null, "tooltipForAdd", null, 0, //$NON-NLS-1$
                1, Duplicable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getDuplicable_DisplayLabelForRemove(), theExpressionPackage.getExpression(), null,
                "displayLabelForRemove", null, 0, 1, Duplicable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, //$NON-NLS-1$
                IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getDuplicable_TooltipForRemove(), theExpressionPackage.getExpression(), null, "tooltipForRemove", //$NON-NLS-1$
                null, 0, 1, Duplicable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(viewFormEClass, ViewForm.class, "ViewForm", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$

        initEClass(cssCustomizableEClass, CSSCustomizable.class, "CSSCustomizable", IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getCSSCustomizable_HtmlAttributes(), ecorePackage.getEStringToStringMapEntry(), null,
                "htmlAttributes", null, 0, -1, CSSCustomizable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, //$NON-NLS-1$
                IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(widgetEClass, Widget.class, "Widget", IS_ABSTRACT, IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
        initEReference(getWidget_WidgetLayoutInfo(), this.getWidgetLayoutInfo(), null, "widgetLayoutInfo", null, 0, 1, //$NON-NLS-1$
                Widget.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getWidget_ShowDisplayLabel(), ecorePackage.getEBooleanObject(), "showDisplayLabel", "true", 0, 1, //$NON-NLS-1$//$NON-NLS-2$
                Widget.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEAttribute(getWidget_AllowHTMLForDisplayLabel(), ecorePackage.getEBoolean(), "allowHTMLForDisplayLabel", "false", //$NON-NLS-1$//$NON-NLS-2$
                0, 1, Widget.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEReference(getWidget_DependOn(), this.getWidgetDependency(), null, "dependOn", null, 0, -1, Widget.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getWidget_DisplayDependentWidgetOnlyOnEventTriggered(), ecorePackage.getEBoolean(),
                "displayDependentWidgetOnlyOnEventTriggered", "false", 0, 1, Widget.class, !IS_TRANSIENT, !IS_VOLATILE, //$NON-NLS-1$//$NON-NLS-2$
                IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getWidget_ParentOf(), this.getWidgetDependency(), null, "parentOf", null, 0, -1, Widget.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getWidget_Mandatory(), ecorePackage.getEBoolean(), "mandatory", "false", 0, 1, Widget.class, //$NON-NLS-1$//$NON-NLS-2$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getWidget_ReadOnly(), ecorePackage.getEBoolean(), "readOnly", "false", 0, 1, Widget.class, //$NON-NLS-1$//$NON-NLS-2$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getWidget_LabelPosition(), this.getLabelPosition(), "labelPosition", "Up", 0, 1, Widget.class, //$NON-NLS-1$//$NON-NLS-2$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getWidget_RealHtmlAttributes(), ecorePackage.getEString(), "realHtmlAttributes", null, 0, 1, //$NON-NLS-1$
                Widget.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEAttribute(getWidget_InjectWidgetCondition(), ecorePackage.getEBoolean(), "injectWidgetCondition", "false", 0, 1, //$NON-NLS-1$//$NON-NLS-2$
                Widget.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEAttribute(getWidget_Version(), ecorePackage.getEString(), "version", null, 0, 1, Widget.class, !IS_TRANSIENT, //$NON-NLS-1$
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getWidget_ReturnTypeModifier(), ecorePackage.getEString(), "returnTypeModifier", "java.lang.String", //$NON-NLS-1$//$NON-NLS-2$
                0, 1, Widget.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEReference(getWidget_DisplayDependentWidgetOnlyAfterFirstEventTriggeredAndCondition(),
                theExpressionPackage.getExpression(), null, "displayDependentWidgetOnlyAfterFirstEventTriggeredAndCondition", //$NON-NLS-1$
                null, 0, 1, Widget.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getWidget_DisplayAfterEventDependsOnConditionScript(), theExpressionPackage.getExpression(), null,
                "displayAfterEventDependsOnConditionScript", null, 0, 1, Widget.class, !IS_TRANSIENT, !IS_VOLATILE, //$NON-NLS-1$
                IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getWidget_InputExpression(), theExpressionPackage.getExpression(), null, "inputExpression", null, 0, //$NON-NLS-1$
                1, Widget.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getWidget_AfterEventExpression(), theExpressionPackage.getExpression(), null, "afterEventExpression", //$NON-NLS-1$
                null, 0, 1, Widget.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getWidget_Tooltip(), theExpressionPackage.getExpression(), null, "tooltip", null, 0, 1, Widget.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEReference(getWidget_HelpMessage(), theExpressionPackage.getExpression(), null, "helpMessage", null, 0, 1, //$NON-NLS-1$
                Widget.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getWidget_DisplayLabel(), theExpressionPackage.getExpression(), null, "displayLabel", null, 0, 1, //$NON-NLS-1$
                Widget.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getWidget_InjectWidgetScript(), theExpressionPackage.getExpression(), null, "injectWidgetScript", //$NON-NLS-1$
                null, 0, 1, Widget.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getWidget_Action(), theExpressionPackage.getOperation(), null, "action", null, 0, 1, Widget.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);

        initEClass(groupEClass, Group.class, "Group", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
        initEReference(getGroup_Widgets(), this.getWidget(), null, "widgets", null, 0, -1, Group.class, !IS_TRANSIENT, //$NON-NLS-1$
                !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEAttribute(getGroup_ShowBorder(), ecorePackage.getEBoolean(), "showBorder", "false", 1, 1, Group.class, //$NON-NLS-1$//$NON-NLS-2$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getGroup_Columns(), this.getColumn(), null, "columns", null, 0, -1, Group.class, !IS_TRANSIENT, //$NON-NLS-1$
                !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEReference(getGroup_Lines(), this.getLine(), null, "lines", null, 0, -1, Group.class, !IS_TRANSIENT, //$NON-NLS-1$
                !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEAttribute(getGroup_UseIterator(), ecorePackage.getEBoolean(), "useIterator", "false", 1, 1, Group.class, //$NON-NLS-1$//$NON-NLS-2$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getGroup_Iterator(), this.getGroupIterator(), null, "iterator", null, 0, 1, Group.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);

        initEClass(formFieldEClass, FormField.class, "FormField", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
        initEAttribute(getFormField_Description(), ecorePackage.getEString(), "description", null, 0, 1, FormField.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getFormField_ExampleMessagePosition(), this.getLabelPosition(), "exampleMessagePosition", "Down", 0, //$NON-NLS-1$//$NON-NLS-2$
                1, FormField.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEReference(getFormField_ExampleMessage(), theExpressionPackage.getExpression(), null, "exampleMessage", null, 0, //$NON-NLS-1$
                1, FormField.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(multipleValuatedFormFieldEClass, MultipleValuatedFormField.class, "MultipleValuatedFormField", //$NON-NLS-1$
                IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getMultipleValuatedFormField_DefaultExpression(), theExpressionPackage.getExpression(), null,
                "defaultExpression", null, 0, 1, MultipleValuatedFormField.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, //$NON-NLS-1$
                IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getMultipleValuatedFormField_DefaultExpressionAfterEvent(), theExpressionPackage.getExpression(),
                null, "defaultExpressionAfterEvent", null, 0, 1, MultipleValuatedFormField.class, !IS_TRANSIENT, //$NON-NLS-1$
                !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);

        initEClass(singleValuatedFormFieldEClass, SingleValuatedFormField.class, "SingleValuatedFormField", IS_ABSTRACT, //$NON-NLS-1$
                !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

        initEClass(checkBoxMultipleFormFieldEClass, CheckBoxMultipleFormField.class, "CheckBoxMultipleFormField", //$NON-NLS-1$
                !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

        initEClass(comboFormFieldEClass, ComboFormField.class, "ComboFormField", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);

        initEClass(dateFormFieldEClass, DateFormField.class, "DateFormField", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getDateFormField_InitialFormat(), ecorePackage.getEString(), "initialFormat", null, 0, 1, //$NON-NLS-1$
                DateFormField.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getDateFormField_DisplayFormat(), ecorePackage.getEString(), "displayFormat", null, 0, 1, //$NON-NLS-1$
                DateFormField.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);

        initEClass(listFormFieldEClass, ListFormField.class, "ListFormField", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getListFormField_MaxHeigth(), ecorePackage.getEInt(), "maxHeigth", null, 0, 1, ListFormField.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(passwordFormFieldEClass, PasswordFormField.class, "PasswordFormField", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getPasswordFormField_MaxLength(), ecorePackage.getEInt(), "maxLength", null, 0, 1, //$NON-NLS-1$
                PasswordFormField.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);

        initEClass(radioFormFieldEClass, RadioFormField.class, "RadioFormField", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);

        initEClass(selectFormFieldEClass, SelectFormField.class, "SelectFormField", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);

        initEClass(textFormFieldEClass, TextFormField.class, "TextFormField", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getTextFormField_MaxLength(), ecorePackage.getEInt(), "maxLength", null, 0, 1, TextFormField.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(textAreaFormFieldEClass, TextAreaFormField.class, "TextAreaFormField", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getTextAreaFormField_MaxLength(), ecorePackage.getEInt(), "maxLength", null, 0, 1, //$NON-NLS-1$
                TextAreaFormField.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getTextAreaFormField_MaxHeigth(), ecorePackage.getEInt(), "maxHeigth", null, 0, 1, //$NON-NLS-1$
                TextAreaFormField.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);

        initEClass(richTextAreaFormFieldEClass, RichTextAreaFormField.class, "RichTextAreaFormField", !IS_ABSTRACT, //$NON-NLS-1$
                !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

        initEClass(formButtonEClass, FormButton.class, "FormButton", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getFormButton_LabelBehavior(), ecorePackage.getEBooleanObject(), "labelBehavior", "false", 0, 1, //$NON-NLS-1$//$NON-NLS-2$
                FormButton.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);

        initEClass(submitFormButtonEClass, SubmitFormButton.class, "SubmitFormButton", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getSubmitFormButton_Actions(), theExpressionPackage.getOperation(), null, "actions", null, 0, -1, //$NON-NLS-1$
                SubmitFormButton.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(previousFormButtonEClass, PreviousFormButton.class, "PreviousFormButton", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);

        initEClass(nextFormButtonEClass, NextFormButton.class, "NextFormButton", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        ...
        initEClass(messageInfoEClass, MessageInfo.class, "MessageInfo", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);

        initEClass(checkBoxSingleFormFieldEClass, CheckBoxSingleFormField.class, "CheckBoxSingleFormField", !IS_ABSTRACT, //$NON-NLS-1$
                !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

        initEClass(fileWidgetEClass, FileWidget.class, "FileWidget", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getFileWidget_DownloadOnly(), ecorePackage.getEBoolean(), "downloadOnly", "false", 0, 1, //$NON-NLS-1$//$NON-NLS-2$
                FileWidget.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEAttribute(getFileWidget_UsePreview(), ecorePackage.getEBoolean(), "usePreview", "false", 0, 1, FileWidget.class, //$NON-NLS-1$//$NON-NLS-2$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getFileWidget_Document(), theProcessPackage.getDocument(), null, "document", null, 0, 1, //$NON-NLS-1$
                FileWidget.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getFileWidget_InitialResourcePath(), ecorePackage.getEString(), "initialResourcePath", null, 0, 1, //$NON-NLS-1$
                FileWidget.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEAttribute(getFileWidget_OutputDocumentName(), ecorePackage.getEString(), "outputDocumentName", null, 0, 1, //$NON-NLS-1$
                FileWidget.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEAttribute(getFileWidget_UpdateDocument(), ecorePackage.getEBoolean(), "updateDocument", "true", 0, 1, //$NON-NLS-1$//$NON-NLS-2$
                FileWidget.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEAttribute(getFileWidget_IntialResourceList(), ecorePackage.getEString(), "intialResourceList", null, 0, -1, //$NON-NLS-1$
                FileWidget.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEAttribute(getFileWidget_InputType(), this.getFileWidgetInputType(), "inputType", "URL", 0, 1, FileWidget.class, //$NON-NLS-1$//$NON-NLS-2$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getFileWidget_OutputDocumentListExpression(), theExpressionPackage.getExpression(), null,
                "outputDocumentListExpression", null, 0, 1, FileWidget.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, //$NON-NLS-1$
                IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getFileWidget_DownloadType(), this.getFileWidgetDownloadType(), "downloadType", null, 0, 1, //$NON-NLS-1$
                FileWidget.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);

        initEClass(imageWidgetEClass, ImageWidget.class, "ImageWidget", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getImageWidget_IsADocument(), ecorePackage.getEBoolean(), "isADocument", "false", 0, 1, //$NON-NLS-1$//$NON-NLS-2$
                ImageWidget.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEReference(getImageWidget_Document(), theProcessPackage.getDocument(), null, "document", null, 0, 1, //$NON-NLS-1$
                ImageWidget.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getImageWidget_ImgPath(), theExpressionPackage.getExpression(), null, "imgPath", null, 0, 1, //$NON-NLS-1$
                ImageWidget.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(hiddenWidgetEClass, HiddenWidget.class, "HiddenWidget", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);

        initEClass(durationFormFieldEClass, DurationFormField.class, "DurationFormField", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getDurationFormField_Day(), ecorePackage.getEBooleanObject(), "day", "true", 1, 1, //$NON-NLS-1$//$NON-NLS-2$
                DurationFormField.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getDurationFormField_Hour(), ecorePackage.getEBooleanObject(), "hour", "true", 1, 1, //$NON-NLS-1$//$NON-NLS-2$
                DurationFormField.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getDurationFormField_Min(), ecorePackage.getEBooleanObject(), "min", "true", 1, 1, //$NON-NLS-1$//$NON-NLS-2$
                DurationFormField.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getDurationFormField_Sec(), ecorePackage.getEBooleanObject(), "sec", "true", 1, 1, //$NON-NLS-1$//$NON-NLS-2$
                DurationFormField.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);

        initEClass(abstractTableEClass, AbstractTable.class, "AbstractTable", IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getAbstractTable_LeftColumnIsHeader(), ecorePackage.getEBoolean(), "leftColumnIsHeader", null, 0, 1, //$NON-NLS-1$
                AbstractTable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getAbstractTable_RightColumnIsHeader(), ecorePackage.getEBoolean(), "rightColumnIsHeader", null, 0, 1, //$NON-NLS-1$
                AbstractTable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getAbstractTable_FirstRowIsHeader(), ecorePackage.getEBoolean(), "firstRowIsHeader", null, 0, 1, //$NON-NLS-1$
                AbstractTable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getAbstractTable_LastRowIsHeader(), ecorePackage.getEBoolean(), "LastRowIsHeader", null, 0, 1, //$NON-NLS-1$
                AbstractTable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getAbstractTable_InitializedUsingCells(), ecorePackage.getEBoolean(), "initializedUsingCells", null, //$NON-NLS-1$
                0, 1, AbstractTable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getAbstractTable_UseHorizontalHeader(), ecorePackage.getEBoolean(), "useHorizontalHeader", "false", 0, //$NON-NLS-1$//$NON-NLS-2$
                1, AbstractTable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getAbstractTable_UseVerticalHeader(), ecorePackage.getEBoolean(), "useVerticalHeader", "false", 0, 1, //$NON-NLS-1$//$NON-NLS-2$
                AbstractTable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEReference(getAbstractTable_HorizontalHeaderExpression(), theExpressionPackage.getExpression(), null,
                "horizontalHeaderExpression", null, 0, 1, AbstractTable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, //$NON-NLS-1$
                IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getAbstractTable_VerticalHeaderExpression(), theExpressionPackage.getExpression(), null,
                "verticalHeaderExpression", null, 0, 1, AbstractTable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, //$NON-NLS-1$
                IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getAbstractTable_TableExpression(), theExpressionPackage.getTableExpression(), null,
                "tableExpression", null, 0, 1, AbstractTable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, //$NON-NLS-1$
                !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(tableEClass, Table.class, "Table", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
        initEAttribute(getTable_UsePagination(), ecorePackage.getEBoolean(), "usePagination", "false", 0, 1, Table.class, //$NON-NLS-1$//$NON-NLS-2$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getTable_AllowSelection(), ecorePackage.getEBoolean(), "allowSelection", "false", 0, 1, Table.class, //$NON-NLS-1$//$NON-NLS-2$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getTable_SelectionModeIsMultiple(), ecorePackage.getEBoolean(), "selectionModeIsMultiple", "true", 0, //$NON-NLS-1$//$NON-NLS-2$
                1, Table.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEReference(getTable_MaxRowForPagination(), theExpressionPackage.getExpression(), null, "maxRowForPagination", //$NON-NLS-1$
                null, 0, 1, Table.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getTable_ColumnForInitialSelectionIndex(), theExpressionPackage.getExpression(), null,
                "columnForInitialSelectionIndex", null, 0, 1, Table.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, //$NON-NLS-1$
                IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getTable_SelectedValues(), theExpressionPackage.getExpression(), null, "selectedValues", null, 0, 1, //$NON-NLS-1$
                Table.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(dynamicTableEClass, DynamicTable.class, "DynamicTable", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getDynamicTable_LimitMinNumberOfColumn(), ecorePackage.getEBoolean(), "limitMinNumberOfColumn", //$NON-NLS-1$
                "false", 0, 1, DynamicTable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, //$NON-NLS-1$
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getDynamicTable_LimitMinNumberOfRow(), ecorePackage.getEBoolean(), "limitMinNumberOfRow", "false", 0, //$NON-NLS-1$//$NON-NLS-2$
                1, DynamicTable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getDynamicTable_AllowAddRemoveRow(), ecorePackage.getEBoolean(), "allowAddRemoveRow", "true", 0, 1, //$NON-NLS-1$//$NON-NLS-2$
                DynamicTable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getDynamicTable_AllowAddRemoveColumn(), ecorePackage.getEBoolean(), "allowAddRemoveColumn", "true", 0, //$NON-NLS-1$//$NON-NLS-2$
                1, DynamicTable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getDynamicTable_LimitMaxNumberOfColumn(), ecorePackage.getEBoolean(), "limitMaxNumberOfColumn", //$NON-NLS-1$
                "false", 0, 1, DynamicTable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, //$NON-NLS-1$
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getDynamicTable_LimitMaxNumberOfRow(), ecorePackage.getEBoolean(), "limitMaxNumberOfRow", "false", 0, //$NON-NLS-1$//$NON-NLS-2$
                1, DynamicTable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEReference(getDynamicTable_MinNumberOfColumn(), theExpressionPackage.getExpression(), null, "minNumberOfColumn", //$NON-NLS-1$
                null, 0, 1, DynamicTable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
                !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getDynamicTable_MinNumberOfRow(), theExpressionPackage.getExpression(), null, "minNumberOfRow", null, //$NON-NLS-1$
                0, 1, DynamicTable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getDynamicTable_MaxNumberOfColumn(), theExpressionPackage.getExpression(), null, "maxNumberOfColumn", //$NON-NLS-1$
                null, 0, 1, DynamicTable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
                !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getDynamicTable_MaxNumberOfRow(), theExpressionPackage.getExpression(), null, "maxNumberOfRow", null, //$NON-NLS-1$
                0, 1, DynamicTable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(iFrameWidgetEClass, IFrameWidget.class, "IFrameWidget", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);

        initEClass(mandatoryFieldsCustomizationEClass, MandatoryFieldsCustomization.class, "MandatoryFieldsCustomization", //$NON-NLS-1$
                IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getMandatoryFieldsCustomization_MandatorySymbol(), theExpressionPackage.getExpression(), null,
                "mandatorySymbol", null, 0, 1, MandatoryFieldsCustomization.class, !IS_TRANSIENT, !IS_VOLATILE, //$NON-NLS-1$
                IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getMandatoryFieldsCustomization_MandatoryLabel(), theExpressionPackage.getExpression(), null,
                "mandatoryLabel", null, 0, 1, MandatoryFieldsCustomization.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, //$NON-NLS-1$
                IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(htmlWidgetEClass, HtmlWidget.class, "HtmlWidget", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);

        initEClass(suggestBoxEClass, SuggestBox.class, "SuggestBox", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getSuggestBox_MaxItems(), ecorePackage.getEInt(), "maxItems", "-1", 1, 1, SuggestBox.class, //$NON-NLS-1$//$NON-NLS-2$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getSuggestBox_UseMaxItems(), ecorePackage.getEBoolean(), "useMaxItems", "false", 1, 1, //$NON-NLS-1$//$NON-NLS-2$
                SuggestBox.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEAttribute(getSuggestBox_Asynchronous(), ecorePackage.getEBoolean(), "asynchronous", "false", 1, 1, //$NON-NLS-1$//$NON-NLS-2$
                SuggestBox.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEAttribute(getSuggestBox_Delay(), ecorePackage.getEInt(), "delay", "1000", 0, 1, SuggestBox.class, !IS_TRANSIENT, //$NON-NLS-1$//$NON-NLS-2$
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(groupIteratorEClass, GroupIterator.class, "GroupIterator", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getGroupIterator_ClassName(), ecorePackage.getEString(), "className", null, 0, 1, GroupIterator.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
