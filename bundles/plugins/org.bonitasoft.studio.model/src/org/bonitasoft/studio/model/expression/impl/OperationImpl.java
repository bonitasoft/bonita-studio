...
public class OperationImpl extends EObjectImpl implements Operation {
    ...
    public NotificationChain basicSetLeftOperand(Expression newLeftOperand, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ExpressionPackage.OPERATION__LEFT_OPERAND, oldLeftOperand, newLeftOperand);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newLeftOperand != leftOperand) {
            ...
            if (leftOperand != null)
                msgs = ((InternalEObject) leftOperand).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ExpressionPackage.OPERATION__LEFT_OPERAND, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ExpressionPackage.OPERATION__LEFT_OPERAND, newLeftOperand,
                    newLeftOperand));
    }
    ...
    public NotificationChain basicSetRightOperand(Expression newRightOperand, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ExpressionPackage.OPERATION__RIGHT_OPERAND, oldRightOperand, newRightOperand);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newRightOperand != rightOperand) {
            ...
            if (rightOperand != null)
                msgs = ((InternalEObject) rightOperand).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ExpressionPackage.OPERATION__RIGHT_OPERAND, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ExpressionPackage.OPERATION__RIGHT_OPERAND,
    ...
    public NotificationChain basicSetOperator(Operator newOperator, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ExpressionPackage.OPERATION__OPERATOR, oldOperator, newOperator);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newOperator != operator) {
            ...
            if (operator != null)
                msgs = ((InternalEObject) operator).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ExpressionPackage.OPERATION__OPERATOR, null, msgs);
            if (newOperator != null)
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ExpressionPackage.OPERATION__OPERATOR, newOperator,
                    newOperator));
    }
