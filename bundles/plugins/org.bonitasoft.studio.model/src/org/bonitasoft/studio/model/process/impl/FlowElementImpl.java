 ...
 *   <li>{@link org.bonitasoft.studio.model.process.impl.FlowElementImpl#getRegExpToHideDefaultField <em>Reg Exp To Hide Default Field</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.FlowElementImpl#isUseRegExpToHideDefaultField <em>Use Reg Exp To Hide Default Field</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.FlowElementImpl#getViewPageFlowTransitions <em>View Page Flow Transitions</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.FlowElementImpl#getViewTransientData <em>View Transient Data</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.FlowElementImpl#getViewPageFlowConnectors <em>View Page Flow Connectors</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.FlowElementImpl#getViewPageFlowType <em>View Page Flow Type</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.FlowElementImpl#getViewForm <em>View Form</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.FlowElementImpl#getViewPageFlowRedirectionURL <em>View Page Flow Redirection URL</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.FlowElementImpl#getSimulationData <em>Simulation Data</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.FlowElementImpl#getResourcesUsages <em>Resources Usages</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.FlowElementImpl#getExecutionTime <em>Execution Time</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.FlowElementImpl#getEstimatedTime <em>Estimated Time</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.FlowElementImpl#getMaximumTime <em>Maximum Time</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.FlowElementImpl#isContigous <em>Contigous</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.FlowElementImpl#isExclusiveOutgoingTransition <em>Exclusive Outgoing Transition</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.FlowElementImpl#getLoopTransition <em>Loop Transition</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.FlowElementImpl#getDataChange <em>Data Change</em>}</li>
...
public class FlowElementImpl extends EObjectImpl implements FlowElement {
	...
	public void setRegExpToHideDefaultField(String newRegExpToHideDefaultField) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.FLOW_ELEMENT__REG_EXP_TO_HIDE_DEFAULT_FIELD, oldRegExpToHideDefaultField, regExpToHideDefaultField));
	}
	...
	public void setUseRegExpToHideDefaultField(boolean newUseRegExpToHideDefaultField) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.FLOW_ELEMENT__USE_REG_EXP_TO_HIDE_DEFAULT_FIELD, oldUseRegExpToHideDefaultField, useRegExpToHideDefaultField));
	}
	...
	public EList<PageFlowTransition> getViewPageFlowTransitions() {
		if (viewPageFlowTransitions == null) {
			viewPageFlowTransitions = new EObjectContainmentEList<PageFlowTransition>(PageFlowTransition.class, this, ProcessPackage.FLOW_ELEMENT__VIEW_PAGE_FLOW_TRANSITIONS);
		}
	...
	public EList<Data> getViewTransientData() {
		if (viewTransientData == null) {
			viewTransientData = new EObjectContainmentEList<Data>(Data.class, this, ProcessPackage.FLOW_ELEMENT__VIEW_TRANSIENT_DATA);
		}
	...
	public EList<Connector> getViewPageFlowConnectors() {
		if (viewPageFlowConnectors == null) {
			viewPageFlowConnectors = new EObjectContainmentEList<Connector>(Connector.class, this, ProcessPackage.FLOW_ELEMENT__VIEW_PAGE_FLOW_CONNECTORS);
		}
	...
	public void setViewPageFlowType(ConsultationPageFlowType newViewPageFlowType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.FLOW_ELEMENT__VIEW_PAGE_FLOW_TYPE, oldViewPageFlowType, viewPageFlowType));
	}
	...
	public EList<ViewForm> getViewForm() {
		if (viewForm == null) {
			viewForm = new EObjectContainmentEList<ViewForm>(ViewForm.class, this, ProcessPackage.FLOW_ELEMENT__VIEW_FORM);
		}
		return viewForm;
	}
	...
	public NotificationChain basicSetViewPageFlowRedirectionURL(Expression newViewPageFlowRedirectionURL, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.FLOW_ELEMENT__VIEW_PAGE_FLOW_REDIRECTION_URL, oldViewPageFlowRedirectionURL, newViewPageFlowRedirectionURL);
	...
	public void setViewPageFlowRedirectionURL(Expression newViewPageFlowRedirectionURL) {
		if (newViewPageFlowRedirectionURL != viewPageFlowRedirectionURL) {
			...
			if (viewPageFlowRedirectionURL != null)
				msgs = ((InternalEObject)viewPageFlowRedirectionURL).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.FLOW_ELEMENT__VIEW_PAGE_FLOW_REDIRECTION_URL, null, msgs);
			if (newViewPageFlowRedirectionURL != null)
				msgs = ((InternalEObject)newViewPageFlowRedirectionURL).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.FLOW_ELEMENT__VIEW_PAGE_FLOW_REDIRECTION_URL, null, msgs);
			msgs = basicSetViewPageFlowRedirectionURL(newViewPageFlowRedirectionURL, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.FLOW_ELEMENT__VIEW_PAGE_FLOW_REDIRECTION_URL, newViewPageFlowRedirectionURL, newViewPageFlowRedirectionURL));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case ProcessPackage.FLOW_ELEMENT__VIEW_PAGE_FLOW_TRANSITIONS:
				return ((InternalEList<?>)getViewPageFlowTransitions()).basicRemove(otherEnd, msgs);
			case ProcessPackage.FLOW_ELEMENT__VIEW_TRANSIENT_DATA:
				return ((InternalEList<?>)getViewTransientData()).basicRemove(otherEnd, msgs);
			case ProcessPackage.FLOW_ELEMENT__VIEW_PAGE_FLOW_CONNECTORS:
				return ((InternalEList<?>)getViewPageFlowConnectors()).basicRemove(otherEnd, msgs);
			case ProcessPackage.FLOW_ELEMENT__VIEW_FORM:
				return ((InternalEList<?>)getViewForm()).basicRemove(otherEnd, msgs);
			case ProcessPackage.FLOW_ELEMENT__VIEW_PAGE_FLOW_REDIRECTION_URL:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ProcessPackage.FLOW_ELEMENT__INCOMING:
				return getIncoming();
			case ProcessPackage.FLOW_ELEMENT__REG_EXP_TO_HIDE_DEFAULT_FIELD:
				return getRegExpToHideDefaultField();
			case ProcessPackage.FLOW_ELEMENT__USE_REG_EXP_TO_HIDE_DEFAULT_FIELD:
			...
			case ProcessPackage.FLOW_ELEMENT__VIEW_PAGE_FLOW_TYPE:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == AbstractPageFlow.class) {
			switch (derivedFeatureID) {
				case ProcessPackage.FLOW_ELEMENT__REG_EXP_TO_HIDE_DEFAULT_FIELD: return ProcessPackage.ABSTRACT_PAGE_FLOW__REG_EXP_TO_HIDE_DEFAULT_FIELD;
				case ProcessPackage.FLOW_ELEMENT__USE_REG_EXP_TO_HIDE_DEFAULT_FIELD: return ProcessPackage.ABSTRACT_PAGE_FLOW__USE_REG_EXP_TO_HIDE_DEFAULT_FIELD;
				default: return -1;
			}
		}
		if (baseClass == ViewPageFlow.class) {
			switch (derivedFeatureID) {
				case ProcessPackage.FLOW_ELEMENT__VIEW_PAGE_FLOW_TRANSITIONS: return ProcessPackage.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_TRANSITIONS;
				case ProcessPackage.FLOW_ELEMENT__VIEW_TRANSIENT_DATA: return ProcessPackage.VIEW_PAGE_FLOW__VIEW_TRANSIENT_DATA;
				case ProcessPackage.FLOW_ELEMENT__VIEW_PAGE_FLOW_CONNECTORS: return ProcessPackage.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_CONNECTORS;
				case ProcessPackage.FLOW_ELEMENT__VIEW_PAGE_FLOW_TYPE: return ProcessPackage.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_TYPE;
				case ProcessPackage.FLOW_ELEMENT__VIEW_FORM: return ProcessPackage.VIEW_PAGE_FLOW__VIEW_FORM;
				case ProcessPackage.FLOW_ELEMENT__VIEW_PAGE_FLOW_REDIRECTION_URL: return ProcessPackage.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_REDIRECTION_URL;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == AbstractPageFlow.class) {
			switch (baseFeatureID) {
				case ProcessPackage.ABSTRACT_PAGE_FLOW__REG_EXP_TO_HIDE_DEFAULT_FIELD: return ProcessPackage.FLOW_ELEMENT__REG_EXP_TO_HIDE_DEFAULT_FIELD;
				case ProcessPackage.ABSTRACT_PAGE_FLOW__USE_REG_EXP_TO_HIDE_DEFAULT_FIELD: return ProcessPackage.FLOW_ELEMENT__USE_REG_EXP_TO_HIDE_DEFAULT_FIELD;
				default: return -1;
			}
		}
		if (baseClass == ViewPageFlow.class) {
			switch (baseFeatureID) {
				case ProcessPackage.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_TRANSITIONS: return ProcessPackage.FLOW_ELEMENT__VIEW_PAGE_FLOW_TRANSITIONS;
				case ProcessPackage.VIEW_PAGE_FLOW__VIEW_TRANSIENT_DATA: return ProcessPackage.FLOW_ELEMENT__VIEW_TRANSIENT_DATA;
				case ProcessPackage.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_CONNECTORS: return ProcessPackage.FLOW_ELEMENT__VIEW_PAGE_FLOW_CONNECTORS;
				case ProcessPackage.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_TYPE: return ProcessPackage.FLOW_ELEMENT__VIEW_PAGE_FLOW_TYPE;
				case ProcessPackage.VIEW_PAGE_FLOW__VIEW_FORM: return ProcessPackage.FLOW_ELEMENT__VIEW_FORM;
				case ProcessPackage.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_REDIRECTION_URL: return ProcessPackage.FLOW_ELEMENT__VIEW_PAGE_FLOW_REDIRECTION_URL;
				default: return -1;
			}
		}
		if (baseClass == SimulationDataContainer.class) {
