 ...
 * <li>{@link org.bonitasoft.studio.model.expression.impl.ExpressionImpl#getReferencedElements <em>Referenced
 * Elements</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.expression.impl.ExpressionImpl#getConnectors <em>Connectors</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.expression.impl.ExpressionImpl#getPropagateVariableChange <em>Propagate Variable
 * Change</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.expression.impl.ExpressionImpl#isReturnTypeFixed <em>Return Type Fixed</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.expression.impl.ExpressionImpl#isAutomaticDependencies <em>Automatic
 * Dependencies</em>}</li>
...
public class ExpressionImpl extends AbstractExpressionImpl implements Expression {
    ...
    public void setContent(String newContent) {
        ...
        content = newContent;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ExpressionPackage.EXPRESSION__CONTENT, oldContent,
                    content));
    }
    ...
    public void setInterpreter(String newInterpreter) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ExpressionPackage.EXPRESSION__INTERPRETER, oldInterpreter,
                    interpreter));
    }
    ...
    public void setReturnType(String newReturnType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ExpressionPackage.EXPRESSION__RETURN_TYPE, oldReturnType,
                    returnType));
    }
    ...
    public EList<EObject> getReferencedElements() {
        if (referencedElements == null) {
            referencedElements = new EObjectContainmentEList<EObject>(EObject.class, this,
                    ExpressionPackage.EXPRESSION__REFERENCED_ELEMENTS);
        }
    ...
    public EList<Connector> getConnectors() {
        if (connectors == null) {
            connectors = new EObjectContainmentEList<Connector>(Connector.class, this,
                    ExpressionPackage.EXPRESSION__CONNECTORS);
        }
        return connectors;
    }
    ...
    public void setPropagateVariableChange(Boolean newPropagateVariableChange) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ExpressionPackage.EXPRESSION__PROPAGATE_VARIABLE_CHANGE,
                    oldPropagateVariableChange, propagateVariableChange));
    }
    ...
    public void setReturnTypeFixed(boolean newReturnTypeFixed) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ExpressionPackage.EXPRESSION__RETURN_TYPE_FIXED,
                    oldReturnTypeFixed, returnTypeFixed));
    }
    ...
    public void setAutomaticDependencies(boolean newAutomaticDependencies) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ExpressionPackage.EXPRESSION__AUTOMATIC_DEPENDENCIES,
                    oldAutomaticDependencies, automaticDependencies));
    }
    ...
    public void setHtmlAllowed(boolean newHtmlAllowed) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ExpressionPackage.EXPRESSION__HTML_ALLOWED, oldHtmlAllowed,
                    htmlAllowed));
    }
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            ...
            case ExpressionPackage.EXPRESSION__PROPAGATE_VARIABLE_CHANGE:
                return PROPAGATE_VARIABLE_CHANGE_EDEFAULT == null ? propagateVariableChange != null
                        : !PROPAGATE_VARIABLE_CHANGE_EDEFAULT.equals(propagateVariableChange);
            case ExpressionPackage.EXPRESSION__RETURN_TYPE_FIXED:
