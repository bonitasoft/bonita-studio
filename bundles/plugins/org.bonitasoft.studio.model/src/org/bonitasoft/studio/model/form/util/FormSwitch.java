    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            ...
            case FormPackage.FORM: {
                ...
                if (result == null)
                    result = caseConnectableElement(form);
                if (result == null)
                    result = caseValidable(form);
                if (result == null)
                    result = caseResourceContainer(form);
                if (result == null)
                    result = caseElement(form);
                if (result == null)
                    result = caseDataAware(form);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case FormPackage.VIEW_FORM: {
                ...
                if (result == null)
                    result = caseForm(viewForm);
                if (result == null)
                    result = caseConnectableElement(viewForm);
                if (result == null)
                    result = caseValidable(viewForm);
                if (result == null)
                    result = caseResourceContainer(viewForm);
                if (result == null)
                    result = caseElement(viewForm);
                if (result == null)
                    result = caseDataAware(viewForm);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case FormPackage.WIDGET: {
                ...
                if (result == null)
                    result = caseCSSCustomizable(widget);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case FormPackage.GROUP: {
                ...
                if (result == null)
                    result = caseWidget(group);
                if (result == null)
                    result = caseDuplicable(group);
                if (result == null)
                    result = caseElement(group);
                if (result == null)
                    result = caseCSSCustomizable(group);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case FormPackage.FORM_FIELD: {
                ...
                if (result == null)
                    result = caseWidget(formField);
                if (result == null)
                    result = caseValidable(formField);
                if (result == null)
                    result = caseDuplicable(formField);
                if (result == null)
                    result = caseElement(formField);
                if (result == null)
                    result = caseCSSCustomizable(formField);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case FormPackage.MULTIPLE_VALUATED_FORM_FIELD: {
                ...
                if (result == null)
                    result = caseFormField(multipleValuatedFormField);
                if (result == null)
                    result = caseWidget(multipleValuatedFormField);
                if (result == null)
                    result = caseValidable(multipleValuatedFormField);
                if (result == null)
                    result = caseDuplicable(multipleValuatedFormField);
                if (result == null)
                    result = caseElement(multipleValuatedFormField);
                if (result == null)
                    result = caseCSSCustomizable(multipleValuatedFormField);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case FormPackage.SINGLE_VALUATED_FORM_FIELD: {
                ...
                if (result == null)
                    result = caseFormField(singleValuatedFormField);
                if (result == null)
                    result = caseWidget(singleValuatedFormField);
                if (result == null)
                    result = caseValidable(singleValuatedFormField);
                if (result == null)
                    result = caseDuplicable(singleValuatedFormField);
                if (result == null)
                    result = caseElement(singleValuatedFormField);
                if (result == null)
                    result = caseCSSCustomizable(singleValuatedFormField);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case FormPackage.CHECK_BOX_MULTIPLE_FORM_FIELD: {
                ...
                if (result == null)
                    result = caseMultipleValuatedFormField(checkBoxMultipleFormField);
                if (result == null)
                    result = caseItemContainer(checkBoxMultipleFormField);
                if (result == null)
                    result = caseFormField(checkBoxMultipleFormField);
                if (result == null)
                    result = caseWidget(checkBoxMultipleFormField);
                if (result == null)
                    result = caseValidable(checkBoxMultipleFormField);
                if (result == null)
                    result = caseDuplicable(checkBoxMultipleFormField);
                if (result == null)
                    result = caseElement(checkBoxMultipleFormField);
                if (result == null)
                    result = caseCSSCustomizable(checkBoxMultipleFormField);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case FormPackage.COMBO_FORM_FIELD: {
                ...
                if (result == null)
                    result = caseMultipleValuatedFormField(comboFormField);
                if (result == null)
                    result = caseFormField(comboFormField);
                if (result == null)
                    result = caseWidget(comboFormField);
                if (result == null)
                    result = caseValidable(comboFormField);
                if (result == null)
                    result = caseDuplicable(comboFormField);
                if (result == null)
                    result = caseElement(comboFormField);
                if (result == null)
                    result = caseCSSCustomizable(comboFormField);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case FormPackage.DATE_FORM_FIELD: {
                ...
                if (result == null)
                    result = caseSingleValuatedFormField(dateFormField);
                if (result == null)
                    result = caseFormField(dateFormField);
                if (result == null)
                    result = caseWidget(dateFormField);
                if (result == null)
                    result = caseValidable(dateFormField);
                if (result == null)
                    result = caseDuplicable(dateFormField);
                if (result == null)
                    result = caseElement(dateFormField);
                if (result == null)
                    result = caseCSSCustomizable(dateFormField);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case FormPackage.LIST_FORM_FIELD: {
                ...
                if (result == null)
                    result = caseMultipleValuatedFormField(listFormField);
                if (result == null)
                    result = caseFormField(listFormField);
                if (result == null)
                    result = caseWidget(listFormField);
                if (result == null)
                    result = caseValidable(listFormField);
                if (result == null)
                    result = caseDuplicable(listFormField);
                if (result == null)
                    result = caseElement(listFormField);
                if (result == null)
                    result = caseCSSCustomizable(listFormField);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case FormPackage.PASSWORD_FORM_FIELD: {
                ...
                if (result == null)
                    result = caseSingleValuatedFormField(passwordFormField);
                if (result == null)
                    result = caseFormField(passwordFormField);
                if (result == null)
                    result = caseWidget(passwordFormField);
                if (result == null)
                    result = caseValidable(passwordFormField);
                if (result == null)
                    result = caseDuplicable(passwordFormField);
                if (result == null)
                    result = caseElement(passwordFormField);
                if (result == null)
                    result = caseCSSCustomizable(passwordFormField);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case FormPackage.RADIO_FORM_FIELD: {
                ...
                if (result == null)
                    result = caseMultipleValuatedFormField(radioFormField);
                if (result == null)
                    result = caseItemContainer(radioFormField);
                if (result == null)
                    result = caseFormField(radioFormField);
                if (result == null)
                    result = caseWidget(radioFormField);
                if (result == null)
                    result = caseValidable(radioFormField);
                if (result == null)
                    result = caseDuplicable(radioFormField);
                if (result == null)
                    result = caseElement(radioFormField);
                if (result == null)
                    result = caseCSSCustomizable(radioFormField);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case FormPackage.SELECT_FORM_FIELD: {
                ...
                if (result == null)
                    result = caseMultipleValuatedFormField(selectFormField);
                if (result == null)
                    result = caseFormField(selectFormField);
                if (result == null)
                    result = caseWidget(selectFormField);
                if (result == null)
                    result = caseValidable(selectFormField);
                if (result == null)
                    result = caseDuplicable(selectFormField);
                if (result == null)
                    result = caseElement(selectFormField);
                if (result == null)
                    result = caseCSSCustomizable(selectFormField);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case FormPackage.TEXT_FORM_FIELD: {
                ...
                if (result == null)
                    result = caseSingleValuatedFormField(textFormField);
                if (result == null)
                    result = caseFormField(textFormField);
                if (result == null)
                    result = caseWidget(textFormField);
                if (result == null)
                    result = caseValidable(textFormField);
                if (result == null)
                    result = caseDuplicable(textFormField);
                if (result == null)
                    result = caseElement(textFormField);
                if (result == null)
                    result = caseCSSCustomizable(textFormField);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case FormPackage.TEXT_AREA_FORM_FIELD: {
                ...
                if (result == null)
                    result = caseSingleValuatedFormField(textAreaFormField);
                if (result == null)
                    result = caseFormField(textAreaFormField);
                if (result == null)
                    result = caseWidget(textAreaFormField);
                if (result == null)
                    result = caseValidable(textAreaFormField);
                if (result == null)
                    result = caseDuplicable(textAreaFormField);
                if (result == null)
                    result = caseElement(textAreaFormField);
                if (result == null)
                    result = caseCSSCustomizable(textAreaFormField);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case FormPackage.RICH_TEXT_AREA_FORM_FIELD: {
                ...
                if (result == null)
                    result = caseSingleValuatedFormField(richTextAreaFormField);
                if (result == null)
                    result = caseFormField(richTextAreaFormField);
                if (result == null)
                    result = caseWidget(richTextAreaFormField);
                if (result == null)
                    result = caseValidable(richTextAreaFormField);
                if (result == null)
                    result = caseDuplicable(richTextAreaFormField);
                if (result == null)
                    result = caseElement(richTextAreaFormField);
                if (result == null)
                    result = caseCSSCustomizable(richTextAreaFormField);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case FormPackage.FORM_BUTTON: {
                ...
                if (result == null)
                    result = caseWidget(formButton);
                if (result == null)
                    result = caseElement(formButton);
                if (result == null)
                    result = caseCSSCustomizable(formButton);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case FormPackage.SUBMIT_FORM_BUTTON: {
                ...
                if (result == null)
                    result = caseFormButton(submitFormButton);
                if (result == null)
                    result = caseConnectableElement(submitFormButton);
                if (result == null)
                    result = caseWidget(submitFormButton);
                if (result == null)
                    result = caseDataAware(submitFormButton);
                if (result == null)
                    result = caseElement(submitFormButton);
                if (result == null)
                    result = caseCSSCustomizable(submitFormButton);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case FormPackage.PREVIOUS_FORM_BUTTON: {
                ...
                if (result == null)
                    result = caseFormButton(previousFormButton);
                if (result == null)
                    result = caseWidget(previousFormButton);
                if (result == null)
                    result = caseElement(previousFormButton);
                if (result == null)
                    result = caseCSSCustomizable(previousFormButton);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case FormPackage.NEXT_FORM_BUTTON: {
                ...
                if (result == null)
                    result = caseFormButton(nextFormButton);
                if (result == null)
                    result = caseWidget(nextFormButton);
                if (result == null)
                    result = caseElement(nextFormButton);
                if (result == null)
                    result = caseCSSCustomizable(nextFormButton);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case FormPackage.INFO: {
                ...
                if (result == null)
                    result = caseWidget(info);
                if (result == null)
                    result = caseElement(info);
                if (result == null)
                    result = caseCSSCustomizable(info);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case FormPackage.TEXT_INFO: {
                ...
                if (result == null)
                    result = caseInfo(textInfo);
                if (result == null)
                    result = caseDuplicable(textInfo);
                if (result == null)
                    result = caseWidget(textInfo);
                if (result == null)
                    result = caseElement(textInfo);
                if (result == null)
                    result = caseCSSCustomizable(textInfo);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case FormPackage.MESSAGE_INFO: {
                ...
                if (result == null)
                    result = caseInfo(messageInfo);
                if (result == null)
                    result = caseWidget(messageInfo);
                if (result == null)
                    result = caseElement(messageInfo);
                if (result == null)
                    result = caseCSSCustomizable(messageInfo);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case FormPackage.CHECK_BOX_SINGLE_FORM_FIELD: {
                ...
                if (result == null)
                    result = caseSingleValuatedFormField(checkBoxSingleFormField);
                if (result == null)
                    result = caseFormField(checkBoxSingleFormField);
                if (result == null)
                    result = caseWidget(checkBoxSingleFormField);
                if (result == null)
                    result = caseValidable(checkBoxSingleFormField);
                if (result == null)
                    result = caseDuplicable(checkBoxSingleFormField);
                if (result == null)
                    result = caseElement(checkBoxSingleFormField);
                if (result == null)
                    result = caseCSSCustomizable(checkBoxSingleFormField);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case FormPackage.FILE_WIDGET: {
                ...
                if (result == null)
                    result = caseSingleValuatedFormField(fileWidget);
                if (result == null)
                    result = caseFormField(fileWidget);
                if (result == null)
                    result = caseWidget(fileWidget);
                if (result == null)
                    result = caseValidable(fileWidget);
                if (result == null)
                    result = caseDuplicable(fileWidget);
                if (result == null)
                    result = caseElement(fileWidget);
                if (result == null)
                    result = caseCSSCustomizable(fileWidget);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case FormPackage.IMAGE_WIDGET: {
                ...
                if (result == null)
                    result = caseDuplicable(imageWidget);
                if (result == null)
                    result = caseElement(imageWidget);
                if (result == null)
                    result = caseCSSCustomizable(imageWidget);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case FormPackage.HIDDEN_WIDGET: {
                ...
                if (result == null)
                    result = caseSingleValuatedFormField(hiddenWidget);
                if (result == null)
                    result = caseFormField(hiddenWidget);
                if (result == null)
                    result = caseWidget(hiddenWidget);
                if (result == null)
                    result = caseValidable(hiddenWidget);
                if (result == null)
                    result = caseDuplicable(hiddenWidget);
                if (result == null)
                    result = caseElement(hiddenWidget);
                if (result == null)
                    result = caseCSSCustomizable(hiddenWidget);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case FormPackage.DURATION_FORM_FIELD: {
                ...
                if (result == null)
                    result = caseSingleValuatedFormField(durationFormField);
                if (result == null)
                    result = caseItemContainer(durationFormField);
                if (result == null)
                    result = caseFormField(durationFormField);
                if (result == null)
                    result = caseWidget(durationFormField);
                if (result == null)
                    result = caseValidable(durationFormField);
                if (result == null)
                    result = caseDuplicable(durationFormField);
                if (result == null)
                    result = caseElement(durationFormField);
                if (result == null)
                    result = caseCSSCustomizable(durationFormField);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case FormPackage.ABSTRACT_TABLE: {
                ...
                if (result == null)
                    result = caseWidget(abstractTable);
                if (result == null)
                    result = caseDuplicable(abstractTable);
                if (result == null)
                    result = caseElement(abstractTable);
                if (result == null)
                    result = caseCSSCustomizable(abstractTable);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case FormPackage.TABLE: {
                ...
                if (result == null)
                    result = caseAbstractTable(table);
                if (result == null)
                    result = caseMultipleValuatedFormField(table);
                if (result == null)
                    result = caseFormField(table);
                if (result == null)
                    result = caseWidget(table);
                if (result == null)
                    result = caseElement(table);
                if (result == null)
                    result = caseCSSCustomizable(table);
                if (result == null)
                    result = caseDuplicable(table);
                if (result == null)
                    result = caseValidable(table);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case FormPackage.DYNAMIC_TABLE: {
                ...
                if (result == null)
                    result = caseAbstractTable(dynamicTable);
                if (result == null)
                    result = caseSingleValuatedFormField(dynamicTable);
                if (result == null)
                    result = caseFormField(dynamicTable);
                if (result == null)
                    result = caseWidget(dynamicTable);
                if (result == null)
                    result = caseElement(dynamicTable);
                if (result == null)
                    result = caseCSSCustomizable(dynamicTable);
                if (result == null)
                    result = caseDuplicable(dynamicTable);
                if (result == null)
                    result = caseValidable(dynamicTable);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case FormPackage.IFRAME_WIDGET: {
                ...
                if (result == null)
                    result = caseInfo(iFrameWidget);
                if (result == null)
                    result = caseWidget(iFrameWidget);
                if (result == null)
                    result = caseElement(iFrameWidget);
                if (result == null)
                    result = caseCSSCustomizable(iFrameWidget);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case FormPackage.MANDATORY_FIELDS_CUSTOMIZATION: {
                ...
                if (result == null)
                    result = caseCSSCustomizable(mandatoryFieldsCustomization);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case FormPackage.HTML_WIDGET: {
                ...
                if (result == null)
                    result = caseInfo(htmlWidget);
                if (result == null)
                    result = caseWidget(htmlWidget);
                if (result == null)
                    result = caseElement(htmlWidget);
                if (result == null)
                    result = caseCSSCustomizable(htmlWidget);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case FormPackage.SUGGEST_BOX: {
                ...
                if (result == null)
                    result = caseMultipleValuatedFormField(suggestBox);
                if (result == null)
                    result = caseFormField(suggestBox);
                if (result == null)
                    result = caseWidget(suggestBox);
                if (result == null)
                    result = caseValidable(suggestBox);
                if (result == null)
                    result = caseDuplicable(suggestBox);
                if (result == null)
                    result = caseElement(suggestBox);
                if (result == null)
                    result = caseCSSCustomizable(suggestBox);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case FormPackage.GROUP_ITERATOR: {
                ...
                if (result == null)
                    result = caseElement(groupIterator);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
