...
public class ConfigurationAdapterFactory extends AdapterFactoryImpl {
    ...
    protected ConfigurationSwitch<Adapter> modelSwitch = new ConfigurationSwitch<Adapter>() {
        ...
        @Override
        public Adapter caseDefinitionMapping(DefinitionMapping object) {
            return createDefinitionMappingAdapter();
        }
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.bonitasoft.studio.model.configuration.Configuration
     * <em>Configuration</em>}'.
     * <!-- begin-user-doc -->
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.bonitasoft.studio.model.configuration.Fragment
     * <em>Fragment</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.bonitasoft.studio.model.configuration.DefinitionMapping
     * <em>Definition Mapping</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.bonitasoft.studio.model.configuration.FragmentContainer
