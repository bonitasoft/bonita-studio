...
public class ValidatorImpl extends EObjectImpl implements Validator {
    ...
    public void setValidatorClass(String newValidatorClass) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.VALIDATOR__VALIDATOR_CLASS, oldValidatorClass,
                    validatorClass));
    }
    ...
    public void setHtmlClass(String newHtmlClass) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.VALIDATOR__HTML_CLASS, oldHtmlClass,
                    htmlClass));
    }
    ...
    public void setBelowField(boolean newBelowField) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.VALIDATOR__BELOW_FIELD, oldBelowField,
                    belowField));
    }
    ...
    public NotificationChain basicSetParameter(Expression newParameter, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FormPackage.VALIDATOR__PARAMETER,
        ...
        if (newParameter != parameter) {
            ...
            if (parameter != null)
                msgs = ((InternalEObject) parameter).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.VALIDATOR__PARAMETER, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.VALIDATOR__PARAMETER, newParameter,
                    newParameter));
    }
    ...
    public NotificationChain basicSetDisplayName(Expression newDisplayName, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.VALIDATOR__DISPLAY_NAME, oldDisplayName, newDisplayName);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setDisplayName(Expression newDisplayName) {
        if (newDisplayName != displayName) {
            NotificationChain msgs = null;
            if (displayName != null)
                msgs = ((InternalEObject) displayName).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.VALIDATOR__DISPLAY_NAME, null, msgs);
            if (newDisplayName != null)
                msgs = ((InternalEObject) newDisplayName).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.VALIDATOR__DISPLAY_NAME, null, msgs);
            msgs = basicSetDisplayName(newDisplayName, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.VALIDATOR__DISPLAY_NAME, newDisplayName,
                    newDisplayName));
    }
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            case FormPackage.VALIDATOR__VALIDATOR_CLASS:
                return VALIDATOR_CLASS_EDEFAULT == null ? validatorClass != null
                        : !VALIDATOR_CLASS_EDEFAULT.equals(validatorClass);
            case FormPackage.VALIDATOR__HTML_CLASS:
