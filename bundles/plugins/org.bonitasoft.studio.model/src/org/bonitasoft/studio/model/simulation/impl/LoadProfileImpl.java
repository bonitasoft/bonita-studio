 ...
 * <li>{@link org.bonitasoft.studio.model.simulation.impl.LoadProfileImpl#getInjectionPeriods <em>Injection
 * Periods</em>}</li>
 * </ul>
 *
 * @generated
...
public class LoadProfileImpl extends SimulationElementImpl implements LoadProfile {
    ...
    public void setVersion(String newVersion) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SimulationPackage.LOAD_PROFILE__VERSION, oldVersion,
                    version));
    }
    ...
    public NotificationChain basicSetCalendar(SimulationCalendar newCalendar, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    SimulationPackage.LOAD_PROFILE__CALENDAR, oldCalendar, newCalendar);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newCalendar != calendar) {
            ...
            if (calendar != null)
                msgs = ((InternalEObject) calendar).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - SimulationPackage.LOAD_PROFILE__CALENDAR, null, msgs);
            if (newCalendar != null)
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, SimulationPackage.LOAD_PROFILE__CALENDAR, newCalendar,
                    newCalendar));
    }
    ...
    public EList<InjectionPeriod> getInjectionPeriods() {
        if (injectionPeriods == null) {
            injectionPeriods = new EObjectContainmentEList<InjectionPeriod>(InjectionPeriod.class, this,
                    SimulationPackage.LOAD_PROFILE__INJECTION_PERIODS);
        }
        ...
        if (baseClass == ModelVersion.class) {
            switch (baseFeatureID) {
                case SimulationPackage.MODEL_VERSION__VERSION:
                    return SimulationPackage.LOAD_PROFILE__VERSION;
                default:
                    return -1;
            }
        }
