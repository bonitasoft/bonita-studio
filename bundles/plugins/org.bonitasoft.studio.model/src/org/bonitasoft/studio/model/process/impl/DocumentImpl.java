 ...
 * <li>{@link org.bonitasoft.studio.model.process.impl.DocumentImpl#getTextAnnotationAttachment <em>Text Annotation
 * Attachment</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.process.impl.DocumentImpl#getDefaultValueIdOfDocumentStore <em>Default Value Id Of
 * Document Store</em>}</li>
 ...
 * <li>{@link org.bonitasoft.studio.model.process.impl.DocumentImpl#getInitialMultipleContent <em>Initial Multiple
 * Content</em>}</li>
...
public class DocumentImpl extends EObjectImpl implements Document {
    ...
    /**
     * The default value of the '{@link #getDefaultValueIdOfDocumentStore() <em>Default Value Id Of Document Store</em>}'
     * attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * The cached value of the '{@link #getDefaultValueIdOfDocumentStore() <em>Default Value Id Of Document Store</em>}'
     * attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * The cached value of the '{@link #getInitialMultipleContent() <em>Initial Multiple Content</em>}' containment
     * reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    public void setDocumentation(String newDocumentation) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.DOCUMENT__DOCUMENTATION, oldDocumentation,
                    documentation));
    }
    ...
    public EList<TextAnnotationAttachment> getTextAnnotationAttachment() {
        if (textAnnotationAttachment == null) {
            textAnnotationAttachment = new EObjectContainmentWithInverseEList<TextAnnotationAttachment>(
                    TextAnnotationAttachment.class, this, ProcessPackage.DOCUMENT__TEXT_ANNOTATION_ATTACHMENT,
    ...
    public void setDefaultValueIdOfDocumentStore(String newDefaultValueIdOfDocumentStore) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.DOCUMENT__DEFAULT_VALUE_ID_OF_DOCUMENT_STORE, oldDefaultValueIdOfDocumentStore,
                    defaultValueIdOfDocumentStore));
    }
    ...
    public NotificationChain basicSetMimeType(Expression newMimeType, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.DOCUMENT__MIME_TYPE, oldMimeType, newMimeType);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setMimeType(Expression newMimeType) {
        if (newMimeType != mimeType) {
            ...
            if (mimeType != null)
                msgs = ((InternalEObject) mimeType).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.DOCUMENT__MIME_TYPE, null, msgs);
            if (newMimeType != null)
                msgs = ((InternalEObject) newMimeType).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.DOCUMENT__MIME_TYPE, null, msgs);
            msgs = basicSetMimeType(newMimeType, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.DOCUMENT__MIME_TYPE, newMimeType,
                    newMimeType));
    }
    ...
    public NotificationChain basicSetUrl(Expression newUrl, NotificationChain msgs) {
        ...
        url = newUrl;
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.DOCUMENT__URL,
                    oldUrl, newUrl);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setUrl(Expression newUrl) {
        if (newUrl != url) {
            NotificationChain msgs = null;
            if (url != null)
                msgs = ((InternalEObject) url).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.DOCUMENT__URL,
                        null, msgs);
            if (newUrl != null)
                msgs = ((InternalEObject) newUrl).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.DOCUMENT__URL,
                        null, msgs);
    ...
    public void setDocumentType(DocumentType newDocumentType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.DOCUMENT__DOCUMENT_TYPE, oldDocumentType,
                    documentType));
    }
    ...
    public NotificationChain basicSetInitialMultipleContent(Expression newInitialMultipleContent, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.DOCUMENT__INITIAL_MULTIPLE_CONTENT, oldInitialMultipleContent, newInitialMultipleContent);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setInitialMultipleContent(Expression newInitialMultipleContent) {
        if (newInitialMultipleContent != initialMultipleContent) {
            ...
            if (initialMultipleContent != null)
                msgs = ((InternalEObject) initialMultipleContent).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.DOCUMENT__INITIAL_MULTIPLE_CONTENT, null, msgs);
            if (newInitialMultipleContent != null)
                msgs = ((InternalEObject) newInitialMultipleContent).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.DOCUMENT__INITIAL_MULTIPLE_CONTENT, null, msgs);
            msgs = basicSetInitialMultipleContent(newInitialMultipleContent, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.DOCUMENT__INITIAL_MULTIPLE_CONTENT,
                    newInitialMultipleContent, newInitialMultipleContent));
    }
    ...
    public ContractInput getContractInput() {
        if (contractInput != null && contractInput.eIsProxy()) {
            ...
            if (contractInput != oldContractInput) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, ProcessPackage.DOCUMENT__CONTRACT_INPUT,
                            oldContractInput, contractInput));
            }
        }
    ...
    public void setContractInput(ContractInput newContractInput) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.DOCUMENT__CONTRACT_INPUT, oldContractInput,
                    contractInput));
    }
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            ...
            case ProcessPackage.DOCUMENT__DEFAULT_VALUE_ID_OF_DOCUMENT_STORE:
                return DEFAULT_VALUE_ID_OF_DOCUMENT_STORE_EDEFAULT == null ? defaultValueIdOfDocumentStore != null
                        : !DEFAULT_VALUE_ID_OF_DOCUMENT_STORE_EDEFAULT.equals(defaultValueIdOfDocumentStore);
            case ProcessPackage.DOCUMENT__MIME_TYPE:
