 ...
 * <li>{@link org.bonitasoft.studio.model.connectorconfiguration.impl.ConnectorParameterImpl#getExpression
 * <em>Expression</em>}</li>
 * </ul>
 *
 * @generated
...
public class ConnectorParameterImpl extends EObjectImpl implements ConnectorParameter {
    ...
    public void setKey(String newKey) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConnectorConfigurationPackage.CONNECTOR_PARAMETER__KEY,
                    oldKey, key));
    }
    ...
    public NotificationChain basicSetExpression(AbstractExpression newExpression, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ConnectorConfigurationPackage.CONNECTOR_PARAMETER__EXPRESSION, oldExpression, newExpression);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newExpression != expression) {
            ...
            if (expression != null)
                msgs = ((InternalEObject) expression).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ConnectorConfigurationPackage.CONNECTOR_PARAMETER__EXPRESSION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ConnectorConfigurationPackage.CONNECTOR_PARAMETER__EXPRESSION, newExpression, newExpression));
    }
