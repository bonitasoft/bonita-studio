...
public class DateFormFieldImpl extends SingleValuatedFormFieldImpl implements DateFormField {
    ...
    public void setInitialFormat(String newInitialFormat) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DATE_FORM_FIELD__INITIAL_FORMAT,
                    oldInitialFormat, initialFormat));
    }
    ...
    public void setDisplayFormat(String newDisplayFormat) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DATE_FORM_FIELD__DISPLAY_FORMAT,
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            case FormPackage.DATE_FORM_FIELD__INITIAL_FORMAT:
                return INITIAL_FORMAT_EDEFAULT == null ? initialFormat != null
                        : !INITIAL_FORMAT_EDEFAULT.equals(initialFormat);
            case FormPackage.DATE_FORM_FIELD__DISPLAY_FORMAT:
