...
public class ActorMappingFactoryImpl extends EFactoryImpl implements ActorMappingFactory {
    ...
    public static ActorMappingFactory init() {
        try {
            ActorMappingFactory theActorMappingFactory = (ActorMappingFactory) EPackage.Registry.INSTANCE
                    .getEFactory(ActorMappingPackage.eNS_URI);
    ...
    public EObject create(EClass eClass) {
        switch (eClass.getClassifierID()) {
            case ActorMappingPackage.ACTOR_MAPPING:
                return createActorMapping();
            case ActorMappingPackage.ACTOR_MAPPINGS_TYPE:
                return createActorMappingsType();
