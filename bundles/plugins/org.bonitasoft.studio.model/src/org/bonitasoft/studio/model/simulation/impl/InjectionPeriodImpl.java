...
public class InjectionPeriodImpl extends EObjectImpl implements InjectionPeriod {
    ...
    public void setBegin(long newBegin) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SimulationPackage.INJECTION_PERIOD__BEGIN, oldBegin,
                    begin));
    }
    ...
    public void setNbInstances(int newNbInstances) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SimulationPackage.INJECTION_PERIOD__NB_INSTANCES,
    ...
    public void setRepartition(RepartitionType newRepartition) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SimulationPackage.INJECTION_PERIOD__REPARTITION,
                    oldRepartition, repartition));
    }
