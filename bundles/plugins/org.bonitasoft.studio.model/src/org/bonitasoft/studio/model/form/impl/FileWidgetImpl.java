 ...
 * <li>{@link org.bonitasoft.studio.model.form.impl.FileWidgetImpl#getInitialResourcePath <em>Initial Resource
 * Path</em>}</li>
 ...
 * <li>{@link org.bonitasoft.studio.model.form.impl.FileWidgetImpl#getOutputDocumentListExpression <em>Output Document List
 * Expression</em>}</li>
...
public class FileWidgetImpl extends SingleValuatedFormFieldImpl implements FileWidget {
    ...
    /**
     * The cached value of the '{@link #getOutputDocumentListExpression() <em>Output Document List Expression</em>}'
    ...
    public void setDownloadOnly(boolean newDownloadOnly) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FILE_WIDGET__DOWNLOAD_ONLY, oldDownloadOnly,
                    downloadOnly));
    }
    ...
    public void setUsePreview(boolean newUsePreview) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FILE_WIDGET__USE_PREVIEW, oldUsePreview,
                    usePreview));
    }
    ...
    public Document getDocument() {
        if (document != null && document.eIsProxy()) {
            ...
            if (document != oldDocument) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, FormPackage.FILE_WIDGET__DOCUMENT, oldDocument,
                            document));
            }
        }
        return document;
    ...
    public void setInitialResourcePath(String newInitialResourcePath) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FILE_WIDGET__INITIAL_RESOURCE_PATH,
                    oldInitialResourcePath, initialResourcePath));
    }
    ...
    public void setOutputDocumentName(String newOutputDocumentName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FILE_WIDGET__OUTPUT_DOCUMENT_NAME,
                    oldOutputDocumentName, outputDocumentName));
    }
    ...
    public void setUpdateDocument(boolean newUpdateDocument) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FILE_WIDGET__UPDATE_DOCUMENT,
                    oldUpdateDocument, updateDocument));
    }
    ...
    public EList<String> getIntialResourceList() {
        if (intialResourceList == null) {
            intialResourceList = new EDataTypeUniqueEList<String>(String.class, this,
                    FormPackage.FILE_WIDGET__INTIAL_RESOURCE_LIST);
        }
    ...
    public void setInputType(FileWidgetInputType newInputType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FILE_WIDGET__INPUT_TYPE, oldInputType,
                    inputType));
    }
     ...
     * @generated
     */
    public NotificationChain basicSetOutputDocumentListExpression(Expression newOutputDocumentListExpression,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.FILE_WIDGET__OUTPUT_DOCUMENT_LIST_EXPRESSION, oldOutputDocumentListExpression,
                    newOutputDocumentListExpression);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setOutputDocumentListExpression(Expression newOutputDocumentListExpression) {
        if (newOutputDocumentListExpression != outputDocumentListExpression) {
            ...
            if (outputDocumentListExpression != null)
                msgs = ((InternalEObject) outputDocumentListExpression).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.FILE_WIDGET__OUTPUT_DOCUMENT_LIST_EXPRESSION, null, msgs);
            if (newOutputDocumentListExpression != null)
                msgs = ((InternalEObject) newOutputDocumentListExpression).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.FILE_WIDGET__OUTPUT_DOCUMENT_LIST_EXPRESSION, null, msgs);
            msgs = basicSetOutputDocumentListExpression(newOutputDocumentListExpression, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FILE_WIDGET__OUTPUT_DOCUMENT_LIST_EXPRESSION,
                    newOutputDocumentListExpression, newOutputDocumentListExpression));
    }
    ...
    public void setDownloadType(FileWidgetDownloadType newDownloadType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FILE_WIDGET__DOWNLOAD_TYPE, oldDownloadType,
                    downloadType));
    }
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            ...
            case FormPackage.FILE_WIDGET__INITIAL_RESOURCE_PATH:
                return INITIAL_RESOURCE_PATH_EDEFAULT == null ? initialResourcePath != null
                        : !INITIAL_RESOURCE_PATH_EDEFAULT.equals(initialResourcePath);
            case FormPackage.FILE_WIDGET__OUTPUT_DOCUMENT_NAME:
                return OUTPUT_DOCUMENT_NAME_EDEFAULT == null ? outputDocumentName != null
                        : !OUTPUT_DOCUMENT_NAME_EDEFAULT.equals(outputDocumentName);
            case FormPackage.FILE_WIDGET__UPDATE_DOCUMENT:
