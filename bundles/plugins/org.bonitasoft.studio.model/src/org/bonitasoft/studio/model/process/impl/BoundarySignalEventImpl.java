...
public class BoundarySignalEventImpl extends BoundaryEventImpl implements BoundarySignalEvent {
    ...
    public void setSignalCode(String newSignalCode) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.BOUNDARY_SIGNAL_EVENT__SIGNAL_CODE,
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        if (baseClass == SignalEvent.class) {
            switch (derivedFeatureID) {
                case ProcessPackage.BOUNDARY_SIGNAL_EVENT__SIGNAL_CODE:
                    return ProcessPackage.SIGNAL_EVENT__SIGNAL_CODE;
                default:
                    return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == SignalEvent.class) {
            switch (baseFeatureID) {
                case ProcessPackage.SIGNAL_EVENT__SIGNAL_CODE:
                    return ProcessPackage.BOUNDARY_SIGNAL_EVENT__SIGNAL_CODE;
                default:
                    return -1;
            }
        }
