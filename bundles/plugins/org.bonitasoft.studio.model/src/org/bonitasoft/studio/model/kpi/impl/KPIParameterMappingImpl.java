...
public class KPIParameterMappingImpl extends EObjectImpl implements KPIParameterMapping {
    ...
    public void setKpiFieldName(String newKpiFieldName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, KpiPackage.KPI_PARAMETER_MAPPING__KPI_FIELD_NAME,
                    oldKpiFieldName, kpiFieldName));
    }
    ...
    public NotificationChain basicSetValue(Expression newValue, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    KpiPackage.KPI_PARAMETER_MAPPING__VALUE, oldValue, newValue);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newValue != value) {
            ...
            if (value != null)
                msgs = ((InternalEObject) value).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - KpiPackage.KPI_PARAMETER_MAPPING__VALUE, null, msgs);
            if (newValue != null)
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, KpiPackage.KPI_PARAMETER_MAPPING__VALUE, newValue,
                    newValue));
    }
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            case KpiPackage.KPI_PARAMETER_MAPPING__KPI_FIELD_NAME:
                return KPI_FIELD_NAME_EDEFAULT == null ? kpiFieldName != null
                        : !KPI_FIELD_NAME_EDEFAULT.equals(kpiFieldName);
            case KpiPackage.KPI_PARAMETER_MAPPING__VALUE:
                return value != null;
        }
