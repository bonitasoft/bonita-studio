...
public class ResourceImpl extends SimulationElementImpl implements Resource {
    ...
    public void setQuantity(int newQuantity) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SimulationPackage.RESOURCE__QUANTITY, oldQuantity,
                    quantity));
    }
    ...
    public void setMaximumQuantity(int newMaximumQuantity) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SimulationPackage.RESOURCE__MAXIMUM_QUANTITY,
                    oldMaximumQuantity, maximumQuantity));
    }
    ...
    public void setCostUnit(String newCostUnit) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SimulationPackage.RESOURCE__COST_UNIT, oldCostUnit,
                    costUnit));
    }
    ...
    public void setTimeUnit(TimeUnit newTimeUnit) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SimulationPackage.RESOURCE__TIME_UNIT, oldTimeUnit,
                    timeUnit));
    }
    ...
    public void setFixedCost(double newFixedCost) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SimulationPackage.RESOURCE__FIXED_COST, oldFixedCost,
                    fixedCost));
    }
    ...
    public void setTimeCost(double newTimeCost) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SimulationPackage.RESOURCE__TIME_COST, oldTimeCost,
                    timeCost));
    }
    ...
    public NotificationChain basicSetCalendar(SimulationCalendar newCalendar, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    SimulationPackage.RESOURCE__CALENDAR, oldCalendar, newCalendar);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newCalendar != calendar) {
            ...
            if (calendar != null)
                msgs = ((InternalEObject) calendar).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - SimulationPackage.RESOURCE__CALENDAR, null, msgs);
            if (newCalendar != null)
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, SimulationPackage.RESOURCE__CALENDAR, newCalendar,
                    newCalendar));
    }
    ...
    public void setUnlimited(boolean newUnlimited) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SimulationPackage.RESOURCE__UNLIMITED, oldUnlimited,
                    unlimited));
    }
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        if (baseClass == ModelVersion.class) {
            switch (derivedFeatureID) {
                case SimulationPackage.RESOURCE__VERSION:
                    return SimulationPackage.MODEL_VERSION__VERSION;
                default:
                    return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == ModelVersion.class) {
            switch (baseFeatureID) {
                case SimulationPackage.MODEL_VERSION__VERSION:
                    return SimulationPackage.RESOURCE__VERSION;
                default:
                    return -1;
            }
        }
