    ...
    public EList<Expression> getConditions() {
        if (conditions == null) {
            conditions = new EObjectContainmentEList<Expression>(Expression.class, this,
                    DecisionPackage.DECISION_TABLE_LINE__CONDITIONS);
        }
        return conditions;
    }
    ...
    public NotificationChain basicSetAction(DecisionTableAction newAction, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    DecisionPackage.DECISION_TABLE_LINE__ACTION, oldAction, newAction);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newAction != action) {
            ...
            if (action != null)
                msgs = ((InternalEObject) action).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - DecisionPackage.DECISION_TABLE_LINE__ACTION, null, msgs);
            if (newAction != null)
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, DecisionPackage.DECISION_TABLE_LINE__ACTION, newAction,
                    newAction));
    }
