 ...
 * <li>{@link org.bonitasoft.studio.model.process.impl.DataImpl#getTextAnnotationAttachment <em>Text Annotation
 * Attachment</em>}</li>
...
public class DataImpl extends EObjectImpl implements Data {
    ...
    public void setDocumentation(String newDocumentation) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.DATA__DOCUMENTATION, oldDocumentation,
                    documentation));
    }
    ...
    public EList<TextAnnotationAttachment> getTextAnnotationAttachment() {
        if (textAnnotationAttachment == null) {
            textAnnotationAttachment = new EObjectContainmentWithInverseEList<TextAnnotationAttachment>(
                    TextAnnotationAttachment.class, this, ProcessPackage.DATA__TEXT_ANNOTATION_ATTACHMENT,
    ...
    public void setDatasourceId(String newDatasourceId) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.DATA__DATASOURCE_ID, oldDatasourceId,
                    datasourceId));
    }
    ...
    public DataType getDataType() {
        if (dataType != null && dataType.eIsProxy()) {
            ...
            if (dataType != oldDataType) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, ProcessPackage.DATA__DATA_TYPE, oldDataType,
                            dataType));
            }
        }
        return dataType;
    ...
    public NotificationChain basicSetDefaultValue(Expression newDefaultValue, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.DATA__DEFAULT_VALUE, oldDefaultValue, newDefaultValue);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newDefaultValue != defaultValue) {
            ...
            if (defaultValue != null)
                msgs = ((InternalEObject) defaultValue).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.DATA__DEFAULT_VALUE, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.DATA__DEFAULT_VALUE, newDefaultValue,
                    newDefaultValue));
    }
