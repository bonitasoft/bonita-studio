 ...
 * </p>
 * <ul>
 * <li>{@link org.bonitasoft.studio.model.form.impl.WidgetDependencyImpl#isTriggerRefreshOnModification <em>Trigger Refresh
 * On Modification</em>}</li>
...
public class WidgetDependencyImpl extends EObjectImpl implements WidgetDependency {
    ...
    /**
     * The default value of the '{@link #isTriggerRefreshOnModification() <em>Trigger Refresh On Modification</em>}'
     * attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * The cached value of the '{@link #isTriggerRefreshOnModification() <em>Trigger Refresh On Modification</em>}'
     * attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    public void setTriggerRefreshOnModification(boolean newTriggerRefreshOnModification) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    FormPackage.WIDGET_DEPENDENCY__TRIGGER_REFRESH_ON_MODIFICATION, oldTriggerRefreshOnModification,
    ...
    public EList<EventDependencyType> getEventTypes() {
        if (eventTypes == null) {
            eventTypes = new EDataTypeUniqueEList<EventDependencyType>(EventDependencyType.class, this,
                    FormPackage.WIDGET_DEPENDENCY__EVENT_TYPES);
        }
        return eventTypes;
    }
    ...
    public Widget getWidget() {
        if (widget != null && widget.eIsProxy()) {
            ...
            if (widget != oldWidget) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, FormPackage.WIDGET_DEPENDENCY__WIDGET,
                            oldWidget, widget));
            }
        }
        return widget;
