 ...
 * <li>{@link org.bonitasoft.studio.model.process.impl.ThrowMessageEventImpl#getOutgoingMessages <em>Outgoing
 * Messages</em>}</li>
 * </ul>
 *
 * @generated
...
public class ThrowMessageEventImpl extends MessageEventImpl implements ThrowMessageEvent {
    ...
    public EList<Message> getEvents() {
        if (events == null) {
            events = new EObjectContainmentWithInverseEList<Message>(Message.class, this,
                    ProcessPackage.THROW_MESSAGE_EVENT__EVENTS, ProcessPackage.MESSAGE__SOURCE);
        }
        return events;
    }
    ...
    public EList<MessageFlow> getOutgoingMessages() {
        if (outgoingMessages == null) {
            outgoingMessages = new EObjectWithInverseResolvingEList<MessageFlow>(MessageFlow.class, this,
                    ProcessPackage.THROW_MESSAGE_EVENT__OUTGOING_MESSAGES, ProcessPackage.MESSAGE_FLOW__SOURCE);
        }
