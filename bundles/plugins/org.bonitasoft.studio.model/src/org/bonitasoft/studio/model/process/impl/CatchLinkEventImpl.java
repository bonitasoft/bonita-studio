...
public class CatchLinkEventImpl extends LinkEventImpl implements CatchLinkEvent {
    ...
    public EList<ThrowLinkEvent> getFrom() {
        if (from == null) {
            from = new EObjectWithInverseResolvingEList<ThrowLinkEvent>(ThrowLinkEvent.class, this,
                    ProcessPackage.CATCH_LINK_EVENT__FROM, ProcessPackage.THROW_LINK_EVENT__TO);
        }
        return from;
    }
