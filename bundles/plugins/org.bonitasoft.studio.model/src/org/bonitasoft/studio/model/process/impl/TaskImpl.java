 ...
 * </p>
 * <ul>
 * <li>{@link org.bonitasoft.studio.model.process.impl.TaskImpl#getByPassFormsGeneration <em>By Pass Forms
 * Generation</em>}</li>
 ...
 * <li>{@link org.bonitasoft.studio.model.process.impl.TaskImpl#isTransmitURLAsParameter <em>Transmit URL As
 * Parameter</em>}</li>
 ...
 * <li>{@link org.bonitasoft.studio.model.process.impl.TaskImpl#getEntryRedirectionActions <em>Entry Redirection
 * Actions</em>}</li>
 ...
 * <li>{@link org.bonitasoft.studio.model.process.impl.TaskImpl#isOverrideActorsOfTheLane <em>Override Actors Of The
 * Lane</em>}</li>
...
public class TaskImpl extends ActivityImpl implements Task {
    ...
    public void setByPassFormsGeneration(Boolean newByPassFormsGeneration) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.TASK__BY_PASS_FORMS_GENERATION,
    ...
    public NotificationChain basicSetConfirmationTemplate(AssociatedFile newConfirmationTemplate, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.TASK__CONFIRMATION_TEMPLATE, oldConfirmationTemplate, newConfirmationTemplate);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newConfirmationTemplate != confirmationTemplate) {
            ...
            if (confirmationTemplate != null)
                msgs = ((InternalEObject) confirmationTemplate).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.TASK__CONFIRMATION_TEMPLATE, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.TASK__CONFIRMATION_TEMPLATE,
    ...
    public EList<Connector> getPageFlowConnectors() {
        if (pageFlowConnectors == null) {
            pageFlowConnectors = new EObjectContainmentEList<Connector>(Connector.class, this,
                    ProcessPackage.TASK__PAGE_FLOW_CONNECTORS);
        }
    ...
    public void setEntryPageFlowType(EntryPageFlowType newEntryPageFlowType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.TASK__ENTRY_PAGE_FLOW_TYPE,
    ...
    public void setTransmitURLAsParameter(boolean newTransmitURLAsParameter) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.TASK__TRANSMIT_URL_AS_PARAMETER,
    ...
    public EList<PageFlowTransition> getPageFlowTransitions() {
        if (pageFlowTransitions == null) {
            pageFlowTransitions = new EObjectContainmentEList<PageFlowTransition>(PageFlowTransition.class, this,
                    ProcessPackage.TASK__PAGE_FLOW_TRANSITIONS);
        }
    ...
    public NotificationChain basicSetEntryRedirectionURL(Expression newEntryRedirectionURL, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.TASK__ENTRY_REDIRECTION_URL, oldEntryRedirectionURL, newEntryRedirectionURL);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newEntryRedirectionURL != entryRedirectionURL) {
            ...
            if (entryRedirectionURL != null)
                msgs = ((InternalEObject) entryRedirectionURL).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.TASK__ENTRY_REDIRECTION_URL, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.TASK__ENTRY_REDIRECTION_URL,
    ...
    public NotificationChain basicSetConfirmationMessage(Expression newConfirmationMessage, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.TASK__CONFIRMATION_MESSAGE, oldConfirmationMessage, newConfirmationMessage);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newConfirmationMessage != confirmationMessage) {
            ...
            if (confirmationMessage != null)
                msgs = ((InternalEObject) confirmationMessage).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.TASK__CONFIRMATION_MESSAGE, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.TASK__CONFIRMATION_MESSAGE,
    ...
    public EList<Operation> getEntryRedirectionActions() {
        if (entryRedirectionActions == null) {
            entryRedirectionActions = new EObjectContainmentEList<Operation>(Operation.class, this,
                    ProcessPackage.TASK__ENTRY_REDIRECTION_ACTIONS);
        }
    ...
    public NotificationChain basicSetFormMapping(FormMapping newFormMapping, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.TASK__FORM_MAPPING,
                    oldFormMapping, newFormMapping);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newFormMapping != formMapping) {
            ...
            if (formMapping != null)
                msgs = ((InternalEObject) formMapping).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.TASK__FORM_MAPPING, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.TASK__FORM_MAPPING, newFormMapping,
                    newFormMapping));
    }
    ...
    public NotificationChain basicSetHtmlTemplate(AssociatedFile newHtmlTemplate, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.TASK__HTML_TEMPLATE, oldHtmlTemplate, newHtmlTemplate);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newHtmlTemplate != htmlTemplate) {
            ...
            if (htmlTemplate != null)
                msgs = ((InternalEObject) htmlTemplate).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.TASK__HTML_TEMPLATE, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.TASK__HTML_TEMPLATE, newHtmlTemplate,
                    newHtmlTemplate));
    }
    ...
    public EList<String> getResourceValidators() {
        if (resourceValidators == null) {
            resourceValidators = new EDataTypeUniqueEList<String>(String.class, this,
                    ProcessPackage.TASK__RESOURCE_VALIDATORS);
        }
    ...
    public EList<ResourceFile> getResourceFiles() {
        if (resourceFiles == null) {
            resourceFiles = new EObjectContainmentEList<ResourceFile>(ResourceFile.class, this,
                    ProcessPackage.TASK__RESOURCE_FILES);
        }
    ...
    public EList<ResourceFolder> getResourceFolders() {
        if (resourceFolders == null) {
            resourceFolders = new EObjectContainmentEList<ResourceFolder>(ResourceFolder.class, this,
                    ProcessPackage.TASK__RESOURCE_FOLDERS);
        }
    ...
    public NotificationChain basicSetContract(Contract newContract, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.TASK__CONTRACT,
        ...
        if (newContract != contract) {
            ...
            if (contract != null)
                msgs = ((InternalEObject) contract).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.TASK__CONTRACT, null, msgs);
            if (newContract != null)
    ...
    public void setOverrideActorsOfTheLane(boolean newOverrideActorsOfTheLane) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.TASK__OVERRIDE_ACTORS_OF_THE_LANE,
                    oldOverrideActorsOfTheLane, overrideActorsOfTheLane));
    }
    ...
    public NotificationChain basicSetExpectedDuration(Expression newExpectedDuration, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.TASK__EXPECTED_DURATION, oldExpectedDuration, newExpectedDuration);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setExpectedDuration(Expression newExpectedDuration) {
        if (newExpectedDuration != expectedDuration) {
            ...
            if (expectedDuration != null)
                msgs = ((InternalEObject) expectedDuration).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.TASK__EXPECTED_DURATION, null, msgs);
            if (newExpectedDuration != null)
                msgs = ((InternalEObject) newExpectedDuration).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.TASK__EXPECTED_DURATION, null, msgs);
            msgs = basicSetExpectedDuration(newExpectedDuration, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.TASK__EXPECTED_DURATION,
                    newExpectedDuration, newExpectedDuration));
    }
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == Assignable.class) {
            switch (derivedFeatureID) {
                case ProcessPackage.TASK__ACTOR:
                    return ProcessPackage.ASSIGNABLE__ACTOR;
                case ProcessPackage.TASK__FILTERS:
                    return ProcessPackage.ASSIGNABLE__FILTERS;
                default:
                    return -1;
            }
        }
        if (baseClass == ContractContainer.class) {
            switch (derivedFeatureID) {
                case ProcessPackage.TASK__CONTRACT:
                    return ProcessPackage.CONTRACT_CONTAINER__CONTRACT;
                default:
                    return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == PageFlow.class) {
            switch (baseFeatureID) {
                case ProcessPackage.PAGE_FLOW__BY_PASS_FORMS_GENERATION:
                    return ProcessPackage.TASK__BY_PASS_FORMS_GENERATION;
                case ProcessPackage.PAGE_FLOW__CONFIRMATION_TEMPLATE:
                    return ProcessPackage.TASK__CONFIRMATION_TEMPLATE;
                case ProcessPackage.PAGE_FLOW__TRANSIENT_DATA:
                    return ProcessPackage.TASK__TRANSIENT_DATA;
                case ProcessPackage.PAGE_FLOW__PAGE_FLOW_CONNECTORS:
                    return ProcessPackage.TASK__PAGE_FLOW_CONNECTORS;
                case ProcessPackage.PAGE_FLOW__ENTRY_PAGE_FLOW_TYPE:
                    return ProcessPackage.TASK__ENTRY_PAGE_FLOW_TYPE;
                case ProcessPackage.PAGE_FLOW__TRANSMIT_URL_AS_PARAMETER:
                    return ProcessPackage.TASK__TRANSMIT_URL_AS_PARAMETER;
                case ProcessPackage.PAGE_FLOW__PAGE_FLOW_TRANSITIONS:
                    return ProcessPackage.TASK__PAGE_FLOW_TRANSITIONS;
                case ProcessPackage.PAGE_FLOW__FORM:
                    return ProcessPackage.TASK__FORM;
                case ProcessPackage.PAGE_FLOW__ENTRY_REDIRECTION_URL:
                    return ProcessPackage.TASK__ENTRY_REDIRECTION_URL;
                case ProcessPackage.PAGE_FLOW__CONFIRMATION_MESSAGE:
                    return ProcessPackage.TASK__CONFIRMATION_MESSAGE;
                case ProcessPackage.PAGE_FLOW__ENTRY_REDIRECTION_ACTIONS:
                    return ProcessPackage.TASK__ENTRY_REDIRECTION_ACTIONS;
                case ProcessPackage.PAGE_FLOW__FORM_MAPPING:
                    return ProcessPackage.TASK__FORM_MAPPING;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == Assignable.class) {
            switch (baseFeatureID) {
                case ProcessPackage.ASSIGNABLE__ACTOR:
                    return ProcessPackage.TASK__ACTOR;
                case ProcessPackage.ASSIGNABLE__FILTERS:
                    return ProcessPackage.TASK__FILTERS;
                default:
                    return -1;
            }
        }
        if (baseClass == ContractContainer.class) {
            switch (baseFeatureID) {
                case ProcessPackage.CONTRACT_CONTAINER__CONTRACT:
                    return ProcessPackage.TASK__CONTRACT;
                default:
                    return -1;
            }
        }
