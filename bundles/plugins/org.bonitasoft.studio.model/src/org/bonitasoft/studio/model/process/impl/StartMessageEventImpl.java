...
public class StartMessageEventImpl extends MessageEventImpl implements StartMessageEvent {
    ...
    public void setEvent(String newEvent) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.START_MESSAGE_EVENT__EVENT, oldEvent,
                    event));
    }
            ...
            if (incomingMessag != oldIncomingMessag) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            ProcessPackage.START_MESSAGE_EVENT__INCOMING_MESSAG, oldIncomingMessag, incomingMessag));
            }
        }
    ...
    public NotificationChain basicSetIncomingMessag(MessageFlow newIncomingMessag, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.START_MESSAGE_EVENT__INCOMING_MESSAG, oldIncomingMessag, newIncomingMessag);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setIncomingMessag(MessageFlow newIncomingMessag) {
        if (newIncomingMessag != incomingMessag) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.START_MESSAGE_EVENT__INCOMING_MESSAG,
    ...
    public NotificationChain basicSetCorrelation(TableExpression newCorrelation, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.START_MESSAGE_EVENT__CORRELATION, oldCorrelation, newCorrelation);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newCorrelation != correlation) {
            ...
            if (correlation != null)
                msgs = ((InternalEObject) correlation).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.START_MESSAGE_EVENT__CORRELATION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.START_MESSAGE_EVENT__CORRELATION,
    ...
    public EList<Operation> getMessageContent() {
        if (messageContent == null) {
            messageContent = new EObjectContainmentEList<Operation>(Operation.class, this,
                    ProcessPackage.START_MESSAGE_EVENT__MESSAGE_CONTENT);
        }
        ...
        if (baseClass == AbstractCatchMessageEvent.class) {
            switch (baseFeatureID) {
                case ProcessPackage.ABSTRACT_CATCH_MESSAGE_EVENT__EVENT:
                    return ProcessPackage.START_MESSAGE_EVENT__EVENT;
                case ProcessPackage.ABSTRACT_CATCH_MESSAGE_EVENT__INCOMING_MESSAG:
                    return ProcessPackage.START_MESSAGE_EVENT__INCOMING_MESSAG;
                case ProcessPackage.ABSTRACT_CATCH_MESSAGE_EVENT__CORRELATION:
                    return ProcessPackage.START_MESSAGE_EVENT__CORRELATION;
                case ProcessPackage.ABSTRACT_CATCH_MESSAGE_EVENT__MESSAGE_CONTENT:
                    return ProcessPackage.START_MESSAGE_EVENT__MESSAGE_CONTENT;
                default:
                    return -1;
            }
        }
        if (baseClass == DataAware.class) {
            switch (baseFeatureID) {
                case ProcessPackage.DATA_AWARE__DATA:
                    return ProcessPackage.START_MESSAGE_EVENT__DATA;
                default:
                    return -1;
            }
        }
