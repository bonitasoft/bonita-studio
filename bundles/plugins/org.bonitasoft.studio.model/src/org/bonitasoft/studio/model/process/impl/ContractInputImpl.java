...
public class ContractInputImpl extends EObjectImpl implements ContractInput {
    ...
    public void setDescription(String newDescription) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.CONTRACT_INPUT__DESCRIPTION, oldDescription,
                    description));
    }
    ...
    public void setMultiple(boolean newMultiple) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.CONTRACT_INPUT__MULTIPLE, oldMultiple,
                    multiple));
    }
    ...
    public NotificationChain basicSetMapping(ContractInputMapping newMapping, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.CONTRACT_INPUT__MAPPING, oldMapping, newMapping);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newMapping != mapping) {
            ...
            if (mapping != null)
                msgs = ((InternalEObject) mapping).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.CONTRACT_INPUT__MAPPING, null, msgs);
            if (newMapping != null)
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.CONTRACT_INPUT__MAPPING, newMapping,
                    newMapping));
    }
    ...
    public EList<ContractInput> getInputs() {
        if (inputs == null) {
            inputs = new EObjectContainmentEList<ContractInput>(ContractInput.class, this,
                    ProcessPackage.CONTRACT_INPUT__INPUTS);
        }
        return inputs;
    }
    ...
    public String getJavaType() {
        switch (getType()) {
            ...
            case FILE:
                return "org.bonitasoft.engine.bpm.contract.FileInputValue";
            case COMPLEX:
