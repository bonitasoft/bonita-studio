...
public class SendTaskImpl extends ActivityImpl implements SendTask {
    ...
    public EList<Message> getEvents() {
        if (events == null) {
            events = new EObjectContainmentWithInverseEList<Message>(Message.class, this, ProcessPackage.SEND_TASK__EVENTS,
                    ProcessPackage.MESSAGE__SOURCE);
        }
        return events;
    }
    ...
    public EList<MessageFlow> getOutgoingMessages() {
        if (outgoingMessages == null) {
            outgoingMessages = new EObjectWithInverseResolvingEList<MessageFlow>(MessageFlow.class, this,
                    ProcessPackage.SEND_TASK__OUTGOING_MESSAGES, ProcessPackage.MESSAGE_FLOW__SOURCE);
        }
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == ThrowMessageEvent.class) {
            switch (derivedFeatureID) {
                case ProcessPackage.SEND_TASK__EVENTS:
                    return ProcessPackage.THROW_MESSAGE_EVENT__EVENTS;
                case ProcessPackage.SEND_TASK__OUTGOING_MESSAGES:
                    return ProcessPackage.THROW_MESSAGE_EVENT__OUTGOING_MESSAGES;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == ThrowMessageEvent.class) {
            switch (baseFeatureID) {
                case ProcessPackage.THROW_MESSAGE_EVENT__EVENTS:
                    return ProcessPackage.SEND_TASK__EVENTS;
                case ProcessPackage.THROW_MESSAGE_EVENT__OUTGOING_MESSAGES:
                    return ProcessPackage.SEND_TASK__OUTGOING_MESSAGES;
                default:
                    return -1;
            }
        }
