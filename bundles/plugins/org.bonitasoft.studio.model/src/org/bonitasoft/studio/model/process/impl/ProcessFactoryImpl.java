...
public class ProcessFactoryImpl extends EFactoryImpl implements ProcessFactory {
    ...
    public EObject create(EClass eClass) {
        switch (eClass.getClassifierID()) {
            ...
            case ProcessPackage.CONTRACT_INPUT_MAPPING:
                return createContractInputMapping();
            ...
            case ProcessPackage.CORRELATION_ASSOCIATION:
                return createCorrelationAssociation();
            case ProcessPackage.DATA:
                return createData();
            case ProcessPackage.DATA_AWARE:
                return createDataAware();
            ...
            case ProcessPackage.END_SIGNAL_EVENT:
                return createEndSignalEvent();
            case ProcessPackage.END_TERMINATED_EVENT:
                return createEndTerminatedEvent();
            ...
            case ProcessPackage.TEXT_ANNOTATION_ATTACHMENT:
                return createTextAnnotationAttachment();
            case ProcessPackage.THROW_LINK_EVENT:
                return createThrowLinkEvent();
            case ProcessPackage.THROW_MESSAGE_EVENT:
                return createThrowMessageEvent();
     ...
     * @generated
     */
    public InputMappingAssignationType createInputMappingAssignationTypeFromString(EDataType eDataType,
            String initialValue) {
