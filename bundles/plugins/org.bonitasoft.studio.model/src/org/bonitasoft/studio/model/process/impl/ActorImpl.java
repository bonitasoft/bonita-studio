 ...
 * <li>{@link org.bonitasoft.studio.model.process.impl.ActorImpl#getTextAnnotationAttachment <em>Text Annotation
 * Attachment</em>}</li>
...
public class ActorImpl extends EObjectImpl implements Actor {
    ...
    public void setDocumentation(String newDocumentation) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.ACTOR__DOCUMENTATION, oldDocumentation,
                    documentation));
    }
    ...
    public EList<TextAnnotationAttachment> getTextAnnotationAttachment() {
        if (textAnnotationAttachment == null) {
            textAnnotationAttachment = new EObjectContainmentWithInverseEList<TextAnnotationAttachment>(
                    TextAnnotationAttachment.class, this, ProcessPackage.ACTOR__TEXT_ANNOTATION_ATTACHMENT,
