    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            case ProcessPackage.ABSTRACT_CATCH_MESSAGE_EVENT: {
                ...
                if (result == null)
                    result = caseElement(abstractCatchMessageEvent);
                if (result == null)
            ...
            case ProcessPackage.ABSTRACT_PAGE_FLOW: {
                ...
                if (result == null)
                    result = caseElement(abstractPageFlow);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.ABSTRACT_PROCESS: {
                ...
                if (result == null)
                    result = caseContainer(abstractProcess);
                if (result == null)
                    result = caseProcessApplication(abstractProcess);
                if (result == null)
                    result = casePageFlow(abstractProcess);
                if (result == null)
                    result = caseSimulationAbstractProcess(abstractProcess);
                if (result == null)
                    result = caseRecapFlow(abstractProcess);
                if (result == null)
                    result = caseViewPageFlow(abstractProcess);
                if (result == null)
                    result = caseResourceContainer(abstractProcess);
                if (result == null)
                    result = caseMandatoryFieldsCustomization(abstractProcess);
                if (result == null)
                    result = caseConnectableElement(abstractProcess);
                if (result == null)
                    result = caseAbstractPageFlow(abstractProcess);
                if (result == null)
                    result = caseSimulationDataContainer(abstractProcess);
                if (result == null)
                    result = caseElement(abstractProcess);
                if (result == null)
                    result = caseCSSCustomizable(abstractProcess);
                if (result == null)
                    result = caseDataAware(abstractProcess);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.ABSTRACT_TIMER_EVENT: {
                ...
                if (result == null)
                    result = caseElement(abstractTimerEvent);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.ACTIVITY: {
                ...
                if (result == null)
                    result = caseConnectableElement(activity);
                if (result == null)
                    result = caseOperationContainer(activity);
                if (result == null)
                    result = caseMultiInstantiable(activity);
                if (result == null)
                    result = caseSourceElement(activity);
                if (result == null)
                    result = caseTargetElement(activity);
                if (result == null)
                    result = caseViewPageFlow(activity);
                if (result == null)
                    result = caseSimulationActivity(activity);
                if (result == null)
                    result = caseDataAware(activity);
                if (result == null)
                    result = caseAbstractPageFlow(activity);
                if (result == null)
                    result = caseSimulationDataContainer(activity);
                if (result == null)
            ...
            case ProcessPackage.ACTOR_FILTER: {
                ...
                if (result == null)
                    result = caseConnector(actorFilter);
                if (result == null)
                    result = caseElement(actorFilter);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.AND_GATEWAY: {
                ...
                if (result == null)
                    result = caseSourceElement(andGateway);
                if (result == null)
                    result = caseTargetElement(andGateway);
                if (result == null)
                    result = caseViewPageFlow(andGateway);
                if (result == null)
                    result = caseSimulationActivity(andGateway);
                if (result == null)
                    result = caseAbstractPageFlow(andGateway);
                if (result == null)
                    result = caseSimulationDataContainer(andGateway);
                if (result == null)
                    result = caseElement(andGateway);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case ProcessPackage.ASSOCIATION: {
                ...
                if (result == null)
                    result = caseSimulationTransition(association);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case ProcessPackage.BOUNDARY_EVENT: {
                ...
                if (result == null)
                    result = caseSourceElement(boundaryEvent);
                if (result == null)
                    result = caseElement(boundaryEvent);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.BOUNDARY_MESSAGE_EVENT: {
                ...
                if (result == null)
                    result = caseBoundaryEvent(boundaryMessageEvent);
                if (result == null)
                    result = caseAbstractCatchMessageEvent(boundaryMessageEvent);
                if (result == null)
                    result = caseSourceElement(boundaryMessageEvent);
                if (result == null)
                    result = caseElement(boundaryMessageEvent);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.BOUNDARY_SIGNAL_EVENT: {
                ...
                if (result == null)
                    result = caseBoundaryEvent(boundarySignalEvent);
                if (result == null)
                    result = caseSignalEvent(boundarySignalEvent);
                if (result == null)
                    result = caseSourceElement(boundarySignalEvent);
                if (result == null)
                    result = caseElement(boundarySignalEvent);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.BOUNDARY_TIMER_EVENT: {
                ...
                if (result == null)
                    result = caseBoundaryEvent(boundaryTimerEvent);
                if (result == null)
                    result = caseAbstractTimerEvent(boundaryTimerEvent);
                if (result == null)
                    result = caseSourceElement(boundaryTimerEvent);
                if (result == null)
                    result = caseElement(boundaryTimerEvent);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.BUSINESS_OBJECT_DATA: {
                ...
                if (result == null)
                    result = caseJavaObjectData(businessObjectData);
                if (result == null)
                    result = caseData(businessObjectData);
                if (result == null)
                    result = caseElement(businessObjectData);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.BUSINESS_OBJECT_TYPE: {
                ...
                if (result == null)
                    result = caseDataType(businessObjectType);
                if (result == null)
                    result = caseElement(businessObjectType);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.CALL_ACTIVITY: {
                ...
                if (result == null)
                    result = caseConnectableElement(callActivity);
                if (result == null)
                    result = caseOperationContainer(callActivity);
                if (result == null)
                    result = caseMultiInstantiable(callActivity);
                if (result == null)
                    result = caseSourceElement(callActivity);
                if (result == null)
                    result = caseTargetElement(callActivity);
                if (result == null)
                    result = caseViewPageFlow(callActivity);
                if (result == null)
                    result = caseSimulationActivity(callActivity);
                if (result == null)
                    result = caseDataAware(callActivity);
                if (result == null)
                    result = caseAbstractPageFlow(callActivity);
                if (result == null)
                    result = caseSimulationDataContainer(callActivity);
                if (result == null)
                    result = caseElement(callActivity);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.CATCH_LINK_EVENT: {
                ...
                if (result == null)
                    result = caseLinkEvent(catchLinkEvent);
                if (result == null)
                    result = caseEvent(catchLinkEvent);
                if (result == null)
                    result = caseFlowElement(catchLinkEvent);
                if (result == null)
                    result = caseSourceElement(catchLinkEvent);
                if (result == null)
                    result = caseTargetElement(catchLinkEvent);
                if (result == null)
                    result = caseViewPageFlow(catchLinkEvent);
                if (result == null)
                    result = caseSimulationActivity(catchLinkEvent);
                if (result == null)
                    result = caseAbstractPageFlow(catchLinkEvent);
                if (result == null)
                    result = caseSimulationDataContainer(catchLinkEvent);
                if (result == null)
                    result = caseElement(catchLinkEvent);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.CATCH_MESSAGE_EVENT: {
                ...
                if (result == null)
                    result = caseMessageEvent(catchMessageEvent);
                if (result == null)
                    result = caseAbstractCatchMessageEvent(catchMessageEvent);
                if (result == null)
                    result = caseDataAware(catchMessageEvent);
                if (result == null)
                    result = caseEvent(catchMessageEvent);
                if (result == null)
                    result = caseFlowElement(catchMessageEvent);
                if (result == null)
                    result = caseSourceElement(catchMessageEvent);
                if (result == null)
                    result = caseTargetElement(catchMessageEvent);
                if (result == null)
                    result = caseViewPageFlow(catchMessageEvent);
                if (result == null)
                    result = caseSimulationActivity(catchMessageEvent);
                if (result == null)
                    result = caseAbstractPageFlow(catchMessageEvent);
                if (result == null)
                    result = caseSimulationDataContainer(catchMessageEvent);
                if (result == null)
                    result = caseElement(catchMessageEvent);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.CATCH_SIGNAL_EVENT: {
                ...
                if (result == null)
                    result = caseSignalEvent(catchSignalEvent);
                if (result == null)
                    result = caseElement(catchSignalEvent);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.CONNECTABLE_ELEMENT: {
                ...
                if (result == null)
                    result = caseDataAware(connectableElement);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case ProcessPackage.CONNECTION: {
                ...
                if (result == null)
                    result = caseSimulationTransition(connection);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case ProcessPackage.DATE_TYPE: {
                ...
                if (result == null)
                    result = caseStringType(dateType);
                if (result == null)
                    result = caseDataType(dateType);
                if (result == null)
                    result = caseElement(dateType);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case ProcessPackage.DOUBLE_TYPE: {
                ...
                if (result == null)
                    result = caseDataType(doubleType);
                if (result == null)
                    result = caseElement(doubleType);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case ProcessPackage.EVENT: {
                ...
                if (result == null)
                    result = caseSourceElement(event);
                if (result == null)
                    result = caseTargetElement(event);
                if (result == null)
                    result = caseViewPageFlow(event);
                if (result == null)
                    result = caseSimulationActivity(event);
                if (result == null)
                    result = caseAbstractPageFlow(event);
                if (result == null)
                    result = caseSimulationDataContainer(event);
                if (result == null)
            ...
            case ProcessPackage.END_ERROR_EVENT: {
                ...
                if (result == null)
                    result = caseEvent(endErrorEvent);
                if (result == null)
                    result = caseErrorEvent(endErrorEvent);
                if (result == null)
                    result = caseFlowElement(endErrorEvent);
                if (result == null)
                    result = caseSourceElement(endErrorEvent);
                if (result == null)
                    result = caseTargetElement(endErrorEvent);
                if (result == null)
                    result = caseViewPageFlow(endErrorEvent);
                if (result == null)
                    result = caseSimulationActivity(endErrorEvent);
                if (result == null)
                    result = caseAbstractPageFlow(endErrorEvent);
                if (result == null)
                    result = caseSimulationDataContainer(endErrorEvent);
                if (result == null)
                    result = caseElement(endErrorEvent);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.END_EVENT: {
                ...
                if (result == null)
                    result = caseSourceElement(endEvent);
                if (result == null)
                    result = caseTargetElement(endEvent);
                if (result == null)
                    result = caseViewPageFlow(endEvent);
                if (result == null)
                    result = caseSimulationActivity(endEvent);
                if (result == null)
                    result = caseAbstractPageFlow(endEvent);
                if (result == null)
                    result = caseSimulationDataContainer(endEvent);
                if (result == null)
                    result = caseElement(endEvent);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.END_MESSAGE_EVENT: {
                ...
                if (result == null)
                    result = caseThrowMessageEvent(endMessageEvent);
                if (result == null)
                    result = caseMessageEvent(endMessageEvent);
                if (result == null)
                    result = caseEvent(endMessageEvent);
                if (result == null)
                    result = caseFlowElement(endMessageEvent);
                if (result == null)
                    result = caseSourceElement(endMessageEvent);
                if (result == null)
                    result = caseTargetElement(endMessageEvent);
                if (result == null)
                    result = caseViewPageFlow(endMessageEvent);
                if (result == null)
                    result = caseSimulationActivity(endMessageEvent);
                if (result == null)
                    result = caseAbstractPageFlow(endMessageEvent);
                if (result == null)
                    result = caseSimulationDataContainer(endMessageEvent);
                if (result == null)
                    result = caseElement(endMessageEvent);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.END_SIGNAL_EVENT: {
                ...
                if (result == null)
                    result = caseThrowSignalEvent(endSignalEvent);
                if (result == null)
                    result = caseEvent(endSignalEvent);
                if (result == null)
                    result = caseSignalEvent(endSignalEvent);
                if (result == null)
                    result = caseFlowElement(endSignalEvent);
                if (result == null)
                    result = caseSourceElement(endSignalEvent);
                if (result == null)
                    result = caseTargetElement(endSignalEvent);
                if (result == null)
                    result = caseViewPageFlow(endSignalEvent);
                if (result == null)
                    result = caseSimulationActivity(endSignalEvent);
                if (result == null)
                    result = caseAbstractPageFlow(endSignalEvent);
                if (result == null)
                    result = caseSimulationDataContainer(endSignalEvent);
                if (result == null)
                    result = caseElement(endSignalEvent);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.END_TERMINATED_EVENT: {
                ...
                if (result == null)
                    result = caseEvent(endTerminatedEvent);
                if (result == null)
                    result = caseFlowElement(endTerminatedEvent);
                if (result == null)
                    result = caseSourceElement(endTerminatedEvent);
                if (result == null)
                    result = caseTargetElement(endTerminatedEvent);
                if (result == null)
                    result = caseViewPageFlow(endTerminatedEvent);
                if (result == null)
                    result = caseSimulationActivity(endTerminatedEvent);
                if (result == null)
                    result = caseAbstractPageFlow(endTerminatedEvent);
                if (result == null)
                    result = caseSimulationDataContainer(endTerminatedEvent);
                if (result == null)
                    result = caseElement(endTerminatedEvent);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case ProcessPackage.FLOAT_TYPE: {
                ...
                if (result == null)
                    result = caseDataType(floatType);
                if (result == null)
                    result = caseElement(floatType);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.FLOW_ELEMENT: {
                ...
                if (result == null)
                    result = caseSourceElement(flowElement);
                if (result == null)
                    result = caseTargetElement(flowElement);
                if (result == null)
                    result = caseViewPageFlow(flowElement);
                if (result == null)
                    result = caseSimulationActivity(flowElement);
                if (result == null)
                    result = caseAbstractPageFlow(flowElement);
                if (result == null)
                    result = caseSimulationDataContainer(flowElement);
                if (result == null)
            ...
            case ProcessPackage.GATEWAY: {
                ...
                if (result == null)
                    result = caseSourceElement(gateway);
                if (result == null)
                    result = caseTargetElement(gateway);
                if (result == null)
                    result = caseViewPageFlow(gateway);
                if (result == null)
                    result = caseSimulationActivity(gateway);
                if (result == null)
                    result = caseAbstractPageFlow(gateway);
                if (result == null)
                    result = caseSimulationDataContainer(gateway);
                if (result == null)
                    result = caseElement(gateway);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.INCLUSIVE_GATEWAY: {
                ...
                if (result == null)
                    result = caseSourceElement(inclusiveGateway);
                if (result == null)
                    result = caseTargetElement(inclusiveGateway);
                if (result == null)
                    result = caseViewPageFlow(inclusiveGateway);
                if (result == null)
                    result = caseSimulationActivity(inclusiveGateway);
                if (result == null)
                    result = caseAbstractPageFlow(inclusiveGateway);
                if (result == null)
                    result = caseSimulationDataContainer(inclusiveGateway);
                if (result == null)
                    result = caseElement(inclusiveGateway);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case ProcessPackage.INTERMEDIATE_ERROR_CATCH_EVENT: {
                ...
                if (result == null)
                    result = caseBoundaryEvent(intermediateErrorCatchEvent);
                if (result == null)
                    result = caseErrorEvent(intermediateErrorCatchEvent);
                if (result == null)
                    result = caseSourceElement(intermediateErrorCatchEvent);
                if (result == null)
                    result = caseElement(intermediateErrorCatchEvent);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.INTERMEDIATE_CATCH_SIGNAL_EVENT: {
                ...
                if (result == null)
                    result = caseCatchSignalEvent(intermediateCatchSignalEvent);
                if (result == null)
                    result = caseEvent(intermediateCatchSignalEvent);
                if (result == null)
                    result = caseDataAware(intermediateCatchSignalEvent);
                if (result == null)
                    result = caseSignalEvent(intermediateCatchSignalEvent);
                if (result == null)
                    result = caseFlowElement(intermediateCatchSignalEvent);
                if (result == null)
                    result = caseSourceElement(intermediateCatchSignalEvent);
                if (result == null)
                    result = caseTargetElement(intermediateCatchSignalEvent);
                if (result == null)
                    result = caseViewPageFlow(intermediateCatchSignalEvent);
                if (result == null)
                    result = caseSimulationActivity(intermediateCatchSignalEvent);
                if (result == null)
                    result = caseAbstractPageFlow(intermediateCatchSignalEvent);
                if (result == null)
                    result = caseSimulationDataContainer(intermediateCatchSignalEvent);
                if (result == null)
                    result = caseElement(intermediateCatchSignalEvent);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.INTERMEDIATE_THROW_SIGNAL_EVENT: {
                ...
                if (result == null)
                    result = caseThrowSignalEvent(intermediateThrowSignalEvent);
                if (result == null)
                    result = caseEvent(intermediateThrowSignalEvent);
                if (result == null)
                    result = caseSignalEvent(intermediateThrowSignalEvent);
                if (result == null)
                    result = caseFlowElement(intermediateThrowSignalEvent);
                if (result == null)
                    result = caseSourceElement(intermediateThrowSignalEvent);
                if (result == null)
                    result = caseTargetElement(intermediateThrowSignalEvent);
                if (result == null)
                    result = caseViewPageFlow(intermediateThrowSignalEvent);
                if (result == null)
                    result = caseSimulationActivity(intermediateThrowSignalEvent);
                if (result == null)
                    result = caseAbstractPageFlow(intermediateThrowSignalEvent);
                if (result == null)
                    result = caseSimulationDataContainer(intermediateThrowSignalEvent);
                if (result == null)
                    result = caseElement(intermediateThrowSignalEvent);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.INTERMEDIATE_CATCH_MESSAGE_EVENT: {
                ...
                if (result == null)
                    result = caseCatchMessageEvent(intermediateCatchMessageEvent);
                if (result == null)
                    result = caseMessageEvent(intermediateCatchMessageEvent);
                if (result == null)
                    result = caseAbstractCatchMessageEvent(intermediateCatchMessageEvent);
                if (result == null)
                    result = caseDataAware(intermediateCatchMessageEvent);
                if (result == null)
                    result = caseEvent(intermediateCatchMessageEvent);
                if (result == null)
                    result = caseFlowElement(intermediateCatchMessageEvent);
                if (result == null)
                    result = caseSourceElement(intermediateCatchMessageEvent);
                if (result == null)
                    result = caseTargetElement(intermediateCatchMessageEvent);
                if (result == null)
                    result = caseViewPageFlow(intermediateCatchMessageEvent);
                if (result == null)
                    result = caseSimulationActivity(intermediateCatchMessageEvent);
                if (result == null)
                    result = caseAbstractPageFlow(intermediateCatchMessageEvent);
                if (result == null)
                    result = caseSimulationDataContainer(intermediateCatchMessageEvent);
                if (result == null)
                    result = caseElement(intermediateCatchMessageEvent);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.INTERMEDIATE_THROW_MESSAGE_EVENT: {
                ...
                if (result == null)
                    result = caseThrowMessageEvent(intermediateThrowMessageEvent);
                if (result == null)
                    result = caseMessageEvent(intermediateThrowMessageEvent);
                if (result == null)
                    result = caseEvent(intermediateThrowMessageEvent);
                if (result == null)
                    result = caseFlowElement(intermediateThrowMessageEvent);
                if (result == null)
                    result = caseSourceElement(intermediateThrowMessageEvent);
                if (result == null)
                    result = caseTargetElement(intermediateThrowMessageEvent);
                if (result == null)
                    result = caseViewPageFlow(intermediateThrowMessageEvent);
                if (result == null)
                    result = caseSimulationActivity(intermediateThrowMessageEvent);
                if (result == null)
                    result = caseAbstractPageFlow(intermediateThrowMessageEvent);
                if (result == null)
                    result = caseSimulationDataContainer(intermediateThrowMessageEvent);
                if (result == null)
                    result = caseElement(intermediateThrowMessageEvent);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.INTERMEDIATE_CATCH_TIMER_EVENT: {
                ...
                if (result == null)
                    result = caseTimerEvent(intermediateCatchTimerEvent);
                if (result == null)
                    result = caseEvent(intermediateCatchTimerEvent);
                if (result == null)
                    result = caseAbstractTimerEvent(intermediateCatchTimerEvent);
                if (result == null)
                    result = caseDataAware(intermediateCatchTimerEvent);
                if (result == null)
                    result = caseFlowElement(intermediateCatchTimerEvent);
                if (result == null)
                    result = caseSourceElement(intermediateCatchTimerEvent);
                if (result == null)
                    result = caseTargetElement(intermediateCatchTimerEvent);
                if (result == null)
                    result = caseViewPageFlow(intermediateCatchTimerEvent);
                if (result == null)
                    result = caseSimulationActivity(intermediateCatchTimerEvent);
                if (result == null)
                    result = caseAbstractPageFlow(intermediateCatchTimerEvent);
                if (result == null)
                    result = caseSimulationDataContainer(intermediateCatchTimerEvent);
                if (result == null)
                    result = caseElement(intermediateCatchTimerEvent);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.JAVA_OBJECT_DATA: {
                ...
                if (result == null)
                    result = caseData(javaObjectData);
                if (result == null)
                    result = caseElement(javaObjectData);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.JAVA_TYPE: {
                ...
                if (result == null)
                    result = caseDataType(javaType);
                if (result == null)
                    result = caseElement(javaType);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.LANE: {
                ...
                if (result == null)
                    result = caseContainer(lane);
                if (result == null)
                    result = caseAssignable(lane);
                if (result == null)
                    result = caseElement(lane);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.LINK_EVENT: {
                ...
                if (result == null)
                    result = caseFlowElement(linkEvent);
                if (result == null)
                    result = caseSourceElement(linkEvent);
                if (result == null)
                    result = caseTargetElement(linkEvent);
                if (result == null)
                    result = caseViewPageFlow(linkEvent);
                if (result == null)
                    result = caseSimulationActivity(linkEvent);
                if (result == null)
                    result = caseAbstractPageFlow(linkEvent);
                if (result == null)
                    result = caseSimulationDataContainer(linkEvent);
                if (result == null)
                    result = caseElement(linkEvent);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.LONG_TYPE: {
                ...
                if (result == null)
                    result = caseDataType(longType);
                if (result == null)
                    result = caseElement(longType);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.MAIN_PROCESS: {
                ...
                if (result == null)
                    result = caseAbstractProcess(mainProcess);
                if (result == null)
                    result = caseContainer(mainProcess);
                if (result == null)
                    result = caseProcessApplication(mainProcess);
                if (result == null)
                    result = casePageFlow(mainProcess);
                if (result == null)
                    result = caseSimulationAbstractProcess(mainProcess);
                if (result == null)
                    result = caseRecapFlow(mainProcess);
                if (result == null)
                    result = caseViewPageFlow(mainProcess);
                if (result == null)
                    result = caseResourceContainer(mainProcess);
                if (result == null)
                    result = caseMandatoryFieldsCustomization(mainProcess);
                if (result == null)
                    result = caseConnectableElement(mainProcess);
                if (result == null)
                    result = caseAbstractPageFlow(mainProcess);
                if (result == null)
                    result = caseSimulationDataContainer(mainProcess);
                if (result == null)
                    result = caseElement(mainProcess);
                if (result == null)
                    result = caseCSSCustomizable(mainProcess);
                if (result == null)
                    result = caseDataAware(mainProcess);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case ProcessPackage.MESSAGE_FLOW: {
                ...
                if (result == null)
                    result = caseElement(messageFlow);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.MESSAGE_EVENT: {
                ...
                if (result == null)
                    result = caseFlowElement(messageEvent);
                if (result == null)
                    result = caseSourceElement(messageEvent);
                if (result == null)
                    result = caseTargetElement(messageEvent);
                if (result == null)
                    result = caseViewPageFlow(messageEvent);
                if (result == null)
                    result = caseSimulationActivity(messageEvent);
                if (result == null)
                    result = caseAbstractPageFlow(messageEvent);
                if (result == null)
                    result = caseSimulationDataContainer(messageEvent);
                if (result == null)
            ...
            case ProcessPackage.NON_INTERRUPTING_BOUNDARY_TIMER_EVENT: {
                ...
                if (result == null)
                    result = caseBoundaryTimerEvent(nonInterruptingBoundaryTimerEvent);
                if (result == null)
                    result = caseBoundaryEvent(nonInterruptingBoundaryTimerEvent);
                if (result == null)
                    result = caseAbstractTimerEvent(nonInterruptingBoundaryTimerEvent);
                if (result == null)
                    result = caseSourceElement(nonInterruptingBoundaryTimerEvent);
                if (result == null)
                    result = caseElement(nonInterruptingBoundaryTimerEvent);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case ProcessPackage.PAGE_FLOW: {
                ...
                if (result == null)
                    result = caseConnectableElement(pageFlow);
                if (result == null)
                    result = caseAbstractPageFlow(pageFlow);
                if (result == null)
                    result = caseElement(pageFlow);
                if (result == null)
                    result = caseDataAware(pageFlow);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.POOL: {
                ...
                if (result == null)
                    result = caseAbstractProcess(pool);
                if (result == null)
                    result = caseContractContainer(pool);
                if (result == null)
                    result = caseContainer(pool);
                if (result == null)
                    result = caseProcessApplication(pool);
                if (result == null)
                    result = casePageFlow(pool);
                if (result == null)
                    result = caseSimulationAbstractProcess(pool);
                if (result == null)
                    result = caseRecapFlow(pool);
                if (result == null)
                    result = caseViewPageFlow(pool);
                if (result == null)
                    result = caseResourceContainer(pool);
                if (result == null)
                    result = caseMandatoryFieldsCustomization(pool);
                if (result == null)
                    result = caseConnectableElement(pool);
                if (result == null)
                    result = caseAbstractPageFlow(pool);
                if (result == null)
                    result = caseSimulationDataContainer(pool);
                if (result == null)
                    result = caseElement(pool);
                if (result == null)
                    result = caseCSSCustomizable(pool);
                if (result == null)
                    result = caseDataAware(pool);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.PROCESS_APPLICATION: {
                ...
                if (result == null)
                    result = caseResourceContainer(processApplication);
                if (result == null)
                    result = caseMandatoryFieldsCustomization(processApplication);
                if (result == null)
                    result = caseCSSCustomizable(processApplication);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case ProcessPackage.RECAP_FLOW: {
                ...
                if (result == null)
                    result = caseAbstractPageFlow(recapFlow);
                if (result == null)
                    result = caseElement(recapFlow);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.RECEIVE_TASK: {
                ...
                if (result == null)
                    result = caseCatchMessageEvent(receiveTask);
                if (result == null)
                    result = caseConnectableElement(receiveTask);
                if (result == null)
                    result = caseOperationContainer(receiveTask);
                if (result == null)
                    result = caseMultiInstantiable(receiveTask);
                if (result == null)
                    result = caseMessageEvent(receiveTask);
                if (result == null)
                    result = caseAbstractCatchMessageEvent(receiveTask);
                if (result == null)
                    result = caseSourceElement(receiveTask);
                if (result == null)
                    result = caseTargetElement(receiveTask);
                if (result == null)
                    result = caseViewPageFlow(receiveTask);
                if (result == null)
                    result = caseSimulationActivity(receiveTask);
                if (result == null)
                    result = caseDataAware(receiveTask);
                if (result == null)
                    result = caseEvent(receiveTask);
                if (result == null)
                    result = caseFlowElement(receiveTask);
                if (result == null)
                    result = caseAbstractPageFlow(receiveTask);
                if (result == null)
                    result = caseSimulationDataContainer(receiveTask);
                if (result == null)
                    result = caseElement(receiveTask);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case ProcessPackage.RESOURCE_FILE: {
                ...
                if (result == null)
                    result = caseAssociatedFile(resourceFile);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.RESOURCE_FOLDER: {
                ...
                if (result == null)
                    result = caseAssociatedFile(resourceFolder);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.SEQUENCE_FLOW: {
                ...
                if (result == null)
                    result = caseConnection(sequenceFlow);
                if (result == null)
                    result = caseElement(sequenceFlow);
                if (result == null)
                    result = caseSimulationTransition(sequenceFlow);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case ProcessPackage.SOURCE_ELEMENT: {
                ...
                if (result == null)
                    result = caseElement(sourceElement);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case ProcessPackage.SCRIPT_TASK: {
                ...
                if (result == null)
                    result = caseConnectableElement(scriptTask);
                if (result == null)
                    result = caseOperationContainer(scriptTask);
                if (result == null)
                    result = caseMultiInstantiable(scriptTask);
                if (result == null)
                    result = caseSourceElement(scriptTask);
                if (result == null)
                    result = caseTargetElement(scriptTask);
                if (result == null)
                    result = caseViewPageFlow(scriptTask);
                if (result == null)
                    result = caseSimulationActivity(scriptTask);
                if (result == null)
                    result = caseDataAware(scriptTask);
                if (result == null)
                    result = caseAbstractPageFlow(scriptTask);
                if (result == null)
                    result = caseSimulationDataContainer(scriptTask);
                if (result == null)
                    result = caseElement(scriptTask);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case ProcessPackage.SEND_TASK: {
                ...
                if (result == null)
                    result = caseThrowMessageEvent(sendTask);
                if (result == null)
                    result = caseConnectableElement(sendTask);
                if (result == null)
                    result = caseOperationContainer(sendTask);
                if (result == null)
                    result = caseMultiInstantiable(sendTask);
                if (result == null)
                    result = caseMessageEvent(sendTask);
                if (result == null)
                    result = caseSourceElement(sendTask);
                if (result == null)
                    result = caseTargetElement(sendTask);
                if (result == null)
                    result = caseViewPageFlow(sendTask);
                if (result == null)
                    result = caseSimulationActivity(sendTask);
                if (result == null)
                    result = caseDataAware(sendTask);
                if (result == null)
                    result = caseEvent(sendTask);
                if (result == null)
                    result = caseFlowElement(sendTask);
                if (result == null)
                    result = caseAbstractPageFlow(sendTask);
                if (result == null)
                    result = caseSimulationDataContainer(sendTask);
                if (result == null)
                    result = caseElement(sendTask);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.SERVICE_TASK: {
                ...
                if (result == null)
                    result = caseConnectableElement(serviceTask);
                if (result == null)
                    result = caseOperationContainer(serviceTask);
                if (result == null)
                    result = caseMultiInstantiable(serviceTask);
                if (result == null)
                    result = caseSourceElement(serviceTask);
                if (result == null)
                    result = caseTargetElement(serviceTask);
                if (result == null)
                    result = caseViewPageFlow(serviceTask);
                if (result == null)
                    result = caseSimulationActivity(serviceTask);
                if (result == null)
                    result = caseDataAware(serviceTask);
                if (result == null)
                    result = caseAbstractPageFlow(serviceTask);
                if (result == null)
                    result = caseSimulationDataContainer(serviceTask);
                if (result == null)
                    result = caseElement(serviceTask);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.START_ERROR_EVENT: {
                ...
                if (result == null)
                    result = caseErrorEvent(startErrorEvent);
                if (result == null)
                    result = caseEvent(startErrorEvent);
                if (result == null)
                    result = caseFlowElement(startErrorEvent);
                if (result == null)
                    result = caseSourceElement(startErrorEvent);
                if (result == null)
                    result = caseTargetElement(startErrorEvent);
                if (result == null)
                    result = caseViewPageFlow(startErrorEvent);
                if (result == null)
                    result = caseSimulationActivity(startErrorEvent);
                if (result == null)
                    result = caseAbstractPageFlow(startErrorEvent);
                if (result == null)
                    result = caseSimulationDataContainer(startErrorEvent);
                if (result == null)
                    result = caseElement(startErrorEvent);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.START_EVENT: {
                ...
                if (result == null)
                    result = caseSourceElement(startEvent);
                if (result == null)
                    result = caseTargetElement(startEvent);
                if (result == null)
                    result = caseViewPageFlow(startEvent);
                if (result == null)
                    result = caseSimulationActivity(startEvent);
                if (result == null)
                    result = caseAbstractPageFlow(startEvent);
                if (result == null)
                    result = caseSimulationDataContainer(startEvent);
                if (result == null)
                    result = caseElement(startEvent);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.START_MESSAGE_EVENT: {
                ...
                if (result == null)
                    result = caseCatchMessageEvent(startMessageEvent);
                if (result == null)
                    result = caseMessageEvent(startMessageEvent);
                if (result == null)
                    result = caseAbstractCatchMessageEvent(startMessageEvent);
                if (result == null)
                    result = caseDataAware(startMessageEvent);
                if (result == null)
                    result = caseEvent(startMessageEvent);
                if (result == null)
                    result = caseFlowElement(startMessageEvent);
                if (result == null)
                    result = caseSourceElement(startMessageEvent);
                if (result == null)
                    result = caseTargetElement(startMessageEvent);
                if (result == null)
                    result = caseViewPageFlow(startMessageEvent);
                if (result == null)
                    result = caseSimulationActivity(startMessageEvent);
                if (result == null)
                    result = caseAbstractPageFlow(startMessageEvent);
                if (result == null)
                    result = caseSimulationDataContainer(startMessageEvent);
                if (result == null)
                    result = caseElement(startMessageEvent);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.START_SIGNAL_EVENT: {
                ...
                if (result == null)
                    result = caseCatchSignalEvent(startSignalEvent);
                if (result == null)
                    result = caseEvent(startSignalEvent);
                if (result == null)
                    result = caseDataAware(startSignalEvent);
                if (result == null)
                    result = caseSignalEvent(startSignalEvent);
                if (result == null)
                    result = caseFlowElement(startSignalEvent);
                if (result == null)
                    result = caseSourceElement(startSignalEvent);
                if (result == null)
                    result = caseTargetElement(startSignalEvent);
                if (result == null)
                    result = caseViewPageFlow(startSignalEvent);
                if (result == null)
                    result = caseSimulationActivity(startSignalEvent);
                if (result == null)
                    result = caseAbstractPageFlow(startSignalEvent);
                if (result == null)
                    result = caseSimulationDataContainer(startSignalEvent);
                if (result == null)
                    result = caseElement(startSignalEvent);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.START_TIMER_EVENT: {
                ...
                if (result == null)
                    result = caseTimerEvent(startTimerEvent);
                if (result == null)
                    result = caseEvent(startTimerEvent);
                if (result == null)
                    result = caseAbstractTimerEvent(startTimerEvent);
                if (result == null)
                    result = caseDataAware(startTimerEvent);
                if (result == null)
                    result = caseFlowElement(startTimerEvent);
                if (result == null)
                    result = caseSourceElement(startTimerEvent);
                if (result == null)
                    result = caseTargetElement(startTimerEvent);
                if (result == null)
                    result = caseViewPageFlow(startTimerEvent);
                if (result == null)
                    result = caseSimulationActivity(startTimerEvent);
                if (result == null)
                    result = caseAbstractPageFlow(startTimerEvent);
                if (result == null)
                    result = caseSimulationDataContainer(startTimerEvent);
                if (result == null)
                    result = caseElement(startTimerEvent);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.SUB_PROCESS_EVENT: {
                ...
                if (result == null)
                    result = caseContainer(subProcessEvent);
                if (result == null)
                    result = caseElement(subProcessEvent);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.TASK: {
                ...
                if (result == null)
                    result = casePageFlow(task);
                if (result == null)
                    result = caseResourceContainer(task);
                if (result == null)
                    result = caseAssignable(task);
                if (result == null)
                    result = caseContractContainer(task);
                if (result == null)
                    result = caseFlowElement(task);
                if (result == null)
                    result = caseConnectableElement(task);
                if (result == null)
                    result = caseOperationContainer(task);
                if (result == null)
                    result = caseMultiInstantiable(task);
                if (result == null)
                    result = caseSourceElement(task);
                if (result == null)
                    result = caseTargetElement(task);
                if (result == null)
                    result = caseViewPageFlow(task);
                if (result == null)
                    result = caseSimulationActivity(task);
                if (result == null)
                    result = caseDataAware(task);
                if (result == null)
                    result = caseAbstractPageFlow(task);
                if (result == null)
                    result = caseSimulationDataContainer(task);
                if (result == null)
            ...
            case ProcessPackage.TARGET_ELEMENT: {
                ...
                if (result == null)
                    result = caseElement(targetElement);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.TEXT_ANNOTATION: {
                ...
                if (result == null)
                    result = caseElement(textAnnotation);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case ProcessPackage.THROW_SIGNAL_EVENT: {
                ...
                if (result == null)
                    result = caseSignalEvent(throwSignalEvent);
                if (result == null)
                    result = caseElement(throwSignalEvent);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.THROW_LINK_EVENT: {
                ...
                if (result == null)
                    result = caseLinkEvent(throwLinkEvent);
                if (result == null)
                    result = caseEvent(throwLinkEvent);
                if (result == null)
                    result = caseFlowElement(throwLinkEvent);
                if (result == null)
                    result = caseSourceElement(throwLinkEvent);
                if (result == null)
                    result = caseTargetElement(throwLinkEvent);
                if (result == null)
                    result = caseViewPageFlow(throwLinkEvent);
                if (result == null)
                    result = caseSimulationActivity(throwLinkEvent);
                if (result == null)
                    result = caseAbstractPageFlow(throwLinkEvent);
                if (result == null)
                    result = caseSimulationDataContainer(throwLinkEvent);
                if (result == null)
                    result = caseElement(throwLinkEvent);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.THROW_MESSAGE_EVENT: {
                ...
                if (result == null)
                    result = caseMessageEvent(throwMessageEvent);
                if (result == null)
                    result = caseEvent(throwMessageEvent);
                if (result == null)
                    result = caseFlowElement(throwMessageEvent);
                if (result == null)
                    result = caseSourceElement(throwMessageEvent);
                if (result == null)
                    result = caseTargetElement(throwMessageEvent);
                if (result == null)
                    result = caseViewPageFlow(throwMessageEvent);
                if (result == null)
                    result = caseSimulationActivity(throwMessageEvent);
                if (result == null)
                    result = caseAbstractPageFlow(throwMessageEvent);
                if (result == null)
                    result = caseSimulationDataContainer(throwMessageEvent);
                if (result == null)
                    result = caseElement(throwMessageEvent);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.TIMER_EVENT: {
                ...
                if (result == null)
                    result = caseAbstractTimerEvent(timerEvent);
                if (result == null)
                    result = caseDataAware(timerEvent);
                if (result == null)
                    result = caseFlowElement(timerEvent);
                if (result == null)
                    result = caseSourceElement(timerEvent);
                if (result == null)
                    result = caseTargetElement(timerEvent);
                if (result == null)
                    result = caseViewPageFlow(timerEvent);
                if (result == null)
                    result = caseSimulationActivity(timerEvent);
                if (result == null)
                    result = caseAbstractPageFlow(timerEvent);
                if (result == null)
                    result = caseSimulationDataContainer(timerEvent);
                if (result == null)
                    result = caseElement(timerEvent);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.VIEW_PAGE_FLOW: {
                ...
                if (result == null)
                    result = caseAbstractPageFlow(viewPageFlow);
                if (result == null)
                    result = caseElement(viewPageFlow);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.XML_DATA: {
                ...
                if (result == null)
                    result = caseData(xmlData);
                if (result == null)
                    result = caseElement(xmlData);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.XML_TYPE: {
                ...
                if (result == null)
                    result = caseDataType(xmlType);
                if (result == null)
                    result = caseElement(xmlType);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ProcessPackage.XOR_GATEWAY: {
                ...
                if (result == null)
                    result = caseSourceElement(xorGateway);
                if (result == null)
                    result = caseTargetElement(xorGateway);
                if (result == null)
                    result = caseViewPageFlow(xorGateway);
                if (result == null)
                    result = caseSimulationActivity(xorGateway);
                if (result == null)
                    result = caseAbstractPageFlow(xorGateway);
                if (result == null)
                    result = caseSimulationDataContainer(xorGateway);
                if (result == null)
                    result = caseElement(xorGateway);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
