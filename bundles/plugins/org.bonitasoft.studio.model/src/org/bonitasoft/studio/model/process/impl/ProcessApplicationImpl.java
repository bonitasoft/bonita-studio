 ...
 * </p>
 * <ul>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.ProcessApplicationImpl#getHtmlAttributes <em>Html Attributes</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.ProcessApplicationImpl#getMandatorySymbol <em>Mandatory Symbol</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.ProcessApplicationImpl#getMandatoryLabel <em>Mandatory Label</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.ProcessApplicationImpl#getErrorTemplate <em>Error Template</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.ProcessApplicationImpl#getProcessTemplate <em>Process Template</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.ProcessApplicationImpl#getPageTemplate <em>Page Template</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.ProcessApplicationImpl#getConsultationTemplate <em>Consultation Template</em>}</li>
 ...
 *   <li>{@link org.bonitasoft.studio.model.process.impl.ProcessApplicationImpl#getWelcomePageInternal <em>Welcome Page Internal</em>}</li>
 ...
 *   <li>{@link org.bonitasoft.studio.model.process.impl.ProcessApplicationImpl#getBasedOnLookAndFeel <em>Based On Look And Feel</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProcessApplicationImpl extends ResourceContainerImpl implements ProcessApplication {
	...
	public EMap<String, String> getHtmlAttributes() {
		if (htmlAttributes == null) {
			htmlAttributes = new EcoreEMap<String,String>(EcorePackage.Literals.ESTRING_TO_STRING_MAP_ENTRY, EStringToStringMapEntryImpl.class, this, ProcessPackage.PROCESS_APPLICATION__HTML_ATTRIBUTES);
		}
	...
	public NotificationChain basicSetMandatorySymbol(Expression newMandatorySymbol, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.PROCESS_APPLICATION__MANDATORY_SYMBOL, oldMandatorySymbol, newMandatorySymbol);
	...
	public void setMandatorySymbol(Expression newMandatorySymbol) {
		if (newMandatorySymbol != mandatorySymbol) {
			...
			if (mandatorySymbol != null)
				msgs = ((InternalEObject)mandatorySymbol).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.PROCESS_APPLICATION__MANDATORY_SYMBOL, null, msgs);
			if (newMandatorySymbol != null)
				msgs = ((InternalEObject)newMandatorySymbol).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.PROCESS_APPLICATION__MANDATORY_SYMBOL, null, msgs);
			msgs = basicSetMandatorySymbol(newMandatorySymbol, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.PROCESS_APPLICATION__MANDATORY_SYMBOL, newMandatorySymbol, newMandatorySymbol));
	}
	...
	public NotificationChain basicSetMandatoryLabel(Expression newMandatoryLabel, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.PROCESS_APPLICATION__MANDATORY_LABEL, oldMandatoryLabel, newMandatoryLabel);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMandatoryLabel(Expression newMandatoryLabel) {
		if (newMandatoryLabel != mandatoryLabel) {
			...
			if (mandatoryLabel != null)
				msgs = ((InternalEObject)mandatoryLabel).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.PROCESS_APPLICATION__MANDATORY_LABEL, null, msgs);
			if (newMandatoryLabel != null)
				msgs = ((InternalEObject)newMandatoryLabel).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.PROCESS_APPLICATION__MANDATORY_LABEL, null, msgs);
			msgs = basicSetMandatoryLabel(newMandatoryLabel, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.PROCESS_APPLICATION__MANDATORY_LABEL, newMandatoryLabel, newMandatoryLabel));
	}
	...
	public NotificationChain basicSetErrorTemplate(AssociatedFile newErrorTemplate, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.PROCESS_APPLICATION__ERROR_TEMPLATE, oldErrorTemplate, newErrorTemplate);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setErrorTemplate(AssociatedFile newErrorTemplate) {
		if (newErrorTemplate != errorTemplate) {
			...
			if (errorTemplate != null)
				msgs = ((InternalEObject)errorTemplate).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.PROCESS_APPLICATION__ERROR_TEMPLATE, null, msgs);
			if (newErrorTemplate != null)
				msgs = ((InternalEObject)newErrorTemplate).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.PROCESS_APPLICATION__ERROR_TEMPLATE, null, msgs);
			msgs = basicSetErrorTemplate(newErrorTemplate, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.PROCESS_APPLICATION__ERROR_TEMPLATE, newErrorTemplate, newErrorTemplate));
	}
	...
	public NotificationChain basicSetProcessTemplate(AssociatedFile newProcessTemplate, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.PROCESS_APPLICATION__PROCESS_TEMPLATE, oldProcessTemplate, newProcessTemplate);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setProcessTemplate(AssociatedFile newProcessTemplate) {
		if (newProcessTemplate != processTemplate) {
			...
			if (processTemplate != null)
				msgs = ((InternalEObject)processTemplate).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.PROCESS_APPLICATION__PROCESS_TEMPLATE, null, msgs);
			if (newProcessTemplate != null)
				msgs = ((InternalEObject)newProcessTemplate).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.PROCESS_APPLICATION__PROCESS_TEMPLATE, null, msgs);
			msgs = basicSetProcessTemplate(newProcessTemplate, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.PROCESS_APPLICATION__PROCESS_TEMPLATE, newProcessTemplate, newProcessTemplate));
	}
	...
	public NotificationChain basicSetPageTemplate(AssociatedFile newPageTemplate, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.PROCESS_APPLICATION__PAGE_TEMPLATE, oldPageTemplate, newPageTemplate);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPageTemplate(AssociatedFile newPageTemplate) {
		if (newPageTemplate != pageTemplate) {
			...
			if (pageTemplate != null)
				msgs = ((InternalEObject)pageTemplate).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.PROCESS_APPLICATION__PAGE_TEMPLATE, null, msgs);
			if (newPageTemplate != null)
				msgs = ((InternalEObject)newPageTemplate).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.PROCESS_APPLICATION__PAGE_TEMPLATE, null, msgs);
			msgs = basicSetPageTemplate(newPageTemplate, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.PROCESS_APPLICATION__PAGE_TEMPLATE, newPageTemplate, newPageTemplate));
	}
	...
	public NotificationChain basicSetConsultationTemplate(AssociatedFile newConsultationTemplate, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.PROCESS_APPLICATION__CONSULTATION_TEMPLATE, oldConsultationTemplate, newConsultationTemplate);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setConsultationTemplate(AssociatedFile newConsultationTemplate) {
		if (newConsultationTemplate != consultationTemplate) {
			...
			if (consultationTemplate != null)
				msgs = ((InternalEObject)consultationTemplate).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.PROCESS_APPLICATION__CONSULTATION_TEMPLATE, null, msgs);
			if (newConsultationTemplate != null)
				msgs = ((InternalEObject)newConsultationTemplate).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.PROCESS_APPLICATION__CONSULTATION_TEMPLATE, null, msgs);
			msgs = basicSetConsultationTemplate(newConsultationTemplate, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.PROCESS_APPLICATION__CONSULTATION_TEMPLATE, newConsultationTemplate, newConsultationTemplate));
	}
	...
	public NotificationChain basicSetLogInPage(AssociatedFile newLogInPage, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.PROCESS_APPLICATION__LOG_IN_PAGE, oldLogInPage, newLogInPage);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLogInPage(AssociatedFile newLogInPage) {
		if (newLogInPage != logInPage) {
			NotificationChain msgs = null;
			if (logInPage != null)
				msgs = ((InternalEObject)logInPage).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.PROCESS_APPLICATION__LOG_IN_PAGE, null, msgs);
			if (newLogInPage != null)
				msgs = ((InternalEObject)newLogInPage).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.PROCESS_APPLICATION__LOG_IN_PAGE, null, msgs);
			msgs = basicSetLogInPage(newLogInPage, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.PROCESS_APPLICATION__LOG_IN_PAGE, newLogInPage, newLogInPage));
	}
	...
	public NotificationChain basicSetWelcomePage(AssociatedFile newWelcomePage, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.PROCESS_APPLICATION__WELCOME_PAGE, oldWelcomePage, newWelcomePage);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setWelcomePage(AssociatedFile newWelcomePage) {
		if (newWelcomePage != welcomePage) {
			NotificationChain msgs = null;
			if (welcomePage != null)
				msgs = ((InternalEObject)welcomePage).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.PROCESS_APPLICATION__WELCOME_PAGE, null, msgs);
			if (newWelcomePage != null)
				msgs = ((InternalEObject)newWelcomePage).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.PROCESS_APPLICATION__WELCOME_PAGE, null, msgs);
			msgs = basicSetWelcomePage(newWelcomePage, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.PROCESS_APPLICATION__WELCOME_PAGE, newWelcomePage, newWelcomePage));
	}
	...
	public void setWelcomePageInternal(Boolean newWelcomePageInternal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.PROCESS_APPLICATION__WELCOME_PAGE_INTERNAL, oldWelcomePageInternal, welcomePageInternal));
	}
	...
	public void setAutoLogin(boolean newAutoLogin) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.PROCESS_APPLICATION__AUTO_LOGIN, oldAutoLogin, autoLogin));
	}
	...
	public void setAutoLoginId(String newAutoLoginId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.PROCESS_APPLICATION__AUTO_LOGIN_ID, oldAutoLoginId, autoLoginId));
	}
	...
	public NotificationChain basicSetHostPage(AssociatedFile newHostPage, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.PROCESS_APPLICATION__HOST_PAGE, oldHostPage, newHostPage);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setHostPage(AssociatedFile newHostPage) {
		if (newHostPage != hostPage) {
			NotificationChain msgs = null;
			if (hostPage != null)
				msgs = ((InternalEObject)hostPage).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.PROCESS_APPLICATION__HOST_PAGE, null, msgs);
			if (newHostPage != null)
				msgs = ((InternalEObject)newHostPage).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.PROCESS_APPLICATION__HOST_PAGE, null, msgs);
			msgs = basicSetHostPage(newHostPage, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.PROCESS_APPLICATION__HOST_PAGE, newHostPage, newHostPage));
	}
	...
	public void setBasedOnLookAndFeel(String newBasedOnLookAndFeel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.PROCESS_APPLICATION__BASED_ON_LOOK_AND_FEEL, oldBasedOnLookAndFeel, basedOnLookAndFeel));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == CSSCustomizable.class) {
			switch (derivedFeatureID) {
				case ProcessPackage.PROCESS_APPLICATION__HTML_ATTRIBUTES: return FormPackage.CSS_CUSTOMIZABLE__HTML_ATTRIBUTES;
				default: return -1;
			}
		}
		if (baseClass == MandatoryFieldsCustomization.class) {
			switch (derivedFeatureID) {
				case ProcessPackage.PROCESS_APPLICATION__MANDATORY_SYMBOL: return FormPackage.MANDATORY_FIELDS_CUSTOMIZATION__MANDATORY_SYMBOL;
				case ProcessPackage.PROCESS_APPLICATION__MANDATORY_LABEL: return FormPackage.MANDATORY_FIELDS_CUSTOMIZATION__MANDATORY_LABEL;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == CSSCustomizable.class) {
			switch (baseFeatureID) {
				case FormPackage.CSS_CUSTOMIZABLE__HTML_ATTRIBUTES: return ProcessPackage.PROCESS_APPLICATION__HTML_ATTRIBUTES;
				default: return -1;
			}
		}
		if (baseClass == MandatoryFieldsCustomization.class) {
			switch (baseFeatureID) {
				case FormPackage.MANDATORY_FIELDS_CUSTOMIZATION__MANDATORY_SYMBOL: return ProcessPackage.PROCESS_APPLICATION__MANDATORY_SYMBOL;
				case FormPackage.MANDATORY_FIELDS_CUSTOMIZATION__MANDATORY_LABEL: return ProcessPackage.PROCESS_APPLICATION__MANDATORY_LABEL;
				default: return -1;
			}
		}
