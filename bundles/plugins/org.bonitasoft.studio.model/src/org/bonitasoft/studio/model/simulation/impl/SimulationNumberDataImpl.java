 ...
 * </p>
 * <ul>
 * <li>{@link org.bonitasoft.studio.model.simulation.impl.SimulationNumberDataImpl#isExpressionBased <em>Expression
 * Based</em>}</li>
...
public class SimulationNumberDataImpl extends SimulationElementImpl implements SimulationNumberData {
    ...
    public void setExpressionBased(boolean newExpressionBased) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SimulationPackage.SIMULATION_NUMBER_DATA__EXPRESSION_BASED,
    ...
    public NotificationChain basicSetExpression(Expression newExpression, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    SimulationPackage.SIMULATION_NUMBER_DATA__EXPRESSION, oldExpression, newExpression);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newExpression != expression) {
            ...
            if (expression != null)
                msgs = ((InternalEObject) expression).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - SimulationPackage.SIMULATION_NUMBER_DATA__EXPRESSION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, SimulationPackage.SIMULATION_NUMBER_DATA__EXPRESSION,
    ...
    public EList<SimulationNumberRange> getRanges() {
        if (ranges == null) {
            ranges = new EObjectContainmentEList<SimulationNumberRange>(SimulationNumberRange.class, this,
                    SimulationPackage.SIMULATION_NUMBER_DATA__RANGES);
        }
        return ranges;
    }
