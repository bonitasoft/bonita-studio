...
public class KPIFieldImpl extends EObjectImpl implements KPIField {
    ...
    public void setFieldName(String newFieldName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, KpiPackage.KPI_FIELD__FIELD_NAME, oldFieldName,
                    fieldName));
    }
    ...
    public void setFieldType(String newFieldType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, KpiPackage.KPI_FIELD__FIELD_TYPE, oldFieldType,
                    fieldType));
    }
    ...
    public void setUseQuotes(boolean newUseQuotes) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, KpiPackage.KPI_FIELD__USE_QUOTES, oldUseQuotes,
                    useQuotes));
    }
