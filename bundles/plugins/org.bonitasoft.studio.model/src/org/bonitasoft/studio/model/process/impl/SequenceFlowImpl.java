...
public class SequenceFlowImpl extends ConnectionImpl implements SequenceFlow {
    ...
    public void setIsDefault(boolean newIsDefault) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.SEQUENCE_FLOW__IS_DEFAULT, oldIsDefault,
                    isDefault));
    }
    ...
    public void setConditionType(SequenceFlowConditionType newConditionType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.SEQUENCE_FLOW__CONDITION_TYPE,
    ...
    public NotificationChain basicSetDecisionTable(DecisionTable newDecisionTable, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.SEQUENCE_FLOW__DECISION_TABLE, oldDecisionTable, newDecisionTable);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setDecisionTable(DecisionTable newDecisionTable) {
        if (newDecisionTable != decisionTable) {
            ...
            if (decisionTable != null)
                msgs = ((InternalEObject) decisionTable).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.SEQUENCE_FLOW__DECISION_TABLE, null, msgs);
            if (newDecisionTable != null)
                msgs = ((InternalEObject) newDecisionTable).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.SEQUENCE_FLOW__DECISION_TABLE, null, msgs);
            msgs = basicSetDecisionTable(newDecisionTable, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.SEQUENCE_FLOW__DECISION_TABLE,
    ...
    public NotificationChain basicSetCondition(Expression newCondition, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.SEQUENCE_FLOW__CONDITION, oldCondition, newCondition);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newCondition != condition) {
            ...
            if (condition != null)
                msgs = ((InternalEObject) condition).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.SEQUENCE_FLOW__CONDITION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.SEQUENCE_FLOW__CONDITION, newCondition,
                    newCondition));
    }
    ...
    public void setPathToken(String newPathToken) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.SEQUENCE_FLOW__PATH_TOKEN, oldPathToken,
                    pathToken));
    }
