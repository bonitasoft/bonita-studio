 ...
 * <li>{@link org.bonitasoft.studio.model.process.impl.ActivityImpl#getCardinalityExpression <em>Cardinality
 * Expression</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.process.impl.ActivityImpl#getCollectionDataToMultiInstantiate <em>Collection Data
 * To Multi Instantiate</em>}</li>
 ...
 * <li>{@link org.bonitasoft.studio.model.process.impl.ActivityImpl#getListDataContainingOutputResults <em>List Data
 * Containing Output Results</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.process.impl.ActivityImpl#getCompletionCondition <em>Completion
 * Condition</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.process.impl.ActivityImpl#isStoreOutput <em>Store Output</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.process.impl.ActivityImpl#getBoundaryIntermediateEvents <em>Boundary Intermediate
 * Events</em>}</li>
 * </ul>
 *
 * @generated
...
public class ActivityImpl extends FlowElementImpl implements Activity {
    ...
    /**
     * The cached value of the '{@link #getCollectionDataToMultiInstantiate() <em>Collection Data To Multi Instantiate</em>}'
     * reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * The cached value of the '{@link #getListDataContainingOutputResults() <em>List Data Containing Output Results</em>}'
     * reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * The cached value of the '{@link #getBoundaryIntermediateEvents() <em>Boundary Intermediate Events</em>}' containment
     * reference list.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    public void setTestBefore(Boolean newTestBefore) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.ACTIVITY__TEST_BEFORE, oldTestBefore,
                    testBefore));
    }
    ...
    public NotificationChain basicSetLoopCondition(Expression newLoopCondition, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.ACTIVITY__LOOP_CONDITION, oldLoopCondition, newLoopCondition);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newLoopCondition != loopCondition) {
            ...
            if (loopCondition != null)
                msgs = ((InternalEObject) loopCondition).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.ACTIVITY__LOOP_CONDITION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.ACTIVITY__LOOP_CONDITION, newLoopCondition,
                    newLoopCondition));
    }
    ...
    public NotificationChain basicSetLoopMaximum(Expression newLoopMaximum, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.ACTIVITY__LOOP_MAXIMUM, oldLoopMaximum, newLoopMaximum);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newLoopMaximum != loopMaximum) {
            ...
            if (loopMaximum != null)
                msgs = ((InternalEObject) loopMaximum).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.ACTIVITY__LOOP_MAXIMUM, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.ACTIVITY__LOOP_MAXIMUM, newLoopMaximum,
                    newLoopMaximum));
    }
    ...
    public void setUseCardinality(boolean newUseCardinality) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.ACTIVITY__USE_CARDINALITY,
                    oldUseCardinality, useCardinality));
    }
    ...
    public NotificationChain basicSetCardinalityExpression(Expression newCardinalityExpression, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.ACTIVITY__CARDINALITY_EXPRESSION, oldCardinalityExpression, newCardinalityExpression);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setCardinalityExpression(Expression newCardinalityExpression) {
        if (newCardinalityExpression != cardinalityExpression) {
            ...
            if (cardinalityExpression != null)
                msgs = ((InternalEObject) cardinalityExpression).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.ACTIVITY__CARDINALITY_EXPRESSION, null, msgs);
            if (newCardinalityExpression != null)
                msgs = ((InternalEObject) newCardinalityExpression).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.ACTIVITY__CARDINALITY_EXPRESSION, null, msgs);
            msgs = basicSetCardinalityExpression(newCardinalityExpression, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.ACTIVITY__CARDINALITY_EXPRESSION,
                    newCardinalityExpression, newCardinalityExpression));
    }
            ...
            if (collectionDataToMultiInstantiate != oldCollectionDataToMultiInstantiate) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            ProcessPackage.ACTIVITY__COLLECTION_DATA_TO_MULTI_INSTANTIATE,
                            oldCollectionDataToMultiInstantiate, collectionDataToMultiInstantiate));
            }
        }
    ...
    public void setCollectionDataToMultiInstantiate(Data newCollectionDataToMultiInstantiate) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.ACTIVITY__COLLECTION_DATA_TO_MULTI_INSTANTIATE, oldCollectionDataToMultiInstantiate,
    ...
    public NotificationChain basicSetIteratorExpression(Expression newIteratorExpression, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.ACTIVITY__ITERATOR_EXPRESSION, oldIteratorExpression, newIteratorExpression);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setIteratorExpression(Expression newIteratorExpression) {
        if (newIteratorExpression != iteratorExpression) {
            ...
            if (iteratorExpression != null)
                msgs = ((InternalEObject) iteratorExpression).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.ACTIVITY__ITERATOR_EXPRESSION, null, msgs);
            if (newIteratorExpression != null)
                msgs = ((InternalEObject) newIteratorExpression).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.ACTIVITY__ITERATOR_EXPRESSION, null, msgs);
            msgs = basicSetIteratorExpression(newIteratorExpression, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.ACTIVITY__ITERATOR_EXPRESSION,
                    newIteratorExpression, newIteratorExpression));
    }
    ...
    public Data getOutputData() {
        if (outputData != null && outputData.eIsProxy()) {
            ...
            if (outputData != oldOutputData) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, ProcessPackage.ACTIVITY__OUTPUT_DATA,
    ...
    public void setOutputData(Data newOutputData) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.ACTIVITY__OUTPUT_DATA, oldOutputData,
                    outputData));
    }
    ...
    public Data getListDataContainingOutputResults() {
        if (listDataContainingOutputResults != null && listDataContainingOutputResults.eIsProxy()) {
            ...
            if (listDataContainingOutputResults != oldListDataContainingOutputResults) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            ProcessPackage.ACTIVITY__LIST_DATA_CONTAINING_OUTPUT_RESULTS, oldListDataContainingOutputResults,
    ...
    public NotificationChain basicSetCompletionCondition(Expression newCompletionCondition, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.ACTIVITY__COMPLETION_CONDITION, oldCompletionCondition, newCompletionCondition);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newCompletionCondition != completionCondition) {
            ...
            if (completionCondition != null)
                msgs = ((InternalEObject) completionCondition).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.ACTIVITY__COMPLETION_CONDITION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.ACTIVITY__COMPLETION_CONDITION,
    ...
    public void setStoreOutput(boolean newStoreOutput) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.ACTIVITY__STORE_OUTPUT, oldStoreOutput,
                    storeOutput));
    }
    ...
    public EList<BoundaryEvent> getBoundaryIntermediateEvents() {
        if (boundaryIntermediateEvents == null) {
            boundaryIntermediateEvents = new EObjectContainmentEList<BoundaryEvent>(BoundaryEvent.class, this,
                    ProcessPackage.ACTIVITY__BOUNDARY_INTERMEDIATE_EVENTS);
        }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            ...
            case ProcessPackage.ACTIVITY__COLLECTION_DATA_TO_MULTI_INSTANTIATE:
                if (resolve)
                    return getCollectionDataToMultiInstantiate();
            ...
            case ProcessPackage.ACTIVITY__LIST_DATA_CONTAINING_OUTPUT_RESULTS:
                if (resolve)
                    return getListDataContainingOutputResults();
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == OperationContainer.class) {
            switch (derivedFeatureID) {
                case ProcessPackage.ACTIVITY__OPERATIONS:
                    return ProcessPackage.OPERATION_CONTAINER__OPERATIONS;
                default:
                    return -1;
            }
        }
        if (baseClass == MultiInstantiable.class) {
            switch (derivedFeatureID) {
                case ProcessPackage.ACTIVITY__TYPE:
                    return ProcessPackage.MULTI_INSTANTIABLE__TYPE;
                case ProcessPackage.ACTIVITY__TEST_BEFORE:
                    return ProcessPackage.MULTI_INSTANTIABLE__TEST_BEFORE;
                case ProcessPackage.ACTIVITY__LOOP_CONDITION:
                    return ProcessPackage.MULTI_INSTANTIABLE__LOOP_CONDITION;
                case ProcessPackage.ACTIVITY__LOOP_MAXIMUM:
                    return ProcessPackage.MULTI_INSTANTIABLE__LOOP_MAXIMUM;
                case ProcessPackage.ACTIVITY__USE_CARDINALITY:
                    return ProcessPackage.MULTI_INSTANTIABLE__USE_CARDINALITY;
                case ProcessPackage.ACTIVITY__CARDINALITY_EXPRESSION:
                    return ProcessPackage.MULTI_INSTANTIABLE__CARDINALITY_EXPRESSION;
                case ProcessPackage.ACTIVITY__COLLECTION_DATA_TO_MULTI_INSTANTIATE:
                    return ProcessPackage.MULTI_INSTANTIABLE__COLLECTION_DATA_TO_MULTI_INSTANTIATE;
                case ProcessPackage.ACTIVITY__ITERATOR_EXPRESSION:
                    return ProcessPackage.MULTI_INSTANTIABLE__ITERATOR_EXPRESSION;
                case ProcessPackage.ACTIVITY__OUTPUT_DATA:
                    return ProcessPackage.MULTI_INSTANTIABLE__OUTPUT_DATA;
                case ProcessPackage.ACTIVITY__LIST_DATA_CONTAINING_OUTPUT_RESULTS:
                    return ProcessPackage.MULTI_INSTANTIABLE__LIST_DATA_CONTAINING_OUTPUT_RESULTS;
                case ProcessPackage.ACTIVITY__COMPLETION_CONDITION:
                    return ProcessPackage.MULTI_INSTANTIABLE__COMPLETION_CONDITION;
                case ProcessPackage.ACTIVITY__STORE_OUTPUT:
                    return ProcessPackage.MULTI_INSTANTIABLE__STORE_OUTPUT;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == DataAware.class) {
            switch (baseFeatureID) {
                case ProcessPackage.DATA_AWARE__DATA:
                    return ProcessPackage.ACTIVITY__DATA;
                default:
                    return -1;
            }
        }
        if (baseClass == ConnectableElement.class) {
            switch (baseFeatureID) {
                case ProcessPackage.CONNECTABLE_ELEMENT__CONNECTORS:
                    return ProcessPackage.ACTIVITY__CONNECTORS;
                case ProcessPackage.CONNECTABLE_ELEMENT__KPIS:
                    return ProcessPackage.ACTIVITY__KPIS;
                default:
                    return -1;
            }
        }
        if (baseClass == OperationContainer.class) {
            switch (baseFeatureID) {
                case ProcessPackage.OPERATION_CONTAINER__OPERATIONS:
                    return ProcessPackage.ACTIVITY__OPERATIONS;
                default:
                    return -1;
            }
        }
