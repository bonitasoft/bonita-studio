...
public class ConnectionImpl extends EObjectImpl implements Connection {
	...
	public void setProbability(double newProbability) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.CONNECTION__PROBABILITY, oldProbability, probability));
	}
	...
	public void setDataBased(boolean newDataBased) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.CONNECTION__DATA_BASED, oldDataBased, dataBased));
	}
	...
	public void setUseExpression(boolean newUseExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.CONNECTION__USE_EXPRESSION, oldUseExpression, useExpression));
	}
	...
	public NotificationChain basicSetExpression(Expression newExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.CONNECTION__EXPRESSION, oldExpression, newExpression);
	...
	public void setExpression(Expression newExpression) {
		if (newExpression != expression) {
			...
			if (expression != null)
				msgs = ((InternalEObject)expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.CONNECTION__EXPRESSION, null, msgs);
			if (newExpression != null)
				msgs = ((InternalEObject)newExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.CONNECTION__EXPRESSION, null, msgs);
			msgs = basicSetExpression(newExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.CONNECTION__EXPRESSION, newExpression, newExpression));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == SimulationTransition.class) {
			switch (derivedFeatureID) {
				case ProcessPackage.CONNECTION__PROBABILITY: return SimulationPackage.SIMULATION_TRANSITION__PROBABILITY;
				case ProcessPackage.CONNECTION__DATA_BASED: return SimulationPackage.SIMULATION_TRANSITION__DATA_BASED;
				case ProcessPackage.CONNECTION__USE_EXPRESSION: return SimulationPackage.SIMULATION_TRANSITION__USE_EXPRESSION;
				case ProcessPackage.CONNECTION__EXPRESSION: return SimulationPackage.SIMULATION_TRANSITION__EXPRESSION;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == SimulationTransition.class) {
			switch (baseFeatureID) {
				case SimulationPackage.SIMULATION_TRANSITION__PROBABILITY: return ProcessPackage.CONNECTION__PROBABILITY;
				case SimulationPackage.SIMULATION_TRANSITION__DATA_BASED: return ProcessPackage.CONNECTION__DATA_BASED;
				case SimulationPackage.SIMULATION_TRANSITION__USE_EXPRESSION: return ProcessPackage.CONNECTION__USE_EXPRESSION;
				case SimulationPackage.SIMULATION_TRANSITION__EXPRESSION: return ProcessPackage.CONNECTION__EXPRESSION;
				default: return -1;
			}
		}
