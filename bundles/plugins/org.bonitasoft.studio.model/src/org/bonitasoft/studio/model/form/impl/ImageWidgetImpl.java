 ...
 * <li>{@link org.bonitasoft.studio.model.form.impl.ImageWidgetImpl#getTextAnnotationAttachment <em>Text Annotation
 * Attachment</em>}</li>
 ...
 * <li>{@link org.bonitasoft.studio.model.form.impl.ImageWidgetImpl#isAllowHTMLForDisplayLabel <em>Allow HTML For Display
 * Label</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.ImageWidgetImpl#getDependOn <em>Depend On</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.ImageWidgetImpl#isDisplayDependentWidgetOnlyOnEventTriggered <em>Display
 ...
 * <li>{@link org.bonitasoft.studio.model.form.impl.ImageWidgetImpl#isInjectWidgetCondition <em>Inject Widget
 * Condition</em>}</li>
 ...
 * <li>{@link org.bonitasoft.studio.model.form.impl.ImageWidgetImpl#getDisplayDependentWidgetOnlyAfterFirstEventTriggeredAndCondition
 * <em>Display Dependent Widget Only After First Event Triggered And Condition</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.ImageWidgetImpl#getDisplayAfterEventDependsOnConditionScript <em>Display
 ...
 * <li>{@link org.bonitasoft.studio.model.form.impl.ImageWidgetImpl#getAfterEventExpression <em>After Event
 * Expression</em>}</li>
 ...
 * <li>{@link org.bonitasoft.studio.model.form.impl.ImageWidgetImpl#isLimitNumberOfDuplication <em>Limit Number Of
 * Duplication</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.ImageWidgetImpl#isLimitMinNumberOfDuplication <em>Limit Min Number Of
 * Duplication</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.ImageWidgetImpl#getMaxNumberOfDuplication <em>Max Number Of
 * Duplication</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.ImageWidgetImpl#getMinNumberOfDuplication <em>Min Number Of
 * Duplication</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.ImageWidgetImpl#getDisplayLabelForAdd <em>Display Label For
 * Add</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.ImageWidgetImpl#getTooltipForAdd <em>Tooltip For Add</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.ImageWidgetImpl#getDisplayLabelForRemove <em>Display Label For
 * Remove</em>}</li>
...
public class ImageWidgetImpl extends EObjectImpl implements ImageWidget {
    ...
    public void setDocumentation(String newDocumentation) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_WIDGET__DOCUMENTATION, oldDocumentation,
                    documentation));
    }
    ...
    public EList<TextAnnotationAttachment> getTextAnnotationAttachment() {
        if (textAnnotationAttachment == null) {
            textAnnotationAttachment = new EObjectContainmentWithInverseEList<TextAnnotationAttachment>(
                    TextAnnotationAttachment.class, this, FormPackage.IMAGE_WIDGET__TEXT_ANNOTATION_ATTACHMENT,
    ...
    public EMap<String, String> getHtmlAttributes() {
        if (htmlAttributes == null) {
            htmlAttributes = new EcoreEMap<String, String>(EcorePackage.Literals.ESTRING_TO_STRING_MAP_ENTRY,
                    EStringToStringMapEntryImpl.class, this, FormPackage.IMAGE_WIDGET__HTML_ATTRIBUTES);
        }
    ...
    public NotificationChain basicSetWidgetLayoutInfo(WidgetLayoutInfo newWidgetLayoutInfo, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.IMAGE_WIDGET__WIDGET_LAYOUT_INFO, oldWidgetLayoutInfo, newWidgetLayoutInfo);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newWidgetLayoutInfo != widgetLayoutInfo) {
            ...
            if (widgetLayoutInfo != null)
                msgs = ((InternalEObject) widgetLayoutInfo).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.IMAGE_WIDGET__WIDGET_LAYOUT_INFO, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_WIDGET__WIDGET_LAYOUT_INFO,
    ...
    public void setShowDisplayLabel(Boolean newShowDisplayLabel) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_WIDGET__SHOW_DISPLAY_LABEL,
    ...
    public void setAllowHTMLForDisplayLabel(boolean newAllowHTMLForDisplayLabel) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_WIDGET__ALLOW_HTML_FOR_DISPLAY_LABEL,
    ...
    public EList<WidgetDependency> getDependOn() {
        if (dependOn == null) {
            dependOn = new EObjectContainmentEList<WidgetDependency>(WidgetDependency.class, this,
                    FormPackage.IMAGE_WIDGET__DEPEND_ON);
        }
        return dependOn;
    }
    ...
    public void setDisplayDependentWidgetOnlyOnEventTriggered(boolean newDisplayDependentWidgetOnlyOnEventTriggered) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    FormPackage.IMAGE_WIDGET__DISPLAY_DEPENDENT_WIDGET_ONLY_ON_EVENT_TRIGGERED,
    ...
    public EList<WidgetDependency> getParentOf() {
        if (parentOf == null) {
            parentOf = new EObjectContainmentEList<WidgetDependency>(WidgetDependency.class, this,
                    FormPackage.IMAGE_WIDGET__PARENT_OF);
        }
        return parentOf;
    }
    ...
    public void setMandatory(boolean newMandatory) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_WIDGET__MANDATORY, oldMandatory,
                    mandatory));
    }
    ...
    public void setReadOnly(boolean newReadOnly) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_WIDGET__READ_ONLY, oldReadOnly,
                    readOnly));
    }
    ...
    public void setLabelPosition(LabelPosition newLabelPosition) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_WIDGET__LABEL_POSITION, oldLabelPosition,
                    labelPosition));
    }
    ...
    public void setRealHtmlAttributes(String newRealHtmlAttributes) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_WIDGET__REAL_HTML_ATTRIBUTES,
    ...
    public void setInjectWidgetCondition(boolean newInjectWidgetCondition) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_WIDGET__INJECT_WIDGET_CONDITION,
    ...
    public void setReturnTypeModifier(String newReturnTypeModifier) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_WIDGET__RETURN_TYPE_MODIFIER,
    ...
    public NotificationChain basicSetDisplayDependentWidgetOnlyAfterFirstEventTriggeredAndCondition(
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.IMAGE_WIDGET__DISPLAY_DEPENDENT_WIDGET_ONLY_AFTER_FIRST_EVENT_TRIGGERED_AND_CONDITION,
    ...
    public NotificationChain basicSetDisplayAfterEventDependsOnConditionScript(
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.IMAGE_WIDGET__DISPLAY_AFTER_EVENT_DEPENDS_ON_CONDITION_SCRIPT,
        ...
        if (newDisplayAfterEventDependsOnConditionScript != displayAfterEventDependsOnConditionScript) {
            ...
            if (displayAfterEventDependsOnConditionScript != null)
                msgs = ((InternalEObject) displayAfterEventDependsOnConditionScript).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.IMAGE_WIDGET__DISPLAY_AFTER_EVENT_DEPENDS_ON_CONDITION_SCRIPT,
                        null, msgs);
    ...
    public NotificationChain basicSetInputExpression(Expression newInputExpression, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.IMAGE_WIDGET__INPUT_EXPRESSION, oldInputExpression, newInputExpression);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newInputExpression != inputExpression) {
            ...
            if (inputExpression != null)
                msgs = ((InternalEObject) inputExpression).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.IMAGE_WIDGET__INPUT_EXPRESSION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_WIDGET__INPUT_EXPRESSION,
    ...
    public NotificationChain basicSetAfterEventExpression(Expression newAfterEventExpression, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.IMAGE_WIDGET__AFTER_EVENT_EXPRESSION, oldAfterEventExpression, newAfterEventExpression);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newAfterEventExpression != afterEventExpression) {
            ...
            if (afterEventExpression != null)
                msgs = ((InternalEObject) afterEventExpression).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.IMAGE_WIDGET__AFTER_EVENT_EXPRESSION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_WIDGET__AFTER_EVENT_EXPRESSION,
    ...
    public NotificationChain basicSetTooltip(Expression newTooltip, NotificationChain msgs) {
        ...
        tooltip = newTooltip;
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_WIDGET__TOOLTIP,
        ...
        if (newTooltip != tooltip) {
            ...
            if (tooltip != null)
                msgs = ((InternalEObject) tooltip).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.IMAGE_WIDGET__TOOLTIP, null, msgs);
            if (newTooltip != null)
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_WIDGET__TOOLTIP, newTooltip,
                    newTooltip));
    }
    ...
    public NotificationChain basicSetHelpMessage(Expression newHelpMessage, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.IMAGE_WIDGET__HELP_MESSAGE, oldHelpMessage, newHelpMessage);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newHelpMessage != helpMessage) {
            ...
            if (helpMessage != null)
                msgs = ((InternalEObject) helpMessage).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.IMAGE_WIDGET__HELP_MESSAGE, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_WIDGET__HELP_MESSAGE, newHelpMessage,
                    newHelpMessage));
    }
    ...
    public NotificationChain basicSetDisplayLabel(Expression newDisplayLabel, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.IMAGE_WIDGET__DISPLAY_LABEL, oldDisplayLabel, newDisplayLabel);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newDisplayLabel != displayLabel) {
            ...
            if (displayLabel != null)
                msgs = ((InternalEObject) displayLabel).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.IMAGE_WIDGET__DISPLAY_LABEL, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_WIDGET__DISPLAY_LABEL, newDisplayLabel,
                    newDisplayLabel));
    }
    ...
    public NotificationChain basicSetInjectWidgetScript(Expression newInjectWidgetScript, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.IMAGE_WIDGET__INJECT_WIDGET_SCRIPT, oldInjectWidgetScript, newInjectWidgetScript);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newInjectWidgetScript != injectWidgetScript) {
            ...
            if (injectWidgetScript != null)
                msgs = ((InternalEObject) injectWidgetScript).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.IMAGE_WIDGET__INJECT_WIDGET_SCRIPT, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_WIDGET__INJECT_WIDGET_SCRIPT,
    ...
    public NotificationChain basicSetAction(Operation newAction, NotificationChain msgs) {
        ...
        action = newAction;
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_WIDGET__ACTION,
                    oldAction, newAction);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newAction != action) {
            ...
            if (action != null)
                msgs = ((InternalEObject) action).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.IMAGE_WIDGET__ACTION, null, msgs);
            if (newAction != null)
    ...
    public void setDuplicate(boolean newDuplicate) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_WIDGET__DUPLICATE, oldDuplicate,
                    duplicate));
    }
    ...
    public void setLimitNumberOfDuplication(boolean newLimitNumberOfDuplication) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_WIDGET__LIMIT_NUMBER_OF_DUPLICATION,
    ...
    public void setLimitMinNumberOfDuplication(boolean newLimitMinNumberOfDuplication) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_WIDGET__LIMIT_MIN_NUMBER_OF_DUPLICATION,
    ...
    public NotificationChain basicSetMaxNumberOfDuplication(Expression newMaxNumberOfDuplication, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.IMAGE_WIDGET__MAX_NUMBER_OF_DUPLICATION, oldMaxNumberOfDuplication,
        ...
        if (newMaxNumberOfDuplication != maxNumberOfDuplication) {
            ...
            if (maxNumberOfDuplication != null)
                msgs = ((InternalEObject) maxNumberOfDuplication).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.IMAGE_WIDGET__MAX_NUMBER_OF_DUPLICATION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_WIDGET__MAX_NUMBER_OF_DUPLICATION,
    ...
    public NotificationChain basicSetMinNumberOfDuplication(Expression newMinNumberOfDuplication, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.IMAGE_WIDGET__MIN_NUMBER_OF_DUPLICATION, oldMinNumberOfDuplication,
        ...
        if (newMinNumberOfDuplication != minNumberOfDuplication) {
            ...
            if (minNumberOfDuplication != null)
                msgs = ((InternalEObject) minNumberOfDuplication).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.IMAGE_WIDGET__MIN_NUMBER_OF_DUPLICATION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_WIDGET__MIN_NUMBER_OF_DUPLICATION,
    ...
    public NotificationChain basicSetDisplayLabelForAdd(Expression newDisplayLabelForAdd, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.IMAGE_WIDGET__DISPLAY_LABEL_FOR_ADD, oldDisplayLabelForAdd, newDisplayLabelForAdd);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newDisplayLabelForAdd != displayLabelForAdd) {
            ...
            if (displayLabelForAdd != null)
                msgs = ((InternalEObject) displayLabelForAdd).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.IMAGE_WIDGET__DISPLAY_LABEL_FOR_ADD, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_WIDGET__DISPLAY_LABEL_FOR_ADD,
    ...
    public NotificationChain basicSetTooltipForAdd(Expression newTooltipForAdd, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.IMAGE_WIDGET__TOOLTIP_FOR_ADD, oldTooltipForAdd, newTooltipForAdd);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newTooltipForAdd != tooltipForAdd) {
            ...
            if (tooltipForAdd != null)
                msgs = ((InternalEObject) tooltipForAdd).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.IMAGE_WIDGET__TOOLTIP_FOR_ADD, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_WIDGET__TOOLTIP_FOR_ADD,
    ...
    public NotificationChain basicSetDisplayLabelForRemove(Expression newDisplayLabelForRemove, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.IMAGE_WIDGET__DISPLAY_LABEL_FOR_REMOVE, oldDisplayLabelForRemove, newDisplayLabelForRemove);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newDisplayLabelForRemove != displayLabelForRemove) {
            ...
            if (displayLabelForRemove != null)
                msgs = ((InternalEObject) displayLabelForRemove).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.IMAGE_WIDGET__DISPLAY_LABEL_FOR_REMOVE, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_WIDGET__DISPLAY_LABEL_FOR_REMOVE,
    ...
    public NotificationChain basicSetTooltipForRemove(Expression newTooltipForRemove, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.IMAGE_WIDGET__TOOLTIP_FOR_REMOVE, oldTooltipForRemove, newTooltipForRemove);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newTooltipForRemove != tooltipForRemove) {
            ...
            if (tooltipForRemove != null)
                msgs = ((InternalEObject) tooltipForRemove).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.IMAGE_WIDGET__TOOLTIP_FOR_REMOVE, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_WIDGET__TOOLTIP_FOR_REMOVE,
    ...
    public void setIsADocument(boolean newIsADocument) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_WIDGET__IS_ADOCUMENT, oldIsADocument,
                    isADocument));
    }
    ...
    public Document getDocument() {
        if (document != null && document.eIsProxy()) {
            ...
            if (document != oldDocument) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, FormPackage.IMAGE_WIDGET__DOCUMENT,
    ...
    public void setDocument(Document newDocument) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_WIDGET__DOCUMENT, oldDocument,
                    document));
    }
    ...
    public NotificationChain basicSetImgPath(Expression newImgPath, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.IMAGE_WIDGET__IMG_PATH, oldImgPath, newImgPath);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setImgPath(Expression newImgPath) {
        if (newImgPath != imgPath) {
            NotificationChain msgs = null;
            if (imgPath != null)
                msgs = ((InternalEObject) imgPath).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.IMAGE_WIDGET__IMG_PATH, null, msgs);
            if (newImgPath != null)
                msgs = ((InternalEObject) newImgPath).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.IMAGE_WIDGET__IMG_PATH, null, msgs);
            msgs = basicSetImgPath(newImgPath, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_WIDGET__IMG_PATH, newImgPath,
                    newImgPath));
    }
        ...
        if (baseClass == CSSCustomizable.class) {
            switch (baseFeatureID) {
                case FormPackage.CSS_CUSTOMIZABLE__HTML_ATTRIBUTES:
                    return FormPackage.IMAGE_WIDGET__HTML_ATTRIBUTES;
                default:
                    return -1;
            }
        }
        if (baseClass == Duplicable.class) {
            switch (baseFeatureID) {
                case FormPackage.DUPLICABLE__DUPLICATE:
                    return FormPackage.IMAGE_WIDGET__DUPLICATE;
                case FormPackage.DUPLICABLE__LIMIT_NUMBER_OF_DUPLICATION:
                    return FormPackage.IMAGE_WIDGET__LIMIT_NUMBER_OF_DUPLICATION;
                case FormPackage.DUPLICABLE__LIMIT_MIN_NUMBER_OF_DUPLICATION:
                    return FormPackage.IMAGE_WIDGET__LIMIT_MIN_NUMBER_OF_DUPLICATION;
                case FormPackage.DUPLICABLE__MAX_NUMBER_OF_DUPLICATION:
                    return FormPackage.IMAGE_WIDGET__MAX_NUMBER_OF_DUPLICATION;
                case FormPackage.DUPLICABLE__MIN_NUMBER_OF_DUPLICATION:
                    return FormPackage.IMAGE_WIDGET__MIN_NUMBER_OF_DUPLICATION;
                case FormPackage.DUPLICABLE__DISPLAY_LABEL_FOR_ADD:
                    return FormPackage.IMAGE_WIDGET__DISPLAY_LABEL_FOR_ADD;
                case FormPackage.DUPLICABLE__TOOLTIP_FOR_ADD:
                    return FormPackage.IMAGE_WIDGET__TOOLTIP_FOR_ADD;
                case FormPackage.DUPLICABLE__DISPLAY_LABEL_FOR_REMOVE:
                    return FormPackage.IMAGE_WIDGET__DISPLAY_LABEL_FOR_REMOVE;
                case FormPackage.DUPLICABLE__TOOLTIP_FOR_REMOVE:
                    return FormPackage.IMAGE_WIDGET__TOOLTIP_FOR_REMOVE;
                default:
                    return -1;
            }
        }
