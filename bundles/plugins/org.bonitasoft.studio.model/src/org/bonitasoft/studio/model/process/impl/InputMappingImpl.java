...
public class InputMappingImpl extends EObjectImpl implements InputMapping {
    ...
    public NotificationChain basicSetProcessSource(Expression newProcessSource, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.INPUT_MAPPING__PROCESS_SOURCE, oldProcessSource, newProcessSource);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setProcessSource(Expression newProcessSource) {
        if (newProcessSource != processSource) {
            ...
            if (processSource != null)
                msgs = ((InternalEObject) processSource).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.INPUT_MAPPING__PROCESS_SOURCE, null, msgs);
            if (newProcessSource != null)
                msgs = ((InternalEObject) newProcessSource).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.INPUT_MAPPING__PROCESS_SOURCE, null, msgs);
            msgs = basicSetProcessSource(newProcessSource, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.INPUT_MAPPING__PROCESS_SOURCE,
                    newProcessSource, newProcessSource));
    }
    ...
    public void setSubprocessTarget(String newSubprocessTarget) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.INPUT_MAPPING__SUBPROCESS_TARGET,
                    oldSubprocessTarget, subprocessTarget));
    }
    ...
    public void setAssignationType(InputMappingAssignationType newAssignationType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.INPUT_MAPPING__ASSIGNATION_TYPE,
                    oldAssignationType, assignationType));
    }
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            ...
            case ProcessPackage.INPUT_MAPPING__SUBPROCESS_TARGET:
                return SUBPROCESS_TARGET_EDEFAULT == null ? subprocessTarget != null
                        : !SUBPROCESS_TARGET_EDEFAULT.equals(subprocessTarget);
            case ProcessPackage.INPUT_MAPPING__ASSIGNATION_TYPE:
