 ...
 * </p>
 * <ul>
 * <li>{@link org.bonitasoft.studio.model.process.impl.CorrelationAssociationImpl#getCorrelationExpression <em>Correlation
 * Expression</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.process.impl.CorrelationAssociationImpl#getCorrelationKey <em>Correlation
 * Key</em>}</li>
 * </ul>
 *
 * @generated
...
public class CorrelationAssociationImpl extends EObjectImpl implements CorrelationAssociation {
     ...
     * @generated
     */
    public NotificationChain basicSetCorrelationExpression(AbstractExpression newCorrelationExpression,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.CORRELATION_ASSOCIATION__CORRELATION_EXPRESSION, oldCorrelationExpression,
    ...
    public void setCorrelationExpression(AbstractExpression newCorrelationExpression) {
        if (newCorrelationExpression != correlationExpression) {
            ...
            if (correlationExpression != null)
                msgs = ((InternalEObject) correlationExpression).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.CORRELATION_ASSOCIATION__CORRELATION_EXPRESSION, null, msgs);
            if (newCorrelationExpression != null)
                msgs = ((InternalEObject) newCorrelationExpression).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.CORRELATION_ASSOCIATION__CORRELATION_EXPRESSION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.CORRELATION_ASSOCIATION__CORRELATION_EXPRESSION, newCorrelationExpression,
                    newCorrelationExpression));
    }
    ...
    public NotificationChain basicSetCorrelationKey(AbstractExpression newCorrelationKey, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.CORRELATION_ASSOCIATION__CORRELATION_KEY, oldCorrelationKey, newCorrelationKey);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setCorrelationKey(AbstractExpression newCorrelationKey) {
        if (newCorrelationKey != correlationKey) {
            ...
            if (correlationKey != null)
                msgs = ((InternalEObject) correlationKey).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.CORRELATION_ASSOCIATION__CORRELATION_KEY, null, msgs);
            if (newCorrelationKey != null)
                msgs = ((InternalEObject) newCorrelationKey).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.CORRELATION_ASSOCIATION__CORRELATION_KEY, null, msgs);
            msgs = basicSetCorrelationKey(newCorrelationKey, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.CORRELATION_ASSOCIATION__CORRELATION_KEY,
