...
public class SimulationElementImpl extends EObjectImpl implements SimulationElement {
    ...
    public void setName(String newName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SimulationPackage.SIMULATION_ELEMENT__NAME, oldName,
                    name));
    }
    ...
    public void setDescription(String newDescription) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SimulationPackage.SIMULATION_ELEMENT__DESCRIPTION,
