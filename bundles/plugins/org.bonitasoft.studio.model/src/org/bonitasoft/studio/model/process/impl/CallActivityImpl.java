 ...
 * <li>{@link org.bonitasoft.studio.model.process.impl.CallActivityImpl#getCalledActivityName <em>Called Activity
 * Name</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.process.impl.CallActivityImpl#getCalledActivityVersion <em>Called Activity
 * Version</em>}</li>
 * </ul>
 *
 * @generated
...
public class CallActivityImpl extends ActivityImpl implements CallActivity {
    ...
    public EList<InputMapping> getInputMappings() {
        if (inputMappings == null) {
            inputMappings = new EObjectContainmentEList<InputMapping>(InputMapping.class, this,
                    ProcessPackage.CALL_ACTIVITY__INPUT_MAPPINGS);
        }
    ...
    public EList<OutputMapping> getOutputMappings() {
        if (outputMappings == null) {
            outputMappings = new EObjectContainmentEList<OutputMapping>(OutputMapping.class, this,
                    ProcessPackage.CALL_ACTIVITY__OUTPUT_MAPPINGS);
        }
    ...
    public NotificationChain basicSetCalledActivityName(Expression newCalledActivityName, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.CALL_ACTIVITY__CALLED_ACTIVITY_NAME, oldCalledActivityName, newCalledActivityName);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setCalledActivityName(Expression newCalledActivityName) {
        if (newCalledActivityName != calledActivityName) {
            ...
            if (calledActivityName != null)
                msgs = ((InternalEObject) calledActivityName).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.CALL_ACTIVITY__CALLED_ACTIVITY_NAME, null, msgs);
            if (newCalledActivityName != null)
                msgs = ((InternalEObject) newCalledActivityName).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.CALL_ACTIVITY__CALLED_ACTIVITY_NAME, null, msgs);
            msgs = basicSetCalledActivityName(newCalledActivityName, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.CALL_ACTIVITY__CALLED_ACTIVITY_NAME,
                    newCalledActivityName, newCalledActivityName));
    }
    ...
    public NotificationChain basicSetCalledActivityVersion(Expression newCalledActivityVersion, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.CALL_ACTIVITY__CALLED_ACTIVITY_VERSION, oldCalledActivityVersion,
                    newCalledActivityVersion);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setCalledActivityVersion(Expression newCalledActivityVersion) {
        if (newCalledActivityVersion != calledActivityVersion) {
            ...
            if (calledActivityVersion != null)
                msgs = ((InternalEObject) calledActivityVersion).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.CALL_ACTIVITY__CALLED_ACTIVITY_VERSION, null, msgs);
            if (newCalledActivityVersion != null)
                msgs = ((InternalEObject) newCalledActivityVersion).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.CALL_ACTIVITY__CALLED_ACTIVITY_VERSION, null, msgs);
            msgs = basicSetCalledActivityVersion(newCalledActivityVersion, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.CALL_ACTIVITY__CALLED_ACTIVITY_VERSION,
                    newCalledActivityVersion, newCalledActivityVersion));
    }
