...
public class ThrowLinkEventImpl extends LinkEventImpl implements ThrowLinkEvent {
        ...
        if (to != null && to.eIsProxy()) {
            ...
            if (to != oldTo) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, ProcessPackage.THROW_LINK_EVENT__TO, oldTo,
                            to));
            }
        }
        return to;
    ...
    public NotificationChain basicSetTo(CatchLinkEvent newTo, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.THROW_LINK_EVENT__TO, oldTo, newTo);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setTo(CatchLinkEvent newTo) {
        if (newTo != to) {
            ...
            if (to != null)
                msgs = ((InternalEObject) to).eInverseRemove(this, ProcessPackage.CATCH_LINK_EVENT__FROM,
                        CatchLinkEvent.class, msgs);
            if (newTo != null)
                msgs = ((InternalEObject) newTo).eInverseAdd(this, ProcessPackage.CATCH_LINK_EVENT__FROM,
                        CatchLinkEvent.class, msgs);
