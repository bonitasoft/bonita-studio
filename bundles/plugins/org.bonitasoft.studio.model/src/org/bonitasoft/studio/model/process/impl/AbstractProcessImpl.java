 ...
 *   <li>{@link org.bonitasoft.studio.model.process.impl.AbstractProcessImpl#getResourceValidators <em>Resource Validators</em>}</li>
 ...
 *   <li>{@link org.bonitasoft.studio.model.process.impl.AbstractProcessImpl#getConsultationTemplate <em>Consultation Template</em>}</li>
 ...
 *   <li>{@link org.bonitasoft.studio.model.process.impl.AbstractProcessImpl#getWelcomePageInternal <em>Welcome Page Internal</em>}</li>
 ...
 *   <li>{@link org.bonitasoft.studio.model.process.impl.AbstractProcessImpl#getBasedOnLookAndFeel <em>Based On Look And Feel</em>}</li>
 ...
 *   <li>{@link org.bonitasoft.studio.model.process.impl.AbstractProcessImpl#getRegExpToHideDefaultField <em>Reg Exp To Hide Default Field</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.AbstractProcessImpl#isUseRegExpToHideDefaultField <em>Use Reg Exp To Hide Default Field</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.AbstractProcessImpl#getByPassFormsGeneration <em>By Pass Forms Generation</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.AbstractProcessImpl#getConfirmationTemplate <em>Confirmation Template</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.AbstractProcessImpl#getTransientData <em>Transient Data</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.AbstractProcessImpl#getPageFlowConnectors <em>Page Flow Connectors</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.AbstractProcessImpl#getEntryPageFlowType <em>Entry Page Flow Type</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.AbstractProcessImpl#isTransmitURLAsParameter <em>Transmit URL As Parameter</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.AbstractProcessImpl#getPageFlowTransitions <em>Page Flow Transitions</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.AbstractProcessImpl#getForm <em>Form</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.AbstractProcessImpl#getEntryRedirectionURL <em>Entry Redirection URL</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.AbstractProcessImpl#getConfirmationMessage <em>Confirmation Message</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.AbstractProcessImpl#getEntryRedirectionActions <em>Entry Redirection Actions</em>}</li>
 ...
 *   <li>{@link org.bonitasoft.studio.model.process.impl.AbstractProcessImpl#getRecapPageFlowTransitions <em>Recap Page Flow Transitions</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.AbstractProcessImpl#getRecapTransientData <em>Recap Transient Data</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.AbstractProcessImpl#getRecapFlowConnectors <em>Recap Flow Connectors</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.AbstractProcessImpl#getRecapPageFlowType <em>Recap Page Flow Type</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.AbstractProcessImpl#getRecapForms <em>Recap Forms</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.AbstractProcessImpl#getRecapPageFlowRedirectionURL <em>Recap Page Flow Redirection URL</em>}</li>
 ...
 *   <li>{@link org.bonitasoft.studio.model.process.impl.AbstractProcessImpl#getViewPageFlowTransitions <em>View Page Flow Transitions</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.AbstractProcessImpl#getViewTransientData <em>View Transient Data</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.AbstractProcessImpl#getViewPageFlowConnectors <em>View Page Flow Connectors</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.AbstractProcessImpl#getViewPageFlowType <em>View Page Flow Type</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.AbstractProcessImpl#getViewForm <em>View Form</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.AbstractProcessImpl#getViewPageFlowRedirectionURL <em>View Page Flow Redirection URL</em>}</li>
...
public abstract class AbstractProcessImpl extends ContainerImpl implements AbstractProcess {
	...
	/**
	 * The cached value of the '{@link #getRecapPageFlowTransitions() <em>Recap Page Flow Transitions</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * The cached value of the '{@link #getRecapPageFlowRedirectionURL() <em>Recap Page Flow Redirection URL</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * The cached value of the '{@link #getViewPageFlowTransitions() <em>View Page Flow Transitions</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * The cached value of the '{@link #getViewPageFlowConnectors() <em>View Page Flow Connectors</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * The cached value of the '{@link #getViewPageFlowRedirectionURL() <em>View Page Flow Redirection URL</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EMap<String, String> getHtmlAttributes() {
		if (htmlAttributes == null) {
			htmlAttributes = new EcoreEMap<String,String>(EcorePackage.Literals.ESTRING_TO_STRING_MAP_ENTRY, EStringToStringMapEntryImpl.class, this, ProcessPackage.ABSTRACT_PROCESS__HTML_ATTRIBUTES);
		}
	...
	public NotificationChain basicSetMandatorySymbol(Expression newMandatorySymbol, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.ABSTRACT_PROCESS__MANDATORY_SYMBOL, oldMandatorySymbol, newMandatorySymbol);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMandatorySymbol(Expression newMandatorySymbol) {
		if (newMandatorySymbol != mandatorySymbol) {
			...
			if (mandatorySymbol != null)
				msgs = ((InternalEObject)mandatorySymbol).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.ABSTRACT_PROCESS__MANDATORY_SYMBOL, null, msgs);
			if (newMandatorySymbol != null)
				msgs = ((InternalEObject)newMandatorySymbol).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.ABSTRACT_PROCESS__MANDATORY_SYMBOL, null, msgs);
			msgs = basicSetMandatorySymbol(newMandatorySymbol, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.ABSTRACT_PROCESS__MANDATORY_SYMBOL, newMandatorySymbol, newMandatorySymbol));
	}
	...
	public NotificationChain basicSetMandatoryLabel(Expression newMandatoryLabel, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.ABSTRACT_PROCESS__MANDATORY_LABEL, oldMandatoryLabel, newMandatoryLabel);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMandatoryLabel(Expression newMandatoryLabel) {
		if (newMandatoryLabel != mandatoryLabel) {
			...
			if (mandatoryLabel != null)
				msgs = ((InternalEObject)mandatoryLabel).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.ABSTRACT_PROCESS__MANDATORY_LABEL, null, msgs);
			if (newMandatoryLabel != null)
				msgs = ((InternalEObject)newMandatoryLabel).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.ABSTRACT_PROCESS__MANDATORY_LABEL, null, msgs);
			msgs = basicSetMandatoryLabel(newMandatoryLabel, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.ABSTRACT_PROCESS__MANDATORY_LABEL, newMandatoryLabel, newMandatoryLabel));
	}
	...
	public void setAutoLogin(boolean newAutoLogin) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.ABSTRACT_PROCESS__AUTO_LOGIN, oldAutoLogin, autoLogin));
	}
	...
	public void setAutoLoginId(String newAutoLoginId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.ABSTRACT_PROCESS__AUTO_LOGIN_ID, oldAutoLoginId, autoLoginId));
	}
	...
	public NotificationChain basicSetHostPage(AssociatedFile newHostPage, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.ABSTRACT_PROCESS__HOST_PAGE, oldHostPage, newHostPage);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setHostPage(AssociatedFile newHostPage) {
		if (newHostPage != hostPage) {
			NotificationChain msgs = null;
			if (hostPage != null)
				msgs = ((InternalEObject)hostPage).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.ABSTRACT_PROCESS__HOST_PAGE, null, msgs);
			if (newHostPage != null)
				msgs = ((InternalEObject)newHostPage).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.ABSTRACT_PROCESS__HOST_PAGE, null, msgs);
			msgs = basicSetHostPage(newHostPage, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.ABSTRACT_PROCESS__HOST_PAGE, newHostPage, newHostPage));
	}
	...
	public void setBasedOnLookAndFeel(String newBasedOnLookAndFeel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.ABSTRACT_PROCESS__BASED_ON_LOOK_AND_FEEL, oldBasedOnLookAndFeel, basedOnLookAndFeel));
	}
	...
	public EList<Data> getTransientData() {
		if (transientData == null) {
			transientData = new EObjectContainmentEList<Data>(Data.class, this, ProcessPackage.ABSTRACT_PROCESS__TRANSIENT_DATA);
		}
	...
	public EList<Connector> getPageFlowConnectors() {
		if (pageFlowConnectors == null) {
			pageFlowConnectors = new EObjectContainmentEList<Connector>(Connector.class, this, ProcessPackage.ABSTRACT_PROCESS__PAGE_FLOW_CONNECTORS);
		}
	...
	public void setEntryPageFlowType(EntryPageFlowType newEntryPageFlowType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.ABSTRACT_PROCESS__ENTRY_PAGE_FLOW_TYPE, oldEntryPageFlowType, entryPageFlowType));
	}
	...
	public void setTransmitURLAsParameter(boolean newTransmitURLAsParameter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.ABSTRACT_PROCESS__TRANSMIT_URL_AS_PARAMETER, oldTransmitURLAsParameter, transmitURLAsParameter));
	}
	...
	public EList<PageFlowTransition> getPageFlowTransitions() {
		if (pageFlowTransitions == null) {
			pageFlowTransitions = new EObjectContainmentEList<PageFlowTransition>(PageFlowTransition.class, this, ProcessPackage.ABSTRACT_PROCESS__PAGE_FLOW_TRANSITIONS);
		}
	...
	public NotificationChain basicSetEntryRedirectionURL(Expression newEntryRedirectionURL, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.ABSTRACT_PROCESS__ENTRY_REDIRECTION_URL, oldEntryRedirectionURL, newEntryRedirectionURL);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setEntryRedirectionURL(Expression newEntryRedirectionURL) {
		if (newEntryRedirectionURL != entryRedirectionURL) {
			...
			if (entryRedirectionURL != null)
				msgs = ((InternalEObject)entryRedirectionURL).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.ABSTRACT_PROCESS__ENTRY_REDIRECTION_URL, null, msgs);
			if (newEntryRedirectionURL != null)
				msgs = ((InternalEObject)newEntryRedirectionURL).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.ABSTRACT_PROCESS__ENTRY_REDIRECTION_URL, null, msgs);
			msgs = basicSetEntryRedirectionURL(newEntryRedirectionURL, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.ABSTRACT_PROCESS__ENTRY_REDIRECTION_URL, newEntryRedirectionURL, newEntryRedirectionURL));
	}
	...
	public NotificationChain basicSetConfirmationMessage(Expression newConfirmationMessage, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.ABSTRACT_PROCESS__CONFIRMATION_MESSAGE, oldConfirmationMessage, newConfirmationMessage);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setConfirmationMessage(Expression newConfirmationMessage) {
		if (newConfirmationMessage != confirmationMessage) {
			...
			if (confirmationMessage != null)
				msgs = ((InternalEObject)confirmationMessage).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.ABSTRACT_PROCESS__CONFIRMATION_MESSAGE, null, msgs);
			if (newConfirmationMessage != null)
				msgs = ((InternalEObject)newConfirmationMessage).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.ABSTRACT_PROCESS__CONFIRMATION_MESSAGE, null, msgs);
			msgs = basicSetConfirmationMessage(newConfirmationMessage, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.ABSTRACT_PROCESS__CONFIRMATION_MESSAGE, newConfirmationMessage, newConfirmationMessage));
	}
	...
	public EList<Operation> getEntryRedirectionActions() {
		if (entryRedirectionActions == null) {
			entryRedirectionActions = new EObjectContainmentEList<Operation>(Operation.class, this, ProcessPackage.ABSTRACT_PROCESS__ENTRY_REDIRECTION_ACTIONS);
		}
	...
	public void setMaximumTime(long newMaximumTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.ABSTRACT_PROCESS__MAXIMUM_TIME, oldMaximumTime, maximumTime));
	}
	...
	public EList<PageFlowTransition> getRecapPageFlowTransitions() {
		if (recapPageFlowTransitions == null) {
			recapPageFlowTransitions = new EObjectContainmentEList<PageFlowTransition>(PageFlowTransition.class, this, ProcessPackage.ABSTRACT_PROCESS__RECAP_PAGE_FLOW_TRANSITIONS);
		}
	...
	public EList<Data> getRecapTransientData() {
		if (recapTransientData == null) {
			recapTransientData = new EObjectContainmentEList<Data>(Data.class, this, ProcessPackage.ABSTRACT_PROCESS__RECAP_TRANSIENT_DATA);
		}
	...
	public EList<Connector> getRecapFlowConnectors() {
		if (recapFlowConnectors == null) {
			recapFlowConnectors = new EObjectContainmentEList<Connector>(Connector.class, this, ProcessPackage.ABSTRACT_PROCESS__RECAP_FLOW_CONNECTORS);
		}
	...
	public void setRecapPageFlowType(ConsultationPageFlowType newRecapPageFlowType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.ABSTRACT_PROCESS__RECAP_PAGE_FLOW_TYPE, oldRecapPageFlowType, recapPageFlowType));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetRecapPageFlowRedirectionURL(Expression newRecapPageFlowRedirectionURL, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.ABSTRACT_PROCESS__RECAP_PAGE_FLOW_REDIRECTION_URL, oldRecapPageFlowRedirectionURL, newRecapPageFlowRedirectionURL);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setRecapPageFlowRedirectionURL(Expression newRecapPageFlowRedirectionURL) {
		if (newRecapPageFlowRedirectionURL != recapPageFlowRedirectionURL) {
			...
			if (recapPageFlowRedirectionURL != null)
				msgs = ((InternalEObject)recapPageFlowRedirectionURL).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.ABSTRACT_PROCESS__RECAP_PAGE_FLOW_REDIRECTION_URL, null, msgs);
			if (newRecapPageFlowRedirectionURL != null)
				msgs = ((InternalEObject)newRecapPageFlowRedirectionURL).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.ABSTRACT_PROCESS__RECAP_PAGE_FLOW_REDIRECTION_URL, null, msgs);
			msgs = basicSetRecapPageFlowRedirectionURL(newRecapPageFlowRedirectionURL, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.ABSTRACT_PROCESS__RECAP_PAGE_FLOW_REDIRECTION_URL, newRecapPageFlowRedirectionURL, newRecapPageFlowRedirectionURL));
	}
	...
	public EList<PageFlowTransition> getViewPageFlowTransitions() {
		if (viewPageFlowTransitions == null) {
			viewPageFlowTransitions = new EObjectContainmentEList<PageFlowTransition>(PageFlowTransition.class, this, ProcessPackage.ABSTRACT_PROCESS__VIEW_PAGE_FLOW_TRANSITIONS);
		}
	...
	public EList<Data> getViewTransientData() {
		if (viewTransientData == null) {
			viewTransientData = new EObjectContainmentEList<Data>(Data.class, this, ProcessPackage.ABSTRACT_PROCESS__VIEW_TRANSIENT_DATA);
		}
	...
	public EList<Connector> getViewPageFlowConnectors() {
		if (viewPageFlowConnectors == null) {
			viewPageFlowConnectors = new EObjectContainmentEList<Connector>(Connector.class, this, ProcessPackage.ABSTRACT_PROCESS__VIEW_PAGE_FLOW_CONNECTORS);
		}
	...
	public void setViewPageFlowType(ConsultationPageFlowType newViewPageFlowType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.ABSTRACT_PROCESS__VIEW_PAGE_FLOW_TYPE, oldViewPageFlowType, viewPageFlowType));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetViewPageFlowRedirectionURL(Expression newViewPageFlowRedirectionURL, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.ABSTRACT_PROCESS__VIEW_PAGE_FLOW_REDIRECTION_URL, oldViewPageFlowRedirectionURL, newViewPageFlowRedirectionURL);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setViewPageFlowRedirectionURL(Expression newViewPageFlowRedirectionURL) {
		if (newViewPageFlowRedirectionURL != viewPageFlowRedirectionURL) {
			...
			if (viewPageFlowRedirectionURL != null)
				msgs = ((InternalEObject)viewPageFlowRedirectionURL).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.ABSTRACT_PROCESS__VIEW_PAGE_FLOW_REDIRECTION_URL, null, msgs);
			if (newViewPageFlowRedirectionURL != null)
				msgs = ((InternalEObject)newViewPageFlowRedirectionURL).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.ABSTRACT_PROCESS__VIEW_PAGE_FLOW_REDIRECTION_URL, null, msgs);
			msgs = basicSetViewPageFlowRedirectionURL(newViewPageFlowRedirectionURL, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.ABSTRACT_PROCESS__VIEW_PAGE_FLOW_REDIRECTION_URL, newViewPageFlowRedirectionURL, newViewPageFlowRedirectionURL));
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case ProcessPackage.ABSTRACT_PROCESS__BASED_ON_LOOK_AND_FEEL:
				return BASED_ON_LOOK_AND_FEEL_EDEFAULT == null ? basedOnLookAndFeel != null : !BASED_ON_LOOK_AND_FEEL_EDEFAULT.equals(basedOnLookAndFeel);
			case ProcessPackage.ABSTRACT_PROCESS__DATA:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == CSSCustomizable.class) {
			switch (derivedFeatureID) {
				case ProcessPackage.ABSTRACT_PROCESS__HTML_ATTRIBUTES: return FormPackage.CSS_CUSTOMIZABLE__HTML_ATTRIBUTES;
				default: return -1;
			}
		}
		if (baseClass == MandatoryFieldsCustomization.class) {
			switch (derivedFeatureID) {
				case ProcessPackage.ABSTRACT_PROCESS__MANDATORY_SYMBOL: return FormPackage.MANDATORY_FIELDS_CUSTOMIZATION__MANDATORY_SYMBOL;
				case ProcessPackage.ABSTRACT_PROCESS__MANDATORY_LABEL: return FormPackage.MANDATORY_FIELDS_CUSTOMIZATION__MANDATORY_LABEL;
				default: return -1;
			}
		}
		if (baseClass == ProcessApplication.class) {
			switch (derivedFeatureID) {
				case ProcessPackage.ABSTRACT_PROCESS__ERROR_TEMPLATE: return ProcessPackage.PROCESS_APPLICATION__ERROR_TEMPLATE;
				case ProcessPackage.ABSTRACT_PROCESS__PROCESS_TEMPLATE: return ProcessPackage.PROCESS_APPLICATION__PROCESS_TEMPLATE;
				case ProcessPackage.ABSTRACT_PROCESS__PAGE_TEMPLATE: return ProcessPackage.PROCESS_APPLICATION__PAGE_TEMPLATE;
				case ProcessPackage.ABSTRACT_PROCESS__CONSULTATION_TEMPLATE: return ProcessPackage.PROCESS_APPLICATION__CONSULTATION_TEMPLATE;
				case ProcessPackage.ABSTRACT_PROCESS__LOG_IN_PAGE: return ProcessPackage.PROCESS_APPLICATION__LOG_IN_PAGE;
				case ProcessPackage.ABSTRACT_PROCESS__WELCOME_PAGE: return ProcessPackage.PROCESS_APPLICATION__WELCOME_PAGE;
				case ProcessPackage.ABSTRACT_PROCESS__WELCOME_PAGE_INTERNAL: return ProcessPackage.PROCESS_APPLICATION__WELCOME_PAGE_INTERNAL;
				case ProcessPackage.ABSTRACT_PROCESS__AUTO_LOGIN: return ProcessPackage.PROCESS_APPLICATION__AUTO_LOGIN;
				case ProcessPackage.ABSTRACT_PROCESS__AUTO_LOGIN_ID: return ProcessPackage.PROCESS_APPLICATION__AUTO_LOGIN_ID;
				case ProcessPackage.ABSTRACT_PROCESS__HOST_PAGE: return ProcessPackage.PROCESS_APPLICATION__HOST_PAGE;
				case ProcessPackage.ABSTRACT_PROCESS__BASED_ON_LOOK_AND_FEEL: return ProcessPackage.PROCESS_APPLICATION__BASED_ON_LOOK_AND_FEEL;
				default: return -1;
			}
		}
		...
		if (baseClass == AbstractPageFlow.class) {
			switch (derivedFeatureID) {
				case ProcessPackage.ABSTRACT_PROCESS__REG_EXP_TO_HIDE_DEFAULT_FIELD: return ProcessPackage.ABSTRACT_PAGE_FLOW__REG_EXP_TO_HIDE_DEFAULT_FIELD;
				case ProcessPackage.ABSTRACT_PROCESS__USE_REG_EXP_TO_HIDE_DEFAULT_FIELD: return ProcessPackage.ABSTRACT_PAGE_FLOW__USE_REG_EXP_TO_HIDE_DEFAULT_FIELD;
				default: return -1;
			}
		}
		if (baseClass == PageFlow.class) {
			switch (derivedFeatureID) {
				...
				case ProcessPackage.ABSTRACT_PROCESS__TRANSIENT_DATA: return ProcessPackage.PAGE_FLOW__TRANSIENT_DATA;
				case ProcessPackage.ABSTRACT_PROCESS__PAGE_FLOW_CONNECTORS: return ProcessPackage.PAGE_FLOW__PAGE_FLOW_CONNECTORS;
				case ProcessPackage.ABSTRACT_PROCESS__ENTRY_PAGE_FLOW_TYPE: return ProcessPackage.PAGE_FLOW__ENTRY_PAGE_FLOW_TYPE;
				case ProcessPackage.ABSTRACT_PROCESS__TRANSMIT_URL_AS_PARAMETER: return ProcessPackage.PAGE_FLOW__TRANSMIT_URL_AS_PARAMETER;
				case ProcessPackage.ABSTRACT_PROCESS__PAGE_FLOW_TRANSITIONS: return ProcessPackage.PAGE_FLOW__PAGE_FLOW_TRANSITIONS;
				case ProcessPackage.ABSTRACT_PROCESS__FORM: return ProcessPackage.PAGE_FLOW__FORM;
				case ProcessPackage.ABSTRACT_PROCESS__ENTRY_REDIRECTION_URL: return ProcessPackage.PAGE_FLOW__ENTRY_REDIRECTION_URL;
				case ProcessPackage.ABSTRACT_PROCESS__CONFIRMATION_MESSAGE: return ProcessPackage.PAGE_FLOW__CONFIRMATION_MESSAGE;
				case ProcessPackage.ABSTRACT_PROCESS__ENTRY_REDIRECTION_ACTIONS: return ProcessPackage.PAGE_FLOW__ENTRY_REDIRECTION_ACTIONS;
		...
		if (baseClass == SimulationAbstractProcess.class) {
			switch (derivedFeatureID) {
				...
				case ProcessPackage.ABSTRACT_PROCESS__MAXIMUM_TIME: return SimulationPackage.SIMULATION_ABSTRACT_PROCESS__MAXIMUM_TIME;
				default: return -1;
			}
		}
		if (baseClass == RecapFlow.class) {
			switch (derivedFeatureID) {
				case ProcessPackage.ABSTRACT_PROCESS__RECAP_PAGE_FLOW_TRANSITIONS: return ProcessPackage.RECAP_FLOW__RECAP_PAGE_FLOW_TRANSITIONS;
				case ProcessPackage.ABSTRACT_PROCESS__RECAP_TRANSIENT_DATA: return ProcessPackage.RECAP_FLOW__RECAP_TRANSIENT_DATA;
				case ProcessPackage.ABSTRACT_PROCESS__RECAP_FLOW_CONNECTORS: return ProcessPackage.RECAP_FLOW__RECAP_FLOW_CONNECTORS;
				case ProcessPackage.ABSTRACT_PROCESS__RECAP_PAGE_FLOW_TYPE: return ProcessPackage.RECAP_FLOW__RECAP_PAGE_FLOW_TYPE;
				case ProcessPackage.ABSTRACT_PROCESS__RECAP_FORMS: return ProcessPackage.RECAP_FLOW__RECAP_FORMS;
				case ProcessPackage.ABSTRACT_PROCESS__RECAP_PAGE_FLOW_REDIRECTION_URL: return ProcessPackage.RECAP_FLOW__RECAP_PAGE_FLOW_REDIRECTION_URL;
		...
		if (baseClass == ViewPageFlow.class) {
			switch (derivedFeatureID) {
				case ProcessPackage.ABSTRACT_PROCESS__VIEW_PAGE_FLOW_TRANSITIONS: return ProcessPackage.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_TRANSITIONS;
				case ProcessPackage.ABSTRACT_PROCESS__VIEW_TRANSIENT_DATA: return ProcessPackage.VIEW_PAGE_FLOW__VIEW_TRANSIENT_DATA;
				case ProcessPackage.ABSTRACT_PROCESS__VIEW_PAGE_FLOW_CONNECTORS: return ProcessPackage.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_CONNECTORS;
				case ProcessPackage.ABSTRACT_PROCESS__VIEW_PAGE_FLOW_TYPE: return ProcessPackage.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_TYPE;
				case ProcessPackage.ABSTRACT_PROCESS__VIEW_FORM: return ProcessPackage.VIEW_PAGE_FLOW__VIEW_FORM;
				case ProcessPackage.ABSTRACT_PROCESS__VIEW_PAGE_FLOW_REDIRECTION_URL: return ProcessPackage.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_REDIRECTION_URL;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == CSSCustomizable.class) {
			switch (baseFeatureID) {
				case FormPackage.CSS_CUSTOMIZABLE__HTML_ATTRIBUTES: return ProcessPackage.ABSTRACT_PROCESS__HTML_ATTRIBUTES;
				default: return -1;
			}
		}
		if (baseClass == MandatoryFieldsCustomization.class) {
			switch (baseFeatureID) {
				case FormPackage.MANDATORY_FIELDS_CUSTOMIZATION__MANDATORY_SYMBOL: return ProcessPackage.ABSTRACT_PROCESS__MANDATORY_SYMBOL;
				case FormPackage.MANDATORY_FIELDS_CUSTOMIZATION__MANDATORY_LABEL: return ProcessPackage.ABSTRACT_PROCESS__MANDATORY_LABEL;
				default: return -1;
			}
		}
		if (baseClass == ProcessApplication.class) {
			switch (baseFeatureID) {
				case ProcessPackage.PROCESS_APPLICATION__ERROR_TEMPLATE: return ProcessPackage.ABSTRACT_PROCESS__ERROR_TEMPLATE;
				case ProcessPackage.PROCESS_APPLICATION__PROCESS_TEMPLATE: return ProcessPackage.ABSTRACT_PROCESS__PROCESS_TEMPLATE;
				case ProcessPackage.PROCESS_APPLICATION__PAGE_TEMPLATE: return ProcessPackage.ABSTRACT_PROCESS__PAGE_TEMPLATE;
				case ProcessPackage.PROCESS_APPLICATION__CONSULTATION_TEMPLATE: return ProcessPackage.ABSTRACT_PROCESS__CONSULTATION_TEMPLATE;
				case ProcessPackage.PROCESS_APPLICATION__LOG_IN_PAGE: return ProcessPackage.ABSTRACT_PROCESS__LOG_IN_PAGE;
				case ProcessPackage.PROCESS_APPLICATION__WELCOME_PAGE: return ProcessPackage.ABSTRACT_PROCESS__WELCOME_PAGE;
				case ProcessPackage.PROCESS_APPLICATION__WELCOME_PAGE_INTERNAL: return ProcessPackage.ABSTRACT_PROCESS__WELCOME_PAGE_INTERNAL;
				case ProcessPackage.PROCESS_APPLICATION__AUTO_LOGIN: return ProcessPackage.ABSTRACT_PROCESS__AUTO_LOGIN;
				case ProcessPackage.PROCESS_APPLICATION__AUTO_LOGIN_ID: return ProcessPackage.ABSTRACT_PROCESS__AUTO_LOGIN_ID;
				case ProcessPackage.PROCESS_APPLICATION__HOST_PAGE: return ProcessPackage.ABSTRACT_PROCESS__HOST_PAGE;
				case ProcessPackage.PROCESS_APPLICATION__BASED_ON_LOOK_AND_FEEL: return ProcessPackage.ABSTRACT_PROCESS__BASED_ON_LOOK_AND_FEEL;
				default: return -1;
			}
		}
		if (baseClass == DataAware.class) {
		...
		if (baseClass == AbstractPageFlow.class) {
			switch (baseFeatureID) {
				case ProcessPackage.ABSTRACT_PAGE_FLOW__REG_EXP_TO_HIDE_DEFAULT_FIELD: return ProcessPackage.ABSTRACT_PROCESS__REG_EXP_TO_HIDE_DEFAULT_FIELD;
				case ProcessPackage.ABSTRACT_PAGE_FLOW__USE_REG_EXP_TO_HIDE_DEFAULT_FIELD: return ProcessPackage.ABSTRACT_PROCESS__USE_REG_EXP_TO_HIDE_DEFAULT_FIELD;
				default: return -1;
			}
		}
		if (baseClass == PageFlow.class) {
			switch (baseFeatureID) {
				...
				case ProcessPackage.PAGE_FLOW__TRANSIENT_DATA: return ProcessPackage.ABSTRACT_PROCESS__TRANSIENT_DATA;
				case ProcessPackage.PAGE_FLOW__PAGE_FLOW_CONNECTORS: return ProcessPackage.ABSTRACT_PROCESS__PAGE_FLOW_CONNECTORS;
				case ProcessPackage.PAGE_FLOW__ENTRY_PAGE_FLOW_TYPE: return ProcessPackage.ABSTRACT_PROCESS__ENTRY_PAGE_FLOW_TYPE;
				case ProcessPackage.PAGE_FLOW__TRANSMIT_URL_AS_PARAMETER: return ProcessPackage.ABSTRACT_PROCESS__TRANSMIT_URL_AS_PARAMETER;
				case ProcessPackage.PAGE_FLOW__PAGE_FLOW_TRANSITIONS: return ProcessPackage.ABSTRACT_PROCESS__PAGE_FLOW_TRANSITIONS;
				case ProcessPackage.PAGE_FLOW__FORM: return ProcessPackage.ABSTRACT_PROCESS__FORM;
				case ProcessPackage.PAGE_FLOW__ENTRY_REDIRECTION_URL: return ProcessPackage.ABSTRACT_PROCESS__ENTRY_REDIRECTION_URL;
				case ProcessPackage.PAGE_FLOW__CONFIRMATION_MESSAGE: return ProcessPackage.ABSTRACT_PROCESS__CONFIRMATION_MESSAGE;
				case ProcessPackage.PAGE_FLOW__ENTRY_REDIRECTION_ACTIONS: return ProcessPackage.ABSTRACT_PROCESS__ENTRY_REDIRECTION_ACTIONS;
		...
		if (baseClass == SimulationAbstractProcess.class) {
			switch (baseFeatureID) {
				...
				case SimulationPackage.SIMULATION_ABSTRACT_PROCESS__MAXIMUM_TIME: return ProcessPackage.ABSTRACT_PROCESS__MAXIMUM_TIME;
				default: return -1;
			}
		}
		if (baseClass == RecapFlow.class) {
			switch (baseFeatureID) {
				case ProcessPackage.RECAP_FLOW__RECAP_PAGE_FLOW_TRANSITIONS: return ProcessPackage.ABSTRACT_PROCESS__RECAP_PAGE_FLOW_TRANSITIONS;
				case ProcessPackage.RECAP_FLOW__RECAP_TRANSIENT_DATA: return ProcessPackage.ABSTRACT_PROCESS__RECAP_TRANSIENT_DATA;
				case ProcessPackage.RECAP_FLOW__RECAP_FLOW_CONNECTORS: return ProcessPackage.ABSTRACT_PROCESS__RECAP_FLOW_CONNECTORS;
				case ProcessPackage.RECAP_FLOW__RECAP_PAGE_FLOW_TYPE: return ProcessPackage.ABSTRACT_PROCESS__RECAP_PAGE_FLOW_TYPE;
				case ProcessPackage.RECAP_FLOW__RECAP_FORMS: return ProcessPackage.ABSTRACT_PROCESS__RECAP_FORMS;
				case ProcessPackage.RECAP_FLOW__RECAP_PAGE_FLOW_REDIRECTION_URL: return ProcessPackage.ABSTRACT_PROCESS__RECAP_PAGE_FLOW_REDIRECTION_URL;
		...
		if (baseClass == ViewPageFlow.class) {
			switch (baseFeatureID) {
				case ProcessPackage.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_TRANSITIONS: return ProcessPackage.ABSTRACT_PROCESS__VIEW_PAGE_FLOW_TRANSITIONS;
				case ProcessPackage.VIEW_PAGE_FLOW__VIEW_TRANSIENT_DATA: return ProcessPackage.ABSTRACT_PROCESS__VIEW_TRANSIENT_DATA;
				case ProcessPackage.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_CONNECTORS: return ProcessPackage.ABSTRACT_PROCESS__VIEW_PAGE_FLOW_CONNECTORS;
				case ProcessPackage.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_TYPE: return ProcessPackage.ABSTRACT_PROCESS__VIEW_PAGE_FLOW_TYPE;
				case ProcessPackage.VIEW_PAGE_FLOW__VIEW_FORM: return ProcessPackage.ABSTRACT_PROCESS__VIEW_FORM;
				case ProcessPackage.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_REDIRECTION_URL: return ProcessPackage.ABSTRACT_PROCESS__VIEW_PAGE_FLOW_REDIRECTION_URL;
				default: return -1;
			}
		}
