 ...
 * </p>
 * <ul>
 * <li>{@link org.bonitasoft.studio.model.process.decision.transitions.impl.TakeTransitionActionImpl#isTakeTransition
 * <em>Take Transition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TakeTransitionActionImpl extends DecisionTableActionImpl implements TakeTransitionAction {
    ...
    public void setTakeTransition(boolean newTakeTransition) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, TransitionsPackage.TAKE_TRANSITION_ACTION__TAKE_TRANSITION,
                    oldTakeTransition, takeTransition));
    }
