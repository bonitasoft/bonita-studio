...
public class ProcessPackageImpl extends EPackageImpl implements ProcessPackage {
    ...
    public static ProcessPackage init() {
        ...
        ProcessPackageImpl theProcessPackage = (ProcessPackageImpl) (EPackage.Registry.INSTANCE
                .get(eNS_URI) instanceof ProcessPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
    ...
    public void initializePackageContents() {
        ...
        DecisionPackage theDecisionPackage = (DecisionPackage) EPackage.Registry.INSTANCE
                .getEPackage(DecisionPackage.eNS_URI);
        ExpressionPackage theExpressionPackage = (ExpressionPackage) EPackage.Registry.INSTANCE
                .getEPackage(ExpressionPackage.eNS_URI);
        SimulationPackage theSimulationPackage = (SimulationPackage) EPackage.Registry.INSTANCE
        ...
        ConnectorConfigurationPackage theConnectorConfigurationPackage = (ConnectorConfigurationPackage) EPackage.Registry.INSTANCE
        ...
        initEClass(abstractCatchMessageEventEClass, AbstractCatchMessageEvent.class, "AbstractCatchMessageEvent", //$NON-NLS-1$
                IS_ABSTRACT, IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getAbstractCatchMessageEvent_Event(), ecorePackage.getEString(), "event", null, 0, 1, //$NON-NLS-1$
                AbstractCatchMessageEvent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getAbstractCatchMessageEvent_IncomingMessag(), this.getMessageFlow(), this.getMessageFlow_Target(),
                "incomingMessag", null, 0, 1, AbstractCatchMessageEvent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, //$NON-NLS-1$
                !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getAbstractCatchMessageEvent_Correlation(), theExpressionPackage.getTableExpression(), null,
                "correlation", null, 0, 1, AbstractCatchMessageEvent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, //$NON-NLS-1$
                IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getAbstractCatchMessageEvent_MessageContent(), theExpressionPackage.getOperation(), null,
                "messageContent", null, 0, -1, AbstractCatchMessageEvent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, //$NON-NLS-1$
                IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(abstractPageFlowEClass, AbstractPageFlow.class, "AbstractPageFlow", IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getAbstractPageFlow_RegExpToHideDefaultField(), ecorePackage.getEString(), "regExpToHideDefaultField", //$NON-NLS-1$
                null, 0, 1, AbstractPageFlow.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getAbstractPageFlow_UseRegExpToHideDefaultField(), ecorePackage.getEBoolean(),
                "useRegExpToHideDefaultField", "false", 0, 1, AbstractPageFlow.class, !IS_TRANSIENT, !IS_VOLATILE, //$NON-NLS-1$//$NON-NLS-2$
                IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(abstractProcessEClass, AbstractProcess.class, "AbstractProcess", IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getAbstractProcess_Version(), ecorePackage.getEString(), "version", "1.0", 0, 1, //$NON-NLS-1$//$NON-NLS-2$
                AbstractProcess.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getAbstractProcess_Author(), ecorePackage.getEString(), "author", null, 0, 1, AbstractProcess.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getAbstractProcess_CreationDate(), ecorePackage.getEDate(), "creationDate", null, 0, 1, //$NON-NLS-1$
                AbstractProcess.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getAbstractProcess_ModificationDate(), ecorePackage.getEDate(), "modificationDate", null, 0, 1, //$NON-NLS-1$
                AbstractProcess.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEReference(getAbstractProcess_Datatypes(), this.getDataType(), null, "datatypes", null, 0, -1, //$NON-NLS-1$
                AbstractProcess.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getAbstractProcess_Connections(), this.getConnection(), null, "connections", null, 0, -1, //$NON-NLS-1$
                AbstractProcess.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getAbstractProcess_Categories(), ecorePackage.getEString(), "categories", null, 0, -1, //$NON-NLS-1$
                AbstractProcess.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEReference(getAbstractProcess_Actors(), this.getActor(), null, "actors", null, 0, -1, AbstractProcess.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEReference(getAbstractProcess_Configurations(), theConfigurationPackage.getConfiguration(), null,
                "configurations", null, 0, -1, AbstractProcess.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, //$NON-NLS-1$
                IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getAbstractProcess_Parameters(), theParameterPackage.getParameter(), null, "parameters", null, 0, -1, //$NON-NLS-1$
                AbstractProcess.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(abstractTimerEventEClass, AbstractTimerEvent.class, "AbstractTimerEvent", IS_ABSTRACT, IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getAbstractTimerEvent_Condition(), theExpressionPackage.getExpression(), null, "condition", null, 0, //$NON-NLS-1$
                1, AbstractTimerEvent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(activityEClass, Activity.class, "Activity", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
        initEReference(getActivity_BoundaryIntermediateEvents(), this.getBoundaryEvent(), null, "BoundaryIntermediateEvents", //$NON-NLS-1$
                null, 0, -1, Activity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(actorEClass, Actor.class, "Actor", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
        initEAttribute(getActor_Initiator(), ecorePackage.getEBoolean(), "initiator", "false", 0, 1, Actor.class, //$NON-NLS-1$//$NON-NLS-2$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(actorFilterEClass, ActorFilter.class, "ActorFilter", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);

        initEClass(andGatewayEClass, ANDGateway.class, "ANDGateway", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);

        initEClass(assignableEClass, Assignable.class, "Assignable", IS_ABSTRACT, IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
        initEReference(getAssignable_Actor(), this.getActor(), null, "actor", null, 0, 1, Assignable.class, !IS_TRANSIENT, //$NON-NLS-1$
                !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEReference(getAssignable_Filters(), this.getActorFilter(), null, "filters", null, 0, -1, Assignable.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);

        initEClass(associatedFileEClass, AssociatedFile.class, "AssociatedFile", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getAssociatedFile_Path(), ecorePackage.getEString(), "path", null, 0, 1, AssociatedFile.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getAssociatedFile_WarPath(), ecorePackage.getEString(), "warPath", null, 0, 1, AssociatedFile.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(associationEClass, Association.class, "Association", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getAssociation_IsDirected(), ecorePackage.getEBoolean(), "isDirected", "false", 0, 1, //$NON-NLS-1$//$NON-NLS-2$
                Association.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);

        initEClass(booleanTypeEClass, BooleanType.class, "BooleanType", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);

        initEClass(boundaryEventEClass, BoundaryEvent.class, "BoundaryEvent", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);

        initEClass(boundaryMessageEventEClass, BoundaryMessageEvent.class, "BoundaryMessageEvent", !IS_ABSTRACT, //$NON-NLS-1$
                !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

        initEClass(boundarySignalEventEClass, BoundarySignalEvent.class, "BoundarySignalEvent", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);

        initEClass(boundaryTimerEventEClass, BoundaryTimerEvent.class, "BoundaryTimerEvent", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);

        initEClass(businessObjectDataEClass, BusinessObjectData.class, "BusinessObjectData", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getBusinessObjectData_BusinessDataRepositoryId(), ecorePackage.getEString(),
                "businessDataRepositoryId", null, 0, 1, BusinessObjectData.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, //$NON-NLS-1$
                !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getBusinessObjectData_CreateNewInstance(), ecorePackage.getEBoolean(), "createNewInstance", "true", 0, //$NON-NLS-1$//$NON-NLS-2$
                1, BusinessObjectData.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getBusinessObjectData_EClassName(), ecorePackage.getEString(), "eClassName", null, 0, 1, //$NON-NLS-1$
                BusinessObjectData.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);

        initEClass(businessObjectTypeEClass, BusinessObjectType.class, "BusinessObjectType", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);

        initEClass(callActivityEClass, CallActivity.class, "CallActivity", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getCallActivity_InputMappings(), this.getInputMapping(), null, "inputMappings", null, 0, -1, //$NON-NLS-1$
                CallActivity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getCallActivity_OutputMappings(), this.getOutputMapping(), null, "outputMappings", null, 0, -1, //$NON-NLS-1$
                CallActivity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getCallActivity_CalledActivityName(), theExpressionPackage.getExpression(), null,
                "calledActivityName", null, 0, 1, CallActivity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, //$NON-NLS-1$
                IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getCallActivity_CalledActivityVersion(), theExpressionPackage.getExpression(), null,
                "calledActivityVersion", null, 0, 1, CallActivity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, //$NON-NLS-1$
                IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(catchLinkEventEClass, CatchLinkEvent.class, "CatchLinkEvent", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getCatchLinkEvent_From(), this.getThrowLinkEvent(), this.getThrowLinkEvent_To(), "from", null, 0, -1, //$NON-NLS-1$
                CatchLinkEvent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(catchMessageEventEClass, CatchMessageEvent.class, "CatchMessageEvent", IS_ABSTRACT, IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);

        initEClass(catchSignalEventEClass, CatchSignalEvent.class, "CatchSignalEvent", IS_ABSTRACT, IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);

        initEClass(connectableElementEClass, ConnectableElement.class, "ConnectableElement", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getConnectableElement_Connectors(), this.getConnector(), null, "connectors", null, 0, -1, //$NON-NLS-1$
                ConnectableElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getConnectableElement_Kpis(), theKpiPackage.getAbstractKPIBinding(), null, "kpis", null, 0, -1, //$NON-NLS-1$
                ConnectableElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(connectorEClass, Connector.class, "Connector", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
        initEAttribute(getConnector_DefinitionId(), ecorePackage.getEString(), "definitionId", "", 1, 1, Connector.class, //$NON-NLS-1$//$NON-NLS-2$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getConnector_Event(), ecorePackage.getEString(), "event", null, 0, 1, Connector.class, !IS_TRANSIENT, //$NON-NLS-1$
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getConnector_IgnoreErrors(), ecorePackage.getEBoolean(), "ignoreErrors", "false", 0, 1, //$NON-NLS-1$//$NON-NLS-2$
                Connector.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEAttribute(getConnector_ThrowErrorEvent(), ecorePackage.getEBoolean(), "throwErrorEvent", "false", 1, 1, //$NON-NLS-1$//$NON-NLS-2$
                Connector.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEAttribute(getConnector_NamedError(), ecorePackage.getEString(), "namedError", "", 0, 1, Connector.class, //$NON-NLS-1$//$NON-NLS-2$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getConnector_DefinitionVersion(), ecorePackage.getEString(), "definitionVersion", null, 1, 1, //$NON-NLS-1$
                Connector.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEReference(getConnector_Configuration(), theConnectorConfigurationPackage.getConnectorConfiguration(), null,
                "configuration", null, 0, 1, Connector.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, //$NON-NLS-1$
                !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getConnector_Outputs(), theExpressionPackage.getOperation(), null, "outputs", null, 0, -1, //$NON-NLS-1$
                Connector.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(containerEClass, org.bonitasoft.studio.model.process.Container.class, "Container", !IS_ABSTRACT, //$NON-NLS-1$
                !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getContainer_Elements(), this.getElement(), null, "elements", null, 0, -1, //$NON-NLS-1$
                org.bonitasoft.studio.model.process.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(contractEClass, Contract.class, "Contract", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
        initEReference(getContract_Inputs(), this.getContractInput(), null, "inputs", null, 0, -1, Contract.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEReference(getContract_Constraints(), this.getContractConstraint(), null, "constraints", null, 0, -1, //$NON-NLS-1$
                Contract.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(contractInputMappingEClass, ContractInputMapping.class, "ContractInputMapping", !IS_ABSTRACT, //$NON-NLS-1$
                !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getContractInputMapping_Data(), this.getData(), null, "data", null, 0, 1, ContractInputMapping.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getContractInputMapping_SetterName(), ecorePackage.getEString(), "setterName", null, 0, 1, //$NON-NLS-1$
                ContractInputMapping.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getContractInputMapping_SetterParamType(), ecorePackage.getEString(), "setterParamType", null, 0, 1, //$NON-NLS-1$
                ContractInputMapping.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);

        initEClass(contractInputEClass, ContractInput.class, "ContractInput", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getContractInput_Name(), ecorePackage.getEString(), "name", null, 0, 1, ContractInput.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getContractInput_Type(), this.getContractInputType(), "type", null, 0, 1, ContractInput.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getContractInput_Description(), ecorePackage.getEString(), "description", null, 0, 1, //$NON-NLS-1$
                ContractInput.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getContractInput_Multiple(), ecorePackage.getEBoolean(), "multiple", null, 0, 1, ContractInput.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getContractInput_Mapping(), this.getContractInputMapping(), null, "mapping", null, 0, 1, //$NON-NLS-1$
                ContractInput.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getContractInput_Inputs(), this.getContractInput(), null, "inputs", null, 0, -1, ContractInput.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);

        addEOperation(contractInputEClass, ecorePackage.getEString(), "getJavaType", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$

        initEClass(contractConstraintEClass, ContractConstraint.class, "ContractConstraint", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getContractConstraint_Expression(), ecorePackage.getEString(), "expression", null, 0, 1, //$NON-NLS-1$
                ContractConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getContractConstraint_ErrorMessage(), ecorePackage.getEString(), "errorMessage", null, 0, 1, //$NON-NLS-1$
                ContractConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getContractConstraint_Name(), ecorePackage.getEString(), "name", null, 0, 1, ContractConstraint.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getContractConstraint_InputNames(), ecorePackage.getEString(), "inputNames", null, 0, -1, //$NON-NLS-1$
                ContractConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);

        initEClass(contractContainerEClass, ContractContainer.class, "ContractContainer", IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getContractContainer_Contract(), this.getContract(), null, "contract", null, 0, 1, //$NON-NLS-1$
                ContractContainer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(connectionEClass, Connection.class, "Connection", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getConnection_Target(), this.getTargetElement(), this.getTargetElement_Incoming(), "target", null, 0, //$NON-NLS-1$
                1, Connection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getConnection_Source(), this.getSourceElement(), this.getSourceElement_Outgoing(), "source", null, 0, //$NON-NLS-1$
                1, Connection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);

        initEClass(correlationEClass, Correlation.class, "Correlation", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getCorrelation_CorrelationType(), this.getCorrelationTypeActive(), "correlationType", "INACTIVE", 1, //$NON-NLS-1$//$NON-NLS-2$
                1, Correlation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEReference(getCorrelation_CorrelationAssociation(), theExpressionPackage.getTableExpression(), null,
                "correlationAssociation", null, 1, 1, Correlation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, //$NON-NLS-1$
                IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(correlationAssociationEClass, CorrelationAssociation.class, "CorrelationAssociation", !IS_ABSTRACT, //$NON-NLS-1$
                !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getCorrelationAssociation_CorrelationExpression(), theExpressionPackage.getAbstractExpression(), null,
                "CorrelationExpression", null, 0, 1, CorrelationAssociation.class, !IS_TRANSIENT, !IS_VOLATILE, //$NON-NLS-1$
                IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getCorrelationAssociation_CorrelationKey(), theExpressionPackage.getAbstractExpression(), null,
                "correlationKey", null, 0, 1, CorrelationAssociation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, //$NON-NLS-1$
                IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(dataEClass, Data.class, "Data", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
        initEAttribute(getData_Generated(), ecorePackage.getEBoolean(), "generated", "true", 0, 1, Data.class, !IS_TRANSIENT, //$NON-NLS-1$//$NON-NLS-2$
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getData_Multiple(), ecorePackage.getEBoolean(), "multiple", null, 0, 1, Data.class, !IS_TRANSIENT, //$NON-NLS-1$
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getData_Transient(), ecorePackage.getEBoolean(), "transient", null, 0, 1, Data.class, !IS_TRANSIENT, //$NON-NLS-1$
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getData_DatasourceId(), ecorePackage.getEString(), "datasourceId", "BOS", 1, 1, Data.class, //$NON-NLS-1$//$NON-NLS-2$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getData_DataType(), this.getDataType(), null, "dataType", null, 1, 1, Data.class, !IS_TRANSIENT, //$NON-NLS-1$
                !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEReference(getData_DefaultValue(), theExpressionPackage.getExpression(), null, "defaultValue", null, 0, 1, //$NON-NLS-1$
                Data.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(dataAwareEClass, DataAware.class, "DataAware", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
        initEReference(getDataAware_Data(), this.getData(), null, "data", null, 0, -1, DataAware.class, !IS_TRANSIENT, //$NON-NLS-1$
                !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        ...
        initEAttribute(getDocument_DefaultValueIdOfDocumentStore(), ecorePackage.getEString(),
                "defaultValueIdOfDocumentStore", null, 0, 1, Document.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, //$NON-NLS-1$
                !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getDocument_MimeType(), theExpressionPackage.getExpression(), null, "mimeType", null, 0, 1, //$NON-NLS-1$
                Document.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getDocument_Url(), theExpressionPackage.getExpression(), null, "url", null, 0, 1, Document.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getDocument_DocumentType(), this.getDocumentType(), "documentType", "NONE", 1, 1, Document.class, //$NON-NLS-1$//$NON-NLS-2$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getDocument_InitialMultipleContent(), theExpressionPackage.getExpression(), null,
                "initialMultipleContent", null, 0, 1, Document.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, //$NON-NLS-1$
                IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getDocument_Multiple(), ecorePackage.getEBoolean(), "multiple", null, 0, 1, Document.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getDocument_ContractInput(), this.getContractInput(), null, "contractInput", null, 0, 1, //$NON-NLS-1$
                Document.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(doubleTypeEClass, DoubleType.class, "DoubleType", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);

        initEClass(elementEClass, Element.class, "Element", IS_ABSTRACT, IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
        initEAttribute(getElement_Documentation(), ecorePackage.getEString(), "documentation", "", 0, 1, Element.class, //$NON-NLS-1$//$NON-NLS-2$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getElement_Name(), ecorePackage.getEString(), "name", "", 1, 1, Element.class, !IS_TRANSIENT, //$NON-NLS-1$//$NON-NLS-2$
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getElement_TextAnnotationAttachment(), this.getTextAnnotationAttachment(),
                this.getTextAnnotationAttachment_Target(), "textAnnotationAttachment", null, 0, -1, Element.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);

        initEClass(eventEClass, Event.class, "Event", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$

        initEClass(endErrorEventEClass, EndErrorEvent.class, "EndErrorEvent", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);

        initEClass(endEventEClass, EndEvent.class, "EndEvent", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$

        initEClass(endMessageEventEClass, EndMessageEvent.class, "EndMessageEvent", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);

        initEClass(endSignalEventEClass, EndSignalEvent.class, "EndSignalEvent", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);

        initEClass(endTerminatedEventEClass, EndTerminatedEvent.class, "EndTerminatedEvent", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);

        initEClass(errorEventEClass, ErrorEvent.class, "ErrorEvent", IS_ABSTRACT, IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
        initEAttribute(getErrorEvent_ErrorCode(), ecorePackage.getEString(), "errorCode", null, 0, 1, ErrorEvent.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(enumTypeEClass, EnumType.class, "EnumType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
        initEAttribute(getEnumType_Literals(), ecorePackage.getEString(), "literals", null, 0, -1, EnumType.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(floatTypeEClass, FloatType.class, "FloatType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$

        initEClass(flowElementEClass, FlowElement.class, "FlowElement", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getFlowElement_DynamicLabel(), theExpressionPackage.getExpression(), null, "dynamicLabel", null, 0, 1, //$NON-NLS-1$
                FlowElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getFlowElement_DynamicDescription(), theExpressionPackage.getExpression(), null, "dynamicDescription", //$NON-NLS-1$
                null, 0, 1, FlowElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getFlowElement_StepSummary(), theExpressionPackage.getExpression(), null, "stepSummary", null, 0, 1, //$NON-NLS-1$
                FlowElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(formMappingEClass, FormMapping.class, "FormMapping", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getFormMapping_TargetForm(), theExpressionPackage.getExpression(), null, "targetForm", null, 0, 1, //$NON-NLS-1$
                FormMapping.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getFormMapping_Type(), this.getFormMappingType(), "type", "INTERNAL", 0, 1, FormMapping.class, //$NON-NLS-1$//$NON-NLS-2$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getFormMapping_Url(), ecorePackage.getEString(), "url", null, 0, 1, FormMapping.class, !IS_TRANSIENT, //$NON-NLS-1$
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(gatewayEClass, Gateway.class, "Gateway", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
        initEAttribute(getGateway_GatewayType(), this.getGatewayType(), "gatewayType", null, 0, 1, Gateway.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(inclusiveGatewayEClass, InclusiveGateway.class, "InclusiveGateway", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);

        initEClass(inputMappingEClass, InputMapping.class, "InputMapping", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getInputMapping_ProcessSource(), theExpressionPackage.getExpression(), null, "processSource", null, 0, //$NON-NLS-1$
                1, InputMapping.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getInputMapping_SubprocessTarget(), ecorePackage.getEString(), "subprocessTarget", null, 0, 1, //$NON-NLS-1$
                InputMapping.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getInputMapping_AssignationType(), this.getInputMappingAssignationType(), "assignationType", //$NON-NLS-1$
                "ContractInput", 1, 1, InputMapping.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, //$NON-NLS-1$
                !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(integerTypeEClass, IntegerType.class, "IntegerType", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);

        initEClass(intermediateErrorCatchEventEClass, IntermediateErrorCatchEvent.class, "IntermediateErrorCatchEvent", //$NON-NLS-1$
                !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

        initEClass(intermediateCatchSignalEventEClass, IntermediateCatchSignalEvent.class, "IntermediateCatchSignalEvent", //$NON-NLS-1$
                !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

        initEClass(intermediateThrowSignalEventEClass, IntermediateThrowSignalEvent.class, "IntermediateThrowSignalEvent", //$NON-NLS-1$
                !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

        initEClass(intermediateCatchMessageEventEClass, IntermediateCatchMessageEvent.class, "IntermediateCatchMessageEvent", //$NON-NLS-1$
                !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

        initEClass(intermediateThrowMessageEventEClass, IntermediateThrowMessageEvent.class, "IntermediateThrowMessageEvent", //$NON-NLS-1$
                !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

        initEClass(intermediateCatchTimerEventEClass, IntermediateCatchTimerEvent.class, "IntermediateCatchTimerEvent", //$NON-NLS-1$
                !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

        initEClass(javaObjectDataEClass, JavaObjectData.class, "JavaObjectData", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getJavaObjectData_ClassName(), ecorePackage.getEString(), "className", null, 0, 1, //$NON-NLS-1$
                JavaObjectData.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        ...
        initEClass(mainProcessEClass, MainProcess.class, "MainProcess", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getMainProcess_BonitaVersion(), ecorePackage.getEString(), "bonitaVersion", "", 1, 1, //$NON-NLS-1$//$NON-NLS-2$
                MainProcess.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getMainProcess_BonitaModelVersion(), ecorePackage.getEString(), "bonitaModelVersion", "5.0", 0, 1, //$NON-NLS-1$//$NON-NLS-2$
                MainProcess.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getMainProcess_IncludedEntries(), ecorePackage.getEString(), "includedEntries", null, 0, -1, //$NON-NLS-1$
                MainProcess.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEReference(getMainProcess_MessageConnections(), this.getMessageFlow(), null, "messageConnections", null, 0, -1, //$NON-NLS-1$
                MainProcess.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getMainProcess_GeneratedLibs(), ecorePackage.getEString(), "generatedLibs", null, 0, -1, //$NON-NLS-1$
                MainProcess.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getMainProcess_EnableValidation(), ecorePackage.getEBoolean(), "enableValidation", "true", 0, 1, //$NON-NLS-1$//$NON-NLS-2$
                MainProcess.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getMainProcess_ConfigId(), ecorePackage.getEJavaObject(), "configId", null, 0, 1, MainProcess.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(messageEClass, Message.class, "Message", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
        initEAttribute(getMessage_ThrowEvent(), ecorePackage.getEString(), "throwEvent", "", 1, 1, Message.class, //$NON-NLS-1$//$NON-NLS-2$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getMessage_Ttl(), ecorePackage.getEString(), "ttl", "31104000000", 0, 1, Message.class, !IS_TRANSIENT, //$NON-NLS-1$//$NON-NLS-2$
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getMessage_Correlation(), this.getCorrelation(), null, "correlation", null, 1, 1, Message.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEReference(getMessage_Source(), this.getThrowMessageEvent(), this.getThrowMessageEvent_Events(), "source", null, //$NON-NLS-1$
                0, 1, Message.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getMessage_TargetProcessExpression(), theExpressionPackage.getExpression(), null,
                "targetProcessExpression", null, 0, 1, Message.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, //$NON-NLS-1$
                IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getMessage_TargetElementExpression(), theExpressionPackage.getExpression(), null,
                "targetElementExpression", null, 0, 1, Message.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, //$NON-NLS-1$
                IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getMessage_MessageContent(), theExpressionPackage.getTableExpression(), null, "messageContent", null, //$NON-NLS-1$
                1, 1, Message.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(messageFlowEClass, MessageFlow.class, "MessageFlow", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getMessageFlow_Target(), this.getAbstractCatchMessageEvent(),
                this.getAbstractCatchMessageEvent_IncomingMessag(), "target", null, 1, 1, MessageFlow.class, !IS_TRANSIENT, //$NON-NLS-1$
                !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEReference(getMessageFlow_Source(), this.getThrowMessageEvent(), this.getThrowMessageEvent_OutgoingMessages(),
                "source", null, 1, 1, MessageFlow.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, //$NON-NLS-1$
                IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(messageEventEClass, MessageEvent.class, "MessageEvent", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);

        initEClass(multiInstantiableEClass, MultiInstantiable.class, "MultiInstantiable", IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getMultiInstantiable_Type(), this.getMultiInstanceType(), "type", "NONE", 1, 1, //$NON-NLS-1$//$NON-NLS-2$
                MultiInstantiable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getMultiInstantiable_TestBefore(), ecorePackage.getEBooleanObject(), "testBefore", "false", 0, 1, //$NON-NLS-1$//$NON-NLS-2$
                MultiInstantiable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEReference(getMultiInstantiable_LoopCondition(), theExpressionPackage.getExpression(), null, "loopCondition", //$NON-NLS-1$
                null, 0, 1, MultiInstantiable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
                !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getMultiInstantiable_LoopMaximum(), theExpressionPackage.getExpression(), null, "loopMaximum", null, //$NON-NLS-1$
                0, 1, MultiInstantiable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getMultiInstantiable_UseCardinality(), ecorePackage.getEBoolean(), "useCardinality", "false", 0, 1, //$NON-NLS-1$//$NON-NLS-2$
                MultiInstantiable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEReference(getMultiInstantiable_CardinalityExpression(), theExpressionPackage.getExpression(), null,
                "cardinalityExpression", null, 0, 1, MultiInstantiable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, //$NON-NLS-1$
                IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getMultiInstantiable_CollectionDataToMultiInstantiate(), this.getData(), null,
                "collectionDataToMultiInstantiate", null, 0, 1, MultiInstantiable.class, !IS_TRANSIENT, !IS_VOLATILE, //$NON-NLS-1$
                IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getMultiInstantiable_IteratorExpression(), theExpressionPackage.getExpression(), null,
                "iteratorExpression", null, 0, 1, MultiInstantiable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, //$NON-NLS-1$
                IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getMultiInstantiable_OutputData(), this.getData(), null, "outputData", null, 0, 1, //$NON-NLS-1$
                MultiInstantiable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getMultiInstantiable_ListDataContainingOutputResults(), this.getData(), null,
                "listDataContainingOutputResults", null, 0, 1, MultiInstantiable.class, !IS_TRANSIENT, !IS_VOLATILE, //$NON-NLS-1$
                IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getMultiInstantiable_CompletionCondition(), theExpressionPackage.getExpression(), null,
                "completionCondition", null, 0, 1, MultiInstantiable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, //$NON-NLS-1$
                IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getMultiInstantiable_StoreOutput(), ecorePackage.getEBoolean(), "storeOutput", "false", 0, 1, //$NON-NLS-1$//$NON-NLS-2$
                MultiInstantiable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);

        initEClass(nonInterruptingBoundaryTimerEventEClass, NonInterruptingBoundaryTimerEvent.class,
                "NonInterruptingBoundaryTimerEvent", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$

        initEClass(operationContainerEClass, OperationContainer.class, "OperationContainer", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getOperationContainer_Operations(), theExpressionPackage.getOperation(), null, "operations", null, 0, //$NON-NLS-1$
                -1, OperationContainer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(outputMappingEClass, OutputMapping.class, "OutputMapping", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getOutputMapping_SubprocessSource(), ecorePackage.getEString(), "subprocessSource", null, 0, 1, //$NON-NLS-1$
                OutputMapping.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEReference(getOutputMapping_ProcessTarget(), this.getData(), null, "processTarget", null, 0, 1, //$NON-NLS-1$
                OutputMapping.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(pageFlowEClass, PageFlow.class, "PageFlow", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
        initEAttribute(getPageFlow_ByPassFormsGeneration(), ecorePackage.getEBooleanObject(), "byPassFormsGeneration", null, //$NON-NLS-1$
                0, 1, PageFlow.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEReference(getPageFlow_ConfirmationTemplate(), this.getAssociatedFile(), null, "confirmationTemplate", null, 0, //$NON-NLS-1$
                1, PageFlow.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getPageFlow_TransientData(), this.getData(), null, "transientData", null, 0, -1, PageFlow.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEReference(getPageFlow_PageFlowConnectors(), this.getConnector(), null, "pageFlowConnectors", null, 0, -1, //$NON-NLS-1$
                PageFlow.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getPageFlow_EntryPageFlowType(), this.getEntryPageFlowType(), "entryPageFlowType", "PAGEFLOW", 0, 1, //$NON-NLS-1$//$NON-NLS-2$
                PageFlow.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEAttribute(getPageFlow_TransmitURLAsParameter(), ecorePackage.getEBoolean(), "transmitURLAsParameter", "true", 1, //$NON-NLS-1$//$NON-NLS-2$
                1, PageFlow.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEReference(getPageFlow_PageFlowTransitions(), this.getPageFlowTransition(), null, "pageFlowTransitions", null, 0, //$NON-NLS-1$
                -1, PageFlow.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getPageFlow_Form(), theFormPackage.getForm(), null, "form", null, 0, -1, PageFlow.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEReference(getPageFlow_EntryRedirectionURL(), theExpressionPackage.getExpression(), null, "entryRedirectionURL", //$NON-NLS-1$
                null, 0, 1, PageFlow.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getPageFlow_ConfirmationMessage(), theExpressionPackage.getExpression(), null, "confirmationMessage", //$NON-NLS-1$
                null, 0, 1, PageFlow.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getPageFlow_EntryRedirectionActions(), theExpressionPackage.getOperation(), null,
                "entryRedirectionActions", null, 0, -1, PageFlow.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, //$NON-NLS-1$
                IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getPageFlow_FormMapping(), this.getFormMapping(), null, "formMapping", null, 0, 1, PageFlow.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);

        initEClass(poolEClass, Pool.class, "Pool", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
        initEReference(getPool_Documents(), this.getDocument(), null, "documents", null, 0, -1, Pool.class, !IS_TRANSIENT, //$NON-NLS-1$
                !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEReference(getPool_SearchIndexes(), this.getSearchIndex(), null, "searchIndexes", null, 0, -1, Pool.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getPool_DisplayName(), ecorePackage.getEString(), "displayName", null, 0, 1, Pool.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(processApplicationEClass, ProcessApplication.class, "ProcessApplication", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getProcessApplication_ErrorTemplate(), this.getAssociatedFile(), null, "errorTemplate", null, 0, 1, //$NON-NLS-1$
                ProcessApplication.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getProcessApplication_ProcessTemplate(), this.getAssociatedFile(), null, "processTemplate", null, 0, //$NON-NLS-1$
                1, ProcessApplication.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getProcessApplication_PageTemplate(), this.getAssociatedFile(), null, "pageTemplate", null, 0, 1, //$NON-NLS-1$
                ProcessApplication.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getProcessApplication_ConsultationTemplate(), this.getAssociatedFile(), null, "consultationTemplate", //$NON-NLS-1$
                null, 0, 1, ProcessApplication.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
                !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getProcessApplication_LogInPage(), this.getAssociatedFile(), null, "logInPage", null, 0, 1, //$NON-NLS-1$
                ProcessApplication.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getProcessApplication_WelcomePage(), this.getAssociatedFile(), null, "welcomePage", null, 0, 1, //$NON-NLS-1$
                ProcessApplication.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getProcessApplication_WelcomePageInternal(), ecorePackage.getEBooleanObject(), "welcomePageInternal", //$NON-NLS-1$
                "true", 0, 1, ProcessApplication.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, //$NON-NLS-1$
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getProcessApplication_AutoLogin(), ecorePackage.getEBoolean(), "autoLogin", null, 0, 1, //$NON-NLS-1$
                ProcessApplication.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getProcessApplication_AutoLoginId(), ecorePackage.getEString(), "autoLoginId", null, 0, 1, //$NON-NLS-1$
                ProcessApplication.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEReference(getProcessApplication_HostPage(), this.getAssociatedFile(), null, "hostPage", null, 0, 1, //$NON-NLS-1$
                ProcessApplication.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getProcessApplication_BasedOnLookAndFeel(), ecorePackage.getEString(), "basedOnLookAndFeel", null, 0, //$NON-NLS-1$
                1, ProcessApplication.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);

        initEClass(pageFlowTransitionEClass, PageFlowTransition.class, "PageFlowTransition", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getPageFlowTransition_From(), theFormPackage.getForm(), null, "from", null, 0, 1, //$NON-NLS-1$
                PageFlowTransition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getPageFlowTransition_To(), theFormPackage.getForm(), null, "to", null, 0, 1, //$NON-NLS-1$
                PageFlowTransition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getPageFlowTransition_Condition(), theExpressionPackage.getExpression(), null, "condition", null, 0, //$NON-NLS-1$
                1, PageFlowTransition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(recapFlowEClass, RecapFlow.class, "RecapFlow", IS_ABSTRACT, IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
        initEReference(getRecapFlow_RecapPageFlowTransitions(), this.getPageFlowTransition(), null,
                "recapPageFlowTransitions", null, 0, -1, RecapFlow.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, //$NON-NLS-1$
                IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getRecapFlow_RecapTransientData(), this.getData(), null, "recapTransientData", null, 0, -1, //$NON-NLS-1$
                RecapFlow.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getRecapFlow_RecapFlowConnectors(), this.getConnector(), null, "recapFlowConnectors", null, 0, -1, //$NON-NLS-1$
                RecapFlow.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getRecapFlow_RecapPageFlowType(), this.getConsultationPageFlowType(), "recapPageFlowType", "PAGEFLOW", //$NON-NLS-1$//$NON-NLS-2$
                0, 1, RecapFlow.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEReference(getRecapFlow_RecapForms(), theFormPackage.getViewForm(), null, "recapForms", null, 0, -1, //$NON-NLS-1$
                RecapFlow.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getRecapFlow_RecapPageFlowRedirectionURL(), theExpressionPackage.getExpression(), null,
                "recapPageFlowRedirectionURL", null, 0, 1, RecapFlow.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, //$NON-NLS-1$
                IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getRecapFlow_OverviewFormMapping(), this.getFormMapping(), null, "overviewFormMapping", null, 0, 1, //$NON-NLS-1$
                RecapFlow.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(receiveTaskEClass, ReceiveTask.class, "ReceiveTask", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);

        initEClass(resourceContainerEClass, ResourceContainer.class, "ResourceContainer", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getResourceContainer_HtmlTemplate(), this.getAssociatedFile(), null, "htmlTemplate", null, 0, 1, //$NON-NLS-1$
                ResourceContainer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getResourceContainer_ResourceJars(), ecorePackage.getEString(), "resourceJars", null, 0, -1, //$NON-NLS-1$
                ResourceContainer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getResourceContainer_ResourceValidators(), ecorePackage.getEString(), "resourceValidators", null, 0, //$NON-NLS-1$
                -1, ResourceContainer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEReference(getResourceContainer_ResourceFiles(), this.getResourceFile(), null, "resourceFiles", null, 0, -1, //$NON-NLS-1$
                ResourceContainer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getResourceContainer_ResourceFolders(), this.getResourceFolder(), null, "resourceFolders", null, 0, //$NON-NLS-1$
                -1, ResourceContainer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(resourceFileEClass, ResourceFile.class, "ResourceFile", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);

        initEClass(resourceFolderEClass, ResourceFolder.class, "ResourceFolder", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getResourceFolder_ResourceFiles(), this.getResourceFile(), null, "resourceFiles", null, 0, -1, //$NON-NLS-1$
                ResourceFolder.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(sequenceFlowEClass, SequenceFlow.class, "SequenceFlow", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getSequenceFlow_IsDefault(), ecorePackage.getEBoolean(), "isDefault", "false", 0, 1, //$NON-NLS-1$//$NON-NLS-2$
                SequenceFlow.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getSequenceFlow_ConditionType(), this.getSequenceFlowConditionType(), "conditionType", "EXPRESSION", //$NON-NLS-1$//$NON-NLS-2$
                0, 1, SequenceFlow.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEReference(getSequenceFlow_DecisionTable(), theDecisionPackage.getDecisionTable(), null, "decisionTable", null, //$NON-NLS-1$
                1, 1, SequenceFlow.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getSequenceFlow_Condition(), theExpressionPackage.getExpression(), null, "condition", null, 0, 1, //$NON-NLS-1$
                SequenceFlow.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getSequenceFlow_PathToken(), ecorePackage.getEString(), "pathToken", null, 0, 1, SequenceFlow.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(signalEventEClass, SignalEvent.class, "SignalEvent", IS_ABSTRACT, IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getSignalEvent_SignalCode(), ecorePackage.getEString(), "signalCode", null, 0, 1, SignalEvent.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(sourceElementEClass, SourceElement.class, "SourceElement", IS_ABSTRACT, IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getSourceElement_Outgoing(), this.getConnection(), this.getConnection_Source(), "outgoing", null, 0, //$NON-NLS-1$
                -1, SourceElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(stringTypeEClass, StringType.class, "StringType", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);

        initEClass(scriptTaskEClass, ScriptTask.class, "ScriptTask", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);

        initEClass(searchIndexEClass, SearchIndex.class, "SearchIndex", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getSearchIndex_Name(), theExpressionPackage.getExpression(), null, "name", null, 0, 1, //$NON-NLS-1$
                SearchIndex.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getSearchIndex_Value(), theExpressionPackage.getExpression(), null, "value", null, 0, 1, //$NON-NLS-1$
                SearchIndex.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(sendTaskEClass, SendTask.class, "SendTask", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$

        initEClass(serviceTaskEClass, ServiceTask.class, "ServiceTask", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);

        initEClass(startErrorEventEClass, StartErrorEvent.class, "StartErrorEvent", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);

        initEClass(startEventEClass, StartEvent.class, "StartEvent", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);

        initEClass(startMessageEventEClass, StartMessageEvent.class, "StartMessageEvent", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);

        initEClass(startSignalEventEClass, StartSignalEvent.class, "StartSignalEvent", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);

        initEClass(startTimerEventEClass, StartTimerEvent.class, "StartTimerEvent", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getStartTimerEvent_From(), ecorePackage.getEDate(), "from", null, 0, 1, StartTimerEvent.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getStartTimerEvent_At(), ecorePackage.getEDate(), "at", null, 0, 1, StartTimerEvent.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getStartTimerEvent_Month(), ecorePackage.getEInt(), "month", "-1", 0, 1, StartTimerEvent.class, //$NON-NLS-1$//$NON-NLS-2$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getStartTimerEvent_Day(), ecorePackage.getEInt(), "day", "-1", 0, 1, StartTimerEvent.class, //$NON-NLS-1$//$NON-NLS-2$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getStartTimerEvent_Hours(), ecorePackage.getEInt(), "hours", "-1", 0, 1, StartTimerEvent.class, //$NON-NLS-1$//$NON-NLS-2$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getStartTimerEvent_DayNumber(), ecorePackage.getEInt(), "dayNumber", "-1", 0, 1, //$NON-NLS-1$//$NON-NLS-2$
                StartTimerEvent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getStartTimerEvent_Minutes(), ecorePackage.getEInt(), "minutes", null, 0, 1, StartTimerEvent.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getStartTimerEvent_Seconds(), ecorePackage.getEInt(), "seconds", null, 0, 1, StartTimerEvent.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getStartTimerEvent_ScriptType(), this.getStartTimerScriptType(), "scriptType", "GROOVY", 0, 1, //$NON-NLS-1$//$NON-NLS-2$
                StartTimerEvent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);

        initEClass(subProcessEventEClass, SubProcessEvent.class, "SubProcessEvent", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);

        initEClass(taskEClass, Task.class, "Task", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
        initEAttribute(getTask_OverrideActorsOfTheLane(), ecorePackage.getEBoolean(), "overrideActorsOfTheLane", "true", 0, //$NON-NLS-1$//$NON-NLS-2$
                1, Task.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEAttribute(getTask_Priority(), ecorePackage.getEInt(), "priority", "2", 0, 1, Task.class, !IS_TRANSIENT, //$NON-NLS-1$//$NON-NLS-2$
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getTask_ExpectedDuration(), theExpressionPackage.getExpression(), null, "expectedDuration", null, 0, //$NON-NLS-1$
                1, Task.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(targetElementEClass, TargetElement.class, "TargetElement", IS_ABSTRACT, IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getTargetElement_Incoming(), this.getConnection(), this.getConnection_Target(), "incoming", null, 0, //$NON-NLS-1$
                -1, TargetElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(textAnnotationEClass, TextAnnotation.class, "TextAnnotation", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getTextAnnotation_Text(), ecorePackage.getEString(), "text", null, 1, 1, TextAnnotation.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(textAnnotationAttachmentEClass, TextAnnotationAttachment.class, "TextAnnotationAttachment", !IS_ABSTRACT, //$NON-NLS-1$
                !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getTextAnnotationAttachment_Source(), this.getTextAnnotation(), null, "source", null, 0, 1, //$NON-NLS-1$
                TextAnnotationAttachment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
                IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getTextAnnotationAttachment_Target(), this.getElement(), this.getElement_TextAnnotationAttachment(),
                "target", null, 0, 1, TextAnnotationAttachment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, //$NON-NLS-1$
                !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(throwSignalEventEClass, ThrowSignalEvent.class, "ThrowSignalEvent", IS_ABSTRACT, IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);

        initEClass(throwLinkEventEClass, ThrowLinkEvent.class, "ThrowLinkEvent", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getThrowLinkEvent_To(), this.getCatchLinkEvent(), this.getCatchLinkEvent_From(), "to", null, 0, 1, //$NON-NLS-1$
                ThrowLinkEvent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(throwMessageEventEClass, ThrowMessageEvent.class, "ThrowMessageEvent", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getThrowMessageEvent_Events(), this.getMessage(), this.getMessage_Source(), "events", null, 0, -1, //$NON-NLS-1$
                ThrowMessageEvent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getThrowMessageEvent_OutgoingMessages(), this.getMessageFlow(), this.getMessageFlow_Source(),
                "outgoingMessages", null, 0, -1, ThrowMessageEvent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, //$NON-NLS-1$
                !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(timerEventEClass, TimerEvent.class, "TimerEvent", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);

        initEClass(viewPageFlowEClass, ViewPageFlow.class, "ViewPageFlow", IS_ABSTRACT, IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getViewPageFlow_ViewPageFlowTransitions(), this.getPageFlowTransition(), null,
                "viewPageFlowTransitions", null, 0, -1, ViewPageFlow.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, //$NON-NLS-1$
                IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getViewPageFlow_ViewTransientData(), this.getData(), null, "viewTransientData", null, 0, -1, //$NON-NLS-1$
                ViewPageFlow.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getViewPageFlow_ViewPageFlowConnectors(), this.getConnector(), null, "viewPageFlowConnectors", null, //$NON-NLS-1$
                0, -1, ViewPageFlow.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getViewPageFlow_ViewPageFlowType(), this.getConsultationPageFlowType(), "viewPageFlowType", //$NON-NLS-1$
                "PAGEFLOW", 0, 1, ViewPageFlow.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, //$NON-NLS-1$
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getViewPageFlow_ViewForm(), theFormPackage.getViewForm(), null, "viewForm", null, 0, -1, //$NON-NLS-1$
                ViewPageFlow.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getViewPageFlow_ViewPageFlowRedirectionURL(), theExpressionPackage.getExpression(), null,
                "viewPageFlowRedirectionURL", null, 0, 1, ViewPageFlow.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, //$NON-NLS-1$
                IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(xmlDataEClass, XMLData.class, "XMLData", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
        initEAttribute(getXMLData_Namespace(), ecorePackage.getEString(), "namespace", null, 0, 1, XMLData.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getXMLData_Type(), ecorePackage.getEString(), "type", null, 0, 1, XMLData.class, !IS_TRANSIENT, //$NON-NLS-1$
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(xmlTypeEClass, XMLType.class, "XMLType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$

        initEClass(xorGatewayEClass, XORGateway.class, "XORGateway", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
    ...
    protected void createDeprecated_since_5Annotations() {
        ...
        addAnnotation(getPageFlow_ByPassFormsGeneration(),
                source,
                new String[] {
                });
    }
