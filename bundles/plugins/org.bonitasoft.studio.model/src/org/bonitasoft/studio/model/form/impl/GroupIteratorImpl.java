 ...
 * <li>{@link org.bonitasoft.studio.model.form.impl.GroupIteratorImpl#getTextAnnotationAttachment <em>Text Annotation
 * Attachment</em>}</li>
...
public class GroupIteratorImpl extends EObjectImpl implements GroupIterator {
    ...
    public void setDocumentation(String newDocumentation) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.GROUP_ITERATOR__DOCUMENTATION,
    ...
    public EList<TextAnnotationAttachment> getTextAnnotationAttachment() {
        if (textAnnotationAttachment == null) {
            textAnnotationAttachment = new EObjectContainmentWithInverseEList<TextAnnotationAttachment>(
                    TextAnnotationAttachment.class, this, FormPackage.GROUP_ITERATOR__TEXT_ANNOTATION_ATTACHMENT,
    ...
    public void setClassName(String newClassName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.GROUP_ITERATOR__CLASS_NAME, oldClassName,
                    className));
    }
