...
public class StartTimerEventImpl extends TimerEventImpl implements StartTimerEvent {
    ...
    public void setDayNumber(int newDayNumber) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.START_TIMER_EVENT__DAY_NUMBER, oldDayNumber,
                    dayNumber));
    }
    ...
    public void setMinutes(int newMinutes) {
        ...
        minutes = newMinutes;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.START_TIMER_EVENT__MINUTES, oldMinutes,
                    minutes));
    }
    ...
    public void setSeconds(int newSeconds) {
        ...
        seconds = newSeconds;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.START_TIMER_EVENT__SECONDS, oldSeconds,
                    seconds));
    }
    ...
    public void setScriptType(StartTimerScriptType newScriptType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.START_TIMER_EVENT__SCRIPT_TYPE,
