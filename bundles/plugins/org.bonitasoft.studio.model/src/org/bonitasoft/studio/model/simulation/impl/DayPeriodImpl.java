...
public class DayPeriodImpl extends EObjectImpl implements DayPeriod {
    ...
    public void setStartHour(int newStartHour) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SimulationPackage.DAY_PERIOD__START_HOUR, oldStartHour,
                    startHour));
    }
    ...
    public void setEndHour(int newEndHour) {
        ...
        endHour = newEndHour;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SimulationPackage.DAY_PERIOD__END_HOUR, oldEndHour,
                    endHour));
    }
    ...
    public void setStartMinute(int newStartMinute) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SimulationPackage.DAY_PERIOD__START_MINUTE, oldStartMinute,
                    startMinute));
    }
    ...
    public void setEndMinute(int newEndMinute) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SimulationPackage.DAY_PERIOD__END_MINUTE, oldEndMinute,
                    endMinute));
    }
