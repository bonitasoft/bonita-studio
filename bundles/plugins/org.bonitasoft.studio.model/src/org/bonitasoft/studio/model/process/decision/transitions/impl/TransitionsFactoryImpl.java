...
public class TransitionsFactoryImpl extends EFactoryImpl implements TransitionsFactory {
    ...
    public static TransitionsFactory init() {
        try {
            TransitionsFactory theTransitionsFactory = (TransitionsFactory) EPackage.Registry.INSTANCE
                    .getEFactory(TransitionsPackage.eNS_URI);
    ...
    public EObject create(EClass eClass) {
        switch (eClass.getClassifierID()) {
            case TransitionsPackage.TAKE_TRANSITION_ACTION:
                return createTakeTransitionAction();
            default:
