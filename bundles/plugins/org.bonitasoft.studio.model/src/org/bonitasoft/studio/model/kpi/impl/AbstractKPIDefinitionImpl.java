 ...
 * <li>{@link org.bonitasoft.studio.model.kpi.impl.AbstractKPIDefinitionImpl#getTextAnnotationAttachment <em>Text Annotation
 * Attachment</em>}</li>
...
public abstract class AbstractKPIDefinitionImpl extends EObjectImpl implements AbstractKPIDefinition {
    ...
    public void setDocumentation(String newDocumentation) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, KpiPackage.ABSTRACT_KPI_DEFINITION__DOCUMENTATION,
    ...
    public EList<TextAnnotationAttachment> getTextAnnotationAttachment() {
        if (textAnnotationAttachment == null) {
            textAnnotationAttachment = new EObjectContainmentWithInverseEList<TextAnnotationAttachment>(
                    TextAnnotationAttachment.class, this, KpiPackage.ABSTRACT_KPI_DEFINITION__TEXT_ANNOTATION_ATTACHMENT,
    ...
    public void setVersion(String newVersion) {
        ...
        version = newVersion;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, KpiPackage.ABSTRACT_KPI_DEFINITION__VERSION, oldVersion,
                    version));
    }
