 ...
 * <li>{@link org.bonitasoft.studio.model.process.impl.DataTypeImpl#getTextAnnotationAttachment <em>Text Annotation
 * Attachment</em>}</li>
 * </ul>
 *
 * @generated
...
public abstract class DataTypeImpl extends EObjectImpl implements DataType {
    ...
    public void setDocumentation(String newDocumentation) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.DATA_TYPE__DOCUMENTATION, oldDocumentation,
                    documentation));
    }
    ...
    public EList<TextAnnotationAttachment> getTextAnnotationAttachment() {
        if (textAnnotationAttachment == null) {
            textAnnotationAttachment = new EObjectContainmentWithInverseEList<TextAnnotationAttachment>(
                    TextAnnotationAttachment.class, this, ProcessPackage.DATA_TYPE__TEXT_ANNOTATION_ATTACHMENT,
