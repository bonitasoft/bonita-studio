 ...
 * <li>{@link org.bonitasoft.studio.model.process.impl.StartErrorEventImpl#getTextAnnotationAttachment <em>Text Annotation
 * Attachment</em>}</li>
 ...
 * <li>{@link org.bonitasoft.studio.model.process.impl.StartErrorEventImpl#getRegExpToHideDefaultField <em>Reg Exp To Hide
 * Default Field</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.process.impl.StartErrorEventImpl#isUseRegExpToHideDefaultField <em>Use Reg Exp To
 * Hide Default Field</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.process.impl.StartErrorEventImpl#getViewPageFlowTransitions <em>View Page Flow
 * Transitions</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.process.impl.StartErrorEventImpl#getViewTransientData <em>View Transient
 * Data</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.process.impl.StartErrorEventImpl#getViewPageFlowConnectors <em>View Page Flow
 * Connectors</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.process.impl.StartErrorEventImpl#getViewPageFlowType <em>View Page Flow
 * Type</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.process.impl.StartErrorEventImpl#getViewForm <em>View Form</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.process.impl.StartErrorEventImpl#getViewPageFlowRedirectionURL <em>View Page Flow
 ...
 * <li>{@link org.bonitasoft.studio.model.process.impl.StartErrorEventImpl#isExclusiveOutgoingTransition <em>Exclusive
 ...
 * <li>{@link org.bonitasoft.studio.model.process.impl.StartErrorEventImpl#getDynamicDescription <em>Dynamic
 * Description</em>}</li>
...
public class StartErrorEventImpl extends EObjectImpl implements StartErrorEvent {
    ...
    public void setErrorCode(String newErrorCode) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.START_ERROR_EVENT__ERROR_CODE, oldErrorCode,
                    errorCode));
    }
    ...
    public void setDocumentation(String newDocumentation) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.START_ERROR_EVENT__DOCUMENTATION,
    ...
    public EList<TextAnnotationAttachment> getTextAnnotationAttachment() {
        if (textAnnotationAttachment == null) {
            textAnnotationAttachment = new EObjectContainmentWithInverseEList<TextAnnotationAttachment>(
                    TextAnnotationAttachment.class, this, ProcessPackage.START_ERROR_EVENT__TEXT_ANNOTATION_ATTACHMENT,
    ...
    public EList<Connection> getOutgoing() {
        if (outgoing == null) {
            outgoing = new EObjectWithInverseResolvingEList<Connection>(Connection.class, this,
                    ProcessPackage.START_ERROR_EVENT__OUTGOING, ProcessPackage.CONNECTION__SOURCE);
        }
        return outgoing;
    }
    ...
    public EList<Connection> getIncoming() {
        if (incoming == null) {
            incoming = new EObjectWithInverseResolvingEList<Connection>(Connection.class, this,
                    ProcessPackage.START_ERROR_EVENT__INCOMING, ProcessPackage.CONNECTION__TARGET);
        }
        return incoming;
    }
    ...
    public void setRegExpToHideDefaultField(String newRegExpToHideDefaultField) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.START_ERROR_EVENT__REG_EXP_TO_HIDE_DEFAULT_FIELD, oldRegExpToHideDefaultField,
    ...
    public void setUseRegExpToHideDefaultField(boolean newUseRegExpToHideDefaultField) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.START_ERROR_EVENT__USE_REG_EXP_TO_HIDE_DEFAULT_FIELD, oldUseRegExpToHideDefaultField,
    ...
    public EList<PageFlowTransition> getViewPageFlowTransitions() {
        if (viewPageFlowTransitions == null) {
            viewPageFlowTransitions = new EObjectContainmentEList<PageFlowTransition>(PageFlowTransition.class, this,
                    ProcessPackage.START_ERROR_EVENT__VIEW_PAGE_FLOW_TRANSITIONS);
        }
    ...
    public EList<Data> getViewTransientData() {
        if (viewTransientData == null) {
            viewTransientData = new EObjectContainmentEList<Data>(Data.class, this,
                    ProcessPackage.START_ERROR_EVENT__VIEW_TRANSIENT_DATA);
        }
    ...
    public EList<Connector> getViewPageFlowConnectors() {
        if (viewPageFlowConnectors == null) {
            viewPageFlowConnectors = new EObjectContainmentEList<Connector>(Connector.class, this,
                    ProcessPackage.START_ERROR_EVENT__VIEW_PAGE_FLOW_CONNECTORS);
        }
    ...
    public void setViewPageFlowType(ConsultationPageFlowType newViewPageFlowType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.START_ERROR_EVENT__VIEW_PAGE_FLOW_TYPE,
    ...
    public EList<ViewForm> getViewForm() {
        if (viewForm == null) {
            viewForm = new EObjectContainmentEList<ViewForm>(ViewForm.class, this,
                    ProcessPackage.START_ERROR_EVENT__VIEW_FORM);
        }
        return viewForm;
    }
    ...
    public NotificationChain basicSetViewPageFlowRedirectionURL(Expression newViewPageFlowRedirectionURL,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.START_ERROR_EVENT__VIEW_PAGE_FLOW_REDIRECTION_URL, oldViewPageFlowRedirectionURL,
        ...
        if (newViewPageFlowRedirectionURL != viewPageFlowRedirectionURL) {
            ...
            if (viewPageFlowRedirectionURL != null)
                msgs = ((InternalEObject) viewPageFlowRedirectionURL).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.START_ERROR_EVENT__VIEW_PAGE_FLOW_REDIRECTION_URL, null,
                        msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.START_ERROR_EVENT__VIEW_PAGE_FLOW_REDIRECTION_URL, newViewPageFlowRedirectionURL,
                    newViewPageFlowRedirectionURL));
    }
    ...
    public EList<SimulationData> getSimulationData() {
        if (simulationData == null) {
            simulationData = new EObjectContainmentEList<SimulationData>(SimulationData.class, this,
                    ProcessPackage.START_ERROR_EVENT__SIMULATION_DATA);
        }
    ...
    public EList<ResourceUsage> getResourcesUsages() {
        if (resourcesUsages == null) {
            resourcesUsages = new EObjectContainmentEList<ResourceUsage>(ResourceUsage.class, this,
                    ProcessPackage.START_ERROR_EVENT__RESOURCES_USAGES);
        }
    ...
    public void setExecutionTime(long newExecutionTime) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.START_ERROR_EVENT__EXECUTION_TIME,
    ...
    public void setEstimatedTime(double newEstimatedTime) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.START_ERROR_EVENT__ESTIMATED_TIME,
    ...
    public void setMaximumTime(double newMaximumTime) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.START_ERROR_EVENT__MAXIMUM_TIME,
    ...
    public void setContigous(boolean newContigous) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.START_ERROR_EVENT__CONTIGOUS, oldContigous,
                    contigous));
    }
    ...
    public void setExclusiveOutgoingTransition(boolean newExclusiveOutgoingTransition) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.START_ERROR_EVENT__EXCLUSIVE_OUTGOING_TRANSITION, oldExclusiveOutgoingTransition,
    ...
    public NotificationChain basicSetLoopTransition(SimulationTransition newLoopTransition, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.START_ERROR_EVENT__LOOP_TRANSITION, oldLoopTransition, newLoopTransition);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newLoopTransition != loopTransition) {
            ...
            if (loopTransition != null)
                msgs = ((InternalEObject) loopTransition).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.START_ERROR_EVENT__LOOP_TRANSITION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.START_ERROR_EVENT__LOOP_TRANSITION,
    ...
    public EList<DataChange> getDataChange() {
        if (dataChange == null) {
            dataChange = new EObjectContainmentEList<DataChange>(DataChange.class, this,
                    ProcessPackage.START_ERROR_EVENT__DATA_CHANGE);
        }
        return dataChange;
    }
    ...
    public NotificationChain basicSetDynamicLabel(Expression newDynamicLabel, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.START_ERROR_EVENT__DYNAMIC_LABEL, oldDynamicLabel, newDynamicLabel);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newDynamicLabel != dynamicLabel) {
            ...
            if (dynamicLabel != null)
                msgs = ((InternalEObject) dynamicLabel).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.START_ERROR_EVENT__DYNAMIC_LABEL, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.START_ERROR_EVENT__DYNAMIC_LABEL,
    ...
    public NotificationChain basicSetDynamicDescription(Expression newDynamicDescription, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.START_ERROR_EVENT__DYNAMIC_DESCRIPTION, oldDynamicDescription, newDynamicDescription);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newDynamicDescription != dynamicDescription) {
            ...
            if (dynamicDescription != null)
                msgs = ((InternalEObject) dynamicDescription).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.START_ERROR_EVENT__DYNAMIC_DESCRIPTION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.START_ERROR_EVENT__DYNAMIC_DESCRIPTION,
    ...
    public NotificationChain basicSetStepSummary(Expression newStepSummary, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.START_ERROR_EVENT__STEP_SUMMARY, oldStepSummary, newStepSummary);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newStepSummary != stepSummary) {
            ...
            if (stepSummary != null)
                msgs = ((InternalEObject) stepSummary).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.START_ERROR_EVENT__STEP_SUMMARY, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.START_ERROR_EVENT__STEP_SUMMARY,
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        if (baseClass == Element.class) {
            switch (derivedFeatureID) {
                case ProcessPackage.START_ERROR_EVENT__DOCUMENTATION:
                    return ProcessPackage.ELEMENT__DOCUMENTATION;
                case ProcessPackage.START_ERROR_EVENT__NAME:
                    return ProcessPackage.ELEMENT__NAME;
                case ProcessPackage.START_ERROR_EVENT__TEXT_ANNOTATION_ATTACHMENT:
                    return ProcessPackage.ELEMENT__TEXT_ANNOTATION_ATTACHMENT;
                default:
                    return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == Element.class) {
            switch (baseFeatureID) {
                case ProcessPackage.ELEMENT__DOCUMENTATION:
                    return ProcessPackage.START_ERROR_EVENT__DOCUMENTATION;
                case ProcessPackage.ELEMENT__NAME:
                    return ProcessPackage.START_ERROR_EVENT__NAME;
                case ProcessPackage.ELEMENT__TEXT_ANNOTATION_ATTACHMENT:
                    return ProcessPackage.START_ERROR_EVENT__TEXT_ANNOTATION_ATTACHMENT;
                default:
                    return -1;
            }
        }
        if (baseClass == SourceElement.class) {
            switch (baseFeatureID) {
                case ProcessPackage.SOURCE_ELEMENT__OUTGOING:
                    return ProcessPackage.START_ERROR_EVENT__OUTGOING;
                default:
                    return -1;
            }
        }
        if (baseClass == TargetElement.class) {
            switch (baseFeatureID) {
                case ProcessPackage.TARGET_ELEMENT__INCOMING:
                    return ProcessPackage.START_ERROR_EVENT__INCOMING;
                default:
                    return -1;
            }
        }
        if (baseClass == AbstractPageFlow.class) {
            switch (baseFeatureID) {
                case ProcessPackage.ABSTRACT_PAGE_FLOW__REG_EXP_TO_HIDE_DEFAULT_FIELD:
                    return ProcessPackage.START_ERROR_EVENT__REG_EXP_TO_HIDE_DEFAULT_FIELD;
                case ProcessPackage.ABSTRACT_PAGE_FLOW__USE_REG_EXP_TO_HIDE_DEFAULT_FIELD:
                    return ProcessPackage.START_ERROR_EVENT__USE_REG_EXP_TO_HIDE_DEFAULT_FIELD;
                default:
                    return -1;
            }
        }
        if (baseClass == ViewPageFlow.class) {
            switch (baseFeatureID) {
                case ProcessPackage.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_TRANSITIONS:
                    return ProcessPackage.START_ERROR_EVENT__VIEW_PAGE_FLOW_TRANSITIONS;
                case ProcessPackage.VIEW_PAGE_FLOW__VIEW_TRANSIENT_DATA:
                    return ProcessPackage.START_ERROR_EVENT__VIEW_TRANSIENT_DATA;
                case ProcessPackage.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_CONNECTORS:
                    return ProcessPackage.START_ERROR_EVENT__VIEW_PAGE_FLOW_CONNECTORS;
                case ProcessPackage.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_TYPE:
                    return ProcessPackage.START_ERROR_EVENT__VIEW_PAGE_FLOW_TYPE;
                case ProcessPackage.VIEW_PAGE_FLOW__VIEW_FORM:
                    return ProcessPackage.START_ERROR_EVENT__VIEW_FORM;
                case ProcessPackage.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_REDIRECTION_URL:
                    return ProcessPackage.START_ERROR_EVENT__VIEW_PAGE_FLOW_REDIRECTION_URL;
                default:
                    return -1;
            }
        }
        if (baseClass == SimulationDataContainer.class) {
            switch (baseFeatureID) {
                case SimulationPackage.SIMULATION_DATA_CONTAINER__SIMULATION_DATA:
                    return ProcessPackage.START_ERROR_EVENT__SIMULATION_DATA;
                default:
                    return -1;
            }
        }
        if (baseClass == SimulationActivity.class) {
            switch (baseFeatureID) {
                case SimulationPackage.SIMULATION_ACTIVITY__RESOURCES_USAGES:
                    return ProcessPackage.START_ERROR_EVENT__RESOURCES_USAGES;
                case SimulationPackage.SIMULATION_ACTIVITY__EXECUTION_TIME:
                    return ProcessPackage.START_ERROR_EVENT__EXECUTION_TIME;
                case SimulationPackage.SIMULATION_ACTIVITY__ESTIMATED_TIME:
                    return ProcessPackage.START_ERROR_EVENT__ESTIMATED_TIME;
                case SimulationPackage.SIMULATION_ACTIVITY__MAXIMUM_TIME:
                    return ProcessPackage.START_ERROR_EVENT__MAXIMUM_TIME;
                case SimulationPackage.SIMULATION_ACTIVITY__CONTIGOUS:
                    return ProcessPackage.START_ERROR_EVENT__CONTIGOUS;
                case SimulationPackage.SIMULATION_ACTIVITY__EXCLUSIVE_OUTGOING_TRANSITION:
                    return ProcessPackage.START_ERROR_EVENT__EXCLUSIVE_OUTGOING_TRANSITION;
                case SimulationPackage.SIMULATION_ACTIVITY__LOOP_TRANSITION:
                    return ProcessPackage.START_ERROR_EVENT__LOOP_TRANSITION;
                case SimulationPackage.SIMULATION_ACTIVITY__DATA_CHANGE:
                    return ProcessPackage.START_ERROR_EVENT__DATA_CHANGE;
                default:
                    return -1;
            }
        }
        if (baseClass == FlowElement.class) {
            switch (baseFeatureID) {
                case ProcessPackage.FLOW_ELEMENT__DYNAMIC_LABEL:
                    return ProcessPackage.START_ERROR_EVENT__DYNAMIC_LABEL;
                case ProcessPackage.FLOW_ELEMENT__DYNAMIC_DESCRIPTION:
                    return ProcessPackage.START_ERROR_EVENT__DYNAMIC_DESCRIPTION;
                case ProcessPackage.FLOW_ELEMENT__STEP_SUMMARY:
                    return ProcessPackage.START_ERROR_EVENT__STEP_SUMMARY;
                default:
                    return -1;
            }
        }
