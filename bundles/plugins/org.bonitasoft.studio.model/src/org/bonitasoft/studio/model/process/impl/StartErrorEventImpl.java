 ...
 * </p>
 * <ul>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.StartErrorEventImpl#getErrorCode <em>Error Code</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.StartErrorEventImpl#getDocumentation <em>Documentation</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.StartErrorEventImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.StartErrorEventImpl#getTextAnnotationAttachment <em>Text Annotation Attachment</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.StartErrorEventImpl#getOutgoing <em>Outgoing</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.StartErrorEventImpl#getIncoming <em>Incoming</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.StartErrorEventImpl#getRegExpToHideDefaultField <em>Reg Exp To Hide Default Field</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.StartErrorEventImpl#isUseRegExpToHideDefaultField <em>Use Reg Exp To Hide Default Field</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.StartErrorEventImpl#getViewPageFlowTransitions <em>View Page Flow Transitions</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.StartErrorEventImpl#getViewTransientData <em>View Transient Data</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.StartErrorEventImpl#getViewPageFlowConnectors <em>View Page Flow Connectors</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.StartErrorEventImpl#getViewPageFlowType <em>View Page Flow Type</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.StartErrorEventImpl#getViewForm <em>View Form</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.StartErrorEventImpl#getViewPageFlowRedirectionURL <em>View Page Flow Redirection URL</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.StartErrorEventImpl#getSimulationData <em>Simulation Data</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.StartErrorEventImpl#getResourcesUsages <em>Resources Usages</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.StartErrorEventImpl#getExecutionTime <em>Execution Time</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.StartErrorEventImpl#getEstimatedTime <em>Estimated Time</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.StartErrorEventImpl#getMaximumTime <em>Maximum Time</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.StartErrorEventImpl#isContigous <em>Contigous</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.StartErrorEventImpl#isExclusiveOutgoingTransition <em>Exclusive Outgoing Transition</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.StartErrorEventImpl#getLoopTransition <em>Loop Transition</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.StartErrorEventImpl#getDataChange <em>Data Change</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.StartErrorEventImpl#getDynamicLabel <em>Dynamic Label</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.StartErrorEventImpl#getDynamicDescription <em>Dynamic Description</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.StartErrorEventImpl#getStepSummary <em>Step Summary</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StartErrorEventImpl extends EObjectImpl implements StartErrorEvent {
	...
	public void setRegExpToHideDefaultField(String newRegExpToHideDefaultField) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.START_ERROR_EVENT__REG_EXP_TO_HIDE_DEFAULT_FIELD, oldRegExpToHideDefaultField, regExpToHideDefaultField));
	}
	...
	public void setUseRegExpToHideDefaultField(boolean newUseRegExpToHideDefaultField) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.START_ERROR_EVENT__USE_REG_EXP_TO_HIDE_DEFAULT_FIELD, oldUseRegExpToHideDefaultField, useRegExpToHideDefaultField));
	}
	...
	public EList<PageFlowTransition> getViewPageFlowTransitions() {
		if (viewPageFlowTransitions == null) {
			viewPageFlowTransitions = new EObjectContainmentEList<PageFlowTransition>(PageFlowTransition.class, this, ProcessPackage.START_ERROR_EVENT__VIEW_PAGE_FLOW_TRANSITIONS);
		}
	...
	public EList<Data> getViewTransientData() {
		if (viewTransientData == null) {
			viewTransientData = new EObjectContainmentEList<Data>(Data.class, this, ProcessPackage.START_ERROR_EVENT__VIEW_TRANSIENT_DATA);
		}
	...
	public EList<Connector> getViewPageFlowConnectors() {
		if (viewPageFlowConnectors == null) {
			viewPageFlowConnectors = new EObjectContainmentEList<Connector>(Connector.class, this, ProcessPackage.START_ERROR_EVENT__VIEW_PAGE_FLOW_CONNECTORS);
		}
	...
	public void setViewPageFlowType(ConsultationPageFlowType newViewPageFlowType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.START_ERROR_EVENT__VIEW_PAGE_FLOW_TYPE, oldViewPageFlowType, viewPageFlowType));
	}
	...
	public EList<ViewForm> getViewForm() {
		if (viewForm == null) {
			viewForm = new EObjectContainmentEList<ViewForm>(ViewForm.class, this, ProcessPackage.START_ERROR_EVENT__VIEW_FORM);
		}
		return viewForm;
	}
	...
	public NotificationChain basicSetViewPageFlowRedirectionURL(Expression newViewPageFlowRedirectionURL, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.START_ERROR_EVENT__VIEW_PAGE_FLOW_REDIRECTION_URL, oldViewPageFlowRedirectionURL, newViewPageFlowRedirectionURL);
	...
	public void setViewPageFlowRedirectionURL(Expression newViewPageFlowRedirectionURL) {
		if (newViewPageFlowRedirectionURL != viewPageFlowRedirectionURL) {
			...
			if (viewPageFlowRedirectionURL != null)
				msgs = ((InternalEObject)viewPageFlowRedirectionURL).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.START_ERROR_EVENT__VIEW_PAGE_FLOW_REDIRECTION_URL, null, msgs);
			if (newViewPageFlowRedirectionURL != null)
				msgs = ((InternalEObject)newViewPageFlowRedirectionURL).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.START_ERROR_EVENT__VIEW_PAGE_FLOW_REDIRECTION_URL, null, msgs);
			msgs = basicSetViewPageFlowRedirectionURL(newViewPageFlowRedirectionURL, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.START_ERROR_EVENT__VIEW_PAGE_FLOW_REDIRECTION_URL, newViewPageFlowRedirectionURL, newViewPageFlowRedirectionURL));
	}
	...
	public EList<SimulationData> getSimulationData() {
		if (simulationData == null) {
			simulationData = new EObjectContainmentEList<SimulationData>(SimulationData.class, this, ProcessPackage.START_ERROR_EVENT__SIMULATION_DATA);
		}
	...
	public EList<ResourceUsage> getResourcesUsages() {
		if (resourcesUsages == null) {
			resourcesUsages = new EObjectContainmentEList<ResourceUsage>(ResourceUsage.class, this, ProcessPackage.START_ERROR_EVENT__RESOURCES_USAGES);
		}
	...
	public void setExecutionTime(long newExecutionTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.START_ERROR_EVENT__EXECUTION_TIME, oldExecutionTime, executionTime));
	}
	...
	public void setEstimatedTime(double newEstimatedTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.START_ERROR_EVENT__ESTIMATED_TIME, oldEstimatedTime, estimatedTime));
	}
	...
	public void setMaximumTime(double newMaximumTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.START_ERROR_EVENT__MAXIMUM_TIME, oldMaximumTime, maximumTime));
	}
	...
	public void setContigous(boolean newContigous) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.START_ERROR_EVENT__CONTIGOUS, oldContigous, contigous));
	}
	...
	public void setExclusiveOutgoingTransition(boolean newExclusiveOutgoingTransition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.START_ERROR_EVENT__EXCLUSIVE_OUTGOING_TRANSITION, oldExclusiveOutgoingTransition, exclusiveOutgoingTransition));
	}
	...
	public NotificationChain basicSetLoopTransition(SimulationTransition newLoopTransition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.START_ERROR_EVENT__LOOP_TRANSITION, oldLoopTransition, newLoopTransition);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLoopTransition(SimulationTransition newLoopTransition) {
		if (newLoopTransition != loopTransition) {
			...
			if (loopTransition != null)
				msgs = ((InternalEObject)loopTransition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.START_ERROR_EVENT__LOOP_TRANSITION, null, msgs);
			if (newLoopTransition != null)
				msgs = ((InternalEObject)newLoopTransition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.START_ERROR_EVENT__LOOP_TRANSITION, null, msgs);
			msgs = basicSetLoopTransition(newLoopTransition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.START_ERROR_EVENT__LOOP_TRANSITION, newLoopTransition, newLoopTransition));
	}
	...
	public EList<DataChange> getDataChange() {
		if (dataChange == null) {
			dataChange = new EObjectContainmentEList<DataChange>(DataChange.class, this, ProcessPackage.START_ERROR_EVENT__DATA_CHANGE);
		}
		return dataChange;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case ProcessPackage.START_ERROR_EVENT__VIEW_PAGE_FLOW_TRANSITIONS:
				return ((InternalEList<?>)getViewPageFlowTransitions()).basicRemove(otherEnd, msgs);
			case ProcessPackage.START_ERROR_EVENT__VIEW_TRANSIENT_DATA:
				return ((InternalEList<?>)getViewTransientData()).basicRemove(otherEnd, msgs);
			case ProcessPackage.START_ERROR_EVENT__VIEW_PAGE_FLOW_CONNECTORS:
				return ((InternalEList<?>)getViewPageFlowConnectors()).basicRemove(otherEnd, msgs);
			case ProcessPackage.START_ERROR_EVENT__VIEW_FORM:
				return ((InternalEList<?>)getViewForm()).basicRemove(otherEnd, msgs);
			case ProcessPackage.START_ERROR_EVENT__VIEW_PAGE_FLOW_REDIRECTION_URL:
				return basicSetViewPageFlowRedirectionURL(null, msgs);
			case ProcessPackage.START_ERROR_EVENT__SIMULATION_DATA:
				return ((InternalEList<?>)getSimulationData()).basicRemove(otherEnd, msgs);
			case ProcessPackage.START_ERROR_EVENT__RESOURCES_USAGES:
				return ((InternalEList<?>)getResourcesUsages()).basicRemove(otherEnd, msgs);
			case ProcessPackage.START_ERROR_EVENT__LOOP_TRANSITION:
				return basicSetLoopTransition(null, msgs);
			case ProcessPackage.START_ERROR_EVENT__DATA_CHANGE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ProcessPackage.START_ERROR_EVENT__INCOMING:
				return getIncoming();
			case ProcessPackage.START_ERROR_EVENT__REG_EXP_TO_HIDE_DEFAULT_FIELD:
				return getRegExpToHideDefaultField();
			case ProcessPackage.START_ERROR_EVENT__USE_REG_EXP_TO_HIDE_DEFAULT_FIELD:
			...
			case ProcessPackage.START_ERROR_EVENT__VIEW_PAGE_FLOW_TYPE:
			...
			case ProcessPackage.START_ERROR_EVENT__EXECUTION_TIME:
				return getExecutionTime();
			case ProcessPackage.START_ERROR_EVENT__ESTIMATED_TIME:
				return getEstimatedTime();
			case ProcessPackage.START_ERROR_EVENT__MAXIMUM_TIME:
				return getMaximumTime();
			case ProcessPackage.START_ERROR_EVENT__CONTIGOUS:
				return isContigous();
			case ProcessPackage.START_ERROR_EVENT__EXCLUSIVE_OUTGOING_TRANSITION:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == AbstractPageFlow.class) {
			switch (derivedFeatureID) {
				case ProcessPackage.START_ERROR_EVENT__REG_EXP_TO_HIDE_DEFAULT_FIELD: return ProcessPackage.ABSTRACT_PAGE_FLOW__REG_EXP_TO_HIDE_DEFAULT_FIELD;
				case ProcessPackage.START_ERROR_EVENT__USE_REG_EXP_TO_HIDE_DEFAULT_FIELD: return ProcessPackage.ABSTRACT_PAGE_FLOW__USE_REG_EXP_TO_HIDE_DEFAULT_FIELD;
				default: return -1;
			}
		}
		if (baseClass == ViewPageFlow.class) {
			switch (derivedFeatureID) {
				case ProcessPackage.START_ERROR_EVENT__VIEW_PAGE_FLOW_TRANSITIONS: return ProcessPackage.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_TRANSITIONS;
				case ProcessPackage.START_ERROR_EVENT__VIEW_TRANSIENT_DATA: return ProcessPackage.VIEW_PAGE_FLOW__VIEW_TRANSIENT_DATA;
				case ProcessPackage.START_ERROR_EVENT__VIEW_PAGE_FLOW_CONNECTORS: return ProcessPackage.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_CONNECTORS;
				case ProcessPackage.START_ERROR_EVENT__VIEW_PAGE_FLOW_TYPE: return ProcessPackage.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_TYPE;
				case ProcessPackage.START_ERROR_EVENT__VIEW_FORM: return ProcessPackage.VIEW_PAGE_FLOW__VIEW_FORM;
				case ProcessPackage.START_ERROR_EVENT__VIEW_PAGE_FLOW_REDIRECTION_URL: return ProcessPackage.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_REDIRECTION_URL;
				default: return -1;
			}
		}
		if (baseClass == SimulationDataContainer.class) {
			switch (derivedFeatureID) {
				case ProcessPackage.START_ERROR_EVENT__SIMULATION_DATA: return SimulationPackage.SIMULATION_DATA_CONTAINER__SIMULATION_DATA;
				default: return -1;
			}
		}
		if (baseClass == SimulationActivity.class) {
			switch (derivedFeatureID) {
				case ProcessPackage.START_ERROR_EVENT__RESOURCES_USAGES: return SimulationPackage.SIMULATION_ACTIVITY__RESOURCES_USAGES;
				case ProcessPackage.START_ERROR_EVENT__EXECUTION_TIME: return SimulationPackage.SIMULATION_ACTIVITY__EXECUTION_TIME;
				case ProcessPackage.START_ERROR_EVENT__ESTIMATED_TIME: return SimulationPackage.SIMULATION_ACTIVITY__ESTIMATED_TIME;
				case ProcessPackage.START_ERROR_EVENT__MAXIMUM_TIME: return SimulationPackage.SIMULATION_ACTIVITY__MAXIMUM_TIME;
				case ProcessPackage.START_ERROR_EVENT__CONTIGOUS: return SimulationPackage.SIMULATION_ACTIVITY__CONTIGOUS;
				case ProcessPackage.START_ERROR_EVENT__EXCLUSIVE_OUTGOING_TRANSITION: return SimulationPackage.SIMULATION_ACTIVITY__EXCLUSIVE_OUTGOING_TRANSITION;
				case ProcessPackage.START_ERROR_EVENT__LOOP_TRANSITION: return SimulationPackage.SIMULATION_ACTIVITY__LOOP_TRANSITION;
				case ProcessPackage.START_ERROR_EVENT__DATA_CHANGE: return SimulationPackage.SIMULATION_ACTIVITY__DATA_CHANGE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == AbstractPageFlow.class) {
			switch (baseFeatureID) {
				case ProcessPackage.ABSTRACT_PAGE_FLOW__REG_EXP_TO_HIDE_DEFAULT_FIELD: return ProcessPackage.START_ERROR_EVENT__REG_EXP_TO_HIDE_DEFAULT_FIELD;
				case ProcessPackage.ABSTRACT_PAGE_FLOW__USE_REG_EXP_TO_HIDE_DEFAULT_FIELD: return ProcessPackage.START_ERROR_EVENT__USE_REG_EXP_TO_HIDE_DEFAULT_FIELD;
				default: return -1;
			}
		}
		if (baseClass == ViewPageFlow.class) {
			switch (baseFeatureID) {
				case ProcessPackage.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_TRANSITIONS: return ProcessPackage.START_ERROR_EVENT__VIEW_PAGE_FLOW_TRANSITIONS;
				case ProcessPackage.VIEW_PAGE_FLOW__VIEW_TRANSIENT_DATA: return ProcessPackage.START_ERROR_EVENT__VIEW_TRANSIENT_DATA;
				case ProcessPackage.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_CONNECTORS: return ProcessPackage.START_ERROR_EVENT__VIEW_PAGE_FLOW_CONNECTORS;
				case ProcessPackage.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_TYPE: return ProcessPackage.START_ERROR_EVENT__VIEW_PAGE_FLOW_TYPE;
				case ProcessPackage.VIEW_PAGE_FLOW__VIEW_FORM: return ProcessPackage.START_ERROR_EVENT__VIEW_FORM;
				case ProcessPackage.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_REDIRECTION_URL: return ProcessPackage.START_ERROR_EVENT__VIEW_PAGE_FLOW_REDIRECTION_URL;
				default: return -1;
			}
		}
		if (baseClass == SimulationDataContainer.class) {
			switch (baseFeatureID) {
				case SimulationPackage.SIMULATION_DATA_CONTAINER__SIMULATION_DATA: return ProcessPackage.START_ERROR_EVENT__SIMULATION_DATA;
				default: return -1;
			}
		}
		if (baseClass == SimulationActivity.class) {
			switch (baseFeatureID) {
				case SimulationPackage.SIMULATION_ACTIVITY__RESOURCES_USAGES: return ProcessPackage.START_ERROR_EVENT__RESOURCES_USAGES;
				case SimulationPackage.SIMULATION_ACTIVITY__EXECUTION_TIME: return ProcessPackage.START_ERROR_EVENT__EXECUTION_TIME;
				case SimulationPackage.SIMULATION_ACTIVITY__ESTIMATED_TIME: return ProcessPackage.START_ERROR_EVENT__ESTIMATED_TIME;
				case SimulationPackage.SIMULATION_ACTIVITY__MAXIMUM_TIME: return ProcessPackage.START_ERROR_EVENT__MAXIMUM_TIME;
				case SimulationPackage.SIMULATION_ACTIVITY__CONTIGOUS: return ProcessPackage.START_ERROR_EVENT__CONTIGOUS;
				case SimulationPackage.SIMULATION_ACTIVITY__EXCLUSIVE_OUTGOING_TRANSITION: return ProcessPackage.START_ERROR_EVENT__EXCLUSIVE_OUTGOING_TRANSITION;
				case SimulationPackage.SIMULATION_ACTIVITY__LOOP_TRANSITION: return ProcessPackage.START_ERROR_EVENT__LOOP_TRANSITION;
				case SimulationPackage.SIMULATION_ACTIVITY__DATA_CHANGE: return ProcessPackage.START_ERROR_EVENT__DATA_CHANGE;
				default: return -1;
			}
		}
		if (baseClass == FlowElement.class) {
