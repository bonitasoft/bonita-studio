 ...
 * <li>{@link org.bonitasoft.studio.model.simulation.impl.SimulationNumberRangeImpl#getRepartitionType <em>Repartition
 * Type</em>}</li>
 * </ul>
 *
 * @generated
...
public class SimulationNumberRangeImpl extends EObjectImpl implements SimulationNumberRange {
    ...
    public void setMin(long newMin) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SimulationPackage.SIMULATION_NUMBER_RANGE__MIN, oldMin,
                    min));
    }
    ...
    public void setMax(long newMax) {
        ...
        max = newMax;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SimulationPackage.SIMULATION_NUMBER_RANGE__MAX, oldMax,
                    max));
    }
    ...
    public void setProbability(double newProbability) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SimulationPackage.SIMULATION_NUMBER_RANGE__PROBABILITY,
    ...
    public void setRepartitionType(RepartitionType newRepartitionType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    SimulationPackage.SIMULATION_NUMBER_RANGE__REPARTITION_TYPE, oldRepartitionType, repartitionType));
    }
