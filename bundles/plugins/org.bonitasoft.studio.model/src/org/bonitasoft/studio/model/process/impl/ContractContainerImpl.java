    ...
    public NotificationChain basicSetContract(Contract newContract, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.CONTRACT_CONTAINER__CONTRACT, oldContract, newContract);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newContract != contract) {
            ...
            if (contract != null)
                msgs = ((InternalEObject) contract).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.CONTRACT_CONTAINER__CONTRACT, null, msgs);
            if (newContract != null)
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.CONTRACT_CONTAINER__CONTRACT, newContract,
                    newContract));
    }
