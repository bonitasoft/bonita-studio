...
public class FormImpl extends ConnectableElementImpl implements Form {
    ...
    public void setUseDefaultValidator(Boolean newUseDefaultValidator) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FORM__USE_DEFAULT_VALIDATOR,
    ...
    public NotificationChain basicSetHtmlTemplate(AssociatedFile newHtmlTemplate, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FormPackage.FORM__HTML_TEMPLATE,
                    oldHtmlTemplate, newHtmlTemplate);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newHtmlTemplate != htmlTemplate) {
            ...
            if (htmlTemplate != null)
                msgs = ((InternalEObject) htmlTemplate).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.FORM__HTML_TEMPLATE, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FORM__HTML_TEMPLATE, newHtmlTemplate,
                    newHtmlTemplate));
    }
    ...
    public EList<ResourceFile> getResourceFiles() {
        if (resourceFiles == null) {
            resourceFiles = new EObjectContainmentEList<ResourceFile>(ResourceFile.class, this,
                    FormPackage.FORM__RESOURCE_FILES);
        }
    ...
    public EList<ResourceFolder> getResourceFolders() {
        if (resourceFolders == null) {
            resourceFolders = new EObjectContainmentEList<ResourceFolder>(ResourceFolder.class, this,
                    FormPackage.FORM__RESOURCE_FOLDERS);
        }
    ...
    public EMap<String, String> getStringAttributes() {
        if (stringAttributes == null) {
            stringAttributes = new EcoreEMap<String, String>(EcorePackage.Literals.ESTRING_TO_STRING_MAP_ENTRY,
                    EStringToStringMapEntryImpl.class, this, FormPackage.FORM__STRING_ATTRIBUTES);
        }
    ...
    public void setShowPageLabel(Boolean newShowPageLabel) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FORM__SHOW_PAGE_LABEL, oldShowPageLabel,
                    showPageLabel));
    }
    ...
    public void setAllowHTMLInPageLabel(boolean newAllowHTMLInPageLabel) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FORM__ALLOW_HTML_IN_PAGE_LABEL,
                    oldAllowHTMLInPageLabel, allowHTMLInPageLabel));
    }
    ...
    public NotificationChain basicSetPageLabel(Expression newPageLabel, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FormPackage.FORM__PAGE_LABEL,
                    oldPageLabel, newPageLabel);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setPageLabel(Expression newPageLabel) {
        if (newPageLabel != pageLabel) {
            NotificationChain msgs = null;
            if (pageLabel != null)
                msgs = ((InternalEObject) pageLabel).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.FORM__PAGE_LABEL, null, msgs);
            if (newPageLabel != null)
                msgs = ((InternalEObject) newPageLabel).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.FORM__PAGE_LABEL, null, msgs);
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            ...
            case FormPackage.FORM__SHOW_PAGE_LABEL:
                return SHOW_PAGE_LABEL_EDEFAULT == null ? showPageLabel != null
                        : !SHOW_PAGE_LABEL_EDEFAULT.equals(showPageLabel);
            case FormPackage.FORM__ALLOW_HTML_IN_PAGE_LABEL:
        ...
        if (baseClass == Validable.class) {
            switch (baseFeatureID) {
                case FormPackage.VALIDABLE__VALIDATORS:
                    return FormPackage.FORM__VALIDATORS;
                case FormPackage.VALIDABLE__USE_DEFAULT_VALIDATOR:
                    return FormPackage.FORM__USE_DEFAULT_VALIDATOR;
                case FormPackage.VALIDABLE__BELOW:
                    return FormPackage.FORM__BELOW;
                default:
                    return -1;
            }
        }
