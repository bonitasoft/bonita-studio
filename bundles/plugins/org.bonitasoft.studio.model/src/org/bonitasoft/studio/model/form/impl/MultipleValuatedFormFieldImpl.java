 ...
 * </p>
 * <ul>
 * <li>{@link org.bonitasoft.studio.model.form.impl.MultipleValuatedFormFieldImpl#getDefaultExpression <em>Default
 * Expression</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.MultipleValuatedFormFieldImpl#getDefaultExpressionAfterEvent <em>Default
 * Expression After Event</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class MultipleValuatedFormFieldImpl extends FormFieldImpl implements MultipleValuatedFormField {
    ...
    public NotificationChain basicSetDefaultExpression(Expression newDefaultExpression, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.MULTIPLE_VALUATED_FORM_FIELD__DEFAULT_EXPRESSION, oldDefaultExpression,
        ...
        if (newDefaultExpression != defaultExpression) {
            ...
            if (defaultExpression != null)
                msgs = ((InternalEObject) defaultExpression).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.MULTIPLE_VALUATED_FORM_FIELD__DEFAULT_EXPRESSION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    FormPackage.MULTIPLE_VALUATED_FORM_FIELD__DEFAULT_EXPRESSION, newDefaultExpression,
                    newDefaultExpression));
    }
    ...
    public NotificationChain basicSetDefaultExpressionAfterEvent(Expression newDefaultExpressionAfterEvent,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.MULTIPLE_VALUATED_FORM_FIELD__DEFAULT_EXPRESSION_AFTER_EVENT, oldDefaultExpressionAfterEvent,
        ...
        if (newDefaultExpressionAfterEvent != defaultExpressionAfterEvent) {
            ...
            if (defaultExpressionAfterEvent != null)
                msgs = ((InternalEObject) defaultExpressionAfterEvent).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.MULTIPLE_VALUATED_FORM_FIELD__DEFAULT_EXPRESSION_AFTER_EVENT,
                        null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    FormPackage.MULTIPLE_VALUATED_FORM_FIELD__DEFAULT_EXPRESSION_AFTER_EVENT, newDefaultExpressionAfterEvent,
                    newDefaultExpressionAfterEvent));
    }
