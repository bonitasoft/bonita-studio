...
public class SimulationPackageImpl extends EPackageImpl implements SimulationPackage {
    ...
    public static SimulationPackage init() {
        ...
        SimulationPackageImpl theSimulationPackage = (SimulationPackageImpl) (EPackage.Registry.INSTANCE
                .get(eNS_URI) instanceof SimulationPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
    ...
    public void initializePackageContents() {
        ...
        initEClass(simulationElementEClass, SimulationElement.class, "SimulationElement", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getSimulationElement_Name(), ecorePackage.getEString(), "name", null, 1, 1, SimulationElement.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getSimulationElement_Description(), ecorePackage.getEString(), "description", null, 0, 1, //$NON-NLS-1$
                SimulationElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);

        initEClass(simulationDataEClass, SimulationData.class, "SimulationData", IS_ABSTRACT, IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getSimulationData_ExpressionBased(), ecorePackage.getEBoolean(), "expressionBased", "true", 1, 1, //$NON-NLS-1$//$NON-NLS-2$
                SimulationData.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEReference(getSimulationData_Expression(), theExpressionPackage.getExpression(), null, "expression", null, 0, 1, //$NON-NLS-1$
                SimulationData.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(simulationTransitionEClass, SimulationTransition.class, "SimulationTransition", !IS_ABSTRACT, //$NON-NLS-1$
                !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getSimulationTransition_Probability(), ecorePackage.getEDouble(), "probability", "1", 1, 1, //$NON-NLS-1$//$NON-NLS-2$
                SimulationTransition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getSimulationTransition_DataBased(), ecorePackage.getEBoolean(), "dataBased", null, 0, 1, //$NON-NLS-1$
                SimulationTransition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getSimulationTransition_UseExpression(), ecorePackage.getEBoolean(), "useExpression", "false", 0, 1, //$NON-NLS-1$//$NON-NLS-2$
                SimulationTransition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEReference(getSimulationTransition_Expression(), theExpressionPackage.getExpression(), null, "expression", null, //$NON-NLS-1$
                0, 1, SimulationTransition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
                !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(resourceUsageEClass, ResourceUsage.class, "ResourceUsage", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getResourceUsage_Duration(), ecorePackage.getELong(), "duration", null, 0, 1, ResourceUsage.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getResourceUsage_ResourceID(), ecorePackage.getEString(), "resourceID", null, 0, 1, //$NON-NLS-1$
                ResourceUsage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getResourceUsage_Quantity(), ecorePackage.getEInt(), "quantity", "1", 1, 1, ResourceUsage.class, //$NON-NLS-1$//$NON-NLS-2$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getResourceUsage_UseActivityDuration(), ecorePackage.getEBoolean(), "useActivityDuration", "true", 1, //$NON-NLS-1$//$NON-NLS-2$
                1, ResourceUsage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);

        initEClass(injectionPeriodEClass, InjectionPeriod.class, "InjectionPeriod", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getInjectionPeriod_Begin(), ecorePackage.getELong(), "begin", "0", 1, 1, InjectionPeriod.class, //$NON-NLS-1$//$NON-NLS-2$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getInjectionPeriod_End(), ecorePackage.getELong(), "end", "0", 1, 1, InjectionPeriod.class, //$NON-NLS-1$//$NON-NLS-2$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getInjectionPeriod_NbInstances(), ecorePackage.getEInt(), "nbInstances", "1", 1, 1, //$NON-NLS-1$//$NON-NLS-2$
                InjectionPeriod.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getInjectionPeriod_Repartition(), this.getRepartitionType(), "repartition", "CONSTANT", 1, 1, //$NON-NLS-1$//$NON-NLS-2$
                InjectionPeriod.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);

        initEClass(simulationBooleanEClass, SimulationBoolean.class, "SimulationBoolean", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getSimulationBoolean_ProbabilityOfTrue(), ecorePackage.getEDouble(), "probabilityOfTrue", "1", 1, 1, //$NON-NLS-1$//$NON-NLS-2$
                SimulationBoolean.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);

        initEClass(simulationNumberDataEClass, SimulationNumberData.class, "SimulationNumberData", !IS_ABSTRACT, //$NON-NLS-1$
                !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getSimulationNumberData_Ranges(), this.getSimulationNumberRange(), null, "ranges", null, 0, -1, //$NON-NLS-1$
                SimulationNumberData.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(simulationLiteralDataEClass, SimulationLiteralData.class, "SimulationLiteralData", !IS_ABSTRACT, //$NON-NLS-1$
                !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getSimulationLiteralData_Literals(), this.getSimulationLiteral(), null, "literals", null, 0, -1, //$NON-NLS-1$
                SimulationLiteralData.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(simulationLiteralEClass, SimulationLiteral.class, "SimulationLiteral", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getSimulationLiteral_Probability(), ecorePackage.getEDouble(), "probability", "1", 1, 1, //$NON-NLS-1$//$NON-NLS-2$
                SimulationLiteral.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getSimulationLiteral_Value(), ecorePackage.getEString(), "value", "", 1, 1, SimulationLiteral.class, //$NON-NLS-1$//$NON-NLS-2$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(simulationNumberRangeEClass, SimulationNumberRange.class, "SimulationNumberRange", !IS_ABSTRACT, //$NON-NLS-1$
                !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getSimulationNumberRange_Min(), ecorePackage.getELong(), "min", "0", 1, 1, //$NON-NLS-1$//$NON-NLS-2$
                SimulationNumberRange.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getSimulationNumberRange_Max(), ecorePackage.getELong(), "max", "0", 1, 1, //$NON-NLS-1$//$NON-NLS-2$
                SimulationNumberRange.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getSimulationNumberRange_Probability(), ecorePackage.getEDouble(), "probability", "1", 0, 1, //$NON-NLS-1$//$NON-NLS-2$
                SimulationNumberRange.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getSimulationNumberRange_RepartitionType(), this.getRepartitionType(), "repartitionType", "CONSTANT", //$NON-NLS-1$//$NON-NLS-2$
                1, 1, SimulationNumberRange.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(simulationDataContainerEClass, SimulationDataContainer.class, "SimulationDataContainer", IS_ABSTRACT, //$NON-NLS-1$
                IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getSimulationDataContainer_SimulationData(), this.getSimulationData(), null, "simulationData", null, //$NON-NLS-1$
                0, -1, SimulationDataContainer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
                !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(simulationAbstractProcessEClass, SimulationAbstractProcess.class, "SimulationAbstractProcess", //$NON-NLS-1$
                IS_ABSTRACT, IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getSimulationAbstractProcess_LoadProfileID(), ecorePackage.getEString(), "loadProfileID", null, 0, 1, //$NON-NLS-1$
                SimulationAbstractProcess.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getSimulationAbstractProcess_MaximumTime(), ecorePackage.getELong(), "maximumTime", null, 0, 1, //$NON-NLS-1$
                SimulationAbstractProcess.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(simulationActivityEClass, SimulationActivity.class, "SimulationActivity", IS_ABSTRACT, IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getSimulationActivity_ResourcesUsages(), this.getResourceUsage(), null, "resourcesUsages", null, 0, //$NON-NLS-1$
                -1, SimulationActivity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getSimulationActivity_ExecutionTime(), ecorePackage.getELong(), "executionTime", null, 0, 1, //$NON-NLS-1$
                SimulationActivity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getSimulationActivity_EstimatedTime(), ecorePackage.getEDouble(), "estimatedTime", "0", 0, 1, //$NON-NLS-1$//$NON-NLS-2$
                SimulationActivity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getSimulationActivity_MaximumTime(), ecorePackage.getEDouble(), "maximumTime", "0", 0, 1, //$NON-NLS-1$//$NON-NLS-2$
                SimulationActivity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getSimulationActivity_Contigous(), ecorePackage.getEBoolean(), "contigous", null, 0, 1, //$NON-NLS-1$
                SimulationActivity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getSimulationActivity_ExclusiveOutgoingTransition(), ecorePackage.getEBoolean(),
                "exclusiveOutgoingTransition", null, 0, 1, SimulationActivity.class, !IS_TRANSIENT, !IS_VOLATILE, //$NON-NLS-1$
                IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getSimulationActivity_LoopTransition(), this.getSimulationTransition(), null, "loopTransition", null, //$NON-NLS-1$
                0, 1, SimulationActivity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
                !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getSimulationActivity_DataChange(), this.getDataChange(), null, "dataChange", null, 0, -1, //$NON-NLS-1$
                SimulationActivity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(dataChangeEClass, DataChange.class, "DataChange", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getDataChange_Data(), this.getSimulationData(), null, "data", null, 0, 1, DataChange.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEReference(getDataChange_Value(), theExpressionPackage.getExpression(), null, "value", null, 0, 1, //$NON-NLS-1$
                DataChange.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(simulationCalendarEClass, SimulationCalendar.class, "SimulationCalendar", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getSimulationCalendar_DaysOfWeek(), this.getDayPeriod(), null, "daysOfWeek", null, 0, 7, //$NON-NLS-1$
                SimulationCalendar.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(dayPeriodEClass, DayPeriod.class, "DayPeriod", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
        initEAttribute(getDayPeriod_Day(), ecorePackage.getEInt(), "day", null, 0, -1, DayPeriod.class, !IS_TRANSIENT, //$NON-NLS-1$
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getDayPeriod_StartHour(), ecorePackage.getEInt(), "startHour", "0", 1, 1, DayPeriod.class, //$NON-NLS-1$//$NON-NLS-2$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getDayPeriod_EndHour(), ecorePackage.getEInt(), "endHour", "0", 1, 1, DayPeriod.class, !IS_TRANSIENT, //$NON-NLS-1$//$NON-NLS-2$
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getDayPeriod_StartMinute(), ecorePackage.getEInt(), "startMinute", "0", 1, 1, DayPeriod.class, //$NON-NLS-1$//$NON-NLS-2$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getDayPeriod_EndMinute(), ecorePackage.getEInt(), "endMinute", "0", 1, 1, DayPeriod.class, //$NON-NLS-1$//$NON-NLS-2$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(modelVersionEClass, ModelVersion.class, "ModelVersion", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getModelVersion_Version(), ecorePackage.getEString(), "version", null, 0, 1, ModelVersion.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(loadProfileEClass, LoadProfile.class, "LoadProfile", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getLoadProfile_Calendar(), this.getSimulationCalendar(), null, "calendar", null, 0, 1, //$NON-NLS-1$
                LoadProfile.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getLoadProfile_InjectionPeriods(), this.getInjectionPeriod(), null, "injectionPeriods", null, 0, -1, //$NON-NLS-1$
                LoadProfile.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEAttribute(getResource_Type(), ecorePackage.getEString(), "type", null, 0, 1, Resource.class, !IS_TRANSIENT, //$NON-NLS-1$
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getResource_Quantity(), ecorePackage.getEInt(), "quantity", "1", 0, 1, Resource.class, !IS_TRANSIENT, //$NON-NLS-1$//$NON-NLS-2$
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getResource_MaximumQuantity(), ecorePackage.getEInt(), "maximumQuantity", null, 0, 1, Resource.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getResource_CostUnit(), ecorePackage.getEString(), "costUnit", null, 0, 1, Resource.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getResource_TimeUnit(), this.getTimeUnit(), "timeUnit", null, 0, 1, Resource.class, !IS_TRANSIENT, //$NON-NLS-1$
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getResource_FixedCost(), ecorePackage.getEDouble(), "fixedCost", null, 0, 1, Resource.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getResource_TimeCost(), ecorePackage.getEDouble(), "timeCost", null, 0, 1, Resource.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getResource_Calendar(), this.getSimulationCalendar(), null, "calendar", null, 0, 1, Resource.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getResource_Unlimited(), ecorePackage.getEBoolean(), "unlimited", "false", 0, 1, Resource.class, //$NON-NLS-1$//$NON-NLS-2$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
