...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>End Signal Event</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.EndSignalEventImpl#getDocumentation <em>Documentation</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.EndSignalEventImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.EndSignalEventImpl#getTextAnnotationAttachment <em>Text Annotation Attachment</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.EndSignalEventImpl#getSignalCode <em>Signal Code</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.EndSignalEventImpl#getOutgoing <em>Outgoing</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.EndSignalEventImpl#getIncoming <em>Incoming</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.EndSignalEventImpl#getRegExpToHideDefaultField <em>Reg Exp To Hide Default Field</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.EndSignalEventImpl#isUseRegExpToHideDefaultField <em>Use Reg Exp To Hide Default Field</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.EndSignalEventImpl#getViewPageFlowTransitions <em>View Page Flow Transitions</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.EndSignalEventImpl#getViewTransientData <em>View Transient Data</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.EndSignalEventImpl#getViewPageFlowConnectors <em>View Page Flow Connectors</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.EndSignalEventImpl#getViewPageFlowType <em>View Page Flow Type</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.EndSignalEventImpl#getViewForm <em>View Form</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.EndSignalEventImpl#getViewPageFlowRedirectionURL <em>View Page Flow Redirection URL</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.EndSignalEventImpl#getSimulationData <em>Simulation Data</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.EndSignalEventImpl#getResourcesUsages <em>Resources Usages</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.EndSignalEventImpl#getExecutionTime <em>Execution Time</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.EndSignalEventImpl#getEstimatedTime <em>Estimated Time</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.EndSignalEventImpl#getMaximumTime <em>Maximum Time</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.EndSignalEventImpl#isContigous <em>Contigous</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.EndSignalEventImpl#isExclusiveOutgoingTransition <em>Exclusive Outgoing Transition</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.EndSignalEventImpl#getLoopTransition <em>Loop Transition</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.EndSignalEventImpl#getDataChange <em>Data Change</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.EndSignalEventImpl#getDynamicLabel <em>Dynamic Label</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.EndSignalEventImpl#getDynamicDescription <em>Dynamic Description</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.EndSignalEventImpl#getStepSummary <em>Step Summary</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EndSignalEventImpl extends EObjectImpl implements EndSignalEvent {
	/**
	...
	protected EClass eStaticClass() {
		return ProcessPackage.Literals.END_SIGNAL_EVENT;
	}
	...
	public void setDocumentation(String newDocumentation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.END_SIGNAL_EVENT__DOCUMENTATION, oldDocumentation, documentation));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.END_SIGNAL_EVENT__NAME, oldName, name));
	}
	...
	public void setSignalCode(String newSignalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.END_SIGNAL_EVENT__SIGNAL_CODE, oldSignalCode, signalCode));
	}
	...
	public void setRegExpToHideDefaultField(String newRegExpToHideDefaultField) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.END_SIGNAL_EVENT__REG_EXP_TO_HIDE_DEFAULT_FIELD, oldRegExpToHideDefaultField, regExpToHideDefaultField));
	}
	...
	public void setUseRegExpToHideDefaultField(boolean newUseRegExpToHideDefaultField) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.END_SIGNAL_EVENT__USE_REG_EXP_TO_HIDE_DEFAULT_FIELD, oldUseRegExpToHideDefaultField, useRegExpToHideDefaultField));
	}
	...
	public EList<PageFlowTransition> getViewPageFlowTransitions() {
		if (viewPageFlowTransitions == null) {
			viewPageFlowTransitions = new EObjectContainmentEList<PageFlowTransition>(PageFlowTransition.class, this, ProcessPackage.END_SIGNAL_EVENT__VIEW_PAGE_FLOW_TRANSITIONS);
		}
	...
	public EList<Data> getViewTransientData() {
		if (viewTransientData == null) {
			viewTransientData = new EObjectContainmentEList<Data>(Data.class, this, ProcessPackage.END_SIGNAL_EVENT__VIEW_TRANSIENT_DATA);
		}
	...
	public EList<Connector> getViewPageFlowConnectors() {
		if (viewPageFlowConnectors == null) {
			viewPageFlowConnectors = new EObjectContainmentEList<Connector>(Connector.class, this, ProcessPackage.END_SIGNAL_EVENT__VIEW_PAGE_FLOW_CONNECTORS);
		}
	...
	public void setViewPageFlowType(ConsultationPageFlowType newViewPageFlowType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.END_SIGNAL_EVENT__VIEW_PAGE_FLOW_TYPE, oldViewPageFlowType, viewPageFlowType));
	}
	...
	public EList<ViewForm> getViewForm() {
		if (viewForm == null) {
			viewForm = new EObjectContainmentEList<ViewForm>(ViewForm.class, this, ProcessPackage.END_SIGNAL_EVENT__VIEW_FORM);
		}
		return viewForm;
	}
	...
	public NotificationChain basicSetViewPageFlowRedirectionURL(Expression newViewPageFlowRedirectionURL, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.END_SIGNAL_EVENT__VIEW_PAGE_FLOW_REDIRECTION_URL, oldViewPageFlowRedirectionURL, newViewPageFlowRedirectionURL);
	...
	public void setViewPageFlowRedirectionURL(Expression newViewPageFlowRedirectionURL) {
		if (newViewPageFlowRedirectionURL != viewPageFlowRedirectionURL) {
			...
			if (viewPageFlowRedirectionURL != null)
				msgs = ((InternalEObject)viewPageFlowRedirectionURL).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.END_SIGNAL_EVENT__VIEW_PAGE_FLOW_REDIRECTION_URL, null, msgs);
			if (newViewPageFlowRedirectionURL != null)
				msgs = ((InternalEObject)newViewPageFlowRedirectionURL).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.END_SIGNAL_EVENT__VIEW_PAGE_FLOW_REDIRECTION_URL, null, msgs);
			msgs = basicSetViewPageFlowRedirectionURL(newViewPageFlowRedirectionURL, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.END_SIGNAL_EVENT__VIEW_PAGE_FLOW_REDIRECTION_URL, newViewPageFlowRedirectionURL, newViewPageFlowRedirectionURL));
	}
	...
	public EList<SimulationData> getSimulationData() {
		if (simulationData == null) {
			simulationData = new EObjectContainmentEList<SimulationData>(SimulationData.class, this, ProcessPackage.END_SIGNAL_EVENT__SIMULATION_DATA);
		}
	...
	public EList<ResourceUsage> getResourcesUsages() {
		if (resourcesUsages == null) {
			resourcesUsages = new EObjectContainmentEList<ResourceUsage>(ResourceUsage.class, this, ProcessPackage.END_SIGNAL_EVENT__RESOURCES_USAGES);
		}
	...
	public void setExecutionTime(long newExecutionTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.END_SIGNAL_EVENT__EXECUTION_TIME, oldExecutionTime, executionTime));
	}
	...
	public void setEstimatedTime(double newEstimatedTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.END_SIGNAL_EVENT__ESTIMATED_TIME, oldEstimatedTime, estimatedTime));
	}
	...
	public void setMaximumTime(double newMaximumTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.END_SIGNAL_EVENT__MAXIMUM_TIME, oldMaximumTime, maximumTime));
	}
	...
	public void setContigous(boolean newContigous) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.END_SIGNAL_EVENT__CONTIGOUS, oldContigous, contigous));
	}
	...
	public void setExclusiveOutgoingTransition(boolean newExclusiveOutgoingTransition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.END_SIGNAL_EVENT__EXCLUSIVE_OUTGOING_TRANSITION, oldExclusiveOutgoingTransition, exclusiveOutgoingTransition));
	}
	...
	public NotificationChain basicSetLoopTransition(SimulationTransition newLoopTransition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.END_SIGNAL_EVENT__LOOP_TRANSITION, oldLoopTransition, newLoopTransition);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLoopTransition(SimulationTransition newLoopTransition) {
		if (newLoopTransition != loopTransition) {
			...
			if (loopTransition != null)
				msgs = ((InternalEObject)loopTransition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.END_SIGNAL_EVENT__LOOP_TRANSITION, null, msgs);
			if (newLoopTransition != null)
				msgs = ((InternalEObject)newLoopTransition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.END_SIGNAL_EVENT__LOOP_TRANSITION, null, msgs);
			msgs = basicSetLoopTransition(newLoopTransition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.END_SIGNAL_EVENT__LOOP_TRANSITION, newLoopTransition, newLoopTransition));
	}
	...
	public EList<DataChange> getDataChange() {
		if (dataChange == null) {
			dataChange = new EObjectContainmentEList<DataChange>(DataChange.class, this, ProcessPackage.END_SIGNAL_EVENT__DATA_CHANGE);
		}
		return dataChange;
	}
	...
	public NotificationChain basicSetDynamicLabel(Expression newDynamicLabel, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.END_SIGNAL_EVENT__DYNAMIC_LABEL, oldDynamicLabel, newDynamicLabel);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDynamicLabel(Expression newDynamicLabel) {
		if (newDynamicLabel != dynamicLabel) {
			...
			if (dynamicLabel != null)
				msgs = ((InternalEObject)dynamicLabel).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.END_SIGNAL_EVENT__DYNAMIC_LABEL, null, msgs);
			if (newDynamicLabel != null)
				msgs = ((InternalEObject)newDynamicLabel).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.END_SIGNAL_EVENT__DYNAMIC_LABEL, null, msgs);
			msgs = basicSetDynamicLabel(newDynamicLabel, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.END_SIGNAL_EVENT__DYNAMIC_LABEL, newDynamicLabel, newDynamicLabel));
	}
	...
	public NotificationChain basicSetDynamicDescription(Expression newDynamicDescription, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.END_SIGNAL_EVENT__DYNAMIC_DESCRIPTION, oldDynamicDescription, newDynamicDescription);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDynamicDescription(Expression newDynamicDescription) {
		if (newDynamicDescription != dynamicDescription) {
			...
			if (dynamicDescription != null)
				msgs = ((InternalEObject)dynamicDescription).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.END_SIGNAL_EVENT__DYNAMIC_DESCRIPTION, null, msgs);
			if (newDynamicDescription != null)
				msgs = ((InternalEObject)newDynamicDescription).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.END_SIGNAL_EVENT__DYNAMIC_DESCRIPTION, null, msgs);
			msgs = basicSetDynamicDescription(newDynamicDescription, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.END_SIGNAL_EVENT__DYNAMIC_DESCRIPTION, newDynamicDescription, newDynamicDescription));
	}
	...
	public NotificationChain basicSetStepSummary(Expression newStepSummary, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.END_SIGNAL_EVENT__STEP_SUMMARY, oldStepSummary, newStepSummary);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setStepSummary(Expression newStepSummary) {
		if (newStepSummary != stepSummary) {
			NotificationChain msgs = null;
			if (stepSummary != null)
				msgs = ((InternalEObject)stepSummary).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.END_SIGNAL_EVENT__STEP_SUMMARY, null, msgs);
			if (newStepSummary != null)
				msgs = ((InternalEObject)newStepSummary).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.END_SIGNAL_EVENT__STEP_SUMMARY, null, msgs);
			msgs = basicSetStepSummary(newStepSummary, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.END_SIGNAL_EVENT__STEP_SUMMARY, newStepSummary, newStepSummary));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ProcessPackage.END_SIGNAL_EVENT__TEXT_ANNOTATION_ATTACHMENT:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getTextAnnotationAttachment()).basicAdd(otherEnd, msgs);
			case ProcessPackage.END_SIGNAL_EVENT__OUTGOING:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getOutgoing()).basicAdd(otherEnd, msgs);
			case ProcessPackage.END_SIGNAL_EVENT__INCOMING:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case ProcessPackage.END_SIGNAL_EVENT__VIEW_PAGE_FLOW_TRANSITIONS:
				return ((InternalEList<?>)getViewPageFlowTransitions()).basicRemove(otherEnd, msgs);
			case ProcessPackage.END_SIGNAL_EVENT__VIEW_TRANSIENT_DATA:
				return ((InternalEList<?>)getViewTransientData()).basicRemove(otherEnd, msgs);
			case ProcessPackage.END_SIGNAL_EVENT__VIEW_PAGE_FLOW_CONNECTORS:
				return ((InternalEList<?>)getViewPageFlowConnectors()).basicRemove(otherEnd, msgs);
			case ProcessPackage.END_SIGNAL_EVENT__VIEW_FORM:
				return ((InternalEList<?>)getViewForm()).basicRemove(otherEnd, msgs);
			case ProcessPackage.END_SIGNAL_EVENT__VIEW_PAGE_FLOW_REDIRECTION_URL:
				return basicSetViewPageFlowRedirectionURL(null, msgs);
			case ProcessPackage.END_SIGNAL_EVENT__SIMULATION_DATA:
				return ((InternalEList<?>)getSimulationData()).basicRemove(otherEnd, msgs);
			case ProcessPackage.END_SIGNAL_EVENT__RESOURCES_USAGES:
				return ((InternalEList<?>)getResourcesUsages()).basicRemove(otherEnd, msgs);
			case ProcessPackage.END_SIGNAL_EVENT__LOOP_TRANSITION:
				return basicSetLoopTransition(null, msgs);
			case ProcessPackage.END_SIGNAL_EVENT__DATA_CHANGE:
				return ((InternalEList<?>)getDataChange()).basicRemove(otherEnd, msgs);
			case ProcessPackage.END_SIGNAL_EVENT__DYNAMIC_LABEL:
				return basicSetDynamicLabel(null, msgs);
			case ProcessPackage.END_SIGNAL_EVENT__DYNAMIC_DESCRIPTION:
				return basicSetDynamicDescription(null, msgs);
			case ProcessPackage.END_SIGNAL_EVENT__STEP_SUMMARY:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ProcessPackage.END_SIGNAL_EVENT__DOCUMENTATION:
				return getDocumentation();
			case ProcessPackage.END_SIGNAL_EVENT__NAME:
				return getName();
			case ProcessPackage.END_SIGNAL_EVENT__TEXT_ANNOTATION_ATTACHMENT:
				return getTextAnnotationAttachment();
			case ProcessPackage.END_SIGNAL_EVENT__SIGNAL_CODE:
				return getSignalCode();
			case ProcessPackage.END_SIGNAL_EVENT__OUTGOING:
				return getOutgoing();
			case ProcessPackage.END_SIGNAL_EVENT__INCOMING:
				return getIncoming();
			case ProcessPackage.END_SIGNAL_EVENT__REG_EXP_TO_HIDE_DEFAULT_FIELD:
				return getRegExpToHideDefaultField();
			case ProcessPackage.END_SIGNAL_EVENT__USE_REG_EXP_TO_HIDE_DEFAULT_FIELD:
			...
			case ProcessPackage.END_SIGNAL_EVENT__VIEW_PAGE_FLOW_TYPE:
			...
			case ProcessPackage.END_SIGNAL_EVENT__EXECUTION_TIME:
				return getExecutionTime();
			case ProcessPackage.END_SIGNAL_EVENT__ESTIMATED_TIME:
				return getEstimatedTime();
			case ProcessPackage.END_SIGNAL_EVENT__MAXIMUM_TIME:
				return getMaximumTime();
			case ProcessPackage.END_SIGNAL_EVENT__CONTIGOUS:
				return isContigous();
			case ProcessPackage.END_SIGNAL_EVENT__EXCLUSIVE_OUTGOING_TRANSITION:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == SourceElement.class) {
			switch (derivedFeatureID) {
				case ProcessPackage.END_SIGNAL_EVENT__OUTGOING: return ProcessPackage.SOURCE_ELEMENT__OUTGOING;
				default: return -1;
			}
		}
		if (baseClass == TargetElement.class) {
			switch (derivedFeatureID) {
				case ProcessPackage.END_SIGNAL_EVENT__INCOMING: return ProcessPackage.TARGET_ELEMENT__INCOMING;
				default: return -1;
			}
		}
		if (baseClass == AbstractPageFlow.class) {
			switch (derivedFeatureID) {
				case ProcessPackage.END_SIGNAL_EVENT__REG_EXP_TO_HIDE_DEFAULT_FIELD: return ProcessPackage.ABSTRACT_PAGE_FLOW__REG_EXP_TO_HIDE_DEFAULT_FIELD;
				case ProcessPackage.END_SIGNAL_EVENT__USE_REG_EXP_TO_HIDE_DEFAULT_FIELD: return ProcessPackage.ABSTRACT_PAGE_FLOW__USE_REG_EXP_TO_HIDE_DEFAULT_FIELD;
				default: return -1;
			}
		}
		if (baseClass == ViewPageFlow.class) {
			switch (derivedFeatureID) {
				case ProcessPackage.END_SIGNAL_EVENT__VIEW_PAGE_FLOW_TRANSITIONS: return ProcessPackage.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_TRANSITIONS;
				case ProcessPackage.END_SIGNAL_EVENT__VIEW_TRANSIENT_DATA: return ProcessPackage.VIEW_PAGE_FLOW__VIEW_TRANSIENT_DATA;
				case ProcessPackage.END_SIGNAL_EVENT__VIEW_PAGE_FLOW_CONNECTORS: return ProcessPackage.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_CONNECTORS;
				case ProcessPackage.END_SIGNAL_EVENT__VIEW_PAGE_FLOW_TYPE: return ProcessPackage.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_TYPE;
				case ProcessPackage.END_SIGNAL_EVENT__VIEW_FORM: return ProcessPackage.VIEW_PAGE_FLOW__VIEW_FORM;
				case ProcessPackage.END_SIGNAL_EVENT__VIEW_PAGE_FLOW_REDIRECTION_URL: return ProcessPackage.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_REDIRECTION_URL;
				default: return -1;
			}
		}
		if (baseClass == SimulationDataContainer.class) {
			switch (derivedFeatureID) {
				case ProcessPackage.END_SIGNAL_EVENT__SIMULATION_DATA: return SimulationPackage.SIMULATION_DATA_CONTAINER__SIMULATION_DATA;
				default: return -1;
			}
		}
		if (baseClass == SimulationActivity.class) {
			switch (derivedFeatureID) {
				case ProcessPackage.END_SIGNAL_EVENT__RESOURCES_USAGES: return SimulationPackage.SIMULATION_ACTIVITY__RESOURCES_USAGES;
				case ProcessPackage.END_SIGNAL_EVENT__EXECUTION_TIME: return SimulationPackage.SIMULATION_ACTIVITY__EXECUTION_TIME;
				case ProcessPackage.END_SIGNAL_EVENT__ESTIMATED_TIME: return SimulationPackage.SIMULATION_ACTIVITY__ESTIMATED_TIME;
				case ProcessPackage.END_SIGNAL_EVENT__MAXIMUM_TIME: return SimulationPackage.SIMULATION_ACTIVITY__MAXIMUM_TIME;
				case ProcessPackage.END_SIGNAL_EVENT__CONTIGOUS: return SimulationPackage.SIMULATION_ACTIVITY__CONTIGOUS;
				case ProcessPackage.END_SIGNAL_EVENT__EXCLUSIVE_OUTGOING_TRANSITION: return SimulationPackage.SIMULATION_ACTIVITY__EXCLUSIVE_OUTGOING_TRANSITION;
				case ProcessPackage.END_SIGNAL_EVENT__LOOP_TRANSITION: return SimulationPackage.SIMULATION_ACTIVITY__LOOP_TRANSITION;
				case ProcessPackage.END_SIGNAL_EVENT__DATA_CHANGE: return SimulationPackage.SIMULATION_ACTIVITY__DATA_CHANGE;
				default: return -1;
			}
		}
		if (baseClass == FlowElement.class) {
			switch (derivedFeatureID) {
				case ProcessPackage.END_SIGNAL_EVENT__DYNAMIC_LABEL: return ProcessPackage.FLOW_ELEMENT__DYNAMIC_LABEL;
				case ProcessPackage.END_SIGNAL_EVENT__DYNAMIC_DESCRIPTION: return ProcessPackage.FLOW_ELEMENT__DYNAMIC_DESCRIPTION;
				case ProcessPackage.END_SIGNAL_EVENT__STEP_SUMMARY: return ProcessPackage.FLOW_ELEMENT__STEP_SUMMARY;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == SourceElement.class) {
			switch (baseFeatureID) {
				case ProcessPackage.SOURCE_ELEMENT__OUTGOING: return ProcessPackage.END_SIGNAL_EVENT__OUTGOING;
				default: return -1;
			}
		}
		if (baseClass == TargetElement.class) {
			switch (baseFeatureID) {
				case ProcessPackage.TARGET_ELEMENT__INCOMING: return ProcessPackage.END_SIGNAL_EVENT__INCOMING;
				default: return -1;
			}
		}
		if (baseClass == AbstractPageFlow.class) {
			switch (baseFeatureID) {
				case ProcessPackage.ABSTRACT_PAGE_FLOW__REG_EXP_TO_HIDE_DEFAULT_FIELD: return ProcessPackage.END_SIGNAL_EVENT__REG_EXP_TO_HIDE_DEFAULT_FIELD;
				case ProcessPackage.ABSTRACT_PAGE_FLOW__USE_REG_EXP_TO_HIDE_DEFAULT_FIELD: return ProcessPackage.END_SIGNAL_EVENT__USE_REG_EXP_TO_HIDE_DEFAULT_FIELD;
				default: return -1;
			}
		}
		if (baseClass == ViewPageFlow.class) {
			switch (baseFeatureID) {
				case ProcessPackage.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_TRANSITIONS: return ProcessPackage.END_SIGNAL_EVENT__VIEW_PAGE_FLOW_TRANSITIONS;
				case ProcessPackage.VIEW_PAGE_FLOW__VIEW_TRANSIENT_DATA: return ProcessPackage.END_SIGNAL_EVENT__VIEW_TRANSIENT_DATA;
				case ProcessPackage.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_CONNECTORS: return ProcessPackage.END_SIGNAL_EVENT__VIEW_PAGE_FLOW_CONNECTORS;
				case ProcessPackage.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_TYPE: return ProcessPackage.END_SIGNAL_EVENT__VIEW_PAGE_FLOW_TYPE;
				case ProcessPackage.VIEW_PAGE_FLOW__VIEW_FORM: return ProcessPackage.END_SIGNAL_EVENT__VIEW_FORM;
				case ProcessPackage.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_REDIRECTION_URL: return ProcessPackage.END_SIGNAL_EVENT__VIEW_PAGE_FLOW_REDIRECTION_URL;
				default: return -1;
			}
		}
		if (baseClass == SimulationDataContainer.class) {
			switch (baseFeatureID) {
				case SimulationPackage.SIMULATION_DATA_CONTAINER__SIMULATION_DATA: return ProcessPackage.END_SIGNAL_EVENT__SIMULATION_DATA;
				default: return -1;
			}
		}
		if (baseClass == SimulationActivity.class) {
			switch (baseFeatureID) {
				case SimulationPackage.SIMULATION_ACTIVITY__RESOURCES_USAGES: return ProcessPackage.END_SIGNAL_EVENT__RESOURCES_USAGES;
				case SimulationPackage.SIMULATION_ACTIVITY__EXECUTION_TIME: return ProcessPackage.END_SIGNAL_EVENT__EXECUTION_TIME;
				case SimulationPackage.SIMULATION_ACTIVITY__ESTIMATED_TIME: return ProcessPackage.END_SIGNAL_EVENT__ESTIMATED_TIME;
				case SimulationPackage.SIMULATION_ACTIVITY__MAXIMUM_TIME: return ProcessPackage.END_SIGNAL_EVENT__MAXIMUM_TIME;
				case SimulationPackage.SIMULATION_ACTIVITY__CONTIGOUS: return ProcessPackage.END_SIGNAL_EVENT__CONTIGOUS;
				case SimulationPackage.SIMULATION_ACTIVITY__EXCLUSIVE_OUTGOING_TRANSITION: return ProcessPackage.END_SIGNAL_EVENT__EXCLUSIVE_OUTGOING_TRANSITION;
				case SimulationPackage.SIMULATION_ACTIVITY__LOOP_TRANSITION: return ProcessPackage.END_SIGNAL_EVENT__LOOP_TRANSITION;
				case SimulationPackage.SIMULATION_ACTIVITY__DATA_CHANGE: return ProcessPackage.END_SIGNAL_EVENT__DATA_CHANGE;
				default: return -1;
			}
		}
		if (baseClass == FlowElement.class) {
			switch (baseFeatureID) {
				case ProcessPackage.FLOW_ELEMENT__DYNAMIC_LABEL: return ProcessPackage.END_SIGNAL_EVENT__DYNAMIC_LABEL;
				case ProcessPackage.FLOW_ELEMENT__DYNAMIC_DESCRIPTION: return ProcessPackage.END_SIGNAL_EVENT__DYNAMIC_DESCRIPTION;
				case ProcessPackage.FLOW_ELEMENT__STEP_SUMMARY: return ProcessPackage.END_SIGNAL_EVENT__STEP_SUMMARY;
				default: return -1;
			}
		}
		if (baseClass == Event.class) {
