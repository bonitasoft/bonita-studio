...
public class TransitionsPackageImpl extends EPackageImpl implements TransitionsPackage {
    ...
    public static TransitionsPackage init() {
        if (isInited)
            return (TransitionsPackage) EPackage.Registry.INSTANCE.getEPackage(TransitionsPackage.eNS_URI);

        // Obtain or create and register package
        TransitionsPackageImpl theTransitionsPackage = (TransitionsPackageImpl) (EPackage.Registry.INSTANCE
                .get(eNS_URI) instanceof TransitionsPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
                        : new TransitionsPackageImpl());
    ...
    public void initializePackageContents() {
        ...
        initEClass(takeTransitionActionEClass, TakeTransitionAction.class, "TakeTransitionAction", !IS_ABSTRACT, //$NON-NLS-1$
                !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getTakeTransitionAction_TakeTransition(), ecorePackage.getEBoolean(), "takeTransition", null, 0, 1, //$NON-NLS-1$
                TakeTransitionAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE,
