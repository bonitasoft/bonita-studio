 ...
 * <li>{@link org.bonitasoft.studio.model.configuration.impl.ConfigurationImpl#getAnonymousUserName <em>Anonymous User
 * Name</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.configuration.impl.ConfigurationImpl#getAnonymousPassword <em>Anonymous
 * Password</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.configuration.impl.ConfigurationImpl#getDefinitionMappings <em>Definition
 * Mappings</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.configuration.impl.ConfigurationImpl#getProcessDependencies <em>Process
 * Dependencies</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.configuration.impl.ConfigurationImpl#getApplicationDependencies <em>Application
 * Dependencies</em>}</li>
...
public class ConfigurationImpl extends EObjectImpl implements Configuration {
    ...
    /**
     * The cached value of the '{@link #getApplicationDependencies() <em>Application Dependencies</em>}' containment
     * reference list.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    public void setDescription(String newDescription) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConfigurationPackage.CONFIGURATION__DESCRIPTION,
    ...
    public NotificationChain basicSetActorMappings(ActorMappingsType newActorMappings, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ConfigurationPackage.CONFIGURATION__ACTOR_MAPPINGS, oldActorMappings, newActorMappings);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setActorMappings(ActorMappingsType newActorMappings) {
        if (newActorMappings != actorMappings) {
            ...
            if (actorMappings != null)
                msgs = ((InternalEObject) actorMappings).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ConfigurationPackage.CONFIGURATION__ACTOR_MAPPINGS, null, msgs);
            if (newActorMappings != null)
                msgs = ((InternalEObject) newActorMappings).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - ConfigurationPackage.CONFIGURATION__ACTOR_MAPPINGS, null, msgs);
            msgs = basicSetActorMappings(newActorMappings, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConfigurationPackage.CONFIGURATION__ACTOR_MAPPINGS,
                    newActorMappings, newActorMappings));
    }
    ...
    public void setAnonymousUserName(String newAnonymousUserName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConfigurationPackage.CONFIGURATION__ANONYMOUS_USER_NAME,
                    oldAnonymousUserName, anonymousUserName));
    }
    ...
    public void setAnonymousPassword(String newAnonymousPassword) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConfigurationPackage.CONFIGURATION__ANONYMOUS_PASSWORD,
                    oldAnonymousPassword, anonymousPassword));
    }
    ...
    public EList<DefinitionMapping> getDefinitionMappings() {
        if (definitionMappings == null) {
            definitionMappings = new EObjectContainmentEList<DefinitionMapping>(DefinitionMapping.class, this,
                    ConfigurationPackage.CONFIGURATION__DEFINITION_MAPPINGS);
        }
    ...
    public EList<FragmentContainer> getProcessDependencies() {
        if (processDependencies == null) {
            processDependencies = new EObjectContainmentEList<FragmentContainer>(FragmentContainer.class, this,
                    ConfigurationPackage.CONFIGURATION__PROCESS_DEPENDENCIES);
        }
    ...
    public EList<FragmentContainer> getApplicationDependencies() {
        if (applicationDependencies == null) {
            applicationDependencies = new EObjectContainmentEList<FragmentContainer>(FragmentContainer.class, this,
                    ConfigurationPackage.CONFIGURATION__APPLICATION_DEPENDENCIES);
        }
    ...
    public EList<Parameter> getParameters() {
        if (parameters == null) {
            parameters = new EObjectContainmentEList<Parameter>(Parameter.class, this,
                    ConfigurationPackage.CONFIGURATION__PARAMETERS);
        }
        return parameters;
    }
    ...
    public void setVersion(String newVersion) {
        ...
        version = newVersion;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConfigurationPackage.CONFIGURATION__VERSION, oldVersion,
                    version));
    }
    ...
    public void setUsername(String newUsername) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConfigurationPackage.CONFIGURATION__USERNAME, oldUsername,
                    username));
    }
    ...
    public void setPassword(String newPassword) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConfigurationPackage.CONFIGURATION__PASSWORD, oldPassword,
                    password));
    }
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            ...
            case ConfigurationPackage.CONFIGURATION__ANONYMOUS_USER_NAME:
                return ANONYMOUS_USER_NAME_EDEFAULT == null ? anonymousUserName != null
                        : !ANONYMOUS_USER_NAME_EDEFAULT.equals(anonymousUserName);
            case ConfigurationPackage.CONFIGURATION__ANONYMOUS_PASSWORD:
                return ANONYMOUS_PASSWORD_EDEFAULT == null ? anonymousPassword != null
                        : !ANONYMOUS_PASSWORD_EDEFAULT.equals(anonymousPassword);
            case ConfigurationPackage.CONFIGURATION__DEFINITION_MAPPINGS:
