    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            ...
            case SimulationPackage.SIMULATION_DATA: {
                ...
                if (result == null)
                    result = caseSimulationElement(simulationData);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case SimulationPackage.SIMULATION_BOOLEAN: {
                ...
                if (result == null)
                    result = caseSimulationData(simulationBoolean);
                if (result == null)
                    result = caseSimulationElement(simulationBoolean);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case SimulationPackage.SIMULATION_NUMBER_DATA: {
                ...
                if (result == null)
                    result = caseSimulationData(simulationNumberData);
                if (result == null)
                    result = caseSimulationElement(simulationNumberData);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case SimulationPackage.SIMULATION_LITERAL_DATA: {
                ...
                if (result == null)
                    result = caseSimulationData(simulationLiteralData);
                if (result == null)
                    result = caseSimulationElement(simulationLiteralData);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case SimulationPackage.SIMULATION_ABSTRACT_PROCESS: {
                ...
                if (result == null)
                    result = caseSimulationDataContainer(simulationAbstractProcess);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case SimulationPackage.SIMULATION_ACTIVITY: {
                ...
                if (result == null)
                    result = caseSimulationDataContainer(simulationActivity);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case SimulationPackage.LOAD_PROFILE: {
                ...
                if (result == null)
                    result = caseSimulationElement(loadProfile);
                if (result == null)
                    result = caseModelVersion(loadProfile);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case SimulationPackage.RESOURCE: {
                ...
                if (result == null)
                    result = caseSimulationElement(resource);
                if (result == null)
                    result = caseModelVersion(resource);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
