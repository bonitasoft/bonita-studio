...
public class EndErrorEventImpl extends EventImpl implements EndErrorEvent {
    ...
    public void setErrorCode(String newErrorCode) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.END_ERROR_EVENT__ERROR_CODE, oldErrorCode,
                    errorCode));
    }
        ...
        if (baseClass == ErrorEvent.class) {
            switch (baseFeatureID) {
                case ProcessPackage.ERROR_EVENT__ERROR_CODE:
                    return ProcessPackage.END_ERROR_EVENT__ERROR_CODE;
                default:
                    return -1;
            }
        }
