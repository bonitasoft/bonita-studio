 ...
 * <li>{@link org.bonitasoft.studio.model.form.impl.TextInfoImpl#isLimitNumberOfDuplication <em>Limit Number Of
 * Duplication</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.TextInfoImpl#isLimitMinNumberOfDuplication <em>Limit Min Number Of
 * Duplication</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.TextInfoImpl#getMaxNumberOfDuplication <em>Max Number Of
 * Duplication</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.TextInfoImpl#getMinNumberOfDuplication <em>Min Number Of
 * Duplication</em>}</li>
 ...
 * <li>{@link org.bonitasoft.studio.model.form.impl.TextInfoImpl#getDisplayLabelForRemove <em>Display Label For
 * Remove</em>}</li>
...
public class TextInfoImpl extends InfoImpl implements TextInfo {
    ...
    public void setDuplicate(boolean newDuplicate) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXT_INFO__DUPLICATE, oldDuplicate,
                    duplicate));
    }
    ...
    public void setLimitNumberOfDuplication(boolean newLimitNumberOfDuplication) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXT_INFO__LIMIT_NUMBER_OF_DUPLICATION,
    ...
    public void setLimitMinNumberOfDuplication(boolean newLimitMinNumberOfDuplication) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXT_INFO__LIMIT_MIN_NUMBER_OF_DUPLICATION,
    ...
    public NotificationChain basicSetMaxNumberOfDuplication(Expression newMaxNumberOfDuplication, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.TEXT_INFO__MAX_NUMBER_OF_DUPLICATION, oldMaxNumberOfDuplication, newMaxNumberOfDuplication);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newMaxNumberOfDuplication != maxNumberOfDuplication) {
            ...
            if (maxNumberOfDuplication != null)
                msgs = ((InternalEObject) maxNumberOfDuplication).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.TEXT_INFO__MAX_NUMBER_OF_DUPLICATION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXT_INFO__MAX_NUMBER_OF_DUPLICATION,
    ...
    public NotificationChain basicSetMinNumberOfDuplication(Expression newMinNumberOfDuplication, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.TEXT_INFO__MIN_NUMBER_OF_DUPLICATION, oldMinNumberOfDuplication, newMinNumberOfDuplication);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newMinNumberOfDuplication != minNumberOfDuplication) {
            ...
            if (minNumberOfDuplication != null)
                msgs = ((InternalEObject) minNumberOfDuplication).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.TEXT_INFO__MIN_NUMBER_OF_DUPLICATION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXT_INFO__MIN_NUMBER_OF_DUPLICATION,
    ...
    public NotificationChain basicSetDisplayLabelForAdd(Expression newDisplayLabelForAdd, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.TEXT_INFO__DISPLAY_LABEL_FOR_ADD, oldDisplayLabelForAdd, newDisplayLabelForAdd);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newDisplayLabelForAdd != displayLabelForAdd) {
            ...
            if (displayLabelForAdd != null)
                msgs = ((InternalEObject) displayLabelForAdd).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.TEXT_INFO__DISPLAY_LABEL_FOR_ADD, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXT_INFO__DISPLAY_LABEL_FOR_ADD,
    ...
    public NotificationChain basicSetTooltipForAdd(Expression newTooltipForAdd, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.TEXT_INFO__TOOLTIP_FOR_ADD, oldTooltipForAdd, newTooltipForAdd);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newTooltipForAdd != tooltipForAdd) {
            ...
            if (tooltipForAdd != null)
                msgs = ((InternalEObject) tooltipForAdd).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.TEXT_INFO__TOOLTIP_FOR_ADD, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXT_INFO__TOOLTIP_FOR_ADD, newTooltipForAdd,
                    newTooltipForAdd));
    }
    ...
    public NotificationChain basicSetDisplayLabelForRemove(Expression newDisplayLabelForRemove, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.TEXT_INFO__DISPLAY_LABEL_FOR_REMOVE, oldDisplayLabelForRemove, newDisplayLabelForRemove);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newDisplayLabelForRemove != displayLabelForRemove) {
            ...
            if (displayLabelForRemove != null)
                msgs = ((InternalEObject) displayLabelForRemove).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.TEXT_INFO__DISPLAY_LABEL_FOR_REMOVE, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXT_INFO__DISPLAY_LABEL_FOR_REMOVE,
    ...
    public NotificationChain basicSetTooltipForRemove(Expression newTooltipForRemove, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.TEXT_INFO__TOOLTIP_FOR_REMOVE, oldTooltipForRemove, newTooltipForRemove);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newTooltipForRemove != tooltipForRemove) {
            ...
            if (tooltipForRemove != null)
                msgs = ((InternalEObject) tooltipForRemove).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.TEXT_INFO__TOOLTIP_FOR_REMOVE, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXT_INFO__TOOLTIP_FOR_REMOVE,
        ...
        if (baseClass == Duplicable.class) {
            switch (baseFeatureID) {
                case FormPackage.DUPLICABLE__DUPLICATE:
                    return FormPackage.TEXT_INFO__DUPLICATE;
                case FormPackage.DUPLICABLE__LIMIT_NUMBER_OF_DUPLICATION:
                    return FormPackage.TEXT_INFO__LIMIT_NUMBER_OF_DUPLICATION;
                case FormPackage.DUPLICABLE__LIMIT_MIN_NUMBER_OF_DUPLICATION:
                    return FormPackage.TEXT_INFO__LIMIT_MIN_NUMBER_OF_DUPLICATION;
                case FormPackage.DUPLICABLE__MAX_NUMBER_OF_DUPLICATION:
                    return FormPackage.TEXT_INFO__MAX_NUMBER_OF_DUPLICATION;
                case FormPackage.DUPLICABLE__MIN_NUMBER_OF_DUPLICATION:
                    return FormPackage.TEXT_INFO__MIN_NUMBER_OF_DUPLICATION;
                case FormPackage.DUPLICABLE__DISPLAY_LABEL_FOR_ADD:
                    return FormPackage.TEXT_INFO__DISPLAY_LABEL_FOR_ADD;
                case FormPackage.DUPLICABLE__TOOLTIP_FOR_ADD:
                    return FormPackage.TEXT_INFO__TOOLTIP_FOR_ADD;
                case FormPackage.DUPLICABLE__DISPLAY_LABEL_FOR_REMOVE:
                    return FormPackage.TEXT_INFO__DISPLAY_LABEL_FOR_REMOVE;
                case FormPackage.DUPLICABLE__TOOLTIP_FOR_REMOVE:
                    return FormPackage.TEXT_INFO__TOOLTIP_FOR_REMOVE;
                default:
                    return -1;
            }
        }
