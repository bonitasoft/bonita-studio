 ...
 * <li>{@link org.bonitasoft.studio.model.process.impl.ContractInputMappingImpl#getSetterParamType <em>Setter Param
 * Type</em>}</li>
 * </ul>
 *
 * @generated
...
public class ContractInputMappingImpl extends EObjectImpl implements ContractInputMapping {
        ...
        if (data != null && data.eIsProxy()) {
            ...
            if (data != oldData) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, ProcessPackage.CONTRACT_INPUT_MAPPING__DATA,
                            oldData, data));
            }
        }
        return data;
    ...
    public void setData(Data newData) {
        ...
        data = newData;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.CONTRACT_INPUT_MAPPING__DATA, oldData,
                    data));
    }
    ...
    public void setSetterName(String newSetterName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.CONTRACT_INPUT_MAPPING__SETTER_NAME,
                    oldSetterName, setterName));
    }
    ...
    public void setSetterParamType(String newSetterParamType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.CONTRACT_INPUT_MAPPING__SETTER_PARAM_TYPE,
                    oldSetterParamType, setterParamType));
    }
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            ...
            case ProcessPackage.CONTRACT_INPUT_MAPPING__SETTER_PARAM_TYPE:
                return SETTER_PARAM_TYPE_EDEFAULT == null ? setterParamType != null
                        : !SETTER_PARAM_TYPE_EDEFAULT.equals(setterParamType);
        }
