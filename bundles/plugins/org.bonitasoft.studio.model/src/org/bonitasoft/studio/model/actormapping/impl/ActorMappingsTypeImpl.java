 ...
 * </p>
 * <ul>
 * <li>{@link org.bonitasoft.studio.model.actormapping.impl.ActorMappingsTypeImpl#getActorMapping <em>Actor
 * Mapping</em>}</li>
 * </ul>
 *
 * @generated
...
public class ActorMappingsTypeImpl extends EObjectImpl implements ActorMappingsType {
    ...
    public EList<ActorMapping> getActorMapping() {
        if (actorMapping == null) {
            actorMapping = new EObjectContainmentEList<ActorMapping>(ActorMapping.class, this,
                    ActorMappingPackage.ACTOR_MAPPINGS_TYPE__ACTOR_MAPPING);
        }
        return actorMapping;
    }
