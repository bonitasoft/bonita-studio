 ...
 * <li>{@link org.bonitasoft.studio.model.simulation.impl.ResourceUsageImpl#isUseActivityDuration <em>Use Activity
 * Duration</em>}</li>
 * </ul>
 *
 * @generated
...
public class ResourceUsageImpl extends EObjectImpl implements ResourceUsage {
    ...
    public void setDuration(long newDuration) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SimulationPackage.RESOURCE_USAGE__DURATION, oldDuration,
                    duration));
    }
    ...
    public void setResourceID(String newResourceID) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SimulationPackage.RESOURCE_USAGE__RESOURCE_ID,
    ...
    public void setQuantity(int newQuantity) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SimulationPackage.RESOURCE_USAGE__QUANTITY, oldQuantity,
                    quantity));
    }
    ...
    public void setUseActivityDuration(boolean newUseActivityDuration) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SimulationPackage.RESOURCE_USAGE__USE_ACTIVITY_DURATION,
                    oldUseActivityDuration, useActivityDuration));
    }
