 ...
 * <li>{@link org.bonitasoft.studio.model.process.impl.ResourceContainerImpl#getResourceValidators <em>Resource
 * Validators</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.process.impl.ResourceContainerImpl#getResourceFiles <em>Resource Files</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.process.impl.ResourceContainerImpl#getResourceFolders <em>Resource
 * Folders</em>}</li>
 * </ul>
 *
 * @generated
    ...
    public NotificationChain basicSetHtmlTemplate(AssociatedFile newHtmlTemplate, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.RESOURCE_CONTAINER__HTML_TEMPLATE, oldHtmlTemplate, newHtmlTemplate);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newHtmlTemplate != htmlTemplate) {
            ...
            if (htmlTemplate != null)
                msgs = ((InternalEObject) htmlTemplate).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.RESOURCE_CONTAINER__HTML_TEMPLATE, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.RESOURCE_CONTAINER__HTML_TEMPLATE,
    ...
    public EList<String> getResourceJars() {
        if (resourceJars == null) {
            resourceJars = new EDataTypeUniqueEList<String>(String.class, this,
                    ProcessPackage.RESOURCE_CONTAINER__RESOURCE_JARS);
        }
        return resourceJars;
    }
    ...
    public EList<String> getResourceValidators() {
        if (resourceValidators == null) {
            resourceValidators = new EDataTypeUniqueEList<String>(String.class, this,
                    ProcessPackage.RESOURCE_CONTAINER__RESOURCE_VALIDATORS);
        }
    ...
    public EList<ResourceFile> getResourceFiles() {
        if (resourceFiles == null) {
            resourceFiles = new EObjectContainmentEList<ResourceFile>(ResourceFile.class, this,
                    ProcessPackage.RESOURCE_CONTAINER__RESOURCE_FILES);
        }
    ...
    public EList<ResourceFolder> getResourceFolders() {
        if (resourceFolders == null) {
            resourceFolders = new EObjectContainmentEList<ResourceFolder>(ResourceFolder.class, this,
                    ProcessPackage.RESOURCE_CONTAINER__RESOURCE_FOLDERS);
        }
