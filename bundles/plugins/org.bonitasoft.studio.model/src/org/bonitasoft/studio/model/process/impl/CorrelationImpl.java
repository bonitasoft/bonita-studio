 ...
 * <li>{@link org.bonitasoft.studio.model.process.impl.CorrelationImpl#getCorrelationAssociation <em>Correlation
 * Association</em>}</li>
 * </ul>
 *
 * @generated
...
public class CorrelationImpl extends EObjectImpl implements Correlation {
    ...
    public void setCorrelationType(CorrelationTypeActive newCorrelationType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.CORRELATION__CORRELATION_TYPE,
                    oldCorrelationType, correlationType));
    }
     ...
     * @generated
     */
    public NotificationChain basicSetCorrelationAssociation(TableExpression newCorrelationAssociation,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.CORRELATION__CORRELATION_ASSOCIATION, oldCorrelationAssociation,
                    newCorrelationAssociation);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setCorrelationAssociation(TableExpression newCorrelationAssociation) {
        if (newCorrelationAssociation != correlationAssociation) {
            ...
            if (correlationAssociation != null)
                msgs = ((InternalEObject) correlationAssociation).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.CORRELATION__CORRELATION_ASSOCIATION, null, msgs);
            if (newCorrelationAssociation != null)
                msgs = ((InternalEObject) newCorrelationAssociation).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.CORRELATION__CORRELATION_ASSOCIATION, null, msgs);
            msgs = basicSetCorrelationAssociation(newCorrelationAssociation, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.CORRELATION__CORRELATION_ASSOCIATION,
                    newCorrelationAssociation, newCorrelationAssociation));
    }
