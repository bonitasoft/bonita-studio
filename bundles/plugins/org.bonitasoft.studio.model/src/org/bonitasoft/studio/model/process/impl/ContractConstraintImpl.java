...
public class ContractConstraintImpl extends EObjectImpl implements ContractConstraint {
    ...
    public void setExpression(String newExpression) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.CONTRACT_CONSTRAINT__EXPRESSION,
    ...
    public void setErrorMessage(String newErrorMessage) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.CONTRACT_CONSTRAINT__ERROR_MESSAGE,
    ...
    public EList<String> getInputNames() {
        if (inputNames == null) {
            inputNames = new EDataTypeUniqueEList<String>(String.class, this,
                    ProcessPackage.CONTRACT_CONSTRAINT__INPUT_NAMES);
        }
        return inputNames;
    }
