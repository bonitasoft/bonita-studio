...
public class ParameterImpl extends EObjectImpl implements Parameter {
    ...
    public void setTypeClassname(String newTypeClassname) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ParameterPackage.PARAMETER__TYPE_CLASSNAME,
                    oldTypeClassname, typeClassname));
    }
    ...
    public void setDescription(String newDescription) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ParameterPackage.PARAMETER__DESCRIPTION, oldDescription,
                    description));
    }
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            ...
            case ParameterPackage.PARAMETER__TYPE_CLASSNAME:
                return TYPE_CLASSNAME_EDEFAULT == null ? typeClassname != null
                        : !TYPE_CLASSNAME_EDEFAULT.equals(typeClassname);
            case ParameterPackage.PARAMETER__DESCRIPTION:
