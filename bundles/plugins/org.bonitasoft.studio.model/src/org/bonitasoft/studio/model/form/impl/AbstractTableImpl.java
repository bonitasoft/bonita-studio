 ...
 * <li>{@link org.bonitasoft.studio.model.form.impl.AbstractTableImpl#getTextAnnotationAttachment <em>Text Annotation
 * Attachment</em>}</li>
 ...
 * <li>{@link org.bonitasoft.studio.model.form.impl.AbstractTableImpl#isAllowHTMLForDisplayLabel <em>Allow HTML For Display
 * Label</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.AbstractTableImpl#getDependOn <em>Depend On</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.AbstractTableImpl#isDisplayDependentWidgetOnlyOnEventTriggered
 * <em>Display Dependent Widget Only On Event Triggered</em>}</li>
 ...
 * <li>{@link org.bonitasoft.studio.model.form.impl.AbstractTableImpl#getRealHtmlAttributes <em>Real Html
 * Attributes</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.AbstractTableImpl#isInjectWidgetCondition <em>Inject Widget
 * Condition</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.AbstractTableImpl#getVersion <em>Version</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.AbstractTableImpl#getReturnTypeModifier <em>Return Type
 * Modifier</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.AbstractTableImpl#getDisplayDependentWidgetOnlyAfterFirstEventTriggeredAndCondition
 * <em>Display Dependent Widget Only After First Event Triggered And Condition</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.AbstractTableImpl#getDisplayAfterEventDependsOnConditionScript
 * <em>Display After Event Depends On Condition Script</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.AbstractTableImpl#getInputExpression <em>Input Expression</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.AbstractTableImpl#getAfterEventExpression <em>After Event
 * Expression</em>}</li>
 ...
 * <li>{@link org.bonitasoft.studio.model.form.impl.AbstractTableImpl#getInjectWidgetScript <em>Inject Widget
 * Script</em>}</li>
 ...
 * <li>{@link org.bonitasoft.studio.model.form.impl.AbstractTableImpl#isLimitNumberOfDuplication <em>Limit Number Of
 * Duplication</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.AbstractTableImpl#isLimitMinNumberOfDuplication <em>Limit Min Number Of
 * Duplication</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.AbstractTableImpl#getMaxNumberOfDuplication <em>Max Number Of
 * Duplication</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.AbstractTableImpl#getMinNumberOfDuplication <em>Min Number Of
 * Duplication</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.AbstractTableImpl#getDisplayLabelForAdd <em>Display Label For
 * Add</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.AbstractTableImpl#getTooltipForAdd <em>Tooltip For Add</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.AbstractTableImpl#getDisplayLabelForRemove <em>Display Label For
 * Remove</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.AbstractTableImpl#getTooltipForRemove <em>Tooltip For Remove</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.AbstractTableImpl#isLeftColumnIsHeader <em>Left Column Is
 * Header</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.AbstractTableImpl#isRightColumnIsHeader <em>Right Column Is
 * Header</em>}</li>
 ...
 * <li>{@link org.bonitasoft.studio.model.form.impl.AbstractTableImpl#isInitializedUsingCells <em>Initialized Using
 * Cells</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.AbstractTableImpl#isUseHorizontalHeader <em>Use Horizontal
 * Header</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.AbstractTableImpl#isUseVerticalHeader <em>Use Vertical Header</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.AbstractTableImpl#getHorizontalHeaderExpression <em>Horizontal Header
 * Expression</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.AbstractTableImpl#getVerticalHeaderExpression <em>Vertical Header
 * Expression</em>}</li>
...
public abstract class AbstractTableImpl extends EObjectImpl implements AbstractTable {
    ...
    /**
     * The cached value of the '{@link #getHorizontalHeaderExpression() <em>Horizontal Header Expression</em>}' containment
     * reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * The cached value of the '{@link #getVerticalHeaderExpression() <em>Vertical Header Expression</em>}' containment
     * reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    public void setDocumentation(String newDocumentation) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.ABSTRACT_TABLE__DOCUMENTATION,
    ...
    public EList<TextAnnotationAttachment> getTextAnnotationAttachment() {
        if (textAnnotationAttachment == null) {
            textAnnotationAttachment = new EObjectContainmentWithInverseEList<TextAnnotationAttachment>(
                    TextAnnotationAttachment.class, this, FormPackage.ABSTRACT_TABLE__TEXT_ANNOTATION_ATTACHMENT,
    ...
    public EMap<String, String> getHtmlAttributes() {
        if (htmlAttributes == null) {
            htmlAttributes = new EcoreEMap<String, String>(EcorePackage.Literals.ESTRING_TO_STRING_MAP_ENTRY,
                    EStringToStringMapEntryImpl.class, this, FormPackage.ABSTRACT_TABLE__HTML_ATTRIBUTES);
        }
    ...
    public NotificationChain basicSetWidgetLayoutInfo(WidgetLayoutInfo newWidgetLayoutInfo, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.ABSTRACT_TABLE__WIDGET_LAYOUT_INFO, oldWidgetLayoutInfo, newWidgetLayoutInfo);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newWidgetLayoutInfo != widgetLayoutInfo) {
            ...
            if (widgetLayoutInfo != null)
                msgs = ((InternalEObject) widgetLayoutInfo).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.ABSTRACT_TABLE__WIDGET_LAYOUT_INFO, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.ABSTRACT_TABLE__WIDGET_LAYOUT_INFO,
    ...
    public void setShowDisplayLabel(Boolean newShowDisplayLabel) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.ABSTRACT_TABLE__SHOW_DISPLAY_LABEL,
    ...
    public void setAllowHTMLForDisplayLabel(boolean newAllowHTMLForDisplayLabel) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.ABSTRACT_TABLE__ALLOW_HTML_FOR_DISPLAY_LABEL,
    ...
    public EList<WidgetDependency> getDependOn() {
        if (dependOn == null) {
            dependOn = new EObjectContainmentEList<WidgetDependency>(WidgetDependency.class, this,
                    FormPackage.ABSTRACT_TABLE__DEPEND_ON);
        }
        return dependOn;
    }
    ...
    public void setDisplayDependentWidgetOnlyOnEventTriggered(boolean newDisplayDependentWidgetOnlyOnEventTriggered) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    FormPackage.ABSTRACT_TABLE__DISPLAY_DEPENDENT_WIDGET_ONLY_ON_EVENT_TRIGGERED,
    ...
    public EList<WidgetDependency> getParentOf() {
        if (parentOf == null) {
            parentOf = new EObjectContainmentEList<WidgetDependency>(WidgetDependency.class, this,
                    FormPackage.ABSTRACT_TABLE__PARENT_OF);
        }
        return parentOf;
    }
    ...
    public void setMandatory(boolean newMandatory) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.ABSTRACT_TABLE__MANDATORY, oldMandatory,
                    mandatory));
    }
    ...
    public void setReadOnly(boolean newReadOnly) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.ABSTRACT_TABLE__READ_ONLY, oldReadOnly,
                    readOnly));
    }
    ...
    public void setLabelPosition(LabelPosition newLabelPosition) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.ABSTRACT_TABLE__LABEL_POSITION,
    ...
    public void setRealHtmlAttributes(String newRealHtmlAttributes) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.ABSTRACT_TABLE__REAL_HTML_ATTRIBUTES,
    ...
    public void setInjectWidgetCondition(boolean newInjectWidgetCondition) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.ABSTRACT_TABLE__INJECT_WIDGET_CONDITION,
    ...
    public void setReturnTypeModifier(String newReturnTypeModifier) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.ABSTRACT_TABLE__RETURN_TYPE_MODIFIER,
    ...
    public NotificationChain basicSetDisplayDependentWidgetOnlyAfterFirstEventTriggeredAndCondition(
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.ABSTRACT_TABLE__DISPLAY_DEPENDENT_WIDGET_ONLY_AFTER_FIRST_EVENT_TRIGGERED_AND_CONDITION,
    ...
    public NotificationChain basicSetDisplayAfterEventDependsOnConditionScript(
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.ABSTRACT_TABLE__DISPLAY_AFTER_EVENT_DEPENDS_ON_CONDITION_SCRIPT,
        ...
        if (newDisplayAfterEventDependsOnConditionScript != displayAfterEventDependsOnConditionScript) {
            ...
            if (displayAfterEventDependsOnConditionScript != null)
                msgs = ((InternalEObject) displayAfterEventDependsOnConditionScript).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.ABSTRACT_TABLE__DISPLAY_AFTER_EVENT_DEPENDS_ON_CONDITION_SCRIPT,
                        null, msgs);
    ...
    public NotificationChain basicSetInputExpression(Expression newInputExpression, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.ABSTRACT_TABLE__INPUT_EXPRESSION, oldInputExpression, newInputExpression);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newInputExpression != inputExpression) {
            ...
            if (inputExpression != null)
                msgs = ((InternalEObject) inputExpression).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.ABSTRACT_TABLE__INPUT_EXPRESSION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.ABSTRACT_TABLE__INPUT_EXPRESSION,
    ...
    public NotificationChain basicSetAfterEventExpression(Expression newAfterEventExpression, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.ABSTRACT_TABLE__AFTER_EVENT_EXPRESSION, oldAfterEventExpression, newAfterEventExpression);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newAfterEventExpression != afterEventExpression) {
            ...
            if (afterEventExpression != null)
                msgs = ((InternalEObject) afterEventExpression).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.ABSTRACT_TABLE__AFTER_EVENT_EXPRESSION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.ABSTRACT_TABLE__AFTER_EVENT_EXPRESSION,
    ...
    public NotificationChain basicSetTooltip(Expression newTooltip, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.ABSTRACT_TABLE__TOOLTIP, oldTooltip, newTooltip);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newTooltip != tooltip) {
            ...
            if (tooltip != null)
                msgs = ((InternalEObject) tooltip).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.ABSTRACT_TABLE__TOOLTIP, null, msgs);
            if (newTooltip != null)
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.ABSTRACT_TABLE__TOOLTIP, newTooltip,
                    newTooltip));
    }
    ...
    public NotificationChain basicSetHelpMessage(Expression newHelpMessage, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.ABSTRACT_TABLE__HELP_MESSAGE, oldHelpMessage, newHelpMessage);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newHelpMessage != helpMessage) {
            ...
            if (helpMessage != null)
                msgs = ((InternalEObject) helpMessage).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.ABSTRACT_TABLE__HELP_MESSAGE, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.ABSTRACT_TABLE__HELP_MESSAGE, newHelpMessage,
                    newHelpMessage));
    }
    ...
    public NotificationChain basicSetDisplayLabel(Expression newDisplayLabel, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.ABSTRACT_TABLE__DISPLAY_LABEL, oldDisplayLabel, newDisplayLabel);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newDisplayLabel != displayLabel) {
            ...
            if (displayLabel != null)
                msgs = ((InternalEObject) displayLabel).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.ABSTRACT_TABLE__DISPLAY_LABEL, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.ABSTRACT_TABLE__DISPLAY_LABEL, newDisplayLabel,
                    newDisplayLabel));
    }
    ...
    public NotificationChain basicSetInjectWidgetScript(Expression newInjectWidgetScript, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.ABSTRACT_TABLE__INJECT_WIDGET_SCRIPT, oldInjectWidgetScript, newInjectWidgetScript);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newInjectWidgetScript != injectWidgetScript) {
            ...
            if (injectWidgetScript != null)
                msgs = ((InternalEObject) injectWidgetScript).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.ABSTRACT_TABLE__INJECT_WIDGET_SCRIPT, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.ABSTRACT_TABLE__INJECT_WIDGET_SCRIPT,
    ...
    public NotificationChain basicSetAction(Operation newAction, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.ABSTRACT_TABLE__ACTION, oldAction, newAction);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newAction != action) {
            ...
            if (action != null)
                msgs = ((InternalEObject) action).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.ABSTRACT_TABLE__ACTION, null, msgs);
            if (newAction != null)
    ...
    public void setDuplicate(boolean newDuplicate) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.ABSTRACT_TABLE__DUPLICATE, oldDuplicate,
                    duplicate));
    }
    ...
    public void setLimitNumberOfDuplication(boolean newLimitNumberOfDuplication) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.ABSTRACT_TABLE__LIMIT_NUMBER_OF_DUPLICATION,
    ...
    public void setLimitMinNumberOfDuplication(boolean newLimitMinNumberOfDuplication) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    FormPackage.ABSTRACT_TABLE__LIMIT_MIN_NUMBER_OF_DUPLICATION, oldLimitMinNumberOfDuplication,
    ...
    public NotificationChain basicSetMaxNumberOfDuplication(Expression newMaxNumberOfDuplication, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.ABSTRACT_TABLE__MAX_NUMBER_OF_DUPLICATION, oldMaxNumberOfDuplication,
                    newMaxNumberOfDuplication);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newMaxNumberOfDuplication != maxNumberOfDuplication) {
            ...
            if (maxNumberOfDuplication != null)
                msgs = ((InternalEObject) maxNumberOfDuplication).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.ABSTRACT_TABLE__MAX_NUMBER_OF_DUPLICATION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.ABSTRACT_TABLE__MAX_NUMBER_OF_DUPLICATION,
    ...
    public NotificationChain basicSetMinNumberOfDuplication(Expression newMinNumberOfDuplication, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.ABSTRACT_TABLE__MIN_NUMBER_OF_DUPLICATION, oldMinNumberOfDuplication,
                    newMinNumberOfDuplication);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newMinNumberOfDuplication != minNumberOfDuplication) {
            ...
            if (minNumberOfDuplication != null)
                msgs = ((InternalEObject) minNumberOfDuplication).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.ABSTRACT_TABLE__MIN_NUMBER_OF_DUPLICATION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.ABSTRACT_TABLE__MIN_NUMBER_OF_DUPLICATION,
    ...
    public NotificationChain basicSetDisplayLabelForAdd(Expression newDisplayLabelForAdd, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.ABSTRACT_TABLE__DISPLAY_LABEL_FOR_ADD, oldDisplayLabelForAdd, newDisplayLabelForAdd);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newDisplayLabelForAdd != displayLabelForAdd) {
            ...
            if (displayLabelForAdd != null)
                msgs = ((InternalEObject) displayLabelForAdd).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.ABSTRACT_TABLE__DISPLAY_LABEL_FOR_ADD, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.ABSTRACT_TABLE__DISPLAY_LABEL_FOR_ADD,
    ...
    public NotificationChain basicSetTooltipForAdd(Expression newTooltipForAdd, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.ABSTRACT_TABLE__TOOLTIP_FOR_ADD, oldTooltipForAdd, newTooltipForAdd);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newTooltipForAdd != tooltipForAdd) {
            ...
            if (tooltipForAdd != null)
                msgs = ((InternalEObject) tooltipForAdd).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.ABSTRACT_TABLE__TOOLTIP_FOR_ADD, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.ABSTRACT_TABLE__TOOLTIP_FOR_ADD,
                    newTooltipForAdd, newTooltipForAdd));
    }
    ...
    public NotificationChain basicSetDisplayLabelForRemove(Expression newDisplayLabelForRemove, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.ABSTRACT_TABLE__DISPLAY_LABEL_FOR_REMOVE, oldDisplayLabelForRemove,
                    newDisplayLabelForRemove);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newDisplayLabelForRemove != displayLabelForRemove) {
            ...
            if (displayLabelForRemove != null)
                msgs = ((InternalEObject) displayLabelForRemove).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.ABSTRACT_TABLE__DISPLAY_LABEL_FOR_REMOVE, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.ABSTRACT_TABLE__DISPLAY_LABEL_FOR_REMOVE,
    ...
    public NotificationChain basicSetTooltipForRemove(Expression newTooltipForRemove, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.ABSTRACT_TABLE__TOOLTIP_FOR_REMOVE, oldTooltipForRemove, newTooltipForRemove);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newTooltipForRemove != tooltipForRemove) {
            ...
            if (tooltipForRemove != null)
                msgs = ((InternalEObject) tooltipForRemove).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.ABSTRACT_TABLE__TOOLTIP_FOR_REMOVE, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.ABSTRACT_TABLE__TOOLTIP_FOR_REMOVE,
    ...
    public void setLeftColumnIsHeader(boolean newLeftColumnIsHeader) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.ABSTRACT_TABLE__LEFT_COLUMN_IS_HEADER,
                    oldLeftColumnIsHeader, leftColumnIsHeader));
    }
    ...
    public void setRightColumnIsHeader(boolean newRightColumnIsHeader) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.ABSTRACT_TABLE__RIGHT_COLUMN_IS_HEADER,
                    oldRightColumnIsHeader, rightColumnIsHeader));
    }
    ...
    public void setFirstRowIsHeader(boolean newFirstRowIsHeader) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.ABSTRACT_TABLE__FIRST_ROW_IS_HEADER,
                    oldFirstRowIsHeader, firstRowIsHeader));
    }
    ...
    public void setLastRowIsHeader(boolean newLastRowIsHeader) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.ABSTRACT_TABLE__LAST_ROW_IS_HEADER,
                    oldLastRowIsHeader, lastRowIsHeader));
    }
    ...
    public void setInitializedUsingCells(boolean newInitializedUsingCells) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.ABSTRACT_TABLE__INITIALIZED_USING_CELLS,
                    oldInitializedUsingCells, initializedUsingCells));
    }
    ...
    public void setUseHorizontalHeader(boolean newUseHorizontalHeader) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.ABSTRACT_TABLE__USE_HORIZONTAL_HEADER,
                    oldUseHorizontalHeader, useHorizontalHeader));
    }
    ...
    public void setUseVerticalHeader(boolean newUseVerticalHeader) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.ABSTRACT_TABLE__USE_VERTICAL_HEADER,
                    oldUseVerticalHeader, useVerticalHeader));
    }
     ...
     * @generated
     */
    public NotificationChain basicSetHorizontalHeaderExpression(Expression newHorizontalHeaderExpression,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.ABSTRACT_TABLE__HORIZONTAL_HEADER_EXPRESSION, oldHorizontalHeaderExpression,
                    newHorizontalHeaderExpression);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setHorizontalHeaderExpression(Expression newHorizontalHeaderExpression) {
        if (newHorizontalHeaderExpression != horizontalHeaderExpression) {
            ...
            if (horizontalHeaderExpression != null)
                msgs = ((InternalEObject) horizontalHeaderExpression).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.ABSTRACT_TABLE__HORIZONTAL_HEADER_EXPRESSION, null, msgs);
            if (newHorizontalHeaderExpression != null)
                msgs = ((InternalEObject) newHorizontalHeaderExpression).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.ABSTRACT_TABLE__HORIZONTAL_HEADER_EXPRESSION, null, msgs);
            msgs = basicSetHorizontalHeaderExpression(newHorizontalHeaderExpression, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.ABSTRACT_TABLE__HORIZONTAL_HEADER_EXPRESSION,
                    newHorizontalHeaderExpression, newHorizontalHeaderExpression));
    }
     ...
     * @generated
     */
    public NotificationChain basicSetVerticalHeaderExpression(Expression newVerticalHeaderExpression,
            NotificationChain msgs) {
        Expression oldVerticalHeaderExpression = verticalHeaderExpression;
        verticalHeaderExpression = newVerticalHeaderExpression;
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.ABSTRACT_TABLE__VERTICAL_HEADER_EXPRESSION, oldVerticalHeaderExpression,
                    newVerticalHeaderExpression);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setVerticalHeaderExpression(Expression newVerticalHeaderExpression) {
        if (newVerticalHeaderExpression != verticalHeaderExpression) {
            ...
            if (verticalHeaderExpression != null)
                msgs = ((InternalEObject) verticalHeaderExpression).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.ABSTRACT_TABLE__VERTICAL_HEADER_EXPRESSION, null, msgs);
            if (newVerticalHeaderExpression != null)
                msgs = ((InternalEObject) newVerticalHeaderExpression).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.ABSTRACT_TABLE__VERTICAL_HEADER_EXPRESSION, null, msgs);
            msgs = basicSetVerticalHeaderExpression(newVerticalHeaderExpression, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.ABSTRACT_TABLE__VERTICAL_HEADER_EXPRESSION,
                    newVerticalHeaderExpression, newVerticalHeaderExpression));
    }
    ...
    public NotificationChain basicSetTableExpression(TableExpression newTableExpression, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.ABSTRACT_TABLE__TABLE_EXPRESSION, oldTableExpression, newTableExpression);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setTableExpression(TableExpression newTableExpression) {
        if (newTableExpression != tableExpression) {
            ...
            if (tableExpression != null)
                msgs = ((InternalEObject) tableExpression).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.ABSTRACT_TABLE__TABLE_EXPRESSION, null, msgs);
            if (newTableExpression != null)
                msgs = ((InternalEObject) newTableExpression).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.ABSTRACT_TABLE__TABLE_EXPRESSION, null, msgs);
            msgs = basicSetTableExpression(newTableExpression, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.ABSTRACT_TABLE__TABLE_EXPRESSION,
                    newTableExpression, newTableExpression));
    }
        ...
        if (baseClass == CSSCustomizable.class) {
            switch (baseFeatureID) {
                case FormPackage.CSS_CUSTOMIZABLE__HTML_ATTRIBUTES:
                    return FormPackage.ABSTRACT_TABLE__HTML_ATTRIBUTES;
                default:
                    return -1;
            }
        }
        if (baseClass == Duplicable.class) {
            switch (baseFeatureID) {
                case FormPackage.DUPLICABLE__DUPLICATE:
                    return FormPackage.ABSTRACT_TABLE__DUPLICATE;
                case FormPackage.DUPLICABLE__LIMIT_NUMBER_OF_DUPLICATION:
                    return FormPackage.ABSTRACT_TABLE__LIMIT_NUMBER_OF_DUPLICATION;
                case FormPackage.DUPLICABLE__LIMIT_MIN_NUMBER_OF_DUPLICATION:
                    return FormPackage.ABSTRACT_TABLE__LIMIT_MIN_NUMBER_OF_DUPLICATION;
                case FormPackage.DUPLICABLE__MAX_NUMBER_OF_DUPLICATION:
                    return FormPackage.ABSTRACT_TABLE__MAX_NUMBER_OF_DUPLICATION;
                case FormPackage.DUPLICABLE__MIN_NUMBER_OF_DUPLICATION:
                    return FormPackage.ABSTRACT_TABLE__MIN_NUMBER_OF_DUPLICATION;
                case FormPackage.DUPLICABLE__DISPLAY_LABEL_FOR_ADD:
                    return FormPackage.ABSTRACT_TABLE__DISPLAY_LABEL_FOR_ADD;
                case FormPackage.DUPLICABLE__TOOLTIP_FOR_ADD:
                    return FormPackage.ABSTRACT_TABLE__TOOLTIP_FOR_ADD;
                case FormPackage.DUPLICABLE__DISPLAY_LABEL_FOR_REMOVE:
                    return FormPackage.ABSTRACT_TABLE__DISPLAY_LABEL_FOR_REMOVE;
                case FormPackage.DUPLICABLE__TOOLTIP_FOR_REMOVE:
                    return FormPackage.ABSTRACT_TABLE__TOOLTIP_FOR_REMOVE;
                default:
                    return -1;
            }
        }
