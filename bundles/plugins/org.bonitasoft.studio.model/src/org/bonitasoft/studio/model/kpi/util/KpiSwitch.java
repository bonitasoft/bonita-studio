    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            case KpiPackage.ABSTRACT_KPI_DEFINITION: {
                ...
                if (result == null)
                    result = caseElement(abstractKPIDefinition);
                if (result == null)
            ...
            case KpiPackage.ABSTRACT_KPI_BINDING: {
                ...
                if (result == null)
                    result = caseElement(abstractKPIBinding);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case KpiPackage.DATABASE_KPI_BINDING: {
                ...
                if (result == null)
                    result = caseAbstractKPIBinding(databaseKPIBinding);
                if (result == null)
                    result = caseElement(databaseKPIBinding);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case KpiPackage.DATABASE_KPI_DEFINITION: {
                ...
                if (result == null)
                    result = caseAbstractKPIDefinition(databaseKPIDefinition);
                if (result == null)
                    result = caseElement(databaseKPIDefinition);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
