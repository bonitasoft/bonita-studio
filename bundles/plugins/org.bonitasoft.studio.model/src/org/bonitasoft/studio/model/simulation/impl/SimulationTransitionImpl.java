 ...
 * <li>{@link org.bonitasoft.studio.model.simulation.impl.SimulationTransitionImpl#isUseExpression <em>Use
 * Expression</em>}</li>
...
public class SimulationTransitionImpl extends EObjectImpl implements SimulationTransition {
    ...
    public void setProbability(double newProbability) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SimulationPackage.SIMULATION_TRANSITION__PROBABILITY,
    ...
    public void setDataBased(boolean newDataBased) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SimulationPackage.SIMULATION_TRANSITION__DATA_BASED,
                    oldDataBased, dataBased));
    }
    ...
    public void setUseExpression(boolean newUseExpression) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SimulationPackage.SIMULATION_TRANSITION__USE_EXPRESSION,
    ...
    public NotificationChain basicSetExpression(Expression newExpression, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    SimulationPackage.SIMULATION_TRANSITION__EXPRESSION, oldExpression, newExpression);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newExpression != expression) {
            ...
            if (expression != null)
                msgs = ((InternalEObject) expression).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - SimulationPackage.SIMULATION_TRANSITION__EXPRESSION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, SimulationPackage.SIMULATION_TRANSITION__EXPRESSION,
