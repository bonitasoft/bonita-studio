 ...
 * </p>
 * <ul>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.PageFlowImpl#getRegExpToHideDefaultField <em>Reg Exp To Hide Default Field</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.PageFlowImpl#isUseRegExpToHideDefaultField <em>Use Reg Exp To Hide Default Field</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.PageFlowImpl#getByPassFormsGeneration <em>By Pass Forms Generation</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.PageFlowImpl#getConfirmationTemplate <em>Confirmation Template</em>}</li>
 ...
 *   <li>{@link org.bonitasoft.studio.model.process.impl.PageFlowImpl#isTransmitURLAsParameter <em>Transmit URL As Parameter</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.PageFlowImpl#getPageFlowTransitions <em>Page Flow Transitions</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.PageFlowImpl#getForm <em>Form</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.PageFlowImpl#getEntryRedirectionURL <em>Entry Redirection URL</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.PageFlowImpl#getConfirmationMessage <em>Confirmation Message</em>}</li>
 *   <li>{@link org.bonitasoft.studio.model.process.impl.PageFlowImpl#getEntryRedirectionActions <em>Entry Redirection Actions</em>}</li>
...
public class PageFlowImpl extends ConnectableElementImpl implements PageFlow {
	...
	public EList<Connector> getPageFlowConnectors() {
		if (pageFlowConnectors == null) {
			pageFlowConnectors = new EObjectContainmentEList<Connector>(Connector.class, this, ProcessPackage.PAGE_FLOW__PAGE_FLOW_CONNECTORS);
		}
	...
	public void setEntryPageFlowType(EntryPageFlowType newEntryPageFlowType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.PAGE_FLOW__ENTRY_PAGE_FLOW_TYPE, oldEntryPageFlowType, entryPageFlowType));
	}
	...
	public void setTransmitURLAsParameter(boolean newTransmitURLAsParameter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.PAGE_FLOW__TRANSMIT_URL_AS_PARAMETER, oldTransmitURLAsParameter, transmitURLAsParameter));
	}
	...
	public EList<PageFlowTransition> getPageFlowTransitions() {
		if (pageFlowTransitions == null) {
			pageFlowTransitions = new EObjectContainmentEList<PageFlowTransition>(PageFlowTransition.class, this, ProcessPackage.PAGE_FLOW__PAGE_FLOW_TRANSITIONS);
		}
	...
	public NotificationChain basicSetEntryRedirectionURL(Expression newEntryRedirectionURL, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.PAGE_FLOW__ENTRY_REDIRECTION_URL, oldEntryRedirectionURL, newEntryRedirectionURL);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setEntryRedirectionURL(Expression newEntryRedirectionURL) {
		if (newEntryRedirectionURL != entryRedirectionURL) {
			...
			if (entryRedirectionURL != null)
				msgs = ((InternalEObject)entryRedirectionURL).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.PAGE_FLOW__ENTRY_REDIRECTION_URL, null, msgs);
			if (newEntryRedirectionURL != null)
				msgs = ((InternalEObject)newEntryRedirectionURL).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.PAGE_FLOW__ENTRY_REDIRECTION_URL, null, msgs);
			msgs = basicSetEntryRedirectionURL(newEntryRedirectionURL, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.PAGE_FLOW__ENTRY_REDIRECTION_URL, newEntryRedirectionURL, newEntryRedirectionURL));
	}
	...
	public NotificationChain basicSetConfirmationMessage(Expression newConfirmationMessage, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.PAGE_FLOW__CONFIRMATION_MESSAGE, oldConfirmationMessage, newConfirmationMessage);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setConfirmationMessage(Expression newConfirmationMessage) {
		if (newConfirmationMessage != confirmationMessage) {
			...
			if (confirmationMessage != null)
				msgs = ((InternalEObject)confirmationMessage).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.PAGE_FLOW__CONFIRMATION_MESSAGE, null, msgs);
			if (newConfirmationMessage != null)
				msgs = ((InternalEObject)newConfirmationMessage).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.PAGE_FLOW__CONFIRMATION_MESSAGE, null, msgs);
			msgs = basicSetConfirmationMessage(newConfirmationMessage, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.PAGE_FLOW__CONFIRMATION_MESSAGE, newConfirmationMessage, newConfirmationMessage));
	}
	...
	public EList<Operation> getEntryRedirectionActions() {
		if (entryRedirectionActions == null) {
			entryRedirectionActions = new EObjectContainmentEList<Operation>(Operation.class, this, ProcessPackage.PAGE_FLOW__ENTRY_REDIRECTION_ACTIONS);
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == AbstractPageFlow.class) {
			switch (derivedFeatureID) {
				case ProcessPackage.PAGE_FLOW__REG_EXP_TO_HIDE_DEFAULT_FIELD: return ProcessPackage.ABSTRACT_PAGE_FLOW__REG_EXP_TO_HIDE_DEFAULT_FIELD;
				case ProcessPackage.PAGE_FLOW__USE_REG_EXP_TO_HIDE_DEFAULT_FIELD: return ProcessPackage.ABSTRACT_PAGE_FLOW__USE_REG_EXP_TO_HIDE_DEFAULT_FIELD;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == AbstractPageFlow.class) {
			switch (baseFeatureID) {
				case ProcessPackage.ABSTRACT_PAGE_FLOW__REG_EXP_TO_HIDE_DEFAULT_FIELD: return ProcessPackage.PAGE_FLOW__REG_EXP_TO_HIDE_DEFAULT_FIELD;
				case ProcessPackage.ABSTRACT_PAGE_FLOW__USE_REG_EXP_TO_HIDE_DEFAULT_FIELD: return ProcessPackage.PAGE_FLOW__USE_REG_EXP_TO_HIDE_DEFAULT_FIELD;
				default: return -1;
			}
		}
