 ...
 * </p>
 * <ul>
 * <li>{@link org.bonitasoft.studio.model.process.impl.BusinessObjectDataImpl#getBusinessDataRepositoryId <em>Business Data
 * Repository Id</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.process.impl.BusinessObjectDataImpl#isCreateNewInstance <em>Create New
 * Instance</em>}</li>
...
public class BusinessObjectDataImpl extends JavaObjectDataImpl implements BusinessObjectData {
    ...
    public void setBusinessDataRepositoryId(String newBusinessDataRepositoryId) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.BUSINESS_OBJECT_DATA__BUSINESS_DATA_REPOSITORY_ID, oldBusinessDataRepositoryId,
                    businessDataRepositoryId));
    }
    ...
    public void setCreateNewInstance(boolean newCreateNewInstance) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.BUSINESS_OBJECT_DATA__CREATE_NEW_INSTANCE,
                    oldCreateNewInstance, createNewInstance));
    }
    ...
    public void setEClassName(String newEClassName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.BUSINESS_OBJECT_DATA__ECLASS_NAME,
                    oldEClassName, eClassName));
    }
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            case ProcessPackage.BUSINESS_OBJECT_DATA__BUSINESS_DATA_REPOSITORY_ID:
                return BUSINESS_DATA_REPOSITORY_ID_EDEFAULT == null ? businessDataRepositoryId != null
                        : !BUSINESS_DATA_REPOSITORY_ID_EDEFAULT.equals(businessDataRepositoryId);
            case ProcessPackage.BUSINESS_OBJECT_DATA__CREATE_NEW_INSTANCE:
