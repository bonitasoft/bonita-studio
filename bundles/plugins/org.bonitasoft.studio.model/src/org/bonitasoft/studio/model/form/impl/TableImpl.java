 ...
 * <li>{@link org.bonitasoft.studio.model.form.impl.TableImpl#getExampleMessagePosition <em>Example Message
 * Position</em>}</li>
 ...
 * <li>{@link org.bonitasoft.studio.model.form.impl.TableImpl#getDefaultExpressionAfterEvent <em>Default Expression After
 * Event</em>}</li>
 ...
 * <li>{@link org.bonitasoft.studio.model.form.impl.TableImpl#isSelectionModeIsMultiple <em>Selection Mode Is
 * Multiple</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.TableImpl#getMaxRowForPagination <em>Max Row For Pagination</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.TableImpl#getColumnForInitialSelectionIndex <em>Column For Initial
 * Selection Index</em>}</li>
...
public class TableImpl extends AbstractTableImpl implements Table {
    ...
    /**
     * The cached value of the '{@link #getDefaultExpressionAfterEvent() <em>Default Expression After Event</em>}'
    ...
    /**
     * The cached value of the '{@link #getColumnForInitialSelectionIndex() <em>Column For Initial Selection Index</em>}'
     * containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    public void setUseDefaultValidator(Boolean newUseDefaultValidator) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TABLE__USE_DEFAULT_VALIDATOR,
    ...
    public void setDescription(String newDescription) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TABLE__DESCRIPTION, oldDescription,
                    description));
    }
    ...
    public void setExampleMessagePosition(LabelPosition newExampleMessagePosition) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TABLE__EXAMPLE_MESSAGE_POSITION,
    ...
    public NotificationChain basicSetExampleMessage(Expression newExampleMessage, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.TABLE__EXAMPLE_MESSAGE, oldExampleMessage, newExampleMessage);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newExampleMessage != exampleMessage) {
            ...
            if (exampleMessage != null)
                msgs = ((InternalEObject) exampleMessage).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.TABLE__EXAMPLE_MESSAGE, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TABLE__EXAMPLE_MESSAGE, newExampleMessage,
                    newExampleMessage));
    }
    ...
    public NotificationChain basicSetDefaultExpression(Expression newDefaultExpression, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.TABLE__DEFAULT_EXPRESSION, oldDefaultExpression, newDefaultExpression);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setDefaultExpression(Expression newDefaultExpression) {
        if (newDefaultExpression != defaultExpression) {
            ...
            if (defaultExpression != null)
                msgs = ((InternalEObject) defaultExpression).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.TABLE__DEFAULT_EXPRESSION, null, msgs);
            if (newDefaultExpression != null)
                msgs = ((InternalEObject) newDefaultExpression).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.TABLE__DEFAULT_EXPRESSION, null, msgs);
            msgs = basicSetDefaultExpression(newDefaultExpression, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TABLE__DEFAULT_EXPRESSION,
                    newDefaultExpression, newDefaultExpression));
    }
     ...
     * @generated
     */
    public NotificationChain basicSetDefaultExpressionAfterEvent(Expression newDefaultExpressionAfterEvent,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.TABLE__DEFAULT_EXPRESSION_AFTER_EVENT, oldDefaultExpressionAfterEvent,
                    newDefaultExpressionAfterEvent);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setDefaultExpressionAfterEvent(Expression newDefaultExpressionAfterEvent) {
        if (newDefaultExpressionAfterEvent != defaultExpressionAfterEvent) {
            ...
            if (defaultExpressionAfterEvent != null)
                msgs = ((InternalEObject) defaultExpressionAfterEvent).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.TABLE__DEFAULT_EXPRESSION_AFTER_EVENT, null, msgs);
            if (newDefaultExpressionAfterEvent != null)
                msgs = ((InternalEObject) newDefaultExpressionAfterEvent).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.TABLE__DEFAULT_EXPRESSION_AFTER_EVENT, null, msgs);
            msgs = basicSetDefaultExpressionAfterEvent(newDefaultExpressionAfterEvent, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TABLE__DEFAULT_EXPRESSION_AFTER_EVENT,
                    newDefaultExpressionAfterEvent, newDefaultExpressionAfterEvent));
    }
    ...
    public void setUsePagination(boolean newUsePagination) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TABLE__USE_PAGINATION, oldUsePagination,
                    usePagination));
    }
    ...
    public void setAllowSelection(boolean newAllowSelection) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TABLE__ALLOW_SELECTION, oldAllowSelection,
                    allowSelection));
    }
    ...
    public void setSelectionModeIsMultiple(boolean newSelectionModeIsMultiple) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TABLE__SELECTION_MODE_IS_MULTIPLE,
                    oldSelectionModeIsMultiple, selectionModeIsMultiple));
    }
    ...
    public NotificationChain basicSetMaxRowForPagination(Expression newMaxRowForPagination, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.TABLE__MAX_ROW_FOR_PAGINATION, oldMaxRowForPagination, newMaxRowForPagination);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setMaxRowForPagination(Expression newMaxRowForPagination) {
        if (newMaxRowForPagination != maxRowForPagination) {
            ...
            if (maxRowForPagination != null)
                msgs = ((InternalEObject) maxRowForPagination).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.TABLE__MAX_ROW_FOR_PAGINATION, null, msgs);
            if (newMaxRowForPagination != null)
                msgs = ((InternalEObject) newMaxRowForPagination).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.TABLE__MAX_ROW_FOR_PAGINATION, null, msgs);
            msgs = basicSetMaxRowForPagination(newMaxRowForPagination, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TABLE__MAX_ROW_FOR_PAGINATION,
                    newMaxRowForPagination, newMaxRowForPagination));
    }
     ...
     * @generated
     */
    public NotificationChain basicSetColumnForInitialSelectionIndex(Expression newColumnForInitialSelectionIndex,
            NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.TABLE__COLUMN_FOR_INITIAL_SELECTION_INDEX, oldColumnForInitialSelectionIndex,
                    newColumnForInitialSelectionIndex);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setColumnForInitialSelectionIndex(Expression newColumnForInitialSelectionIndex) {
        if (newColumnForInitialSelectionIndex != columnForInitialSelectionIndex) {
            ...
            if (columnForInitialSelectionIndex != null)
                msgs = ((InternalEObject) columnForInitialSelectionIndex).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.TABLE__COLUMN_FOR_INITIAL_SELECTION_INDEX, null, msgs);
            if (newColumnForInitialSelectionIndex != null)
                msgs = ((InternalEObject) newColumnForInitialSelectionIndex).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.TABLE__COLUMN_FOR_INITIAL_SELECTION_INDEX, null, msgs);
            msgs = basicSetColumnForInitialSelectionIndex(newColumnForInitialSelectionIndex, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TABLE__COLUMN_FOR_INITIAL_SELECTION_INDEX,
                    newColumnForInitialSelectionIndex, newColumnForInitialSelectionIndex));
    }
    ...
    public NotificationChain basicSetSelectedValues(Expression newSelectedValues, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.TABLE__SELECTED_VALUES, oldSelectedValues, newSelectedValues);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setSelectedValues(Expression newSelectedValues) {
        if (newSelectedValues != selectedValues) {
            ...
            if (selectedValues != null)
                msgs = ((InternalEObject) selectedValues).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.TABLE__SELECTED_VALUES, null, msgs);
            if (newSelectedValues != null)
                msgs = ((InternalEObject) newSelectedValues).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.TABLE__SELECTED_VALUES, null, msgs);
            msgs = basicSetSelectedValues(newSelectedValues, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TABLE__SELECTED_VALUES, newSelectedValues,
                    newSelectedValues));
    }
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == FormField.class) {
            switch (derivedFeatureID) {
                case FormPackage.TABLE__DESCRIPTION:
                    return FormPackage.FORM_FIELD__DESCRIPTION;
                case FormPackage.TABLE__EXAMPLE_MESSAGE_POSITION:
                    return FormPackage.FORM_FIELD__EXAMPLE_MESSAGE_POSITION;
                case FormPackage.TABLE__EXAMPLE_MESSAGE:
                    return FormPackage.FORM_FIELD__EXAMPLE_MESSAGE;
                default:
                    return -1;
            }
        }
        if (baseClass == MultipleValuatedFormField.class) {
            switch (derivedFeatureID) {
                case FormPackage.TABLE__DEFAULT_EXPRESSION:
                    return FormPackage.MULTIPLE_VALUATED_FORM_FIELD__DEFAULT_EXPRESSION;
                case FormPackage.TABLE__DEFAULT_EXPRESSION_AFTER_EVENT:
                    return FormPackage.MULTIPLE_VALUATED_FORM_FIELD__DEFAULT_EXPRESSION_AFTER_EVENT;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == Validable.class) {
            switch (baseFeatureID) {
                case FormPackage.VALIDABLE__VALIDATORS:
                    return FormPackage.TABLE__VALIDATORS;
                case FormPackage.VALIDABLE__USE_DEFAULT_VALIDATOR:
                    return FormPackage.TABLE__USE_DEFAULT_VALIDATOR;
                case FormPackage.VALIDABLE__BELOW:
                    return FormPackage.TABLE__BELOW;
                default:
                    return -1;
            }
        }
        if (baseClass == FormField.class) {
            switch (baseFeatureID) {
                case FormPackage.FORM_FIELD__DESCRIPTION:
                    return FormPackage.TABLE__DESCRIPTION;
                case FormPackage.FORM_FIELD__EXAMPLE_MESSAGE_POSITION:
                    return FormPackage.TABLE__EXAMPLE_MESSAGE_POSITION;
                case FormPackage.FORM_FIELD__EXAMPLE_MESSAGE:
                    return FormPackage.TABLE__EXAMPLE_MESSAGE;
                default:
                    return -1;
            }
        }
        if (baseClass == MultipleValuatedFormField.class) {
            switch (baseFeatureID) {
                case FormPackage.MULTIPLE_VALUATED_FORM_FIELD__DEFAULT_EXPRESSION:
                    return FormPackage.TABLE__DEFAULT_EXPRESSION;
                case FormPackage.MULTIPLE_VALUATED_FORM_FIELD__DEFAULT_EXPRESSION_AFTER_EVENT:
                    return FormPackage.TABLE__DEFAULT_EXPRESSION_AFTER_EVENT;
                default:
                    return -1;
            }
        }
