 ...
 * <li>{@link org.bonitasoft.studio.model.process.decision.impl.DecisionTableImpl#getDefaultAction <em>Default
 * Action</em>}</li>
 * </ul>
 *
 * @generated
...
public class DecisionTableImpl extends EObjectImpl implements DecisionTable {
    ...
    public EList<DecisionTableLine> getLines() {
        if (lines == null) {
            lines = new EObjectContainmentEList<DecisionTableLine>(DecisionTableLine.class, this,
                    DecisionPackage.DECISION_TABLE__LINES);
        }
        return lines;
    }
    ...
    public NotificationChain basicSetDefaultAction(DecisionTableAction newDefaultAction, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    DecisionPackage.DECISION_TABLE__DEFAULT_ACTION, oldDefaultAction, newDefaultAction);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setDefaultAction(DecisionTableAction newDefaultAction) {
        if (newDefaultAction != defaultAction) {
            ...
            if (defaultAction != null)
                msgs = ((InternalEObject) defaultAction).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - DecisionPackage.DECISION_TABLE__DEFAULT_ACTION, null, msgs);
            if (newDefaultAction != null)
                msgs = ((InternalEObject) newDefaultAction).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - DecisionPackage.DECISION_TABLE__DEFAULT_ACTION, null, msgs);
            msgs = basicSetDefaultAction(newDefaultAction, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, DecisionPackage.DECISION_TABLE__DEFAULT_ACTION,
                    newDefaultAction, newDefaultAction));
    }
