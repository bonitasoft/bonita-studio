...
public class ConnectorConfigurationFactoryImpl extends EFactoryImpl implements ConnectorConfigurationFactory {
    ...
    public static ConnectorConfigurationFactory init() {
        try {
            ConnectorConfigurationFactory theConnectorConfigurationFactory = (ConnectorConfigurationFactory) EPackage.Registry.INSTANCE
                    .getEFactory(ConnectorConfigurationPackage.eNS_URI);
