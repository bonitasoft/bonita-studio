 ...
 * <li>{@link org.bonitasoft.studio.model.process.impl.MessageFlowImpl#getTextAnnotationAttachment <em>Text Annotation
 * Attachment</em>}</li>
...
public class MessageFlowImpl extends EObjectImpl implements MessageFlow {
    ...
    public void setDocumentation(String newDocumentation) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.MESSAGE_FLOW__DOCUMENTATION,
    ...
    public EList<TextAnnotationAttachment> getTextAnnotationAttachment() {
        if (textAnnotationAttachment == null) {
            textAnnotationAttachment = new EObjectContainmentWithInverseEList<TextAnnotationAttachment>(
                    TextAnnotationAttachment.class, this, ProcessPackage.MESSAGE_FLOW__TEXT_ANNOTATION_ATTACHMENT,
    ...
    public AbstractCatchMessageEvent getTarget() {
        if (target != null && target.eIsProxy()) {
            ...
            if (target != oldTarget) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, ProcessPackage.MESSAGE_FLOW__TARGET, oldTarget,
                            target));
            }
        }
        return target;
    ...
    public NotificationChain basicSetTarget(AbstractCatchMessageEvent newTarget, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.MESSAGE_FLOW__TARGET, oldTarget, newTarget);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newTarget != target) {
            ...
            if (target != null)
                msgs = ((InternalEObject) target).eInverseRemove(this,
                        ProcessPackage.ABSTRACT_CATCH_MESSAGE_EVENT__INCOMING_MESSAG, AbstractCatchMessageEvent.class, msgs);
            if (newTarget != null)
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.MESSAGE_FLOW__TARGET, newTarget,
                    newTarget));
    }
    ...
    public ThrowMessageEvent getSource() {
        if (source != null && source.eIsProxy()) {
            ...
            if (source != oldSource) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, ProcessPackage.MESSAGE_FLOW__SOURCE, oldSource,
                            source));
            }
        }
        return source;
    ...
    public NotificationChain basicSetSource(ThrowMessageEvent newSource, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.MESSAGE_FLOW__SOURCE, oldSource, newSource);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setSource(ThrowMessageEvent newSource) {
        if (newSource != source) {
            NotificationChain msgs = null;
            if (source != null)
                msgs = ((InternalEObject) source).eInverseRemove(this, ProcessPackage.THROW_MESSAGE_EVENT__OUTGOING_MESSAGES,
                        ThrowMessageEvent.class, msgs);
            if (newSource != null)
                msgs = ((InternalEObject) newSource).eInverseAdd(this, ProcessPackage.THROW_MESSAGE_EVENT__OUTGOING_MESSAGES,
                        ThrowMessageEvent.class, msgs);
            msgs = basicSetSource(newSource, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.MESSAGE_FLOW__SOURCE, newSource,
                    newSource));
    }
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            ...
            case ProcessPackage.MESSAGE_FLOW__TARGET:
                if (target != null)
                    msgs = ((InternalEObject) target).eInverseRemove(this,
                            ProcessPackage.ABSTRACT_CATCH_MESSAGE_EVENT__INCOMING_MESSAG, AbstractCatchMessageEvent.class,
                            msgs);
                return basicSetTarget((AbstractCatchMessageEvent) otherEnd, msgs);
            case ProcessPackage.MESSAGE_FLOW__SOURCE:
                if (source != null)
                    msgs = ((InternalEObject) source).eInverseRemove(this,
                            ProcessPackage.THROW_MESSAGE_EVENT__OUTGOING_MESSAGES, ThrowMessageEvent.class, msgs);
