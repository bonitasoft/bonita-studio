...
public class KpiAdapterFactory extends AdapterFactoryImpl {
     ...
     * @generated
     */
    protected KpiSwitch<Adapter> modelSwitch = new KpiSwitch<Adapter>() {
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.bonitasoft.studio.model.kpi.AbstractKPIDefinition
     * <em>Abstract KPI Definition</em>}'.
     * <!-- begin-user-doc -->
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.bonitasoft.studio.model.kpi.AbstractKPIBinding <em>Abstract
     * KPI Binding</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.bonitasoft.studio.model.kpi.KPIParameterMapping <em>KPI
     * Parameter Mapping</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.bonitasoft.studio.model.kpi.DatabaseKPIBinding <em>Database
     * KPI Binding</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.bonitasoft.studio.model.kpi.DatabaseKPIDefinition
     * <em>Database KPI Definition</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
