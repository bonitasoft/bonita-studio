 ...
 * <li>{@link org.bonitasoft.studio.model.form.impl.DynamicTableImpl#getUseDefaultValidator <em>Use Default
 * Validator</em>}</li>
 ...
 * <li>{@link org.bonitasoft.studio.model.form.impl.DynamicTableImpl#getExampleMessagePosition <em>Example Message
 * Position</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.DynamicTableImpl#getExampleMessage <em>Example Message</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.DynamicTableImpl#isLimitMinNumberOfColumn <em>Limit Min Number Of
 * Column</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.DynamicTableImpl#isLimitMinNumberOfRow <em>Limit Min Number Of
 * Row</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.DynamicTableImpl#isAllowAddRemoveRow <em>Allow Add Remove Row</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.DynamicTableImpl#isAllowAddRemoveColumn <em>Allow Add Remove
 * Column</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.DynamicTableImpl#isLimitMaxNumberOfColumn <em>Limit Max Number Of
 * Column</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.DynamicTableImpl#isLimitMaxNumberOfRow <em>Limit Max Number Of
 * Row</em>}</li>
...
public class DynamicTableImpl extends AbstractTableImpl implements DynamicTable {
    ...
    public EList<Validator> getValidators() {
        if (validators == null) {
            validators = new EObjectContainmentEList<Validator>(Validator.class, this,
                    FormPackage.DYNAMIC_TABLE__VALIDATORS);
        }
        return validators;
    }
    ...
    public void setUseDefaultValidator(Boolean newUseDefaultValidator) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DYNAMIC_TABLE__USE_DEFAULT_VALIDATOR,
    ...
    public void setDescription(String newDescription) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DYNAMIC_TABLE__DESCRIPTION, oldDescription,
                    description));
    }
    ...
    public void setExampleMessagePosition(LabelPosition newExampleMessagePosition) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DYNAMIC_TABLE__EXAMPLE_MESSAGE_POSITION,
    ...
    public NotificationChain basicSetExampleMessage(Expression newExampleMessage, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.DYNAMIC_TABLE__EXAMPLE_MESSAGE, oldExampleMessage, newExampleMessage);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newExampleMessage != exampleMessage) {
            ...
            if (exampleMessage != null)
                msgs = ((InternalEObject) exampleMessage).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.DYNAMIC_TABLE__EXAMPLE_MESSAGE, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DYNAMIC_TABLE__EXAMPLE_MESSAGE,
                    newExampleMessage, newExampleMessage));
    }
    ...
    public void setLimitMinNumberOfColumn(boolean newLimitMinNumberOfColumn) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DYNAMIC_TABLE__LIMIT_MIN_NUMBER_OF_COLUMN,
                    oldLimitMinNumberOfColumn, limitMinNumberOfColumn));
    }
    ...
    public void setLimitMinNumberOfRow(boolean newLimitMinNumberOfRow) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DYNAMIC_TABLE__LIMIT_MIN_NUMBER_OF_ROW,
                    oldLimitMinNumberOfRow, limitMinNumberOfRow));
    }
    ...
    public void setAllowAddRemoveRow(boolean newAllowAddRemoveRow) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DYNAMIC_TABLE__ALLOW_ADD_REMOVE_ROW,
                    oldAllowAddRemoveRow, allowAddRemoveRow));
    }
    ...
    public void setAllowAddRemoveColumn(boolean newAllowAddRemoveColumn) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DYNAMIC_TABLE__ALLOW_ADD_REMOVE_COLUMN,
                    oldAllowAddRemoveColumn, allowAddRemoveColumn));
    }
    ...
    public void setLimitMaxNumberOfColumn(boolean newLimitMaxNumberOfColumn) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DYNAMIC_TABLE__LIMIT_MAX_NUMBER_OF_COLUMN,
                    oldLimitMaxNumberOfColumn, limitMaxNumberOfColumn));
    }
    ...
    public void setLimitMaxNumberOfRow(boolean newLimitMaxNumberOfRow) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DYNAMIC_TABLE__LIMIT_MAX_NUMBER_OF_ROW,
                    oldLimitMaxNumberOfRow, limitMaxNumberOfRow));
    }
    ...
    public NotificationChain basicSetMinNumberOfColumn(Expression newMinNumberOfColumn, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.DYNAMIC_TABLE__MIN_NUMBER_OF_COLUMN, oldMinNumberOfColumn, newMinNumberOfColumn);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setMinNumberOfColumn(Expression newMinNumberOfColumn) {
        if (newMinNumberOfColumn != minNumberOfColumn) {
            ...
            if (minNumberOfColumn != null)
                msgs = ((InternalEObject) minNumberOfColumn).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.DYNAMIC_TABLE__MIN_NUMBER_OF_COLUMN, null, msgs);
            if (newMinNumberOfColumn != null)
                msgs = ((InternalEObject) newMinNumberOfColumn).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.DYNAMIC_TABLE__MIN_NUMBER_OF_COLUMN, null, msgs);
            msgs = basicSetMinNumberOfColumn(newMinNumberOfColumn, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DYNAMIC_TABLE__MIN_NUMBER_OF_COLUMN,
                    newMinNumberOfColumn, newMinNumberOfColumn));
    }
    ...
    public NotificationChain basicSetMinNumberOfRow(Expression newMinNumberOfRow, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.DYNAMIC_TABLE__MIN_NUMBER_OF_ROW, oldMinNumberOfRow, newMinNumberOfRow);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setMinNumberOfRow(Expression newMinNumberOfRow) {
        if (newMinNumberOfRow != minNumberOfRow) {
            ...
            if (minNumberOfRow != null)
                msgs = ((InternalEObject) minNumberOfRow).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.DYNAMIC_TABLE__MIN_NUMBER_OF_ROW, null, msgs);
            if (newMinNumberOfRow != null)
                msgs = ((InternalEObject) newMinNumberOfRow).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.DYNAMIC_TABLE__MIN_NUMBER_OF_ROW, null, msgs);
            msgs = basicSetMinNumberOfRow(newMinNumberOfRow, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DYNAMIC_TABLE__MIN_NUMBER_OF_ROW,
                    newMinNumberOfRow, newMinNumberOfRow));
    }
    ...
    public NotificationChain basicSetMaxNumberOfColumn(Expression newMaxNumberOfColumn, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.DYNAMIC_TABLE__MAX_NUMBER_OF_COLUMN, oldMaxNumberOfColumn, newMaxNumberOfColumn);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setMaxNumberOfColumn(Expression newMaxNumberOfColumn) {
        if (newMaxNumberOfColumn != maxNumberOfColumn) {
            ...
            if (maxNumberOfColumn != null)
                msgs = ((InternalEObject) maxNumberOfColumn).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.DYNAMIC_TABLE__MAX_NUMBER_OF_COLUMN, null, msgs);
            if (newMaxNumberOfColumn != null)
                msgs = ((InternalEObject) newMaxNumberOfColumn).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.DYNAMIC_TABLE__MAX_NUMBER_OF_COLUMN, null, msgs);
            msgs = basicSetMaxNumberOfColumn(newMaxNumberOfColumn, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DYNAMIC_TABLE__MAX_NUMBER_OF_COLUMN,
                    newMaxNumberOfColumn, newMaxNumberOfColumn));
    }
    ...
    public NotificationChain basicSetMaxNumberOfRow(Expression newMaxNumberOfRow, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.DYNAMIC_TABLE__MAX_NUMBER_OF_ROW, oldMaxNumberOfRow, newMaxNumberOfRow);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setMaxNumberOfRow(Expression newMaxNumberOfRow) {
        if (newMaxNumberOfRow != maxNumberOfRow) {
            ...
            if (maxNumberOfRow != null)
                msgs = ((InternalEObject) maxNumberOfRow).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.DYNAMIC_TABLE__MAX_NUMBER_OF_ROW, null, msgs);
            if (newMaxNumberOfRow != null)
                msgs = ((InternalEObject) newMaxNumberOfRow).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.DYNAMIC_TABLE__MAX_NUMBER_OF_ROW, null, msgs);
            msgs = basicSetMaxNumberOfRow(newMaxNumberOfRow, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DYNAMIC_TABLE__MAX_NUMBER_OF_ROW,
                    newMaxNumberOfRow, newMaxNumberOfRow));
    }
        ...
        if (baseClass == Validable.class) {
            switch (baseFeatureID) {
                case FormPackage.VALIDABLE__VALIDATORS:
                    return FormPackage.DYNAMIC_TABLE__VALIDATORS;
                case FormPackage.VALIDABLE__USE_DEFAULT_VALIDATOR:
                    return FormPackage.DYNAMIC_TABLE__USE_DEFAULT_VALIDATOR;
                case FormPackage.VALIDABLE__BELOW:
                    return FormPackage.DYNAMIC_TABLE__BELOW;
                default:
                    return -1;
            }
        }
        if (baseClass == FormField.class) {
            switch (baseFeatureID) {
                case FormPackage.FORM_FIELD__DESCRIPTION:
                    return FormPackage.DYNAMIC_TABLE__DESCRIPTION;
                case FormPackage.FORM_FIELD__EXAMPLE_MESSAGE_POSITION:
                    return FormPackage.DYNAMIC_TABLE__EXAMPLE_MESSAGE_POSITION;
                case FormPackage.FORM_FIELD__EXAMPLE_MESSAGE:
                    return FormPackage.DYNAMIC_TABLE__EXAMPLE_MESSAGE;
                default:
                    return -1;
            }
        }
