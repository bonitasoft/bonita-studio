...
public class FragmentContainerImpl extends EObjectImpl implements FragmentContainer {
    ...
    public EList<FragmentContainer> getChildren() {
        if (children == null) {
            children = new EObjectContainmentWithInverseEList<FragmentContainer>(FragmentContainer.class, this,
                    ConfigurationPackage.FRAGMENT_CONTAINER__CHILDREN, ConfigurationPackage.FRAGMENT_CONTAINER__PARENT);
        }
        return children;
    }
    ...
    public FragmentContainer getParent() {
        if (eContainerFeatureID() != ConfigurationPackage.FRAGMENT_CONTAINER__PARENT)
            return null;
    ...
    public void setParent(FragmentContainer newParent) {
        if (newParent != eInternalContainer()
                || (eContainerFeatureID() != ConfigurationPackage.FRAGMENT_CONTAINER__PARENT && newParent != null)) {
            ...
            if (newParent != null)
                msgs = ((InternalEObject) newParent).eInverseAdd(this, ConfigurationPackage.FRAGMENT_CONTAINER__CHILDREN,
                        FragmentContainer.class, msgs);
            msgs = basicSetParent(newParent, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConfigurationPackage.FRAGMENT_CONTAINER__PARENT, newParent,
                    newParent));
    }
    ...
    public EList<Fragment> getFragments() {
        if (fragments == null) {
            fragments = new EObjectContainmentEList<Fragment>(Fragment.class, this,
                    ConfigurationPackage.FRAGMENT_CONTAINER__FRAGMENTS);
        }
        return fragments;
    }
    ...
    public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
        switch (eContainerFeatureID()) {
            case ConfigurationPackage.FRAGMENT_CONTAINER__PARENT:
                return eInternalContainer().eInverseRemove(this, ConfigurationPackage.FRAGMENT_CONTAINER__CHILDREN,
                        FragmentContainer.class, msgs);
        }
