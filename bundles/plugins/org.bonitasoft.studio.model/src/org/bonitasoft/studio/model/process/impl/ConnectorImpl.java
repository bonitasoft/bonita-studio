 ...
 * <li>{@link org.bonitasoft.studio.model.process.impl.ConnectorImpl#getTextAnnotationAttachment <em>Text Annotation
 * Attachment</em>}</li>
...
public class ConnectorImpl extends EObjectImpl implements Connector {
    ...
    public void setDocumentation(String newDocumentation) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.CONNECTOR__DOCUMENTATION, oldDocumentation,
                    documentation));
    }
    ...
    public EList<TextAnnotationAttachment> getTextAnnotationAttachment() {
        if (textAnnotationAttachment == null) {
            textAnnotationAttachment = new EObjectContainmentWithInverseEList<TextAnnotationAttachment>(
                    TextAnnotationAttachment.class, this, ProcessPackage.CONNECTOR__TEXT_ANNOTATION_ATTACHMENT,
    ...
    public void setDefinitionId(String newDefinitionId) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.CONNECTOR__DEFINITION_ID, oldDefinitionId,
                    definitionId));
    }
    ...
    public void setIgnoreErrors(boolean newIgnoreErrors) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.CONNECTOR__IGNORE_ERRORS, oldIgnoreErrors,
                    ignoreErrors));
    }
    ...
    public void setThrowErrorEvent(boolean newThrowErrorEvent) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.CONNECTOR__THROW_ERROR_EVENT,
                    oldThrowErrorEvent, throwErrorEvent));
    }
    ...
    public void setNamedError(String newNamedError) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.CONNECTOR__NAMED_ERROR, oldNamedError,
                    namedError));
    }
    ...
    public void setDefinitionVersion(String newDefinitionVersion) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.CONNECTOR__DEFINITION_VERSION,
                    oldDefinitionVersion, definitionVersion));
    }
    ...
    public NotificationChain basicSetConfiguration(ConnectorConfiguration newConfiguration, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ProcessPackage.CONNECTOR__CONFIGURATION, oldConfiguration, newConfiguration);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newConfiguration != configuration) {
            ...
            if (configuration != null)
                msgs = ((InternalEObject) configuration).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ProcessPackage.CONNECTOR__CONFIGURATION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.CONNECTOR__CONFIGURATION, newConfiguration,
                    newConfiguration));
    }
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            ...
            case ProcessPackage.CONNECTOR__DEFINITION_VERSION:
                return DEFINITION_VERSION_EDEFAULT == null ? definitionVersion != null
                        : !DEFINITION_VERSION_EDEFAULT.equals(definitionVersion);
            case ProcessPackage.CONNECTOR__CONFIGURATION:
