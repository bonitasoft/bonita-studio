...
public class ParameterContextImpl extends EObjectImpl implements ParameterContext {
    ...
    public void setDescription(String newDescription) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ParameterPackage.PARAMETER_CONTEXT__DESCRIPTION,
    ...
    public EList<Parameter> getParameters() {
        if (parameters == null) {
            parameters = new EObjectContainmentEList<Parameter>(Parameter.class, this,
                    ParameterPackage.PARAMETER_CONTEXT__PARAMETERS);
        }
        return parameters;
    }
    ...
    public void setDefaultContext(boolean newDefaultContext) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ParameterPackage.PARAMETER_CONTEXT__DEFAULT_CONTEXT,
