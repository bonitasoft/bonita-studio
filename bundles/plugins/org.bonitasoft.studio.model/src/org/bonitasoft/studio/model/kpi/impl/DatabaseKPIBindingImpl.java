...
public class DatabaseKPIBindingImpl extends AbstractKPIBindingImpl implements DatabaseKPIBinding {
    ...
    public NotificationChain basicSetDriverclassName(Expression newDriverclassName, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    KpiPackage.DATABASE_KPI_BINDING__DRIVERCLASS_NAME, oldDriverclassName, newDriverclassName);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setDriverclassName(Expression newDriverclassName) {
        if (newDriverclassName != driverclassName) {
            ...
            if (driverclassName != null)
                msgs = ((InternalEObject) driverclassName).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - KpiPackage.DATABASE_KPI_BINDING__DRIVERCLASS_NAME, null, msgs);
            if (newDriverclassName != null)
                msgs = ((InternalEObject) newDriverclassName).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - KpiPackage.DATABASE_KPI_BINDING__DRIVERCLASS_NAME, null, msgs);
            msgs = basicSetDriverclassName(newDriverclassName, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, KpiPackage.DATABASE_KPI_BINDING__DRIVERCLASS_NAME,
                    newDriverclassName, newDriverclassName));
    }
    ...
    public NotificationChain basicSetJdbcUrl(Expression newJdbcUrl, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    KpiPackage.DATABASE_KPI_BINDING__JDBC_URL, oldJdbcUrl, newJdbcUrl);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setJdbcUrl(Expression newJdbcUrl) {
        if (newJdbcUrl != jdbcUrl) {
            NotificationChain msgs = null;
            if (jdbcUrl != null)
                msgs = ((InternalEObject) jdbcUrl).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - KpiPackage.DATABASE_KPI_BINDING__JDBC_URL, null, msgs);
            if (newJdbcUrl != null)
                msgs = ((InternalEObject) newJdbcUrl).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - KpiPackage.DATABASE_KPI_BINDING__JDBC_URL, null, msgs);
            msgs = basicSetJdbcUrl(newJdbcUrl, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, KpiPackage.DATABASE_KPI_BINDING__JDBC_URL, newJdbcUrl,
                    newJdbcUrl));
    }
    ...
    public NotificationChain basicSetUser(Expression newUser, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    KpiPackage.DATABASE_KPI_BINDING__USER, oldUser, newUser);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newUser != user) {
            ...
            if (user != null)
                msgs = ((InternalEObject) user).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - KpiPackage.DATABASE_KPI_BINDING__USER, null, msgs);
            if (newUser != null)
    ...
    public NotificationChain basicSetPassword(Expression newPassword, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    KpiPackage.DATABASE_KPI_BINDING__PASSWORD, oldPassword, newPassword);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newPassword != password) {
            ...
            if (password != null)
                msgs = ((InternalEObject) password).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - KpiPackage.DATABASE_KPI_BINDING__PASSWORD, null, msgs);
            if (newPassword != null)
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, KpiPackage.DATABASE_KPI_BINDING__PASSWORD, newPassword,
                    newPassword));
    }
    ...
    public NotificationChain basicSetJndiUrl(Expression newJndiUrl, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    KpiPackage.DATABASE_KPI_BINDING__JNDI_URL, oldJndiUrl, newJndiUrl);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setJndiUrl(Expression newJndiUrl) {
        if (newJndiUrl != jndiUrl) {
            NotificationChain msgs = null;
            if (jndiUrl != null)
                msgs = ((InternalEObject) jndiUrl).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - KpiPackage.DATABASE_KPI_BINDING__JNDI_URL, null, msgs);
            if (newJndiUrl != null)
                msgs = ((InternalEObject) newJndiUrl).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - KpiPackage.DATABASE_KPI_BINDING__JNDI_URL, null, msgs);
            msgs = basicSetJndiUrl(newJndiUrl, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, KpiPackage.DATABASE_KPI_BINDING__JNDI_URL, newJndiUrl,
                    newJndiUrl));
    }
    ...
    public void setTableName(String newTableName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, KpiPackage.DATABASE_KPI_BINDING__TABLE_NAME, oldTableName,
                    tableName));
    }
