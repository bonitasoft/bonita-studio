 ...
 * <li>{@link org.bonitasoft.studio.model.process.impl.BoundaryEventImpl#getTextAnnotationAttachment <em>Text Annotation
 * Attachment</em>}</li>
...
public class BoundaryEventImpl extends EObjectImpl implements BoundaryEvent {
    ...
    public void setDocumentation(String newDocumentation) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.BOUNDARY_EVENT__DOCUMENTATION,
    ...
    public EList<TextAnnotationAttachment> getTextAnnotationAttachment() {
        if (textAnnotationAttachment == null) {
            textAnnotationAttachment = new EObjectContainmentWithInverseEList<TextAnnotationAttachment>(
                    TextAnnotationAttachment.class, this, ProcessPackage.BOUNDARY_EVENT__TEXT_ANNOTATION_ATTACHMENT,
    ...
    public EList<Connection> getOutgoing() {
        if (outgoing == null) {
            outgoing = new EObjectWithInverseResolvingEList<Connection>(Connection.class, this,
                    ProcessPackage.BOUNDARY_EVENT__OUTGOING, ProcessPackage.CONNECTION__SOURCE);
        }
        return outgoing;
    }
        ...
        if (baseClass == SourceElement.class) {
            switch (baseFeatureID) {
                case ProcessPackage.SOURCE_ELEMENT__OUTGOING:
                    return ProcessPackage.BOUNDARY_EVENT__OUTGOING;
                default:
                    return -1;
            }
        }
