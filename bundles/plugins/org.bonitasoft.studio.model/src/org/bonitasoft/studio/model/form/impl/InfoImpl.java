 ...
 * <li>{@link org.bonitasoft.studio.model.form.impl.InfoImpl#getTextAnnotationAttachment <em>Text Annotation
 * Attachment</em>}</li>
 ...
 * <li>{@link org.bonitasoft.studio.model.form.impl.InfoImpl#isAllowHTMLForDisplayLabel <em>Allow HTML For Display
 * Label</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.InfoImpl#getDependOn <em>Depend On</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.InfoImpl#isDisplayDependentWidgetOnlyOnEventTriggered <em>Display
 ...
 * <li>{@link org.bonitasoft.studio.model.form.impl.InfoImpl#getDisplayDependentWidgetOnlyAfterFirstEventTriggeredAndCondition
 * <em>Display Dependent Widget Only After First Event Triggered And Condition</em>}</li>
 * <li>{@link org.bonitasoft.studio.model.form.impl.InfoImpl#getDisplayAfterEventDependsOnConditionScript <em>Display After
...
public class InfoImpl extends EObjectImpl implements Info {
    ...
    public void setDocumentation(String newDocumentation) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.INFO__DOCUMENTATION, oldDocumentation,
                    documentation));
    }
    ...
    public EList<TextAnnotationAttachment> getTextAnnotationAttachment() {
        if (textAnnotationAttachment == null) {
            textAnnotationAttachment = new EObjectContainmentWithInverseEList<TextAnnotationAttachment>(
                    TextAnnotationAttachment.class, this, FormPackage.INFO__TEXT_ANNOTATION_ATTACHMENT,
    ...
    public EMap<String, String> getHtmlAttributes() {
        if (htmlAttributes == null) {
            htmlAttributes = new EcoreEMap<String, String>(EcorePackage.Literals.ESTRING_TO_STRING_MAP_ENTRY,
                    EStringToStringMapEntryImpl.class, this, FormPackage.INFO__HTML_ATTRIBUTES);
        }
    ...
    public NotificationChain basicSetWidgetLayoutInfo(WidgetLayoutInfo newWidgetLayoutInfo, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.INFO__WIDGET_LAYOUT_INFO, oldWidgetLayoutInfo, newWidgetLayoutInfo);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newWidgetLayoutInfo != widgetLayoutInfo) {
            ...
            if (widgetLayoutInfo != null)
                msgs = ((InternalEObject) widgetLayoutInfo).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.INFO__WIDGET_LAYOUT_INFO, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.INFO__WIDGET_LAYOUT_INFO, newWidgetLayoutInfo,
                    newWidgetLayoutInfo));
    }
    ...
    public void setShowDisplayLabel(Boolean newShowDisplayLabel) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.INFO__SHOW_DISPLAY_LABEL, oldShowDisplayLabel,
                    showDisplayLabel));
    }
    ...
    public void setAllowHTMLForDisplayLabel(boolean newAllowHTMLForDisplayLabel) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.INFO__ALLOW_HTML_FOR_DISPLAY_LABEL,
    ...
    public void setDisplayDependentWidgetOnlyOnEventTriggered(boolean newDisplayDependentWidgetOnlyOnEventTriggered) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    FormPackage.INFO__DISPLAY_DEPENDENT_WIDGET_ONLY_ON_EVENT_TRIGGERED,
    ...
    public void setLabelPosition(LabelPosition newLabelPosition) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.INFO__LABEL_POSITION, oldLabelPosition,
                    labelPosition));
    }
    ...
    public void setRealHtmlAttributes(String newRealHtmlAttributes) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.INFO__REAL_HTML_ATTRIBUTES,
    ...
    public void setInjectWidgetCondition(boolean newInjectWidgetCondition) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.INFO__INJECT_WIDGET_CONDITION,
    ...
    public void setReturnTypeModifier(String newReturnTypeModifier) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.INFO__RETURN_TYPE_MODIFIER,
    ...
    public NotificationChain basicSetDisplayDependentWidgetOnlyAfterFirstEventTriggeredAndCondition(
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.INFO__DISPLAY_DEPENDENT_WIDGET_ONLY_AFTER_FIRST_EVENT_TRIGGERED_AND_CONDITION,
    ...
    public NotificationChain basicSetDisplayAfterEventDependsOnConditionScript(
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.INFO__DISPLAY_AFTER_EVENT_DEPENDS_ON_CONDITION_SCRIPT,
        ...
        if (newDisplayAfterEventDependsOnConditionScript != displayAfterEventDependsOnConditionScript) {
            ...
            if (displayAfterEventDependsOnConditionScript != null)
                msgs = ((InternalEObject) displayAfterEventDependsOnConditionScript).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.INFO__DISPLAY_AFTER_EVENT_DEPENDS_ON_CONDITION_SCRIPT, null,
                        msgs);
    ...
    public NotificationChain basicSetInputExpression(Expression newInputExpression, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.INFO__INPUT_EXPRESSION, oldInputExpression, newInputExpression);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newInputExpression != inputExpression) {
            ...
            if (inputExpression != null)
                msgs = ((InternalEObject) inputExpression).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.INFO__INPUT_EXPRESSION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.INFO__INPUT_EXPRESSION, newInputExpression,
                    newInputExpression));
    }
    ...
    public NotificationChain basicSetAfterEventExpression(Expression newAfterEventExpression, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.INFO__AFTER_EVENT_EXPRESSION, oldAfterEventExpression, newAfterEventExpression);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newAfterEventExpression != afterEventExpression) {
            ...
            if (afterEventExpression != null)
                msgs = ((InternalEObject) afterEventExpression).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.INFO__AFTER_EVENT_EXPRESSION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.INFO__AFTER_EVENT_EXPRESSION,
    ...
    public NotificationChain basicSetTooltip(Expression newTooltip, NotificationChain msgs) {
        ...
        tooltip = newTooltip;
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FormPackage.INFO__TOOLTIP,
    ...
    public void setTooltip(Expression newTooltip) {
        if (newTooltip != tooltip) {
            NotificationChain msgs = null;
            if (tooltip != null)
                msgs = ((InternalEObject) tooltip).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FormPackage.INFO__TOOLTIP,
                        null, msgs);
            if (newTooltip != null)
                msgs = ((InternalEObject) newTooltip).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FormPackage.INFO__TOOLTIP,
                        null, msgs);
    ...
    public NotificationChain basicSetHelpMessage(Expression newHelpMessage, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FormPackage.INFO__HELP_MESSAGE,
        ...
        if (newHelpMessage != helpMessage) {
            ...
            if (helpMessage != null)
                msgs = ((InternalEObject) helpMessage).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.INFO__HELP_MESSAGE, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.INFO__HELP_MESSAGE, newHelpMessage,
                    newHelpMessage));
    }
    ...
    public NotificationChain basicSetDisplayLabel(Expression newDisplayLabel, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FormPackage.INFO__DISPLAY_LABEL,
        ...
        if (newDisplayLabel != displayLabel) {
            ...
            if (displayLabel != null)
                msgs = ((InternalEObject) displayLabel).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.INFO__DISPLAY_LABEL, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.INFO__DISPLAY_LABEL, newDisplayLabel,
                    newDisplayLabel));
    }
    ...
    public NotificationChain basicSetInjectWidgetScript(Expression newInjectWidgetScript, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FormPackage.INFO__INJECT_WIDGET_SCRIPT, oldInjectWidgetScript, newInjectWidgetScript);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newInjectWidgetScript != injectWidgetScript) {
            ...
            if (injectWidgetScript != null)
                msgs = ((InternalEObject) injectWidgetScript).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FormPackage.INFO__INJECT_WIDGET_SCRIPT, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.INFO__INJECT_WIDGET_SCRIPT,
    ...
    public NotificationChain basicSetAction(Operation newAction, NotificationChain msgs) {
        ...
        action = newAction;
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FormPackage.INFO__ACTION,
                    oldAction, newAction);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setAction(Operation newAction) {
        if (newAction != action) {
            NotificationChain msgs = null;
            if (action != null)
                msgs = ((InternalEObject) action).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FormPackage.INFO__ACTION,
                        null, msgs);
            if (newAction != null)
                msgs = ((InternalEObject) newAction).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FormPackage.INFO__ACTION,
                        null, msgs);
        ...
        if (baseClass == CSSCustomizable.class) {
            switch (baseFeatureID) {
                case FormPackage.CSS_CUSTOMIZABLE__HTML_ATTRIBUTES:
                    return FormPackage.INFO__HTML_ATTRIBUTES;
                default:
                    return -1;
            }
        }
