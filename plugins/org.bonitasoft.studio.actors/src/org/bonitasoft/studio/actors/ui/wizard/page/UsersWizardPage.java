...
public class UsersWizardPage extends AbstractOrganizationWizardPage {
    ...
    private void refreshBinding(final User selectedUser) {
        ...
        if(selectedUser != null){
            ...
            context.bindValue(SWTObservables.observeText(passwordText,SWT.Modify), EMFObservables.observeValue(selectedUser,  OrganizationPackage.Literals.USER__PASSWORD),mandatoryStrategy,null);
