...
public class PatternExpressionViewer extends Composite {
    ...
    protected void createTextViewer() {
        ...
        patternLineStyle = new PatternLineStyleListener();
                ...
                if(content != null && !content.isEmpty()){
                    for(Expression exp : filteredExpressions){
                        ...
                        while (indexOf != -1 && !added) {
                            ...
                            if(!added){
                                currentContent = currentContent.substring(indexOf+exp.getName().length());
                                indexOf = currentContent.indexOf(exp.getName());
                            }
                        }
                    }
                }
