 ...
 *
 */
public class OpenUserXPCoolbarItem implements IBonitaContributionItem {
	...
	public void fill(ToolBar toolbar, int index, int iconSize) {
		...
		if(iconSize < 0 ){
			...
			item.setImage(Pics.getImage("/appIcons/userxp.png")) ;
			item.setDisabledImage(Pics.getImage("/appIcons/user_xp_disabled.png"));
		}else{
			smallImage = new Image(Display.getDefault(),Pics.getImage("/appIcons/userxp.png").getImageData().scaledTo(iconSize, iconSize));
			smallDisabledImage = new Image(Display.getDefault(),Pics.getImage("/appIcons/user_xp_disabled.png").getImageData().scaledTo(iconSize, iconSize)) ;
