...
public class RunCoolbarItem implements IBonitaContributionItem {
    ...
    public void fill(ToolBar toolbar, int index, int iconSize) {
        ...
        if(iconSize <  0){
            ...
            item.setImage(Pics.getImage("/appIcons/run.png")) ;
            item.setDisabledImage(Pics.getImage("/appIcons/run_disabled.png"));
        }else{
            smallImage = new Image(Display.getDefault(),Pics.getImage("/appIcons/run.png").getImageData().scaledTo(iconSize, iconSize));
            smallDisabledImage = new Image(Display.getDefault(),Pics.getImage("/appIcons/run_disabled.png").getImageData().scaledTo(iconSize, iconSize)) ;
