 ...
 *
 */
public class FlowElementSwith extends AbstractProcessSwitch {

    public FlowElementSwith(ProcessDefinitionBuilder processBuilder,Set<EObject> eObjectNotExported){
        super(processBuilder, eObjectNotExported) ;
    }
    ...
    public CallActivity caseCallActivity(CallActivity object) {
        ...
        for(InputMapping mapping : object.getInputMappings()){
            ...
            builder.setDataName(mapping.getSubprocessTarget()) ;
        ...
        for(OutputMapping mapping : object.getOutputMappings()){
            ...
            final LeftOperandBuilder builder = new LeftOperandBuilder() ;
            builder.createNewInstance() ;
            builder.setDataName(mapping.getProcessTarget().getName()) ;
            opBuilder.setVariableToSet(builder.done());
            opBuilder.setType(OperatorType.ASSIGNMENT);
    ...
    public FlowElement caseStartTimerEvent(final StartTimerEvent startTimer) {
        ...
        ExpressionBuilder expressionBuilder = new ExpressionBuilder().createNewInstance(startTimer.getScriptType().getName());
