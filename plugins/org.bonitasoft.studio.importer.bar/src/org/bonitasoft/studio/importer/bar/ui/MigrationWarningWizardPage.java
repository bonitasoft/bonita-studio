...
public class MigrationWarningWizardPage extends WizardPage {
    ...
    public void createControl(Composite parent) {
        ...
        final Text textArea = new Text(mainComposite, SWT.MULTI | SWT.BORDER | SWT.WRAP | SWT.V_SCROLL);
        textArea.setLayoutData(GridDataFactory.fillDefaults().grab(true, true).hint(300, SWT.DEFAULT).create());
        textArea.setText(Messages.importWarningMessageContent);

        final Button displayCheckbox = new Button(mainComposite, SWT.CHECK);
