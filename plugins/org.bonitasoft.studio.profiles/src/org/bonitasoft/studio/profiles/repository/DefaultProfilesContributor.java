...
// *
// */
//public class DefaultProfilesContributor implements RepositoryInitializationContributor {
//
//
//	/* (non-Javadoc)
...
//		return ProfileRepository.getInstance().getProject().findMember(BonitaProfilesManager.APPLICATION_DEVELOPER_PROFILE+".profile") == null;
//	}
//
//	/* (non-Javadoc)
...
//		Enumeration<?> resources = ProfilePlugin.getDefault().getBundle().findEntries("profiles/", "*.profile", false);
...
//				}
//
//				ProfileRepository.getInstance().importArtifact(fileName,stream,monitor) ;
//				stream.close();
//
//			} catch (Exception ex) {
