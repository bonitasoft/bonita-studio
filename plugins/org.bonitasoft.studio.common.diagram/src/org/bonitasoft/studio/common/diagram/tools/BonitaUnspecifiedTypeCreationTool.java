...
public class BonitaUnspecifiedTypeCreationTool extends UnspecifiedTypeCreationTool {
    ...
    private void showTargetCompartmentFeedback() {
        /*
         * if (revertColor == null && getTargetEditPart() instanceof
         * ShapeCompartmentEditPart) { targetFigure =
         * getFigure(getTargetEditPart());
         * getTargetEditPart().getViewer().getVisualPartMap
         * ().get(getTargetEditPart()); revertColor =
         * targetFigure.getBackgroundColor(); opacity = targetFigure.isOpaque();
         * targetFigure.setBackgroundColor(
         * FigureUtilities.mixColors(FiguresHelper.COMPARTMENT_FEEDBACK_COLOR,
         * revertColor)); targetFigure.setOpaque(true); }
         */
        // DO NOTHING
    }
    ...
    private void hideTargetCompartmentFeedback() {
         ...
         * targetFigure.setOpaque(opacity); revertColor = null; }
         */
        // DO NOTHING
    }
