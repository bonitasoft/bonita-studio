    ...
    void onPaint(GC gc, boolean isSelected) {
        ...
        if (isSelected) {
            ...
            if (!parent.onBottom) {
                ...
                /*begin draw point to have rounded border*/
                if (index != parent.topTabIndex) {
                ...
                gc.drawLine(x + width, y + height - 1, x + width, y + height
                        - 1);
                /*end draw point to have rounded border*/
        ...
        /*Draw top line of a selected tab*/
        if (isSelected) {
        ...
        if(isSelected)
        	gc.setForeground(BonitaTabsColors.getActiveEditorText());
        else
        	gc.setForeground(parent.getForeground());
