 ...
 *
 */
public class PreferenceCoolbarItem implements IBonitaContributionItem {
	...
	private Command getCommand() {
		...
		Command cmd = service.getCommand("org.eclipse.ui.window.preferences") ;
		return cmd;
	}
	...
	public void fill(ToolBar toolbar, int index, int iconSize) {
		...
		if(iconSize < 0 ){
			...
			item.setImage(Pics.getImage("/editIcons/preferences.png")) ;
		}else{
			smallImage = new Image(Display.getDefault(),Pics.getImage("/editIcons/preferences.png").getImageData().scaledTo(iconSize, iconSize));
