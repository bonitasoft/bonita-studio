 ...
 *
 */
public class ExportBarCoolbarItem implements IBonitaContributionItem {
    ...
    private Command getCommand() {
        ...
        Command cmd = service.getCommand("org.bonitasoft.studio.exportBosArchive") ;
        return cmd;
    }
    ...
    public void fill(ToolBar toolbar, int index, int iconSize) {
        ...
        if(iconSize < 0){
            item.setImage(Pics.getImage("/editIcons/export.png")) ;
            item.setDisabledImage(Pics.getImage("/editIcons/export_disabled.png"));
            item.setText(Messages.ExportButtonLabel) ;
        }else{
            smallImage = new Image(Display.getDefault(),Pics.getImage("/editIcons/export.png").getImageData().scaledTo(iconSize, iconSize));
            smallDisabledImage = new Image(Display.getDefault(),Pics.getImage("/editIcons/export_disabled.png").getImageData().scaledTo(iconSize, iconSize)) ;
