 ...
 */
package org.bonitasoft.studio.userguidance.coolbar;
...
public class UserGuidanceCoolbarItem implements IBonitaContributionItem {
	...
	private Command getCommand() {
		...
		Command cmd = service.getCommand("org.bonitasoft.studio.openUserGuidance") ;
		return cmd;
	}
	...
	@Override
	public String getId() {
		return "org.bonitasoft.studio.coolbar.userguidance";
	}
