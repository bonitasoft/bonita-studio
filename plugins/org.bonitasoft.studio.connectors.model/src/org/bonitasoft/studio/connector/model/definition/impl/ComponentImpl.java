 ...
 * <ul>
 *   <li>{@link org.bonitasoft.studio.connector.model.definition.impl.ComponentImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ComponentImpl extends EObjectImpl implements Component {
    ...
    protected EClass eStaticClass() {
		return ConnectorDefinitionPackage.Literals.COMPONENT;
	}
    ...
    public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectorDefinitionPackage.COMPONENT__ID, oldId, id));
	}
