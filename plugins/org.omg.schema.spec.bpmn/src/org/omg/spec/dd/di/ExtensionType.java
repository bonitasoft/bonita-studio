 ...
 * <ul>
 *   <li>{@link org.omg.spec.dd.di.ExtensionType#getAny <em>Any</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.omg.spec.dd.di.DiPackage#getExtensionType()
...
public interface ExtensionType extends EObject {
	 ...
	 * @see org.omg.spec.dd.di.DiPackage#getExtensionType_Any()
