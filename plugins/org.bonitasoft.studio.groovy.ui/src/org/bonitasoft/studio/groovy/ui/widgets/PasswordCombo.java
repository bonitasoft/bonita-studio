 ...
 */
public class PasswordCombo extends Composite {
 ...
 * @see Widget#getStyle()
 */
public PasswordCombo (Composite parent, int style) {
	...
	listener = new Listener () {
		public void handleEvent (Event event) {
			...
			if (PasswordCombo.this == event.widget) {
				comboEvent (event);
				return;
			}
	...
	filter = new Listener() {
		public void handleEvent(Event event) {
			...
			if (shell == PasswordCombo.this.getShell ()) {
				handleFocus (SWT.FocusOut);
			}
		}
	};
