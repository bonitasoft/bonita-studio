 ...
 *
 */
public class ObservablePasswordComboEnabled extends AbstractObservableValue  {

	private PasswordCombo combo;

	public ObservablePasswordComboEnabled(PasswordCombo passwordCombo) {
	...
	protected void doSetValue(Object value) {
		if(value instanceof Boolean){
			combo.setEnabled((Boolean)value);
		}
	}
