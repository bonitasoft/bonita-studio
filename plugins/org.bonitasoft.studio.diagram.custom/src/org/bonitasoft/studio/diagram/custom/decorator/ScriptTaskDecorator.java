 ...
 *
 */
public class ScriptTaskDecorator extends AbstractBonitaDecorator/*implements IBonitaDecorator*/ { 
	 ...
	 */
	public ScriptTaskDecorator(IDecoratorTarget decoratorTarget, ActivityDecoratorProvider activityDecoratorProvider) {
	...
	protected DecoratorSVGFigure getImageDecorator() {
		return FiguresHelper.getDecoratorFigure(FiguresHelper.SCRIPT_DECORATOR) ;
	}
	...
	protected boolean isAppearing(EObject activity) {
		return activity instanceof ScriptTask;
	}
