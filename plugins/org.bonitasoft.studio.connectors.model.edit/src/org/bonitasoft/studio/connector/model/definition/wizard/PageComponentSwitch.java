...
public class PageComponentSwitch extends ConnectorDefinitionSwitch<Component> {
    ...
    private final ViewerFilter connectorExpressionContentTypeFilter =  new AvailableExpressionTypeFilter(new String[]{
    ...
    public Component caseGroup(Group object) {
        ...
        final PageComponentSwitch groupSwitch = new PageComponentSwitch(client,container,definition,connectorConfiguration,context,messageProvider) ;
    ...
    protected void createSelectControl(Composite composite, Select object) {
        ...
        if(parameter != null){
            ...
            ((Expression) parameter.getExpression()).setType(ExpressionConstants.CONSTANT_TYPE) ;
            ((Expression) parameter.getExpression()).setReturnType(input.getType()) ;
            context.bindValue(SWTObservables.observeText(combo), EMFObservables.observeValue(parameter.getExpression(), ExpressionPackage.Literals.EXPRESSION__NAME)) ;
            context.bindValue(SWTObservables.observeText(combo), EMFObservables.observeValue(parameter.getExpression(), ExpressionPackage.Literals.EXPRESSION__CONTENT)) ;
        }
    }
