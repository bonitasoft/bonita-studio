...
public class SWTBotTestUtil implements SWTBotConstants{
     ...
     * @throws IOException
     */
    public static void importProcessWIthPathFromClass(final SWTWorkbenchBot bot, final String resourceNameInClasspath, final String importName, final String diagramEditorTitle, final Class<?> srcClass, final boolean mustAskOverride) throws IOException{
     ...
     * @param dropLocation
     */
    public static void selectElementInContextualPaletteAndDragIt(final SWTBotGefEditor gmfEditor,final String selectedElementName,final int elementIndex, final Point dropLocation){
    ...
    public static void selectElementInContextualPaletteAndDragIt(final SWTBotGefEditor gmfEditor,final String selectedElementName,final int elementIndex, final int position){
        final SWTBotGefEditPart gep = gmfEditor.getEditPart(selectedElementName);
        Assert.assertNotNull("Error: No Edit Part \'"+selectedElementName+"\' found.", gep);
     ...
     * @param defaultValue
     */
    public static void addListOfOptionData(final SWTBot bot,final String name,final String type,final Map<String,List<String>> options,final boolean isMultiple,final String defaultValue){
     ...
     */
    public static void addSequenceFlow(final SWTGefBot bot,final SWTBotGefEditor gmfEditor,final String startElementName,final String endElementName,final int targetAnchorPosition){
     ...
     * @param condition
     */
    public static void configureSequenceFlow(final SWTGefBot bot,final String name,final String pool,final boolean defaultFlow,final String condition,final String expressionType){
    ...
    public static StyleRange getTextStyleInEditExpressionDialog(final SWTGefBot bot,final String expressionType, final int line,final int column) throws OperationCanceledException, InterruptedException{
        bot.waitUntil(new ICondition() {
    ...
    public static void editEmailConnector(final SWTGefBot bot, final String emailName, final String emailDescription, final String from, final String to, final String subject, final String message ) {
        // 1st page
