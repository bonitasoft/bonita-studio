...
public class TestAddJar extends TestCase {
    ...
    public void testAddJar() throws URISyntaxException, IOException, CoreException, OperationCanceledException, InterruptedException {
        URL url = getClass().getResource("TestConnectorBis.jar");
        url = FileLocator.toFileURL(url);
        File file = new File(url.getFile());
        DependencyRepositoryStore drs = (DependencyRepositoryStore) RepositoryManager.getInstance().getRepositoryStore(DependencyRepositoryStore.class);
