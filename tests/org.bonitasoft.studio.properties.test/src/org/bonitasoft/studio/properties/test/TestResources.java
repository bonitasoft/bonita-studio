...
public class TestResources extends SWTBotGefTestCase implements SWTBotConstants{
    ...
    public void testCorrectLabelProvider() throws Exception{
        SWTBotTestUtil.importProcessWIthPathFromClass(bot, "TestExportToBPMNDiagram_1_0.bos", "Bonita 6.x and 7.x", "TestExportToBPMNDiagram", TestResources.class, false);
