...
public class TestRunWithDocument {
    ...
    public void testRunWithDocument() throws Exception {
        SWTBotTestUtil.importProcessWIthPathFromClass(bot, "ProcessWithAttachment_1_0.bos", SWTBotTestUtil.IMPORTER_TITLE_BONITA, "ProcessWithAttachment", TestRunWithDocument.class, false);
        runAndCheckResult();
    }
