...
public class TestFormValidatorIT {
    ...
    public void testParameterEnablementForGroovyValidator() {
        ...
        final BotAddFormWizardDialog botAddFormWizardDialog = botProcessDiagramPerspective.getDiagramPropertiesPart()
                .selectApplicationTab()
                .selectPageflowTab().addForm();
        botAddFormWizardDialog.finish();

        final BotValidatorPropertySection botValidatorPropertySection = botProcessDiagramPerspective.getFormPropertiesPart()
                .selectGeneralTab()
                .selectValidatorsTab();
