 ...
 */
package org.bonitasoft.studio.tests.importer.examples;
...
public class Test59ExampleImport {
    ...
    public void testBuyAMiniMigration() throws Exception {
        ...
        ConnectorImplementation stockCheckImplementation = implStore.getImplementation("MiniStockCheckConnector-impl",
                "1.0.0");
