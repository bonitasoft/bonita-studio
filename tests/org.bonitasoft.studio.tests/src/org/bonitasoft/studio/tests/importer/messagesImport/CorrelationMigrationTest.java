 ...
 */
package org.bonitasoft.studio.tests.importer.messagesImport;
...
public class CorrelationMigrationTest extends TestCase {
    ...
    public void testImportMessage59Bar() throws Exception {
        ...
        final List<MessageFlow> messageFlows = ModelHelper.getAllItemsOfType(mainProcess,
                ProcessPackage.Literals.MESSAGE_FLOW);
        ...
        assertEquals("2 correlation key should be defined", 2,
                message.getCorrelation().getCorrelationAssociation().getExpressions().size());
        resource.unload();
    }
