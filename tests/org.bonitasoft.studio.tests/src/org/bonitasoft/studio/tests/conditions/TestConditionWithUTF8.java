...
public class TestConditionWithUTF8 extends SWTBotGefTestCase {
    ...
    public void testConditionWithUTF8() {
        ...
        final BotAddDataWizardPage botAddDataWizardPage = botProcessDiagramPerspective.getDiagramPropertiesPart()
                .selectDataTab().selectLocalDataTab().addData();
        ...
        final BotGeneralPropertySection botGeneralPropertySection = botProcessDiagramPerspective.getDiagramPropertiesPart()
                .selectGeneralTab()
                .selectGeneralTab();
        botGeneralPropertySection.setConditionExpression("ç®¡ç�†è€… == \"test\"");
        final BotValidationPropertiesView validationPropertiesTab = botProcessDiagramPerspective.getDiagramPropertiesPart()
                .selectValidationStatusTab();
