...
public class TestRemoveWidgetReferencesOperation {
	...
	public void testRemoveWidgetReferencedInScript() throws InvocationTargetException, InterruptedException{
		Widget widgetWithScript = FormFactory.eINSTANCE.createTextFormField();
		Expression scriptRefereincingRefactoredWidget = ExpressionFactory.eINSTANCE.createExpression();
    	...
    	assertEquals("Delete of Widget doesn't update reference in script after undo", initialName,((Widget) scriptRefereincingRefactoredWidget.getReferencedElements().get(0)).getName());
	}
