...
public class BPMNExportImportDataMappingTest extends SWTBotGefTestCase {
	...
	protected void prepareTest() throws IOException {
		SWTBotTestUtil.importProcessWIthPathFromClass(bot, "testBPMNDataMapping-1.0.bos", "Bonita 6.x and 7.x", "testBPMNDataMapping", BPMNExportImportDataMappingTest.class, false);
