...
public class BPMNExportImportMessageDataTest extends SWTBotGefTestCase {
	...
	protected void prepareTest() throws IOException {
		SWTBotTestUtil.importProcessWIthPathFromClass(bot, "MessageDataTestValue-1.0.bos", "Bonita 6.x and 7.x", "MessageDataTestValue", BPMNExportImportMessageDataTest.class, false);
