...
public class BPMNGatewayExportImportTest extends SWTBotGefTestCase {
    ...
    private void prepareTest() throws IOException {
        SWTBotTestUtil.importProcessWIthPathFromClass(bot, "diagramToTestGateways-6.0.bos", "Bonita 6.x and 7.x", "Request_For_Advance_Payment", BPMNGatewayExportImportTest.class, false);
