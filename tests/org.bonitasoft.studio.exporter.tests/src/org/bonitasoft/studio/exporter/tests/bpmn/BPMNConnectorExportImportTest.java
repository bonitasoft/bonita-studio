...
public class BPMNConnectorExportImportTest extends SWTBotGefTestCase {
    ...
    protected void prepareTest() throws IOException {
        SWTBotTestUtil.importProcessWIthPathFromClass(bot, "diagramToTestConnectorBPMNImportExport-1.0.bos", BOS Archive, "diagramToTestConnectorBPMNImportExport", BPMNConnectorExportImportTest.class, false);
